            ...
            vm.searchCustomerWinOptions = {
                ...
                open: function () {
                    ...
                    vm.searchCustomerWin.options.content = {
                        url:bars.config.urlContent('/clients/customers/search/?partial=true')
                    };
                            ...
                            bars.ui.confirm({
                                ...
                                func: function() {
                                    customersService.closeCustomer(row.Id).then(
                                        function() {
                                            bars.ui.notify('Статус', 'Клієнта № ' + row.Id + ' успішно закрито.', 'success');
                                            vm.customersGrid.dataSource.read();
                                        },
                                        function() {
                                            //vm.serviceState.searchText = '';
                ...
                columns: [
                    {
                        ...
                        template: '<a href="#= bars.config.urlContent(\'/clients/customers/view/\') + Id #" ng-click="custCtrl.viewCustomer(#=Id#)" onclick="return false;">#= Id #</a>',
