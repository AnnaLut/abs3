...
namespace Bars.EAD
{
    ...
    public class EadPack : BbPackage
    {
        ...
        public Decimal? DOC_CREATE(String P_TYPE_ID, String P_TEMPLATE_ID, Byte[] P_SCAN_DATA, Decimal? P_EA_STRUCT_ID, Decimal? P_RNK, Decimal? P_AGR_ID, Decimal? ACC)
        {
            List<OracleParameter> parameters = new List<OracleParameter>();
            parameters.Add(new OracleParameter("P_TYPE_ID", OracleDbType.Varchar2, P_TYPE_ID, ParameterDirection.Input));
            ...
            parameters.Add(new OracleParameter("P_ACC", OracleDbType.Decimal, ACC, ParameterDirection.Input));
            parameters.Add(new OracleParameter("$$RETVAL$$", OracleDbType.Decimal, ParameterDirection.ReturnValue));
            object ReturnValue = null;
        ...
        {
            return DOC_CREATE(P_TYPE_ID, P_TEMPLATE_ID, P_SCAN_DATA, P_EA_STRUCT_ID, P_RNK, P_AGR_ID, null);
        }

        public Decimal? DOC_CREATE(String P_TYPE_ID, String P_TEMPLATE_ID, Byte[] P_SCAN_DATA, Decimal? P_EA_STRUCT_ID, Decimal? P_RNK)
        {
            return DOC_CREATE(P_TYPE_ID, P_TEMPLATE_ID, P_SCAN_DATA, P_EA_STRUCT_ID, P_RNK, null, null);
        }
