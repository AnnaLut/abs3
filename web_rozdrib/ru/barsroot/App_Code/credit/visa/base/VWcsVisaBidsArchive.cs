...
namespace credit
{
    public sealed class VWcsVisaBidsArchiveRecord : BbRecord
    {
        public VWcsVisaBidsArchiveRecord(): base()
        {
            fillFields();
        }
        public VWcsVisaBidsArchiveRecord(BbDataSource Parent) : base (Parent)
        {
            fillFields();
        }
        ...
        {
            Fields.Add( new BbField("BID_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Идентификатор заявки"));
            Fields.Add( new BbField("SUBPRODUCT_ID", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Идентификатор субпродукта"));
            Fields.Add( new BbField("SUBPRODUCT_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Наименование субпродукта"));
            Fields.Add( new BbField("CRT_DATE", OracleDbType.Date, false, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Дата создания заявки"));
            Fields.Add( new BbField("STATUS", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Статус заявки"));
            Fields.Add( new BbField("F", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Ф клиента"));
            Fields.Add( new BbField("I", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "И клиента"));
            Fields.Add( new BbField("O", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "О клиента"));
            Fields.Add( new BbField("FIO", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "ФИО клиента"));
            Fields.Add( new BbField("BDATE", OracleDbType.Date, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Дата рождения клиента"));
            Fields.Add( new BbField("INN", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "ИНН клиента"));
            Fields.Add( new BbField("WORK_MAIN_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Наименование основного места работы"));
            Fields.Add( new BbField("WORK_MAIN_INN", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "ЄДРПОУ основного места работы"));
            Fields.Add( new BbField("WORK_ADD_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Наименование дополнительного места работы"));
            Fields.Add( new BbField("WORK_ADD_INN", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "ЄДРПОУ дополнительного места работы"));
            Fields.Add( new BbField("PROPERTY_COST", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Стоимость имущества"));
            Fields.Add( new BbField("SUMM", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Сумма кредита"));
            Fields.Add( new BbField("OWN_FUNDS", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Сума власних коштів"));
            Fields.Add( new BbField("TERM", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Срок кредита"));
            Fields.Add( new BbField("CREDIT_CURRENCY", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Валюта кредиту"));
            Fields.Add( new BbField("SINGLE_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Комісія банку разова"));
            Fields.Add( new BbField("MONTHLY_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Комісія банку щомісячна"));
            Fields.Add( new BbField("INTEREST_RATE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Відсоткова ставка"));
            Fields.Add( new BbField("REPAYMENT_METHOD", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Метод погашення"));
            Fields.Add( new BbField("REPAYMENT_DAY", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "День погашення"));
            Fields.Add( new BbField("GARANTEES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Обеспечения"));
            Fields.Add( new BbField("GARANTEES_IDS", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Обеспечения (коды)"));
            Fields.Add( new BbField("MGR_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Ид менеджера"));
            Fields.Add( new BbField("MGR_FIO", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "ФИО менеджера"));
            Fields.Add( new BbField("BRANCH", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Идентификатор отделения"));
            Fields.Add( new BbField("BRANCH_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Наименование отделения"));
            Fields.Add( new BbField("STATES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Состояния"));
            Fields.Add( new BbField("CHECKOUT_DAT", OracleDbType.Date, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Дата начала обработки"));
            Fields.Add( new BbField("CHECKIN_DAT", OracleDbType.Date, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Дата конца обработки"));
            Fields.Add( new BbField("CHECKOUT_USER_ID", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок для визирования (Представление)", "Ид. пользователя обработки"));
    ...
    {
        public VWcsVisaBidsArchiveFilters(BbDataSource Parent) : base (Parent)
        {
    ...
    {
        public VWcsVisaBidsArchive() : base(new BbConnection())
        {
            // base.Connection.RoleName = "WR_WCS";
        }
        public VWcsVisaBidsArchive(BbConnection Connection)
            : base(Connection)
        {
        }
        public override List<VWcsVisaBidsArchiveRecord> Select(VWcsVisaBidsArchiveRecord Item)
        {
            List<VWcsVisaBidsArchiveRecord> res = new List<VWcsVisaBidsArchiveRecord>();
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    res.Add(new VWcsVisaBidsArchiveRecord(
                        this,
