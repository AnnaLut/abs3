    ...
    public class InsRepository : IInsRepository
    {
        ...
        public IEnumerable<CardInsurance> GetCardsInsur(SearchModel par)
        {
            ...
            try
            {
                ...
                cmd.CommandText += " order by wd.state, dw.acc_daos desc";
        ...
        public string CreateDealEWA(ParamsEwa parameters, OracleConnection connection)
        {
            ...
            /*login.email = "bars@unity-bars.com";
            login.password = "6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2";*/
            ...
            try
            {
                ...
                //var docf = JsonConvert.DeserializeXmlNode(jsonReq, "root");
        ...
        public string RemoteLogin(Login register, string method, string func)
        {
            ...
            /*var tmp = header.GetValues("Set-Cookie");
            cookie = tmp[0];*/
        ...
        public string Send(object register, string method, string func)
        {
            ...
            if (register != null)
            {
                ...
                //File.WriteAllBytes("h:\\json.txt", arrStream);
                stream.Close();
            }
            ...
            request.ContentLength = arrStream.Length;
            //var tmp = "XSESSIONID=" + cookie + ";Path=/";
            //for test
            //request.Headers.Add("Cookie", "XSESSIONID=" + cookie);
