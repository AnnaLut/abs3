namespace EasySMPP
{
    ...
    public class StatusCodes
    {
        ...
        public static string ErrorDesc(int code)
        {
            string result = string.Empty;
            switch (code)
            {
                case ESME_ROK: result = "NO ERROR"; break; 
                case ESME_RINVMSGLEN: result = "Message Length is invalid"; break;
                case ESME_RINVCMDLEN: result = "Command Length is invalid"; break;
                case ESME_RINVCMDID: result = "Invalid Command ID"; break;
