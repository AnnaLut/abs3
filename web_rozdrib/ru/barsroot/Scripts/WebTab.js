...
function fnInitTab(name_obj,array_tabs,height_tab,func)
{
  ...
  for (key in array_tabs) {
      ...
      if (array_tabs[key] == 'blank.html') {
          tab_style = "visibility:hidden";
      } else {
          tab_style = "";
      }
      ...
      if(count == 0){
        ...
        inner_ifframe += "<iframe frameBorder='0' id=Tab" + count + " src='" + array_tabs[key] + "' width='100%' height='100%' style='DISPLAY:none;'></iframe>";
          tab_class = "tabDeactive";
      }    

      inner_button += "<td nowrap align='center' class=" + tab_class + " " + funcOnChange + " onclick='goPage(this)' style='" + tab_style + "' id=bTab" + count + "><a href='#' onclick='return false;'>" + key + "</a></td>";
      count++;
    }
