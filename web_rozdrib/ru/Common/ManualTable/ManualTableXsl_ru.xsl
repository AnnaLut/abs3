...
<TD width="100px" title="Код"><xsl:attribute name="onclick"><xsl:text>Sort('ID')</xsl:text></xsl:attribute>
<xsl:text>Код</xsl:text></TD>

<TD width="297px" title="Описание"><xsl:attribute name="onclick"><xsl:text>Sort('NAME')</xsl:text></xsl:attribute>
<xsl:text>Описание</xsl:text></TD>
</TR>
...
<TD align="left" title="Выбрать" style="CURSOR: hand; COLOR: blue; TEXT-DECORATION: underline"><xsl:value-of select="ID" /></TD>
