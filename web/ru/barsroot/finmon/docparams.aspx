        ...
        <asp:Panel ID="pnCharacter" runat="server" GroupingText="Ознака повідомлень:">
            <table>
                <tr>
                    ...
                    <td>
                        <Bars2:BarsTextBox ID="tbKDFM02" runat="server" MaxLength="4" Width="40px" EnabledStyle-HorizontalAlign="Center" OnTextChanged="tbKDFM02_TextChanged" AutoPostBack="false"></Bars2:BarsTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <Bars2:BarsTextBox ID="tbKDFM03" runat="server" MaxLength="3" Width="40px" EnabledStyle-HorizontalAlign="Center" Enabled="false" OnTextChanged="tbKDFM03_TextChanged" AutoPostBack="false"></Bars2:BarsTextBox>
                    </td>
                    <td>
