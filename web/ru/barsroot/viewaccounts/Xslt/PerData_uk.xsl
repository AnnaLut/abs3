...
<!--BDAT=Дата;IR=Ставка індивідуальна;OP=Формула (+,-,*,/);[BR:NAME:ddName]=Базова ставка-->
<xsl:template match="/">
...
<xsl:text>Ставка індивідуальна</xsl:text></TD>
<TD width="10%">
...
<xsl:text>Базова ставка</xsl:text></TD>
</TR>
...
<xsl:attribute name="ondblclick"><xsl:text>perCustomEdit('</xsl:text><xsl:value-of select="$id"/><xsl:text>',</xsl:text><xsl:value-of select="position()"/><xsl:text>)</xsl:text></xsl:attribute>
<TD>
