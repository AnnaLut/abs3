...
function fnLoadFinancial() {
    ...
    var dep = document.getElementById("b_depth").value;
    if (parseInt(dep) < 3 && accessmode != 0 && acc != 0) {//дизейбл если глубина бранча 3 (/300465/300465/300465/) если 1 или 2 то ейбл
        document.all.ddVidBlkD.disabled = false;
        document.all.ddVidBlkK.disabled = false;
    }
    else if (parseInt(dep) == 3) {
        document.all.ddVidBlkD.disabled = true;
        document.all.ddVidBlkK.disabled = true;
    }
