                ...
                <tr>
                    ...
                    <td style="width: 100Px; text-align: center;">
                        <asp:DropDownList ID="Dl_clas" runat="server" BackColor="#FFEBFF" Width="70px" DataTextField="num"
                            DataValueField="num" 
                            DataSource='<%# SQL_SELECT_dataset("select num from conductor where num <=5") %>' 
...
НЕГАТИВНА - прострочка погашення боргу протягом останніх 12 місяців перевищує 60"
                            onselectedindexchanged="Dl_SelectedIndexChanged" AutoPostBack="true" >
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 280Px; text-align: center;">
                        <asp:CheckBox ID="Cb_zkd" runat="server" Checked="false" 
                             oncheckedchanged="Cb_zkd_CheckedChanged" AutoPostBack="True" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 190Px">
                    ...
                    <td style="width: 280Px; text-align: center;">
                        <asp:DropDownList ID="DL_kpz" runat="server" Width="190Px" BackColor="#FFEBFF" DataTextField="name"
                            DataValueField="val" DataSource='<%# SQL_SELECT_dataset("select val, name as name from FIN_QUESTION_REPLY where kod=" + ((char)39).ToString() + "IP2" +((char)39).ToString() + "and idf = 60 ") %>' ToolTip="ВИСОКИЙ - покриття основної суми боргу забезпеченням, що відповідає вимогам НБУ, становить  ≥ 1,3
ДОБРИЙ  - покриття основної суми боргу забезпеченням, що відповідає вимогам НБУ, становить  ≥  1,0
НИЗЬКИЙ - покриття основної суми боргу забезпеченням, що відповідає вимогам НБУ, становить < 1,0, або забезпечення відсутнє"
                         onselectedindexchanged="Dl_SelectedIndexChanged" AutoPostBack="true" >
                        </asp:DropDownList>
                    </td>
                </tr>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 280Px; text-align: center;">
                        ...
                        <asp:Button ID="Bt_tofolders" runat="server" Text="Повернутись"  
                            ToolTip="Повернутись на попередню сторінку" Width="110Px" Height="35Px"
                            CssClass="navigationButton" onclick="Bt_tofolders_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
