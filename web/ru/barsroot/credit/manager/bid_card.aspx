                            ...
                            <table class="dataTable">
                                <colgroup>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="SUBPRODUCT" runat="server" Text='<%# Eval("SUBPRODUCT_NAME") %>' ToolTip='<%# Eval("SUBPRODUCT_ID") %>' Width="200px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="WORKER_BANKTitle" runat="server" Text="Приналежність до працівників :" />
                                        </td>
                                        <td>
                                            <asp:Label ID="WORKER_BANK" runat="server" Text='<%# Bind("WORKER_BANK") %>' />
                                        </td>
                                    </tr>
                                </colgroup>
                            </table>
                    ...
                    <td colspan="2">
                        <asp:Panel ID="pnlCommands" runat="server" GroupingText="Команды" meta:resourcekey="pnlCommandsResource1">
                            <table class="dataTable">
                                ...
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="lbCreateFromFT" runat="server" CommandName="CreateFromFT" Text="Створити заявку з прискореної"></asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
