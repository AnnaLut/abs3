        ...
        <table border="2" cellpadding="5" cellspacing="2" style="width: 515px">
            <tr>
                <td style="font-weight: 700; font-style: italic" class="style6">
                    <asp:Label ID="Label1" runat="server" Text='<%# "Загальний ресурс " + rp_dosr.NLS + " " %>' ></asp:Label>
                    &nbsp;
                </td>
                <td class="style1">
            ...
            <tr>
                <td class="style6">
                    <asp:Label ID="Label4" runat="server" Text='<%# "Вільний ресурс " + rp_dosr.NLS + " " %>'   Style="font-weight: 700;
            ...
            <tr>
                ...
                <td class="style1">
                    <bec:TextBoxDecimal ID="K1" runat="server" IsRequired="True" Enabled='<%# rp_dosr.R2 > 0 %>'
                        Value='<%# (rp_dosr.K1>0)?(rp_dosr.K1):(0) %>' MaxValue='<%# (rp_dosr.K1_MAX>0)?(rp_dosr.K1_MAX):(0) %>'>
                    </bec:TextBoxDecimal>
                </td>
            </tr>
            <tr>
