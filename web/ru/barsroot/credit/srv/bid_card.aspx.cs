...
public partial class credit_srv_bid_card : System.Web.UI.Page
{
    ...
    protected void lbFinish_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(String.Format("/barsroot/credit/srv/bid_set_status.aspx?srv={0}&srvhr={1}&bid_id={2}", Master.SRV, Master.SRV_HIERARCHY, Master.BID_ID));
    }
    # endregion
    ...
    private Boolean Validate(BbConnection con, Decimal? BID_ID)
    {
        ...
        List<VWcsSrvBidTemplatesRecord> lstTemplates = (new VWcsSrvBidTemplates(con)).SelectSrvBidTemplates(Master.SRV, BID_ID, "SRV_" + Master.SRV_HIERARCHY);
