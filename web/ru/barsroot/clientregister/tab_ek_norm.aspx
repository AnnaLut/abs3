...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="JScriptFortab_ek_norm.js?v=<%= barsroot.ServicesClass.GetVersionWeb() %>.014"></script>
</head>
<body>
            ...
            <td style="font-size: 10pt; font-family: Arial">
                <table id="tb_ek_norm" style="font-size: 10pt; font-family: Arial" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td height="1">
                            <select class="tab_ek_norm_ed2_style" id="ddl_ISE_com" onclick="GetHelpValue(getEl('ed_ISE'), getEl('ddl_ISE_com'), 'V_ISE');ToDoOnChange();"
                                runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="tab_ek_norm_ed2_style" id="ddl_K050_com" onclick="GetHelpValue(getEl('ed_K050'), getEl('ddl_K050_com'), 'SP_K050');ToDoOnChange();/*CalcSedValueByK050(getEl('ed_K050').value);*/">
                                <option selected="selected"></option>
                            </select>
                        </td>
                    </tr>
