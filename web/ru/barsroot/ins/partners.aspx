                                            ...
                                            <tr>
                                                ...
                                                <td class="stl2">
                                                    <bars:TextBoxString ID="NAME" runat="server" Value='<%# Bind("NAME") %>' IsRequired="true"
                                                        Width="200px" ValidationGroup="Partner" TabIndex="101" MaxLength="300" />
                                                </td>
                                                <td class="stl1">
                                                    <asp:Label ID="ACTIVETitle" runat="server" Text="Активно: " />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="stl2">
                                                    <bars:TextBoxString ID="AGR_NO" runat="server" Value='<%# Bind("AGR_NO") %>' IsRequired="false"
                                                        ValidationGroup="Partner" TabIndex="111" MaxLength="100" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="stl1">
                    ...
                    <div class="template_container">
                        <table id="tblPartners" border="0" cellpadding="3" cellspacing="0" class="data_table">
                            <tr>
                                ...
                                <td class="stl2">
                                    <bars:TextBoxString ID="NAME" runat="server" Value='<%# Bind("NAME") %>' IsRequired="true"
                                        Width="200px" ValidationGroup="Partner" TabIndex="301" MaxLength="300" />
                                </td>
                                <td class="stl1">
                                    <asp:Label ID="ACTIVETitle" runat="server" Text="Активно: " />
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="stl2">
                                    <bars:TextBoxString ID="AGR_NO" runat="server" Value='<%# Bind("AGR_NO") %>' IsRequired="false"
                                        ValidationGroup="Partner" TabIndex="311" MaxLength="100" />
                                </td>
                            </tr>
                            <tr>
                                <td class="stl1">
