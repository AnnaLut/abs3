  ...
  <xsl:template match="Statement">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <meta name="Author" content="Дьомін Олександр Володимирович" />
        <meta name="Copyright" content="Перше Всеукраїнське Бюро Кредитних Історій" />
      ...
      <body>
        ...
        <xsl:if test="Subject">
          <fieldset id="SubjectEntityGroup">
            <legend style="background-color: #FFFFFF;">
              ...
              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
              <label><xsl:value-of select="$davEntity/Vocabulary/Statement[code = current()/Subject/entity]/valueUA"/></label>
            </legend>
                  ...
                  <tr>
                    ...
                    <td rowspan="3" colspan="2" style="background-color: #E0E0AD; border-top-style: solid; border-bottom-style: solid; border-width: 1px; border-color: #000000;">
                      <table style="width: 100%; font-size: 10pt;">
                        <tbody style="background-color: #FFFFFF;">
                          <tr>
                            <td style="width: 25%; background-color: #E0E0AD;">Дата народження</td>
                          ...
                          <tr>
                            <td style="width: 25%; background-color: #E0E0AD;">Стать</td>
                            <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                              <xsl:value-of select="Subject/gender"/>
                            </td>
                            <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                              <xsl:value-of select="$davGender/CreditInfo/Dictionary[code = current()/Subject/gender]/valueUA"/>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <xsl:if test="typeId = 2">
                    <tr>
                      ...
                      <td colspan="4" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davIdentificationType/CreditInfo/Dictionary[code = current()/typeId]/valueUA"/>
                      </td>
                    </tr>
                  </xsl:if>
                  <!--Составной Ключ-->
              ...
              <tbody style="background-color: #FFFFFF;">
                <xsl:for-each select="Communication">
                  <tr>
                    ...
                    <td colspan="4" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                      <xsl:value-of select="$davCommunicationType/CreditInfo/Dictionary[code = current()/typeId]/valueUA"/>
                    </td>
                  </tr>
                </xsl:for-each>
              </tbody>
        ...
        <xsl:if test="Address">
          <fieldset id="SubjectAddressGroup">
                ...
                <xsl:attribute name="onclick">if (document.getElementById('SubjectAddress').style.display == 'none')
                                              {
                                                  ...
                                                  this.innerHTML = '[+]';
                                                  this.style.color = '#008000';
                                                  document.getElementById('SubjectAddressGroup').style.backgroundColor = '#ADE0E0';
                                              }</xsl:attribute>
                (-)
              </label>
              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
            ...
            <table id="SubjectAddress" style="width: 100%; font-size: 10pt; background-color: #ADE0E0;">
              <tbody style="background-color: #FFFFFF;">
                <xsl:for-each select="Address">
                  <tr>
                    <td style="background-color: #BDF0F0;">
                      Індекс
                    </td>
                    ...
                    <td colspan="2" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                      <xsl:value-of select="$davAddressType/CreditInfo/Dictionary[code = current()/typeId]/valueUA"/>
                    </td>
                    <td style="background-color: #BDF0F0;">
                      Місцезнаходження
                    </td>
        ...
        <xsl:if test="Subject">
          <fieldset id="SubjectClassificationGroup">
            <legend style="background-color: #FFFFFF;">
              ...
              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
              <label>Класифікація Суб'єкта</label>
            </legend>
                ...
                <tbody style="background-color: #FFFFFF;">
                  <xsl:if test="Subject/entity = 'individual'">
                    <tr>
                      ...
                      <td colspan="4" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davClassification/CreditInfo/Dictionary[code = current()/Subject/classification]/valueUA"/>
                      </td>
                    </tr>
                    <tr>
                      <td style="background-color: #F0F0BD;">
                      ...
                      <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davResidency/CreditInfo/Dictionary[code = current()/Subject/residency]/valueUA"/>
                      </td>
                      <td style="background-color: #F0F0BD;">
                        Громадянство
                      </td>
                    ...
                    <tr>
                      ...
                      <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davEducation/CreditInfo/Dictionary[code = current()/Subject/education]/valueUA"/>
                      </td>
                      <td style="background-color: #F0F0BD;">
                        Сімейний стан
                      </td>
                      ...
                      <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davMaritalStatus/CreditInfo/Dictionary[code = current()/Subject/maritalStatus]/valueUA"/>
                      </td>
                    </tr>
                    <tr>
                      <td style="background-color: #F0F0BD;">
                      ...
                      <td colspan="4" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davNegativeState/CreditInfo/Dictionary[code = current()/Subject/negativeStatus]/valueUA"/>
                      </td>
                    </tr>
                  </xsl:if>
                  <xsl:if test="Subject/entity = 'company'">
                    <tr>
                      ...
                      <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davStatus/CreditInfo/Dictionary[code = current()/Subject/statusId]/valueUA"/>
                      </td>
                      <td style="background-color: #F0F0BD;">
                        Форма власності
                      </td>
                      ...
                      <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davOwnership/CreditInfo/Dictionary[code = current()/Subject/ownership]/valueUA"/>
                      </td>
                    </tr>
                    <tr>
                      <td style="background-color: #F0F0BD;">
                      ...
                      <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davEmployeeCount/CreditInfo/Dictionary[code = current()/Subject/employeeCount]/valueUA"/>
                      </td>
                      <td style="background-color: #F0F0BD;">
                        Сектор економіки
                      </td>
                      ...
                      <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davEconomicActivity/CreditInfo/Dictionary[code = current()/Subject/economicActivity]/valueUA"/>
                      </td>
                    </tr>
                  </xsl:if>
                </tbody>
                ...
                <xsl:attribute name="onclick">if (document.getElementById('FinancialSummary').style.display == 'none')
                                              {
                                                  ...
                                                  this.innerHTML = '[+]';
                                                  this.style.color = '#008000';
                                                  document.getElementById('FinancialSummaryGroup').style.backgroundColor = '#88BB88';
                                              }</xsl:attribute>
                (-)
              </label>
              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
              <label>Зведена Фінансова Інформація</label>
            </legend>
            <div id="FinancialSummary" style="width: 100%;">
              <xsl:for-each select="$davCatGroupHead/Group/Head">
                ...
                <div style="width: 33.32%; float: left;">
                  <table border="0" style="width: 100%; font-size: 10pt; background-color: #88BB88;">
                    <thead style="background-color: #AADDAA;">
                      <tr>
                        <th colspan="2">
                          <xsl:value-of select="textUA"/>
                        </th>
                        <th>
                          кіл
                        </th>
                          ...
                          <xsl:choose>
                            <xsl:when test="string(number(amount)) != 'NaN'">
                              ...
                              <xsl:choose>
                                ...
                                <xsl:otherwise>
                                  <td style="width: 10%; background-color: #AADDAA;">
                                    <xsl:value-of select="count"/>
                                  </td>
                                </xsl:otherwise>
                              </xsl:choose>
                                ...
                                <xsl:when test="$cat = 'phaseId' or $cat = 'roleId'">
                                  ...
                                  <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                                    <xsl:if test="$cat = 'phaseId'">
                                      <xsl:value-of select="$davPhase/CreditInfo/Dictionary[code = current()/value]/valueUA"/>
                                    </xsl:if>
                                    <xsl:if test="$cat = 'roleId'">
                                      <xsl:value-of select="$davRole/CreditInfo/Dictionary[code = current()/value]/valueUA"/>
                                    </xsl:if>
                                  </td>
                                  <td style="width: 10%; text-align: center; border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                                    <xsl:value-of select="count"/>
                            ...
                            <xsl:otherwise>
                              <td colspan="2" style="background-color: #AADDAA;">
                                Кількість
                              </td>
                              <td style="width: 10%; text-align: center; border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                                <xsl:value-of select="count"/>
        ...
        <xsl:for-each select="Contract">
          ...
          <fieldset>
            ...
            <legend style="background-color: #FFFFFF;">
              ...
              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
              <span>
                <xsl:value-of select="$davContractType/Vocabulary/Statement[code = current()/type]/valueUA"/>
              </span>
            </legend>
            <div style="width: 100%;">
              <xsl:attribute name="id">Contract<xsl:value-of select="$curcid"/></xsl:attribute>
              <table style="width: 100%; font-size: 10pt; background-color: #BDF0BD;">
                <tbody style="background-color: #FFFFFF;">
                  <tr>
                  ...
                  <tr>
                    <td colspan="1" style="background-color: #DDFFDD;">
                      Роль суб'єкта
                    </td>
                    ...
                    <td colspan="2" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                      <xsl:value-of select="$davRole/CreditInfo/Dictionary[code = current()/roleId]/valueUA"/>
                    </td>
                  ...
                  <tr>
                    ...
                    <td colspan="2" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                      <xsl:value-of select="$davCreditPurpose/CreditInfo/Dictionary[code = current()/creditPurpose]/valueUA"/>
                    </td>
                    <td colspan="2" style="background-color: #DDFFDD;">
                      Дата початку дії угоди
                    </td>
                    <td colspan="2" style="text-align: center; border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                  ...
                  <tr>
                    ...
                    <td colspan="2" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                      <xsl:value-of select="$davNegativeStatus/CreditInfo/Dictionary[code = current()/negativeStatus]/valueUA"/>
                    </td>
                    <td colspan="2" style="background-color: #DDFFDD;">
                  ...
                  <tr>
                    ...
                    <td colspan="2" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                      <xsl:value-of select="$davPhase/CreditInfo/Dictionary[code = current()/phaseId]/valueUA"/>
                    </td>
                    <td colspan="2" style="background-color: #DDFFDD;">
                ...
                <tbody style="background-color: #FFFFFF;">
                  <xsl:if test="paymentPeriodId">
                    <tr>
                      ...
                      <td colspan="3" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davPaymentPeriod/CreditInfo/Dictionary[code = current()/paymentPeriodId]/valueUA"/>
                      </td>
                      <!--xsl:value-of select="paymentMethodId"/-->
                      <!--xsl:value-of select="$davPaymentMethod/CreditInfo/Dictionary[code = current()/paymentMethodId]/valueUA"/-->
                    </tr>
                  </xsl:if>
                  <tr>
                    <td style="background-color: #DDFFDD;">
                      Повна кількість періодів угоди
                    </td>
                    <td style="text-align: center; border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                  ...
                  <tr>
                    <td style="background-color: #DDFFDD;">
                      Кількість періодів до завершення
                    </td>
                    <td style="text-align: center; border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                    ...
                    <td style="background-color: #BDF0BD;"></td>
                  </tr>
                  <tr>
                    <td style="background-color: #BDF0BD;"></td>
                    <td style="background-color: #BDF0BD;"></td>
                    <td style="background-color: #DDFFDD;">
                      Сума сплати у наступному періоді
                    </td>
                    <td style="text-align: right; border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                ...
                <tbody style="background-color: #FFFFFF;">
                  <xsl:for-each select="../Collateral[contractid = $curcid]">
                    <tr>
                      ...
                      <td style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                        <xsl:value-of select="$davCollateralType/CreditInfo/Dictionary[code = current()/typeId]/valueUA"/>
                      </td>
                    ...
                    <xsl:if test="identification-typeId">
                      ...
                      <xsl:if test="identification-typeId = 2">
                        <tr>
                          ...
                          <td colspan="4" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                            <xsl:value-of select="$davIdentificationType/CreditInfo/Dictionary[code = current()/identification-typeId]/valueUA"/>
                          </td>
                        </tr>
                      </xsl:if>
                    ...
                    <xsl:if test="address-typeId">
                      <tr>
                        ...
                        <td colspan="2" style="border-bottom-style: solid; border-right-style: solid; border-width: 1px; border-color: #000000;">
                          <xsl:value-of select="$davAddressType/CreditInfo/Dictionary[code = current()/address-typeId]/valueUA"/>
                        </td>
                        <td style="background-color: #FFCC33;">
                          Місцезнаходження
                        </td>
                ...
                <thead style="font-size: 8pt; background-color: #DDDDDD; color: #333333;">
                  <tr>
                    <th colspan="9" style="border-left-style: dotted; border-top-style: dotted; border-right-style: dotted; border-width: 1px; border-color: #000000;">
                      <label>
                        Історичний календар платежів за весь термін дії угоди
                      </label>
                      <!--xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text-->
                  ...
                  <xsl:for-each select="../Record[contractid = $curcid]">
                    ...
                    <tr>
                      ...
                      <td style="text-align: center; border-bottom-style: dotted; border-bottom-width: 1px; border-bottom-color: #C0C0C0;">
                        ...
                        <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                        <xsl:value-of select="$davCreditUsage/CreditInfo/Dictionary[code = current()/creditUsage]/valueUA"/>
                      </td>
        ...
        <xsl:if test="Event">
          <fieldset id="SubjectEventsGroup">
            <legend style="background-color: #FFFFFF;">
              ...
              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
              <label>Реєстр Запитів та Передачі інформації суб'єкту</label>
            </legend>
                    ...
                    <td style="text-align: center;">
                      <xsl:choose>
                        <xsl:when test="event = 'request'">
                          Запит інформації про суб'єкта або Отримання звіту по суб'єкту
                        </xsl:when>
                        <xsl:otherwise>
                          <xsl:value-of select="$davContractType/Vocabulary/Statement[code = current()/event]/valueUA"/>
                        </xsl:otherwise>
                      </xsl:choose>
                    </td>
                  </tr>
