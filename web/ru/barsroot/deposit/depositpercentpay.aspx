...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body bgProperties="fixed" onload="focusControl('textSum_t');">
				...
				<tr>
					<td>
						<table class="InnerTable" id="ContractTable">
								...
								<td colSpan="3">
									<table id="tbPayAcc" runat="server" class="InnerTable">
										...
										<tr>
											...
											<td width="25%">
												<asp:textbox id="textNLS" meta:resourcekey="textNLS" runat="server" ToolTip="Номер счета" MaxLength="14" CssClass="InfoText"
							...
							<tr>
								<td colSpan="3">
									<input id="btPay" meta:resourcekey="btPay" type="button" value="Выплата" runat="server" tabIndex="6" class="AcceptButton"></td>
							</tr>
							<tr>
								<td colSpan="3">
