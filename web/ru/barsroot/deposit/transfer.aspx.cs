...
public partial class Transfer : Bars.BarsPage
{
    ...
    private void FillControls(bool complete)
    {
        ...
        try
        {
            ...
            #endregion
            _dbLogger.Info("KV.Value = " + KV.Value, "deposit");
    ...
    {
        _dbLogger.Info("Користувач натиснув кнопку \"Закрити договір\"  №" + DPT_ID.Value + " на сторінці Виплата коштів з поточного рахунку.", "deposit");
    ...
    protected void gvBankMetals_DataBound(object sender, EventArgs e)
    {
        ...
        _dbLogger.Info("METAL=" + METAL.Value);
    }
