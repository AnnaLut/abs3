...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function AfterPageLoad()
        {
            ...
            if (document.getElementById('RBDepoPayWay_OUT')==null || !document.getElementById('RBDepoPayWay_OUT').checked) 
            {
            ...
            if (document.getElementById('rbPercentWay_OUT') == null || !document.getElementById('rbPercentWay_OUT').checked) {
                    ...
                    <tr>
                        <td>
                            <table id="tbInt" class="InnerTable">
                                <tr>
                                    <td colspan="5">
                                        <asp:Label ID="lbPercentInfo" Text="Виплата відсотків" 
                                            meta:resourcekey="lbPercentInfo" runat="server" CssClass="InfoLabel" />
                                    </td>
                                </tr>
                                <tr>
                                 <td style="width: 25%">
                                    <asp:RadioButton ID="rbPercentWay_BPK" Text="&nbsp; Виплата %% на картковий рахунок" Checked=true
                                        OnCheckedChanged="rbPercentWay_CheckedChanged" AutoPostBack="true" runat="server"
                                        GroupName="PercentPayWay" />
                                </td>
                                </tr>
                                <tr>
                                 <td style="width: 25%">
                                    <asp:RadioButton ID="rbPercentWay_BankACC" Text="&nbsp; Виплата %% на інший рахунок банку"
                                        OnCheckedChanged="rbPercentWay_CheckedChanged" AutoPostBack="true" runat="server"
                                        GroupName="PercentPayWay" />
                                </td>
                                </tr>
                                <tr>
                                 <td style="width: 25%">
                                    <asp:RadioButton ID="rbPercentWay_OUT" Text="&nbsp; Виплата %% на рахунок іншого банку" Checked = false
                                        OnCheckedChanged="rbPercentWay_CheckedChanged" AutoPostBack="true" runat="server"
                                        GroupName="PercentPayWay" />
                                </td>
                                </tr>                                
                    ...
                    <tr>
                        <td>
                            <table id="tbRest" class="InnerTable">
                                <tr>
                                    <td colspan="5">
                                        <asp:Label ID="lbRestInfo" meta:resourcekey="lbRestInfo" CssClass="InfoLabel" 
                                            runat="server" Text="Возврат депозита"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                 <td style="width: 25%">
                                    <asp:RadioButton ID="RBDepoPayWay_BPK" Text="&nbsp; Виплата вкладу на картковий рахунок" Checked = true
                                        OnCheckedChanged="rbDepoWay_CheckedChanged" AutoPostBack="true" runat="server"
                                        GroupName="DepoPayWay" />
                                </td>
                                </tr>
                                <tr>
                                 <td style="width: 25%">
                                    <asp:RadioButton ID="RBDepoPayWay_BankACC" Text="&nbsp; Виплата вкладу на інший рахунок банку"
                                        OnCheckedChanged="rbDepoWay_CheckedChanged" AutoPostBack="true" runat="server"
                                        GroupName="DepoPayWay" />
                                </td>
                                </tr>
                                <tr>
                                 <td style="width: 25%">
                                    <asp:RadioButton ID="RBDepoPayWay_OUT" Text="&nbsp; Виплата вкладу на рахунок іншого банку" Checked = false
                                        OnCheckedChanged="rbDepoWay_CheckedChanged" AutoPostBack="true" runat="server"
                                        GroupName="DepoPayWay" />
                                    </td>
                                </tr>
                            ...
                            <table class="InnerTable">
                                <tr>
                                    ...
                                    <td align="right" style="width:50%">
                                        <asp:Button ID="btnBack" Text="До картки вкладу" runat="server" CausesValidation="false" 
