...
public partial class DepositSelectTrustee : Bars.BarsPage
{
    ...
    public DepositSelectTrustee()
    {
        _dbLogger = DbLoggerConstruct.NewDbLogger();
    }

    protected DataSet dsTrustee;
    ...
    private void btOwner_ServerClick(object sender, System.EventArgs e)
    {
        ...
        _dbLogger.Info("Пользователь выбрал владельца вклада для осуществления операции. Депозитный договор №" + 
            dpt_id,"deposit");
    ...
    private void btTrustee_ServerClick(object sender, System.EventArgs e)
    {
        ...
        _dbLogger.Info("Пользователь выбрал доверенное лицо РНК=" + Convert.ToString(rnk.Value)
