...
public partial class docinput_editprops : BarsPage
{
    ...
    private void FillData()
    {
        ...
        string sql =
            "select o.ref, o.tt, o.userid, o.nlsa, o.s, v1.lcv lcv_a, o.vdat, o.s2, v2.lcv lcv_b ,o.mfob, o.nlsb, o.dk, o.sk, o.datd from oper o, tabval$global v1, tabval$global v2 where o.kv=v1.kv AND o.kv2=v2.kv and o.branch LIKE SYS_CONTEXT ('bars_context','user_branch_mask') AND o.pdat >= :pdat {0}";
        ...
        if (string.IsNullOrEmpty(pDat))
            if (Request["ref"] != null)
            {
                pDat = DateTime.Now.AddDays(-10000).ToString("dd/MM/yyyy");
            }
            else
            {
        ...
        {
            sdsProps.SelectCommand = sdsProps.SelectCommand.Replace(":REF", Request["ref"].ToString());
            sdsDocs.SelectCommand = string.Format(sql, " and o.ref=" + Request["ref"]);
