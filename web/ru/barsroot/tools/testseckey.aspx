...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function barsAppletDemo() {
            ...
            options.ModuleType = barsSign.ModuleTypes.Node;//(document.getElementById("rbAx").checked) ? (barsSign.ModuleTypes.AX) : (barsSign.ModuleTypes.JAVA);
            alert(options.ModuleType);
            // инициализация
        ...
        function InitSign() {
            ...
            options.KeyId = document.getElementById("hKeyId").value;
            options.BankDate = document.getElementById("hBankDate").value;
            options.ModuleType = (document.getElementById("rbAx").checked) ? (barsSign.ModuleTypes.AX) : (barsSign.ModuleTypes.Node);
...
<body>
    <form id="formTestSec" runat="server">
        ...
        <fieldset>
            ...
            <input id="rbNode" type="radio" name="rbModeType" checked="checked" />
            <label for="rbNode">Node</label>
            <br />    
