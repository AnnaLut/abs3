...
<%@ Page Language="c#" CodeFile="AddRegular.aspx.cs" AutoEventWireup="true" Inherits="AddRegular" %>
                    ...
                    <tr>
                        <td class="style4">
                            <asp:Label ID="lbDUInfo" meta:resourcekey="lbDUInfo" CssClass="InfoLabel"
                                runat="server" Height="20px">Кредити - погашення заборгованості з карткового рахунку (регулярні платежі)"</asp:Label>
                        </td>
                    </tr>
            </td>
            <tr>
                ...
                <table id="tbTerm" runat="server" class="InnerTable">
                  <tr>
                       <td class="style2"> 
                         <asp:Label ID="lbClientInfo" meta:resourcekey="lbClientInfo2" CssClass="InfoText" runat="server">Клієнт</asp:Label>
                       </td>
                       <td class="style3">
                         <asp:TextBox ID="textClientName" runat="server" CssClasts="InfoText" 
                               ReadOnly="True" BackColor="White" Width="568px" Height="24px"></asp:TextBox>
                                        <asp:Button ID="btFind" Height="24px" runat="server" Text="Пошук" 
                  ...
                  <tr>
                   ...
                   <td class="style3">
                     <asp:TextBox ID="textBankMFO" meta:resourcekey="textMFO" runat="server" 
                           ...
                           ToolTip="МФО банка" TabIndex="1" BackColor="WhiteSmoke" 
                  ...
                  <tr>
                   <td class="style2" dir="rtl">
                     <asp:Label ID="lbIntRcpName" meta:resourcekey="lbNMK2" runat="server" 
                           CssClass="InfoText" ForeColor="#999999" Font-Size="Small">Назва клієнта-платника</asp:Label>
                   </td>
                   <td class="style3">
                      <asp:TextBox ID="textIntRcpName" meta:resourcekey="textNMK" runat="server" 
                           CssClass="InfoText"  readonly="true" BackColor="WhiteSmoke"
                                        BorderStyle="Inset" MaxLength="35" 
                           ToolTip="     Назва клієнта-платника" TabIndex="4" ForeColor="#999999"></asp:TextBox>
                   </td>
                  </tr>
                  <tr>
                   <td class="style2" dir="rtl">
                    <asp:Label ID="lbIntRcpOKPO" meta:resourcekey="lbIntRcpOKPO" runat="server" 
                           CssClass="InfoText" ForeColor="#999999" Font-Size="Small">Код ЄДРПОУ платника</asp:Label>
                   </td>
                   <td class="style3">
                   <asp:TextBox ID="textIntRcpOKPO" meta:resourcekey="textIntRcpOKPO" runat="server" 
                           readonly="true" enable="false" BackColor="WhiteSmoke"
                                            CssClass="InfoText" BorderStyle="Inset" MaxLength="10" 
                           ToolTip="     Код ОКПО" TabIndex="3" ForeColor="#999999"></asp:TextBox>
                   </td>
                  </tr>
                    <tr>
                       <td class="style2" dir="rtl"> 
                         <asp:Label ID="lbAccountDPTNLS" meta:resourcekey="lbAccountDPTNLS" runat="server" 
                               CssClass="InfoText" ForeColor="#999999" Font-Size="Small">Рахунок договора (Рахунок отримувача)</asp:Label>
                       </td>
                       <td class="style3">
                         <asp:TextBox ID="textDPTAccount" runat="server" BorderStyle="Inset" 
                               readonly = "true" CssClass="InfoText" MaxLength="14" meta:resourcekey="textNLS" 
                               BackColor="WhiteSmoke" ToolTip="Номер счета" ForeColor="#999999"></asp:TextBox>
                       </td>
                     </tr>  
                   </tr>
                   <tr>
                    ...
                    <tr>
                       <td class="style2" dir="rtl"> 
                         <asp:Label ID="lbNazn" meta:resourcekey="lbNazn" runat="server" 
                               CssClass="InfoText" ForeColor="#999999" Font-Size="Small">Призначення платежу</asp:Label>
                       </td>
                       <td class="style3">
                    ...
                    <tr>
                        ...
                        <td class="style6">
                            <asp:TextBox ID="StartDate" runat="server" 
                                WeekendDayStyle-BackColor="lightgreen" CssClass="InfoDateSum" ReadOnly="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style5">
                        ...
                        <td class="style6">
                            <asp:TextBox ID="EndDate" runat="server" CssClass="InfoDateSum" 
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width:15%" height="13">
                                        <asp:Button id="btReg" meta:resourcekey="btReg" type="button" 
                                            ...
                                            tabindex="0" class="AcceptButton" onclick = "btnReg_ServerClick" 
                                            Width="559px"/>
                                        <asp:Button ID="btPrint" runat="server" Text="Печать" onclick="btPrint_Click" />
                                    </td>                                    
                                </tr>
                            </table>
                        </td>                        
