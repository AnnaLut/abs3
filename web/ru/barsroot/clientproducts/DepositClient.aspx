...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript" src="js/action.js?v1.34"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function AfterPageLoad() {
            ...
            if (document.getElementById('textClientTerritoryReal'))
                document.getElementById('textClientTerritoryReal').readOnly = true;
            ...
            <tr>
                <td>
                    <table class="InnerTable">
                        <tr>
                            <td colspan="6">
                                <input id="btSearch" meta:resourcekey="btSearch3" onclick="openDialog(this.form)"
                                 ...
                                 <asp:Button ID="btRegister" meta:resourcekey="btRegister" runat="server" Text="Реєструвати нового" CssClass="DirectionButton"  visible="false" TabIndex="10" CausesValidation="false" />                
                            </td>
                        </tr>
                        <tr>
                            <td width="3%">
                            ...
                            <td width="35%">
                                <input id="textClientName" readonly="readonly" type="text" maxlength="70" runat="server"
                                    title="ФИО" class="InfoText" style="background-color: White" />
                            </td>
                            <td width="3%"></td>                            
                            <td width="17%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="textClientAddressFull" runat="server" CssClass="InfoText"
                                    TabIndex="14" ReadOnly="True" BackColor="White" Visible="false" />
                            </td>
                            <td></td>                           
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lbVClientRnk" runat="server" ForeColor="Red" CssClass="InfoText">*</asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lbClientRnk" meta:resourcekey="lbClientRnk" runat="server" CssClass="InfoText">RNK</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="textClientRnk" meta:resourcekey="textClientRnk" runat="server" Enabled="false"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="textCellPhone" meta:resourcekey="textCellPhone" runat="server" MaxLength="15"
                                    TabIndex="40" ToolTip="Мобільний телефон клієнта" CssClass="InfoText40" onchange = "RepeatCellNumbers();"/>
                            </td>
                            <td></td>                                                   
                            <td>
                    ...
                    <table class="InnerTable">                      
                        <tr>
                            <td style="width: 20%">
                                ...
                                <input id="userFIO" type="hidden" runat="server" />                            </td>   
                            <td></td>
                            <td style="width: 20%" colspan="2" align="center">
                                <ead:EADoc ID="eadFinmonQuestionnaire1" runat="server" EAStructID="401" Visible="true"
                                            TitleText="Опитувальний лист ФМ"  Enabled ="true"
                                            OnBeforePrint="eadFinmonQuestionnaire1_BeforePrint"
                                            OnDocSigned="eadFinmonQuestionnaire1_DocSigned" />
                            </td>                
                               <td align="center" width="20%">
                                <asp:Button ID="btCreateRequest" meta:resourcekey="btCreateRequest" runat="server" Visible="false"
                                    Text="Запит на БЕК-офіс" CausesValidation="False" CssClass="AcceptButton" Width="200"/>
                            </td>                                 
                        </tr>
                        <tr>
                            <td align="center" style="width: 20%">
                                <asp:Button ID="btnClear" meta:resourcekey="btnClear" runat="server" Text="Очистить" Enabled ="false"
                                    CausesValidation="False" TabIndex="103" CssClass="AcceptButton" />
                            </td>
                            <td align="center" style="width: 20%">
                                <input ID="btSubmit" runat="server" type="submit" value="Далее" tabindex="101" disabled="disabled"   />
                            </td>
                            <td align="center" width="20%">
                                <asp:Button ID="btUpdate" meta:resourcekey="btUpdate" runat="server" Text="Регистрировать"
                                    Visible="False" TabIndex="100" CssClass="AcceptButton" />
                            </td>
                            <td align="center" width="20%">
                            ...
                            <td align="center" width="20%">
                                <asp:Button ID="btContracts" meta:resourcekey="btContracts" runat="server" Visible="false"
                                    Text="Портфель договорів" CausesValidation="False" CssClass="AcceptButton" Width="200" />
                            </td>
                        </tr>
                    </table>
                </td>
