...
public partial class DptClientSearch : Bars.BarsPage
{
	...
	{
		_dbLogger.Info("Пользователь выполнил поиск клиента на странице поиска", "deposit");
    ...
    private void btClientCard_Click(object sender, System.EventArgs e)
    {
        ...
        _dbLogger.Info("Користувач натиснув кнопку \"Картка Клієнта\" на сторінці пошук клієнта.", "deposit");
    ...
    protected void btSearchByBPK_ClientIdentified(object sender, Bars.UserControls.ClientIdentifiedEventArgs e)
    {
        ...
        _dbLogger.Info("Користувач здійснив ідентифікацію клієнта (rnk=" + Convert.ToString(e.RNK) +
