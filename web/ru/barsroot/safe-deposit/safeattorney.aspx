...
<head runat="server">
    ...
    <script type="text/javascript" src="js/JScript.js?v.1.5"></script>
                                ...
                                <tr>
                                    ...
                                    <td style="width:1%">
                                        <cc1:ImageTextButton ID="btPrint" runat="server" ButtonStyle="Image" ImageUrl="/Common\Images\default\16\visa.png"
                                            OnClick="btPrint_Click" TabIndex="6" ToolTip="Печать" EnabledAfter="0" meta:resourcekey="btPrintResource" />
                                    </td>
                                    <td style="width:1%">
                    ...
                    <tr>
                        <td colspan="5">
                            <Bars:BarsGridViewEx ID="gridSafeDepositAttorney" style='width:100%; cursor:hand' runat="server" 
                                ...
                                <Columns>
                                    <asp:BoundField DataField="ND" SortExpression="ND" HeaderText="№ сейфа"></asp:BoundField>
                                    <asp:BoundField DataField="NMK" SortExpression="NMK" HeaderText="ПІБ"></asp:BoundField>
                                    <asp:BoundField DataField="OKPO" SortExpression="OKPO" HeaderText="ІНН"></asp:BoundField>
                                    <asp:BoundField DataField="NUMDOC" SortExpression="NUMDOC" HeaderText="Серія та номер паспорту"></asp:BoundField>
