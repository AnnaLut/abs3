                            ...
                            <td>
                                <bars:barsgridview id="gridDocs" runat="server" cssclass="BaseGrid" datasourceid="dsDeals"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ADDS" HeaderText="№ дод. угоди" SortExpression="ADDS" meta:resourcekey="BoundFieldResource4" />
                                        <asp:BoundField DataField="VERSION" HeaderText="Версія" SortExpression="VERSION" meta:resourcekey="BoundFieldResource5" />
                                        <asp:BoundField DataField="STATE" HeaderText="Підписан" SortExpression="STATE" meta:resourcekey="BoundFieldResource6" />
                                        <asp:BoundField DataField="FIO" HeaderText="Виконавець" SortExpression="FIO" meta:resourcekey="BoundFieldResource7" />
                                        <asp:BoundField DataField="COMM" HeaderText="Коментар" SortExpression="COMM" meta:resourcekey="BoundFieldResource8" />
                                    </Columns>
                                </bars:barsgridview>
                            </td>
                        </tr>
