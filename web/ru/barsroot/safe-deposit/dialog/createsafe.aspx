            ...
            <tr>
                ...
                <td style="width:40%">
                    <asp:RequiredFieldValidator ID="vSafeId" runat="server" ControlToValidate="SAFE_ID"
                        CssClass="Validator" ErrorMessage="необхідно заповнити" SetFocusOnError="True" meta:resourcekey="vSafeIdResource1"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="vType" runat="server" ControlToValidate="listSafeSize"
                        CssClass="Validator" ErrorMessage="необхідно заповнити" SetFocusOnError="True" meta:resourcekey="vTypeResource1"></asp:RequiredFieldValidator></td>
            </tr>            
            <tr>
                <td>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="vNLS" runat="server" ControlToValidate="NLS" CssClass="Validator"
                        ErrorMessage="необхідно заповнити" SetFocusOnError="True" meta:resourcekey="vNLSResource1"></asp:RequiredFieldValidator></td>
            </tr>            
            <tr>
