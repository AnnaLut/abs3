...
public class Client : System.Object
{
    ...
    public void Clear()
    {
        ...
        TerritoryReal = decimal.MinValue;
        SpecialMarks = null;
    }
    ...
    public override bool Equals(object obj)
    {
        return (
            ...
            this.TerritoryReal == ((Client)obj).TerritoryReal &&
    ...
    public void ReadFromDatabase()
    {
        ...
        try
        {
            _dbLogger.Debug("Пользователь начал читать из базы информацию о клиенте с регистрационным номером rnk=" + this.ID.ToString(),
                "deposit");
            ...
            while (rdr.Read())
            {
                ...
                // код території real
                if (!rdr.IsDBNull(31))
                    this.TerritoryReal = rdr.GetOracleDecimal(31).Value;
            }
            ...
            _dbLogger.Debug("Користувач отримав з БД дані клієнта з РНК=" + this.ID.ToString(), "deposit");
        }
        finally
        {
    ...
    public decimal CheckBeforeWriteToDatabase()
    {
        ...
        try
        {
            _dbLogger.Debug("Ищем существующего клиента по ОКПО, серии и номеру паспорта (ОКПО ="
               + this.Code, "deposit");
            ...
            _dbLogger.Info(Convert.ToString(this.ID));
            ...
            _dbLogger.Debug("Клиент с ОКПО = " + this.Code + " уже существует. Регистрационный номер клиента rnk=" + this.ID.ToString(), "deposit");
            return this.ID;
        }
        finally
        {
    ...
    public void WriteToDatabase()
    {
        ...
        try
        {
            _dbLogger.Debug("!-!Пользователь начал запись в базу информацию о клиенте с ОКПО ="
                + this.Code, "deposit");
            ...
            if (TerritoryReal != decimal.MinValue)
                cmdSearchCustomer.Parameters.Add("p_resid_territory  ", OracleDbType.Decimal, this.TerritoryReal, ParameterDirection.Input);
            else
                cmdSearchCustomer.Parameters.Add("p_resid_territory", OracleDbType.Decimal, null, ParameterDirection.Input);
            ...
            _dbLogger.Debug("Пользователь успешно записал в базу информацию о клиенте с ОКПО = " + this.Code
    ...
    public void ClientFastRegistration()
    {
        HttpContext ctx = HttpContext.Current;
        ...
        try
        {
            ...
            {
                this.Name = this.LastName + " " + this.FirstName + " " + this.Patronymic;
            } 
            ...
            cmdSearchCustomer.Parameters.Add("p_client_surname", OracleDbType.Varchar2, this.LastName.ToUpper(), ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_client_patr", OracleDbType.Varchar2, this.Patronymic.ToUpper(), ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_country", OracleDbType.Decimal, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_index", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_obl", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_district", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_settlement", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_adress", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_fulladdress", OracleDbType.Varchar2, null, ParameterDirection.Input);

            cmdSearchCustomer.Parameters.Add("p_territory", OracleDbType.Decimal, null, ParameterDirection.Input);

            cmdSearchCustomer.Parameters.Add("p_clientcodetype", OracleDbType.Decimal, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_clientcode", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_doctype", OracleDbType.Decimal, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_docserial", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_docnumber", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_docorg", OracleDbType.Varchar2, null, ParameterDirection.Input);
            ...
            cmdSearchCustomer.Parameters.Add("p_clientbplace", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_clientsex", OracleDbType.Decimal, this.Sex, ParameterDirection.Input);

            cmdSearchCustomer.Parameters.Add("p_clientcellphone", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_clienthomeph", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_clientworkph", OracleDbType.Varchar2, null, ParameterDirection.Input);

            cmdSearchCustomer.Parameters.Add("p_special_marks", OracleDbType.Decimal, null, ParameterDirection.Input);

            cmdSearchCustomer.Parameters.Add("p_clientname_gc", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_resid_code", OracleDbType.Decimal, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_resid_index", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_resid_obl", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_resid_district", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_resid_settlement", OracleDbType.Varchar2, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_resid_adress", OracleDbType.Varchar2, null, ParameterDirection.Input);

            cmdSearchCustomer.Parameters.Add("p_resid_territory", OracleDbType.Decimal, null, ParameterDirection.Input);

            cmdSearchCustomer.Parameters.Add("p_selfemployer", OracleDbType.Decimal, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_TaxAgencyCode", OracleDbType.Decimal, null, ParameterDirection.Input);
            cmdSearchCustomer.Parameters.Add("p_RegAgencyCode", OracleDbType.Decimal, null, ParameterDirection.Input);
...
public class ClientAccessRights
{
    ...
    /// <param name="CustID">РНК</param>
    /// <returns></returns>
    public static LevelState Get_AccessLevel(Decimal CustID)
    {
