...
namespace credit
{
    ...
    public class WcsUtl : BbPackage
    {
        ...
        public void SET_NULL_2_HIDED_CD_QUESTS(Decimal? P_BID_ID, String P_SUBPRODUCT_ID, String P_GROUP_ID)
        {
            List<OracleParameter> parameters = new List<OracleParameter>();
            parameters.Add(new OracleParameter("P_BID_ID", OracleDbType.Decimal, P_BID_ID, ParameterDirection.Input));
            parameters.Add(new OracleParameter("P_SUBPRODUCT_ID", OracleDbType.Varchar2, P_SUBPRODUCT_ID, ParameterDirection.Input));
            parameters.Add(new OracleParameter("P_GROUP_ID", OracleDbType.Varchar2, P_GROUP_ID, ParameterDirection.Input));
            object ReturnValue = null;
            ExecuteNonQuery("WCS_UTL.SET_NULL_2_HIDED_CD_QUESTS", parameters.ToArray(), CommandType.StoredProcedure, out ReturnValue);
        }
        public void SET_NULL_2_HIDED_CD_ALL(Decimal? P_BID_ID, String P_SUBPRODUCT_ID)
        {
            List<OracleParameter> parameters = new List<OracleParameter>();
            parameters.Add(new OracleParameter("P_BID_ID", OracleDbType.Decimal, P_BID_ID, ParameterDirection.Input));
            parameters.Add(new OracleParameter("P_SUBPRODUCT_ID", OracleDbType.Varchar2, P_SUBPRODUCT_ID, ParameterDirection.Input));
            object ReturnValue = null;
            ExecuteNonQuery("WCS_UTL.SET_NULL_2_HIDED_CD_ALL", parameters.ToArray(), CommandType.StoredProcedure, out ReturnValue);
        }
