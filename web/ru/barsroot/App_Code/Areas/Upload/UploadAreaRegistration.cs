...
/// <summary>
/// Summary description for UploadAreaRegistration
/// </summary>
public class UploadAreaRegistration : AreaRegistration
{
    public override string AreaName { get { return "Upload"; } }
    ...
    private void BindAreaDI()
    {
        ...
        ninjectKernel.Bind<IUploadRepository>().To<UploadRepository>();
    }
}