    ...
    public partial class ExcelExportController : Controller
    {
        ...
        public ActionResult ExcelExport_Save(string contentType, string base64, string fileName, string rObu, string rNbu)
        {
            ...
            using (var package = new ExcelPackage(fileStream))
            {
                ...
                worksheet.Cells["A29"].Value = "Внутрішній кредитний рейтинг Позичальника: " + rObu;
                worksheet.Cells["A29"].Style.Font.Bold = true;
                worksheet.Cells["A29"].Style.Fill.PatternType = ExcelFillStyle.Solid;
                worksheet.Cells["A29"].Style.Fill.BackgroundColor.SetColor(Color.LightGreen);
                worksheet.Cells["A30"].Value = "Клас Позичальника (відповідно до класифікації НБУ): " + rNbu;
                worksheet.Cells["A30"].Style.Font.Bold = true;
                worksheet.Cells["A30"].Style.Fill.PatternType = ExcelFillStyle.Solid;
                worksheet.Cells["A30"].Style.Fill.BackgroundColor.SetColor(Color.LightGreen);
