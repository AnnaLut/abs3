        ...
        function ($http, $q) {
            ...
            var _getRules = function (registrationId) {
                ...
                if (signedData && signedData !== 'canceled') {
                    ...
                    $http.post(bars.config.urlContent('/api/CorpLight/UserCertificate/getRules'),
            ...
            var _enrollRequest = function (relCustId, subjectData) {
                ...
                if (signedData && signedData !== 'canceled') {
                    ...
                    $http.post(bars.config.urlContent('/api/CorpLight/UserCertificate/enrollRequest/' + relCustId),
                        { signedData: signedData })
                    .success(function (response) {
                        state.isLoading = false;
                        deferred.resolve(response);
            ...
            var _getSubject = function (registrationId, templateId, providerId) {
                ...
                if (signedData && signedData !== 'canceled') {
                    ...
                    $http.post(bars.config.urlContent('/api/CorpLight/UserCertificate/getSubject'),
                        { signedData: signedData })
                    .success(function (response) {
                        state.isLoading = false;
                        deferred.resolve(response);
            ...
            var _getCertificatesStatus = function (relCustId, registrationId) {
                ...
                if (signedData && signedData !== 'canceled') {
                    ...
                    $http.post(bars.config.urlContent('/api/CorpLight/UserCertificate/getSertificatesStatus/' + relCustId),
                        { signedData: signedData })
                    .success(function (response) {
                        state.isLoading = false;
                        deferred.resolve(response);
            ...
            var _sendProfileToAcsk = function (relCustId, custId) {
                ...
                var deferred = $q.defer();
                $http.post(bars.config.urlContent('/api/CorpLight/UserCertificate/sendToAcsk/') + relCustId + '/' + custId)
                    .success(function (response) {
                        state.isLoading = false;
                        deferred.resolve(response);
                    }).error(function (response) {
            ...
            var _changeCertificateState = function (relCustId, registrationId, cerialNumber, newId, comment) {
                ...
                if (signedData && signedData !== 'canceled') {
                    ...
                    $http.post(bars.config.urlContent('/api/CorpLight/UserCertificate/changeState/' + relCustId),
                        { signedData: signedData })
                    .success(function (response) {
                        state.isLoading = false;
                        deferred.resolve(response);
