...
angular.module(globalSettings.modulesAreas)
    .factory('customersService',
        ...
        function ($http, $q) {
            ...
            var closeCustomerInEBK = function (id, custType) {

                var url = bars.config.urlContent('/CDMService/sendCardClose/');
                ...
                var deferred = $q.defer();
                $http.post(url, clientParams).success(function (response) {
            ...
            factory.closeCustomerInEBK = closeCustomerInEBK;
