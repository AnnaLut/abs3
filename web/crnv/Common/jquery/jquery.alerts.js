...
(function ($) {
    ...
    $.popups = {
        ...
        _dialog: function (title, msg, value, type, callback, ctrlBlock) {
            ...
            if (type == "confirm")
                $('#dialogContent').dialog("option", "buttons", [{ text: "Відміна", click: function () { $(this).dialog("close"); if (callback) callback(false); }, width: 80 }, { text: "ОК", click: function () { if (!ctrlBlock) $(this).dialog("close"); if (callback) callback(true); }, width: 80 }]);
            else
