        ...
        <asp:Panel ID="pnlRepResults" runat="server" GroupingText="Сформовані звіти">
            <asp:UpdatePanel ID="upRepResults" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:ObjectDataSource ID="odsVCbirepRepresults" runat="server" EnablePaging="True"
                        SortParameterName="SortExpression" SelectMethod="SelectCbirepRepresults" TypeName="Bars.ObjLayer.CbiRep.VCbirepRepresults">
                    </asp:ObjectDataSource>
                    <Bars:BarsGridViewEx ID="gvVCbirepRepresults" runat="server" AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" CaptionText="" ClearFilterImageUrl="/common/images/default/16/filter_delete.png"
                        CssClass="barsGridView" DataSourceID="odsVCbirepRepresults" DateMask="dd.MM.yyyy"
