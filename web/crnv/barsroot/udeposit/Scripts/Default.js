...
function InitDefault() {
    ...
    v_data[2] = "nvl(d.closed,0) = 0 and d.branch=sys_context('bars_context', 'user_branch')";
...
function fnShowParam() {
    HidePopupMenu();
    if (selectedRow == null) return;
    window.showModalDialog("dptdealparamS.aspx?mode=" + mode + "&dpu_id=" + selectedRowId + "&type=0&dpu_gen=" + selectedRow.dpugen + "&dpu_ad=" + selectedRow.dpuadd + "&rnd=" + Math.random(), window, "dialogWidth:1000px;dialogHeight:800px;center:yes;edge:sunken;help:no;status:no;");
}
//**********************************************************************//
