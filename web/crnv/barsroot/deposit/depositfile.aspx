<%@ Page Language="c#" CodeFile="DepositFile.aspx.cs" AutoEventWireup="true" Inherits="DepositFile" 
            ...
            <tr>
                <td align="center">
                    <asp:Label ID="lbTitle" meta:resourcekey="lbTitle9" runat="server" CssClass="InfoHeader"
                        Text="Прием файла обмена"></asp:Label></td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <table id="tbNewHeader" runat="server" visible="false" class="InnerTable">
                        <tr>
                            ...
                            <td style="width: 20%">
                                <asp:TextBox ID="FILENAME" runat="server" CssClass="InfoText" TabIndex="1" MaxLength="12"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="BRANCH_CODE" runat="server" CssClass="InfoText" TabIndex="17" MaxLength="4"
                                    meta:resourcekey="BRANCH_CODEResource1" ReadOnly="True">0000</asp:TextBox></td>
                            <td>
                            </td>
                            <td>
                            </td>
                        ...
                        <tr>
                            <td colspan="2">
                                <Bars:BarsGridView ID="gridRecords" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        <asp:BoundField HtmlEncode="False" DataField="INFO_ID" SortExpression="INFO_ID" HeaderText="*">
                                        ...
                                        <asp:BoundField DataField="PASP" SortExpression="PASP" HeaderText="Паспорт" meta:resourcekey="BoundFieldResource7">
                                            <itemstyle horizontalalign="Left" />
                                        </asp:BoundField>
