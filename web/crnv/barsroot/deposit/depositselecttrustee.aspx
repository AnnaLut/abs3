	...
	<body onload="focusControl('btTrustee');">
		<form id="Form1" method="post" runat="server">
			<table class="MainTable">
				...
				<tr>
					<td width="50%"><input class="AcceptButton" id="btTrustee" meta:resourcekey="btTrustee" tabIndex="1"
							type="button" value="Оформить на довереное лицо" runat="server"/>
					</td>
					<td width="50%"><input class="AcceptButton" id="btOwner" meta:resourcekey="btOwner" tabIndex="2" type="button" value="Оформить на владельца"
