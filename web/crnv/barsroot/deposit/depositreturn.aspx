				...
				<tr>
					<td>
						<table class="InnerTable">
							...
							<tr>
								<td><asp:label id="lbDptParams" meta:resourcekey="lbDptParams" runat="server" CssClass="InfoLabel">Параметры вклада</asp:label></td>
							</tr>
							<tr>
								<td>
									<table class="InnerTable">
                                        ...
                                        <tr runat="server" id="inherit_row_d">
                                            ...
                                            <td>
                                                <asp:Label ID="lbInheritSum" runat="server" CssClass="InfoText" meta:resourcekey="lbInheritSum"
                                                    Text="Сумма депозита доступная наследнику"></asp:Label></td>
                                            <td>
                                            </td>
                                            <td>
                                                <igtxt:webnumericedit id="InheritDeposit" runat="server" ToolTip="Сумма на депозитном счету" ReadOnly="True" MinValue="0"
													MinDecimalPlaces="SameAsDecimalPlaces" DataMode="Decimal" CssClass="InfoDateSum">
                                        ...
                                        <tr runat="server" id="inherit_row_p">
                                            ...
                                            <td>
                                                <asp:Label ID="lbDInherit" runat="server" CssClass="InfoText" meta:resourcekey="lbPercentSum"
                                                    Text="Сумма процентов доступная наследнику"></asp:Label></td>
                                            <td>
                                            </td>
                                            <td>
										...
										<tr>
											...
											<td>
												<igtxt:webnumericedit id="dptDepositToPay" runat="server" ToolTip="Сумма к выплате с депозитного счета"
													ReadOnly="True" MinValue="0" MinDecimalPlaces="SameAsDecimalPlaces" DataMode="Decimal" CssClass="InfoDateSum"></igtxt:webnumericedit>
											</td>
											<td>
											</td>
											<td>
							...
							<tr>
								<td>
									<table class="InnerTable">
										<tr>
											<td>
												<input class="AcceptButton" id="btNalPay" meta:resourcekey="btNalPay" tabIndex="5" value="Выплата депозита" runat="server"
													type="button">
											</td>
											<td>
												<input class="AcceptButton" id="btPayPercent" meta:resourcekey="btPayPercent" disabled tabIndex="6" type="button" value="Выплата процентов"
													runat="server">
											</td>
										</tr>
										<tr>
										    <td colspan = "2">
										        <input class="AcceptButton" id="btSurvey" style="visibility:hidden" tabIndex="6" type="button" value="Заповнити анкету" runat="server"
										            onclick="OpenSurvey('/barsroot/Survey/Survey.aspx?par=SURVCLOS&rnk=' + document.getElementById('rnk').value);">
										    </td>
										</tr>
										<tr>
											<td></td>
