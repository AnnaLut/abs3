        ...
        <tr>
            <td colspan="3" align="center">
                <asp:Label ID="lbTitle" runat="server" CssClass="InfoHeader" meta:resourcekey="lbTitleResource1"
                    Text="Ресурс по срокам пошения"></asp:Label></td>
        </tr>
        <tr>
            <td style="width:1%">
                <cc1:ImageTextButton ID="btRefreshByDay" runat="server" EnabledAfter="0" ImageUrl="\Common\Images\default\16\refresh.png" meta:resourcekey="btRefreshByDayResource1" OnClick="btRefreshByDay_Click" Text="По дням" ToolTip="По дням" />
            </td>
            <td style="width:1%">
                <cc1:ImageTextButton ID="btRefreshMonth" runat="server" EnabledAfter="0" ImageUrl="\Common\Images\default\16\refresh_table.png"
                    meta:resourcekey="btRefreshMonthResource1" OnClick="btRefreshMonth_Click" Text="По месяцам"
                    ToolTip="По месяцам" />
            </td>
            ...
            <td colspan="3">
                <Bars:BarsGridView ID="BarsGridView1" runat="server" AllowPaging="True" AllowSorting="True" CssClass="BaseGrid" DataSourceID="dsResource" DateMask="dd/MM/yyyy" meta:resourcekey="BarsGridView1Resource1" ShowPageSizeBox="True" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:BoundField DataField="SUM" HeaderText="Сумма" meta:resourcekey="BoundFieldResource3"
                            SortExpression="SUM" >
                            <itemstyle horizontalalign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TOBO" HeaderText="Отделение" meta:resourcekey="BoundFieldResource4"
                            SortExpression="TOBO" >
                            <itemstyle horizontalalign="Center" />
                        </asp:BoundField>
                    </Columns>
