                                                            ...
                                                            <asp:View ID="v0" runat="server">
                                                                <table border="0" cellpadding="3" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <bars:TextBoxString ID="OKPO" runat="server" MaxLength="10" IsRequired="false" ValidationGroup="Params"
                                                                                Value='<%# Bind("OKPO") %>' />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <bars:TextBoxRefer ID="COUNTRY" runat="server" TAB_ID="128" KEY_FIELD="COUNTRY" SEMANTIC_FIELD="NAME"
                                                                                IsRequired="false" ValidationGroup="Params" Value='<%# Bind("COUNTRY") %>' />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <bars:TextBoxString ID="REGION" runat="server" IsRequired="false" ValidationGroup="Params"
                                                                                Value='<%# Bind("REGION") %>' />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Panel ID="pnlREL_ID" runat="server" GroupingText="Ознака пов`язаності">
                                                        <bars:DDLList ID="REL_ID" runat="server" DataSourceID="odsCustRelTypes" DataValueField="ID"
