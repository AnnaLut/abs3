...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="JScriptFortab_ek_norm.js?v.1.8.2"></script>
                ...
                <table id="tb_ek_norm" style="font-size: 10pt; font-family: Arial" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td height="1">
                            ...
                            <div style="display: inline; font-size: 12pt; width: 8px; color: red" id="lb_2">
                                *</div>
                        </td>
                        <td height="1">
                            <select class="tab_ek_norm_ed2_style" id="ddl_FS_com" onclick="GetHelpValue(getEl('ed_FS'), getEl('ddl_FS_com'), 'FS');ToDoOnChange();">
                                <option selected></option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div style="display: inline; font-size: 12pt; width: 8px; color: red" id="lb_5">
                                *</div>
                        </td>
                        <td>
