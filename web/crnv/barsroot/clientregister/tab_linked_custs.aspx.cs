...
public partial class clientregister_tab_linked_custs : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "enchCheck", "if(parent.flagEnhCheck) parent.Check_RekvLinkCusts(); if(parent.obj_Parameters['EditType'] == 'Reg') parent.getEl('bTab6').style.visibility = 'hidden'; DisableAll(document, parent.obj_Parameters['ReadOnly'] == 0);", true);
        }
    }
    ...
    public void RELEXT_ID_ValueChanged(object sender, EventArgs e)
    {
        ...
        if (fv.CurrentMode == FormViewMode.Edit || fv.CurrentMode == FormViewMode.Insert)
        {
            ...
            TextBoxString REGION = fv.FindControl("REGION") as TextBoxString;
