...
<head>
    ...
    <script type="text/javascript" src="Scripts/Default.js?v1.5"></script>
    <script type="text/javascript">        window.onload = InitDefault;
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                &nbsp;<img class="outset" id="btSave" onclick="SaveAccount()" runat="server">
                <img class="outset" id="btClose" onclick="CloseAccount()" runat="server">
                <img class="outset" id="btPrint" onclick="Print()" runat="server">&nbsp;
            </td>
            <td>
