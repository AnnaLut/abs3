<%@ Page Language="C#" AutoEventWireup="true" CodeFile="send2ru.aspx.cs" Inherits="send2ru" %>
...
<head runat="server">
    <title>Претендети для відправки на доходи РУ</title>
...
<body>
    <form id="formOperationList" runat="server">
        <div class="pageTitle">
            <asp:Label ID="lbTitle" runat="server" Text="Претендети для відправки на доходи РУ" />
        </div>
        ...
        <table>
            <tr>
                <td>
                    <asp:Button runat="server" ID="bt_send" Text="Передати в РУ" OnClick="bt_send2ru" ToolTip="Виконує перерахунок на доходи РУ"/>
                </td>
            </tr>
        </table>
        <br />
