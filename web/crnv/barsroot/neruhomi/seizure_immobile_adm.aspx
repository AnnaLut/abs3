<%@ Page Language="C#" AutoEventWireup="true" CodeFile="seizure_immobile_adm.aspx.cs" Inherits="seizure_immobile_adm" %>
   ...
   <script type="text/javascript">
    ...
    <asp:Panel  ID="pnPay" GroupingText="Виконання дій:" runat="server" Style="margin-left: 10px;
        ...
        <tr>
            ...
            <td>
                <asp:ImageButton runat="server" ID="bt_del" ToolTip="Вилучити арешт" ImageUrl="\Common\Images\default\24\document_delete.png" OnClick="bt_del_Click"  />
            </td>
        </tr>
    </asp:Panel>
        <table>
