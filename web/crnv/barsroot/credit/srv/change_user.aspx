<%@ Page Language="C#" MasterPageFile="~/credit/manager/master.master" AutoEventWireup="true"
    CodeFile="change_user.aspx.cs" Inherits="credit_srv_change_user" Title="Переназначение исполнителя по заявке"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <table border="0" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectSrvChangeBids"
                        TypeName="credit.VWcsSrvChangeBids" SortParameterName="SortExpression" EnablePaging="True">
                        <SelectParameters>
