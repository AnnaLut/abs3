    ...
    private void CheckStateAccess()
    {
        ...
        switch (Master.SRV_HIERARCHY.ToUpper())
        {
            case "TOBO":
                ...
                lbFinishSrvAnalyse.Enabled = (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CREDIT_S_SRVANALYSE")) && !HasStateDataReInput;
                lbFinishCcAnalyse.Enabled = (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CREDIT_S_CCANALYSE")) && !HasStateDataReInput;
                lbDataReInput.Enabled = ((1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CREDIT_S_PRC")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CREDIT_S_SRVANALYSE")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CREDIT_S_CCANALYSE"))) && !HasStateDataReInput;
                lbDeny.Enabled = ((1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CREDIT_S_PRC")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CREDIT_S_SRVANALYSE")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CREDIT_S_CCANALYSE"))) && !HasStateDataReInput;
                break;
            case "RU":
                ...
                lbFinishSrvAnalyse.Enabled = (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_RU_CREDIT_S_SRVANALYSE")) && !HasStateDataReInput;
                lbFinishCcAnalyse.Enabled = (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_RU_CREDIT_S_CCANALYSE")) && !HasStateDataReInput;
                lbDataReInput.Enabled = ((1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_RU_CREDIT_S_PRC")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_RU_CREDIT_S_SRVANALYSE")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_RU_CREDIT_S_CCANALYSE"))) && !HasStateDataReInput;
                lbDeny.Enabled = ((1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_RU_CREDIT_S_PRC")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_RU_CREDIT_S_SRVANALYSE")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_RU_CREDIT_S_CCANALYSE"))) && !HasStateDataReInput;
                break;
            case "CA":
                ...
                lbFinishSrvAnalyse.Enabled = (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CA_CREDIT_S_SRVANALYSE")) && !HasStateDataReInput;
                lbFinishCcAnalyse.Enabled = (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CA_CREDIT_S_CCANALYSE")) && !HasStateDataReInput;
                lbDataReInput.Enabled = ((1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CA_CREDIT_S_PRC")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CA_CREDIT_S_SRVANALYSE")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CA_CREDIT_S_CCANALYSE"))) && !HasStateDataReInput;
                lbDeny.Enabled = ((1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CA_CREDIT_S_PRC")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CA_CREDIT_S_SRVANALYSE")) || (1 == cmn.wu.HAS_BID_STATE(Master.BID_ID, "NEW_CA_CREDIT_S_CCANALYSE"))) && !HasStateDataReInput;
                break;
        }
    }
