                                ...
                                <table border="0" cellpadding="3" cellspacing="0">
                                    <colgroup>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <bec:TextBoxString ID="PI_FREE_MFO" runat="server" IsRequired="True" MinLength="6"
                                                    MaxLength="6" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <bec:TextBoxString ID="PI_FREE_NLS" runat="server" IsRequired="True" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <bec:TextBoxString ID="PI_FREE_OKPO" runat="server" IsRequired="True" MinLength="8"
                                                    MaxLength="10" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <bec:TextBoxString ID="PI_FREE_NAME" runat="server" IsRequired="True" Width="300px" />
                                            </td>
                                        </tr>
                                    </colgroup>
                                </table>
