<%@ Page Language="C#" AutoEventWireup="true" CodeFile="grt_insurances.aspx.cs" Inherits="credit_constructor_grt_insurances"
    Theme="default" MasterPageFile="~/credit/manager/master.master" Title="Страховки обеспечения {0} - {1} заявки №{2}"
        ...
        <tr>
            <td id="tdContainer" runat="server">
                <div class="dataContainer">
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectBidGrtInsurances"
                        TypeName="credit.VWcsBidGrtInsurances">
                        <SelectParameters>
                    ...
                    <Bars:BarsGridViewEx ID="gv" runat="server" AutoGenerateColumns="False" CaptionText=""
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="STATUS_NAME" HeaderText="Статус" 
                                SortExpression="STATUS_NAME" meta:resourcekey="BoundFieldResource3">
                            </asp:BoundField>
                ...
                <div class="formViewContainer">
                    <asp:ObjectDataSource ID="odsFV" runat="server" DataObjectTypeName="credit.VWcsBidGrtInsurancesRecord"
                        DeleteMethod="Delete" InsertMethod="Insert" SelectMethod="SelectBidGrtInsurance"
                        TypeName="credit.VWcsBidGrtInsurances">
                        <SelectParameters>
                            <asp:QueryStringParameter Name="BID_ID" QueryStringField="bid_id" Type="Decimal" />
                            <asp:QueryStringParameter Name="GARANTEE_ID" QueryStringField="garantee_id" Type="String"
                    ...
                    <Bars:BarsSqlDataSourceEx ID="sds" runat="server" ProviderName="barsroot.core" 
                        SelectCommand="select i.* from wcs_insurances i, wcs_garantee_insurances gi where i.id = gi.insurance_id and gi.garantee_id = :GARANTEE_ID" 
                        AllowPaging="False" PageButtonCount="10" 
                        PagerMode="NextPrevious" PageSize="10" FilterStatement="" 
                        PreliminaryStatement="" SortExpression=""  >
                        <SelectParameters>
                            <asp:QueryStringParameter Name="GARANTEE_ID" QueryStringField="garantee_id" Type="String"
                                Size="100" />
                        </SelectParameters>
                    </Bars:BarsSqlDataSourceEx>
                    <asp:FormView ID="fv" runat="server" DataKeyNames="BID_ID,GARANTEE_ID,GARANTEE_NUM,INSURANCE_ID,INSURANCE_NUM"
                                ...
                                <tr>
                                    <td class="actionButtonsContainer" colspan="2">
                                        <asp:LinkButton ID="lbtSurvey" runat="server" CommandName="Survey" 
                                            ToolTip="Анкета" meta:resourcekey="lbtSurveyResource1" Text="Анкета"></asp:LinkButton>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="actionButtonsContainer" colspan="2">
