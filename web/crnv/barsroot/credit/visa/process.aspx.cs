...
public partial class credit_visa_process : Bars.BarsPage
{
    ...
    protected void fv_ItemCommand(object sender, FormViewCommandEventArgs e)
    {
        ...
        String WS_ID = (String)gv.SelectedDataKey["WS_ID"];
                ...
                List<VWcsVisaBidInfoqueriesRecord> lst = (new VWcsVisaBidInfoqueries(con)).SelectVisaBidInfoqueries(BID_ID, SRV_HIERARCHY);
                Int32 cnt = lst.Count;
                ...
                if (cnt == 0)
                    Response.Redirect(String.Format("/barsroot/credit/visa/bid_card.aspx?srvhr={0}&bid_id={1}", SRV_HIERARCHY, BID_ID.ToString()));
