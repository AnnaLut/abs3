...
function InitPage()  
{  
  LoadXslt("Xslt/DataBalansIsp_"+getCurrentPageLanguage()+".xsl");
  v_data[3] = "b.isp";
  var obj = new Object();
  obj.v_serviceObjName = 'webService';
  obj.v_serviceName = 'Service.asmx';
  obj.v_serviceMethod = 'GetDataByIsp';
...
function fnByAcc()
{
  window.location.replace("/barsroot/balansaccdoc/balansacc.aspx?tobo="+v_data[12]+"&par=1&val="+selectedRowId+"&nbs="+v_data[10]+"&fdat="+v_data[11]);
}