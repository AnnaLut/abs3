...
public class safe_deposit
{
    ...
    public void CreateSafe(Decimal safe_id, Decimal safe_type_code, String nls)
    {
        OracleConnection connect = new OracleConnection();
        ...
        try
        {
            ...
            cmdCreateSafe.Parameters.Add("safe_id", OracleDbType.Decimal, safe_id, ParameterDirection.Input);
