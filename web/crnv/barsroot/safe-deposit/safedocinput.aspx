            ...
            <tr>
                ...
                <td style="width:1%">
                    <cc1:imagetextbutton id="btCalc" runat="server" buttonstyle="Image" imageurl="/Common\Images\default\16\money_calc.png"
                        tooltip="Расчитать" OnClientClick="if (validateParams()) return;" OnClick="btCalc_Click" TabIndex="2" EnabledAfter="0" meta:resourcekey="btCalcResource1"></cc1:imagetextbutton>
                </td>
                <td style="width:1%">
                    <cc1:imagetextbutton id="btBack" runat="server" buttonstyle="Image" imageurl="/Common\Images\default\16\arrow_left.png"
                        onclientclick="location.replace('safeportfolio.aspx'); return;" tooltip="Назад" TabIndex="3" EnabledAfter="0" meta:resourcekey="btBackResource1"></cc1:imagetextbutton>
                </td>
                        ...
                        <tr runat="server" id="rdat2">
                            <td>
                                <asp:Label ID="lbDAT2" runat="server" CssClass="InfoText95" meta:resourcekey="lbRef"
                                    Style="text-align: center"></asp:Label></td>
                            <td>
                                <cc1:DateEdit ID="DAT2" runat="server" TabIndex="12" onblur="ckDate()" Date="" MaxDate="2099-12-31" meta:resourcekey="DAT2Resource1" MinDate=""></cc1:DateEdit></td>
                            <td>
                                </td>
                        </tr>
