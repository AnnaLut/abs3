...
function getDealtoBindDoc()
{
    ...
    "dialogWidth:400px;dialogHeight:250px;center:yes;edge:sunken;help:no;status:no;");       
...
//        return true;
    ...
    "dialog.aspx?type=metatab&tail='custtype in (2,3)'&role=wr_metatab&tabname=V_CUST_OTC","",
    "dialogWidth:600px;dialogHeight:600px;center:yes;edge:sunken;help:no;status:no;");    
...
function FormNotFilled()
{
    ...
    arr[9] = 'ISSUED';arr[10] = 'NMK';arr[11] = 'ADDRESS';
...
function GetClient()
{
    ...
    document.getElementById("ddClientType").item(document.getElementById("ddClientType").selectedIndex).value
     + "'&role=wr_metatab&tabname=V_CUST_OTC","",
    "dialogWidth:600px;dialogHeight:600px;center:yes;edge:sunken;help:no;status:no;");    
