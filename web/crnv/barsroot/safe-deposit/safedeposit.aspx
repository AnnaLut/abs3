            ...
            <td>
                <table id="SafeTable" class="InnerTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <cc1:numericedit id="BAIL_SUM" runat="server" cssclass="InfoText95" TabIndex="12" meta:resourcekey="BAIL_SUMResource1" Value="0" Text="0"></cc1:numericedit>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <td>
                <table class="InnerTable"> 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="KEY_NUM" runat="server" CssClass="InfoText95" TabIndex="43" meta:resourcekey="KEY_NUMResource1"></asp:TextBox></td>
                        <td>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="KEYS_GIVEN" runat="server" CssClass="InfoText95" TabIndex="44" meta:resourcekey="KEYS_GIVENResource1"></asp:TextBox></td>
                    </tr>
                </table>              
            </td>
        </tr>
