        ...
        <tr>
            <td>
                <table class="InnerTable">
                    ...
                    <tr>
                        <td colspan="5">
                            <bars:barsgridview id="gridSafeDeposit" runat="server" allowpaging="True" allowsorting="True" cssclass="BaseGrid" datasourceid="dsSafeDeposit"
                                datemask="dd/MM/yyyy" AutoGenerateColumns="False" OnRowDataBound="gridSafeDeposit_RowDataBound" CaptionText="" ExcelImageUrl="/common/images/default/16/export_excel.png" FilterImageUrl="/common/images/default/16/find.png" MetaFilterImageUrl="/common/images/default/16/filter.png" MetaTableName="" RefreshImageUrl="/common/images/default/16/refresh.png" ShowFooter="True">
                                <Columns>
<asp:BoundField DataField="SNUM" SortExpression="SNUM" HeaderText="№ сейфа"></asp:BoundField>
<asp:BoundField DataField="TYPE" SortExpression="TYPE" HeaderText="Размер"></asp:BoundField>
<asp:BoundField DataField="KEYUSED" SortExpression="KEYUSED" HeaderText="Ключ выдан"></asp:BoundField>
<asp:BoundField DataField="A_OSTC" SortExpression="A_OSTC" HeaderText="Внесен залог (факт.)"></asp:BoundField>
                                    <asp:BoundField DataField="FACT_PAY" HeaderText="Внес. аренд. плата" SortExpression="FACT_PAY" />
...
<asp:BoundField DataField="NMK" SortExpression="NMK" HeaderText="Кем занято"></asp:BoundField>
<asp:BoundField DataField="DAT_BEGIN" SortExpression="DAT_BEGIN" HeaderText="Начало договора"></asp:BoundField>
<asp:BoundField DataField="DAT_END" SortExpression="DAT_END" HeaderText="Завершение договора"></asp:BoundField>
<asp:BoundField DataField="NLS" SortExpression="NLS" HeaderText="Счет"></asp:BoundField>
                                    <asp:BoundField DataField="NLS3600" HeaderText="Счет 3600" SortExpression="NLS3600" />
<asp:BoundField DataField="DOV_FIO" SortExpression="DOV_FIO" HeaderText="Дов. лицо"></asp:BoundField>
<asp:BoundField DataField="N_SK" SortExpression="N_SK" HeaderText="№ сейфа (сист.)"></asp:BoundField>
<asp:BoundField DataField="LCV" SortExpression="LCV" HeaderText="Вал."></asp:BoundField>
<asp:BoundField DataField="CUSTTYPE" SortExpression="CUSTTYPE" HeaderText="ЮЛ-2, ФЛ-3"></asp:BoundField>
<asp:BoundField DataField="SOS" SortExpression="SOS" HeaderText="*"></asp:BoundField>
                    ...
                    <tr>
                        <td colspan="5">
                            <bars:barssqldatasource ProviderName="barsroot.core" id="dsSafeDeposit" runat="server"></bars:barssqldatasource>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5">
                ...
                <table class="InnerTable">
                    <tr>
                        <td style="width:5%" align="center">
                                        <asp:Label ID="lbColor1" runat="server" BackColor="#B7FFB7" Width="10px" meta:resourcekey="lbColor1Resource1" Height="10px"></asp:Label></td>
                        <td style="width:20%">
                                        <asp:Label ID="lbUsed" runat="server" Text="Зайняті" CssClass="InfoText" meta:resourcekey="lbUsedResource1"></asp:Label></td>
                        <td align="center" style="width:5%">
                                        <asp:Label ID="Label1" runat="server" BackColor="#709C70" meta:resourcekey="lbColor2Resource1"
                                            Width="10px" Height="10px"></asp:Label></td>
                        <td style="width:20%">
                                        <asp:Label ID="lbProlong" runat="server" CssClass="InfoText"
                                            Text="Пролонгація"></asp:Label></td>
                        <td align="center" style="width:5%">
                                        <asp:Label ID="lbColor2" runat="server" BackColor="#DFED4C" Width="10px" meta:resourcekey="lbColor2Resource1" Height="10px"></asp:Label></td>
                        <td style="width:20%">
                                        <asp:Label ID="lbLeft" runat="server" CssClass="InfoText" Text="Зал. 7 днів" meta:resourcekey="lbLeftResource1"></asp:Label></td>
                        <td align="center" style="width:5%">
                                        <asp:Label ID="Label2" runat="server" BackColor="#FF5151" Width="10px" meta:resourcekey="Label2Resource1" Height="10px"></asp:Label></td>
                        <td style="width:20%">
