...
<!--NAME= Наименование тарифа-комиссии;TAR=Тариф в  коп;PR=Комиссия (%);SMIN=Минимум в коп;SMAX=Максимум в коп;BDAT=Дата начала дейст. тар.(dd/mm/yyyy);EDAT=Дата окончания дейст. тар.(dd/mm/yyyy)-->
...
<xsl:text>Наименование тарифа-комиссии</xsl:text></TD>
<TD width="5%">
<xsl:attribute name="onclick"><xsl:text>Sort('LCV')</xsl:text></xsl:attribute>
<xsl:text>Базовая вал</xsl:text></TD>
<TD width="5%">
