<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="printdocs.aspx.cs" Inherits="credit_secretarycc_printdocs" Title="Печать документов по заявке №{0}"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectCcBidTemplates"
