...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        ...
        <table border="0" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectCcBidsArchive"
                        TypeName="credit.VWcsCcBidsArchive" SortParameterName="SortExpression" EnablePaging="True">
                        <SelectParameters>
                    ...
                    <Bars:BarsGridViewEx ID="gv" runat="server" AutoGenerateColumns="False" CaptionText=""
                        ...
                        <Columns>
                            <asp:HyperLinkField DataNavigateUrlFields="BID_ID" DataNavigateUrlFormatString="/barsroot/credit/secretarycc/bid_card_arh.aspx?bid_id={0}"
