<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="queries.aspx.cs" Inherits="credit_secretarycc_queries" Title="Обробка заявок"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <table border="0" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td style="padding: 10px">
                    <table border="0" cellpadding="3" cellspacing="0" style="text-align: center">
                        <tr>
                            <td>
                                <asp:Label ID="SearchBidIdTitle" runat="server" Text="№ заявки :" meta:resourcekey="SearchBidIdTitleResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="SearchInnTitle" runat="server" Text="ІПН :" meta:resourcekey="SearchInnTitleResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="SearchFioTitle" runat="server" Text="Прізвище клієнта :" meta:resourcekey="SearchFioTitleResource1"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Button ID="btSearch" runat="server" Text="Застосуваты" SkinID="bSearch" OnClick="btSearch_Click"
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectCcBids" TypeName="credit.VWcsCcBids"
                    ...
                    <Bars:BarsGridViewEx ID="gv" runat="server" AutoGenerateColumns="False" CaptionText=""
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="SRV_HIERARCHY,BID_ID" DataNavigateUrlFormatString="/barsroot/credit/secretarycc/bid_card.aspx?srvhr={0}&bid_id={1}"
                ...
                <td>
                    <asp:Panel ID="pnlProcess" runat="server" GroupingText="Обработка" meta:resourcekey="pnlProcessResource1">
                        <table class="dataTable">
                            <tr>
                                <td>
                                    <asp:LinkButton ID="lbPROCCESS" runat="server" Text="Обработать выбранные заявки"
                                        CommandName="PROCCESS" OnClick="lbPROCCESS_Click" meta:resourcekey="lbPROCCESSResource1"></asp:LinkButton>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:LinkButton ID="lbDOCS" runat="server" Text="Печать документов по выбранным заявкам"
                                        CommandName="DOCS" OnClick="lbDOCS_Click" meta:resourcekey="lbDOCSResource1"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                            ...
                            <tr>
                                <td>
                                    <asp:LinkButton ID="lbFinish" runat="server" CommandName="Finish" OnClick="lbFinish_Click"
                                        Text="Завершить обработку выбраных заявок" meta:resourcekey="lbFinishResource1"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
