...
public partial class DepositPercentPay : Bars.BarsPage
{
	...
	{
		DBLogger.Info("Пользователь нажал на кнопку \"Выплата\" (процентов) на странице выплаты процентов по договору # " + 
    ...
    protected void btAuthorizationByBPK_ClientIdentified(object sender, Bars.UserControls.ClientIdentifiedEventArgs e)
    {
        ...
        {
            DBLogger.Info("Користувач виконав Авторизацію виплати відсотків за допомогою БПК клієнта (rnk=" + 
