...
<body>
	<form id="Form1" method="post" runat="server">
		<table id="mainTable" class="MainTable">
			<tr>
				<td align="center">
					<asp:label id="lbSearchInfo" runat="server" CssClass="InfoHeader">Вибір власника депозиту</asp:label>
				</td>
			</tr>
            <tr>
                <td align="center">
			...
			<tr>
				<td>
                    <bars:barsgridview id="gridCoowners" runat="server" allowsorting="True" autogeneratecolumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="DPT_NUM" HeaderText="Депозит" HtmlEncode="False" SortExpression="DPT_NUM">
			...
			<tr>
				<td>
                    <bars:barssqldatasource ProviderName="barsroot.core" id="dsCoowners" runat="server"></bars:barssqldatasource><input id="rnk" type="hidden" runat="server" value="null"/>&nbsp;
                    <input id="kv" type="hidden" runat="server" value="null"/>
