                    ...
                    <fieldset>
                        ...
                        <div>
                            ...
                            <bars:BarsSqlDataSourceEx runat="server" ID="dsVCimConclusion" ProviderName="barsroot.core"
                                SelectCommand="select id,contr_id,org_id,org_name,out_num,out_date,kv,s,begin_date,end_date,s_doc, s-s_doc s2, create_date,create_uid from v_cim_conclusion where contr_id=:CONTR_ID">
                                <SelectParameters>
                                    <asp:QueryStringParameter Name="CONTR_ID" QueryStringField="contr_id" DbType="Decimal" />
                                </SelectParameters>
                            </bars:BarsSqlDataSourceEx>
