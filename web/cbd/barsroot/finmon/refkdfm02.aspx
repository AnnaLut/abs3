<%@ Page Language="C#" AutoEventWireup="true" Title="Довідник Kdfm02"
    CodeFile="refkdfm02.aspx.cs" Inherits="finmon_refKdfm02" Trace="false" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="formKdfm02" runat="server">
        ...
        <div class="pageTitle">
            <asp:Label ID="lbTitle" runat="server" Text="Обов`язковий моніторинг"></asp:Label>
        </div>
        <BarsEX:BarsSqlDataSourceEx ID="odsKdfm02" runat="server" AllowPaging="False" ProviderName="barsroot.core"></BarsEX:BarsSqlDataSourceEx>

        <BarsEX:BarsGridViewEx ID="gvKdfm02" runat="server" PagerSettings-PageButtonCount="10" PageIndex="0"
            PageSize="15" AllowPaging="True" AllowSorting="True"
            DataSourceID="odsKdfm02" CssClass="barsGridView" DataKeyNames="CODE,NAME" DateMask="dd/MM/yyyy"
