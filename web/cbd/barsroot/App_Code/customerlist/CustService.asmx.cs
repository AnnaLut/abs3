	...
	public class CustService : BarsWebService
	{
        ...
        public string ExportExcel(string[] data)
        {
            try
            {
                ...
                string sql = "a.nls || '(' || a.kv || ')' \"Номер рахунку\" ," +
                    "a.lcv \"Валюта\"," +
                    "a.rnk \"РНК клієнта\"," +
                    "a.nms \"Найменування рах.\"," +
                    "a.ost \"Вхідний залишок\"," +
                    "a.dos \"Обороти Дебет\"," +
                    "a.kos \"Обороти Кредит\"," +
                    "a.ostc \"Фактичний залишок\"," +
                    "a.ostc \"Плановий залишок\"," +
		...
		public object[] GetData(string[] data)
		{
			try
			{
                ...
                return BindTableWithNewFilter(@"DISTINCT 
                                                ...
                                                a.nmk NMK,
                                                TO_CHAR(a.date_on,'DD/MM/YYYY') DAT_ON,
                                                TO_CHAR(a.date_off,'DD/MM/YYYY') DAT_OFF, 
                                                a.branch BRANCH,
                                                a.date_on,
                                                a.date_off,
