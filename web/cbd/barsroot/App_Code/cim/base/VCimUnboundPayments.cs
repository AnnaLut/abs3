...
namespace cim
{
    public sealed class VCimUnboundPaymentsRecord : BbRecord
    {
        public VCimUnboundPaymentsRecord(): base()
        {
            fillFields();
        }
        public VCimUnboundPaymentsRecord(BbDataSource Parent) : base (Parent)
        {
            fillFields();
        }
        public VCimUnboundPaymentsRecord(BbDataSource Parent, OracleDecimal RowScn, Decimal? REF, Decimal? CUST_RNK, String CUST_OKPO, String CUST_NMK, String CUST_ND, String BENEF_NMK, Decimal? ACC, String NLS, DateTime? VDAT, Decimal? KV, Decimal? TOTAL_SUM, Decimal? UNBOUND_SUM, String NAZN, Decimal? OP_TYPE_ID, String OP_TYPE, Decimal? PAY_TYPE, String PAY_TYPE_NAME, Decimal? IS_VISED, Decimal? DIRECT, String DIRECT_NAME, String TT, Decimal? BACKGROUND_COLOR)
            : this(Parent)
        {
            this.REF = REF;
        ...
        {
            Fields.Add( new BbField("REF", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Референс платежу"));
            Fields.Add( new BbField("CUST_RNK", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Реєстраційний номер клієнта"));
            Fields.Add( new BbField("CUST_OKPO", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "ЄДРПОУ клієнта"));
            Fields.Add( new BbField("CUST_NMK", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Назва клієнта"));
            Fields.Add( new BbField("CUST_ND", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "№ договору з клієнтом"));
            Fields.Add( new BbField("BENEF_NMK", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Найменування контрагента"));
            Fields.Add( new BbField("ACC", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "ACC рахунку"));
            Fields.Add( new BbField("NLS", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Рахунок"));
            Fields.Add( new BbField("VDAT", OracleDbType.Date, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Дата валютування"));
            Fields.Add( new BbField("KV", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Валюта платежу"));
            Fields.Add( new BbField("TOTAL_SUM", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Сума платежу"));
            Fields.Add( new BbField("UNBOUND_SUM", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Частина суми платежу, не прив’язана до жодного з контрактів"));
            Fields.Add( new BbField("NAZN", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Призначення платежу"));
            Fields.Add( new BbField("OP_TYPE_ID", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "id типу операції (додатковий реквізит)"));
            Fields.Add( new BbField("OP_TYPE", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Тип операції (додатковий реквізит)"));
            Fields.Add( new BbField("PAY_TYPE", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Тип, 0-Реальні платежі, >0 - фантоми"));
            Fields.Add( new BbField("PAY_TYPE_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Назва типу, 0-Реальні платежі, >0 - фантоми"));
            Fields.Add( new BbField("IS_VISED", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Признак візи, 0-незавізований,1-завізований"));
            Fields.Add( new BbField("DIRECT", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Напрям платежу 0 - вхідні, 1 - вихідні"));
            Fields.Add( new BbField("DIRECT_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Назва напряму платежу 0 - вхідні, 1 - вихідні"));
            Fields.Add( new BbField("TT", OracleDbType.Char, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Код операції"));
            Fields.Add( new BbField("BACKGROUND_COLOR", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", ""));        
        }
    ...
    public sealed class VCimUnboundPaymentsFilters : BbFilters
    {
        public VCimUnboundPaymentsFilters(BbDataSource Parent) : base (Parent)
        {
    ...
    public partial class VCimUnboundPayments : BbTable<VCimUnboundPaymentsRecord, VCimUnboundPaymentsFilters>
    {
        public VCimUnboundPayments() : base(new BbConnection())
        {
            // base.Connection.RoleName = "WR_WCS";
        }
        public VCimUnboundPayments(BbConnection Connection)
            : base(Connection)
        {
        }
        public override List<VCimUnboundPaymentsRecord> Select(VCimUnboundPaymentsRecord Item)
        {
            List<VCimUnboundPaymentsRecord> res = new List<VCimUnboundPaymentsRecord>();
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    res.Add(new VCimUnboundPaymentsRecord(
                        this,
