...
//**************
        ...
        private void ReadFIO_dopRekv()
        {
            ...
            try
            {
                ...
                cmd.CommandText = @"select tag, 
                                    ...
                                    from v_customerw 
                                    where rnk = :p_rnk 
                                        and tag in ('SN_LN', 'SN_FN', 'SN_MN', 'SN_4N', 'MPNO ')";
        ...
        public string PrepareSetString()
        {
            ...
            res += "'" + SER.Replace("'", "\"") + "', ";
            res += "'" + NUMDOC.Replace("'", "\"") + "', ";
            res += "'" + ORGAN.Replace("'", "\"").Replace("\\", "\\\\") + "', ";
            res += "'" + PDATE.Replace("'", "\"") + "', ";
            res += "'" + BDAY.Replace("'", "\"") + "', ";
            res += "'" + BPLACE.Replace("'", "\"").Replace("\\", "\\\\") + "', ";
            res += "'" + SEX.Replace("'", "\"") + "', ";
            res += "'" + TELD.Replace("'", "\"").Replace("\\", "\\\\") + "', ";
            res += "'" + TELW.Replace("'", "\"") + "', ";
            res += "'" + ISP.Replace("'", "\"") + "', ";
            res += "'" + NOTES.Replace("'", "\"") + "', ";
            res += "'" + CRISK.Replace("'", "\"") + "', ";
