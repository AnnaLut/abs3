...
<xsl:text>Счет 29*</xsl:text></TD>
<TD width="30%">
<xsl:attribute name="onclick"><xsl:text>Sort('NMS')</xsl:text></xsl:attribute>
<xsl:text>Наименование сч. 29*</xsl:text></TD>
<TD width="1%">
