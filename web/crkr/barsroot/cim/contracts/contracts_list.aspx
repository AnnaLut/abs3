        ...
        <div>
            <table>
                <tr runat="server" id="trActions">
                    <td>
                        <button type="button" id="btAddContract" class="btn-add-ico" style="width: 100px" title="Створити новий контракт"
                    ...
                    <td>
                        <input type="button" id="btContractState" value="Стан" style="width: 100px" title="Переглянути стан контракту"
                    ...
                    <td>
                        <input type="button" id="btLicenses" value="Ліцензії" style="width: 100px" title="Перегляд ліцензій по контракту"
