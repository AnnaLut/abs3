    ...
    public class Utils
    {
        public string ConvertReportStructureToFields(IEnumerable<ReportStructure> structure)
        {
            ...
            foreach (var item in structure)
            {
                ...
                fields.Append("\"Column" + item.AttrNum + "\":{\"type\":\"string\", \"length\":\"" + item.Len + "\", \"value\":\"" + item.Value + "\"}");
        ...
        public string CreateReportQuery(string kod, string date, string isCon, string viewKod, IEnumerable<ReportStructure> structure)
        {
            ...
            return string.Format(query, columns, inerColumns, kod, date, isCon == "1" ? view : "tmp_nbu");
        }
    }
}
