...
public class FunNSIEditFParams
{
    ...
    public CallFunctionsMetaInfo BuildToCallFunctionMetaInfo(CallFunctionsMetaInfo func)
    {
    ...
    public CallFunctionsMetaInfo BuildNsiWebFormName(CallFunctionsMetaInfo func)
    {
