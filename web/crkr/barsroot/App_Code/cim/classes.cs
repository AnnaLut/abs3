        ...
        private void readContract()
        {
            ...
            if (this.ContrId.HasValue)
            {
                try
                {
                    ...
                    oraCmd.CommandText = "select contr_id,contr_type, contr_type_name, num, subnum, rnk,open_date,close_date,kv,s,benef_id,status_id,status_name,comments, branch, branch_name, owner_uid, owner_name, bic, b010, service_branch, ea_url from v_cim_all_contracts where contr_id=:contrId";
        ...
        public decimal SaveContract()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    oraCmd.CommandText = @"begin cim_mgr.create_contract (:p_contr_id,:p_contr_type,:p_rnk,:p_num,:p_subnum,:p_s,:p_kv,:p_benef_id,:p_open_date,:p_close_date,:p_comments,:p_bic,:p_b010,:p_service_branch " + addParams + "); end;";
                    oraCmd.ExecuteNonQuery();
