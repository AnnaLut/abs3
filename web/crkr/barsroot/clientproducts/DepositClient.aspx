                ...
                <td>
                    <table class="InnerTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label3" Text="Код території" runat="server"
                                    CssClass="InfoText" meta:resourcekey="lbClientTerritory" />
                            </td>
                            <td>
                                <asp:TextBox ID="textClientTerritoryReal" meta:resourcekey="textClientTerritoryReal" runat="server" 
                                    ToolTip="Код території фактичної адреси" CssClass="InfoText"  TabIndex="22" BackColor="LightGray"
                                    onblur="doNum('textClientTerritoryReal');"/>
                            </td>
                            <td>
                                <input id="btTerritoryReal" onclick="showTerritoryReal()" tabindex="23" type="button" value="?"
                                    runat="server" class="ImgButton" title="Вибрати код території" visible="TRUE" />
                            </td>
                            <td>
                                <asp:RequiredFieldValidator ID="validatorTextClientTerritoryReal" runat="server" 
                                    ControlToValidate="textClientTerritoryReal" ErrorMessage="необходимо заполнить"
                                    CssClass="Validator" meta:resourcekey="NeedToFill" Enabled="true" />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table class="InnerTable">
                        ...
                        <tr>
                            ...
                            <td align="center">
                              <asp:Label ID="LCellPhone" Text="Невірний мобільний телефон" meta:resourcekey="lbCellPhone" runat="server" CssClass="InfoText" 
                              Visible="false" Textcolor="red" ForeColor="#FF3300" Textalign="Center"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center" style="width: 20%">
                                <input id="btSubmit" runat="server" type="submit" value="Далее" tabindex="101" class="DirectionButton" disabled="disabled"   />
                            </td>
                            <td align="center" width="20%">
