...
public partial class DepositClient : Bars.BarsPage
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request["info"] == null)
            {
                ...
                if (Request["simplify"] != null)
                {
                    ...
                    validatorTextClientTerritoryReal.Enabled = false;
                }
    ...
    private void InitControls(bool reloadINFO)
    {
        ...
        if (BankType.GetDptBankType() == BANKTYPE.UPB)
        {
            ...
            lbVTerritoryReal.Visible = true;
            btTerritory.Visible = true;
            btTerritoryReal.Visible = true;
            validatorTextClientTerritory.Enabled = true;
            validatorTextClientTerritoryReal.Enabled = true;
        }
    ...
    private void FillControlsFromClass(Client client)
    {
        ...
        textClientTerritoryReal.Text = (client.TerritoryReal == Decimal.MinValue ? String.Empty : Convert.ToString(client.TerritoryReal));
    ...
    private void FillClassFromControls()
    {
        try
        {
            ...
            if (!String.IsNullOrEmpty(textClientTerritoryReal.Text))
                client.TerritoryReal = Convert.ToDecimal(textClientTerritoryReal.Text);
    ...
    private void disableValidators()
    {
        ...
        lbVTerritoryReal.Visible = false;
        lbVPhotoDate.Visible = false;
