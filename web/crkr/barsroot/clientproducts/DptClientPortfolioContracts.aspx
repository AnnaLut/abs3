                ...
                <ContentTemplate>
                                    ...
                                    <tr>
                                        <td colspan="2" valign="top">
                                            <Bars:BarsGridViewEx ID="gvHeritage" DataSourceID="dsDepositHeritor" runat="server"
                                                ...
                                                ShowCaption="False" JavascriptSelectionType="SingleRow" DataKeyNames="DPT_ID,DPT_LOCK,ARCHDOC_ID,DAT_END,INHERIT_SHARE,LCV"
                                                OnRowDataBound="gv_RowDataBound">
                                                <Columns>
                                                    <asp:BoundField DataField="DPT_ID" Visible="false"></asp:BoundField>
                                    ...
                                    <tr>
                                        <td colspan="2" valign="top">
                                            <Bars:BarsGridViewEx ID="gvDepositBeneficiary" DataSourceID="dsDepositBeneficiary"
                                                ...
                                                DataKeyNames="DPT_ID,DPT_LOCK,ARCHDOC_ID,TRUSTEE_ID,KV"
                                                OnRowDataBound="gv_RowDataBound">
                                                <Columns>
                                                    <asp:BoundField DataField="DPT_ID" Visible="false"></asp:BoundField>
                                                    <asp:BoundField HtmlEncode="False" DataField="DPT_NUM" SortExpression="DPT_NUM" HeaderText="№<BR>договору">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td style="width:25%" align="center">
                                <asp:Label ID="Label1" runat="server" Text="Невідкличний депозит" BackColor="Beige" Font-Bold="True" />
                            </td>
                            <td style="width:25%" align="center">
