<%@ Page Language="C#" AutoEventWireup="true" Title="Довідник Kdfm01b"
    CodeFile="refkdfm01b.aspx.cs" Inherits="finmon_refkdfm01b" Trace="false" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="formKdfm01b" runat="server">
        ...
        <div class="pageTitle">
            <asp:Label ID="lbTitle" runat="server" Text="Вид активу"></asp:Label>
        </div>
        <p></p>
        <BarsEX:BarsSqlDataSourceEx ID="odsKdfm01b" runat="server" AllowPaging="False" ProviderName="barsroot.core"></BarsEX:BarsSqlDataSourceEx>

        <BarsEX:BarsGridViewEx ID="gvKdfm01b" runat="server" PagerSettings-PageButtonCount="10" PageIndex="0"
            PageSize="15" AllowPaging="True" AllowSorting="True"
            DataSourceID="odsKdfm01b" CssClass="barsGridView" DataKeyNames="CODE,NAME" DateMask="dd/MM/yyyy"
