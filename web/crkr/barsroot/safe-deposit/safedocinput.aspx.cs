...
public partial class safe_deposit_safedocinput : System.Web.UI.Page
{
    ...
    protected void btPay_Click(object sender, EventArgs e)
    {
        ...
        sdpt.Pay(Convert.ToDecimal(n_sk.Value), Convert.ToDecimal(listTT.SelectedValue), DAT_BEGIN.Date, DAT_END.Date, nd.Value, !(String.IsNullOrEmpty(NUMPAR.Text)) ?  Convert.ToDecimal(NUMPAR.Text) : 0 );
