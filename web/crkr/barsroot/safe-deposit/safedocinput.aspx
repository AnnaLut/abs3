                ...
                <td colspan="4">
                    <table class="InnerTable">
                        ...
                        <tr runat="server" id="rdat1">
                            ...
                            <td>
                                <cc1:DateEdit ID="DAT_BEGIN" runat="server" TabIndex="11" Date="" MaxDate="2099-12-31" meta:resourcekey="DAT1Resource1" MinDate=""></cc1:DateEdit></td>                            
                            <td>
                                </td>                                                        
                        </tr>
                        <tr runat="server" id="rdat2">
                            <td>
                                <asp:Label ID="lbDAT2" runat="server" CssClass="InfoText95" meta:resourcekey="lbRef"
                                    Style="text-align: center"></asp:Label></td>
                            <td>
                                <cc1:DateEdit ID="DAT_END" runat="server" TabIndex="12" 
                                 onblur="CalcDate();" 
                        ...
                        <tr runat="server" id="rdays" visible="false">
                            ...
                            <td>
                                <asp:TextBox ID="TERM" runat="server" CssClass="InfoText95" TabIndex="13"  meta:resourcekey="NUMPARResource2" Text="" onblur="CalcDate();" ></asp:TextBox></td>
                            <td>
                                </td>
                        </tr>
                        <tr runat="server" id="rnumpar">
                            <td>
                                <asp:Label ID="lbNUMPAR" runat="server" CssClass="InfoText95" meta:resourcekey="lbRef"
                                    Style="text-align: center"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="NUMPAR" runat="server" CssClass="InfoText95" TabIndex="14" meta:resourcekey="NUMPARResource1" Text="0"></asp:TextBox></td>
                            <td>
                                </td>
                        </tr>
                    </table>
