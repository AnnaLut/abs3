<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="process.aspx.cs" Inherits="credit_crdsrv_process" Title="Обработка заявки №{0}"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <Bars:BarsObjectDataSource ID="ods" runat="server" SelectMethod="SelectCrdsrvBidInfoqueries"
            TypeName="credit.VWcsCrdsrvBidInfoqueries">
            <SelectParameters>
    ...
    <div class="formViewContainer">
        <asp:ObjectDataSource ID="odsFV" runat="server" SelectMethod="SelectCrdsrvBidInfoquery"
            TypeName="credit.VWcsCrdsrvBidInfoqueries">
            <SelectParameters>
                <asp:QueryStringParameter Name="BID_ID" QueryStringField="bid_id" Type="Decimal" />
                <asp:QueryStringParameter QueryStringField="srvhr" Name="SRV_HIERARCHY" Type="String" />
