<%@ Page Language="C#" MasterPageFile="~/credit/manager/master.master" AutoEventWireup="true"
    CodeFile="ins_survey.aspx.cs" Inherits="credit_manager_ins_survey" Theme="default"
    Title="Анкета страховки клиента {0} - {1} заявки №{2}" meta:resourcekey="PageResource1" %>
