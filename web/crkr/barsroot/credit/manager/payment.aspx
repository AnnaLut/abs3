                                    ...
                                    <colgroup>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <bec:TextBoxRefer ID="PI_PARTNER_ID" runat="server" TAB_NAME="WCS_PARTNERS" KEY_FIELD="ID" SEMANTIC_FIELD="NAME" SHOW_FIELDS="PTN_OKPO,PTN_NLS,PTN_MFO,PTN_NAME,ID_MATHER,BRANCH" />
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PI_WHO_INVOLVEDTitle" runat="server" Text="Ким залучений клієнт :" />
                                            </td>
                                            <td>
                                                <bec:TextBoxString ID="PI_WHO_INVOLVED" runat="server" Rows="2" Width="300px" MinLength="0" MaxLength="50" IsRequired="false" />
                                            </td>
                                        </tr>
                                    </colgroup>
                                </table>
