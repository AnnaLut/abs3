...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <asp:FileUpload ID="fileLoader" runat="server" Visible="false"/>
    <asp:
    <div class="dataContainer">
        ...
        <table class="dataTable">
            ...
            <asp:ListView ID="lv" runat="server" DataSourceID="ods" OnItemCommand="lv_ItemCommand"
                ...
                <ItemTemplate>
                    <tr id="row" runat="server">
                        <td runat="server">
                            <asp:Label ID="TEMPLATE_NAME" runat="server" Text='<%# Eval("TEMPLATE_NAME") + " (" + Eval("DOCEXP_TYPE_ID") + ")" %>'></asp:Label>
                        </td>
                        <td runat="server">
                            <% /*<asp:CheckBox ID="cbPrint" runat="server" />*/ %>
                            <asp:Label ID="lbCbPrint" runat="server" Visible="false" Text='<%# Eval("TEMPLATE_ID") + ";" + Eval("WS_ID") + ";" + Eval("WS_NUM") + ";" + Eval("DOCEXP_TYPE_ID") %>'></asp:Label>
            ...
            <tr>
                <% /*<td class="allPrintButtonContainer" colspan="4">
                    <asp:Button ID="bPrintAll" runat="server" SkinID="bPrintAll" OnClick="bPrintAll_Click" Text="Роздрукувати все"
                        meta:resourcekey="bPrintAllResource1" />
                </td>*/%>
            ...
            <tr>
                <td>
                    <asp:Label ID="msgSuccess" runat="server" Visible="false" Text="Збережено успішно" ></asp:Label>
                </td>
            </tr>
        </table>
    </div>
