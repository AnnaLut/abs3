...
public partial class credit_manager_prescoringresults : Bars.BarsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            CHPS.Value = cmn.wu.GET_ANSW_DECIMAL(BID_ID, "4PS");
            DP.Value = cmn.wu.GET_ANSW_DECIMAL(BID_ID, "DP");
            P4DP.Value = cmn.wu.GET_ANSW_DECIMAL(BID_ID, "P4DP");
            P4DS.Value = cmn.wu.GET_ANSW_DECIMAL(BID_ID, "P4DS");
            RB.Value = cmn.wu.GET_ANSW_DECIMAL(BID_ID, "RB");
            RB.Value = cmn.wu.GET_ANSW_DECIMAL(BID_ID, "RB");
