<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="process_multi.aspx.cs" Inherits="credit_secretarycc_process_multi"
    Title="Обработка заявок №{0}" Theme="default" Trace="false" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <Bars:BarsObjectDataSource ID="ods" runat="server" SelectMethod="SelectCcBidsInfoqueries"
    ...
    <div class="formViewContainer">
        <asp:ObjectDataSource ID="odsFV" runat="server" SelectMethod="SelectCcBidsInfoquery"
            TypeName="credit.VWcsCcBidInfoqueries">
            <SelectParameters>
                <asp:QueryStringParameter Name="BID_IDS" QueryStringField="bid_ids" Type="String" />
                <asp:QueryStringParameter QueryStringField="srvhr" Name="SRV_HIERARCHY" Type="String" />
