<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="printdocs.aspx.cs" Inherits="credit_srv_printdocs" Title="Печать документов по заявке №{0}"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectSrvBidTemplates" TypeName="credit.VWcsSrvBidTemplates">
            <SelectParameters>
                    ...
                    <tr id="row" runat="server">
                        ...
                        <td runat="server">
                            <asp:ImageButton ID="ibPrint" runat="server" ToolTip="Печать" CausesValidation="False"
                                ImageUrl="/Common/Images/default/16/print.png" CommandName="Print" 
                                CommandArgument='<%# Eval("TEMPLATE_ID") + ";" + Eval("WS_NUM") + ";" + Eval("DOCEXP_TYPE_ID") %>' 
                        ...
                        <td runat="server">
                            ...
                            <asp:Label ID="lbIQUERY_ID" runat="server" Text='<%# Eval("IQUERY_ID") %>' Visible="false"></asp:Label>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:ListView>
