...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <bars:BarsObjectDataSource ID="odsInstantData" runat="server" SelectMethod="SelectCard"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="-1" Name="COUNT" Type="String" />
        </SelectParameters>
    </bars:BarsObjectDataSource>
                ...
                <asp:WizardStep ID="wsInstantCheck" Title="Зв`язка карток" runat="server" StepType="Step"
                    ...
                    <div class="wizard_step_container">
                        <table border="0" cellpadding="3" cellspacing="0" class="data_table">
                            ...
                            <tr>
                                <td>
                                    <asp:Panel ID="Panel1" runat="server" GroupingText="Фiльтр результатiв обробки">
                                        <table border="0" cellpadding="3" cellspacing="0" class="data_table">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="Карт. рахунок" />&nbsp;
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txbxCardNumber" runat="server" OnClientClick="txbxCardNumberClick(this);"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnAddCardNumFilter" runat="server" Text="Додати" OnClick="btnAddCardNumFilter_Click" />
                                                </td>
                                                <td align="center">
                                                    <asp:ListBox ID="lstbxCardNumsList" runat="server" Height="90px" Width="130px" SelectionMode="Multiple"> 
                                                    </asp:ListBox>
                                                    <br />
                                                    <asp:Button ID="btnDelCardNumsListItem" runat="server" Text="Видалити" OnClick="btnDelCardNumsListItem_Click" />
                                                </td> 
                                                <td>
                                                    <asp:Button ID="btnFilterApply" runat="server" Text="Застосувати" OnClick="btnFilterApply_Click"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
