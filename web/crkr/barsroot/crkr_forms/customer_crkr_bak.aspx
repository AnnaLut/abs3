<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customer_crkr_bak.aspx.cs" Inherits="customer_crkr_customer_crkr_bak" %>
...
<body>
    <form id="formOperationList" runat="server">
        <div class="pageTitle">
            <asp:Label ID="lbTitle" runat="server" Text="Портфель клієнтів ЦРКР" />
        </div>
        ...
        <BarsEx:BarsGridViewEx ID="gvMain" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:TemplateField HeaderText="РНК">
                    <ItemTemplate>
                        <asp:HyperLink runat="server" Text='<%#Eval("RNK") %>' ID="btRNK" NavigateUrl='<%#"~/Crkr/ClientProfile/Index?rnk="+Eval("RNK")+"&button=true" %>'></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <%--<asp:BoundField DataField="DOC_TYPE" HeaderText="Документ" />--%>
                ...
                <%--<asp:BoundField DataField="NOTES" HeaderText="Джерело(примітка)" />--%>
