...
public partial class customer_crkr_customer_crkr : Bars.BarsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string burial = Request["burial"];

        if (!String.IsNullOrEmpty(burial))
        {
            pnInfo.GroupingText = "Пошук спадкоємців:";
        }
