	...
	<body onload="focusControl('btDone');">
		...
		<form id="Form1" method="post" runat="server">
			<table id="Table1" class="MainTable">
				<tr>
					<td>
						<asp:Label id="Label1" meta:resourcekey="Label1" runat="server" CssClass="InfoLabel">Выберите из списка страну</asp:Label>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td align="center">
						<input id="btDone" meta:resourcekey="btDone" runat="server" class="AcceptButton" type="button" onclick="Exit()" value="Выбрать"
