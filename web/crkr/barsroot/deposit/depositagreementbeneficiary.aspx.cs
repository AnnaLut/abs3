...
public partial class DepositAgreementBeneficiary : Bars.BarsPage
{
    ...
    public DepositAgreementBeneficiary()
    {
    ...
    private void btEnter_ServerClick(object sender, System.EventArgs e)
    {
        ...
        try
        {
            ...
            _dbLogger.Info("Пользователь выбрал 3 лицо с рнк " + rnkstr +
            ...
            {
                _dbLogger.Info("При оформлении доп. соглашения по депозитному договору №" + Convert.ToString(dpt_id) +
