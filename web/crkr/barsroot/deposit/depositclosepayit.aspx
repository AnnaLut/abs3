					    ...
					    <div class="screen_action">
						    <table class="InnerTable">
							    <tr>
                                    ...
                                    <td width="5%">
                                     <asp:label id="LabelIRR" meta:resourcekey="LabelIRR" runat="server" CssClass="InfoText" ForeColor = "red" Visible = "false">Попередження: Вклад є невідкличним!</asp:label>									    
								    </td>
								    <td width="30%">
