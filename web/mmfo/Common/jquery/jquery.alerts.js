...
(function ($) {
    ...
    $.popups = {
        ...
        _autoHeight: function (frame, frameContainer, originalHeight) {
            ...
            else if (frame.contentWindow && frame.contentWindow.document && frame.contentWindow.document.body && frame.contentWindow.document.body.scrollHeight)
        ...
        _iframe: function (oArg) {
            ...
            $('#dialogFrame').one("load", function () {
            	doc = window.frames["dialogFrame"].document;
