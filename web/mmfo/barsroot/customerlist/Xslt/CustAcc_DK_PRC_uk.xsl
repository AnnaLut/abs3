...
<TD align="right" noWrap="true">
  ...
  <TD align="right" noWrap="true">
	<xsl:if test="OST&gt;0"><xsl:attribute name="style">COLOR: darkblue</xsl:attribute>
    <xsl:value-of select="format-number(OST div DIG, $frmtStr, 'ua')" />
  </xsl:if>
	<xsl:if test="OST&lt;=0">
    <xsl:value-of select="format-number(0, $frmtStr, 'ua')" />
...
<TD align="right" noWrap="true">
	<xsl:if test="OSTC&gt;0"><xsl:attribute name="style">COLOR: darkblue</xsl:attribute>
    <xsl:value-of select="format-number(OSTC div DIG, $frmtStr, 'ua')" />
  </xsl:if>
	<xsl:if test="OSTC&lt;=0">
    <xsl:value-of select="format-number(0, $frmtStr, 'ua')" />
...
<TD align="right" noWrap="true">
	...
	<xsl:if test="OSTB&lt;0"><xsl:attribute name="style">COLOR: red</xsl:attribute>
    <xsl:value-of select="format-number(OSTB div DIG, $frmtStr, 'ua')" />
  </xsl:if>
</TD>
<TD align="right" noWrap="true">
	<xsl:if test="OSTB&gt;0"><xsl:attribute name="style">COLOR: darkblue</xsl:attribute>
    <xsl:value-of select="format-number(OSTB div DIG, $frmtStr, 'ua')" />
  </xsl:if>
	<xsl:if test="OSTB&lt;=0">
    <xsl:value-of select="format-number(0, $frmtStr, 'ua')" />
