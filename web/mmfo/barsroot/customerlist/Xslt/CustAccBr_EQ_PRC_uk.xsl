    ...
    <TABLE cellspacing="0" cellpadding="2" bordercolor="Black" border="1" style="background-color:White;border-color:Black;font-family:Verdana;font-size:8pt;width:100%;border-collapse:collapse;cursor:hand">
      <TR align="center" style="color:White;background-color:Gray;font-family:Verdana;font-size:8pt;font-weight:bold;">
        ...
        <TD width="15%">
          ...
          <xsl:text>Вхідний залишок (екв.)</xsl:text>
        </TD>
        <TD width="5%">
          <xsl:attribute name="onclick">
        ...
        <TD width="15%">
          <xsl:attribute name="onclick">
            <xsl:text>Sort('OSTCEQ')</xsl:text>
          </xsl:attribute>
          <xsl:text>Фактичний залишок (екв.)</xsl:text>
        </TD>
        <TD width="15%">
          <xsl:attribute name="onclick">
        ...
        <TD width="15%">
          <xsl:attribute name="onclick">
            <xsl:text>Sort('OSTBEQ')</xsl:text>
          </xsl:attribute>
          <xsl:text>Плановий залишок (екв.)</xsl:text>
        </TD>
        <TD>
          <xsl:attribute name="onclick">
            <xsl:text>Sort('DAPP')</xsl:text>
          </xsl:attribute>
        ...
        <TD>
          ...
          <xsl:text>Код безбал. від.22</xsl:text>
        </TD>
        <TD >
          <xsl:attribute name="onclick">
