...
public partial class Default : Bars.BarsPage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        else
        {
            ...
            {
                _dbLogger.Info("Пользователь получил информацию из страницы SearchResults",
                    "socialdeposit");
    ...
    private void btUpdate_Click(object sender, System.EventArgs e)
    {
        ...
        try
        {
            ...
            _dbLogger.Info("Пользователь обновил данные о клиенте №" + client.ID.ToString() + " на странице карточки вкладчика",
                "socialdeposit");
    ...
    private bool clientChanged()
    {
        ...
        if (dpt.Client.Code != Client.DefaultOKPO())
        {
            ...
            _dbLogger.Debug("Проверка на существование клиента на странице карточки клиента. ДРФО=" + dpt.Client.Code,
                "socialdeposit");
