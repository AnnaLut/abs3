...
public partial class safe_deposit_dialog_safe_opendeal : System.Web.UI.Page
{
    ...
    private void InitControls()
    {
        ...
        try
        {
            ...
            cmdGetDealNum.CommandText = "SELECT bars_sqnc.get_nextval('S_CC_DEAL') FROM dual";
            ...
            cmdGetNls.CommandText = "SELECT substr(f_newnls((SELECT MAX (a.acc) FROM accounts a, branch_parameters b WHERE a.nls = b.val AND a.kv = 980 AND B.TAG = 'CASH'),'SD_DR','3600'),1,14) FROM dual ";
