...
<!--FDAT=Date of event;ISP= Id. of perf.;FIO= Full name of performer;TXT=Text-->
...
<TD width="5%">
<xsl:attribute name="onclick"><xsl:text>Sort('EV_ID')</xsl:text></xsl:attribute>
<xsl:text>№</xsl:text></TD>
<TD width="10%">
<xsl:attribute name="onclick"><xsl:text>Sort('EV_DT')</xsl:text></xsl:attribute>
<xsl:text>Date of event</xsl:text></TD>
<TD width="5%">
<xsl:attribute name="onclick"><xsl:text>Sort('USR_ID')</xsl:text></xsl:attribute>
<xsl:text>Id. of perf.</xsl:text></TD>
<TD width="15%">
<xsl:attribute name="onclick"><xsl:text>Sort('USR_NM')</xsl:text></xsl:attribute>
<xsl:text>Full name of performer</xsl:text></TD>
<TD width="60%">
<xsl:attribute name="onclick"><xsl:text>Sort('EV_DSC')</xsl:text></xsl:attribute>
<xsl:text>Text</xsl:text></TD>
</TR>
