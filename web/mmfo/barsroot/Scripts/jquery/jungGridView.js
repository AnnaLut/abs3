(function ($) {
    ...
    function theadInputChec(elem) {
        var th = elem.find('thead tr th');
        var mainChrck = th.find('input:checkbox');
        var index = th.index();
        mainChrck.click(function () {
            if (mainChrck.prop('checked')) {
                elem.find('tbody tr').find('td').slice(index).find('input:checkbox').prop('checked', 'checked');
            }
            else {
                elem.find('tbody tr').find('td').slice(index).find('input:checkbox').removeAttr('checked');
            }
        });
