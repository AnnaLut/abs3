...
public partial class deposit_DptRequestArchive : System.Web.UI.Page
{
    ...
    public deposit_DptRequestArchive()
    {
    ...
    {
        _dbLogger.Info(String.Format("Користувач виконав пошук запитів за період з {0} по {1}.", tbDateStart.Text, tbDateFinish.Text), "deposit");                                        
    }
