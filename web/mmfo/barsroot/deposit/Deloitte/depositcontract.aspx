        ...
        <tr>
            <td>
                <table class="InnerTable">
                    ...
                    <tr>
                        <td colspan="8">
                            <asp:RadioButton ID="rbOnBeneficiary" meta:resourcekey="rbOnBeneficiary" runat="server"
                                TabIndex="6" Text="Вклад на бенефіціара" Font-Bold="true" CssClass="BaseCheckBox" GroupName="RadioThird" Checked ="false" Enabled ="false"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="8">
                            <asp:RadioButton ID="rbOnChildren" meta:resourcekey="rbOnChildren" runat="server" 
                                TabIndex="6" Text="Вклад на користь малолітної особи" Font-Bold="true" CssClass="BaseCheckBox" GroupName="RadioThird" Checked ="false" Enabled ="false" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="8">
                            <asp:RadioButton ID="rbOnOwner" meta:resourcekey="rbOnOwner" runat="server" 
                                TabIndex="6" Text="Вклад на ім'я малолітної особи" Font-Bold="true" CssClass="BaseCheckBox" onclick="searchOwner(this.form)" GroupName="RadioThird" Checked ="false" Enabled ="false"/>
                        </td>
                    </tr>
                </table>
            </td>
