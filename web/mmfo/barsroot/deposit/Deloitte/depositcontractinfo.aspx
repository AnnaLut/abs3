...
<head runat="server">
    ...
    <script src="../../clientproducts/js/Base64.js"></script>
    <link href="/barsroot/deposit/style/dpt.css" type="text/css" rel="stylesheet" />
    <script type="text/javascript" language="javascript">
        function checkedFunction() {
            var cbBigFont = document.getElementById('eadPrintContract_cbBigFont');
            var cbEnglis = document.getElementById('eadPrintContract_cbEnglish');

            if (cbBigFont.checked)
                cbEnglis.disabled = true;
            else
                cbEnglis.disabled = false;

            if (cbEnglis.checked)
                cbBigFont.disabled = true;
            else
                cbBigFont.disabled = false;
        }
                        ...
                        <tr>
                            <td>
                                <table class="InnerTable" id="ButtonTable">
                                    <tr>
                                        <td style="width: 25%">
                                            <asp:Button ID="btFirstPayment" runat="server" TabIndex="1" meta:resourcekey="btFirstPayment" Width="200"
                                                Text="Первинний внесок" CssClass="AcceptButton" OnClick="btFirstPayment_Click" OnClientClick="if (check_sign()) return false;" />
                                        </td>
                                        <td style="width: 25%">
                                            <asp:Button ID="btAddAgreement" runat="server" TabIndex="6" Width="200"
                                                Text="Додаткові угоди" CssClass="AcceptButton" OnClick="btAddAgreement_Click" OnClientClick="if (check_sign()) return false;" />
                                        </td>
                                        <td style="width: 25%">
                                            <asp:Button ID="btPercentPay" Text="Виплата відсотків" runat="server" TabIndex="3" Width="200"
                                                CssClass="AcceptButton" OnClick="btPercentPay_Click" OnClientClick="if (check_sign()) return false;" />
                                        </td>
                                        <td style="width: 25%">
                                            <asp:Button ID="btnNext" meta:resourcekey="btnNext" TabIndex="19" runat="server" Width="200"
                                                Text="Портфель договорів" CssClass="AcceptButton" OnClientClick="if (check_sign()) return false;" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Button ID="btRreplenish" Text="Поповнити вклад" TabIndex="2" type="button" runat="server"
                                                OnClick="btRreplenish_Click" class="AcceptButton" Width="200" meta:resourcekey="btRreplenish" OnClientClick="if (check_sign()) return false;" />
                                            <!-- onclick="location.replace('DepositAddSum.aspx?dpt_id=' + document.getElementById('dpt_id').value + '&agr_id=2&fast=Y&portfolio=Y');" -->
                                        </td>
                                        <td>
                                            <asp:Button ID="btReport" TabIndex="7" runat="server" CssClass="AcceptButton" OnClick="btReport_Click" Width="200"
                                                Text="Виписка" OnClientClick="if (check_sign()) return false;" />
                                        </td>
                                        <td>
                                            <asp:Button ID="btPayout" Text="Виплата/Штрафування" runat="server" TabIndex="4" Width="200"
                                                CssClass="AcceptButton" OnClick="btPayout_Click" OnClientClick="if (check_sign()) return false;" />
                                        </td>
                                        <td>
                                            <asp:Button ID="btShowHistory" Text="Історія" runat="server" meta:resourcekey="btShowHistory" Width="200"
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <asp:Button ID="btSurvey" TabIndex="16" meta:resourcekey="btSurvey" runat="server" class="AcceptButton" Width="200"
                                                type="button" Text="Заповнити анкету" OnClientClick="OpenSurvey('/barsroot/Survey/Survey.aspx?par=SURVDPT0&rnk=' + document.getElementById('rnk').value);" />
                                        </td>
                                        <td></td>
                                    </tr>
                                </table>
