                        ...
                        <script>
                          function bindGridRegular() {
                            ...
                            grid.prepend('<thead><tr>\
                                ...
                                <th data-field="USERID_MADE">Створив користувач</th>\
                                <th data-field="BRANCH_MADE">Відділення</th>\
                                <th data-field="BRANCH_CARD">Бранч, де відкрито картрахунок</th>\
                                <th data-field="DATETIMESTAMP">Дата/час створення</th>\
                            </tr></thead>');
                            ...
                            grid.kendoGrid({
                              ...
                              columns: [{
                                ...
                                title: "Призначення"
                                  ...
                                  field: "BRANCH_CARD",
                                  title: "Бранч, де відкрито картрахунок",
                                  width: 150
                              }, {
                                  field: "DATETIMESTAMP",
                                  title: "Дата/час створення",
                                  width: 100
                              }]
                            });
                          }
