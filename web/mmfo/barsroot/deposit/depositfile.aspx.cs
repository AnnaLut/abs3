...
public partial class DepositFile : Bars.BarsPage
{
	...
	private void Page_Load(object sender, System.EventArgs e)
	{
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in Page_Load", except.ToString());
        }
    }
	/// <summary>
	/// 
    ...
    override protected void OnInit(EventArgs e)
	{
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in OnInit", except.ToString());
        }
    }
	...
	private void InitializeComponent()
	{
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in void InitializeComponent()", except.ToString());
        }
    ...
    protected override void RaisePostBackEvent(IPostBackEventHandler sourceControl, string eventArgument)
    {
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in RaisePostBackEvent()", except.ToString());
        }
        try
        {
    ...
    private void InitGrid()
    {
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in InitGrid()", except.ToString());
        }
	...
	private void ShowRecords(BankFile bf)
	{
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in ShowRecords()", except.ToString());
        }
    }		
	/// <summary>
	/// 
	...
	private void ShowRecordsNoUpdate(BankFile bf)
	{
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in ShowRecordsNoUpdate()", except.ToString());
        }
    }
	/// <summary>
	...
	private void RegisterClientScript()
	{
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in RegisterClientScript()", except.ToString());
        }
	...
	private void btUpload_ServerClick(object sender, System.EventArgs e)
	{
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in btUpload_ServerClick()", except.ToString());
        }
    }
	/// <summary>
	/// 
	...
	private void btPay_ServerClick(object sender, System.EventArgs e)
	{
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in btPay_ServerClick()", except.ToString());
        }
    }
	/// <summary>
	/// 
	...
	private void LoadFileTypes()
	{
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in LoadFileTypesk()", except.ToString());
        }
        finally	
		{
    ...
    protected void gridRecords_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in gridRecords_RowDataBound()", except.ToString());
        }
    }
    /// <summary>
    /// 
    ...
    protected void btCreateHeader_Click(object sender, EventArgs e)
    {
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in btCreateHeader_Click()", except.ToString());
        }
    }
    /// <summary>
    /// 
    ...
    private void DisableControls()
    {
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in DisableControls()", except.ToString());
        }
    }
    /// <summary>
    /// 
    ...
    private void InsertHeader()
    {
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in InsertHeader()", except.ToString());
        }
        finally
        {
            if (connect.State != ConnectionState.Closed)
    ...
    protected void btFinish_ServerClick(object sender, EventArgs e)
    {
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in btFinish_ServerClick()", except.ToString());
        }
    }
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        {
            var _dbLogger = DbLoggerConstruct.NewDbLogger();
            _dbLogger.Debug("{0} Exception caught. in OnPreRender()", except.ToString());
        }
