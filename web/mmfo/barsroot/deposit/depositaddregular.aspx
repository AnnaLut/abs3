...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function validateForm() {
            ...
            var nextBankDate = new Date(nextBankDateArray[2], parseInt(nextBankDateArray[1], 10) - 1, nextBankDateArray[0])
            ...
            if (startDate.value == '') {
                ...
                if (startDate1 < nextBankDate) {
                    alert('Дата "з" не може бути меншою за наступну банківську дату');
                    result = false;
                    addClass(startDate, 'error');
        ...
        <tr align="center"  dir="ltl">
            ...
            <tr>
                <td class="style2">
                    ...
                    <tr>
                        <td class="style5">
                            <asp:Label ID="lbStartDate" meta:resourcekey="lbStartDate" runat="server" CssClass="InfoText" >Дата початку дії договору (більша за поточну/поточна)</asp:Label>
                        </td>
                        <td class="style6">
