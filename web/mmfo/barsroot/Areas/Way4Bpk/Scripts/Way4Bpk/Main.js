...
function Search() {
    ...
    g_data = {
        ndNumber: ndNumber, accNls: accNls, custName: custName, okpo: okpo,
...
function onClickBtn(btn) {
    ...
    switch (btn.id) {
        ...
        case "btnNew":
            ...
            if (getCusttype() != 1) {
                $('.only-fo').css('display', 'none');
                $('.docs-scan').css('display', 'none');
            }
            break;
...
$(document).ready(function () {
    ...
    InitGridWindow({ windowID: "#dialogNewCard", srcSettings: { title: "Вибір нової картки", width: "900px", open: prepareNewCard, draggable: false } });
    InitGridWindow({
        windowID: "#dialogGo2BackOffice", srcSettings: {
            title: "Зміна інформації про передачу до бек-офісу", open: function () {
    ...
    InitGridWindow({
        windowID: "#dialogCardUpdate", srcSettings: {
            title: "Дата видачі карти", width: "900px", open: function () {
