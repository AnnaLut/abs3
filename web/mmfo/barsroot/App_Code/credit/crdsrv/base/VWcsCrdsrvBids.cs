...
namespace credit
{
    public sealed class VWcsCrdsrvBidsRecord : BbRecord
    {
        public VWcsCrdsrvBidsRecord(): base()
        {
            fillFields();
        }
        public VWcsCrdsrvBidsRecord(BbDataSource Parent) : base (Parent)
        {
            fillFields();
        }
        public VWcsCrdsrvBidsRecord(BbDataSource Parent, OracleDecimal RowScn, Decimal? BID_ID, String SUBPRODUCT_ID, String SUBPRODUCT_NAME, DateTime? CRT_DATE, String F, String I, String O, DateTime? BDATE, String INN, Decimal? SUMM, Decimal? OWN_FUNDS, String TERM, String CREDIT_CURRENCY, Decimal? SINGLE_FEE, Decimal? MONTHLY_FEE, Decimal? INTEREST_RATE, String REPAYMENT_METHOD, Decimal? REPAYMENT_DAY, String GARANTEES, Decimal? MGR_ID, String MGR_FIO, String BRANCH, String BRANCH_NAME, String STATES, String FIO, String SRV_HIERARCHY, Decimal? CHECKOUTED/*, String STATUS_REVIEW*/)
            : this(Parent)
        {
            this.BID_ID = BID_ID;
        ...
        {
            Fields.Add( new BbField("BID_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Идентификатор заявки"));
            Fields.Add( new BbField("SUBPRODUCT_ID", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Идентификатор субпродукта"));
            Fields.Add( new BbField("SUBPRODUCT_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Наименование субпродукта"));
            Fields.Add( new BbField("CRT_DATE", OracleDbType.Date, false, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Дата создания заявки"));
            Fields.Add( new BbField("F", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Ф клиента"));
            Fields.Add( new BbField("I", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "И клиента"));
            Fields.Add( new BbField("O", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "О клиента"));
            Fields.Add( new BbField("BDATE", OracleDbType.Date, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Дата рождения клиента"));
            Fields.Add( new BbField("INN", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "ИНН клиента"));
            Fields.Add( new BbField("SUMM", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Сумма кредита"));
            Fields.Add( new BbField("OWN_FUNDS", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Сума власних коштів"));
            Fields.Add( new BbField("TERM", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Срок кредита"));
            Fields.Add( new BbField("CREDIT_CURRENCY", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Валюта кредиту"));
            Fields.Add( new BbField("SINGLE_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Комісія банку разова"));
            Fields.Add( new BbField("MONTHLY_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Комісія банку щомісячна"));
            Fields.Add( new BbField("INTEREST_RATE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Відсоткова ставка"));
            Fields.Add( new BbField("REPAYMENT_METHOD", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Метод погашення"));
            Fields.Add( new BbField("REPAYMENT_DAY", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "День погашення"));
            Fields.Add( new BbField("GARANTEES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Обеспечения"));
            Fields.Add( new BbField("MGR_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Ид менеджера"));
            Fields.Add( new BbField("MGR_FIO", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "ФИО менеджера"));
            Fields.Add( new BbField("BRANCH", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Идентификатор отделения"));
            Fields.Add( new BbField("BRANCH_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Наименование отделения"));
            Fields.Add( new BbField("STATES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Состояния"));
            Fields.Add( new BbField("FIO", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "ФИО клиента"));
            Fields.Add( new BbField("SRV_HIERARCHY", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Идентификатор уровеня иерархии"));
            Fields.Add( new BbField("CHECKOUTED", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "В обработке 0/1"));
//            Fields.Add(new BbField("STATUS_REVIEW", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_CRDSRV_BIDS", ObjectTypes.View, "Заявки кредитной службы (Представление)", "Статус рішення"));
        }
    ...
    public sealed class VWcsCrdsrvBidsFilters : BbFilters
    {
        public VWcsCrdsrvBidsFilters(BbDataSource Parent) : base (Parent)
        {
    ...
    public partial class VWcsCrdsrvBids : BbTable<VWcsCrdsrvBidsRecord, VWcsCrdsrvBidsFilters>
    {
        public VWcsCrdsrvBids() : base(new BbConnection())
        {
            // base.Connection.RoleName = "WR_WCS";
        }
        public VWcsCrdsrvBids(BbConnection Connection)
            : base(Connection)
        {
        }
        public override List<VWcsCrdsrvBidsRecord> Select(VWcsCrdsrvBidsRecord Item)
        {
            List<VWcsCrdsrvBidsRecord> res = new List<VWcsCrdsrvBidsRecord>();
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    res.Add(new VWcsCrdsrvBidsRecord(
                        this,
