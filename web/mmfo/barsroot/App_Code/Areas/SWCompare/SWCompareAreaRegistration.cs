...
/// <summary>
/// Summary description for SWCompareAreaRegistration
/// </summary>
public class SWCompareAreaRegistration : AreaRegistration
{
    public override string AreaName { get { return "SWCompare"; } }
    ...
    private void BindAreaDI()
    {
        ...
        ninjectKernel.Bind<ISWCompareRepository>().To<SWCompareRepository>();
    }
}