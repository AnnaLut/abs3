...
{
    public class SaveDealParam
    {
        public string CC_ID { get; set; }
        public decimal nVidd { get; set; }
        public decimal nKv { get; set; }
        public string colDatDU { get; set; }
        public string colDatDV { get; set; }
        public string colDatEndDog { get; set; }
        public decimal RNKB { get; set; }
        public decimal IR { get; set; }
        public decimal colSumma { get; set; }
        public string colSummaZ { get; set; }
