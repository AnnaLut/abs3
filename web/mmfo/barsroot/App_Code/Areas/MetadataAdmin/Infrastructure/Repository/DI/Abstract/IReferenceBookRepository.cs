...
namespace BarsWeb.Areas.MetaDataAdmin.Infrastructure.Repository.DI.Abstract
{
    public interface IReferenceBookRepository
    {
        ...
        string InsertFilter(List<BarsWeb.Areas.Ndi.Infrastructure.Repository.Helpers.FilterRowInfo> filterRows,string filterStructure, int tableid,
        ...
        GetDataResultInfo GetPatternData(string patternName);
        /// <summary>
       ...
       // DataSet ArchiveGrid(string kodf);
        ...
        CallFunctionMetaInfo GetFunctionsMetaInfo(int? codeOper);
