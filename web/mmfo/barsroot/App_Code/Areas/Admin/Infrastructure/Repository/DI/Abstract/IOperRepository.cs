...
namespace BarsWeb.Areas.Admin.Infrastructure.Repository.DI.Abstract
{
    public interface IOperRepository
    {
        ...
        IEnumerable<TTS_OpFlags> FlagsData(int[] code, string tt);
        ...
        void RemoveProp(string tt, string tag);
        byte[] ExportOperationsSQL(string cod);
        void UpdateFlagValue(string tt, decimal code , string value);
