...
namespace BarsWeb.Areas.Cash.Controllers
{
    ...
    public class SyncController : ApplicationController
    {
        ...
        public SyncController(ISyncRepository syncRepository, IAccountRepository accountRepository)
        {
        ...
        private JsonResult LoginLogout(string login, Func<JsonResult> f)
        {
            ...
            _accountRepository.LoginUser(login);

            JsonResult result = f();

            _accountRepository.LogOutUser();
            return result;
        }
        #endregion
