    ...
    public class TresholdController : ApiController
    {
        ...
        public HttpResponseMessage Post(Treshold treshold)
        {
            ...
            else
            {
                ...
                {
                    if (ex.Message.Contains("Допускається лише один запис"))
                    {
                        return Request.CreateErrorResponse(HttpStatusCode.BadRequest, @"Запис вже існує. Для зміни данних необхідно використати Редагувати
                                                                                        (але при цьому дату початку дії змінити неможна).Якщо є необхідність
                                                                                        задати нову дату дії, то потрібно поточний запис видалити і створити новий.");
                    }
                    else
                    {
