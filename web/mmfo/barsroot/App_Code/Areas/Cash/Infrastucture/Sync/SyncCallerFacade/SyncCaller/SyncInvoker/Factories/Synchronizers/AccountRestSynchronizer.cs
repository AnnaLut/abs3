...
namespace BarsWeb.Areas.Cash.Infrastructure.Sync
{
    ...
    {
        public AccountRestSynchronizer(ICenterAccountRepository centerAccountRepository, ISyncRepository syncRepository)
        ...
        {
            string bankDatesUrl = CombineUrl(connectionOption.Url, GetBankDatesActionMethod + "?mfoCode=" + connectionOption.Mfo);
            ...
            */
            ...
            try
            {
                ...
                foreach (var accountRest in accountRests)
                {
                    ...
                    CenterAccountRepository.AddAccountRestData(accountRest);
