...
namespace BarsWeb.Areas.Cash.Infrastructure.Sync
{
    ...
    {
        private ICenterAccountRepository _centerAccountRepository;

        public TransactionSynchronizer(ICenterAccountRepository centerAccountRepository, ISyncRepository syncRepository)
        ...
        {
            var date = _centerAccountRepository.GetLoadTransactionDate(connectionOption.Mfo);
            ...
            */
            ...
            try
            {
                ...
                foreach (var transaction in brachesResponse.Transactions)
                {
                    ...
                    CenterAccountRepository.AddTransactionData(transaction); 
