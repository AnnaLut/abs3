...
namespace BarsWeb.Areas.Cdm.Infrastructure.Repository.DI.Abstract.Individual
{
    public interface ICdmRepository
    {
        ...
        void SaveGcifs(MasterCard[] masterCards, string batchId);// kf не добавляем, нет нужды
        void SaveGcif(MasterCard masterCard, string batchId);// kf не добавляем, нет нужды
