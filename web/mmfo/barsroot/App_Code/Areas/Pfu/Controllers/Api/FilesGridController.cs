...
namespace BarsWeb.Areas.Pfu.Controllers.Api
{
    ...
    public class FilesGridController : ApiController
    {
        ...
        [HttpPost]
        //[POST("/api/pfu/filesgrid/movetoarchive)]
        public HttpResponseMessage MoveToArchive(decimal[] ids)
        {
            try
            {
                var response = _repo.MoveToArchive(ids);
        ...
        [HttpPost]
        //[POST("/api/pfu/filesgrid/movefromarchive)]
        public HttpResponseMessage MoveFromArchive(decimal[] ids)
        {
            try
            {
                var responce = _repo.MoveFromArchive(ids);
        ...
        [HttpGet]
        //[GET("/api/pfu/filesgrid/getpaidarchivedata")]
        public HttpResponseMessage GetPaidArchiveData([ModelBinder(typeof(WebApiDataSourceRequestModelBinder))] DataSourceRequest request)
        {
            try
            {
                var dataCount = _repo.CountPaidArchives(request);
                var data = _repo.PaidArchives(request);
                HttpResponseMessage response = Request.CreateResponse(HttpStatusCode.OK,
                    new { Data = data, Total = dataCount });
                return response;
            }
        ...
        [HttpGet]
        //[GET("/api/pfu/filesgrid/getunpaidarchivedata")]
        public HttpResponseMessage GetUnpaidArchiveData([ModelBinder(typeof(WebApiDataSourceRequestModelBinder))] DataSourceRequest request)
        {
            try
            {
                var dataCount = _repo.CountUnpaidArchives(request);
                var data = _repo.UnpaidArchives(request);
                HttpResponseMessage response = Request.CreateResponse(HttpStatusCode.OK,
                    new { Data = data, Total = dataCount });
                return response;
            }
