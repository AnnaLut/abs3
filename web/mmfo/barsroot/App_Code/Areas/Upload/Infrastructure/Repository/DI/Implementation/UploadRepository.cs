...
namespace BarsWeb.Areas.Upload.Infrastructure.DI.Implementation
{
    public class UploadRepository : IUploadRepository
    {
        ...
        public UploadRepository(IKendoSqlTransformer sqlTransformer, IKendoSqlCounter kendoSqlCounter, IParamsRepository globalData)
        {
            _Upload = new UploadModel(EntitiesConnection.ConnectionString("UploadModel", "Upload"));
        ...
        public IEnumerable<T> SearchGlobal<T>(DataSourceRequest request, BarsSql searchQuery)
        {
            ...
            var item = _Upload.ExecuteStoreQuery<T>(query.SqlText, query.SqlParams);
            return item;
        }
        public decimal CountGlobal(DataSourceRequest request, BarsSql searchQuery)
        {
            ...
            ObjectResult<decimal> res = _Upload.ExecuteStoreQuery<decimal>(query.SqlText, query.SqlParams);
            decimal count = res.Single();
            return count;
        }
        public IEnumerable<T> ExecuteStoreQuery<T>(BarsSql searchQuery)
        {
            return _Upload.ExecuteStoreQuery<T>(searchQuery.SqlText, searchQuery.SqlParams);
        }

        public int ExecuteStoreCommand(string commandText, params object[] parameters)
        {
            return _Upload.ExecuteStoreCommand(commandText, parameters);
        }
