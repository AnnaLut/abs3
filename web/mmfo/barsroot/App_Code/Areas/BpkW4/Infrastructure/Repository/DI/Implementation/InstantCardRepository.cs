...
/// <summary>
/// Summary description for InstantCardRepository
/// </summary>
public class InstantCardRepository: IInstantCardRepository
{
    readonly W4Model _entities;
    readonly IKendoSqlTransformer _sqlTransformer;
    readonly IKendoSqlCounter _kendoSqlCounter;

    public InstantCardRepository(IKendoSqlTransformer sqlTransformer, IKendoSqlCounter kendoSqlCounter)
    {
