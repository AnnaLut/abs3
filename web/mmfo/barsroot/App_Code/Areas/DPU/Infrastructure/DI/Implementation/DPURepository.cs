...
{
    public class DPURepository : IDPURepository
    {
        public DPURepository()
        {
        }
        ...
        public void CreditedAmount(dynamic acc, dynamic row)
        {
            ...
            p.Add("S100", dbType: DbType.Decimal, size: 100, value: Convert.ToDecimal(row.S_100), direction: ParameterDirection.Input);
