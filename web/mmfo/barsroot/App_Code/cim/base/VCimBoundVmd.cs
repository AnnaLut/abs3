...
namespace cim
{
    public sealed class VCimBoundVmdRecord : BbRecord
    {
        ...
        {
            Fields.Add( new BbField("BOUND_ID", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Id прив`язки"));
            Fields.Add( new BbField("CONTR_ID", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Внутрішній код контракту"));
            Fields.Add( new BbField("VMD_ID", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "id ВМД"));
            Fields.Add( new BbField("DIRECT", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Напрямок ВМД (0-вхідні, 1-вихідні)"));
            Fields.Add( new BbField("TYPE_ID", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "id типу документу"));
            Fields.Add( new BbField("DOC_TYPE", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Тип документу"));
            Fields.Add( new BbField("NUM", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Номер документу"));
            Fields.Add( new BbField("DOC_DATE", OracleDbType.Date, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Дата паперового носія"));
            Fields.Add( new BbField("ALLOW_DATE", OracleDbType.Date, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Дата дозволу"));
            Fields.Add( new BbField("VT", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Валюта товару"));
            Fields.Add( new BbField("S_VT", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Сума у валюті товару"));
            Fields.Add( new BbField("RATE_VK", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Курс валюти контракту відносно валюти товару s_vk/s_vt"));
            Fields.Add( new BbField("S_VK", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Сума у валюті контракту"));
            Fields.Add( new BbField("FILE_DATE", OracleDbType.Date, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Дата реєстру"));
            Fields.Add( new BbField("FILE_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "№ реєстру"));
            Fields.Add( new BbField("CONTRACT_NUM", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "№ контракту (з МД)"));
            Fields.Add( new BbField("CONTRACT_DATE", OracleDbType.Date, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Дата конттракту (з МД)"));
            Fields.Add( new BbField("S_PL_VK", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Сума пов`язаних платежів"));
            Fields.Add( new BbField("Z_VT", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Заборгованість по платежах у валюті товару"));
            Fields.Add( new BbField("Z_VK", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Заборгованість по платежах у валюті контракту"));
            Fields.Add( new BbField("S_PL_AFTER_VK", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Сума пов`язаних платежів після контрольного дня (експ"));
            Fields.Add( new BbField("CONTROL_DATE", OracleDbType.Date, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Дата контрольного дня (експ)"));
            Fields.Add( new BbField("OVERDUE", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Кількість днів прострочки"));
            Fields.Add( new BbField("COMMENTS", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_BOUND_VMD", ObjectTypes.View, "Прив`язані ВМД v 1.00.01", "Примітка"));
