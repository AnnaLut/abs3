...
namespace BarsWeb.Infrastructure.Repository.DI.Implementation
{
    ...
    public class DocumentsRepository
    {
        ...
        public cDocPrint CreateTicket(OracleConnection connect, decimal id, bool printModel = true)
        {
            return new cDocPrint(connect, id, HttpContext.Current.Server.MapPath("/TEMPLATE.RPT/"), printModel);
        }
        public byte[] GetByteArrayTicket(decimal id, bool printModel = true)
        {
        ...
        public cDocPrint CreateTicket(decimal[] id, bool printModel = true)
        {
