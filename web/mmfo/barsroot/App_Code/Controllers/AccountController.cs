    ...
    public class AccountController : ApplicationController
    {
        ...
        public ActionResult Login()
        {
            ...
            System.Configuration.ConnectionStringSettingsCollection connectionStrings =
                ...
                as System.Configuration.ConnectionStringSettingsCollection;
            string[] parts = connectionStrings["IBankCoreConnectionString"].ConnectionString.ToUpper()
                .Split(new string[] { "DATA SOURCE=" }, StringSplitOptions.None);
            ViewBag.dbName = parts[1].LastIndexOf(';') > 0 ? parts[1].Split(';')[0] : parts[1].Split()[0];
        ...
        public ActionResult PrepareLogOut()
        {
            var context = System.Web.HttpContext.Current;
            int logoutType = (context.Session["AD_Auth"] != null) ? (1) : (0);
            _repository.LogOutUser();
            // drop session 
            context.Session.Abandon();
            return Json(logoutType, JsonRequestBehavior.AllowGet);
        }
