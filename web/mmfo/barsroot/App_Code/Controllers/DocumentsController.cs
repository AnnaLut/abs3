...
namespace BarsWeb.Controllers
{
    ...
    public class DocumentsController : ApplicationController
    {
        ...
        /// <returns></returns>
        public ActionResult GetTicketHtml(decimal id, bool printModel = true)
        {
        ...
        /// <param name="printModel">признак чи потрібно друкувати бух.модель</param>
        /// <returns></returns>
        public string GetTicketFileName(decimal[] id, bool printModel = true)
        {
        ...
        /// <returns></returns>
        //[DeleteTmpFile]
        public ActionResult GetTicketFile(decimal[] id, bool printModel = true)
        {
            var ticket = _repository.CreateTicket(id, printModel);
        ...
        public void LoadTXT(decimal[] id, bool printModel = true)
        {
        ...
        public void LoadHtml(decimal id, bool printModel = true)
        {
            var icon = (IOraConnection)AppDomain.CurrentDomain.GetData("OracleConnectClass");
            OracleConnection con = icon.GetUserConnection(System.Web.HttpContext.Current);
        ...
        public string GetFileForPrint(decimal[] id, bool printModel = true)
        { 
