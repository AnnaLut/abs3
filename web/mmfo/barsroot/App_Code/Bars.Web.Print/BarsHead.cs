...
namespace Bars.Web.Print
{
    ...
    public class BarsHead : IHttpHandler, IRequiresSessionState 
	{
		...
		void IHttpHandler.ProcessRequest(HttpContext context)
		{
            ...
            if (Request.Params.Get("adds") == null)
            { strExpButton = "<INPUT type='button' id='btExport' value='   Зберегти   'onclick='exportToFile()' " + strDisable + @">"; }
				...
				<TR>
					<TD align='center' nowrap>
						<INPUT type='button' id='btPrint' value='     " + getResource("Print") + @"     ' 
							onclick='printcmd()' " + strDisable + @"> " + strExpButton + "</TD><TD></TD></TR>";
