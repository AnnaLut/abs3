...
namespace clientregister
{
    public sealed class VCustRelationsRecord : BbRecord
    {
        ...
        private void fillFields()
        {
            ...
            // COBUMMFO-8536 --->
            Fields.Add(new BbField("DATE_PHOTO", OracleDbType.Date, true, false, false, false, false, "V_CUST_RELATIONS", ObjectTypes.View, "Связи клиента (Представление)", "Дата вклеювання фото"));
            Fields.Add(new BbField("EDDR_ID", OracleDbType.Varchar2, true, false, false, false, false, "V_CUST_RELATIONS", ObjectTypes.View, "Связи клиента (Представление)", "Унікальний номер запису в ЄДДР"));
            Fields.Add(new BbField("ACTUAL_DATE", OracleDbType.Date, true, false, false, false, false, "V_CUST_RELATIONS", ObjectTypes.View, "Связи клиента (Представление)", "Термін дії паспорту у вигляді ID-картки"));
            // COBUMMFO-8536 <---
    ...
    public sealed class VCustRelationsFilters : BbFilters
    {
        public VCustRelationsFilters(BbDataSource Parent) : base (Parent)
        {
            ...
            // COBUMMFO-8536 --->
            DATE_PHOTO = new BBVarchar2Filter(this, "DATE_PHOTO");
            EDDR_ID = new BBVarchar2Filter(this, "EDDR_ID");
            ACTUAL_DATE = new BBVarchar2Filter(this, "ACTUAL_DATE");
            // COBUMMFO-8536 <---
        }
