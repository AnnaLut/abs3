...
public class CreditResourceService : Bars.BarsWebService
{
    ...
    public class Deal
    {
        ...
        public Int64 InterestAccountId { get; set; }
    }
    ...
    {
        public Int64 DocumentIdValue { get; set; }
    }
    ...
    public DealContract OpenCreditContract(String ContractNumber, int ProductId, int ContractType, int CurrencyCode, int PartyId, String PartyMfo, String PartyName, DateTime? ContractDate, DateTime? ExpiryDate, Decimal InterestRate, Decimal Amount, int BaseYear, int BalanceKind, String MainDebtAccount, String InterestAccount, String PartyMainDebtAccount, String TransitAccount, String PartyInterestAccount, String PaymentPurpose)
    {
        ...
        try
        {
            ...
            cmd.Parameters.Add("p_party_id", OracleDbType.Int64, PartyId, ParameterDirection.Input);
            ...
            cmd.Parameters.Add("p_deal_id", OracleDbType.Int64, ParameterDirection.Output);
            cmd.Parameters.Add("p_main_account_id", OracleDbType.Int64, ParameterDirection.Output);
            cmd.Parameters.Add("p_interest_account_id", OracleDbType.Int64, ParameterDirection.Output);
            cmd.Parameters.Add("p_error_message", OracleDbType.Varchar2, 4000, err.ErrMessage, ParameterDirection.Output);

            cmd.ExecuteNonQuery();

            Int64 dealId = (Int64)((OracleDecimal)cmd.Parameters["p_deal_id"].Value).Value;
            Int64 mainAccountId = (Int64)((OracleDecimal)cmd.Parameters["p_main_account_id"].Value).Value;
            Int64 interestAccountId = (Int64)((OracleDecimal)cmd.Parameters["p_interest_account_id"].Value).Value;
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public AccountNumberContract GenerateAccountNumbers(Int64 OurCustomerId, String BalanceAccount, int CurrencyCode)
    {
        ...
        try
        {
            ...
            cmd.Parameters.Clear();
            cmd.Parameters.Add("p_our_customer_id", OracleDbType.Int64, OurCustomerId, ParameterDirection.Input);
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public DocumentIdContract MakeDocument(Int64 DealId, String OperationType, Int64 PartyA, Int64 PartyB, String MfoA, String MfoB, String AccountA, String AccountB, int DocumentKindId, DateTime? DocumentDate, Decimal Amount, int Currency, String Purpose)
    {
        ...
        try
        {
            ...
            cmd.Parameters.Clear();
            cmd.Parameters.Add("p_deal_id", OracleDbType.Int64, DealId, ParameterDirection.Input);
            cmd.Parameters.Add("p_operation_type", OracleDbType.Varchar2, OperationType, ParameterDirection.Input);
            cmd.Parameters.Add("p_party_a", OracleDbType.Int64, PartyA, ParameterDirection.Input);
            cmd.Parameters.Add("p_party_b", OracleDbType.Int64, PartyB, ParameterDirection.Input);
            ...
            cmd.Parameters.Add("p_operation_id", OracleDbType.Int64, ParameterDirection.Output);
            cmd.Parameters.Add("p_error_message", OracleDbType.Varchar2, 4000, null, ParameterDirection.Output);

            cmd.ExecuteNonQuery();

            Int64 operationId = (Int64)((OracleDecimal)cmd.Parameters["p_operation_id"].Value).Value;
            OracleString errorMesage = (OracleString)cmd.Parameters["p_error_message"].Value;
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public AmountContract GetDealAmount(Int64 DealId)
    {
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public DateContract GetDealExpiryDate(Int64 DealId)
    {
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public Errors SetDealAmount(Int64 DealId, decimal DealAmount)
    {
        String userName = WsHeaderValue.UserName;
        String password = WsHeaderValue.Password;
        ...
        try
        {
            ...
            cmd.Parameters.Clear();
            cmd.Parameters.Add("p_deal_id", OracleDbType.Int64, DealId, System.Data.ParameterDirection.Input);
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public Errors SetDealExpiryDate(Int64 DealId, DateTime ExpiryDate)
    {
        String userName = WsHeaderValue.UserName;
        String password = WsHeaderValue.Password;
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public Errors CheckDealBeforeClose(Int64 DealId)
    {
        String userName = WsHeaderValue.UserName;
        String password = WsHeaderValue.Password;
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public Errors CheckDealInterestRate(Int64 DealId, int InterestKind, string InterestRates)
    {
        String userName = WsHeaderValue.UserName;
        String password = WsHeaderValue.Password;
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public Errors CloseDeal(Int64 DealId, DateTime CloseDate)
    {
        String userName = WsHeaderValue.UserName;
        String password = WsHeaderValue.Password;
    ...
    [WebMethod(EnableSession = true)]
    [SoapHeader("WsHeaderValue", Direction = SoapHeaderDirection.InOut)]
    public Errors AddDealComment(Int64 DealId, string Comment)
    {
        String userName = WsHeaderValue.UserName;
        String password = WsHeaderValue.Password;
