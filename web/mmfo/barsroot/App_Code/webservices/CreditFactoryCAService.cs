...
public class CreditFactoryCAService : Bars.BarsWebService
{
    ...
    public Bars.CreditFactory.Wsdl.WsHeader WsHeaderValue;
    ...
    public XmlNode KF_CREDIT_Registation_RemoteRequest(String DBRANCH, decimal DNUM, String ACCNUM, String DCLASS, String DVKR, decimal DSUM, decimal KV, String DDATE)
    {
        ...
        Bars.CreditFactory.Wsdl.CreditFactoryService factoryRU = new Bars.CreditFactory.Wsdl.CreditFactoryService();
        ...
        try
        {
            ...
            Bars.CreditFactory.Wsdl.WsHeader header = new Bars.CreditFactory.Wsdl.WsHeader();
