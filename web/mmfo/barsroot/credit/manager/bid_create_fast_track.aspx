<%@ Page Language="C#" MasterPageFile="~/credit/manager/master.master" AutoEventWireup="true"
    CodeFile="bid_create_fast_track.aspx.cs" Inherits="credit_manager_bid_create_fast_track" Title="Вибір субпродукту"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <asp:ObjectDataSource ID="odsVWcsFastTrackProducts" runat="server" SelectMethod="SelectProducts"
            TypeName="credit.VWcsFastTrackProducts"></asp:ObjectDataSource>
        <table border="0" cellpadding="3" cellspacing="0">
            <tr>
                ...
                <td>
                    <bec:DDLList ID="PRODUCT_ID" runat="server" DataSourceID="odsVWcsFastTrackProducts" DataValueField="PRODUCT_ID"
