...
<body>
    ...
    <asp:Panel ID="ID1" runat="server" Width="930Px" Style="margin-left: 10px; margin-right: 10px;
        ...
        <table width="900px">
            <tr>
                <td>
                    <asp:Label ID="l_ddl_tip_o" runat="server" Text="Тип оцінки   " Width="700" Visible="false"
                        Style="text-align: right" />
                </td>
                <td>
                    <asp:DropDownList ID="dd_Tip_o" runat="server" IsRequired="false" Width="150Px" Visible="false"
                        AutoPostBack="true" OnSelectedIndexChanged="dd_select_change">
                        <asp:ListItem Text="" Value="0" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="Звичайна" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Спрощена" Value="2"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
    ...
    <asp:Panel runat="server" ID="pnGrid" Style="margin-left: 10px; margin-right: 10px;
        ...
        <table width="910Px">
            ...
            <tr>
                ...
                <td class="style4">
                    &nbsp;
                    <Bars:ImageTextButton ID="Bt_Print" runat="server" Text="Друк" Width="155px" OnClick="Bt_Print_Click"
                        ImageUrl="/Common/Images/default/16/print.png" Enabled="true" Visible="false" />
                    &nbsp;
                </td>
            </tr>
            <tr>
    ...
    <div>
        <asp:HiddenField ID="P_tip" runat="server" />
    </div>
    </form>
</body>
</html>
