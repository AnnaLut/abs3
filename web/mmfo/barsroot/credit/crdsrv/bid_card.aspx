...
<asp:Content ID="cProcess" ContentPlaceHolderID="cphProcess" runat="server">
    <asp:Panel ID="pnlProcess" runat="server" GroupingText="Обработка" meta:resourcekey="pnlProcessResource1">
        <table class="dataTable">
            <tr>
                <td>
                    <asp:LinkButton ID="lbEditBid" runat="server" Text="Редагувати(прискорена)" CommandName="EDITBID"
                        OnClick="lbEDITBID_Click" Visible="false"></asp:LinkButton>
                </td>
                <td rowspan="4">
                    <asp:Panel ID="pnlChoiceService" runat="server" GroupingText="Служби які розглядають заявку">
            ...
            <tr>
                <td>
                    <asp:LinkButton ID="lbCheckService" runat="server" Text="Вибір служб для розгляду" CommandName="CHKSERVICE"
                        OnClick="lbCHKSERVICE_Click" Visible="false"></asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:LinkButton ID="lbPROCCESS" runat="server" Text="Обработать" CommandName="PROCCESS"
                        OnClick="lbPROCCESS_Click" meta:resourcekey="lbPROCCESSResource1" Visible="false"></asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:LinkButton ID="lbDOCS" runat="server" Text="Заключение" CommandName="DOCS"
