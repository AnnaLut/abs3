  ...
  <xsl:template match="/">
    <TABLE cellspacing="0" cellpadding="2" bordercolor="Black" border="1" style="background-color: White; border-color: Black; font-family: Verdana; font-size: 8pt; border-collapse: collapse;cursor:hand">
      <TR align="center" style="color:White;background-color:Gray;font-family:Verdana;font-size:8pt;font-weight:bold; CURSOR: hand">
        ...
        <TD width="70px" title="ОКПО відправника">
          <xsl:attribute name="onclick">
            <xsl:text>Sort('ID_A')</xsl:text>
          </xsl:attribute>
          <xsl:text>ОКПО відправника</xsl:text>
        </TD>
        <TD width="70px" title="Назва відправника">
          <xsl:attribute name="onclick">
            <xsl:text>Sort('NAM_A')</xsl:text>
          </xsl:attribute>
          <xsl:text>Назва відправника</xsl:text>
        </TD>
        <TD width="70px" title="ОКПО отримувача">
          <xsl:attribute name="onclick">
            <xsl:text>Sort('ID_B')</xsl:text>
          </xsl:attribute>
          <xsl:text>ОКПО отримувача</xsl:text>
        </TD>
        <TD width="70px" title="Назва отримувача">
          <xsl:attribute name="onclick">
            <xsl:text>Sort('NAM_B')</xsl:text>
          </xsl:attribute>
          <xsl:text>Назва отримувача</xsl:text>
        </TD>
      </TR>
      <xsl:for-each select="//Table">
        ...
        <TR>
          ...
          <TD align="center">
            <xsl:value-of select="NAM_A"/>
          </TD>
          <TD align="center">
            <xsl:value-of select="ID_B"/>
          </TD>
          <TD align="center">
            <xsl:value-of select="NAM_B"/>
          </TD>
        </TR>
      </xsl:for-each>
    </TABLE>
