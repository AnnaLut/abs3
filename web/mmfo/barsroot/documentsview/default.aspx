...
<body bottommargin="0" leftmargin="0" topmargin="3" rightmargin="0" style="background: whitesmoke;">
    ...
    <table id="tb_border" height="100%" cellspacing="0" cellpadding="0" width="100%"
        ...
        <tr>
            ...
            <td height="50">
                <div id="lb_headerUser" meta:resourcekey="lb_headerUser" style="display: inline;color: #4d5a75; font-size: 1.5em; font-weight: 300; margin: 20px 0 0 20px;" align="center" runat="server">
                    Документы пользователя</div>
                <div id="lb_headerBranch" meta:resourcekey="lb_headerBranch" style="display: inline;
                    color: #4d5a75; font-size: 1.5em; font-weight: 300; margin: 20px 0 0 20px;" align="center"
                    runat="server">
