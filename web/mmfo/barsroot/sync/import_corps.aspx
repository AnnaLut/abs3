                ...
                <table style="width:100%">
                    ...
                    <tr>
                        <td>
                            ...
                            <uc2:DateEdit ID="start_date2" runat="server"
                                validationMessage="Необхідно заповнитиn датау синхронізації по обраному рахунку" Required="True" />
                        </td>
                    </tr>  
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="btSync" runat="server" CausesValidation="true" 
                                ...
                                ToolTip="Синхронізувати виписку по всіх рахунках" Width="160px" />
                                    ...
                                    <asp:TemplateField ShowHeader="False">
                                        <ItemTemplate>
                                            ...
                                            <asp:Button ID="btSyncInGv" runat="server" CausesValidation="true" 
                                                Enabled="true"  OnClientClick="return ControlDateEditValid(true)"
                                                CommandArgument='<%#Eval("ACC")%>' CommandName="SYNC_ACCOUNT"                                                 
                                                Text="Синхронізувати" 
                                                ToolTip="Синхронізувати виписку по вибраному рахунку" Width="150px" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Експортований" SortExpression="IMPORTED">
                                        <itemtemplate>
                                            <asp:CheckBox ID="ckImp" runat="server" Enabled = "false"
                                                Checked='<%#Convert.ToBoolean(Eval("IMPORTED"))%>' />                    
                                        </itemtemplate>
