...
<TD noWrap="true" width="100" title="Счет-А вериф">
<xsl:text>Счет-А вериф</xsl:text></TD>

<TD noWrap="true" width="100" title="МФО-Б вериф">
<xsl:text>МФО-Б вериф</xsl:text></TD>

<TD noWrap="true" width="100" title="Счет-Б вериф">
<xsl:text>Счет-Б вериф</xsl:text></TD>

<TD noWrap="true" width="100" title="ОКПО-Б вериф">
<xsl:text>ОКПО-Б вериф</xsl:text></TD>

<TD noWrap="true" width="120" title="Сумма верификации">
