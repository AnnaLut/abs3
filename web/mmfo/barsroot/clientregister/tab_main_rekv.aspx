...
<div style="padding: 10px">
    ...
    <table id="tblEdits" border="0" cellpadding="1" cellspacing="0" style="">
        ...
        <tr>
            ...
            <td>
                <input class="edit centered" id="ed_ND" tabindex="4" type="text" maxlength="10" />
                <input type="button" id="btRegisterDbo" value="Сформувати ДБО" onclick="registerDbo(); return false;" style="width:140px" class="btn btn-primary"/>
                <label id="lSign" style="align-items:center"><input type="checkbox" id="btSignDbo" ="Підписано ДБО" value="btSignDbo"  onclick="signDbo();" style="width:24px" class="btn btn-primary"/>Підписано</label>               
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input class="edit long" id="ed_NMK" tabindex="5" type="text" maxlength="70" onchange="ToUpperCase('ed_NMK');CopyNMK();" />
        ...
        <tr class="trPersonFIO" id="trPersonFIO">
            <td style="display: none"></td>
            <td style="display: none">
                <div style="float:right;margin:0 173px 0 0;width:320px">
                  <div style="float:right;margin:0">
                      Прізвище клієнта:
                      <input class="edit" id="ed_FIO_LN" tabindex="114" type="text" maxlength="70" autocomplete="off"/>
                      <div class="required">*</div>
                  </div><br/>
                  <div style="float:right;margin:0">
                      Ім'я клієнта:
                      <input class="edit" id="ed_FIO_FN" tabindex="114" type="text" maxlength="70" autocomplete="off"/>
                      <div class="required">*</div>
                  </div><br/>
                  <div style="float:right;margin:0 12px 0 0">
                      По-батькові клієнта:
                      <input class="edit" id="ed_FIO_MN" tabindex="114" type="text" maxlength="70" autocomplete="off"/>
                  </div><br/>
                </div>
            </td>
        </tr>
        <tr class="trPersonFIONR" id="trPersonFIONR">
            <td style="display: none"></td>
            <td style="display: none">
                <div style="float:right;margin:0 173px 0 0;width:320px">
                    <div style="float:right;margin:0 2px 0 0">Ім'я-1 нерезидента:
                        <input class="edit" id="ed_FIO_LN_NR" tabindex="114" type="text" maxlength="70" onchange="ToUpperCase('ed_FIO_LN_NR');CopyNMK();"/>
                        <div class="required">*</div>
                    </div>
                    <div style="float:right;margin:0 12px 0 0">Ім'я-2 нерезидента:
                        <input class="edit" id="ed_FIO_FN_NR" tabindex="114" type="text" maxlength="70" onchange="ToUpperCase('ed_FIO_FN_NR');CopyNMK();"/>
                    </div>
                    <div style="float:right;margin:0 12px 0 0">Ім'я-3 нерезидента:
                        <input class="edit" id="ed_FIO_MN_NR" tabindex="114" type="text" maxlength="70" onchange="ToUpperCase('ed_FIO_MN_NR');CopyNMK();"/>
                    </div>
                    <div style="float:right;margin:0 12px 0 0">Ім'я-4 нерезидента:
                        <input class="edit" id="ed_FIO_4N_NR" tabindex="114" type="text" maxlength="70" onchange="ToUpperCase('ed_FIO_4N_NR');CopyNMK();"/>
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input class="edit long" id="ed_NMKV" tabindex="6" type="text" maxlength="70" onchange="ToUpperCase('ed_NMKV');" />
                <div class="required">*</div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input class="edit long" id="ed_NMKK" tabindex="7" type="text" maxlength="35" onchange="ToUpperCase('ed_NMKK');" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <select class="edit long" style="width:310px;" id="ddl_CODCAGENT" title="Выбор по нажатию левой кнопки мыши"
        ...
        <tr>
            ...
            <td>
                ...
                <select class="edit composite1-value" style="width:246px;" id="ddl_COUNTRY" title="Выбор по нажатию левой кнопки мыши"
        ...
        <tr>
            ...
            <td>
                <select class="edit long" style="width:310px;" id="ddl_PRINSIDER" title="Выбор по нажатию левой кнопки мыши"
        ...
        <tr>
            ...
            <td>
                <select class="edit long ddlTGRClass" style="width:310px;" id="ddl_TGR" title="Выбор по нажатию левой кнопки мыши"
                    tabindex="13">
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input class="edit centered" id="ed_OKPO" onblur="checkOKPO(getEl('ed_OKPO'),true);setTgrList();" tabindex="14"
        ...
        <tr>
            ...
            <td>
                <select class="edit long" style="width:310px;" id="ddl_STMT" title="Выбор по нажатию левой кнопки мыши"
        ...
        <tr>
            ...
            <td>
                ...
                <select class="edit composite2-value" style="width:166px;" id="ddl_TOBO" tabindex="18" onchange="PutTOBOCd();"
                    runat="server">
                </select>
            </td>
        </tr>
