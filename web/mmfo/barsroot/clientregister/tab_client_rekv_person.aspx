                    ...
                    <td>
                        <table id="tblEdits" border="0" cellpadding="2" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="edit" style="width:160px;" id="ddl_PASSP" tabindex="2" runat="server"
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="edit" style="width:160px;" id="ddl_SEX" tabindex="10" runat="server">
                                        <option selected="selected"></option>
                                    </select>
                                    <div class="required">*</div>
                                </td>
                                    ...
                                    <div>
                                        ...
                                        <div class="required">* </div>
                                         ...
                                         <button id="btnShowHidePhone" class="masked"
                                            ...
                                            style="display: none; height: 25px; padding: 0px; width: 220px;"
                                            title="Переглянути/сховати номер телефону">
                                            Переглянути номер
                                        </button>

                                        <div id="loading" style="display: none; color:darkcyan;"><strong>Перевірка номера телефону. Зачекайте...</strong></div>
