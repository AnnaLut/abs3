            ...
            <td align="left">
                <table id="tb_edits" style="font-size: 10pt; font-family: Arial" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="float:left;vertical-align: top;">
                                <input class="tab_main_rekv_ed_style" id="ed_ISP" tabindex="1" type="text" maxlength="20" style="text-align: left;"
                                    onchange="ToDoOnChange();" onblur="isNumberCheck(getEl('ed_ISP'))" disabled>
								<label for="ed_ISP" style="color:red;align-items:center">* </label>
                                <button id="bt_help" 
                                        style="height: 24px;padding:0px;width: 132px;"
                                        onclick="showUsersHandBoock(this)"
                                        title="довідник">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="tab_ek_norm_ed2_style" style="width:310px !important" id="ddl_CRISK" tabindex="3" onchange="SetClientColor(getEl('ddl_CRISK').item(getEl('ddl_CRISK').selectedIndex).value);ToDoOnChange();ToDoOnChange();"
                                runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="tab_ek_norm_ed2_style" style="width:310px !important" id="ddl_MB" tabindex="4" onchange="SetMB();ToDoOnChange();"
                                runat="server">
                                <option selected></option>
                            </select>
                        </td>
