...
public partial class cim_contracts_other_contracts_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!ClientScript.IsStartupScriptRegistered(this.GetType(), "init"))
            ClientScript.RegisterStartupScript(this.GetType(), "init", "CIM.setVariables('" + gvVCimContracts.ClientID + "','" + Request["mode"] + "', '" + Session[Constants.StateKeys.AccessFlag] + "'); ", true);
