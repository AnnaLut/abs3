prompt ===================================== 
prompt == Актуалізація на поховання планові суми виплат 
prompt ===================================== 
...
begin     
   ...
   exception when no_data_found then                       
    ...
    l_zpr.id           := 1;
    l_zpr.name         := 'Актуалізація на поховання планові суми виплат';
    l_zpr.namef        := '';
    l_zpr.bindvars     := ':sFdat1='''',:sFdat2='''',:p_mfo=''МФО (%-всі)'',:p_gr=''В розрізі (0-мфо 1-бранчів)''';
    l_zpr.create_stmt  := '';
    l_zpr.rpt_template := 'brs_3116.frx';
    l_zpr.form_proc    := '';
...
order by 1,7,3';
 ...
 ------------------------    
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Актуалізація на поховання планові суми виплат';
