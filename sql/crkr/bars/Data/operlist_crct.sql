...
begin
     ...
     delete from OPERAPP where codeapp = 'CRCT' and codeoper = l_funcid;
/*  
begin 
insert into bars.operapp
 ...
 exception when dup_val_on_index then null;
    ...
    select s.id, 'CRCT', 1, 1
    from   staff$base s
    where  s.logname = 'ABSADM' and
           not exists (select 1 from applist_staff astf where astf.id = s.id and astf.codeapp = 'CRCT');  
*/
