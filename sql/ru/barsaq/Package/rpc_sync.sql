...
CREATE OR REPLACE PACKAGE BODY BARSAQ.RPC_SYNC is
  ...
  begin
    execute immediate
   'insert into doc_export(doc_id,doc_xml,bank_id,type_id,status_id,status_change_time, doc_desc)
    select doc_id,:p_xml,bank_id,type_id,status_id,status_change_time, doc_desc
...
----
  ...
  begin
    execute immediate
   'insert
	  into ibank.doc_curex_custcommissions(rnk, buy_commission, sell_commission, conv_commission, bank_id)
    select cc.rnk, cc.buy_commission, cc.sell_commission, cc.conv_commission, cc.bank_id
  ...
  begin
   ...
   'insert
    ...
    select ce.rate_id, ce.rnk, ce.buy_sell_flag, ce.cur_group, ce.cur_id, ce.limit, ce.commission_rate, ce.commission_sum, ce.date_on, ce.date_off, ce.bank_id
  ...
  begin
    ...
    execute immediate
   'delete
      from ibank.cust_addresses where bank_id = :1' using l_bankid;
  ...
  begin
   ...
   'insert
    ...
    select ca.rnk, ca.type_id, ca.country_id, ca.zip, ca.region, ca.district, ca.city, ca.address, ca.bank_id
