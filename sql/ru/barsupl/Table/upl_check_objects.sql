...
COMMENT ON TABLE BARSUPL.UPL_CHECK_OBJECTS IS 'Довідник об`єктів АБС що підлягають перевірці';
COMMENT ON COLUMN BARSUPL.UPL_CHECK_OBJECTS.OBJECT_ID IS 'Ідентифікатор об`єкту в АБС';
COMMENT ON COLUMN BARSUPL.UPL_CHECK_OBJECTS.OBJECT_NAME IS 'Назва об`єкту в АБС';
