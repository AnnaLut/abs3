...
COMMENT ON TABLE BARSUPL.UPL_CHECK_TYPES IS 'Довідник існуючих перевірок на наявність помилок в АБС';
COMMENT ON COLUMN BARSUPL.UPL_CHECK_TYPES.CHECK_ID IS 'Ідентифікатор перевірки';
COMMENT ON COLUMN BARSUPL.UPL_CHECK_TYPES.CHECK_NAME IS 'Назва перевірки';
COMMENT ON COLUMN BARSUPL.UPL_CHECK_TYPES.CHECK_DESC IS 'Опис перевірки (за наявності посилання на аналогічний звіт в АБС)';
COMMENT ON COLUMN BARSUPL.UPL_CHECK_TYPES.OBJECT_ID IS '';
COMMENT ON COLUMN BARSUPL.UPL_CHECK_TYPES.FILE_ID IS 'Ідентифікатор файлу вивантаження некоректних даних';
