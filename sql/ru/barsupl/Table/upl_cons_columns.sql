...
COMMENT ON TABLE BARSUPL.UPL_CONS_COLUMNS IS 'Колонки для ссылочных связей';
COMMENT ON COLUMN BARSUPL.UPL_CONS_COLUMNS.FILE_ID IS '';
COMMENT ON COLUMN BARSUPL.UPL_CONS_COLUMNS.CONSTR_NAME IS 'Наименование связи';
COMMENT ON COLUMN BARSUPL.UPL_CONS_COLUMNS.FK_COLID IS 'Последовательность колонки в связаном ключе';
COMMENT ON COLUMN BARSUPL.UPL_CONS_COLUMNS.FK_COLNAME IS 'Имя колонки';
