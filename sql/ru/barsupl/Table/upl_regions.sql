...
COMMENT ON TABLE BARSUPL.UPL_REGIONS IS 'Список регионов по которым ведется выгрузка';
COMMENT ON COLUMN BARSUPL.UPL_REGIONS.KF IS 'МФО региона';
COMMENT ON COLUMN BARSUPL.UPL_REGIONS.REGION_NAME IS '';
COMMENT ON COLUMN BARSUPL.UPL_REGIONS.CODE_NMBR IS 'Числовой код региона';
COMMENT ON COLUMN BARSUPL.UPL_REGIONS.CODE_CHR IS 'Двухсимвольный код региона';
COMMENT ON COLUMN BARSUPL.UPL_REGIONS.FTP_UPL_FOLDER IS 'FTP каталог для выгрузки файлов';
