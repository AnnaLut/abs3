...
COMMENT ON TABLE BARSUPL.UPL_DOMAINS IS 'Справочник доменов для файлов';
COMMENT ON COLUMN BARSUPL.UPL_DOMAINS.DOMAIN_CODE IS 'Код домена';
COMMENT ON COLUMN BARSUPL.UPL_DOMAINS.DESCRIPT IS 'Описание';
