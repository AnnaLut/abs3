...
COMMENT ON TABLE BARSUPL.UPL_AUTOJOBS IS 'Выгружаемые группы в виде автоматического задания';
...
begin   
 execute immediate '
  ALTER TABLE BARSUPL.UPL_AUTOJOBS ADD CONSTRAINT PK_UPLAUTOJOBS PRIMARY KEY (JOB_NAME)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARSUPL.PK_UPLAUTOJOBS ON BARSUPL.UPL_AUTOJOBS (JOB_NAME) 
