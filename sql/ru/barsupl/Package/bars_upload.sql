 ...
 PROMPT ===================================================================================== 
  ...
  CREATE OR REPLACE PACKAGE BARSUPL.BARS_UPLOAD is
    ...
    -- version 4.3 05.07.2018 COBUMMFO-8453  Просимо доопрацювати вивантаження пакетів для сховища даних - винести параметри налаштувань вивантаження на інший рівень
    ...
    G_HEADER_VERSION      constant varchar2(64)  := 'version 4.3 05.07.2018';
...
is
    ...
    --   version 4.10 05.07.2018 COBUMMFO-8453  Просимо доопрацювати вивантаження пакетів для сховища даних - винести параметри налаштувань вивантаження на інший рівень
    --                           параметр UPL_METHOD обрабатывать на уровне файла, а не глобальной настрройки
    --                           добавлены таблицы доп. параметров файлов с соответствующими методами set_file_param, get_file_param
    --                                                             --
    -----------------------------------------------------------------
    ...
    G_BODY_VERSION         constant varchar2(64)  := 'version 4.10 05.07.2018';
