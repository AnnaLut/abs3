...
begin
   ...
   dbms_output.put_line(':   SQL # 6102');
end;
/
-- ***************************************************************************
-- ETL-24887 UPL - добавить в выгрузку файл Accounts для перехода на IFRS 9
-- 
-- ***************************************************************************
...
-- UPL_SQL
-- ***********************
delete from BARSUPL.UPL_SQL where SQL_ID IN (6102);
...
Insert into UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values
   (6102, l_clob, 'begin execute immediate ''begin barsupl.bars_upload_usr.tuda; end;''; exception when others then if sqlcode = -6550 then null; else raise; end if; end;', NULL, 
   'Счета банка от глобальной БД -3 дня до глобальной БД (для IFRS9)', '2.0');
