...
--alter trigger TBIU_UPLPARAMS_CHECK disable;

declare
  l_vers           varchar2(100) := '57.1 22/12/2017';
  l_prev_vers      varchar2(100) := '57.0'; -- список версий (через ';'), на которые можно ставить это обновление
...
--alter trigger TBIU_UPLPARAMS_CHECK enable;
