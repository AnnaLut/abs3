...
Insert into BARSUPL.UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values
   (178, 'select 2 as REF_ID, s.SPPI_ID, s.SPPI_NAME from BARS.SPPI s',
    'begin execute immediate ''begin barsupl.bars_upload_usr.tuda; end;''; exception when others then if sqlcode = -6550 then null; else raise; end if; end;',
     NULL, 'Відповідність критерію SPPI', '1.0');
...
Insert into BARSUPL.UPL_FILES
 ...
 Values
   (178, 178, 'SPPI', 'sppi', 0, '09', NULL, '10', 0, 'Відповідність критерію SPPI', 178, 'null', 'WHOLE', 'GL', 1, NULL, 1, 'mtag', 0, 0);
...
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (178, 0, 'REF_ID', 'Код справочника', 'NUMBER', 5, 0, NULL, 'Y', 'N', NULL, NULL, '0', 0, NULL);
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (178, 1, 'SPPI_ID', 'Параметр', 'VARCHAR2', 15, NULL, NULL, 'Y', 'N', NULL, NULL, 'N/A', 1, NULL);
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (178, 2, 'SPPI_NAME', 'Наименование параметра', 'VARCHAR2', 50, NULL, NULL, NULL, 'Y', NULL, '09,13,10|32,32,32', 'N/A', NULL, NULL);
...
Insert into UPL_FILEGROUPS_RLN (group_id, file_id, sql_id) Values (5, 178, 178);
