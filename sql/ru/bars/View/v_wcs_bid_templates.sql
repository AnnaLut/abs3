...
PROMPT *** Create  view V_WCS_BID_TEMPLATES ***
  ...
  from (select b.id as bid_id,
               ...
               0 as ws_num,
               t.docexp_type_id,
               wcs_utl.get_answ_blob(b.id, st.scan_qid, srvhr.ws_id, 0) as img,
               st.is_scan_required
          from wcs_bids                 b,
               ...
               (select 'NONE' as id,
                  ...
                  from dual
                union
                select id, 'SRV_' || upper(id) as ws_id, 'SERVICE' as type_id, name
                  from wcs_srv_hierarchy
                 where id != 'TOBO') srvhr
