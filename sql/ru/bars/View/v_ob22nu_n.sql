...
PROMPT *** Create  view V_OB22NU_N ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_OB22NU_N ("ACC", "NLS", "NMS", "NBS", "P080", "OB22", "ACCN", "NLSN", "NMSN", "NBSN", "NP080", "NOB22", "PRIZN", "NMS8", "D_CLOSE", "VIDF") AS 
  SELECT a.acc, a.nls, a.nms, a.nbs, s.p080, s.ob22, n.acc accn, n.nls nlsn,
          n.nms nmsn, n.nbs nbsn, n.p080 np080, n.ob22 nob22, n.prizn, n.nms8,
          n.d_close, decode(a.vid,89,1,0) vidf
     FROM accounts a,
          specparam_int s,
          (SELECT a.acc, a.nls, a.nms, a.nbs, s.p080, s.ob22, s.r020_fa,
                  p.prizn_vidp prizn, p.nms8, p.d_close
             FROM accounts a,
                  specparam_int s,
                  (SELECT DISTINCT SUBSTR (txt, 1, 35) nms8, p080, r020_fa,
                                   r020, prizn_vidp, ob22, d_close
                              FROM sb_p0853
    ...
    WHERE  a.acc = s.acc
      AND a.nbs = n.r020_fa AND s.ob22 = n.ob22;
