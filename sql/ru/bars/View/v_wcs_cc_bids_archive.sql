...
PROMPT *** Create  view V_WCS_CC_BIDS_ARCHIVE ***
 ...
 where b.bid_id = bsh.bid_id
   ...
   and sh.id = case
         when bsh.state_id = 'NEW_SECRETARYCC' then
          'TOBO'
         when bsh.state_id = 'NEW_RU_SECRETARYCC' then
          'RU'
         when bsh.state_id = 'NEW_CA_SECRETARYCC' then
          'CA'
       end;
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_WCS_CC_BIDS_ARCHIVE.sql =========*** 
PROMPT ===================================================================================== 
