...
PROMPT *** Create  view V_WCS_SCORING_QS_DECIMAL ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_WCS_SCORING_QS_DECIMAL ("SCORING_ID", "QUESTION_ID", "ORD", "MIN_VAL", "MIN_SIGN", "MIN_SIGN_SIGN", "MAX_VAL", "MAX_SIGN", "MAX_SIGN_SIGN", "SCORE", "SCORE_MAX") AS 
