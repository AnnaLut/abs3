...
PROMPT *** Create  view E_DEAL ***
  ...
  SELECT e.NDI, e.nd, e.rnk, e.sos, e.cc_id, e.sdate, e.wdate, e.acc26,e.acc36,e.accd, a26.nls nls26, a36.nls nls36, ad.nls nls_d, a26.kv kv26,
       a36.kv kv36, ad.kv kvd, e.user_id, e.sa, e.accp, ap.nls, ap.kv, e.kf, a26.branch
  FROM (select * from e_deal$base where kf = sys_context('bars_context','user_mfo') ) e,
       accounts a26,
       accounts a36,
       accounts ad,
       accounts ap
