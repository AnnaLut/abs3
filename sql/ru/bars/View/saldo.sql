...
PROMPT *** Create  view SALDO ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.SALDO ("ACC", "KF", "BRANCH", "OB22", "KV", "NLS", "NLSALT", "OSTB", "OSTC", "DOS", "KOS", "LIM", "OSTF", "OSTQ", "DOSQ", "KOSQ", "NBS", "NBS2", "PAP", "DAOS", "DAPP", "DAZS", "ISP", "TIP", "VID", "MDATE", "NMS", "TRCN", "BLKD", "BLKK", "ACCC", "POS", "SEC", "TOBO", "RNK", "DAPPQ") AS 
  select acc,
       kf, branch,
       ob22,
       kv,nls,nlsalt,ostb,ostc,dos,kos,lim,ostf,ostq,dosq,kosq,
       nbs,nbs2,pap,daos,dapp,dazs,isp,tip,vid,mdate,nms,
       trcn,blkd,blkk,accc,pos,sec,tobo,rnk,dappq
  from accounts
;
