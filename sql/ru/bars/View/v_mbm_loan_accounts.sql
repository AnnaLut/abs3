/* Formatted on 1/13/2016 1:03:13 PM (QP5 v5.227.12220.39754) */
CREATE OR REPLACE FORCE VIEW V_MBM_LOAN_ACCOUNTS
(
   CUST_ID
   ,LOAN_TYPE
   ,CONTRACT_DATE
   ...
   ,REPAYMENT_ACC_NUMBER
   ,REPAYMENT_ACC_CURRENCY_CODE
   ,REPAYMENT_NAME
   ,REPAYMENT_BANK_CODE
   ,REPAYMENT_BANK_NAME
   ,REPAYMENT_TAX_CODE
