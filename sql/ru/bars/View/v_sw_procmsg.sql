...
PROMPT *** Create  view V_SW_PROCMSG ***
  ...
  select j.swref, j.mt, j.trn,
       j.sender   sender_bic,   sb1.name sender_name,
       j.receiver receiver_bic, sb2.name receiver_name,
       j.currency, abs(j.amount) amount,
       j.date_rec, j.date_pay, j.vdate,
