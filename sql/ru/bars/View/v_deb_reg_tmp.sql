CREATE OR REPLACE FORCE VIEW BARS.V_DEB_REG_TMP
(
   EVENTTYPE,
   CCOLOR,
   ACC,
...
GRANT DELETE, INSERT, SELECT, UPDATE ON BARS.V_DEB_REG_TMP TO BARS_ACCESS_DEFROLE;

GRANT DELETE, INSERT, SELECT, UPDATE ON BARS.V_DEB_REG_TMP TO DEB_REG;
/