...
PROMPT *** Create  view V_TMP_REZ_RISK_C5 ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_TMP_REZ_RISK_C5 ("DAT", "ACC", "NLS", "KV", "RNK", "ND", "ID", "S080", "S080_351", "SZ", "SZQ", "REZ_30", "REZQ_30", "RZ", "DISCONT", "PREM", "R013", "REZNQ", "BVQ", "TOBO", "ACCR", "ACCR_30", "DAT_MI") AS 
  SELECT fdat dat,
            acc,
            nls,
            kv,
