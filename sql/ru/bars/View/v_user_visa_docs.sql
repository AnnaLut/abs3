...
PROMPT *** Create  view V_USER_VISA_DOCS ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_USER_VISA_DOCS ("COLOR1", "COLOR2", "VDAT", "REF", "TT", "NLSA", "NLSB", "MFOB", "NB_B", "S", "S_", "DK", "SK", "LCV1", "DIG1", "USERID", "CHK", "NAZN", "LCV2", "DIG2", "S2", "S2_", "ND", "NEXTVISAGRP", "KV", "KV2", "TOBO", "FLAGS", "DEAL_TAG", "DATD", "PDAT", "PRTY", "SOS", "NAM_B", "MFOA", "NB_A", "DATP", "VOB", "NAM_A", "BRANCH", "ID_A", "ID_B") AS 
  select /*+ full(r) index(a pk_oper) */
      ...
      a.id_a,
      a.id_b
from ref_que r, oper a, v_user_visa uv, tts tt,
	banks$base
ba,
	banks$base
bb,
