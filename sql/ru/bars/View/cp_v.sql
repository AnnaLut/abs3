...
PROMPT *** Create  view CP_V ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.CP_V ("BAL_VAR", "SOS", "ND", "DATD", "SUMB", "DAZS", "TIP", "REF", "ID", "CP_ID", "MDATE", "IR", "ERAT", "RYN", "VIDD", "KV", "ACC", "ACCD", "ACCP", "ACCR", "ACCR2", "ACCS", "OSTA", "OSTD", "OSTP", "OSTR", "OSTR2", "OSTR3", "OSTEXPN", "OSTEXPR", "OSTS", "OSTAB", "OSTAF", "EMI", "DOX", "RNK", "PF", "PFNAME", "DAPP", "DATP", "OST_2VD", "OST_2VP", "ZAL", "COUNTRY") AS 
  SELECT (  osta
           + ostd
           + ostp
           + ostr
     ...
     FROM (SELECT o.sos,
             ...
             FROM cp_kod k,
                  ...
                  cp_pf cp,
                  oper o
            WHERE     v.vidd IN (SUBSTR (a.nls, 1, 4),
           ...
           SELECT o.sos,
                  o.nd,
                  a0.daos,
                  NVL (cpa.ostc, 0) / 100 + NVL (cpa.ostcr, 0) / 100 SUMB,
                  a.dazs,
                  k.tip,
                  e.REF,
                  k.ID,
