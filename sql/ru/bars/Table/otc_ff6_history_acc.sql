...
PROMPT *** Create  constraint SYS_C00187596 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTC_FF6_HISTORY_ACC MODIFY (KV NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint SYS_C00187595 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTC_FF6_HISTORY_ACC MODIFY (NLS NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C00187594 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTC_FF6_HISTORY_ACC MODIFY (ACC NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C00187593 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTC_FF6_HISTORY_ACC MODIFY (DATF NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
