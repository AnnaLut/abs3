...
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS_ACC ADD CONSTRAINT FK_CORPSACC_CORPS FOREIGN KEY (RNK)
	  REFERENCES BARS.CORPS (RNK) ENABLE';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS_ACC MODIFY (NLS CONSTRAINT CC_CORPSACC_NLS_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS_ACC MODIFY (MFO CONSTRAINT CC_CORPSACC_MFO_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS_ACC MODIFY (RNK CONSTRAINT CC_CORPSACC_RNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS_ACC MODIFY (ID CONSTRAINT CC_CORPSACC_ID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
