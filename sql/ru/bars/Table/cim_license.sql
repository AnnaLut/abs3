...
PROMPT *** Create  constraint FK_CIMLICENSE_KV ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE ADD CONSTRAINT FK_CIMLICENSE_KV FOREIGN KEY (KV)
...
PROMPT *** Create  constraint FK_CIMLICENSE_TYPE ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE ADD CONSTRAINT FK_CIMLICENSE_TYPE FOREIGN KEY (TYPE)
	  REFERENCES BARS.CIM_LICENSE_TYPE (TYPE_ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE MODIFY (END_DATE CONSTRAINT CC_CIMLICENSE_ENDDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE MODIFY (BEGIN_DATE CONSTRAINT CC_CIMLICENSE_BEGINDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE MODIFY (S CONSTRAINT CC_CIMLICENSE_S_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE MODIFY (KV CONSTRAINT CC_CIMLICENSE_KV_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE MODIFY (TYPE CONSTRAINT CC_CIMLICENSE_TYPE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE MODIFY (OKPO CONSTRAINT CC_CIMLICENSE_OKPO_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_LICENSE     to BARS_ACCESS_DEFROLE;
