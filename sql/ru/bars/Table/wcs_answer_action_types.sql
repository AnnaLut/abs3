...
COMMENT ON TABLE BARS.WCS_ANSWER_ACTION_TYPES IS 'Довідник прожиткового мінімума';
COMMENT ON COLUMN BARS.WCS_ANSWER_ACTION_TYPES.ID IS 'Дата з якої діє';
COMMENT ON COLUMN BARS.WCS_ANSWER_ACTION_TYPES.NAME IS 'Значення';
