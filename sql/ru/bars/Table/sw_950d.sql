...
PROMPT *** Create  constraint FK_SW950D_SWJOURNAL2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SW_950D ADD CONSTRAINT FK_SW950D_SWJOURNAL2 FOREIGN KEY (KF, SWREF)
...
PROMPT *** Create  constraint FK_SW950D_OPER2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SW_950D ADD CONSTRAINT FK_SW950D_OPER2 FOREIGN KEY (KF, OUR_REF)
