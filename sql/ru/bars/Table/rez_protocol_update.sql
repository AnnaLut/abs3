...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''REZ_PROTOCOL_UPDATE'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''REZ_PROTOCOL_UPDATE'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
grant SELECT                                                                 on REZ_PROTOCOL_UPDATE to BARS_SUP;
