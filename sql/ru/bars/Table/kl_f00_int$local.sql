...
begin   
 execute immediate '
  ALTER TABLE BARS.KL_F00_INT$LOCAL ADD CONSTRAINT FK_KLFINTLOC FOREIGN KEY (KODF, A017)
	  REFERENCES BARS.KL_F00_INT$GLOBAL (KODF, A017) ENABLE';
exception when others then
...
PROMPT *** Create  constraint PK_KLFINTLOC ***
begin   
 execute immediate '
  ALTER TABLE BARS.KL_F00_INT$LOCAL ADD CONSTRAINT PK_KLFINTLOC PRIMARY KEY (POLICY_GROUP, BRANCH, KODF, A017)
...
PROMPT *** Create  index PK_KLFINTLOC ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_KLFINTLOC ON BARS.KL_F00_INT$LOCAL (POLICY_GROUP, BRANCH, KODF, A017) 
