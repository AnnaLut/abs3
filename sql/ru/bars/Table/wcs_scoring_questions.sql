...
COMMENT ON COLUMN BARS.WCS_SCORING_QUESTIONS.ORD IS '';
...
PROMPT *** Create  constraint SYS_C003177189 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SCORING_QUESTIONS MODIFY (QUESTION_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177188 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SCORING_QUESTIONS MODIFY (SCORING_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
