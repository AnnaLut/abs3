...
COMMENT ON COLUMN BARS.BPK_ACC_UPDATE.DAT_CLOSE IS 'Дата закриття договору';
COMMENT ON COLUMN BARS.BPK_ACC_UPDATE.GRP IS 'група активу портфельного методу';
