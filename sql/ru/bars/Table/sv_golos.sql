...
COMMENT ON COLUMN BARS.SV_GOLOS.ID IS '';
...
COMMENT ON COLUMN BARS.SV_GOLOS.NOMER IS 'Номер договору, на підставі якого передається голос';
COMMENT ON COLUMN BARS.SV_GOLOS.DT IS 'Дата договору, на підставі якого передається голос';
