...
COMMENT ON COLUMN BARS.PRVN_FLOW_DEALS_VAR.SD1 IS 'Загальні нарах.проц. з початку звітного року';
COMMENT ON COLUMN BARS.PRVN_FLOW_DEALS_VAR.SD2 IS 'Загальна амортизація з початку звітного року';
