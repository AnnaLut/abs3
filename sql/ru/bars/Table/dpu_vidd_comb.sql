...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''DPU_VIDD_COMB'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
PROMPT *** Create  constraint FK_DPUVIDDCOMB_DPUVIDD2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_VIDD_COMB ADD CONSTRAINT FK_DPUVIDDCOMB_DPUVIDD2 FOREIGN KEY (DMND_VIDD)
...
PROMPT *** Create  constraint FK_DPUVIDDCOMB_DPUVIDD ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_VIDD_COMB ADD CONSTRAINT FK_DPUVIDDCOMB_DPUVIDD FOREIGN KEY (MAIN_VIDD)
	  REFERENCES BARS.DPU_VIDD (VIDD) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
