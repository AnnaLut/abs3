...
PROMPT *** Create  constraint FK_MAKDET_GRP ***
begin   
 execute immediate '
  ALTER TABLE BARS.MAKW_DET ADD CONSTRAINT FK_MAKDET_GRP FOREIGN KEY (GRP)
	  REFERENCES BARS.MAKW_GRP (GRP) ENABLE';
exception when others then
...
PROMPT *** Create  constraint FK_MAKWDET_TTS ***
begin   
 execute immediate '
  ALTER TABLE BARS.MAKW_DET ADD CONSTRAINT FK_MAKWDET_TTS FOREIGN KEY (TT)
...
PROMPT *** Create  constraint FK_MAKWDET_VOB ***
begin   
 execute immediate '
  ALTER TABLE BARS.MAKW_DET ADD CONSTRAINT FK_MAKWDET_VOB FOREIGN KEY (VOB)
...
PROMPT *** Create  constraint SYS_C002149218 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002149217 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002149216 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002149215 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002149214 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002149213 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002149212 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002149211 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002149210 ***
begin   
 execute immediate '
