...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''FIN_STAN'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
PROMPT *** Create  constraint FK_FINSTAN_STANFIN ***
begin   
 execute immediate '
  ALTER TABLE BARS.FIN_STAN ADD CONSTRAINT FK_FINSTAN_STANFIN FOREIGN KEY (FIN)
...
PROMPT *** Create  constraint FK_FINSTAN_CUSTTYPE ***
begin   
 execute immediate '
  ALTER TABLE BARS.FIN_STAN ADD CONSTRAINT FK_FINSTAN_CUSTTYPE FOREIGN KEY (CUSTTYPE)
