...
begin   
 execute immediate '
  ALTER TABLE BARS.CC_LIM ADD CONSTRAINT FK_CCLIM_ACCOUNTS FOREIGN KEY (KF, ACC)
...
PROMPT *** Create  constraint FK_CCLIM_CCDEAL ***
begin   
 execute immediate '
  ALTER TABLE BARS.CC_LIM ADD CONSTRAINT FK_CCLIM_CCDEAL FOREIGN KEY (KF, ND)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CC_LIM MODIFY (KF CONSTRAINT CC_CCLIM_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CC_LIM          to BARS_SUP;
