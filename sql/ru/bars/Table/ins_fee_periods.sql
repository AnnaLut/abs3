...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''INS_FEE_PERIODS'', ''FILIAL'' , null, null, null, null);
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_FEE_PERIODS ADD CONSTRAINT FK_FEEPRDS_FID_FEES FOREIGN KEY (FEE_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_FEE_PERIODS ADD CONSTRAINT PK_FEEPRDS PRIMARY KEY (FEE_ID, PERIOD_ID)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_FEEPRDS ON BARS.INS_FEE_PERIODS (FEE_ID, PERIOD_ID) 
