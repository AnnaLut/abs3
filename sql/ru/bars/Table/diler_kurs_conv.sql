...
PROMPT *** Create  constraint FK_DILERKURSCONV_ZAYCONVKV ***
begin   
 execute immediate '
  ALTER TABLE BARS.DILER_KURS_CONV ADD CONSTRAINT FK_DILERKURSCONV_ZAYCONVKV FOREIGN KEY (KV1, KV2)
	  REFERENCES BARS.ZAY_CONV_KV (KV1, KV2) ENABLE';
exception when others then
