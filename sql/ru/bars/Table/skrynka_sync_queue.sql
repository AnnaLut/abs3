...
begin   
 execute immediate '
  ALTER TABLE BARS.SKRYNKA_SYNC_QUEUE ADD CONSTRAINT FK_BR_SKRYN_SYNC_QUEUE_TYPE FOREIGN KEY (SYNC_TYPE)
	  REFERENCES BARS.SKRYNKA_SYNC_TYPE (TYPE) ENABLE';
exception when others then
...
PROMPT *** Create  constraint SYS_C002834877 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002834876 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002834875 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002834874 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002834873 ***
begin   
 execute immediate '
