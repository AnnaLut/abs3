...
PROMPT *** Create  constraint FK_SWNOSTROQUE_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.SW_NOSTRO_QUE ADD CONSTRAINT FK_SWNOSTROQUE_OPER FOREIGN KEY (REF)
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_NOSTRO_QUE MODIFY (REF CONSTRAINT CC_SWNOSTROQUE_REF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
