...
PROMPT *** Create  constraint FK_CP_OPREF ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_PAYMENTS ADD CONSTRAINT FK_CP_OPREF FOREIGN KEY (OP_REF)
...
PROMPT *** Create  constraint SYS_C002868524 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002868523 ***
begin   
 execute immediate '
