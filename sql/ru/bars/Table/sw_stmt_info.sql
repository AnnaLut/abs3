...
PROMPT *** Create  constraint FK_SWSTMTINFO_SWJOURNAL2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SW_STMT_INFO ADD CONSTRAINT FK_SWSTMTINFO_SWJOURNAL2 FOREIGN KEY (KF, LAST_MESSAGE_REF)
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_STMT_INFO MODIFY (KF CONSTRAINT CC_SWSTMTINFO_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_STMT_INFO MODIFY (STATEMENT_NUMBER CONSTRAINT CC_SWSTMTINFO_STMTNUM_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_STMT_INFO MODIFY (ACC CONSTRAINT CC_SWSTMTINFO_ACC_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
