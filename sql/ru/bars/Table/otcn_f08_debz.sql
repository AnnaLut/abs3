...
PROMPT *** Create  constraint SYS_C0010735 ***
begin   
 execute immediate '
...
begin   
 execute immediate '
  ALTER TABLE BARS.OTCN_F08_DEBZ MODIFY (KF CONSTRAINT CC_OTCNF08DEBZ_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0010733 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTCN_F08_DEBZ MODIFY (RECID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0010732 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTCN_F08_DEBZ MODIFY (REF NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  index SYS_C0010735 ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.SYS_C0010735 ON BARS.OTCN_F08_DEBZ (RECID) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE BRSDYNI ';
exception when others then
  if  sqlcode=-955  then null; else raise; end if;
