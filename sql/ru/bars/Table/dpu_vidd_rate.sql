...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''DPU_VIDD_RATE'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''DPU_VIDD_RATE'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_VIDD_RATE ADD CONSTRAINT FK_DPUVIDDRATE_DPUVIDD FOREIGN KEY (VIDD)
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_VIDD_RATE ADD CONSTRAINT UK_DPUVIDDRATE UNIQUE (TYPE_ID, KV, VIDD, TERM, TERM_DAYS, LIMIT)
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UK_DPUVIDDRATE ON BARS.DPU_VIDD_RATE (TYPE_ID, KV, VIDD, TERM, TERM_DAYS, LIMIT) 
