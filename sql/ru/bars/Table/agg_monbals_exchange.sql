...
PROMPT *** Create  constraint SYS_C002915223 ***
begin   
 execute immediate '
  ALTER TABLE BARS.AGG_MONBALS_EXCHANGE MODIFY (KOSQ NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint SYS_C002915222 ***
begin   
 execute immediate '
  ALTER TABLE BARS.AGG_MONBALS_EXCHANGE MODIFY (DOSQ NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002915221 ***
begin   
 execute immediate '
  ALTER TABLE BARS.AGG_MONBALS_EXCHANGE MODIFY (OSTQ NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002915220 ***
begin   
 execute immediate '
  ALTER TABLE BARS.AGG_MONBALS_EXCHANGE MODIFY (KOS NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002915219 ***
begin   
 execute immediate '
  ALTER TABLE BARS.AGG_MONBALS_EXCHANGE MODIFY (DOS NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002915218 ***
begin   
 execute immediate '
  ALTER TABLE BARS.AGG_MONBALS_EXCHANGE MODIFY (OST NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002915217 ***
begin   
 execute immediate '
  ALTER TABLE BARS.AGG_MONBALS_EXCHANGE MODIFY (RNK NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002915216 ***
begin   
 execute immediate '
  ALTER TABLE BARS.AGG_MONBALS_EXCHANGE MODIFY (ACC NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002915215 ***
begin   
 execute immediate '
  ALTER TABLE BARS.AGG_MONBALS_EXCHANGE MODIFY (FDAT NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  index UK_AGG_MONBALS_EXCHANGE ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UK_AGG_MONBALS_EXCHANGE ON BARS.AGG_MONBALS_EXCHANGE (FDAT, ACC) 
