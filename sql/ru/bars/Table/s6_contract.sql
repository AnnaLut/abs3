...
begin 
  ...
  CREATE TABLE BARS.S6_Contract 
   (	BIC NUMBER(10,0), 
	...
	MethodCI NUMBER(3,0), 
	PeriodPr NUMBER(3,0), 
	EffectPrc NUMBER(9,4), 
	EtalonPrc NUMBER(9,4)
...
COMMENT ON COLUMN BARS.S6_Contract.PeriodPr IS '';
COMMENT ON COLUMN BARS.S6_Contract.EffectPrc IS '';
COMMENT ON COLUMN BARS.S6_Contract.EtalonPrc IS '';
...
PROMPT *** Create  constraint SYS_C0097427 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097426 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097425 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097424 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097423 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097422 ***
begin   
 execute immediate '
...
PROMPT *** Create  index XIE_S6_Contract_Id ***
begin   
 execute immediate '
  CREATE INDEX BARS.XIE_S6_Contract_Id ON BARS.S6_Contract (IdContract) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE BRSDYND ';
exception when others then
  if  sqlcode=-955  then null; else raise; end if;
