...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''LIST_ITEM'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
begin   
 execute immediate '
  ALTER TABLE BARS.LIST_ITEM ADD CONSTRAINT FK_ENUM_VAL_REF_PARENT FOREIGN KEY (LIST_TYPE_ID, PARENT_LIST_ITEM_ID)
	  REFERENCES BARS.LIST_ITEM (LIST_TYPE_ID, LIST_ITEM_ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002861297 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861296 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861295 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861294 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861293 ***
begin   
 execute immediate '
