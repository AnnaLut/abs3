...
grant DELETE,INSERT,SELECT,UPDATE                                            on DWH_IMPORT_STAT to BARSDWH_ACCESS_USER;



PROMPT *** Create SYNONYM  to DWH_IMPORT_STAT ***

  CREATE OR REPLACE SYNONYM BARSDWH_ACCESS_USER.DWH_IMPORT_STAT FOR BARS.DWH_IMPORT_STAT;
