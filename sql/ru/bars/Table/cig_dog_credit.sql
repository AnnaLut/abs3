...
PROMPT *** Create  constraint FK_CIGDOGCREDIT_TABVAL3 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_CREDIT ADD CONSTRAINT FK_CIGDOGCREDIT_TABVAL3 FOREIGN KEY (OVERDUE_CURR_ID)
...
PROMPT *** Create  constraint FK_CIGDOGCREDIT_TABVAL2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_CREDIT ADD CONSTRAINT FK_CIGDOGCREDIT_TABVAL2 FOREIGN KEY (RES_CURR_ID)
	  REFERENCES BARS.TABVAL$GLOBAL (KV) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_CIGDOGCREDIT_TABVAL1 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_CREDIT ADD CONSTRAINT FK_CIGDOGCREDIT_TABVAL1 FOREIGN KEY (LIMIT_CURR_ID)
	  REFERENCES BARS.TABVAL$GLOBAL (KV) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_CIGDOGCRED_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_CREDIT ADD CONSTRAINT FK_CIGDOGCRED_BRANCH FOREIGN KEY (BRANCH)
