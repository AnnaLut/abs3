...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_GROUPS MODIFY (CODE CONSTRAINT CC_W4PRODUCTGROUPS_CODE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_GROUPS MODIFY (CLIENT_TYPE CONSTRAINT CC_W4PRODUCTGROUPS_CTYPE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_GROUPS ADD CONSTRAINT CC_W4PRODUCTGROUPS_CLIENTTYPE CHECK (client_type in (1,2)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on W4_PRODUCT_GROUPS to BARS_SUP;
