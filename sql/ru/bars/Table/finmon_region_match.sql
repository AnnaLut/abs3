...
PROMPT *** Create  constraint R_FINMON_REGION_MATCH_SPR_REG ***
begin   
 execute immediate '
  ALTER TABLE BARS.FINMON_REGION_MATCH ADD CONSTRAINT R_FINMON_REGION_MATCH_SPR_REG FOREIGN KEY (BARS_CODE)
	  REFERENCES BARS.SPR_OBL (C_REG) ON DELETE CASCADE ENABLE';
exception when others then
