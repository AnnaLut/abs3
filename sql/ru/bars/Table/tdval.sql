...
PROMPT *** Create  constraint FK_TDVAL_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.TDVAL ADD CONSTRAINT FK_TDVAL_OPER FOREIGN KEY (KF, REF)
...
PROMPT *** Create  constraint FK_TDVAL_ARCRRP2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.TDVAL ADD CONSTRAINT FK_TDVAL_ARCRRP2 FOREIGN KEY (KF, REC)
