...
PROMPT *** Create  constraint FK_DPUTYPESTERM_DPUTYPES ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_TYPES_TERM ADD CONSTRAINT FK_DPUTYPESTERM_DPUTYPES FOREIGN KEY (TYPE_ID)
...
grant SELECT                                                                 on DPU_TYPES_TERM  to BARS_ACCESS_DEFROLE;
