...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''STO_TYPE'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
PROMPT *** Create  constraint SYS_C002755405 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002755406 ***
begin   
 execute immediate '
...
grant SELECT                                                                 on STO_TYPE        to BARSUPL;
