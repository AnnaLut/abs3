...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_SUBPRODUCT MODIFY (CODE CONSTRAINT CC_W4SUBPRODUCT_CODE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_SUBPRODUCT ADD CONSTRAINT CC_W4SUBPRODUCT_FLAGKK CHECK (flag_kk in (0,1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_SUBPRODUCT ADD CONSTRAINT CC_W4SUBPRODUCT_FLAGKK_NN CHECK (flag_kk is not null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_SUBPRODUCT ADD CONSTRAINT CC_W4SUBPRODUCT_FLAGINSTANT CHECK (flag_instant in (0, 1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_SUBPRODUCT ADD CONSTRAINT CC_W4SUBPRODUCT_FLAGINSTANT_NN CHECK (flag_instant is not null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on W4_SUBPRODUCT   to BARS_SUP;
