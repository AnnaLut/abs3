...
begin   
 execute immediate '
  ALTER TABLE BARS.REZ_ACC ADD CONSTRAINT PK_REZ_ACC PRIMARY KEY (ACC) ENABLE';
exception when others then
...
PROMPT *** Create  constraint SYS_C0068225 ***
begin   
 execute immediate '
  ALTER TABLE BARS.REZ_ACC MODIFY (ACC NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
