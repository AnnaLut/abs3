...
PROMPT *** Create  constraint FK_DPTPOAS_SID_STAFF ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_POAS ADD CONSTRAINT FK_DPTPOAS_SID_STAFF FOREIGN KEY (STAFF_ID)
...
grant SELECT                                                                 on DPT_POAS        to BARS_ACCESS_DEFROLE;
grant DELETE,INSERT,SELECT,UPDATE                                            on DPT_POAS        to DPT_ADMIN;
grant FLASHBACK,SELECT                                                       on DPT_POAS        to WR_REFREAD;
