...
PROMPT *** Create  constraint FK_CIMAPE_KV ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_APE ADD CONSTRAINT FK_CIMAPE_KV FOREIGN KEY (KV)
...
PROMPT *** Create  constraint FK_CIMAPE_CONTRID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_APE ADD CONSTRAINT FK_CIMAPE_CONTRID FOREIGN KEY (CONTR_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_APE MODIFY (END_DATE CONSTRAINT CC_CIMAPE_ENDDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_APE MODIFY (BEGIN_DATE CONSTRAINT CC_CIMAPE_BEGINDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_APE MODIFY (S_VK CONSTRAINT CC_CIMAPE_SVK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_APE MODIFY (RATE CONSTRAINT CC_CIMAPE_RATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_APE MODIFY (S CONSTRAINT CC_CIMAPE_S_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_APE MODIFY (KV CONSTRAINT CC_CIMAPE_KV_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_APE MODIFY (CONTR_ID CONSTRAINT CC_CIMAPE_CONTRID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_CONTRACTS_APE to BARS_ACCESS_DEFROLE;
