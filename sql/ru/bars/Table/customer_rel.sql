...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT FK_CUSTOMERREL_CUSTOMERBINDATA FOREIGN KEY (SIGN_ID)
	  REFERENCES BARS.CUSTOMER_BIN_DATA (ID) ENABLE';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT FK_CUSTOMERREL_TRUSTEEDOCTYPE FOREIGN KEY (DOCUMENT_TYPE_ID)
	  REFERENCES BARS.TRUSTEE_DOCUMENT_TYPE (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT FK_CUSTOMERREL_TRUSTEETYPE FOREIGN KEY (TYPE_ID)
	  REFERENCES BARS.TRUSTEE_TYPE (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT FK_CUSTOMERREL_CUSTREL FOREIGN KEY (REL_ID)
	  REFERENCES BARS.CUST_REL (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT CC_CUSTOMERREL_SIGNPRIVS2 CHECK (decode(rel_id, 20, sign_privs, 0) is not null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT CC_CUSTOMERREL_TYPEID CHECK (decode(rel_id, 20, type_id, 0) is not null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT CC_CUSTOMERREL_SIGNPRIVS CHECK (sign_privs in (0,1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT CC_CUSTOMERREL_RELINTEXT CHECK (rel_intext in (0,1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL MODIFY (REL_INTEXT CONSTRAINT CC_CUSTOMERREL_RELINTEXT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL MODIFY (REL_RNK CONSTRAINT CC_CUSTOMERREL_RELRNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL MODIFY (REL_ID CONSTRAINT CC_CUSTOMERREL_RELID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL MODIFY (RNK CONSTRAINT CC_CUSTOMERREL_RNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT CC_CUSTOMERREL_VAGA2 CHECK (vaga2<=100) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_REL ADD CONSTRAINT CC_CUSTOMERREL_VAGA1 CHECK (vaga1<=100) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CUSTOMER_REL    to BARS_SUP;
