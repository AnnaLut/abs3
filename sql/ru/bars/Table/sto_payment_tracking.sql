...
begin   
 execute immediate '
  ALTER TABLE BARS.STO_PAYMENT_TRACKING ADD CONSTRAINT FK_PAYM_TRACK_REF_PAYMENT FOREIGN KEY (PAYMENT_ID)
	  REFERENCES BARS.STO_PAYMENT (ID) ENABLE';
exception when others then
...
PROMPT *** Create  constraint SYS_C002755370 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002755369 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002755368 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002755371 ***
begin   
 execute immediate '
...
grant SELECT                                                                 on STO_PAYMENT_TRACKING to BARSUPL;
grant SELECT                                                                 on STO_PAYMENT_TRACKING to BARS_DM;
