...
PROMPT *** Create  constraint R_FINMON_DOC_MATCH_PASSP ***
begin   
 execute immediate '
  ALTER TABLE BARS.FINMON_DOC_MATCH ADD CONSTRAINT R_FINMON_DOC_MATCH_PASSP FOREIGN KEY (BARS_CODE)
	  REFERENCES BARS.PASSP (PASSP) ON DELETE CASCADE ENABLE';
exception when others then
