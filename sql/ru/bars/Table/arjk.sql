...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''ARJK'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''ARJK'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint PK_ARJK_IDC ***
begin   
 execute immediate '
  ALTER TABLE BARS.ARJK ADD CONSTRAINT PK_ARJK_IDC PRIMARY KEY (ID)
...
PROMPT *** Create  index PK_ARJK_IDC ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_ARJK_IDC ON BARS.ARJK (ID) 
...
grant DELETE,INSERT,SELECT,UPDATE                                            on ARJK            to BARS_ACCESS_DEFROLE;
grant DELETE,INSERT,SELECT,UPDATE                                            on ARJK            to RCC_DEAL;
