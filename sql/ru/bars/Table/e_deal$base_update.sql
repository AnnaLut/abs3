...
PROMPT *** Create  constraint SYS_C002328539 ***
begin   
 execute immediate '
  ALTER TABLE BARS.E_DEAL$BASE_UPDATE MODIFY (ACC26 NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002328538 ***
begin   
 execute immediate '
  ALTER TABLE BARS.E_DEAL$BASE_UPDATE MODIFY (KF NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002328537 ***
begin   
 execute immediate '
  ALTER TABLE BARS.E_DEAL$BASE_UPDATE MODIFY (RNK NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002328536 ***
begin   
 execute immediate '
  ALTER TABLE BARS.E_DEAL$BASE_UPDATE MODIFY (ND NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on E_DEAL$BASE_UPDATE to BARS_SUP;
