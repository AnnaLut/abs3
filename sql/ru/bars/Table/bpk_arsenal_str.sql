...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''BPK_ARSENAL_STR'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''BPK_ARSENAL_STR'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UK_BPKARSENALSTR_OB22 ON BARS.BPK_ARSENAL_STR (OB22) 
