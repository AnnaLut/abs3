...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''KL_S580'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''KL_S580'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
grant DELETE,FLASHBACK,INSERT,SELECT,UPDATE                                  on KL_S580         to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on KL_S580         to BARS_SUP;
grant DELETE,INSERT,SELECT,UPDATE                                            on KL_S580         to RPBN002;
grant SELECT                                                                 on KL_S580         to START1;
grant SELECT                                                                 on KL_S580         to UPLD;
grant FLASHBACK,SELECT                                                       on KL_S580         to WR_REFREAD;
