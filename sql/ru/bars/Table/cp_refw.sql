...
PROMPT *** Create  constraint CP_REFW_TAG ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_REFW ADD CONSTRAINT CP_REFW_TAG FOREIGN KEY (TAG)
...
PROMPT *** Create  constraint CP_REFW_REF ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_REFW ADD CONSTRAINT CP_REFW_REF FOREIGN KEY (REF)
	  REFERENCES BARS.CP_ARCH (REF) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
