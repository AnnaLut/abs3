...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''SKRYNKA_TARIFF1'', ''FILIAL'' , ''Q'', ''Q'', ''Q'', ''Q'');
...
begin   
 execute immediate '
  ALTER TABLE BARS.SKRYNKA_TARIFF1 ADD CONSTRAINT PK_SKRYNKATARIFF1 PRIMARY KEY (TARIFF, TARIFF_DATE)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_SKRYNKATARIFF1 ON BARS.SKRYNKA_TARIFF1 (TARIFF, TARIFF_DATE) 
