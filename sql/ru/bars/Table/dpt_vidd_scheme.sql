...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''DPT_VIDD_SCHEME'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
PROMPT *** Create  constraint FK_DPTVIDDSCHEME_IDFR_DOCSM ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_VIDD_SCHEME ADD CONSTRAINT FK_DPTVIDDSCHEME_IDFR_DOCSM FOREIGN KEY (ID_FR)
...
PROMPT *** Create  constraint FK_DPTVIDDSCHEME_ID_DOCSM ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_VIDD_SCHEME ADD CONSTRAINT FK_DPTVIDDSCHEME_ID_DOCSM FOREIGN KEY (ID)
	  REFERENCES BARS.DOC_SCHEME (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_DPTVIDDSCHEME_DPTVIDDFLAGS ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_VIDD_SCHEME ADD CONSTRAINT FK_DPTVIDDSCHEME_DPTVIDDFLAGS FOREIGN KEY (FLAGS)
...
PROMPT *** Create  constraint FK_DPTVIDDSCHEME_DPTVIDD ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_VIDD_SCHEME ADD CONSTRAINT FK_DPTVIDDSCHEME_DPTVIDD FOREIGN KEY (VIDD)
...
PROMPT *** Create  constraint FK_DPTVIDDSCHEME_DPTTYPE ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_VIDD_SCHEME ADD CONSTRAINT FK_DPTVIDDSCHEME_DPTTYPE FOREIGN KEY (TYPE_ID)
...
grant SELECT                                                                 on DPT_VIDD_SCHEME to BARS_ACCESS_DEFROLE;
