...
COMMENT ON COLUMN BARS.STO_PAYMENT.BRANCH IS '';
...
PROMPT *** Create  constraint SYS_C002755364 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002755363 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002755362 ***
begin   
 execute immediate '
...
grant SELECT                                                                 on STO_PAYMENT     to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on STO_PAYMENT     to BARS_DM;
