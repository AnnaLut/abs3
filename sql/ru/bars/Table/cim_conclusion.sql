...
PROMPT *** Create  constraint FK_CIMCONCLUSION_ORGID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION ADD CONSTRAINT FK_CIMCONCLUSION_ORGID FOREIGN KEY (ORG_ID)
	  REFERENCES BARS.CIM_CONCLUSION_ORG (ID) ENABLE';
exception when others then
...
PROMPT *** Create  constraint FK_CIMCONCLUSION_CONTRID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION ADD CONSTRAINT FK_CIMCONCLUSION_CONTRID FOREIGN KEY (CONTR_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION MODIFY (CREATE_UID CONSTRAINT CC_CIMCONCLUSION_CREATEUID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION MODIFY (CREATE_DATE CONSTRAINT CC_CIMCONCLUSION_CREATEDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION MODIFY (END_DATE CONSTRAINT CC_CIMCONCLUSION_ENDDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION MODIFY (BEGIN_DATE CONSTRAINT CC_CIMCONCLUSION_BEGINDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION MODIFY (S CONSTRAINT CC_CIMCONCLUSION_S_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION MODIFY (KV CONSTRAINT CC_CIMCONCLUSION_KV_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION MODIFY (ORG_ID CONSTRAINT CC_CIMCONCLUSION_ORGID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONCLUSION MODIFY (CONTR_ID CONSTRAINT CC_CIMCONCLUSION_CONTRID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_CONCLUSION  to BARS_ACCESS_DEFROLE;
