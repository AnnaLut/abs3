...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SYNC_STATUSES ADD CONSTRAINT CC_WCSSYNCSTATUSES_NAME_NN CHECK (NAME IS NOT NULL) ENABLE';
exception when others then
...
PROMPT *** Create  constraint SYS_C003177403 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SYNC_STATUSES MODIFY (ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
