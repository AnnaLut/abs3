...
COMMENT ON COLUMN BARS.SEC_ATTR_JOURNAL.REC_ID IS 'Ід.';
COMMENT ON COLUMN BARS.SEC_ATTR_JOURNAL.WHO_GRANT IS 'Хто змінив';
COMMENT ON COLUMN BARS.SEC_ATTR_JOURNAL.DATE_GRANT IS 'Дата зміни';
COMMENT ON COLUMN BARS.SEC_ATTR_JOURNAL.ACTION IS 'Дія';
...
COMMENT ON COLUMN BARS.SEC_ATTR_JOURNAL.USER_ID IS 'Ід. користувача';
