...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CORPS_UPDATE'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''CORPS_UPDATE'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint SYS_C001955667 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS_UPDATE MODIFY (RNK NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003008345 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS_UPDATE MODIFY (GLOBAL_BDATE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CORPS_UPDATE    to BARS_SUP;
