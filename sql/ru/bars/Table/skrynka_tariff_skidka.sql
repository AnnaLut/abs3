...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''SKRYNKA_TARIFF_SKIDKA'', ''FILIAL'' , ''Q'', ''Q'', ''Q'', ''Q'');
...
begin   
 execute immediate '
  ALTER TABLE BARS.SKRYNKA_TARIFF_SKIDKA ADD CONSTRAINT PK_SKRYNKATARIFFSKIDKA PRIMARY KEY (TARIFF, TARIFF_DATE, MONTHS)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_SKRYNKATARIFFSKIDKA ON BARS.SKRYNKA_TARIFF_SKIDKA (TARIFF, TARIFF_DATE, MONTHS) 
