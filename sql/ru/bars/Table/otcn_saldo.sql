...
COMMENT ON TABLE BARS.OTCN_SALDO IS 'Временная таблица оборотов и остатков по счетам для формирования файлов отчетности';
...
PROMPT *** Create  constraint SYS_C001213029 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C001213028 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C001213027 ***
begin   
 execute immediate '
...
grant DELETE,INSERT,SELECT,UPDATE                                            on OTCN_SALDO      to ABS_ADMIN;
