...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''INS_ACCIDENTS'', ''FILIAL'' , null, null, null, null);
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_ACCIDENTS ADD CONSTRAINT FK_INSACCIDENTS_DID_DEALS FOREIGN KEY (DEAL_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_ACCIDENTS ADD CONSTRAINT PK_INSACCIDENTS PRIMARY KEY (ID)
...
PROMPT *** Create  constraint SYS_C003101330 ***
begin   
 execute immediate '
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_INSACCIDENTS ON BARS.INS_ACCIDENTS (ID) 
