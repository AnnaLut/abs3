...
PROMPT *** Create  constraint FK_CLVCUSTOMERADDRESS_CLVREQ ***
begin   
 execute immediate '
  ALTER TABLE BARS.CLV_CUSTOMER_ADDRESS ADD CONSTRAINT FK_CLVCUSTOMERADDRESS_CLVREQ FOREIGN KEY (RNK)
