...
PROMPT *** Create  constraint PK_DPTCUSTOMERCHANGES_TAG ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_CUSTOMER_CHANGES ADD CONSTRAINT PK_DPTCUSTOMERCHANGES_TAG FOREIGN KEY (TAG)
	  REFERENCES BARS.DPT_CUSTOMER_TAGS (TAG_CODE) ENABLE';
exception when others then
...
grant SELECT                                                                 on DPT_CUSTOMER_CHANGES to BARS_ACCESS_DEFROLE;
