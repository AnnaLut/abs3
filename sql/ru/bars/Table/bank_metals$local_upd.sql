...
PROMPT *** Create  constraint FK_BANKMETALSLOCALUPD_ACCOUNTS ***
begin   
 execute immediate '
  ALTER TABLE BARS.BANK_METALS$LOCAL_UPD ADD CONSTRAINT FK_BANKMETALSLOCALUPD_ACCOUNTS FOREIGN KEY (ACC_3800)
