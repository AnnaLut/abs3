...
begin   
 execute immediate '
  ALTER TABLE BARS.PERSON_VALID_DOCUMENT_UPDATE MODIFY (USERID CONSTRAINT CC_PERSVALIDDOCUPD_USERID_NN NOT NULL ENABLE)';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.PERSON_VALID_DOCUMENT_UPDATE MODIFY (DOC_STATE CONSTRAINT CC_PERSVALIDDOCUPD_DOCSTATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.PERSON_VALID_DOCUMENT_UPDATE MODIFY (CHGDATE CONSTRAINT CC_PERSVALIDDOCUPD_CHGDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.PERSON_VALID_DOCUMENT_UPDATE MODIFY (RNK CONSTRAINT CC_PERSVALIDDOCUPD_RNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant INSERT,SELECT,UPDATE                                                   on PERSON_VALID_DOCUMENT_UPDATE to BARS_ACCESS_DEFROLE;
