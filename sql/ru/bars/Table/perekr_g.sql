...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''PEREKR_G'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''PEREKR_G'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
begin   
 execute immediate '
  ALTER TABLE BARS.PEREKR_G ADD CONSTRAINT PK_PEREKRG PRIMARY KEY (IDG)
...
PROMPT *** Create  constraint SYS_C0010833 ***
begin   
 execute immediate '
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_PEREKRG ON BARS.PEREKR_G (IDG) 
