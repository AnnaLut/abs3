...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''PB_1'', ''FILIAL'' , null, null, null, null);
...
grant DELETE,INSERT,SELECT,UPDATE                                            on PB_1            to ABS_ADMIN;
grant DELETE,INSERT,SELECT,UPDATE                                            on PB_1            to BARS_ACCESS_DEFROLE;
grant DELETE,INSERT,SELECT,UPDATE                                            on PB_1            to PB1;
grant SELECT                                                                 on PB_1            to START1;
grant DELETE,FLASHBACK,INSERT,SELECT,UPDATE                                  on PB_1            to WR_ALL_RIGHTS;
