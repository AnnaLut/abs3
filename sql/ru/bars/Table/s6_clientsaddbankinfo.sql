...
COMMENT ON COLUMN BARS.S6_ClientsAddBankInfo.Payment IS '';




PROMPT *** Create  constraint SYS_C0097421 ***
begin   
 execute immediate '
  ALTER TABLE BARS.S6_ClientsAddBankInfo MODIFY (I_VA NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint SYS_C0097420 ***
begin   
 execute immediate '
  ALTER TABLE BARS.S6_ClientsAddBankInfo MODIFY (Account NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0097419 ***
begin   
 execute immediate '
  ALTER TABLE BARS.S6_ClientsAddBankInfo MODIFY (CodeBank NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0097418 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097417 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097416 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097415 ***
begin   
 execute immediate '
