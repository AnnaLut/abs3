...
PROMPT *** Create  constraint FK_CIMCGPAYMENT_PAYFLAG ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CREDGRAPH_PAYMENT ADD CONSTRAINT FK_CIMCGPAYMENT_PAYFLAG FOREIGN KEY (PAY_FLAG)
...
PROMPT *** Create  constraint FK_CIMCGPAYMENT_CONTRID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CREDGRAPH_PAYMENT ADD CONSTRAINT FK_CIMCGPAYMENT_CONTRID FOREIGN KEY (CONTR_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CREDGRAPH_PAYMENT ADD CONSTRAINT CC_CIMCGPAYMENT_PAYFLAG_CC CHECK (pay_flag in (2,3,4,5)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CREDGRAPH_PAYMENT MODIFY (PAY_FLAG CONSTRAINT CC_CIMCGPAYMENT_PAYFLAG_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CREDGRAPH_PAYMENT MODIFY (S CONSTRAINT CC_CIMCGPAYMENT_S_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CREDGRAPH_PAYMENT MODIFY (DAT CONSTRAINT CC_CIMCGPAYMENT_DAT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CREDGRAPH_PAYMENT MODIFY (CONTR_ID CONSTRAINT CC_CIMCGPAYMENT_CONTRID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_CREDGRAPH_PAYMENT to BARS_ACCESS_DEFROLE;
