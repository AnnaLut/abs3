...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''OW_PKK_HISTORY'', ''FILIAL'' , null, null, null, null);
...
PROMPT *** Create  constraint FK_OWPKKHISTORY_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_HISTORY ADD CONSTRAINT FK_OWPKKHISTORY_OPER FOREIGN KEY (REF)
...
PROMPT *** Create  constraint FK_OWPKKHISTORY_ACCOUNTS ***
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_HISTORY ADD CONSTRAINT FK_OWPKKHISTORY_ACCOUNTS FOREIGN KEY (ACC)
