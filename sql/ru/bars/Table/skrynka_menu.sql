...
BEGIN 
        execute immediate  
          'begin  
               ...
               bpa.alter_policy_info(''SKRYNKA_MENU'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
begin   
 execute immediate '
  ALTER TABLE BARS.SKRYNKA_MENU ADD CONSTRAINT XUK_SKRYNKA_MENU_NAME UNIQUE (NAME)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.XUK_SKRYNKA_MENU_NAME ON BARS.SKRYNKA_MENU (NAME) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE BRSMDLI ';
exception when others then
  if  sqlcode=-955  then null; else raise; end if;
