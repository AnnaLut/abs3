...
PROMPT *** Create  constraint FK_KOMISNONCASH_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.KOMIS_NON_CASH ADD CONSTRAINT FK_KOMISNONCASH_OPER FOREIGN KEY (REF)
	  REFERENCES BARS.OPER (REF) DISABLE';
exception when others then
...
PROMPT *** Create  constraint FK_KOMISNONCASH_KF ***
begin   
 execute immediate '
  ALTER TABLE BARS.KOMIS_NON_CASH ADD CONSTRAINT FK_KOMISNONCASH_KF FOREIGN KEY (KF)
