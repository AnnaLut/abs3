...
BEGIN 
        execute immediate  
          'begin  
               ...
               bpa.alter_policy_info(''CDB_DEAL_COMMENT'', ''WHOLE'' , null, ''E'', ''E'', ''E'');
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint FK_DEAL_COMMENT_REF_DEAL ***
begin   
 execute immediate '
  ALTER TABLE BARS.CDB_DEAL_COMMENT ADD CONSTRAINT FK_DEAL_COMMENT_REF_DEAL FOREIGN KEY (ND)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CDB_DEAL_COMMENT MODIFY (COMMENT_MESSAGE CONSTRAINT CC_CDB_DEAL_COMMENT_NOT_NULL NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CDB_DEAL_COMMENT MODIFY (COMMENT_DATE CONSTRAINT CC_CDB_DEAL_COMM_DATE_NOT_NULL NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CDB_DEAL_COMMENT MODIFY (ND CONSTRAINT CC_CDB_DEAL_COMM_ND_NOT_NULL NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
