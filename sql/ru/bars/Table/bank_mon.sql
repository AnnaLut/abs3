...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''BANK_MON'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
PROMPT *** Create  constraint SYS_C009281 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C009280 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C009279 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C009278 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C009277 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C009276 ***
begin   
 execute immediate '
...
grant SELECT                                                                 on BANK_MON        to BARS_SUP;
