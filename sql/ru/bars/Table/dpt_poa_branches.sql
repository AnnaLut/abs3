...
PROMPT *** Create  constraint FK_DPTPOABRANCHES_DPTPOAS ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_POA_BRANCHES ADD CONSTRAINT FK_DPTPOABRANCHES_DPTPOAS FOREIGN KEY (POA_ID)
	  REFERENCES BARS.DPT_POAS (ID) ENABLE';
exception when others then
...
PROMPT *** Create  constraint FK_DPTPOABRANCHES_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_POA_BRANCHES ADD CONSTRAINT FK_DPTPOABRANCHES_BRANCH FOREIGN KEY (BRANCH)
...
PROMPT *** Create  constraint SYS_C002335313 ***
begin   
 execute immediate '
...
grant SELECT                                                                 on DPT_POA_BRANCHES to BARS_ACCESS_DEFROLE;
grant DELETE,INSERT,SELECT,UPDATE                                            on DPT_POA_BRANCHES to DPT_ADMIN;
grant FLASHBACK,SELECT                                                       on DPT_POA_BRANCHES to WR_REFREAD;
