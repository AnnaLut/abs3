...
COMMENT ON COLUMN BARS.SB_OB22.SEGMENT IS 'Добавляем для ПРОФОРМЫ!!! Сегментов нет! Только для пакета NADA';
COMMENT ON COLUMN BARS.SB_OB22.ZN50 IS 'Добавляем для ПРОФОРМЫ!!! Только для пакета NADA';
