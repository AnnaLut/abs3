...
PROMPT *** Create  constraint FK_PKKQUE_ACCOUNTS ***
begin   
 execute immediate '
  ALTER TABLE BARS.PKK_QUE ADD CONSTRAINT FK_PKKQUE_ACCOUNTS FOREIGN KEY (ACC)
...
PROMPT *** Create  constraint FK_PKKQUE_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.PKK_QUE ADD CONSTRAINT FK_PKKQUE_OPER FOREIGN KEY (REF)
...
begin   
 execute immediate '
  ALTER TABLE BARS.PKK_QUE ADD CONSTRAINT PK_PKKQUE PRIMARY KEY (REF, DK)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_PKKQUE ON BARS.PKK_QUE (REF, DK) 
