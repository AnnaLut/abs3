...
COMMENT ON COLUMN BARS.BRANCH.BRANCH IS 'Код безбалансового отделения';
COMMENT ON COLUMN BARS.BRANCH.NAME IS 'Наименование безбалансового отделения';
...
grant REFERENCES,SELECT                                                      on BRANCH          to BARSDWH_ACCESS_USER;
...
grant SELECT                                                                 on BRANCH          to BARS_SUP;
...
grant SELECT                                                                 on BRANCH          to START1;
...
PROMPT *** Create SYNONYM  to BRANCH ***
  ...
  CREATE OR REPLACE SYNONYM BARSDWH_ACCESS_USER.BRANCH FOR BARS.BRANCH;
