...
PROMPT *** Create  constraint SYS_C003086048 ***
begin   
 execute immediate '
  ALTER TABLE BARS.EBKC_GCIF MODIFY (GCIF NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint SYS_C003086047 ***
begin   
 execute immediate '
  ALTER TABLE BARS.EBKC_GCIF MODIFY (RNK NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003086046 ***
begin   
 execute immediate '
  ALTER TABLE BARS.EBKC_GCIF MODIFY (KF NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
