...
PROMPT *** Create  constraint FK_CIMCONTRCRED_PREPAY ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT FK_CIMCONTRCRED_PREPAY FOREIGN KEY (CREDIT_PREPAY)
	  REFERENCES BARS.CIM_CREDIT_PREPAY (ID) ENABLE';
exception when others then
...
PROMPT *** Create  constraint FK_CIMCONTRCRED_PNBUT ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT FK_CIMCONTRCRED_PNBUT FOREIGN KEY (PERCENT_NBU_TYPE)
	  REFERENCES BARS.CIM_CREDIT_PERCENT (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_CIMCONTRCRED_CREDTERM ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT FK_CIMCONTRCRED_CREDTERM FOREIGN KEY (CREDIT_TERM)
	  REFERENCES BARS.CIM_CREDIT_TERM (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_CIMCONTRCRED_CREDTYPE ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT FK_CIMCONTRCRED_CREDTYPE FOREIGN KEY (CREDIT_TYPE)
	  REFERENCES BARS.CIM_CREDIT_TYPE (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_CIMCONTRCRED_BORROWER ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT FK_CIMCONTRCRED_BORROWER FOREIGN KEY (BORROWER)
	  REFERENCES BARS.CIM_CREDIT_BORROWER (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_CIMCONTRCRED_CTORTYPE ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT FK_CIMCONTRCRED_CTORTYPE FOREIGN KEY (CREDITOR_TYPE)
	  REFERENCES BARS.CIM_CREDITOR_TYPE (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_CIMCONTRCRED_CONTRID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT FK_CIMCONTRCRED_CONTRID FOREIGN KEY (CONTR_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT CC_CIMCONTRCRED_F504REASON_C CHECK (f504_reason in (1,2) or f504_reason is null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT CC_CIMCONTRCRED_F503STATE_C CHECK (f503_state in (1,2,3,4,5) or f503_state is null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT ADD CONSTRAINT CC_CIMCONTRCRED_F503REASON_C CHECK (f503_reason in (1,2) or f503_reason is null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT MODIFY (PERCENT_NBU_TYPE CONSTRAINT CC_CIMCONTRCRED_PNBUT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT MODIFY (CREDIT_TERM CONSTRAINT CC_CIMCONTRCRED_CREDTERM_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT MODIFY (PERCENT_NBU CONSTRAINT CC_CIMCONTRCRED_PNBU_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_CONTRACTS_CREDIT MODIFY (CONTR_ID CONSTRAINT CC_CIMCONTRCRED_CONTRID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_CONTRACTS_CREDIT to BARS_ACCESS_DEFROLE;
