...
PROMPT *** Create  constraint FK_CIMVMDBOUND_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND ADD CONSTRAINT FK_CIMVMDBOUND_BRANCH FOREIGN KEY (BRANCH)
...
PROMPT *** Create  constraint FK_CIMVMDBOUND_VMDID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND ADD CONSTRAINT FK_CIMVMDBOUND_VMDID FOREIGN KEY (VMD_ID)
	  REFERENCES BARS.CUSTOMS_DECL (CIM_ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_CIMVMDBOUND_BORGREASON ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND ADD CONSTRAINT FK_CIMVMDBOUND_BORGREASON FOREIGN KEY (BORG_REASON)
...
PROMPT *** Create  constraint FK_CIMVMDBOUND_CONTRID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND ADD CONSTRAINT FK_CIMVMDBOUND_CONTRID FOREIGN KEY (CONTR_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND MODIFY (BRANCH CONSTRAINT CC_CIMVMDBOUND_BRANCH_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND MODIFY (MODIFY_DATE CONSTRAINT CC_CIMVMDBOUND_MDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND MODIFY (CREATE_DATE CONSTRAINT CC_CIMVMDBOUND_CDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND MODIFY (S_VT CONSTRAINT CC_CIMVMDBOUND_SVT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND MODIFY (CONTR_ID CONSTRAINT CC_CIMVMDBOUND_CONTRID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND MODIFY (VMD_ID CONSTRAINT CC_CIMVMDBOUND_VMDID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND MODIFY (DIRECT CONSTRAINT CC_CIMVMDBOUND_DIRECT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_VMD_BOUND   to BARS_ACCESS_DEFROLE;
