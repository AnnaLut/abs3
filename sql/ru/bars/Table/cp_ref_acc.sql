...
PROMPT *** Create  constraint FK_CPREFACC_REF ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_REF_ACC ADD CONSTRAINT FK_CPREFACC_REF FOREIGN KEY (REF)
...
PROMPT *** Create  constraint FK_CPREFACC_ACC ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_REF_ACC ADD CONSTRAINT FK_CPREFACC_ACC FOREIGN KEY (ACC)
...
PROMPT *** Create  constraint SYS_C002685902 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_REF_ACC MODIFY (ACC NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002685901 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_REF_ACC MODIFY (REF NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
