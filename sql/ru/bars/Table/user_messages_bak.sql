...
PROMPT *** Create  constraint FK_USERMESSAGES_STAFF2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.USER_MESSAGES_BAK ADD CONSTRAINT FK_USERMESSAGES_STAFF2 FOREIGN KEY (MSG_SENDER_ID)
...
PROMPT *** Create  constraint FK_USERMESSAGES_STAFF ***
begin   
 execute immediate '
  ALTER TABLE BARS.USER_MESSAGES_BAK ADD CONSTRAINT FK_USERMESSAGES_STAFF FOREIGN KEY (USER_ID)
	  REFERENCES BARS.STAFF$BASE (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_USERMESSAGES_TYPEID ***
begin   
 execute immediate '
  ALTER TABLE BARS.USER_MESSAGES_BAK ADD CONSTRAINT FK_USERMESSAGES_TYPEID FOREIGN KEY (MSG_TYPE_ID)
	  REFERENCES BARS.USER_MESSAGES_TYPES (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant INSERT,SELECT,UPDATE                                                   on USER_MESSAGES_BAK to BARS_ACCESS_DEFROLE;
