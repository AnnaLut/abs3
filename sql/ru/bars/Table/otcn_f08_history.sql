...
PROMPT *** Create  constraint SYS_C0010736 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTCN_F08_HISTORY MODIFY (KV NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  index IDX_OTCNF08HIST ***
begin   
 execute immediate '
  CREATE INDEX BARS.IDX_OTCNF08HIST ON BARS.OTCN_F08_HISTORY (NLSK, NLSD) 
