...
COMMENT ON COLUMN BARS.ACC_OVER.FIN IS 'ФiнКлас';
...
grant DELETE,INSERT,SELECT,UPDATE                                            on ACC_OVER        to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on ACC_OVER        to BARS_SUP;
