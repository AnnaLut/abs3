...
PROMPT *** Create  constraint SYS_C0066908 ***
begin   
 execute immediate '
  ALTER TABLE BARS.REZ_ZAL MODIFY (ACCS1 NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint SYS_C0066907 ***
begin   
 execute immediate '
  ALTER TABLE BARS.REZ_ZAL MODIFY (NLS NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0066906 ***
begin   
 execute immediate '
  ALTER TABLE BARS.REZ_ZAL MODIFY (KV NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0066905 ***
begin   
 execute immediate '
  ALTER TABLE BARS.REZ_ZAL MODIFY (ACCS NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0066904 ***
begin   
 execute immediate '
  ALTER TABLE BARS.REZ_ZAL MODIFY (ACC NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
