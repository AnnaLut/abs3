...
PROMPT *** Create  constraint CP_EMIW_TAG ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_EMIW ADD CONSTRAINT CP_EMIW_TAG FOREIGN KEY (TAG)
...
PROMPT *** Create  constraint CP_EMIW_RNK ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_EMIW ADD CONSTRAINT CP_EMIW_RNK FOREIGN KEY (RNK)
