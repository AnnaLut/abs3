...
PROMPT *** Create  constraint SYS_C0010748 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTCN_F71_HISTORY MODIFY (ACC NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0010747 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTCN_F71_HISTORY MODIFY (DATF NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant DELETE,INSERT,SELECT,UPDATE                                            on OTCN_F71_HISTORY to BARS_ACCESS_DEFROLE;
