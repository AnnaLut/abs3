...
PROMPT *** Create  constraint SYS_IOT_TOP_468265 ***
begin   
 execute immediate '
...
PROMPT *** Create  index SYS_IOT_TOP_468265 ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.SYS_IOT_TOP_468265 ON BARS.AQ$_BARS_MAIL_QT_H (MSGID, SUBSCRIBER#, NAME, ADDRESS#) 
