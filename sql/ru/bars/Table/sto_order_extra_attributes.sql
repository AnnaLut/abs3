...
PROMPT *** Create  constraint SYS_C002755360 ***
begin   
 execute immediate '
  ALTER TABLE BARS.STO_ORDER_EXTRA_ATTRIBUTES MODIFY (EXTRA_ATTRIBUTES NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002755359 ***
begin   
 execute immediate '
  ALTER TABLE BARS.STO_ORDER_EXTRA_ATTRIBUTES MODIFY (ORDER_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
