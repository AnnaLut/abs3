...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_GARANTEE_TEMPLATES ADD CONSTRAINT CC_GRTTMPLS_SQID_NN CHECK (SCAN_QID IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177098 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_GARANTEE_TEMPLATES MODIFY (TEMPLATE_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177097 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_GARANTEE_TEMPLATES MODIFY (GARANTEE_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
