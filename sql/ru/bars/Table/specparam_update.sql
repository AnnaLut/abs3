...
begin 
  execute immediate '
  CREATE TABLE BARS.SPECPARAM_UPDATE 
   (	ACC NUMBER(38,0), 
	R011 VARCHAR2(1), 
	R013 VARCHAR2(1), 
	S080 VARCHAR2(1), 
...
COMMENT ON COLUMN BARS.SPECPARAM_UPDATE.K150 IS '';
...
PROMPT *** Create  constraint SYS_C002910009 ***
begin   
 execute immediate '
...
grant SELECT                                                                 on SPECPARAM_UPDATE to BARS_SUP;
