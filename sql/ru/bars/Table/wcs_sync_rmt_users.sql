...
PROMPT *** Create  constraint FK_WCSSYNCRMTUS_DSID_SYNCDSS ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SYNC_RMT_USERS ADD CONSTRAINT FK_WCSSYNCRMTUS_DSID_SYNCDSS FOREIGN KEY (DS_ID)
	  REFERENCES BARS.WCS_SYNC_DATASTORES (ID) ENABLE';
exception when others then
...
PROMPT *** Create  constraint FK_WCSSYNCRMTUS_LCLID_STAFF ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SYNC_RMT_USERS ADD CONSTRAINT FK_WCSSYNCRMTUS_LCLID_STAFF FOREIGN KEY (LCL_ID)
