...
begin   
 execute immediate '
  ALTER TABLE BARS.INT_ACCN ADD CONSTRAINT FK_INTACCN_ACCOUNTS2 FOREIGN KEY (KF, ACRB)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INT_ACCN ADD CONSTRAINT FK_INTACCN_ACCOUNTS FOREIGN KEY (KF, ACRA)
	  REFERENCES BARS.ACCOUNTS (KF, ACC) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
begin   
 execute immediate '
  ALTER TABLE BARS.INT_ACCN ADD CONSTRAINT FK_INTACCN_ACCOUNTS4 FOREIGN KEY (KF, ACC)
	  REFERENCES BARS.ACCOUNTS (KF, ACC) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
grant SELECT                                                                 on INT_ACCN        to BARSDWH_ACCESS_USER;
...
grant SELECT                                                                 on INT_ACCN        to BARS_SUP;
...
grant UPDATE                                                                 on INT_ACCN        to WR_CREDIT;
