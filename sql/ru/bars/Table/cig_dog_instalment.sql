...
PROMPT *** Create  constraint FK_CIGDOGINST_TABVAL4 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_INSTALMENT ADD CONSTRAINT FK_CIGDOGINST_TABVAL4 FOREIGN KEY (OVERDUE_CURR_ID)
...
PROMPT *** Create  constraint FK_CIGDOGINST_TABVAL3 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_INSTALMENT ADD CONSTRAINT FK_CIGDOGINST_TABVAL3 FOREIGN KEY (OUTSTAND_CURR_ID)
	  REFERENCES BARS.TABVAL$GLOBAL (KV) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_CIGDOGINST_TABVAL2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_INSTALMENT ADD CONSTRAINT FK_CIGDOGINST_TABVAL2 FOREIGN KEY (INSTALMENT_CURR_ID)
	  REFERENCES BARS.TABVAL$GLOBAL (KV) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_CIGDOGINST_TABVAL1 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_INSTALMENT ADD CONSTRAINT FK_CIGDOGINST_TABVAL1 FOREIGN KEY (BODY_CURR_ID)
	  REFERENCES BARS.TABVAL$GLOBAL (KV) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_CIGDOGINST_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_INSTALMENT ADD CONSTRAINT FK_CIGDOGINST_BRANCH FOREIGN KEY (BRANCH)
