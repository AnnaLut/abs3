...
BEGIN 
        execute immediate  
          'begin  
               ...
               bpa.alter_policy_info(''INSU_ACC'', ''WHOLE'' , null, ''E'', ''E'', ''E'');
               null;
           end; 
          '; 
END; 
...
begin   
 execute immediate '
  ALTER TABLE BARS.INSU_ACC ADD CONSTRAINT XPK_INSU_ACC PRIMARY KEY (ACC, RNKI, VID)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.XPK_INSU_ACC ON BARS.INSU_ACC (ACC, RNKI, VID) 
