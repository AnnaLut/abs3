...
PROMPT *** Create  constraint FK_ARCSIGN_OPER2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.ARC_SIGN ADD CONSTRAINT FK_ARCSIGN_OPER2 FOREIGN KEY (KF, REF)
...
PROMPT *** Create  constraint FK_ARCSIGN_ARCRRP2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.ARC_SIGN ADD CONSTRAINT FK_ARCSIGN_ARCRRP2 FOREIGN KEY (KF, REC)
...
PROMPT *** Create  constraint SYS_C009247 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C009246 ***
begin   
 execute immediate '
