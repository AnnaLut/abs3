...
begin   
 execute immediate '
  ALTER TABLE BARS.OTCN_FE8_HISTORY MODIFY (KF CONSTRAINT CC_OTCNFE8HISTORY_KF_NN NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint SYS_C0015759 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTCN_FE8_HISTORY MODIFY (ACC NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0015758 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTCN_FE8_HISTORY MODIFY (DATF NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
