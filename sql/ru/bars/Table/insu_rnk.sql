...
BEGIN 
        execute immediate  
          'begin  
               ...
               bpa.alter_policy_info(''INSU_RNK'', ''WHOLE'' , null, ''E'', ''E'', ''E'');
               null;
           end; 
          '; 
END; 
...
begin   
 execute immediate '
  ALTER TABLE BARS.INSU_RNK ADD CONSTRAINT XPK_INSU_RNK PRIMARY KEY (RNK, RNKI, VID)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.XPK_INSU_RNK ON BARS.INSU_RNK (RNK, RNKI, VID) 
