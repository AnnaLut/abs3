...
PROMPT *** Create  constraint SYS_C003177311 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCT_GARANTEES MODIFY (GARANTEE_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177310 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCT_GARANTEES MODIFY (SUBPRODUCT_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
