...
PROMPT *** Create  constraint FK_DPTJOBSJRNL_FDAT ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_JRNL ADD CONSTRAINT FK_DPTJOBSJRNL_FDAT FOREIGN KEY (KF, BANK_DATE)
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_JRNL ADD CONSTRAINT CC_DPTJOBSJRNL_STATUS CHECK (status IN (-1, 0, 1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_JRNL MODIFY (KF CONSTRAINT CC_DPTJOBSJRNL_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_JRNL MODIFY (BRANCH CONSTRAINT CC_DPTJOBSJRNL_BRANCH_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_JRNL MODIFY (USER_ID CONSTRAINT CC_DPTJOBSJRNL_USERID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_JRNL MODIFY (BANK_DATE CONSTRAINT CC_DPTJOBSJRNL_BANKDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_JRNL MODIFY (START_DATE CONSTRAINT CC_DPTJOBSJRNL_STARTDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_JRNL MODIFY (JOB_ID CONSTRAINT CC_DPTJOBSJRNL_JOBID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
