...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''INS_LIMITS'', ''FILIAL'' , null, null, null, null);
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_LIMITS ADD CONSTRAINT PK_INSLIMITS PRIMARY KEY (ID)
...
PROMPT *** Create  constraint SYS_C003101169 ***
begin   
 execute immediate '
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_INSLIMITS ON BARS.INS_LIMITS (ID) 
