...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CUSTOMER_UPDATE'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''CUSTOMER_UPDATE'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
grant SELECT                                                                 on CUSTOMER_UPDATE to BARSDWH_ACCESS_USER;
...
grant SELECT                                                                 on CUSTOMER_UPDATE to BARS_SUP;
...
PROMPT *** Create SYNONYM  to CUSTOMER_UPDATE ***

  CREATE OR REPLACE SYNONYM BARSDWH_ACCESS_USER.CUSTOMER_UPDATE FOR BARS.CUSTOMER_UPDATE;
