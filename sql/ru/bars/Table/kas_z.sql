...
PROMPT *** Create  constraint FK_KASZ_REFB ***
begin   
 execute immediate '
  ALTER TABLE BARS.KAS_Z ADD CONSTRAINT FK_KASZ_REFB FOREIGN KEY (REFB)
...
PROMPT *** Create  constraint FK_KASZ_REFA ***
begin   
 execute immediate '
  ALTER TABLE BARS.KAS_Z ADD CONSTRAINT FK_KASZ_REFA FOREIGN KEY (REFA)
	  REFERENCES BARS.OPER (REF) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
