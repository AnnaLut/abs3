...
PROMPT *** Create  constraint FK_CIMBENEF_COUNTRIES ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_BENEFICIARIES ADD CONSTRAINT FK_CIMBENEF_COUNTRIES FOREIGN KEY (COUNTRY_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_BENEFICIARIES MODIFY (BENEF_NAME CONSTRAINT CC_CIMBENEF_BENEFNAME_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_BENEFICIARIES MODIFY (BENEF_ID CONSTRAINT CC_CIMBENEF_BENEFID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_BENEFICIARIES to BARS_ACCESS_DEFROLE;
