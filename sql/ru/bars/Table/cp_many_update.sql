...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CP_MANY_UPDATE'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''CP_MANY_UPDATE'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
grant SELECT                                                                 on CP_MANY_UPDATE  to BARS_SUP;
