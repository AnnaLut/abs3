...
PROMPT *** Create  constraint FK_QUEST_ID ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_QUESTION_PARAMS ADD CONSTRAINT FK_QUEST_ID FOREIGN KEY (QUESTION_ID)
...
PROMPT *** Create  constraint SYS_C003177021 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_QUESTION_PARAMS MODIFY (QUESTION_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
