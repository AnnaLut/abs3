...
PROMPT *** Create  constraint FK_REFAPP_APPLIST ***
begin   
 execute immediate '
  ALTER TABLE BARS.REFAPP ADD CONSTRAINT FK_REFAPP_APPLIST FOREIGN KEY (CODEAPP)
...
PROMPT *** Create  constraint SYS_C0010926 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0010925 ***
begin   
 execute immediate '
...
grant DELETE,INSERT,SELECT,UPDATE                                            on REFAPP          to BARS_ACCESS_DEFROLE;
