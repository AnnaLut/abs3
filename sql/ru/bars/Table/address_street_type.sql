...
COMMENT ON TABLE BARS.ADDRESS_STREET_TYPE IS 'Типы улиц';
COMMENT ON COLUMN BARS.ADDRESS_STREET_TYPE.ID IS 'Идентификатор типа улици';
COMMENT ON COLUMN BARS.ADDRESS_STREET_TYPE.NAME IS 'Наименование типа улици';
COMMENT ON COLUMN BARS.ADDRESS_STREET_TYPE.VALUE IS 'Значение';
...
grant SELECT                                                                 on ADDRESS_STREET_TYPE to CUST001;
grant SELECT                                                                 on ADDRESS_STREET_TYPE to START1;
grant DELETE,FLASHBACK,INSERT,SELECT,UPDATE                                  on ADDRESS_STREET_TYPE to WR_ALL_RIGHTS;
grant SELECT                                                                 on ADDRESS_STREET_TYPE to WR_CUSTREG;
