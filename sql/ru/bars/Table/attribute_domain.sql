...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''ATTRIBUTE_DOMAIN'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
PROMPT *** Create  constraint FK_ATTR_DOMAIN_REF_ATTR_KIND ***
begin   
 execute immediate '
  ALTER TABLE BARS.ATTRIBUTE_DOMAIN ADD CONSTRAINT FK_ATTR_DOMAIN_REF_ATTR_KIND FOREIGN KEY (ATTRIBUTE_ID)
...
PROMPT *** Create  constraint SYS_C002861361 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861360 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861359 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861358 ***
begin   
 execute immediate '
