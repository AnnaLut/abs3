...
PROMPT *** Create  constraint FK_REFQUE_OPER2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.REF_QUE ADD CONSTRAINT FK_REFQUE_OPER2 FOREIGN KEY (KF, REF)
...
PROMPT *** Create  constraint SYS_C0010940 ***
begin   
 execute immediate '
