...
begin   
 execute immediate '
  ALTER TABLE BARS.PRVN_FIN_DEB MODIFY (KF CONSTRAINT CC_PRVNFINDEB_KF_NN NOT NULL ENABLE)';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.PRVN_FIN_DEB MODIFY (EFFECTDATE CONSTRAINT CC_PRVNFINDEB_EFFECTDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.PRVN_FIN_DEB MODIFY (ACC_SP CONSTRAINT CC_PRVNFINDEB_ACCSP_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.PRVN_FIN_DEB MODIFY (ACC_SS CONSTRAINT CC_PRVNFINDEB_ACCSS_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
