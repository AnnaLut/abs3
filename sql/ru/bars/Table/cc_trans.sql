...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CC_TRANS'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''CC_TRANS'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint FK_CCTRANS_ACC ***
begin   
 execute immediate '
  ALTER TABLE BARS.CC_TRANS ADD CONSTRAINT FK_CCTRANS_ACC FOREIGN KEY (ACC)
...
grant SELECT                                                                 on CC_TRANS        to BARS_SUP;
