...
begin   
 execute immediate '
  ALTER TABLE BARS.POS MODIFY (NAME CONSTRAINT CC_POS_NAME_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.POS MODIFY (POS CONSTRAINT CC_POS_POS_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant DELETE,INSERT,SELECT,UPDATE                                            on POS             to BARS_ACCESS_DEFROLE;
