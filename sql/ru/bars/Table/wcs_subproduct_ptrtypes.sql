...
PROMPT *** Create  constraint SYS_C003177347 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCT_PTRTYPES MODIFY (PTR_TYPE_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177346 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCT_PTRTYPES MODIFY (SUBPRODUCT_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
