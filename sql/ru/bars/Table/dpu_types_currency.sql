...
PROMPT *** Create  constraint FK_DPUTYPESCURRENCY_TABVAL ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_TYPES_CURRENCY ADD CONSTRAINT FK_DPUTYPESCURRENCY_TABVAL FOREIGN KEY (CURR_ID)
	  REFERENCES BARS.TABVAL$GLOBAL (KV) ON DELETE CASCADE ENABLE';
exception when others then
