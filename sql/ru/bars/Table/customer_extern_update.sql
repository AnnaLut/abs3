...
PROMPT *** Create  constraint SYS_C002125081 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_EXTERN_UPDATE MODIFY (SEX NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002125080 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTOMER_EXTERN_UPDATE MODIFY (ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CUSTOMER_EXTERN_UPDATE to BARS_SUP;
