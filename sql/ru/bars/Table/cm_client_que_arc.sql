...
-- Add/modify columns 
begin
    execute immediate 'alter table cm_client_que_arc add shortnameowner varchar2(105)';
 exception when others then 
...
grant ALTER,DEBUG,DELETE,FLASHBACK,INSERT,ON COMMIT REFRESH,QUERY REWRITE,SELECT,UPDATE on CM_CLIENT_QUE_ARC to BARS_ACCESS_DEFROLE;
