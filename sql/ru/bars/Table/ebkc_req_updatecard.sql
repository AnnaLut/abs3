...
PROMPT *** Create  constraint SYS_C003086055 ***
begin   
 execute immediate '
  ALTER TABLE BARS.EBKC_REQ_UPDATECARD MODIFY (RNK NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint SYS_C003086054 ***
begin   
 execute immediate '
  ALTER TABLE BARS.EBKC_REQ_UPDATECARD MODIFY (KF NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
