...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''OW_CRVFILES_DATA'', ''FILIAL'' , null, null, null, null);
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_CRVFILES_DATA MODIFY (IDN CONSTRAINT CC_OWCRVFILESDATA_IDN_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_CRVFILES_DATA MODIFY (ID CONSTRAINT CC_OWCRVFILESDATA_ID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
