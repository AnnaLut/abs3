...
PROMPT *** Create  constraint FK_SW950A_SWJOURNAL2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SW_950A ADD CONSTRAINT FK_SW950A_SWJOURNAL2 FOREIGN KEY (KF, SWREF)
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_950A MODIFY (S CONSTRAINT CC_SW950A_S_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_950A MODIFY (KV CONSTRAINT CC_SW950A_KV_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_950A MODIFY (FDAT CONSTRAINT CC_SW950A_FDAT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_950A MODIFY (SWREF CONSTRAINT CC_SW950A_SWREF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_950A MODIFY (KF CONSTRAINT CC_SW950A_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
