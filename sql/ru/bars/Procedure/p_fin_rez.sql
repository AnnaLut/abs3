...
--04-10-2011 ¬несено в еталон.

  -- процедура пересмотрена  —ухова 05-07-2010
  -- финансовые результаты по реальным бранчам
  -- в т.ч. до низового уровн€
...
-------------------------------------------------------------------
     ...
     --    ѕроцентные
     --     омиссионные (по методу начислени€)
     If k.b2 = '0'     OR
...
-------------------------------------------------------------------
     -- 3) ќстальное - по умолчанию - от места возникновени€ операции
     --    BRANCH_  := oper.branch
-------------------------------------------------------------------
