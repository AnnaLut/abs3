...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/P_BAL.sql =========*** Run *** ===
PROMPT ===================================================================================== 


PROMPT *** Create  procedure P_BAL ***

  CREATE OR REPLACE PROCEDURE BARS.P_BAL (p_id number,  p_DAT varchar2 ) is
...
/* эквивалент валюты */
  ...
  LOOP
    ...
    -- название группы
      ...
      logger.info('бал-1'|| p.nbs||'/'||p.OB22);
      insert into tmp_bal
...
PROMPT *** Create  grants  P_BAL ***
grant EXECUTE                                                                on P_BAL           to BARS_ACCESS_DEFROLE;
grant EXECUTE                                                                on P_BAL           to RPBN001;
grant EXECUTE                                                                on P_BAL           to WR_ALL_RIGHTS;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_BAL.sql =========*** End *** ===
PROMPT ===================================================================================== 
