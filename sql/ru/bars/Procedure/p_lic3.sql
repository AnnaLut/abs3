...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/P_LIC3.sql =========*** Run *** ==
PROMPT ===================================================================================== 


PROMPT *** Create  procedure P_LIC3 ***

  CREATE OR REPLACE PROCEDURE BARS.P_LIC3 
...
CURSOR SALDOA0 IS
       SELECT s.acc,s.fdat,s.ost-s.kos+s.dos,s.nls,s.kv,s.dapp,
              s.isp, substr(s.nms,1,38)
       FROM sal s
       WHERE s.kv=gl.baseval and
...
BEGIN
  --Процедура формирование ГРН выписок в TMP_LIC с включением в выписку
  --счетов без оборотов
...
PROMPT *** Create  grants  P_LIC3 ***
grant EXECUTE                                                                on P_LIC3          to BARS_ACCESS_DEFROLE;
grant EXECUTE                                                                on P_LIC3          to RPBN001;
grant EXECUTE                                                                on P_LIC3          to WR_ALL_RIGHTS;
grant EXECUTE                                                                on P_LIC3          to WR_DOC_INPUT;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_LIC3.sql =========*** End *** ==
PROMPT ===================================================================================== 
