...
/* РУ+ГОУ          Версия 2 17-03-2017 23-11-2016  29-07-2016 27-07-2016  18-05-2016
...
--                        l_nd := substr(ref_,l_x,l_y);
                        ...
                        paytt (l_pay, ref_, dat31_, tt_, 0, k.kv, k.r_nls, diff_, 980, r7702_, gl.p_icurval (k.kv, diff_, dat31_) );
                     ...
                     IF mode_ = 0 THEN
                        ...
                        paytt (l_pay, ref_, dat31_, tt_, 1, k.kv, k.r_nls, diff_, 980, r7702_, gl.p_icurval (k.kv, diff_, dat31_));
         ...
         exception when others then
            rollback to sp;
            p_error( 5, null,null, null, k.kv, k.branch,ref_||':'||k.NBS_REZ||'/'||k.OB22_REZ, k.kv, null, k.sz,
