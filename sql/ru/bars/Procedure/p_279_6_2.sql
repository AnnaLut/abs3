...
(p_Custytpe char,               -- тит кл: 2=ЮЛ, 3=ФЛ
 p_6 int,                       -- рабочая константа
 p_branch cc_deal.branch%type   -- Бранч или все
 )
 IS
...
-------------------------------
 ...
 l_r080 specparam.s080%type    ;  -- расчетное S080 без данной постановы НБУ
...
begin
 ...
 loop
    begin
      ...
      If k.FIN = 3 then l_m080 := '2'; l_fin := '3=В';
      else              l_m080 := '3'; l_fin := '4=Г';
      end if;
