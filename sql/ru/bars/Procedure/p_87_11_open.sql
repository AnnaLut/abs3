...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/P_87_11_OPEN.sql =========*** Run 
PROMPT ===================================================================================== 


PROMPT *** Create  procedure P_87_11_OPEN ***

  CREATE OR REPLACE PROCEDURE BARS.P_87_11_OPEN (p_dat date) is
-- вариант ОБ
...
begin
 ...
 loop
      ...
      (
       select  p.ap  pap,
        ...
        where (p.d_close is null or p.d_close>gl.bd)
           and p.r020_fa<>'0000' and ob22<>'00'
            and  not exists
    ...
    loop
-- откроем счет если он есть в нашем балансе
    if n.nbs=k.r020_fa and n.ob22=k.ob22 then
      begin
        op_reg_lock (99, 0, 0, p_grp,  l_tmp,  p_rnk,
                vkrzn(substr(f_ourmfo,1,5),k.nls),   980, k.nmsn, 'ODB',
                p_isp, l_acc, '1', k.pap,  0, null, null, null, null, null,
...
/* установка спецпараметров */
   ...
   for k in
      (
        ...
        from   sb_p0853 p
       where (p.d_close is null or p.d_close>gl.bd)
              and p.r020_fa='0000' and p.ob22='00'
              and
              not exists
              (select 1 from  accounts a,specparam_int s
                     where  a.nbs=p.r020 and a.kv=980
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_87_11_OPEN.sql =========*** End 
PROMPT ===================================================================================== 
