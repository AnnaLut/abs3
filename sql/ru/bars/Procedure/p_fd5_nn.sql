...
%
% VERSION     : v.17.005      08/09/2017 (08/08/2017, 14.07.2017)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
BEGIN
   ...
   then --овердрафты
      ...
      END;
       ...
       if nbs_ not in ('2400','2401','3690') then
          BEGIN
             SELECT n.nd, c.vidd
                INTO nd_, vidd_
             FROM nd_acc n, cc_deal c
...
BEGIN
    ...
    LOOP
       ...
       if nbs_ not in ('1590', '1592', '2400', '2401', '3690') then
    ...
    ------------------------------------------------------------------------------
    -- формирование показателей для счетов резерва 1590, 2400, 2401, 3690
    if dat_ >= dat_izm1 then
       ...
       if kol_ = 0 then
          ...
          OPEN SALDO ;
             LOOP
                ...
                if nbs_ in ('1590', '1592', '2400', '2401', '3690') then
          ...
          for k in (select /*+ leading(r) */
                    ...
                    where t.dat=Dat23_
                      and t.acc = r.acc
                      and substr(r.kodp,3,3) not in ('159','240','369') and
                      substr(r.kodp,3,4) not in ('2607', '2627')
