...
--  l_doc    := xmlparser.getDocument(l_parser);
    ...
    for k in (select extractValue(value(dtl),'Notary/Id'               )              Id                      ,
                     ...
                     extractValue(value(dtl),'Notary/DocumentType'     )              DOCUMENT_TYPE           ,
                     extractValue(value(dtl),'Notary/IdcardDocumentNumber')           IDCARD_DOCUMENT_NUMBER  ,
                     extractValue(value(dtl),'Notary/IdcardNotationNumber')           IDCARD_NOTATION_NUMBER  ,
                     extractValue(value(dtl),'Notary/PassportExpiry'      )           PASSPORT_EXPIRY         ,
