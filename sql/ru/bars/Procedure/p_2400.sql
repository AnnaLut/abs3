...
c0 CurTyp;
-- Для NAL=4 - ценные бумаги REZN<>0, было rez-rezn<>0
begin
DECLARE
...
begin
      ...
      OPEN c0 FOR
         select t.country, t.id , t.NBS_REZ, t.OB22_REZ, t.NBS_7f, t.OB22_7f, t.NBS_7r, t.OB22_7r, t.kv   , t.rz   , t.branch,
         ...
         from  (select  c.country,r.id,o.NBS_REZ, o.OB22_REZ    , o.NBS_7f, o.OB22_7f, o.NBS_7r  ,
                        ...
                        nvl(r.rez*100,0) sz,nvl(r.rezn*100,0) szn,nvl(r.rez_30*100,0) sz_30,
                ...
                join srezerv_ob22 o on (r.nbs = o.nbs and o.nal=nal_ AND
                              ...
                              r.arjk=decode(o.nal,'2',1,0) AND nvl(r.ob22,0) = decode(o.ob22,'0', nvl(r.ob22,0),o.ob22) and
         ...
         where fdat = dat01_ and substr(r.id,1,4) <> 'CACP' and
               nvl(decode(nal_,'0',rezn  , 'A' ,rezn,
                               '2',rezn  ,
                               '5',rez_30, 'C' , rez_30,
                               '6',rez_30, 'D' , REz_30,
                               '8',r.rez ,
                               decode(rez_30,0,r.rez-rezn,r.rez-rez_30)),0) <> 0 ) t
         --счет резерва
         ...
         group by t.country,t.id,t.NBS_REZ , t.OB22_REZ, t.NBS_7f, t.OB22_7f, t.NBS_7r,  t.OB22_7r,
                  t.kv, t.rz,t.branch, t.sz,t.szn,t.sz_30,t.s080,t.pr,t.r_s080,t.r013,t.nd,t.cc_id,t.nd_cp;
   ELSIF nal_ in ('3','7') THEN
      OPEN c0 FOR
         select t.country,t.id,t.NBS_REZ , t.OB22_REZ, t.NBS_7f,t.OB22_7f,t.NBS_7r,t.OB22_7r,
           t.kv, t.rz,t.branch, t.sz,t.szn,t.sz_30,t.s080,t.pr,t.r_s080,t.r013,t.nd,t.cc_id,t.nd_cp,
           substr(ConcatStr(ar.acc),1,999) r_acc,    substr(ConcatStr(ar.nls),1,999) r_nls
         from (select c.country, r.id,o.NBS_REZ, o.OB22_REZ, o.NBS_7f, o.OB22_7f, o.NBS_7r,
      ...
      OPEN c0 FOR
         ...
         from (select c.country, r.id,o.NBS_REZ, o.OB22_REZ, o.NBS_7f, o.OB22_7f, o.NBS_7r,
                      o.OB22_7r,o.pr,o.r013,nvl(r.rz,1) rz,r.KV, r.nd nd,r.cc_id,r.nd_cp,
                      rtrim(substr(r.branch||'/',1,instr(r.branch||'/','/',1,3)-1),'/')||'/' branch,
                      nvl(r.rez*100,0) sz,nvl(r.rezn*100,0) szn,0 sz_30,
                      decode(r.kat,1,1,9,9,2) s080,r.kat r_s080
               from nbu23_rez r
               join customer     c on (r.rnk = c.rnk)
   ...
   loop
      ...
      if instr(k.r_nls,',')=0 THEN
         If nal_ IN ('1','4','B') and k.sz<>k.szn THEN
            update nbu23_rez set nls_rez=substr(k.r_nls,1,15),acc_rez=k.r_acc,
                                 ob22_rez=k.ob22_rez
            where id=k.ID and fdat=Dat01_;
         elsif nal_ IN ('5','6','7','C','D') and k.sz_30<>0 THEN
            update nbu23_rez set nls_rez_30=substr(k.r_nls,1,15),acc_rez_30=k.r_acc,
                                 ob22_rez_30=k.ob22_rez
            where id=k.ID and fdat=Dat01_;
         else
            update nbu23_rez set nls_rezn=substr(k.r_nls,1,15),acc_rezn=k.r_acc,
                                 ob22_rezn=k.ob22_rez
            where id=k.ID and fdat=Dat01_;
         end if;
      end if;
