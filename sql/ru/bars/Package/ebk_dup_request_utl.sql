...
procedure request_duplicate_mass(p_batchId in varchar2,
                             p_kf in varchar2,
                             p_rnk in number,
                             p_duplicate_ebk in t_duplicate_ebk) ;
                             
procedure request_gcif_mass(p_batchId in varchar2,
                          p_kf in varchar2,
                          p_rnk in number,
                          p_gcif in varchar2,
                          p_slave_client_ebk in t_slave_client_ebk);
procedure request_del_gcif(/*p_kf in varchar2,
                          p_rnk in number,*/
                          p_gcif in varchar2);
...
is
  ...
  -- constants
  --
  g_body_version  constant   varchar2(64)  := 'version 1.04  2017.02.14';
