...
CREATE OR REPLACE PACKAGE BODY BARS.Z2014 IS
 G_BODY_VERSION  CONSTANT VARCHAR2(64)  :=  'ver.1.5 04.01.2016';
 oo oper%rowtype;
---================================================================
...
begin
   If oo.ref is null then gl.ref (oo.REF);
      gl.in_doc3(ref_=> oo.REF ,  tt_   => oo.tt,   vob_  => oo.vob,  nd_   => oo.nd,
              pdat_  => SYSDATE,  vdat_ => oo.vdat, dk_   => oo.dk,   kv_   => oo.kv,
