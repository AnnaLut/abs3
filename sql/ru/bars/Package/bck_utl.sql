 ...
 PROMPT ===================================================================================== 
  ...
  g_header_version constant varchar2(64) := 'version 1.04 13/08/2015';
...
CREATE OR REPLACE PACKAGE BODY BARS.BCK_UTL is
  ...
  G_BODY_VERSION constant varchar2(64) := 'version 1.06 13/08/2015';
  ...
  G_GETREPORT_FOR_ID         constant varchar2(5) := 'ForId';
  ...
  begin
    ...
    begin
      ...
      dbms_lob.write(l_tmp,1,length(replace(l_response.doc.getClobVal(), 'xmlns', 'mlns')),replace(l_response.doc.getClobVal(), 'xmlns', 'mlns'));
