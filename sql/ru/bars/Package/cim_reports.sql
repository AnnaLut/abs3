...
--   g_header_version    constant varchar2 (64) := 'version 1.00.02 16/11/2015';
   g_header_version    constant varchar2 (64) := 'version 1.00.05 02/12/2016 ru';
...
-- g_body_version      constant varchar2 (64) := 'version 1.00.05 20/09/2016';
   g_body_version      constant varchar2 (64) := 'version 1.01.06 19/02/2018 ru';
  ...
  begin
    ...
    loop
      l_znyvt := lpad(cur.z,10,'0')||lpad(cur.r_agree_no,5,'0')
                 ||case when cur.m=1 then '00000000' else to_char(cur.p1200,'DDMMYYYY') end
  ...
  begin
    ...
    loop
      l_zn0yvt := lpad(cur.z,10,'0')||lpad(cur.r_agree_no,5,'0')
                 ||'00000'
                 ||case when cur.m=1 then '00000000' else to_char(cur.p103,'DDMMYYYY') end
                 ||lpad(cur.pval,3,'0')||cur.t
                 ||'=';
      l_zn  := lpad(cur.z,10,'0')||lpad(cur.r_agree_no,5,'0');
      l_yvt := case when cur.m=1 then '00000000' else to_char(cur.p103,'DDMMYYYY') end
                 ||lpad(cur.pval,3,'0')||cur.t
                 ||'=';
      ...
      l_txt:=cur.m||'050'||l_zn0yvt||translatewin2dos(cur.p050)||chr(13)||chr(10)
           ...
           ||cur.m||'0300'||l_zn0yvt||cur.p030||chr(13)||chr(10)
           ;
    ...
    begin
      ...
      loop
        ...
        values (cur.contr_id, l_date_to, substr(cur.nmkk,1,27) /*as p1000*/, lpad(substr(cur.okpo,1,10),10,'0') /*as z*/, cur.borrower_id /*as p0100*/,
               ...
               '0000' /*as p0200*/, lpad(substr(cur.r_agree_no,1,5),5,'0') /*r_agree_no*/, case when cur.credit_type=0 then null else cur.r_agree_date end /*as p1200*/,
