...
begin
  ...
  EXCEPTION WHEN NO_DATA_FOUND THEN
    l_msg := 'Нет такого вида залога '||chr(10)||dbms_utility.format_call_stack;
  ...
  EXCEPTION WHEN NO_DATA_FOUND THEN
    l_msg := 'Нет такого счета залога '||chr(10)||dbms_utility.format_call_stack;
    bars_audit.error(l_msg);
    raise_application_error(-20000, l_msg, true);
  end;
...
/
ALTER TRIGGER BARS.TIU_PAWN_ACC_NBS ENABLE;
