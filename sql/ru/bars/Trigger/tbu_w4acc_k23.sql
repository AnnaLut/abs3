...
begin
  ...
  begin
    select c.rnk, c.custtype, a.ostc into l_rnk, l_cus, l_accpk_ostc  from customer c, accounts a
  ...
  if :old.acc_9129 is not null then
      begin
       select a.ostc into l_acc_9129_ostc
         from accounts a
         where a.acc = :old.acc_9129 and a.DAZS is null;
       exception when no_data_found then null;
      end;
  end if;

  if (:old.acc_9129 is null or l_acc_9129_ostc = 0) and l_accpk_ostc < 0 then
