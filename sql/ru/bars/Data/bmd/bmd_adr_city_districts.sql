...
begin
  ...
  l_tabsemantic := 'Довідник внутрішньоміських районів';
  l_tabname := 'ADR_CITY_DISTRICTS';
  ...
  bars_metabase.add_column(l_tabid, 1, 'DISTRICT_ID', 'N', 'Ід. району в місті', null, 3, 1, 0, 1, 0, 0, '', '', 1, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'DISTRICT_NAME', 'C', 'Назва району', null, 50, 2, 0, 0, 1, 0, '', '', 1, 0, '', 1, 0, 1, '');
  bars_metabase.add_column(l_tabid, 3, 'DISTRICT_NAME_RU', 'C', 'Назва району (мовою мордора)', null, 50, 3, 0, 0, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 4, 'SETTLEMENT_ID', 'N', 'Ідентифікатор населеного пункту', null, 10, 4, 0, 0, 0, 0, '', '', 1, 0, '', 1, 0, 1, '');
