...
begin
  ...
  l_tabsemantic := 'Довідник вулиць';
  l_tabname := 'ADR_STREETS';
  ...
  bars_metabase.add_column(l_tabid, 1, 'STREET_ID', 'N', 'Ідентифікатор вулиці', null, 22, 1, 0, 1, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'STREET_NAME', 'C', 'Назва вулиці', null, 50, 2, 0, 0, 1, 0, '', '', 1, 0, '', 1, 0, 1, '');
  bars_metabase.add_column(l_tabid, 3, 'STREET_NAME_RU', 'C', 'Назва вулиці (RUS)', null, 50, 3, 0, 0, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 4, 'STREET_TYPE', 'N', 'Ідентифікатор типу вулиці', null, 22, 4, 0, 0, 0, 0, '', '', 1, 0, '', 1, 0, 1, '');
  bars_metabase.add_column(l_tabid, 5, 'SETTLEMENT_ID', 'N', 'Ідентифікатор населеного пункту', null, 22, 5, 0, 0, 0, 0, '', '', 1, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 6, 'EFF_DT', 'D', 'EFF_DT', null, 10, 6, 0, 0, 0, 0, '', '', 0, 0, '', 1, 1, 0, '');
  bars_metabase.add_column(l_tabid, 7, 'END_DT', 'D', 'END_DT', null, 10, 7, 0, 0, 0, 0, '', '', 0, 0, '', 1, 1, 0, '');
