...
begin
  ...
  l_tabsemantic := 'Довідник типів вулиць';
  l_tabname := 'ADR_STREET_TYPES';
  ...
  bars_metabase.add_column(l_tabid, 1, 'STR_TP_ID', 'N', 'Ід.   типу вулиці', null, 3, 1, 0, 1, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'STR_TP_NM', 'C', 'Назва типу вулиці', null, 12, 2, 0, 0, 1, 0, '', '', 1, 0, '', 1, 0, 1, '');
  bars_metabase.add_column(l_tabid, 3, 'STR_TP_NM_RU', 'C', 'Назва типу вулиці', null, 12, 3, 0, 0, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
