...
begin
  ...
  l_tabsemantic := 'Довідник передмість';
  l_tabname := 'ADR_SUBURBS';
  ...
  bars_metabase.add_column(l_tabid, 1, 'SUBURB_ID', 'N', 'Ідентифікатор передмісття', null, 10, 1, 0, 1, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'SUBURB_NAME', 'C', 'Назва передмісття', null, 50, 2, 0, 0, 1, 0, '', '', 1, 0, '', 1, 0, 1, '');
  bars_metabase.add_column(l_tabid, 3, 'SUBURB_NAME_RU', 'C', 'Назва передмісття', null, 50, 3, 0, 0, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 4, 'SETTLEMENT_ID', 'N', 'Ідентифікатор населеного пункту', null, 10, 4, 0, 0, 0, 0, '', '', 1, 0, '', 1, 0, 0, '');
