...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/_BRS_SBM_REP_37.sql =========*** Run **
PROMPT ===================================================================================== 
prompt ===================================== 
prompt == Виписки ВАЛ, вiддiл., маска рахунку з переоц.  (сорт.по сумi)
prompt ===================================== 
...
begin     
   l_zpr.name := 'Виписки ВАЛ, вiддiл., маска рахунку з переоц.  (сорт.по сумi)';
   l_zpr.pkey := '\BRS\SBM\REP\37';
...
order by okpo, nls, v.kv, srt, dksrt, sign(s), vobsrt, abs(s), ref, bis,  fdat';
    l_zpr.xsl_data     := '';
    l_zpr.xsd_data     := '';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Виписки ВАЛ, вiддiл., маска рахунку з переоц.  (сорт.по сумi)';
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/_BRS_SBM_REP_37.sql =========*** End **
PROMPT ===================================================================================== 
