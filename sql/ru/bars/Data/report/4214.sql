prompt ===================================== 
prompt == Оборотно-сальдова вiдомiсть Пiдроздiлу по OB22   (данi ф.#02)
prompt ===================================== 
...
begin     
   l_zpr.name := 'Оборотно-сальдова вiдомiсть Пiдроздiлу по OB22   (данi ф.#02)';
   l_zpr.pkey := '\BRS\SBM\REP\31\7';
