...
PROMPT ===================================================================================== 
prompt ===================================== 
prompt == Виписки в розрізі дат ВАЛ.  (позасистемні рахунки)
prompt ===================================== 
...
begin     
   l_zpr.name := 'Виписки в розрізі дат ВАЛ.  (позасистемні рахунки)';
...
order by okpo, nls, v.kv, v.fdat, srt desc, dksrt, vobsrt, paydate, ref, bis,  v.fdat';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Виписки в розрізі дат ВАЛ.  (позасистемні рахунки)';
