...
prompt Наименование операции: Перерахування 0.5% від купівлі ВАЛ до Пенс.Фонду
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('GOP', 'Перерахування 0.5% від купівлі ВАЛ до Пенс.Фонду', 1, null, null, '29023001501000', 980, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0100100000000000000000000000000000010000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='GOP', name='Перерахування 0.5% від купівлі ВАЛ до Пенс.Фонду', dk=1, nlsm=null, kv=null, nlsk='29023001501000', kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0100100000000000000000000000000000010000000000000000000000000000', nazn=null
       where tt='GOP';
  end;
  --------------------------------
  ----------- Реквизиты ----------
