...
prompt Наименование операции: Конвертація безготівк. валюти EUR<>USD
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    insert into tts(tt, name, dk, nlsm, kv, nlsk, kvk, nlss, nlsa, nlsb, mfob, flc, fli, flv, flr, s, s2, sk, proc, s3800, rang, flags, nazn)
    values ('CV3', 'Конвертація безготівк. валюти EUR<>USD', 1, null, 978, null, 840, null, null, null, null, 1, 0, 1, 0, null, null, null, null, '#(nbs_ob22 (''3800'',''10''))', null, '1000100000000000000000000000000000010000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='CV3', name='Конвертація безготівк. валюти EUR<>USD', dk=1, nlsm=null, kv=978, nlsk=null, kvk=840, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=1, fli=0, flv=1, flr=0, s=null, s2=null, sk=null, proc=null, s3800='#(nbs_ob22 (''3800'',''10''))', rang=null, flags='1000100000000000000000000000000000010000000000000000000000000000', nazn=null
       where tt='CV3';
  end;
  --------------------------------
  ----------- Реквизиты ----------
