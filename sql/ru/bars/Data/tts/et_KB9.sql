...
begin
  ...
  begin
    insert into tts(tt, name, dk, nlsm, kv, nlsk, kvk, nlss, nlsa, nlsb, mfob, flc, fli, flv, flr, s, s2, sk, proc, s3800, rang, flags, nazn)
    values ('KB9', 'off  DPT - Поповнення вкладу гот. ГРН', 0, '#(tobopack.GetTOBOParam(''TRDPT''))', 980, '#( TOBOPACK.GetToboCASH)', 980, null, '#(tobopack.GetTOBOParam(''TRDPT''))', '#( TOBOPACK.GetToboCASH)', null, 0, 0, 0, 0, null, null, 16, null, null, null, '0001100001000000000000000000000000010000000000100000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='KB9', name='off  DPT - Поповнення вкладу гот. ГРН', dk=0, nlsm='#(tobopack.GetTOBOParam(''TRDPT''))', kv=980, nlsk='#( TOBOPACK.GetToboCASH)', kvk=980, nlss=null, nlsa='#(tobopack.GetTOBOParam(''TRDPT''))', nlsb='#( TOBOPACK.GetToboCASH)', mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=16, proc=null, s3800=null, rang=null, flags='0001100001000000000000000000000000010000000000100000000000000000', nazn=null
       where tt='KB9';
  end;
  --------------------------------
  ----------- Реквизиты ----------
