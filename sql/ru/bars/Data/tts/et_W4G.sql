...
prompt Наименование операции: W4. Списання з картрах. для зарахування на інший рах. в іншому банку
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('W4G', 'W4. Списання з картрах. для зарахування на інший рах. в іншому банку', 1, '#(bpk_get_transit('''',''3739'',#(NLSA),#(KVA)))', 980, '#(get_proc_nls(''T00'',#(KVA)))', 980, null, null, null, null, 0, 1, 0, 0, null, null, null, null, null, null, '1300100000000000000000000010000000000000000000000000000000000000', 'Списання з картрахунку коштів для зарахування коштів на інший рахунок в іншому банку');
  exception
    when dup_val_on_index then 
      update tts
         set tt='W4G', name='W4. Списання з картрах. для зарахування на інший рах. в іншому банку', dk=1, nlsm='#(bpk_get_transit('''',''3739'',#(NLSA),#(KVA)))', kv=980, nlsk='#(get_proc_nls(''T00'',#(KVA)))', kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=1, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1300100000000000000000000010000000000000000000000000000000000000', nazn='Списання з картрахунку коштів для зарахування коштів на інший рахунок в іншому банку'
       where tt='W4G';
  end;
  --------------------------------
  ----------- Реквизиты ----------
