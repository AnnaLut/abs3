...
begin
  ...
  begin
    ...
    values ('CU4', 'CU4 Комісія банку за приймання переказу ЮНІСТРІМ (залишок)', 1, '#(nbs_ob22 (''2909'',''69''))', 980, '#(nbs_ob22 (''6110'',''B6''))', 980, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0101100000000000000000000001000000010000000000000000000000000000', 'Комісія банку за прийом переказу (залишок), що належить установі банку');
  exception
    when dup_val_on_index then 
      update tts
         set tt='CU4', name='CU4 Комісія банку за приймання переказу ЮНІСТРІМ (залишок)', dk=1, nlsm='#(nbs_ob22 (''2909'',''69''))', kv=980, nlsk='#(nbs_ob22 (''6110'',''B6''))', kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0101100000000000000000000001000000010000000000000000000000000000', nazn='Комісія банку за прийом переказу (залишок), що належить установі банку'
       where tt='CU4';
  end;
  --------------------------------
  ----------- Реквизиты ----------
