...
prompt Наименование операции: П-Учет неиспользованного лимита overdraft`а в 9-м класс
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('O99', 'П-Учет неиспользованного лимита overdraft`а в 9-м класс', 1, null, null, '#(BRANCH_USR.GET_BRANCH_PARAM2(''BPK_KR9900'',0))', null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0100100000000000000000000000000000000100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='O99', name='П-Учет неиспользованного лимита overdraft`а в 9-м класс', dk=1, nlsm=null, kv=null, nlsk='#(BRANCH_USR.GET_BRANCH_PARAM2(''BPK_KR9900'',0))', kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0100100000000000000000000000000000000100000000000000000000000000', nazn=null
       where tt='O99';
  end;
  --------------------------------
  ----------- Реквизиты ----------
