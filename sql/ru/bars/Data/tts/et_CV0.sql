...
prompt Наименование операции: Конвертація безготівк. валюти USD<>EUR
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    insert into tts(tt, name, dk, nlsm, kv, nlsk, kvk, nlss, nlsa, nlsb, mfob, flc, fli, flv, flr, s, s2, sk, proc, s3800, rang, flags, nazn)
    values ('CV0', 'Конвертація безготівк. валюти USD<>EUR', 1, null, 840, null, 978, null, null, null, null, 1, 0, 1, 0, null, null, null, null, '#(nbs_ob22 (''3800'',''10''))', null, '1000100000000000000000000000000000010000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='CV0', name='Конвертація безготівк. валюти USD<>EUR', dk=1, nlsm=null, kv=840, nlsk=null, kvk=978, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=1, fli=0, flv=1, flr=0, s=null, s2=null, sk=null, proc=null, s3800='#(nbs_ob22 (''3800'',''10''))', rang=null, flags='1000100000000000000000000000000000010000000000000000000000000000', nazn=null
       where tt='CV0';
  end;
  --------------------------------
  ----------- Реквизиты ----------
