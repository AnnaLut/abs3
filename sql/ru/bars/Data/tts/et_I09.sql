...
begin
  ...
  begin
    ...
    values ('I09', 'I09 - Тест', 1, null, null, '#(get_proc_nls(''T00'',#(KVA)))', null, null, null, null, null, 0, 1, 0, 0, null, null, null, null, null, null, '0000100000000000000000000000000000100000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='I09', name='I09 - Тест', dk=1, nlsm=null, kv=null, nlsk='#(get_proc_nls(''T00'',#(KVA)))', kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=1, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000100000000000000000000000000000100000000000000000000000000000', nazn=null
       where tt='I09';
  end;
  --------------------------------
  ----------- Реквизиты ----------
