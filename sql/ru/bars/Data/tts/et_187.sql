...
prompt Наименование операции: Вивезення надл. гот. (ГРН) до НБУ або ін. банків через підр. інкасації
declare
  cnt_  number;
begin
  --------------------------------
