...
prompt Наименование операции: 434 Списання з позабал суми безнад.деб заборг,погаш або списаної у зби
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('434', '434 Списання з позабал суми безнад.деб заборг,погаш або списаної у зби', 1, null, 980, null, 980, null, null, null, null, 0, 0, 0, 1, null, null, null, null, null, null, '1100100000000000000000000000000000010000000000000000000000000000', 'Списання з позабалансу суми безнадійної дебіторської заборгованості, погашеної або списаної у збиток');
  exception
    when dup_val_on_index then 
      update tts
         set tt='434', name='434 Списання з позабал суми безнад.деб заборг,погаш або списаної у зби', dk=1, nlsm=null, kv=980, nlsk=null, kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=1, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1100100000000000000000000000000000010000000000000000000000000000', nazn='Списання з позабалансу суми безнадійної дебіторської заборгованості, погашеної або списаної у збиток'
       where tt='434';
  end;
  --------------------------------
  ----------- Реквизиты ----------
