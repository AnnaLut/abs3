...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WCIA.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WCIA ***
  declare
    l_application_code varchar2(10 char) := 'WCIA';
    l_application_name varchar2(300 char) := 'АРМ Ідентифікація клієнтів ТВБВ';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WCIA створюємо (або оновлюємо) АРМ АРМ Ідентифікація клієнтів ТВБВ ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WCIA) - АРМ Ідентифікація клієнтів ТВБВ  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWCIA.sql =========*** En
PROMPT ===================================================================================== 
