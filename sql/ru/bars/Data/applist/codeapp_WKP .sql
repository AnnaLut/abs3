...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WKP .sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WKP  ***
  declare
    l_application_code varchar2(10 char) := 'WKP ';
    l_application_name varchar2(300 char) := 'АРМ Комунальні платежі  (WEB)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WKP  створюємо (або оновлюємо) АРМ АРМ Комунальні платежі  (WEB) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WKP ) - АРМ Комунальні платежі  (WEB)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWKP .sql =========*** En
PROMPT ===================================================================================== 
