...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_FIN2.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  FIN2 ***
  declare
    l_application_code varchar2(10 char) := 'FIN2';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' FIN2 створюємо (або оновлюємо) АРМ АРМ Фiнансовий стан позичальника ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (FIN2) - АРМ Фiнансовий стан позичальника  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappFIN2.sql =========*** En
PROMPT ===================================================================================== 
