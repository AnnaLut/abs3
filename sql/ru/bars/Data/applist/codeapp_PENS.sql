...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_PENS.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  PENS ***
  declare
    l_application_code varchar2(10 char) := 'PENS';
    l_application_name varchar2(300 char) := 'Імпорт файлів зарахувань (WEB)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' PENS створюємо (або оновлюємо) АРМ Імпорт файлів зарахувань (WEB) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (PENS) - Імпорт файлів зарахувань (WEB)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappPENS.sql =========*** En
PROMPT ===================================================================================== 
