...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_CDML.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  CDML ***
  declare
    l_application_code varchar2(10 char) := 'CDML';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' CDML створюємо (або оновлюємо) АРМ Робота з ЄБК ЮО ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію АРМ Якості ЮО ********** ');
      ...
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  ...
                                                  p_funcname => '/barsroot/cdm/Quality/Index?type=legalPerson',
                                                  p_rolename => '' ,
                                                  p_frontend => l_application_type_id
                                                  );
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (CDML) - Робота з ЄБК ЮО  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappCDML.sql =========*** En
PROMPT ===================================================================================== 
