...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_CURS.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  CURS ***
  declare
    l_application_code varchar2(10 char) := 'CURS';
    l_application_name varchar2(300 char) := 'Установка курсів КУПІВЛІ-ПРОДАЖУ';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' CURS створюємо (або оновлюємо) АРМ Установка курсів КУПІВЛІ-ПРОДАЖУ ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (CURS) - Установка курсів КУПІВЛІ-ПРОДАЖУ  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappCURS.sql =========*** En
PROMPT ===================================================================================== 
