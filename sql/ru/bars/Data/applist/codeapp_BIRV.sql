...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_BIRV.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  BIRV ***
  declare
    l_application_code varchar2(10 char) := 'BIRV';
    l_application_name varchar2(300 char) := 'АРМ Біржеві операції(ВАЛ.КОНТРОЛЬ,БІЗНЕС)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' BIRV створюємо (або оновлюємо) АРМ АРМ Біржеві операції(ВАЛ.КОНТРОЛЬ,БІЗНЕС) ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію ZAY. Розподіл надходжень валютної виручки ********** ');
      ...
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  ...
                                                  p_funcname => 'ZAYf(hWndMDI,38)',
                                                  p_rolename => 'ZAY' ,
                                                  p_frontend => l_application_type_id
                                                  );


   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (BIRV) - АРМ Біржеві операції(ВАЛ.КОНТРОЛЬ,БІЗНЕС)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappBIRV.sql =========*** En
PROMPT ===================================================================================== 
