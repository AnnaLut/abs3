...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_DPTR.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  DPTR ***
  declare
    l_application_code varchar2(10 char) := 'DPTR';
    l_application_name varchar2(300 char) := 'АРМ Обробки запитів від підрозділів';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' DPTR створюємо (або оновлюємо) АРМ АРМ Обробки запитів від підрозділів ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (DPTR) - АРМ Обробки запитів від підрозділів  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappDPTR.sql =========*** En
PROMPT ===================================================================================== 
