...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_BPKP.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  BPKP ***
  declare
    l_application_code varchar2(10 char) := 'BPKP';
    l_application_name varchar2(300 char) := 'АРМ БПК. Портфель';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' BPKP створюємо (або оновлюємо) АРМ АРМ БПК. Портфель ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (BPKP) - АРМ БПК. Портфель  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappBPKP.sql =========*** En
PROMPT ===================================================================================== 
