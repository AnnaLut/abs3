...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WEBP.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WEBP ***
  declare
    l_application_code varchar2(10 char) := 'WEBP';
    l_application_name varchar2(300 char) := 'АРМ Робота з клієнтом (WEB)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WEBP створюємо (або оновлюємо) АРМ АРМ Робота з клієнтом (WEB) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WEBP) - АРМ Робота з клієнтом (WEB)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWEBP.sql =========*** En
PROMPT ===================================================================================== 
