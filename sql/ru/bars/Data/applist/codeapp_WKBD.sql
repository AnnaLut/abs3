...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WKBD.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WKBD ***
  declare
    l_application_code varchar2(10 char) := 'WKBD';
    l_application_name varchar2(300 char) := 'АРМ Директора (Клієнт-Банк)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WKBD створюємо (або оновлюємо) АРМ АРМ Директора (Клієнт-Банк) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WKBD) - АРМ Директора (Клієнт-Банк)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWKBD.sql =========*** En
PROMPT ===================================================================================== 
