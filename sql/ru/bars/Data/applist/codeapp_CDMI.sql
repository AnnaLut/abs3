...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_CDMI.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  CDMI ***
  declare
    l_application_code varchar2(10 char) := 'CDMI';
    l_application_name varchar2(300 char) := 'Робота з ЄБК ФО';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' CDMI створюємо (або оновлюємо) АРМ Робота з ЄБК ФО ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (CDMI) - Робота з ЄБК ФО  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappCDMI.sql =========*** En
PROMPT ===================================================================================== 
