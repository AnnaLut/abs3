...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WASK.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WASK ***
  declare
    l_application_code varchar2(10 char) := 'WASK';
    l_application_name varchar2(300 char) := 'АРМ Аднміністратора депозитних сейфів WEB';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WASK створюємо (або оновлюємо) АРМ АРМ Аднміністратора депозитних сейфів WEB ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WASK) - АРМ Аднміністратора депозитних сейфів WEB  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWASK.sql =========*** En
PROMPT ===================================================================================== 
