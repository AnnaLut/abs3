...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WCCM.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WCCM ***
  declare
    l_application_code varchar2(10 char) := 'WCCM';
    l_application_name varchar2(300 char) := 'АРМ Контролера (валютний контроль)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WCCM створюємо (або оновлюємо) АРМ АРМ Контролера (валютний контроль) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WCCM) - АРМ Контролера (валютний контроль)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWCCM.sql =========*** En
PROMPT ===================================================================================== 
