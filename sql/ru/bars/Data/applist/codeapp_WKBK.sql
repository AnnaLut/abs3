...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WKBK.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WKBK ***
  declare
    l_application_code varchar2(10 char) := 'WKBK';
    l_application_name varchar2(300 char) := 'АРМ Контролера (Клієнт-Банк)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WKBK створюємо (або оновлюємо) АРМ АРМ Контролера (Клієнт-Банк) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WKBK) - АРМ Контролера (Клієнт-Банк)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWKBK.sql =========*** En
PROMPT ===================================================================================== 
