...
PROMPT *** Create/replace  ARM  WDOC ***
  declare
    ...
    l_application_name varchar2(300 char) := '*АРМ Операціоніста (Web)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WDOC створюємо (або оновлюємо) АРМ *АРМ Операціоніста (Web) ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Реєстрація договорів на виконання регулярних платежів WEB ********** ');
          --  Створюємо функцію Реєстрація договорів на виконання регулярних платежів WEB
      l := l +1;
      l_function_ids.extend(l);
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => 'Реєстрація договорів на виконання регулярних платежів WEB',
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Перегляд документів відділення ********** ');
      ...
      --  Створюємо дочірню функцію Перегляд документів відділення(файл тікета)
                     l_function_deps  :=   abs_utils.add_func(
															  p_name     => 'Перегляд документів відділення(файл тікета)',
      ...
      --  Створюємо дочірню функцію Перегляд документів відділення(Grid)
                     l_function_deps  :=   abs_utils.add_func(
															  p_name     => 'Перегляд документів відділення(Grid)',
      ...
      --  Створюємо дочірню функцію Перегляд документів відділення
                     l_function_deps  :=   abs_utils.add_func(
															  p_name     => 'Перегляд документів відділення',
      ...
      --  Створюємо дочірню функцію Перегляд документів відділення(Document)
                     l_function_deps  :=   abs_utils.add_func(
															  p_name     => 'Перегляд документів відділення(Document)',
      ...
      --  Створюємо дочірню функцію Перегляд документів відділення(Html-форма)
                     l_function_deps  :=   abs_utils.add_func(
															  p_name     => 'Перегляд документів відділення(Html-форма)',
      ...
      --  Створюємо дочірню функцію Перегляд документів відділення(імя згенерованого файла)
                     l_function_deps  :=   abs_utils.add_func(
															  p_name     => 'Перегляд документів відділення(імя згенерованого файла)',
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WDOC) - *АРМ Операціоніста (Web)  ');
