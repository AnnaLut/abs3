...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WCIG.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WCIG ***
  declare
    l_application_code varchar2(10 char) := 'WCIG';
    l_application_name varchar2(300 char) := 'АРМ Iнтерфейс з ПВБКI';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WCIG створюємо (або оновлюємо) АРМ АРМ Iнтерфейс з ПВБКI ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WCIG) - АРМ Iнтерфейс з ПВБКI  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWCIG.sql =========*** En
PROMPT ===================================================================================== 
