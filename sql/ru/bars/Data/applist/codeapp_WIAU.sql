...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WIAU.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WIAU ***
  declare
    l_application_code varchar2(10 char) := 'WIAU';
    l_application_name varchar2(300 char) := 'АРМ Страхування ЮО (Адміністратор)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WIAU створюємо (або оновлюємо) АРМ АРМ Страхування ЮО (Адміністратор) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WIAU) - АРМ Страхування ЮО (Адміністратор)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWIAU.sql =========*** En
PROMPT ===================================================================================== 
