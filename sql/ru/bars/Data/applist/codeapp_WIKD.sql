...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WIKD.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WIKD ***
  declare
    l_application_code varchar2(10 char) := 'WIKD';
    l_application_name varchar2(300 char) := 'АРМ Iнвентаризацiя кредитних справ в сховищi(WEB)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WIKD створюємо (або оновлюємо) АРМ АРМ Iнвентаризацiя кредитних справ в сховищi(WEB) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WIKD) - АРМ Iнвентаризацiя кредитних справ в сховищi(WEB)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWIKD.sql =========*** En
PROMPT ===================================================================================== 
