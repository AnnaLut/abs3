...
BEGIN
 ...
 select
     address||', '||decode(locality_type,1,'м.',3,'c.',2,'смт.',5, 'ст.',4, 'хут.',null )||decode(locality,null,null,(locality||', '))||decode(region,null,null,(region||', '))||decode(domain,null,null,(domain||', '))||C.NAME||', '||zip
     into adr
