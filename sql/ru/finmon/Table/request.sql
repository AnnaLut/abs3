...
PROMPT *** Create  constraint R_REQUEST_OPER ***
begin   
 execute immediate '
  ALTER TABLE FINMON.REQUEST ADD CONSTRAINT R_REQUEST_OPER FOREIGN KEY (BRANCH_ID, KL_ID, KL_DATE)
	  REFERENCES FINMON.OPER (BRANCH_ID, KL_ID_BRANCH_ID, KL_DATE_BRANCH_ID) ENABLE';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE FINMON.REQUEST ADD CONSTRAINT R_REQUEST_FILEOUT FOREIGN KEY (FILE_O_ID)
	  REFERENCES FINMON.FILE_OUT (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE FINMON.REQUEST ADD CONSTRAINT R_REQUEST_FILEIN FOREIGN KEY (FILE_I_ID)
...
begin   
 execute immediate '
  ALTER TABLE FINMON.REQUEST ADD CONSTRAINT R_REQUEST_DFILE FOREIGN KEY (DFILE_ID)
	  REFERENCES FINMON.FILE_OUT (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint SYS_C002065799 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002065798 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002065797 ***
begin   
 execute immediate '
