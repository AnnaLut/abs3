...
begin   
 execute immediate '
  ALTER TABLE FINMON.PERSON ADD CONSTRAINT R_PERSON_KDFM11_U FOREIGN KEY (ADR_OBL_U)
	  REFERENCES FINMON.K_DFM11 (CODE) DEFERRABLE ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE FINMON.PERSON ADD CONSTRAINT R_PERSON_KDFM12 FOREIGN KEY (CL_REZ)
	  REFERENCES FINMON.K_DFM12 (CODE) DEFERRABLE ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE FINMON.PERSON ADD CONSTRAINT R_PERSON_KDFM04 FOREIGN KEY (DOC_TYP_P)
	  REFERENCES FINMON.K_DFM04 (CODE) DEFERRABLE ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint NK_PERSON_BRANCH_ID ***
begin   
 execute immediate '
  ALTER TABLE FINMON.PERSON ADD CONSTRAINT NK_PERSON_BRANCH_ID CHECK (branch_id is not null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
