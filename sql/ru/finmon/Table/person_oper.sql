...
PROMPT *** Create  constraint NK_PERSON_OPER_BRANCH_ID ***
begin   
 execute immediate '
  ALTER TABLE FINMON.PERSON_OPER ADD CONSTRAINT NK_PERSON_OPER_BRANCH_ID CHECK (branch_id is not null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
