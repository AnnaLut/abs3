...
create or replace package body BARS_DM.DM_IMPORT
 is
  ...
  g_body_version constant varchar2(64) := 'Version 3.0.1 18/09/2017';
...
--    l_row.kf := bars.f_ourmfo_g;
    ...
    begin
        ...
        loop
            bars.bc.go(lc_kf.kf);
            open l_cursor for
            select /* parallel(4) leading(k) */ bars.t_attribute_value(h.attribute_id, h.object_id, min(h.number_value) keep (dense_rank last order by h.id), null, null, null, null, null, null, null, null, null) as R
        ...
        loop
         ...
         select /* parallel(4) leading(K)*/ bars.t_attribute_value(a.attribute_id, a.object_id, a.value, null, null, null, null, null, null, null, null, null)
            ...
            left join (select d.attribute_id, d.object_id, nh.value
                       from   data d
                       left join bars.attribute_number_history_bak nh on nh.id = d.last_history_id) a on a.object_id = c.rnk
