...
PROMPT *** Create  grants  PFU_ENVELOPE_LIST_REQUEST ***
grant SELECT                                                                 on PFU_ENVELOPE_LIST_REQUEST to BARSREADER_ROLE;
grant SELECT                                                                 on PFU_ENVELOPE_LIST_REQUEST to UPLD;
