...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/NBUR_P_F13.sql =========*** Run **
PROMPT ===================================================================================== 


PROMPT *** Create  procedure NBUR_P_F13 ***

  CREATE OR REPLACE PROCEDURE BARS.NBUR_P_F13 (p_kod_filii        varchar2,
                                             p_report_date      date,
                                             p_form_id          number,
                                             p_scheme           varchar2 default 'C',
                                             p_balance_type     varchar2 default 'S',
                                             p_file_code        varchar2 default '#13')
is
/*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
BEGIN
    logger.info ('NBUR_P_F13 begin for date = '||to_char(p_report_date, 'dd.mm.yyyy'));
    ...
    logger.info ('NBUR_P_F13 end for date = '||to_char(p_report_date, 'dd.mm.yyyy'));
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/NBUR_P_F13.sql =========*** End **
PROMPT ===================================================================================== 
