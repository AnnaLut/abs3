         ...
         THEN
            ...
            THEN                                  -- есть такие в справочнике
               ...
               THEN                                             -- до 30 дней
                  ...
                  THEN
                     r013_new := TO_CHAR (TO_NUMBER (r013_old) - 1);
                  elsif r013_old IN ('C', 'E') then
                     r013_new := (case when r013_old = 'C' then 'B' else 'D' end);
                  END IF;
               ELSE                                           -- свыше 30 дней
                  IF r013_old IN ('3', '5', '7')
                  THEN
                     r013_new := TO_CHAR (TO_NUMBER (r013_old) + 1);
                  elsif r013_old IN ('B', 'D') then
                     r013_new := (case when r013_old = 'B' then 'C' else 'E' end);
                  END IF;
               END IF;
            ELSE                                          -- нет в справочнике
               IF tp_ = 1
...
grant EXECUTE                                                                on P_ANALIZ_R013   to BARS_ACCESS_DEFROLE;
