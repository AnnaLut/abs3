...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/NBUR_P_I51.sql =========*** Run **
PROMPT ===================================================================================== 


PROMPT *** Create  procedure NBUR_P_I51 ***

  CREATE OR REPLACE PROCEDURE BARS.NBUR_P_I51 (p_kod_filii        varchar2,
                                             p_report_date      date,
                                             p_form_id          number,
                                             p_scheme           varchar2 default 'G',
                                             p_balance_type     varchar2 default 'S',
                                             p_file_code        varchar2 default '@51')
 IS
/*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DESCRIPTION : Процедура формирования @51 для КБ
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
   ...
   l_file_code     varchar2(2) := '21';
BEGIN
    logger.info ('NBUR_P_I51 begin for date = '||to_char(p_report_date, 'dd.mm.yyyy'));
    ...
    EXCEPTION
       WHEN OTHERS
       THEN
          logger.info ('NBUR_P_I51 error: ' || SQLERRM);
    END;
   ...
   logger.info ('NBUR_P_I51 end for date = '||to_char(p_report_date, 'dd.mm.yyyy'));
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/NBUR_P_I51.sql =========*** End **
PROMPT ===================================================================================== 
