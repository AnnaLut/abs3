...
begin
  ...
  P_2400_nbs(dat01_, '0')   ; -- не налоговый
  P_2400_nbs(dat01_, '1')   ; -- налоговый
  P_2400_nbs(dat01_, '5')   ; -- налоговый нач.% свыше 30 дней
  --P_2400(dat01_, '6')   ; -- не налоговый нач.% свыше 30 дней

  --P_2400(dat01_, 'A')   ; -- налоговый нач.% свыше 30 дней
  P_2400_nbs(dat01_, 'B')   ; -- налоговый нач.% свыше 30 дней
  P_2400_nbs(dat01_, 'C')   ; -- налоговый нач.% свыше 30 дней
  --P_2400(dat01_, 'D')   ; -- налоговый нач.% свыше 30 дней

  P_2400_nbs(dat01_, '3'); -- цЕННЫЕ БУМАГИ
  P_2400_nbs(dat01_, '4'); -- 3119 ГОУ
  P_2400_nbs(dat01_, '7'); --
