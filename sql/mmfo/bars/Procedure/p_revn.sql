...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/P_REVN.sql =========*** Run *** ==
PROMPT ===================================================================================== 


PROMPT *** Create  procedure P_REVN ***

  CREATE OR REPLACE PROCEDURE BARS.P_REVN 
 ( kv_ NUMBER, dat_ DATE   DEFAULT NULL) IS
...
-----------
BEGIN
  --старушку ЕВРОПУ не переоцениваем (280,...)
  begin
    select kv into V_ from EURO where kv<>978 and kv=KV_;
    return;
  EXCEPTION  WHEN NO_DATA_FOUND THEN V_:=1;
  end;
  -------------------------------
  begin
...
DELETE FROM SALDOB
WHERE ACC IN (SELECT ACC FROM ACCOUNTS WHERE KV=KV_ AND pos=1) AND FDAT>=datN_;
...
PROMPT *** Create  grants  P_REVN ***
grant EXECUTE                                                                on P_REVN          to ABS_ADMIN;
grant EXECUTE                                                                on P_REVN          to BARS_ACCESS_DEFROLE;
grant EXECUTE                                                                on P_REVN          to RPBN001;
grant EXECUTE                                                                on P_REVN          to WR_ALL_RIGHTS;
grant EXECUTE                                                                on P_REVN          to WR_DOC_INPUT;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_REVN.sql =========*** End *** ==
PROMPT ===================================================================================== 
