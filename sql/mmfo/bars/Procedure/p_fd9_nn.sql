...
11.05.2018 - для кода 206 изменено формирование значения показателя 
...
31.01.2018 - зм_нено формування частини показника ЗЗЗЗЗЗЗЗЗЗ для 
             нерезидент_в
25.01.2018 - зм_нено формування код_в ZZZZZZZZZZ _ ЗЗЗЗЗЗЗЗЗЗ а також
             код K021
13.10.2017 - якщо код ОКПО сформований як сер_я и номер паспорта тод_  
...
14.08.2017 - для орган_в державної влади параметр K021 будемо заповнювати
             значенням '9'
...
-------------------------------------------------------------------
   ...
   loop
       ...
       -- визначаємо чи є учасник кл_єнтом банку
       BEGIN
          select 1
             into pr_kl_
          from customer 
