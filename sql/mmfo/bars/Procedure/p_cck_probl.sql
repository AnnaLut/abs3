...
str_z CC_DEAL_PROBL%rowtype;
p_dat1  varchar2(10);

begin

EXECUTE IMMEDIATE 'truncate table CC_DEAL_PROBL';
...
p_dat1:=to_char(p_dat01,'dd/mm/yyyy');
 ...
 for k in (
           ...
           from cc_deal d, customer c, nd_txt nt, cc_add da, accounts a8, nd_acc na
...
*/
 ...
 loop
        ...
        Insert into BARS.CC_DEAL_PROBL
