...
--курсор по контрагентам
   CURSOR c_main
   IS
      SELECT   t.fdat, t.ko, decode(substr(b.b040,9,1),'2',substr(b.b040,15,2),substr(b.b040,10,2)),
...
-------------------------------------------------------------------
   ...
   if ( (mfou_ = 300465 and mfou_ = mfo_) OR mfou_ <> 300465 ) and kol_ref_ = 0 then
        ...
        INSERT INTO OTCN_PROV_TEMP
               (ko, rnk, REF, fdat, tt, accd, nlsd, kv, acck, nlsk, nazn,
                s_nom, s_eqv)
        SELECT *
        FROM (
              SELECT   '3' ko, ca.rnk, o.REF, o.fdat, tt, o.accd, o.nlsd, o.kv, o.acck,
                       o.nlsk, o.nazn,
                       o.s * 100 s_nom,
     ...
     INSERT INTO OTCN_PROV_TEMP
        ...
        FROM (
            SELECT /*+NO_MERGE(v) PUSH_PRED(v) */
                  '3' ko, o.rnkd rnk, o.REF, fdat, tt, o.accd, o.nlsd, o.kv, o.acck,
                     o.nlsk, o.nazn,
                     o.s * 100 s_nom,
                     gl.p_icurval (o.kv, o.s * 100, dat_) s_eqv
            FROM provodki_otc o,
               ( select /*+ index(a, XIE_DAT_A_ARC_RRP) */ o.ref
                  ...
                  where trunc(a.dat_a) >= Dat_
                    ...
                    and substr(a.d_rec, 6+instr(a.d_rec, '#CREF:'),
                        ...
                        o.s = a.s) v
            WHERE o.kv != 980
              and o.fdat between Dat_ - 10 and dat_ + 1
              and o.ref = v.ref
   ...
   LOOP
      FETCH c_main
       INTO odat_, ko_, kod_obl_, rnk_, okpo1_, nmk_, k040_, adr_, k110_, codc_, sum1_, sumk1_;
