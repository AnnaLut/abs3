create or replace procedure p_nbur_get_sk_data(p_ReportDateFrom in date, p_ReportDateTo in date, p_kf in varchar2)
is
...
--  l_url:= 'http://10.10.10.35:1212/barsroot/webservices/QuickMoneyService.asmx'; --jeka потом убрать
  ...
  logger.info(title||'profix_service: begin call service ' || l_url || ' with method [ TransactionShortReport ]');
