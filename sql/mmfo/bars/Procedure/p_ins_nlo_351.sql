...
/* ¬ерси€ 3.0  14-07-2017  09-03-2017  27-01-2017   
   Ќ≈ќѕќ«ЌјЌЌџе —„≈“а
   -------------------------------------
...
begin
   ...
   dat31_ := Dat_last_work (p_dat01 - 1 ) ;  -- последний рабочий день мес€ца
   z23.DI_SNP;

   for k in ( select acc  from accounts a, kl_f3_29 f 
              where  ost_korr(a.acc,dat31_,z23.di_,a.nbs)<0 and a.nbs=f.r020 and f.kf='1B' and (dazs is null or dazs >= p_dat01)
                     and f.r020 not in ('2805','2806','1410','1412','1413','1414','1415','1417','1418','1419','1420','1427','1428','3103',
