CREATE OR REPLACE PROCEDURE P_JOB_FM_DOCCHECK_EXT is
-- parallel stuff
c_task_name  constant varchar2(32) := 'FINMON_JOB_EXT_SLAVE';
...
exception
    when others then
        bars_audit.error('FM. job: error during execution procedure P_JOB_FM_DOCCHECK_EXT: ' ||
