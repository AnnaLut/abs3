...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/MERGE_2700.sql =========*** Run **
PROMPT ===================================================================================== 


PROMPT *** Create  procedure MERGE_2700 ***

  CREATE OR REPLACE PROCEDURE BARS.MERGE_2700 ( p_vidd number, p_rnk number, p_kv number, p_NN number ) is
...
begin bc.go('300465')  ;
   ...
   loop
      ...
      if p_nn =1 THEN
         select acc into l_acc from accounts where nls='27010201' and kv=g.kv;
         l_freq  := 180;
         l_dat   := to_date('10-03-2018','dd-mm-yyyy');
         l_dat_s := to_date('10-03-2017','dd-mm-yyyy');
         g.sdate := to_date('04-03-2011','dd-mm-yyyy');
      else
         select acc into l_acc from accounts where nls='27019202' and kv=g.kv;
         l_freq  := 180;
         l_dat   := to_date('20-03-2018','dd-mm-yyyy');
         l_dat_s := to_date('20-03-2017','dd-mm-yyyy');
         g.sdate := to_date('15-03-2013','dd-mm-yyyy');
      end if;
...
PROMPT *** Create  grants  MERGE_2700 ***
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/MERGE_2700.sql =========*** End **
PROMPT ===================================================================================== 
