...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/P_IDENT_FM_UL.sql =========*** Run
PROMPT ===================================================================================== 


PROMPT *** Create  procedure P_IDENT_FM_UL ***

  CREATE OR REPLACE PROCEDURE BARS.P_IDENT_FM_UL (p_num number ) is
-- ƒанные про последующую идентификацию клиентов дл€ ‘ћ

  G00_ IDENT_FM_UL.G00%type;
  G01_ IDENT_FM_UL.G01%type;
  G02_ IDENT_FM_UL.G02%type;
  G03_ IDENT_FM_UL.G03%type;
  G04_ IDENT_FM_UL.G04%type;
  G05_ IDENT_FM_UL.G05%type;
  G06_ IDENT_FM_UL.G06%type;
  G07_ IDENT_FM_UL.G07%type;
  G08_ IDENT_FM_UL.G08%type;
  G09_ IDENT_FM_UL.G09%type;
  G10_ IDENT_FM_UL.G10%type;
  G11_ IDENT_FM_UL.G11%type;
  G12_ IDENT_FM_UL.G12%type;
...
for k in
  ...
  loop
    ...
    begin
      select g01 into l_rnk from IDENT_FM_UL where g01=k.rnk and g05=k.pldat;
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_IDENT_FM_UL.sql =========*** End
PROMPT ===================================================================================== 
