...
PROMPT *** Create  procedure P_KOL_DEB ***

  CREATE OR REPLACE PROCEDURE BARS.P_KOL_DEB (p_dat01 date, p_mode integer, p_deb integer) IS
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_KOL_DEB.sql =========*** End ***
PROMPT ===================================================================================== 
