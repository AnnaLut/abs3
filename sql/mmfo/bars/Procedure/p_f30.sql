...
VERSION     : 29/03/2016 (17/03/2016, 09/02/2016, 27/01/2016)
COMMENT     :
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if Dat_ >= to_date('30112012','ddmmyyyy') then
   ...
   loop
     ...
     loop
       ...
       if L_ = '3' then
          if substr(k.nbs,1,3) in ('900','902') and k.nbs||k.r013<>'90231' then
             s090_:='A';
          elsif substr(k.nbs,1,3) in ('910','912') and k.nbs||k.r013<>'91299' then
             s090_:='B';
          elsif k.nbs||k.r013='90231' or k.nbs||k.r013='91299' then
             s090_:='C';
          else
             null;
          end if;
       ...
       then  
          ...
          if k.nbs||k.r013 <> '90231' and k.nbs||k.r013 <> '91299' then
             bv_nd_ := bv_nd_ + k.bv;
          end if;
       ...
       if L_ = '3' then
          if (k.BV - k.PV) > 0 and ( k.nbs||k.r013 <> '90231' and k.nbs||k.r013 <> '91299')
          then  
             n_ := '7';
             kodp_:= L_ || N_ || k.kat || s090_ || '00' || lpad(to_char(k.kv),3,'0') || k.REZ;
       ...
       if k.PV >= 0 and k.nbs not like '9%' and 
                          ( (k.nbs in ('2600','2607','2067','2069','2625','2627',
                             ...
                             ((k.id like 'BPK%' and k.nbs like '9129%' and k.r013='1') or 
                              (k.id like 'BPK%' and k.nbs not like '9129%') ) OR 
                             ((k.id like 'W4%' and k.nbs like '9129%' and k.r013='1') or 
       ...
       -- резерв
       if k.rezq <> 0 and ( (k.nbs like '9023%' and k.r013='9') or
