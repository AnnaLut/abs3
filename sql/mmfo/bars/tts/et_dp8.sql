...
prompt Наименование операции: Виплата відсотків в нац.валюті (міжбанк) з комісією
declare
  cnt_  number;
begin
  --------------------------------
