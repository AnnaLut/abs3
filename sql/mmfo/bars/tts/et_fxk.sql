...
prompt Наименование операции: FOREX: Результат переоцiнки 9202-9212
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('FXK', 'FOREX: Результат переоцiнки 9202-9212', 1, null, 980, '62045010119017', 980, null, '354001', '364091', null, 0, 0, 0, 0, null, null, null, null, null, null, '0000000000000000000000000000000000000100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='FXK', name='FOREX: Результат переоцiнки 9202-9212', dk=1, nlsm=null, kv=980, nlsk='62045010119017', kvk=980, nlss=null, nlsa='354001', nlsb='364091', mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000000000000000000000000000000000000100000000000000000000000000', nazn=null
       where tt='FXK';
  end;
  --------------------------------
  ----------- Реквизиты ----------
