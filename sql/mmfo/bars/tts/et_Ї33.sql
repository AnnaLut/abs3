...
prompt Наименование операции: Ф33-Кл. платежі в межах СВОГО МФО
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('Ф33', 'Ф33-Кл. платежі в межах СВОГО МФО', 1, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '1000100000000000000000000001000000000000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='Ф33', name='Ф33-Кл. платежі в межах СВОГО МФО', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1000100000000000000000000001000000000000000000000000000000000000', nazn=null
       where tt='Ф33';
  end;
  --------------------------------
  ----------- Реквизиты ----------
