...
prompt Наименование операции: p) Перекриття-згортання(внутрішня) БЕЗ ВІЗ
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('PSG', 'p) Перекриття-згортання(внутрішня) БЕЗ ВІЗ', 1, null, null, null, null, null, null, null, null, 0, 0, 1, 0, null, null, null, null, '#(nbs_ob22 (''3800'',''03''))', null, '0000100000000000000000000000000000000100000000000010000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='PSG', name='p) Перекриття-згортання(внутрішня) БЕЗ ВІЗ', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=1, flr=0, s=null, s2=null, sk=null, proc=null, s3800='#(nbs_ob22 (''3800'',''03''))', rang=null, flags='0000100000000000000000000000000000000100000000000010000000000000', nazn=null
       where tt='PSG';
  end;
  --------------------------------
  ----------- Реквизиты ----------
