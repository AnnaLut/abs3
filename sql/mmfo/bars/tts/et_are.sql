...
prompt Наименование операции: Авто-Резерв по Стандартним
declare
  cnt_  number;
begin
  --------------------------------
