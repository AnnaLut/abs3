...
prompt Наименование операции: Internet_Banking внутрібанк 2620-2620
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    insert into tts(tt, name, dk, nlsm, kv, nlsk, kvk, nlss, nlsa, nlsb, mfob, flc, fli, flv, flr, s, s2, sk, proc, s3800, rang, flags, nazn)
    values ('P2V', 'Internet_Banking внутрібанк 2620-2620', 1, null, null, '#(GetGlobalOption(''NLS_373914_LOCPAY''))', null, null, null, null, null, 1, 0, 0, 0, null, null, null, null, null, null, '1000000000000000000000000000000000000100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='P2V', name='Internet_Banking внутрібанк 2620-2620', dk=1, nlsm=null, kv=null, nlsk='#(GetGlobalOption(''NLS_373914_LOCPAY''))', kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=1, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1000000000000000000000000000000000000100000000000000000000000000', nazn=null
       where tt='P2V';
  end;
  --------------------------------
  ----------- Реквизиты ----------
