...
begin
  ...
  begin
    ...
    values ('FX6', 'FX6-FOREX Отправка (ЛОРО)', 1, null, null, '191992', null, null, null, '191992', '300465', 0, 2, 0, 0, null, null, null, null, null, null, '0001000000000000000000000000000000010000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='FX6', name='FX6-FOREX Отправка (ЛОРО)', dk=1, nlsm=null, kv=null, nlsk='191992', kvk=null, nlss=null, nlsa=null, nlsb='191992', mfob='300465', flc=0, fli=2, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0001000000000000000000000000000000010000000000000000000000000000', nazn=null
       where tt='FX6';
  end;
  --------------------------------
  ----------- Реквизиты ----------
