...
prompt Наименование операции: (доч.CA0) Комісія агента за прийом переказу для “INTEREXPRESS”
declare
  cnt_  number;
begin
  --------------------------------
