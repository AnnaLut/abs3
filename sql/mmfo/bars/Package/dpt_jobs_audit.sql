...
g_body_version  constant varchar2(64)  := 'version 6.01 24/10/2016';
    ...
    CASE
      ...
      THEN
        ...
        INSERT INTO dpt_jobs_jrnl
          ( run_id, job_id, branch, start_date, finish_date, bank_date, user_id, status, errmsg, kf )
        VALUES
          ( l_run, p_jobid, p_branch, sysdate, null, p_bdate, p_user, 0, null, sys_context('bars_context','user_mfo') );
      ...
      THEN
        ...
        INSERT INTO dpt_jobs_log
          ( rec_id, run_id, job_id, dpt_id, branch, ref, rnk, nls, kv, dpt_sum, int_sum,
            status, errmsg, contract_id, deal_num, rate_val, rate_dat, kf )
        VALUES
          ( l_recid, p_runid, l_jobid, p_dptid, p_branch, p_ref, p_rnk, p_nls, p_kv, p_dptsum, p_intsum,
            p_status, p_errmsg, p_contractid, p_dealnum, p_rateval, p_ratedat,sys_context('bars_context','user_mfo'));
      ...
      THEN
        ...
        INSERT INTO dpu_jobs_log
          ( rec_id, run_id, job_id, dpt_id, branch, ref, rnk, nls, kv,
            dpt_sum, int_sum, status, errmsg, deal_num, rate_val, rate_dat, kf )
        VALUES
          ( l_recid, p_runid, l_jobid, p_dptid, p_branch, p_ref, p_rnk, p_nls, p_kv,
            p_dptsum, p_intsum, p_status, p_errmsg, p_dealnum, p_rateval, p_ratedat, sys_context('bars_context','user_mfo') );
