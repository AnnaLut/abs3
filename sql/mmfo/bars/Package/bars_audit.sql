  ...
  begin
    ...
    is
     ...
     begin
         ...
         -- Имя модуля либо передается, либо берется установленное SET_MODULE
         ...
         -- Определяем банковскую дату, определяется в контексте BARS_GL. Если значение на данный
...
-- Вставляем запись в журнал аудита збд
