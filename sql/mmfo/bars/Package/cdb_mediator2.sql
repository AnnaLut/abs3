 ...
 PROMPT ===================================================================================== 
 PROMPT *** Run *** ========== Scripts /Sql/BARS/package/cdb_mediator2.sql =========*** Run *
 PROMPT ===================================================================================== 
 
  CREATE OR REPLACE PACKAGE BARS.CDB_MEDIATOR2 is
...
/
CREATE OR REPLACE PACKAGE BODY BARS.CDB_MEDIATOR2 as
...
*/
    ...
    is
    begin
        bars_audit.log_trace('cdb_mediator.pay_accrued_interest',
                             'sys_context(''bars_pul'', ''reckoning_id'') : ' || sys_context('bars_pul', 'reckoning_id'));

        interest_utl2.pay_accrued_interest(p_do_not_store_interest_tails => true);
    end;
    ...
    begin
        bars_audit.trace('cdb_mediator.pay_selected_interest' || chr(10) ||
        ...
        if (l_int_reckoning_row.id is not null) then
            interest_utl2.pay_int_reckoning_row(l_int_reckoning_row, p_silent_mode => true, p_do_not_store_interest_tails => true);
        end if;
    end;
    ...
    is
    begin
        bars_audit.trace('cdb_mediator.remove_selected_reckoning' || chr(10) ||
                         'sys_context(''bars_pul'', ''reckoning_id'') : ' || sys_context('bars_pul', 'reckoning_id') || chr(10) ||
                         'p_id : ' || p_reckoning_id);
...
PROMPT *** Create  grants  CDB_MEDIATOR2 ***
grant EXECUTE                                                                on CDB_MEDIATOR2   to BARS_ACCESS_DEFROLE;

 
 
 PROMPT ===================================================================================== 
 PROMPT *** End *** ========== Scripts /Sql/BARS/package/cdb_mediator2.sql =========*** End *
 PROMPT ===================================================================================== 
