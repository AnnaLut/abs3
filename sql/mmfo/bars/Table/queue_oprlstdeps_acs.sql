...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''QUEUE_OPRLSTDEPS_ACS'', ''CENTER'' , null, null, null, null);
...
COMMENT ON TABLE BARS.QUEUE_OPRLSTDEPS_ACS IS 'Очередь на обновление зависимости веб-функций';
COMMENT ON COLUMN BARS.QUEUE_OPRLSTDEPS_ACS.CODEOPER IS 'Код функции';




PROMPT *** Create  constraint SYS_C004735 ***
begin   
 execute immediate '
