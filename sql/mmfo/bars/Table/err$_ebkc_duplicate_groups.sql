...
PROMPT *** Create  grants  ERR$_EBKC_DUPLICATE_GROUPS ***
grant SELECT                                                                 on ERR$_EBKC_DUPLICATE_GROUPS to BARSREADER_ROLE;
grant SELECT                                                                 on ERR$_EBKC_DUPLICATE_GROUPS to UPLD;
