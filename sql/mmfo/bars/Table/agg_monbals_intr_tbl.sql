...
COMMENT ON TABLE  AGG_MONBALS_INTR_TBL            IS 'Накопительные балансы за місяць';

COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.FDAT       IS 'Дата балансу';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.KF         IS 'Код філіалу (МФО)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.ACC        IS 'Ід. рахунка';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.RNK        IS 'Ід. клієнта';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.OST        IS 'Вихідний залишок по рахунку (номінал)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.OSTQ       IS 'Вихідний залишок по рахунку (еквівалент)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.DOS        IS 'Сума дебетових оборотів (номінал)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.DOSQ       IS 'Сума дебетових оборотів (еквівалент)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.KOS        IS 'Сума кредитових оборотів (номінал)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.KOSQ       IS 'Сума кредитових оборотів (еквівалент)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.CRDOS      IS 'Сума корегуючих дебетових  оборотів (номінал)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.CRDOSQ     IS 'Сума корегуючих дебетових  оборотів (еквівалент)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.CRKOS      IS 'Сума корегуючих кредитових оборотів (номінал)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.CRKOSQ     IS 'Сума корегуючих кредитових оборотів (еквівалент)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.CUDOS      IS 'Сума корегуючих дебетових  оборотів минулого місяця (номінал)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.CUDOSQ     IS 'Сума корегуючих дебетових  оборотів минулого місяця (еквівалент)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.CUKOS      IS 'Сума корегуючих кредитових оборотів минулого місяця (номінал)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.CUKOSQ     IS 'Сума корегуючих кредитових оборотів минулого місяця (еквівалент)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.YR_DOS     IS 'Дебетовi обороти по коригуючих рiчних';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.YR_DOS_UAH IS 'Дебетовi обороти по коригуючих рiчних (в еквіваленті)';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.YR_KOS     IS 'Кредитовi обороти по коригуючих рiчних';
COMMENT ON COLUMN AGG_MONBALS_INTR_TBL.YR_KOS_UAH IS 'Кредитовi обороти по коригуючих рiчних (в еквіваленті)';
