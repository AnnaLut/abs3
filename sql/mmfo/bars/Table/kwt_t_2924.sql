...
PROMPT *** Create  grants  KWT_T_2924 ***
grant SELECT                                                                 on KWT_T_2924      to BARSREADER_ROLE;
grant SELECT                                                                 on KWT_T_2924      to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on KWT_T_2924      to UPLD;
