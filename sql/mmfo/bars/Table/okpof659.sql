...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''OKPOF659'', ''CENTER'' , null, null, null, null);
               bpa.alter_policy_info(''OKPOF659'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''OKPOF659'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
COMMENT ON COLUMN BARS.OKPOF659.PAR_SK IS '';
COMMENT ON COLUMN BARS.OKPOF659.PAR_LINK IS '';
COMMENT ON COLUMN BARS.OKPOF659.PAR_INVEST IS '';
...
PROMPT *** Create  grants  OKPOF659 ***
grant SELECT                                                                 on OKPOF659        to UPLD;
