...
COMMENT ON TABLE BARS.NBUR_DM_TXN_SYMBOLS_ARCH IS 'Додаткові реквізити (символи) документів';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS_ARCH.REPORT_DATE IS 'Звітна дата';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS_ARCH.KF IS 'Код філіалу (МФО)';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS_ARCH.VERSION_ID IS 'Iдентифiкатор версії';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS_ARCH.REF IS 'Ідентифікатор документу';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS_ARCH.STMT IS 'Ідентифікатор транзакції';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS_ARCH.SYMB_TP IS 'Тип символу (1- касовий, 2- позабалансовий)';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS_ARCH.SYMB_VAL IS 'Значення символу';
...
grant SELECT                                                                 on NBUR_DM_TXN_SYMBOLS_ARCH to BARSREADER_ROLE;
...
grant SELECT                                                                 on NBUR_DM_TXN_SYMBOLS_ARCH to UPLD;
