...
PROMPT *** Create  grants  KWT_D_2924 ***
grant SELECT                                                                 on KWT_D_2924      to BARSREADER_ROLE;
grant SELECT                                                                 on KWT_D_2924      to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on KWT_D_2924      to START1;
grant SELECT                                                                 on KWT_D_2924      to UPLD;
