...
COMMENT ON COLUMN BARS.DPT_VIDD_UPDATE.AMR_METR IS 'Метод амортизации процентов';
...
COMMENT ON COLUMN BARS.DPT_VIDD_UPDATE.TERM_TYPE IS 'Тип срока: 1-фикс, 0-плав, 2-диапазон';
