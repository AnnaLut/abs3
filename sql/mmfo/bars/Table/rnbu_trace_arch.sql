...
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.KODP IS 'Код показника';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.ZNAP IS 'Значення показника';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.NBUC IS 'Код області (МФО)';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.ISP IS 'Код виконац';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.RNK IS 'РНК';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.ACC IS '';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.NLS IS '№ рахунку';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.KV IS 'Валюта';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.ODATE IS 'Дата формування';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.REF IS 'Номер документу';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.COMM IS 'Коментр';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.ND IS 'Номер договору';
COMMENT ON COLUMN BARS.RNBU_TRACE_ARCH.MDATE IS 'Дата погашення';
