...
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_KOR_DATA_FD3 ADD CONSTRAINT PK_KORDATAFD3 PRIMARY KEY (REPORT_DATE, KF, VAR_10, VAR_40)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_KORDATAFD3 ON BARS.NBUR_KOR_DATA_FD3 (REPORT_DATE, KF, VAR_10, VAR_40) 
