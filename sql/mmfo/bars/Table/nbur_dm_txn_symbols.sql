...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Table/NBUR_DM_TXN_SYMBOLS.sql =========*** R
PROMPT ===================================================================================== 


PROMPT *** ALTER_POLICY_INFO to NBUR_DM_TXN_SYMBOLS ***


BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''NBUR_DM_TXN_SYMBOLS'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  table NBUR_DM_TXN_SYMBOLS ***
begin 
  execute immediate '
  CREATE TABLE BARS.NBUR_DM_TXN_SYMBOLS 
   (	REPORT_DATE DATE, 
	KF VARCHAR2(6), 
	REF NUMBER(38,0), 
	STMT NUMBER(38,0), 
...
PROMPT *** ALTER_POLICIES to NBUR_DM_TXN_SYMBOLS ***
 exec bpa.alter_policies('NBUR_DM_TXN_SYMBOLS');


COMMENT ON TABLE BARS.NBUR_DM_TXN_SYMBOLS IS 'Додаткові реквізити (символи) документів';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS.SYMB_VAL IS 'Значення символу';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS.REPORT_DATE IS 'Звітна дата';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS.KF IS 'Код філіалу (МФО)';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS.REF IS 'Ідентифікатор документу';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS.STMT IS 'Ідентифікатор транзакції';
COMMENT ON COLUMN BARS.NBUR_DM_TXN_SYMBOLS.SYMB_TP IS 'Тип символу (1- касовий, 2- позабалансовий)';




PROMPT *** Create  constraint CC_DMTXNSYMBOLS_REPORTDT_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_TXN_SYMBOLS MODIFY (REPORT_DATE CONSTRAINT CC_DMTXNSYMBOLS_REPORTDT_NN NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint CC_DMTXNSYMBOLS_KF_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_TXN_SYMBOLS MODIFY (KF CONSTRAINT CC_DMTXNSYMBOLS_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMTXNSYMBOLS_STMT_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_TXN_SYMBOLS MODIFY (STMT CONSTRAINT CC_DMTXNSYMBOLS_STMT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  index UK_DMTXNSYMBOLS ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UK_DMTXNSYMBOLS ON BARS.NBUR_DM_TXN_SYMBOLS (KF, REF, STMT, SYMB_TP) 
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Table/NBUR_DM_TXN_SYMBOLS.sql =========*** E
PROMPT ===================================================================================== 
