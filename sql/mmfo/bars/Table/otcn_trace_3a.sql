...
PROMPT *** Create  index I1_OTCN_TRACE_3A ***
begin   
 execute immediate '
  CREATE INDEX BARS.I1_OTCN_TRACE_3A ON BARS.OTCN_TRACE_3A (KF, DATF) 
...
grant SELECT                                                                 on OTCN_TRACE_3A   to BARSREADER_ROLE;
...
grant SELECT                                                                 on OTCN_TRACE_3A   to UPLD;
