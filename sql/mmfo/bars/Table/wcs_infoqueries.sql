...
PROMPT *** Create  constraint FK_INFOQUERIES_ЕID_IQTYPES_ID ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_INFOQUERIES ADD CONSTRAINT FK_INFOQUERIES_ЕID_IQTYPES_ID FOREIGN KEY (TYPE_ID)
