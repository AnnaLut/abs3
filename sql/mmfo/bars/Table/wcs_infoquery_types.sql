...
COMMENT ON TABLE BARS.WCS_INFOQUERY_TYPES IS 'Типы информационных запросов';
COMMENT ON COLUMN BARS.WCS_INFOQUERY_TYPES.ID IS 'Идентификатор';
COMMENT ON COLUMN BARS.WCS_INFOQUERY_TYPES.NAME IS 'Наименование';
