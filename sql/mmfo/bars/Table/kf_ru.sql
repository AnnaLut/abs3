...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''KF_RU'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
               bpa.alter_policy_info(''KF_RU'', ''WHOLE'' , null, ''E'', ''E'', ''E'');
               null;
           end; 
          '; 
END; 
...
begin 
  ...
  CREATE TABLE BARS.KF_RU 
   (	KF VARCHAR2(6), 
	RU VARCHAR2(2), 
	 CONSTRAINT PK_KFRU PRIMARY KEY (KF) ENABLE
...
grant SELECT                                                                 on KF_RU           to BARS_ACCESS_DEFROLE;
