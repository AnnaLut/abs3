...
COMMENT ON TABLE  ATM_REF1      IS 'Картотека надлишків та нестач в банкоматах';
COMMENT ON COLUMN ATM_REF1.acc  IS 'АСС рахунку 2924/07-08';
COMMENT ON COLUMN ATM_REF1.ref1 IS 'Реф.виникнення заборгованості';
