...
COMMENT ON TABLE BARS.NBUR_DM_AGRM_RATES IS 'Зв`язок рахунків та договорів';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.REPORT_DATE IS 'Звітна дата';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.KF IS 'Код філіалу (МФО)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.AGRM_ID IS 'Ідентифікатор договору';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.ACC_ID IS 'Iдентифiкатор рахунку (ACC)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.RATE_TP IS 'Тип процентної картки (ID)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.FRQ_TP IS 'Періодисність нарахування (FREQ)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.ACR_ACC_ID IS 'Ідентифікатор рахунка нарахування (ACRA)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.PNL_ACC_ID IS 'Ідентифікатор рахунка доходів/витрат (ACRB)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.RATE_DT IS 'Дата початку дії процентної ставки (BDAT)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_RATES.RATE_VAL IS 'Значення процентної ставки на звітну дату';
