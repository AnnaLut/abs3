...
PROMPT *** Create  constraint SYS_IOT_TOP_80145 ***
begin   
 execute immediate '
...
PROMPT *** Create  index SYS_IOT_TOP_80145 ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.SYS_IOT_TOP_80145 ON BARS.AQ$_BARS_MSG_QT_G (MSGID, SUBSCRIBER#, NAME, ADDRESS#) 
...
PROMPT *** Create  grants  AQ$_BARS_MSG_QT_G ***
grant SELECT                                                                 on AQ$_BARS_MSG_QT_G to BARSREADER_ROLE;
grant SELECT                                                                 on AQ$_BARS_MSG_QT_G to BARS_DM;
