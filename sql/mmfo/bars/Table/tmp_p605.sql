begin execute immediate 'CREATE TABLE tmp_P605 (  md int, nd number , G01 date , G02 number, G03 number,  G04 number, G05 number,  G06 number, G07 int,  G08 number,  G09 number, G10 number, G11 number) ' ;
