...
select  /*+ first_rows(50) */  "ID","REPORT_ID","OBJECT_ID","OBJECT_TYPE_ID","OBJECT_TYPE_NAME","OBJECT_KF","OBJECT_CODE","OBJECT_NAME","SESSION_CREATION_TIME","SESSION_ACTIVITY_TIME","SESSION_TYPE_ID","SESSION_TYPE_NAME","STATE_ID","SESSION_STATE","SESSION_DETAILS","LAST_ACTIVITY_AT","OBJ","OBJECT_LINK" from nbu_gateway.v_nbu_session_history
