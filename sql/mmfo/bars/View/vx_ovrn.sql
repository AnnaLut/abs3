...
SELECT t.rnk,  t.kv,  t.nms,  t.NLS,  i.acr_dat,  y.dat1,  y.dat2,  x.acc8,  x.acc,       ROUND (ABS (x.pr), 0) PR,       1 - i.id ID,       aa.nls NLSA,       aa.nms NAM_a,       x.vn,
       ...
       SUBSTR (DECODE (x.vn,   60,'Нар.%% дох.за ОВР ',   70,'Нар.%% витр.',    61,'Нар.ком за ОВР 1 дн',  62,'Нар.ком за ОВР Холд.',  63,'Нар.ком за посл NPP',65,'Донарах.%% дох.за ОВР',    NULL), 1, 38) NAzn
