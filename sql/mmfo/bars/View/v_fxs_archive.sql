...
PROMPT *** Create  view V_FXS_ARCHIVE ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_FXS_ARCHIVE ("DEAL_TAG", "NTIK", "KVA", "SUMA", "KVB", "SUMB", "REF", "SOSM", "REFA", "SOSA", "REFB", "SOSB", "REFB2", "REF1", "REFA_SPTOD", "REFB_SPTOD", "REFB2_SPTOD", "KODB", "TA_DIG", "TB_DIG", "SWI_REF", "SWO_REF", "SUMPA", "SUMPB", "SUMP", "SWAP_TAG", "RNK", "OKPO", "MFO", "DAT", "DAT_A", "DAT_B", "KURS", "SUMC", "RATEA", "RATEB", "NB", "RECPAR") AS 
  select "DEAL_TAG","NTIK","KVA","SUMA","KVB","SUMB","REF","SOSM","REFA","SOSA","REFB","SOSB","REFB2","REF1","REFA_SPTOD","REFB_SPTOD","REFB2_SPTOD","KODB","TA_DIG","TB_DIG","SWI_REF","SWO_REF","SUMPA","SUMPB","SUMP","SWAP_TAG","RNK","OKPO","MFO","DAT","DAT_A","DAT_B","KURS","SUMC","RATEA","RATEB","NB","'ÐÅÄÀÃÓÂÀÍÍßÏÀÐÀÌ.'" from 
(  
     SELECT DEAL_TAG,
            NTIK,
            KVA,
