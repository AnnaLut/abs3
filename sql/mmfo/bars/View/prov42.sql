...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/PROV42.sql =========*** Run *** =======
PROMPT ===================================================================================== 


PROMPT *** Create  view PROV42 ***

  CREATE OR REPLACE FORCE VIEW BARS.PROV42 ("COMM", "FFF", "KV", "NLS", "OST", "SUM1", "DEL1", "KK") AS 
          ...
          FROM   (SELECT kk                                     ,
                  ...
                  FROM   (SELECT SUBSTR(d.nd,1,instr(d.nd,'_')-1) kk,
                          ...
                          WHERE  d.acc=a.acc                                  AND
                                 ...
                                 d.comments='*Imported from MEGABANK')
                  ...
                  FROM   (SELECT SUBSTR(d.nd,1,instr(d.nd,'_')-1) kk,
                          ...
                          WHERE  d.acc=a.acc                                  AND
                                 ...
                                 b.fff=SUBSTR(pul.get_mas_ini_val('FFF'),1,3) AND
                                 substr(d.nd,INSTR(d.nd,'_')+1,3)=b.fff       AND
                                 d.comments='*Imported from MEGABANK'         AND
                                 w.tag='ZPR_D')            detali,
                         (SELECT n.kk             ,
                                 n.kv             ,
                                 n.nls0_procz  nls,
...
PROMPT *** Create  grants  PROV42 ***
grant SELECT                                                                 on PROV42          to BARSREADER_ROLE;
grant SELECT                                                                 on PROV42          to UPLD;
grant DELETE,FLASHBACK,INSERT,SELECT,UPDATE                                  on PROV42          to WR_ALL_RIGHTS;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/PROV42.sql =========*** End *** =======
PROMPT ===================================================================================== 
