...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_SW_IMPMSG_DOC.sql =========*** Run **
PROMPT ===================================================================================== 


PROMPT *** Create  view V_SW_IMPMSG_DOC ***

  CREATE OR REPLACE FORCE VIEW BARS.V_SW_IMPMSG_DOC ("REF", "VDAT", "NLSA", "NLSB", "AMOUNT", "LCV", "DIG", "DK", "NAZN", "ACCD", "ACCK", "S", "FDAT", "TAG20", "TT", "NEXTVISAGRP") AS 
  SELECT p.REF,
            p.vdat,
            p.nlsa,
            p.nlsb,
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_SW_IMPMSG_DOC.sql =========*** End **
PROMPT ===================================================================================== 
