...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_MBDK_INT_RECKONING.sql =========*** R
PROMPT ===================================================================================== 


PROMPT *** Create  view V_MBDK_INT_RECKONING ***

  CREATE OR REPLACE FORCE VIEW BARS.V_MBDK_INT_RECKONING ("ID", "DEAL_NUMBER", "CURRENCY_ID", "PARTNER_BIC", "PARTNER_NAME", "ACCOUNT_NUMBER", "INTEREST_ACCOUNT", "INCOME_ACCOUNT", "DATE_FROM", "DATE_TO", "ACCOUNT_REST", "INTEREST_RATE", "INTEREST_AMOUNT", "OPERATION_TYPE", "PURPOSE", "MESSAGE", "STATE_ID") AS 
  select t.id,
       d.cc_id deal_number,
       dd.kv currency_id,
       cb.bic partner_bic,
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_MBDK_INT_RECKONING.sql =========*** E
PROMPT ===================================================================================== 
