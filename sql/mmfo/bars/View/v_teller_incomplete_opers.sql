 ...
 PROMPT ===================================================================================== 
  ...
  select t.rowid as atm_id, t.oper_time atm_time, t.oper_type atm_op_type, t.cur_code atm_cur, t.amount atm_amn, t.user_ref atm_user, null tel_op_type, null tel_amn, null tel_cur, null tel_user, null tel_time, null as tel_id
from TELLER_ATM_OPERS t
