...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_S080_2.sql =========*** Run *** =====
PROMPT ===================================================================================== 


PROMPT *** Create  view V_S080_2 ***

  CREATE OR REPLACE FORCE VIEW BARS.V_S080_2 ("KV", "VIDD", "NMK", "BRANCH", "ND", "CC_ID", "SDATE", "WDATE", "S080", "R080", "M080", "C080", "OTM", "ISP", "FIN", "OBS") AS 
...
WHERE d.rnk  = c.rnk
  ...
  AND d.vidd IN (1,2,3) AND d.nd   = m.nd (+) ;

PROMPT *** Create  grants  V_S080_2 ***
grant SELECT                                                                 on V_S080_2        to BARSREADER_ROLE;
grant SELECT,UPDATE                                                          on V_S080_2        to BARS_ACCESS_DEFROLE;
grant SELECT,UPDATE                                                          on V_S080_2        to RCC_DEAL;
grant SELECT                                                                 on V_S080_2        to UPLD;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_S080_2.sql =========*** End *** =====
PROMPT ===================================================================================== 
