...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_EBKC_LEGAL_SUBGRP.sql =========*** Ru
PROMPT ===================================================================================== 


PROMPT *** Create  view V_EBKC_LEGAL_SUBGRP ***

  CREATE OR REPLACE FORCE VIEW BARS.V_EBKC_LEGAL_SUBGRP ("RNK", "GROUP_ID", "ID_PRC_QUALITY", "OKPO", "NMK", "QUALITY", "DOCUMENT", "BIRTH_DAY", "ATTR_QTY", "LAST_CARD_UPD", "LAST_USER_UPD", "BRANCH") AS 
  select r.rnk,
       r.group_id,
       r.id_prc_quality,
       r.okpo,
...
where teru.kf = ss_kf.kf
  ...
  and nvl(teru.cust_type,ebkc_pack.get_custtype(c.rnk)) = 'L') r;

PROMPT *** Create  grants  V_EBKC_LEGAL_SUBGRP ***
grant SELECT                                                                 on V_EBKC_LEGAL_SUBGRP to BARSREADER_ROLE;
grant SELECT                                                                 on V_EBKC_LEGAL_SUBGRP to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on V_EBKC_LEGAL_SUBGRP to UPLD;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_EBKC_LEGAL_SUBGRP.sql =========*** En
PROMPT ===================================================================================== 
