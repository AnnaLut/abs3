...
PROMPT *** Create  view V_CIM_BOUND_PAYMENTS ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_CIM_BOUND_PAYMENTS ("BOUND_ID", "CONTR_ID", "PAY_FLAG", "PAY_FLAG_NAME", "REF", "DIRECT", "TYPE_ID", "TYPE", "VDAT", "ACCOUNT", "NAZN", "V_PL", "S_VPL", "SK_VPL", "RATE", "S_VK", "CREATE_DATE", "MODIFY_DATE", "BORG_REASON", "EA_URL", "BRANCH") AS 
