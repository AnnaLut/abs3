...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_FM_DFM02_5010EX.sql =========*** Run 
PROMPT ===================================================================================== 


PROMPT *** Create  view V_FM_DFM02_5010EX ***

  CREATE OR REPLACE FORCE VIEW BARS.V_FM_DFM02_5010EX ("REF") AS 
  select o.ref
...
PROMPT *** Create  grants  V_FM_DFM02_5010EX ***
grant SELECT                                                                 on V_FM_DFM02_5010EX to BARSREADER_ROLE;
grant SELECT                                                                 on V_FM_DFM02_5010EX to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on V_FM_DFM02_5010EX to START1;
grant SELECT                                                                 on V_FM_DFM02_5010EX to UPLD;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_FM_DFM02_5010EX.sql =========*** End 
PROMPT ===================================================================================== 
