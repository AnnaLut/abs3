...
BEGIN 
  ...
  , p_file_nm          => '81X Данi про коригуючі обороти за результатами звітного року та залишки на рахунках (без кл.6,7)'
  , p_file_fmt         => 'XML'
  ...
  ( p_proc_id => l_proc_id
   ...
   , p_proc_active => 'Y'
   , p_scheme => 'BARS'
   , p_proc_name => 'NBUR_P_F81X_NC'
   , p_description => '81 XML-формат'
   , p_version => 'v.19.001'
...
begin
    delete from BARS.NBUR_REF_PREPARE_XML WHERE FILE_CODE = '81X'; 
