...
add_question('Жодне з зобов’язань Контрагента на дату ухвалення рішення про припинення визнання дефолту не є простроченим більше ніж на 30 календарних днів', 2, 'ZD2', 55, 'Жодне з зобов’язань Контрагента на дату ухвалення рішення про припинення визнання дефолту боржника/контрагента не є простроченим більше ніж на 30 календарних днів', 0);
...
dbms_output.put_line('PROMPT *** IDF=55 KOD>>ZD4 *** З моменту усунення події/подій, на підставі якої/яких було визнано дефолт божника, минуло щонайменше 180 днів');
add_question('З моменту усунення події/подій, на підставі якої/яких було визнано дефолт божника, минуло щонайменше 180 днів', 3, 'ZD4', 55, '', 0);
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== /Sql/bars/data/fin_question_55.sql  =========*** End *** =====
PROMPT ===================================================================================== 
