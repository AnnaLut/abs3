...
begin
  ...
  NBUR_FILES.SET_OBJECT_DEPENDENCIES
  ( p_file_id => l_file_id
  , p_obj_id  => NBUR_OBJECTS.F_GET_OBJECT_ID_BY_NAME('NBUR_DM_TRANSACTIONS')
  , p_strt_dt => date '2015-01-01'
  );

  NBUR_FILES.SET_OBJECT_DEPENDENCIES
  ( p_file_id => l_file_id
  , p_obj_id  => nbur_objects.f_get_object_id_by_name('NBUR_DM_ADL_DOC_RPT_DTL')
  , p_strt_dt => date '2015-01-01'
  );
