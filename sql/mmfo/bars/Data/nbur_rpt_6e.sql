...
begin
  ...
  , p_scm_code         => 'C'
  , p_file_tp          => 1
  , p_file_nm          => '(xml) 6EX Дані для розрахунку коефіцієнта покриття ліквідністю (LCR)'
  , p_file_fmt         => 'XML'
  , p_scm_num          => '03'
  , p_unit_code        => '01'
  , p_period_tp        => 'M'
  ...
  ( p_proc_id => l_proc_id
   ...
   , p_description => '(xml) 6EX Дані для розрахунку коефіцієнта покриття ліквідністю (LCR)'
   , p_version => '1.0'
