...
prompt Наименование операции: KD2 КD2 Комісія за створення дод. угод по вкладам ф.о.
declare
  cnt_  number;
begin
  --------------------------------
