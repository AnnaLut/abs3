...
prompt Наименование операции: MF1/2а.Сума без ПДВ та номінальної вартості (для монет з пл.ном.)
declare
  cnt_  number;
begin
  --------------------------------
