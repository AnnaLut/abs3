...
prompt Наименование операции: $V9 2.9.Викуп ЦП:кiлькiсть
declare
  cnt_  number;
begin
  --------------------------------
