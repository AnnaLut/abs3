...
begin
  ...
  begin
    ...
    values ('I07', 'I07 - Iмпорт реальний ДЕБЕТ мiжбанк', 0, null, null, '#(get_proc_nls(''T0D'',#(KVA)))', null, null, null, null, null, 0, 1, 0, 0, null, null, null, null, null, null, '0201100000000000000000000000000000110000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='I07', name='I07 - Iмпорт реальний ДЕБЕТ мiжбанк', dk=0, nlsm=null, kv=null, nlsk='#(get_proc_nls(''T0D'',#(KVA)))', kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=1, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0201100000000000000000000000000000110000000000000000000000000000', nazn=null
       where tt='I07';
  end;
  --------------------------------
  ----------- Реквизиты ----------
