...
prompt Наименование операции: CB4 (доч.CA4) Комісія агента за прийом переказу для BLIZKO
declare
  cnt_  number;
begin
  --------------------------------
