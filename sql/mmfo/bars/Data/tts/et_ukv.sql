...
prompt Наименование операции: Облік ощадної книжки(видача) 
declare
  cnt_  number;
begin
  --------------------------------
