...
prompt Наименование операции: MOM-Відсилання надлишків ювілейних монет до сховища РУ з ТВБВ II рiвн
declare
  cnt_  number;
begin
  --------------------------------
