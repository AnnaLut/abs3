...
prompt Наименование операции: PK4 p) П-Кредит картрахунку (мультивалютна)
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('PK4', 'PK4 p) П-Кредит картрахунку (мультивалютна)', 0, null, null, null, null, null, null, null, null, 0, 0, 1, 0, null, null, null, null, '#(nbs_ob22 (''3800'',''03''))', null, '0000100000000000000000000000000000010100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='PK4', name='PK4 p) П-Кредит картрахунку (мультивалютна)', dk=0, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=1, flr=0, s=null, s2=null, sk=null, proc=null, s3800='#(nbs_ob22 (''3800'',''03''))', rang=null, flags='0000100000000000000000000000000000010100000000000000000000000000', nazn=null
       where tt='PK4';
  end;
  --------------------------------
  ----------- Реквизиты ----------
