...
prompt Наименование операции: CDO (доч.CDA) Комісія банку за прийом переказу  WU/РФ/ком(Терміновий)
declare
  cnt_  number;
begin
  --------------------------------
