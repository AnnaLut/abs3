...
begin
  ...
  begin
    ...
    values ('ASG', 'ASG КП АВТОобработка счета SG', 1, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, '0', null, '0000100000000000000000000000000000000100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='ASG', name='ASG КП АВТОобработка счета SG', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800='0', rang=null, flags='0000100000000000000000000000000000000100000000000000000000000000', nazn=null
       where tt='ASG';
  end;
  --------------------------------
  ----------- Реквизиты ----------
