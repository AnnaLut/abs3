...
prompt Наименование операции: DP& +D: STOP-правило на первинний внесок
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('DP&', 'DP& +D: STOP-правило на первинний внесок', 1, null, null, null, null, null, null, null, null, 0, 0, 0, 0, 'BARS.F_DPT_STOP(0,#(KVA),#(NLSA),#(S),BANKDATE)', null, null, null, null, 0, '0000100000000000000000000000000000000100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='DP&', name='DP& +D: STOP-правило на первинний внесок', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s='BARS.F_DPT_STOP(0,#(KVA),#(NLSA),#(S),BANKDATE)', s2=null, sk=null, proc=null, s3800=null, rang=0, flags='0000100000000000000000000000000000000100000000000000000000000000', nazn=null
       where tt='DP&';
  end;
  --------------------------------
  ----------- Реквизиты ----------
