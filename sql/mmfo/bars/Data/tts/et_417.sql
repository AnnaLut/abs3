...
begin
  ...
  begin
    ...
    values ('K17', 'd: розрахунки за виплачені перекази по системі "Швидка копійка"', 1, null, 980, '373910300465', 980, null, null, null, null, 0, 0, 0, 0, null, null, 5, null, null, null, '0000100000000000000000000000000000000100000000000000000000000000', 'розрахунки за виплачені перекази по системі "Швидка копійка"');
  exception
...
begin
  ...
  exception
    when dup_val_on_index then 
      update tts
         set tt='417', name='417-Виплачено перекази по системі "Швидка копійка"', dk=1, nlsm='#(nbs_ob22 (''2809'',''24''))', kv=980, nlsk='#(BRANCH_USR.GET_BRANCH_PARAM2(''CASH'',0))', kvk=980, nlss=null, nlsa='#(nbs_ob22 (''2809'',''24''))', nlsb='#(BRANCH_USR.GET_BRANCH_PARAM2(''CASH'',0))', mfob=null, flc=1, fli=0, flv=0, flr=0, s=null, s2=null, sk=61, proc=null, s3800=null, rang=null, flags='1000100001000000000000000000000000010000000000000000000000000000', nazn='Виплачено перекази по системі "Швидка копійка"'
       where tt='417';
  end;
  --------------------------------
  ----------- Реквизиты ----------
