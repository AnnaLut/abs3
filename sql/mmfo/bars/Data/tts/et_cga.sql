...
prompt Наименование операции: CGA (доч.CG8) Комісія агента за прийом переказу по системі "MoneyGram"
declare
  cnt_  number;
begin
  --------------------------------
