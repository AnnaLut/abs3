...
prompt Наименование операции: Повернення суми вкладу в нац.валюті (міжбанк) з комісією
declare
  cnt_  number;
begin
  --------------------------------
