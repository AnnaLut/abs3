...
prompt Наименование операции: ПРИХІД КАСИ. Продаж лоторей
declare
  cnt_  number;
begin
  --------------------------------
