...
begin
  ...
  begin
    insert into tts(tt, name, dk, nlsm, kv, nlsk, kvk, nlss, nlsa, nlsb, mfob, flc, fli, flv, flr, s, s2, sk, proc, s3800, rang, flags, nazn)
    values ('00C', '00C-Видача по ЧЕКУ ЮО (з коміс. %)', 1, null, 980, null, 980, null, null, null, null, 1, 0, 0, 0, null, null, null, null, null, null, '1000100000000000000000000000000000010300000000000000000000000100', 'Видаток готівки по чеку');
  exception
    when dup_val_on_index then 
      update tts
         set tt='00C', name='00C-Видача по ЧЕКУ ЮО (з коміс. %)', dk=1, nlsm=null, kv=980, nlsk=null, kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=1, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1000100000000000000000000000000000010300000000000000000000000100', nazn='Видаток готівки по чеку'
       where tt='00C';
  end;
  --------------------------------
  ----------- Реквизиты ----------
