...
begin
  ...
  begin
    ...
    values ('26R', 'Зарахування на тр/рах 2603 для нерезидентів', 1, null, null, '#(DECODE(SUBSTR(#(NLSB),1,4),''1602'',''1919'',''2600'',''2603'',''2650'', ''2603'', ''2610'', ''2622'', SUBSTR(#(NLSB),1,4))||''??????????'')', null, null, null, null, null, 0, 0, 0, 0, '#(S)', null, null, null, null, null, '0000100000000000000000080000000000010100000000000010000000000000', null);
  exception
