...
prompt Наименование операции: CDR (доч.CAR) Комісія агента за прийом переказу по сист."RIA"(Інші кра
declare
  cnt_  number;
begin
  --------------------------------
