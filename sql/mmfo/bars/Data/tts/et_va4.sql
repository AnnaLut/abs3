...
prompt Наименование операции: Виплата виграшів по лотерейних білетах (каса)
declare
  cnt_  number;
begin
  --------------------------------
