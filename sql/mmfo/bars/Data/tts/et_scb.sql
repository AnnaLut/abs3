...
begin
  ...
  begin
    ...
    values ('SCB', 'Первинний внесок на вклад з поточного рах.клієнта', 1, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0000100000000000000000000000000000010000000000000000000000000000', 'Внесення коштів згідно договору #{dpt_social.f_nazn(''U'',#(ND))}');
  exception
    when dup_val_on_index then 
      update tts
         set tt='SCB', name='Первинний внесок на вклад з поточного рах.клієнта', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000100000000000000000000000000000010000000000000000000000000000', nazn='Внесення коштів згідно договору #{dpt_social.f_nazn(''U'',#(ND))}'
       where tt='SCB';
  end;
  --------------------------------
  ----------- Реквизиты ----------
