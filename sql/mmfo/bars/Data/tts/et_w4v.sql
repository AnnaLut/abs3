...
prompt Наименование операции: W4V-Зарахування на картрахунок
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('W4V', 'W4V-Зарахування на картрахунок', 1, null, null, '#(bpk_get_transit('''',#(NLSA),#(NLSB),#(KVA)))', null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0000100000000000000000000001000000000100000000000000000000000000', 'Зарахування на  картрахунок');
  exception
    when dup_val_on_index then 
      update tts
         set tt='W4V', name='W4V-Зарахування на картрахунок', dk=1, nlsm=null, kv=null, nlsk='#(bpk_get_transit('''',#(NLSA),#(NLSB),#(KVA)))', kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000100000000000000000000001000000000100000000000000000000000000', nazn='Зарахування на  картрахунок'
       where tt='W4V';
  end;
  --------------------------------
  ----------- Реквизиты ----------
