...
prompt Наименование операции: K50 (доч.CDA) Комісія за прийом переказу WU/РФ/ком(Терміновий)
declare
  cnt_  number;
begin
  --------------------------------
