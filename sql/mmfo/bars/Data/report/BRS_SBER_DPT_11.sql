prompt ===============================================
prompt == Виписка з рахунку в ін.валюті (розширена) ==
prompt ===============================================
...
begin     
   l_zpr.name := 'Виписка з рахунку в ін.валюті (розширена)';
 ...
 order by t.fdat, t.docref';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Виписка з рахунку в ін.валюті (розширена)';
