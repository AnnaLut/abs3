prompt ===================================== 
prompt == Реєстр документів, що передаються до БОРУ 4-ї категорії
prompt ===================================== 
...
begin     
   l_zpr.name := 'Реєстр документів, що передаються до БОРУ 4-ї категорії';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.name         := 'Реєстр документів, що передаються до БОРУ 4-ї категорії';
    l_zpr.namef        := '';
    l_zpr.bindvars     := ':sFdat1='''',:sFdat2='''',:Param0=''Код виконавця (%-всі)'',:BRANCH=''Код відділення (%-всі)''';
    l_zpr.create_stmt  := '';
    l_zpr.rpt_template := 'eaddocs4.frx';
    l_zpr.form_proc    := '';
    l_zpr.default_vars := ':Param0=''%'',:BRANCH=''Поточне''';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Реєстр документів, що передаються до БОРУ 4-ї категорії';
    ...
    if l_isnew = 1 then                        
     ...
     if l_isnewr = 1 then                        
        l_rep.id := 387; --bars_report.next_reportid;   
        begin                                    
