prompt ===================================== 
prompt == ЗДК: Касир: Безготiвковий об/с журнал
prompt ===================================== 
...
begin     
   l_zpr.name := 'ЗДК: Касир: Безготiвковий об/с журнал';
   l_zpr.pkey := '\BRS\SBM\REP\62';
...
from ( select o.txt ob22txt, a.nbs||''(''||i.ob22||'')'' ob22,
       ...
       from saldoa s, accounts a, staff$base f, specparam_int i, sb_ob22 o 
       ...
       and s.acc = a.acc and f.id = USER_ID
       and a.acc= i.acc 
       and a.nbs = o.r020
       and i.ob22 = o.ob22
