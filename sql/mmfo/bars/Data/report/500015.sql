...
begin     
   ...
   exception when no_data_found then                       
    ...
    l_zpr.bindvars     := '';
    l_zpr.create_stmt  := 'KU NUMBER(2), REGION CHAR(15), R25 NUMBER(8),'||nlchr||
                           'R260_261 NUMBER(8),R2620_NV NUMBER(8),R2620_IN NUMBER(8),'||nlchr||
                           'R2625_NV NUMBER(8),R2625_IN NUMBER(8),R2630_NV NUMBER(8),'||nlchr||
                           'R2630_IN NUMBER(8)';
    l_zpr.rpt_template := '';
    l_zpr.form_proc    := '';
    l_zpr.default_vars := '';
