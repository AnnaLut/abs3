...
PROMPT ===================================================================================== 
prompt ===================================== 
prompt == Довідка про стан рахунку
prompt ===================================== 
...
begin     
   l_zpr.name := 'Довідка про стан рахунку';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.name         := 'Довідка про стан рахунку';
    l_zpr.namef        := 'dov.txt';
    l_zpr.bindvars     := ':sFdat1='''',:Param0=''Реєстр. № кл. (0-всi)'',:Param1=''Маска рахунку (%-всi)'',:Param2=''Виконавець (0-всi)''';
    l_zpr.create_stmt  := '';
...
ORDER BY C.RNK, A.NLS, A.KV';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Довідка про стан рахунку';
