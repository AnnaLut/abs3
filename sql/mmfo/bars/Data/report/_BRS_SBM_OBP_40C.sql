...
PROMPT ===================================================================================== 
prompt ===================================== 
prompt == Сводная в разрезе дат way4
prompt ===================================== 
...
begin     
   l_zpr.name := 'Сводная в разрезе дат way4';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.name         := 'Сводная в разрезе дат way4';
    l_zpr.namef        := '';
    l_zpr.bindvars     := ':sFdat1='''',:sFdat2='''',:p_rnk=''RNK комп.''';
    l_zpr.create_stmt  := '';
  ...
  from (select sum(sa.dos)/100 dos,--сума по всем счетам
               sum(sa.kos)/100 kos,
               sum(fost(w4a.acc_pk, sa.fdat) / 100    --сума всех остатков по счетам на определенный день, с учетом счетов наче 2208,3570
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Сводная в разрезе дат way4';
