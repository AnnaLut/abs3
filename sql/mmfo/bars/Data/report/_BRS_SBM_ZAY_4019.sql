prompt ===================================== 
prompt == Звіт з купівлі іноземної валюти фізичною особою
prompt ===================================== 
...
begin     
   l_zpr.name := 'Звіт з купівлі іноземної валюти фізичною особою';
   l_zpr.pkey := '\BRS\SBM\ZAY\4019';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.create_stmt  := '';
    l_zpr.rpt_template := 'rep_4019.frx';
    l_zpr.form_proc    := '';
...
';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Звіт з купівлі іноземної валюти фізичною особою';
    ...
    if l_isnew = 1 then                        
     ...
     if l_isnewr = 1 then    l_rep.id := 4019;
