prompt ===================================== 
prompt == Друк заяв з купівлі ІВ, що надійшли через Corp2
prompt ===================================== 
...
begin     
   l_zpr.name := 'Друк заяв з купівлі ІВ, що надійшли через Corp2';
   ...
   exception when no_data_found then                       
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Друк заяв з купівлі ІВ, що надійшли через Corp2';
