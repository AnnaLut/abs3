...
begin     
   ...
   exception when no_data_found then                       
    ...
    l_zpr.txt          := 'SELECT
                  ...
                  trim(substr(replace(CASE WHEN dk = 0 THEN  nb  ELSE nb2  END,''"'', ''""''),1,100)) as char03,
                  substr(replace(CASE WHEN dk = 0 THEN  nmk ELSE nmk2 END,''"'', ''""''),1,100) as char04,
                  ...
                  trim(substr(replace(CASE WHEN dk = 1 THEN  nb  ELSE nb2  END,''"'', ''""''),1,100)) as char08,
                  trim(substr(replace(CASE WHEN dk = 1 THEN  nmk ELSE nmk2 END,''"'', ''""''),1,100)) as char09,
                  CASE WHEN dk = 1 THEN okpo ELSE okpo2 END as char10,
                  substr(replace(nazn,''"'', ''""''),1,250) as char11,
                  nls as char12,
