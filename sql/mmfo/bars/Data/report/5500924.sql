prompt ===================================== 
prompt == Зал. та кіль-ть  рах. 2610(5),2651(2) (ТВБВ н.т.)
prompt ===================================== 
...
begin     
   l_zpr.name := 'Зал. та кіль-ть  рах. 2610(5),2651(2) (ТВБВ н.т.)';
   l_zpr.pkey := '\BRS\SBR\DPT\129';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.name         := 'Зал. та кіль-ть  рах. 2610(5),2651(2) (ТВБВ н.т.)';
    l_zpr.namef        := 'my.txt';
    l_zpr.bindvars     := ':zDate=''Звітна дата(DD.MM.YYYY) :'',:nbs=''Бал.рахунки (пусто - всі, ВВВВ,ВВВВ...- окремі):'',:kv=''Валюта (0 або пусто - всі, 1 - всі крім UAH, ККК - код вал.)
 :''';
    l_zpr.create_stmt  := '';
    l_zpr.rpt_template := '';
    l_zpr.form_proc    := '';
