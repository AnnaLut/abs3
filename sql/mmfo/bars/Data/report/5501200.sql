prompt ===================================== 
prompt == погашение по %  проблемн юрики(проблемн)
prompt ===================================== 
...
begin     
   l_zpr.name := 'погашение по %  проблемн юрики(проблемн)';
   l_zpr.pkey := '\zap\SBER\CCK\20';
...
and   ( o.nlsb like ''2068%''  or o.nlsb like ''2078%'') 
