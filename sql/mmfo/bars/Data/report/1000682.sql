...
begin     
 ...
 (select ir  from int_ratn where acc=(select ae.acc from accounts ae, nd_acc nae where ae.acc=nae.acc and NAE.ND=d.nd and ae.tip=''LIM'' ) and id=-2 
  ...
  and a.nbs in (2010, 2020, 2030,  2040, 2045, 2046, 2047, 2050, 2055, 2057, 2061,  2063,  2070, 2071, 2072, 2073, 2074,   2083,  2100,  2103,  2110,  2113,   2123,   2133)
