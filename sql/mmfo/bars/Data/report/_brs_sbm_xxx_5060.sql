prompt =====================================
prompt == Надходження коштів на рахунки НАК Нафтогаз
prompt =====================================
...
'        when :sFdat1=to_date(''01/07/2016'',''dd/mm/yyyy'') and :sFdat2=to_date(''30/06/2017'',''dd/mm/yyyy'') and l=''Кошти 1 рівня пріоритетності: '' then sum(sq)/100+4702017757.73+13128920403.45+1588708217.19+406712.96 '||nlchr||
'        when :sFdat1=to_date(''01/07/2016'',''dd/mm/yyyy'') and :sFdat2=to_date(''30/06/2017'',''dd/mm/yyyy'') and l=''Кошти 2 рівня пріоритетності: '' then sum(sq)/100+ 780117118.43+ 7907877489.75+1677843432.62+244973.40 '||nlchr||
'        when :sFdat1=to_date(''01/10/2016'',''dd/mm/yyyy'') and :sFdat2=to_date(''30/09/2017'',''dd/mm/yyyy'') and l=''Кошти 1 рівня пріоритетності: '' then sum(sq)/100+13128920403.45+1588708217.19+406712.96 '||nlchr||
'        when :sFdat1=to_date(''01/10/2016'',''dd/mm/yyyy'') and :sFdat2=to_date(''30/09/2017'',''dd/mm/yyyy'') and l=''Кошти 2 рівня пріоритетності: '' then sum(sq)/100+ 7907877489.75+1677843432.62+244973.40 '||nlchr||
