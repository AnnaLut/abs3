...
begin
  ...
  l_tabsemantic := 'Область дії договору';
  l_tabname := 'ACCP_SCOPE';
  ...
  bars_metabase.add_column(l_tabid, 1, 'ID', 'N', 'Код ', null, 22, 1, 0, 1, 0, 0, '', '', 0, 0, '', 0, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'TEXT', 'C', 'Опис області дії ', null, 50, 2, 0, 0, 1, 0, '', '', 0, 0, '', 0, 0, 0, '');
