...
begin
  ...
  l_tabsemantic := 'W4. ƒов≥дник груп продукт≥в ‘ќ';
  l_tablinesdef := '';
  l_tabname     := 'V_W4_PRODUCT_GROUPS';
  ...
  bars_metabase.add_column(l_tabid, 1, 'CODE', 'C', ' од групи продукт≥в', null, 32, 1, 1, 1, 0, 0, '', '', 1, 0, '', 0, 0, 0, '', '', 0);
  bars_metabase.add_column(l_tabid, 2, 'NAME', 'C', 'Ќазва', null, 100, 2, 1, 0, 1, 0, '', '', 1, 0, '', 0, 0, 0, '', '', 0);
