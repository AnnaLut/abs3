PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/Applist/codeapp_$RM_WCLR.sql =========*
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  $RM_WCLR ***
  declare
    l_application_code varchar2(10 char) := '$RM_WCLR';
    l_application_name varchar2(300 char) := 'АРМ Кліринг переказів';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_WCLR створюємо (або оновлюємо) АРМ АРМ Кліринг переказів ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_WCLR) - АРМ Кліринг переказів  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp$RM_WCLR.sql =========**
PROMPT ===================================================================================== 
