...
begin
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Довідники NEW ********** ');
	 ...
	 DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Бал.рах+Ob22 для модуля МБДК (Довідник) ********** ');
          --  Створюємо функцію Бал.рах+Ob22 для модуля МБДК (Довідник)
      l := l +1;
      l_function_ids.extend(l);      
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => 'Бал.рах+Ob22 для модуля МБДК (Довідник)',
