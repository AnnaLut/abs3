...
begin
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію КП S7: Амортизація Диск/Прем з ЕПС ********** ');
          --  Створюємо функцію КП S7: Амортизація Диск/Прем з ЕПС
      l := l +1;
      l_function_ids.extend(l);
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => 'КП S7: Амортизація Диск/Прем з ЕПС',
