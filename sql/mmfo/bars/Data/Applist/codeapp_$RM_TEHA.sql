PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/Applist/codeapp_$RM_TEHA.sql =========*
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  $RM_TEHA ***
  declare
    l_application_code varchar2(10 char) := '$RM_TEHA';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_TEHA створюємо (або оновлюємо) АРМ АРМ Регламентні роботи ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Історія зміни банківських днів ********** ');
          --  Створюємо функцію Історія зміни банківських днів
      l := l +1;
      l_function_ids.extend(l);
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => 'Історія зміни банківських днів',
                                                  p_funcname => '/barsroot/opencloseday/openclose/ophistory',
                                                  p_rolename => '' ,
                                                  p_frontend => l_application_type_id
                                                  );


    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію 1.Готовність РУ до зміни банківського дня ********** ');
          --  Створюємо функцію 1.Готовність РУ до зміни банківського дня
      l := l +1;
      l_function_ids.extend(l);
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => '1.Готовність РУ до зміни банківського дня',
                                                  p_funcname => '/barsroot/opencloseday/openclose/opstagedirectory',
                                                  p_rolename => '' ,
                                                  p_frontend => l_application_type_id
                                                  );
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_TEHA) - АРМ Регламентні роботи  ');
   ...
   commit;
umu.add_report2arm(31,'$RM_TEHA');
umu.add_report2arm(61,'$RM_TEHA');
commit;
end;
/
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp$RM_TEHA.sql =========**
PROMPT ===================================================================================== 
