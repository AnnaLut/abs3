...
begin
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Готовність РУ до зміни банківського дня ********** ');
          --  Створюємо функцію Готовність РУ до зміни банківського дня
      l := l +1;
      l_function_ids.extend(l);      
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => 'Готовність РУ до зміни банківського дня',
