PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/Applist/codeapp_$RM_WASK.sql =========*
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  $RM_WASK ***
  declare
    l_application_code varchar2(10 char) := '$RM_WASK';
    l_application_name varchar2(300 char) := 'АРМ Адміністратора депозитних сейфів WEB';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_WASK створюємо (або оновлюємо) АРМ АРМ Адміністратора депозитних сейфів WEB ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_WASK) - АРМ Адміністратора депозитних сейфів WEB  ');
   ...
   commit;
umu.add_report2arm(3997,'$RM_WASK');
umu.add_report2arm(3998,'$RM_WASK');
commit;
end;
/
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp$RM_WASK.sql =========**
PROMPT ===================================================================================== 
