...
begin
   ...
   commit;
umu.add_report2arm(11,'$RM_WCCK');
umu.add_report2arm(18,'$RM_WCCK');
umu.add_report2arm(30,'$RM_WCCK');
umu.add_report2arm(294,'$RM_WCCK');
umu.add_report2arm(415,'$RM_WCCK');
umu.add_report2arm(416,'$RM_WCCK');
umu.add_report2arm(426,'$RM_WCCK');
umu.add_report2arm(429,'$RM_WCCK');
umu.add_report2arm(479,'$RM_WCCK');
umu.add_report2arm(675,'$RM_WCCK');
umu.add_report2arm(786,'$RM_WCCK');
umu.add_report2arm(787,'$RM_WCCK');
umu.add_report2arm(788,'$RM_WCCK');
commit;
end;
/
