...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/Applist/codeapp_$RM_@HDL.sql =========*
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  $RM_@HDL ***
  declare
    l_application_code varchar2(10 char) := '$RM_@HDL';
    l_application_name varchar2(300 char) := 'АРМ Керування подіями';
    ...
    d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_@HDL створюємо (або оновлюємо) АРМ АРМ Керування подіями ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_@HDL) - АРМ Керування подіями  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp$RM_@HDL.sql =========**
PROMPT ===================================================================================== 
