...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/Applist/codeapp_$RM_@UPR.sql =========*
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  $RM_@UPR ***
  declare
    l_application_code varchar2(10 char) := '$RM_@UPR';
    l_application_name varchar2(300 char) := 'АРМ МБДК+FOREX (Перегляд)';
    ...
    d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_@UPR створюємо (або оновлюємо) АРМ АРМ МБДК+FOREX (Перегляд) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_@UPR) - АРМ МБДК+FOREX (Перегляд)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp$RM_@UPR.sql =========**
PROMPT ===================================================================================== 
