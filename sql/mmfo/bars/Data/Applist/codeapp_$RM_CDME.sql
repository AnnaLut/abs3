...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/Applist/codeapp_$RM_CDME.sql =========*
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  $RM_CDME ***
  declare
    l_application_code varchar2(10 char) := '$RM_CDME';
    l_application_name varchar2(300 char) := 'Робота з ЄБК ФОП';
    ...
    d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_CDME створюємо (або оновлюємо) АРМ Робота з ЄБК ФОП ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію АРМ Дедублікації ФОП ********** ');
          --  Створюємо функцію АРМ Дедублікації ФОП
      l := l +1;
      l_function_ids.extend(l);      
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => 'АРМ Дедублікації ФОП',
                                                  p_funcname => '/barsroot/cdm/Deduplicate/Index?type=entrepreneurPerson',
                                                  p_rolename => '' ,    
                                                  p_frontend => l_application_type_id
                                                  );
     

    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію АРМ Якості ФОП ********** ');
          --  Створюємо функцію АРМ Якості ФОП
      l := l +1;
      l_function_ids.extend(l);      
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => 'АРМ Якості ФОП',
                                                  p_funcname => '/barsroot/cdm/Quality/Index?type=entrepreneurPerson',
                                                  p_rolename => '' ,    
                                                  p_frontend => l_application_type_id
                                                  );
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_CDME) - Робота з ЄБК ФОП  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp$RM_CDME.sql =========**
PROMPT ===================================================================================== 
