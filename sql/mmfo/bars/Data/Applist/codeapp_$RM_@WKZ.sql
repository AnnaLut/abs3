...
PROMPT *** Create/replace  ARM  $RM_@WKZ ***
  declare
    l_application_code varchar2(10 char) := '$RM_@WKZ';
    l_application_name varchar2(300 char) := 'АРМ Казначейство (SWIFT)';
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp$RM_@WKZ.sql =========**
PROMPT ===================================================================================== 
