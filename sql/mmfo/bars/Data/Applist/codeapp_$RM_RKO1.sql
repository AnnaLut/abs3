PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/Applist/codeapp_$RM_RKO1.sql =========*
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  $RM_RKO1 ***
  declare
    l_application_code varchar2(10 char) := '$RM_RKO1';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_RKO1 створюємо (або оновлюємо) АРМ АРМ Плата за РО ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_RKO1) - АРМ Плата за РО  ');
   ...
   commit;
umu.add_report2arm(335,'$RM_RKO1');
umu.add_report2arm(380,'$RM_RKO1');
umu.add_report2arm(412,'$RM_RKO1');
commit;
end;
/
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp$RM_RKO1.sql =========**
PROMPT ===================================================================================== 
