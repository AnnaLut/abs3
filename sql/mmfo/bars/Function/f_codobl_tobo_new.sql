 ...
 PROMPT ===================================================================================== 
 PROMPT *** Run *** ========== Scripts /Sql/BARS/function/f_codobl_tobo_new.sql =========*** 
 PROMPT ===================================================================================== 
 
  CREATE OR REPLACE FUNCTION BARS.F_CODOBL_TOBO_NEW (acc_ IN NUMBER, dat_ in date, type_ IN NUMBER DEFAULT 1) RETURN VARCHAR2 IS
 -------------------------------------------------------------------
 -- ¬≈–—»я:  19.03.2013 (20.02.2013, 08.11.2011)
 -------------------------------------------------------------------
 -- 19.03.2013 дл€ type_ = 9 (вместо кода ћ‘ќ=300465) и бал.счета 1004
 --            будем обрабатывать доп.параметр TAG='B040' и из данного
 --            кода формировать код области и код подразделени€
 -- дл€ —Ѕ дл€ кода файла #94 изменим PR_TOBO с 5 на 9
...
/
 ...
 PROMPT ===================================================================================== 
 PROMPT *** End *** ========== Scripts /Sql/BARS/function/f_codobl_tobo_new.sql =========*** 
 PROMPT ===================================================================================== 
