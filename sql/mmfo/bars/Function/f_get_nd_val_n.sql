 ...
 PROMPT ===================================================================================== 
  ...
  CREATE OR REPLACE FUNCTION BARS.F_GET_ND_VAL_N (p_tag varchar2, p_nd integer, p_dat01 date, p_tipa integer, p_RNK INTEGER) RETURN NUMBER is
...
begin
   begin
      execute immediate 'select    nvl(' || p_tag   || ',0) from nd_val
                         ...
                         into l_val_n using p_dat01, p_rnk, p_nd, p_tipa;
