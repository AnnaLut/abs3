...
Insert into BARS.NBUR_REF_FORM_STRU
 ...
 Values
   (16753, 1, NULL, '1-Дт~2-Кт', 'substr(kodp,1,1)', 
    '1', 1);
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 2, NULL, 'Бал.~рах.', 'substr(kodp,2,4)', 
    '1', 2);
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 3, NULL, 'Параметр~R011', 'substr(kodp,6,1)', 
    '1', 3);
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 4, NULL, 'Параметр~R013', 'substr(kodp,7,1)', 
    '1', 4);   
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 5, NULL, 'Код~валюти', 'substr(kodp,8,3)', 
    '1', 5);
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 6, NULL, 'Розподіл~активів~(S580)', 'substr(kodp,11,1)', 
    '1', 6);      
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 7, NULL, 'Код~індексації~(R017)', 'substr(kodp,12,1)', 
    '1', 7);
...
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 8, NULL, 'Валюта~індексації', 'substr(kodp,13,3)', 
   '1', 8);
...
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 9, NULL, 'Код~кінцевого строку~(S245)', 'substr(kodp,16,1)', 
    '1', 9);
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 10, NULL, 'Код~агрегованого сектору~(K077)', 'substr(kodp,17,1)', 
    '1', 10);
...
Insert into BARS.NBUR_REF_FORM_STRU
   (FILE_ID, SEGMENT_NUMBER, SEGMENT_CODE, SEGMENT_NAME, SEGMENT_RULE, 
    KEY_ATTRIBUTE, SORT_ATTRIBUTE)
 Values
   (16753, 11, NULL, 'Значення~показника', 'znap', 
    NULL, NULL);
COMMIT;
