...
declare
    l_app_code varchar2(10 char) := '$RM_MAIN';
    l_app_name varchar2(300 char) := 'АРМ Адміністратора АБС ';
    l_appid number(5);
    l_funcname1 varchar2(250 Byte) := '/barsroot/metaDataAdmin/ReferenceBookAdmin/GetRefBookData?AccessCode=0'||chr(38)||'TableName=META_TABLES'||chr(38)||'code=META_TABLES_INFO';
    l_name1 varchar2(250 Byte) := 'Конструктор бази метеданих';
