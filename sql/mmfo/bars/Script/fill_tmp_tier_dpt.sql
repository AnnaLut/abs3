               ...
               where br.br_id = bte.br_id
                 ...
                 --and br.br_id = 3313
                           ...
                           for x in (select * from bars.int_ratn ir
                                    ...
                                    begin                     
                                     SELECT *  -- выбираем все депозиты, открытые до 28.02.17 и еще не закрытые
                                     into l_dep
                                    ...
                                    exception when others
                                     ...
                                     if not l_dep.deposit_id is null then 
                                       if (l_dep.dat_end is null or l_dep.dat_end > p_Dat) and (l_dep.dat_begin < to_date('28.02.2017', 'DD.MM.YYYY')) and (l_dep.kv = q.kv) then
