...
declare
    l_app_code varchar2(10 char) := 'SWE';
    l_app_name varchar2(300 char) := 'АРМ Звірка переказів';
    l_appid number(5);
    l_funcname1 varchar2(250 Byte) := '/barsroot/SWCompare/SWCompare';
    l_name1 varchar2(250 Byte) := 'Протокол розбіжностей електронних переказів';
