...
after insert or update of p080, ob22, ob88, mfo, r020_fa ON BARS.SPECPARAM_INT
for each row
declare
  l_id number;
begin
  select bars_sqnc.get_nextval('s_specparamintupdate', :new.kf) into l_id from dual;
  if inserting or updating and (
     ...
     insert into specparam_int_update (acc, p080, ob22, ob88, mfo, r020_fa, kf,
         fdat, user_name, idupd)
     values (:new.acc, :new.p080, :new.ob22, :new.ob88, :new.mfo, :new.r020_fa, :new.kf,
