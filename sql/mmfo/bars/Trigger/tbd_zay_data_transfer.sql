...
before delete ON BARS.ZAY_DATA_TRANSFER
for each row
declare
...
begin
  insert into zay_data_transfer_log(id, req_id, url,mfo, transfer_type, transfer_date, transfer_result, comm)
  values(:old.id, :old.req_id, :old.url, :old.mfo, :old.transfer_type, :old.transfer_date, :old.transfer_result, :old.comm);
