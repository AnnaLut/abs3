...
begin
  ...
  then
    ...
    then
      ...
      l_chgaction:= 'I';
      l_idupd 	  := bars_sqnc.get_nextval('s_cclim_update', :new.KF);

    
     BARS_AUDIT.info('CC_LIM_UPDATE IDUPD = '||l_idupd);
    insert into CC_LIM_UPDATE
      ( IDUPD, CHGACTION, EFFECTDATE, CHGDATE, DONEBY,
        ND, FDAT, LIM2, ACC, NOT_9129, SUMG, SUMO, OTM, KF, SUMK, NOT_SN )
    values
