...
COMMENT ON TABLE BARSTRANS.OUT_REQ_PARAMS IS 'Параметри відповіді';
COMMENT ON COLUMN BARSTRANS.OUT_REQ_PARAMS.REQ_ID IS 'Ід підзапиту';
COMMENT ON COLUMN BARSTRANS.OUT_REQ_PARAMS.PARAM_TYPE IS 'Тип параметру (GET, HEAD)';
COMMENT ON COLUMN BARSTRANS.OUT_REQ_PARAMS.TAG IS 'Тег';
COMMENT ON COLUMN BARSTRANS.OUT_REQ_PARAMS.VALUE IS 'Значення';
