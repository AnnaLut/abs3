...
/
-- ***************************************************************************
-- TSK-0001202 В файле UPLSTAT  (выгрузка за 11 октября)  пришли записи с пустым полем PARAMS
-- 
-- ***************************************************************************
...
Insert into UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 ...
 where v.upl_bankdate = to_date (:param1, ''dd/mm/yyyy'')
   ...
   'begin execute immediate ''begin bars.tuda; end;''; exception when others then if sqlcode = -6550 then null; else raise; end if; end;', NULL, 'Статистика', '4.5');
