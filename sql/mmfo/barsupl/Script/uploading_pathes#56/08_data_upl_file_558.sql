...
/
-- ***************************************************************************
-- ETL-20022 - UPL - “далить из выгрузки 5 таблиц
...
Insert into UPL_FILES
 ...
 Values (558, 558, 'CCK_RESTR_HIST', 'ccrestrhist', 0, '09', NULL, '10', 0, 'TEMPORARY (Історія реструктуризацій КД)', 558, 'null', 'WHOLE', 'ARR', 0, NULL, 1, 'ccrestrhist', 1, 1);
