...
-- ETL-22015  UPL - initial upload - 99 группа (arracc2 - дельта + full по W4 (Кравченко О.))
-- ***************************************************************************
...
Insert into BARSUPL.UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values
   ...
   NULL, 'Зв''язок угода-рахунок для виду 2 (БПК w4 + old + РКО + ЦП)', '5.3');
...
Insert into BARSUPL.UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values
   ...
   NULL, 'Зв''язок угода-рахунок для виду 2 (дельта + Full по W4) ММФО', '1.3');
...
Insert into BARSUPL.UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values
   ...
   NULL, 'Зв''язок угода-рахунок для виду 2 (дельта + Full по W4) РУ', '1.3');
