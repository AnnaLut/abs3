...
-- ***************************************************************************
-- ETL-***
-- В выгрузку добавить поле NDG - Реф генерального КД
-- ***************************************************************************
...
l_clob_before:= to_clob('declare
  ...
  l_stmt    varchar2(500);
begin
  -- пока поля CC_DEAL_UPDATE.NDG нет в таблице, используем TEMPORARY TABLE для выгрузки
  begin
...
Insert into BARSUPL.UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values (161, l_clob, l_clob_before, NULL, 'Кредитні угоди + МБДК', '7.1');
...
Insert into BARSUPL.UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values (1161, l_clob, l_clob_before, NULL, 'Кредитні угоди + МБДК', '7.1');
...
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (161, 36, 'NDG', 'Реф генерального КД', 'NUMBER', 38, 0, NULL, NULL, 'Y', NULL, NULL, '0', NULL, 'TRUNC_E2');
