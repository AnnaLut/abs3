...
/
-- ***************************************************************************
-- ETL-22638  UPL - отключить выгрузку файла MIR.SRC_PRVN_SNAT0
-- ***************************************************************************
...
Insert into BARSUPL.UPL_FILES
 ...
 Values (539, 539, 'PRVN_SNA_T0', 'prvn_snat0', 0, '09', NULL, '10', 0, 'НЕвизнані нараховані доходи в розрізі субдоговорів КП (для FineVare)', 7546, 'null', 'DELTA', 'ARR', 0, NULL, 1, 'prvn_snat0', 1, 1);
