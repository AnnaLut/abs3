...
begin
    ...
    g_nbu_url(nbu_object_utl.OBJ_TYPE_PLEDGE)  := 'https://172.22.2.168/cr_reestr/api/pledge';
    g_nbu_url(nbu_object_utl.OBJ_TYPE_LOAN)    := 'https://172.22.2.168/cr_reestr/api/credit';
    -- *app_test
end;
/
