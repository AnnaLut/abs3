...
with a as (select TRANSLATE(TRIM( REGEXP_REPLACE ( REGEXP_REPLACE (UPPER("BARS"."STRTOK"(ADDRESS,',',1)),'^(\,|\.|ок |ок\.|оп |оп\.|опнб |опнб\.|оеп |оеп\.|\оп-й |\оп-й.|опнбскнй |опнбскнй\.|оепескнй |оепескнй\.|бск\.|бск |ск |ск\.|бскхжъ |опняоейр |опняо |опняоейр\.|опняо\.|оп-р |оп-р\.|опр |опр\.)',''),'(\,|\.|\*|\"|\\|\/| а | а\.| асд | асдхмнй |\d)','',3)),'ETYUIOPAHKXCBM','ерсх╡нпюмйуябл') aa,
                  count(*) ncount,
                  ARG.REGION_ID,
                  ARG.REGION_NAME,
                  ADA.AREA_ID,
           ...
           where a.country=804
             ...
             group by  TRANSLATE(TRIM( REGEXP_REPLACE ( REGEXP_REPLACE (UPPER("BARS"."STRTOK"(ADDRESS,',',1)),'^(\,|\.|ок |ок\.|оп |оп\.|опнб |опнб\.|оеп |оеп\.|\оп-й |\оп-й.|опнбскнй |опнбскнй\.|оепескнй |оепескнй\.|бск\.|бск |ск |ск\.|бскхжъ |опняоейр |опняо |опняоейр\.|опняо\.|оп-р |оп-р\.|опр |опр\.)',''),'(\,|\.|\*|\"|\\|\/| а | а\.| асд | асдхмнй |\d)','',3)),'ETYUIOPAHKXCBM','ерсх╡нпюмйуябл'),
                       ARG.REGION_ID,
                       ARG.REGION_NAME,
                       ADA.AREA_ID,
                       ADA.AREA_NAME,
