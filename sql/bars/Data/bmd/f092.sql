...
begin
  ...
  l_tabsemantic := 'Підстава для купівлі/ мета продажу';
  l_tablinesdef := '';
  l_tabname     := 'F092';
  ...
  bars_metabase.add_column(l_tabid, 1, 'D_CLOSE', 'D', 'Дата закриття', null, 10, 5, 1, 0, 0, 0, '', '', 1, 0, '', 0, 0, 1, '', '', 0);
  bars_metabase.add_column(l_tabid, 2, 'D_MODE', 'D', 'Дата модифікації', null, 10, 4, 1, 0, 0, 0, '', '', 1, 0, '', 0, 0, 1, '', '', 0);
  bars_metabase.add_column(l_tabid, 3, 'D_OPEN', 'D', 'Дата відкриття', null, 10, 3, 1, 1, 0, 0, '', '', 1, 0, '', 0, 0, 1, '', '', 0);
  bars_metabase.add_column(l_tabid, 4, 'F092', 'C', 'Показник', null, 3, 1, 1, 1, 0, 0, '', '', 1, 0, '', 0, 0, 1, '', '', 0);
  bars_metabase.add_column(l_tabid, 5, 'TXT', 'C', 'Текстовий опис', null, 250, 2, 1, 0, 1, 0, '', '', 1, 0, '', 0, 0, 1, '', '', 0);
