...
if   l_dl<>4000
 then 
      execute immediate 'alter table OW_OIC_ATRANSFERS_DATA drop column trans_info ';
...
COMMENT ON COLUMN BARS.OW_OIC_ATRANSFERS_DATA.TRANS_INFO IS 'Деталі транзакції';
...
COMMENT ON COLUMN BARS.OW_OIC_ATRANSFERS_DATA.ACCOUNT_2924_016 IS 'рахунок торговця';
