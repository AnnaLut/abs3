...
begin
  ...
  l_tabsemantic := 'Відділення банку';
  l_tablinesdef := '10';
  l_tabname     := 'V_BRANCH_OBU';
  ...
  bars_metabase.add_column(l_tabid, 1, 'BRANCH', 'C', 'Відділення', null, 25, 1, 1, 1, 0, 0, '', '', 1, 0, '', 0, 0, 1, '', '', 0);
  bars_metabase.add_column(l_tabid, 2, 'NAME', 'C', 'Назва відділення', null, 100, 2, 1, 0, 0, 0, '', '', 1, 0, '', 0, 0, 1, '', '', 0);
  bars_metabase.add_column(l_tabid, 3, 'RU_CODE', 'N', 'Код РУ', null, 22, 3, 1, 0, 0, 0, '', '', 1, 0, '', 0, 0, 1, '', '', 0);
  bars_metabase.add_column(l_tabid, 4, 'RU_NAME', 'C', 'Назва РУ', null, 20, 4, 1, 0, 0, 0, '', '', 1, 0, '', 0, 0, 1, '', '', 0);
