prompt ===================================== 
prompt == Актуалізація (у розрізі РУ) за період
prompt ===================================== 
...
begin     
   l_zpr.name := 'Актуалізація (у розрізі РУ) за період';
   l_zpr.pkey := '\BRS\SBER\CRCA\3112';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.name         := 'Актуалізація (у розрізі РУ) за період';
    l_zpr.namef        := '';
    l_zpr.bindvars     := ':sFdat1='''',:sFdat2='''',:p_mfo=''МФО (%-всі)'',:p_status=''Статус операції'',:p_type=''Код операції''';
    l_zpr.create_stmt  := '';
    l_zpr.rpt_template := 'brs_3112.frx';
    l_zpr.form_proc    := '';
 ...
 ------------------------    
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Актуалізація (у розрізі РУ) за період';
