...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARSAQ/Trigger/TU_OPER_GUARD.sql =========*** Run
PROMPT ===================================================================================== 


PROMPT *** Create  trigger TU_OPER_GUARD ***

  CREATE OR REPLACE TRIGGER BARSAQ.TU_OPER_GUARD 
...
exception when err then
  ...
  logger.info('sgn:: ref=' || :new.ref || ', ' || erm);
  raise_application_error(-20000, 'Попытка модификации реквизита '''||erm||''', ref='||:new.ref, true);
end;
/
ALTER TRIGGER BARSAQ.TU_OPER_GUARD ENABLE;


PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARSAQ/Trigger/TU_OPER_GUARD.sql =========*** End
PROMPT ===================================================================================== 
