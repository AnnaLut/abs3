...
----------------------------------------------------------------------
prompt 7. Створення ВЕБ-функцій та включення їх в ВЕБ-Арм $RM_XOZD = АРМ Деб.заборг. за госп. діяльністю банку
@bars\Data\operlist_xoz.sql
@bars\Data\xoz_adm.sql 
-----------------------------------------------------------------------
prompt 8. Наповнення базов. довідників 
@bars\Data\xoz_w4.sql
-----------------------------------------------------------------------
prompt 9. Звіт про куп/прод вал та результат
@bars\Data\report\_brs_sbm_rep_r6204.sql
