create or replace procedure p_transform_forecast_newacc is
...
select * from sec_audit where rec_date > sysdate - 1/48 and rec_message like 'T2017.look_for_notmaped:%' order by rec_id desc
