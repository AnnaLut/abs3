...
begin
    ...
    insert into barsupl.upl_columns (FILE_ID, COL_ID, COL_NAME, COL_DESC, COL_TYPE, COL_LENGTH, COL_SCALE, COL_FORMAT, PK_CONSTR, NULLABLE, NULL_VALUES, REPL_CHARS_WITH, SKELETON_VALUES, PK_CONSTR_ID, PREFUN)
    values (100103, 2, 'deposit_id', 'ID депозиту ', 'NUMBER', 15, 0, null, null, 'Y', null, null, null, null, 'TRUNC_E2');
    ...
    insert into barsupl.upl_columns (FILE_ID, COL_ID, COL_NAME, COL_DESC, COL_TYPE, COL_LENGTH, COL_SCALE, COL_FORMAT, PK_CONSTR, NULLABLE, NULL_VALUES, REPL_CHARS_WITH, SKELETON_VALUES, PK_CONSTR_ID, PREFUN)
    values (100103, 5, 'ref', 'Референс док-та', 'NUMBER', 38, 0, null, null, 'Y', null, null, null, null, 'TRUNC_E2');
	
    insert into barsupl.upl_columns (FILE_ID, COL_ID, COL_NAME, COL_DESC, COL_TYPE, COL_LENGTH, COL_SCALE, COL_FORMAT, PK_CONSTR, NULLABLE, NULL_VALUES, REPL_CHARS_WITH, SKELETON_VALUES, PK_CONSTR_ID, PREFUN)
    values (100103, 6, 'nd', 'Номер документу', 'VARCHAR2', 10, null, null, null, 'Y', null, null, null, null, 'TRUNC_E2');
