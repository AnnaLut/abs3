...
COMMENT ON COLUMN BARSUPL.UPL_TAG_LISTS.ISUSE IS '';
...
begin   
 execute immediate '
  ALTER TABLE BARSUPL.UPL_TAG_LISTS ADD CONSTRAINT FK_UPLTAGLISTS_TAGTABLE FOREIGN KEY (TAG_TABLE)
	  REFERENCES BARSUPL.UPL_TAG_TABLES (TAG_TABLE) ENABLE';
exception when others then
