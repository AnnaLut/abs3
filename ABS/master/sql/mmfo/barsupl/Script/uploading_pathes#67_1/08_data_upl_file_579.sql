...
-- новый довідник перелік допустимих станів, в яких можуть перебувати об''єкти АБС
-- ***************************************************************************
...
Insert into BARSUPL.UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values
  ...
  NULL, 'Довідник перелік допустимих станів, в яких можуть перебувати об''єкти АБС', '1.0');
...
Insert into BARSUPL.UPL_FILES
 ...
 Values
   (579, 579, 'OBJECT_STATE', 'objectstate', 0, '09', NULL, '10', 0, 'Довідник станів об''єктів АБС', 579, 'null', 'WHOLE', 'ARR', 1, NULL, 1, 'objectstate', 1, 0);
...
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (579, 1, 'ID', 'Ідентифікатор стану об''єкту - первинний ключ', 'NUMBER', 38, 0, NULL, 'Y', 'N', NULL, NULL, '0', 1, NULL);
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (579, 2, 'STATE_CODE', 'Код стану об''єкта - унікальний в рамках типу об''єктів', 'VARCHAR2', 300, NULL, NULL, NULL, 'N', NULL, NULL, 'N/A', NULL, NULL);
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (579, 3, 'STATE_NAME', 'Назва стану об''єкта', 'VARCHAR2', 300, NULL, NULL, NULL, 'N', NULL, NULL, 'N/A', NULL, NULL);
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (579, 4, 'IS_ACTIVE', 'Ознака активності стану об''єкта (Y/N)', 'CHAR', 1, NULL, NULL, NULL, 'N', NULL, NULL, '/', NULL, NULL);
