...
Insert into BARSUPL.UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values
  ...
  NULL, 'Довідник типы атрибутов', '1.0');
...
Insert into BARSUPL.UPL_FILES
 ...
 Values
   (578, 578, 'ATTRIBUTE_TYPE', 'attributetype', 0, '09', NULL, '10', 0, 'Довідник типы атрибутов', 578, 'null', 'WHOLE', 'EVENT', 1, NULL, 1, 'attributetype', 1, 0);
...
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (578, 1, 'ID', 'уникальный ключ', 'NUMBER', 38, 0, NULL, NULL, 'N', NULL, NULL, '0', NULL, NULL);
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (578, 2, 'ATTRIBUTE_CODE', 'код атрибута', 'VARCHAR2', 100, NULL, NULL, 'Y', 'N', NULL, NULL, 'N/A', 1, NULL);
Insert into BARSUPL.UPL_COLUMNS (file_id, col_id, col_name, col_desc, col_type, col_length, col_scale, col_format, pk_constr, nullable, null_values, repl_chars_with, skeleton_values, pk_constr_id, prefun)
 Values (578, 3, 'ATTRIBUTE_NAME', 'наименование атрибута', 'VARCHAR2', 300, NULL, NULL, NULL, 'N', NULL, NULL, 'N/A', NULL, NULL);
