...
/
-- ***************************************************************************
-- ETL-20518 UPL - Обеспечить выгрузку файла SKRYNDREF исходя из условий разных политик РУ и ММФО
-- SKRYNKA_ND_REF
...
select 18 type_id, n.nd, n.ref, n.rent, n.branch, n.kf
  ...
  where kf.kf=n.kf', 'begin execute immediate ''begin barsupl.bars_upload_usr.suda; end;''; exception when others then if sqlcode = -6550 then null; else raise; end if; end;',
   'begin barsupl.bars_upload_usr.tuda(null); end;', 'Платіжні документи за угодами оренди депозитних сейфів', '1.2');
