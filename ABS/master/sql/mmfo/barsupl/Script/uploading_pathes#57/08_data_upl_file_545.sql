...
/
-- ***************************************************************************
-- ETL-21239  UPL - Для файла card_loans (545) Установить critical_flg = 1
-- ***************************************************************************
...
Insert into BARSUPL.UPL_FILES
 ...
 Values (545, 545, 'CARD_LOANS', 'card_loans', 0, '09', NULL, '10', 0, 'Договора кредитних лімітів під БПК', 545, 'null', 'DELTA', 'ARR', 1, NULL, 1, 'AR', 1, 1);
