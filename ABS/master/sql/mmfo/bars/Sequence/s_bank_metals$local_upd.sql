...
PROMPT *** Create  sequence S_BANK_METALS$LOCAL_UPD ***
   ...
   CREATE SEQUENCE  BARS.S_BANK_METALS$LOCAL_UPD  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 796913 CACHE 20 NOORDER  NOCYCLE ;
