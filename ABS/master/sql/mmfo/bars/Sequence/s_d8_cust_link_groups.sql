...
PROMPT *** Create  sequence S_D8_CUST_LINK_GROUPS ***
   ...
   CREATE SEQUENCE  BARS.S_D8_CUST_LINK_GROUPS  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 19841 CACHE 20 NOORDER  NOCYCLE ;

PROMPT *** Create  grants  S_D8_CUST_LINK_GROUPS ***
grant SELECT                                                                 on S_D8_CUST_LINK_GROUPS to BARS_ACCESS_DEFROLE;
