...
declare
    l_app_code varchar2(10 char) := '$RM_@BDK';
    l_app_name varchar2(300 char) := 'ÀÐÌ Êàçíà÷åéñòâî (ÌÁÄÊ+FOREX)';
    l_appid number(5);
    l_funcname1 varchar2(250 Byte) := '/barsroot/MBDK/Nostro/Portfolio';
    l_name1 varchar2(250 Byte) := 'Ïîðòôåëü ÍÎÑÒÐÎ-ðàõóíê³â (òåñò)';
