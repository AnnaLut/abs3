PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/Applist/codeapp_$RM_STO1.sql =========*
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  $RM_STO1 ***
  declare
    l_application_code varchar2(10 char) := '$RM_STO1';
    l_application_name varchar2(300 char) := 'АРМ Регулярні платежі';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_STO1 створюємо (або оновлюємо) АРМ АРМ Регулярні платежі ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Виконання регулярних платежів ********** ');
      ...
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  ...
                                                  p_funcname => '/barsroot/ndi/referencebook/GetRefBookData/?tableName=V_STOSCHEDULES_WEB&accessCode=2&sPar=[NSIFUNCTION]',
                                                  p_rolename => '' ,
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_STO1) - АРМ Регулярні платежі  ');
   ...
   commit;
umu.add_report2arm(14000,'$RM_STO1');
commit;
end;
/
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp$RM_STO1.sql =========**
PROMPT ===================================================================================== 
