...
PROMPT *** Create/replace  ARM  $RM_@PPZ ***
  declare
    ...
    l_application_name varchar2(300 char) := 'АРМ "Київ-Дніпровський" та "Укрзалізниця"';
    ...
    d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_@PPZ створюємо (або оновлюємо) АРМ АРМ "Київ-Дніпровський" та "Укрзалізниця" ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_@PPZ) - АРМ "Київ-Дніпровський" та "Укрзалізниця"  ');
