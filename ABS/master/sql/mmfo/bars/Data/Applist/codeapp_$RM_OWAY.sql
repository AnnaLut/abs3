...
begin
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію 2924:Квитовка по сумі ********** ');
          --  Створюємо функцію 2924:Квитовка по сумі
      l := l +1;
      l_function_ids.extend(l);      
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => '2924:Квитовка по сумі',
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію '2924*07*08* Надлишки та Нестачі в АТМ' ********** ');
          --  Створюємо функцію Way4. Імпорт та обробка файлів *.xml
      l := l +1;
      l_function_ids.extend(l);      
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => '2924*07*08* Надлишки та Нестачі в АТМ',
                                                  p_funcname => '/barsroot/ndi/referencebook/GetRefBookData/?accessCode=1'||chr(38)||'sPar=V_ATMREF0[NSIFUNCTION][showDialogWindow=>false]',
                                                  p_rolename => '' ,    
                                                  p_frontend => l_application_type_id
                                                  );
