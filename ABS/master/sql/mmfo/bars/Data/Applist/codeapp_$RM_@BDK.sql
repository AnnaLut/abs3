...
begin
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію НОСТРО-рахунки. Портфель Дог. ********** ');
      ...
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  ...
                                                  p_funcname => '/barsroot/ndi/referencebook/GetRefBookData/?accessCode=0&sPar=NOSTRO_DEAL[NSIFUNCTION][EDIT_MODE=>MULTI_EDIT,CARRIAGE_RALLBACK][SAVE_COLUMNS=>BY_DEFAULT]',
                                                  p_rolename => 'RCC_DEAL' ,
                                                  p_frontend => l_application_type_id
                                                  );
