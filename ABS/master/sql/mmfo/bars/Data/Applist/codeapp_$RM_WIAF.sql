...
begin
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу ($RM_WIAF) - АРМ Страхування ФО (Адміністратор)  ');
	...
	DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Додаємо довідники до даного АРМу ($RM_WIAF) - АРМ Страхування ФО (Адміністратор)  ');
	
	UMU.ADD_REFERENCE2ARM_BYTABNAME ('INS_TYPES',     '$RM_WIAF', 2, 1);
    UMU.ADD_REFERENCE2ARM_BYTABNAME ('INS_EWA_TYPES', '$RM_WIAF', 2, 1);
