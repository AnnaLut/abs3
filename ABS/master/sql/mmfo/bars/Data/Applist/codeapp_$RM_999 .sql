...
PROMPT *** Create/replace  ARM  $RM_999  ***
  declare
    ...
    l_application_name varchar2(300 char) := 'АРМ Закриття фінансового року';
    ...
    d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' $RM_999  створюємо (або оновлюємо) АРМ АРМ Закриття фінансового року ');
