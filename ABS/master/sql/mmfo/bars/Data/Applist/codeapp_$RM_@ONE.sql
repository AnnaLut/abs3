...
begin
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію 1-3. Вилучити НЕоброблений файл з протоколу ********** ');
      ...
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => '1-3. Вилучити НЕоброблений файл з протоколу',
                                                  p_funcname => '/barsroot/ndi/referencebook/GetRefBookData/?accessCode=1&sPar=MONEXRI[PROC=>monex.DEL_FILE(:D,:N)][PAR=>:D(SEM=За dd.mm.yyyy>,TYPE=D),:N(SEM=Код по НБУ,TYPE=S,REF=MONEX_NBU)][EXEC=>BEFORE][MSG=>OK!]',
