...
begin  
  ...
  NBUR_FILES.SET_FILE( 
                        ...
                        , p_file_nm          => Substr('(xml) '||r_file.FILE_NAME, 1, 70)
                        , p_file_fmt         => 'XML'
  ...
  ( 
    p_file_id => l_file_id
    , p_obj_id => nbur_objects.f_get_object_id_by_name(p_object_name => 'NBUR_DM_TRANSACTIONS')
  ...
  ( 
    p_file_id => l_file_id
    , p_obj_id  => nbur_objects.f_get_object_id_by_name(p_object_name => 'NBUR_DM_ADL_DOC_RPT_DTL')
    , p_strt_dt => date '2015-01-01'
  );
