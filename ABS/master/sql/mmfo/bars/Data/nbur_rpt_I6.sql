...
begin
  ...
  , p_file_nm          => '(xml) I6X Дані про процентні ставки за непогашеними сумами депозитів (за класифікаціями видів депозитів та контрагентів)'
  , p_file_fmt         => 'XML'
...
begin
    delete from NBUR_REF_PREPARE_XML WHERE FILE_CODE in ('#I6'); 
