prompt ===================================== 
prompt == SBER. Кол-во и суммы открытых счетов.
prompt ===================================== 
...
begin     
   l_zpr.name := 'SBER. Кол-во и суммы открытых счетов.';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.txt          := 'select br.branch, :kv "Код валюты",
         nvl(a1.k_vo,0) "Кол-во 2620",nvl(a1.ost,0) "Остаток 2620", 
         nvl(a2.k_vo,0) "Кол-во 2625",nvl(a2.ost,0) "Остаток 2625",
         nvl(a3.k_vo,0) "Кол-во 2630",nvl(a3.ost,0) "Остаток 2630"
