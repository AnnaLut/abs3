PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/_BRS_SBER_CRNV_953.sql =========*** Run
PROMPT ===================================================================================== 
prompt ===================================== 
prompt == Список вкладів, переданих в ЦРНВ
prompt ===================================== 
...
begin     
   l_zpr.name := 'Список вкладів, переданих в ЦРНВ';
   l_zpr.pkey := '\BRS\SBER\CRNV\953';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.create_stmt  := '';
    l_zpr.rpt_template := 'CRNV953.frx';
    l_zpr.form_proc    := '';
    l_zpr.default_vars := '';
    l_zpr.bind_sql     := '';
    ...
    l_zpr.txt          := 'SELECT  rownum, S.* FROM '||nlchr||
                           ...
                           '    a.kv, '||nlchr||
                           '    case a.source when ''BARS'' then ''БАРС'' when ''АСВО'' then ''АСВО'' else ''Інше'' end source, '||nlchr||
                           '    a.fio,'||nlchr||
                           '    a.branch, '||nlchr||
                           '    a.nd,'||nlchr||
                           ...
                           'ORDER BY SOURCE, A.KV, A.FIO'||nlchr||
                           ') S';
    l_zpr.xsl_data     := '';
    l_zpr.xsd_data     := '';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Список вкладів, переданих в ЦРНВ';
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/_BRS_SBER_CRNV_953.sql =========*** End
PROMPT ===================================================================================== 
