prompt ===================================== 
prompt == БПК. Прострочена заборгованість.
prompt ===================================== 
...
begin     
   l_zpr.name := 'БПК. Прострочена заборгованість.';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.txt          := 'select nvl(a1.branch,a2.branch) branch,nvl(a1.kv,a2.kv) kv,nvl(a1.ost_beg,0)/100 "фо", nvl(a2.ost_beg,0)/100 "юо"
from 
