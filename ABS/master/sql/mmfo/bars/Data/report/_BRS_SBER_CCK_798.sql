...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/_BRS_SBER_CCK_798.sql =========*** Run 
PROMPT ===================================================================================== 
prompt ===================================== 
...
begin     
   ...
   exception when no_data_found then                       
    ...
    l_zpr.txt          := 'select rownum as rn,
       ...
       nullif((select NAME from V_STTYPE where id = cck_app.Get_ND_TXT(d.nd,''SQBA3'') and cck_app.Get_ND_TXT(d.nd,''SQBA3'')=1 and  cck_app.Get_ND_TXT(d.nd,''SQBA1'') = ''Району'')||chr(13)||chr(10), chr(13)||chr(10))||
       ...
       (select NAME from V_STTYPE where id = cck_app.Get_ND_TXT(d.nd,''SQDA3'')and cck_app.Get_ND_TXT(d.nd,''SQDA3'')=1 and cck_app.Get_ND_TXT(d.nd,''SQCA1'') = ''Району'') typecom,
       case when  cck_app.Get_ND_TXT(d.nd,''SQBA1'') = ''Району'' then cck_app.Get_ND_TXT(d.nd,''SQBA1'')
            when  cck_app.Get_ND_TXT(d.nd,''SQCA1'') = ''Району'' then cck_app.Get_ND_TXT(d.nd,''SQCA1'')
            when  cck_app.Get_ND_TXT(d.nd,''SQDA1'') = ''Району'' then cck_app.Get_ND_TXT(d.nd,''SQDA1'')
            end zalcom,
       case when  cck_app.Get_ND_TXT(d.nd,''SQBA1'') = ''Району'' then cck_app.Get_ND_TXT(d.nd,''SQBA2'')
...
exec umu.add_report2arm(798,'$RM_DRU1');
commit;


PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/_BRS_SBER_CCK_798.sql =========*** End 
PROMPT ===================================================================================== 
