prompt ===================================== 
prompt == Звіт про формування резерву за доходами (в розрізі RNK)
prompt ===================================== 
...
begin     
   l_zpr.name := 'Звіт про формування резерву за доходами (в розрізі RNK)';
   l_zpr.pkey := '\BRS\SBM\OTC\4009';
