...
'||nlchr||
  ...
  C15.CNT substr_IN
FROM
  (SELECT COUNT(*) CNT FROM ACCOUNTS WHERE NBS LIKE ''25%'' AND NBS NOT LIKE ''25_8'' AND (DAZS IS NULL or dazs>:Param0) AND KV=980 AND DAOS<=:Param0) C1,
  (SELECT COUNT(*) CNT FROM ACCOUNTS WHERE NBS LIKE ''25%'' AND NBS NOT LIKE ''25_8'' AND (DAZS IS NULL or dazs>:Param0) and kv<>980 AND DAOS<=:Param0) C2,
  ...
  (SELECT COUNT(a.acc) CNT FROM ACCOUNTS a, specparam_int s WHERE a.NBS =''2620'' AND a.KV=980 AND (a.DAZS IS NULL or a.dazs>:Param0) and s.acc=a.acc and s.ob22 in (04,15) AND DAOS<=:Param0) C5,
  ...
  (SELECT COUNT(*) CNT FROM ACCOUNTS WHERE (((NBS like ''260%'' OR NBS like ''265%'') and pap=2) OR NBS =''2640'' OR NBS =''2641'' OR NBS =''2642'' OR NBS =''2643'' OR NBS =''2650'')  AND KV=980 AND (DAZS IS NULL or dazs>:Param0) AND DAOS<=:Param0) C12,
  (SELECT COUNT(*) CNT FROM ACCOUNTS WHERE (((NBS like ''260%'' OR NBS like ''265%'') and pap=2) OR NBS =''2640'' OR NBS =''2641'' OR NBS =''2642'' OR NBS =''2643'' OR NBS =''2650'')  AND KV<>980 AND (DAZS IS NULL or dazs>:Param0) AND DAOS<=:Param0) C13,
  (SELECT COUNT(*) CNT FROM ACCOUNTS WHERE (NBS =''2610'' OR NBS =''2611'' OR NBS =''2651'')  AND KV=980 AND (DAZS IS NULL or dazs>:Param0) AND DAOS<=:Param0) C14,
  (SELECT COUNT(*) CNT FROM ACCOUNTS WHERE (NBS =''2610'' OR NBS =''2611'' OR NBS =''2651'')  AND KV<>980 AND (DAZS IS NULL or dazs>:Param0) AND DAOS<=:Param0) C15';
    l_zpr.xsl_data     := '';
    l_zpr.xsd_data     := '';
