...
PROMPT ===================================================================================== 
prompt ===================================== 
prompt == Виписки в розрізі дат ГРН. (позасистемні рахунки)
prompt ===================================== 
...
begin     
   l_zpr.name := 'Виписки в розрізі дат ГРН. (позасистемні рахунки)';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.bindvars     := ':sFdat1='''',:sFdat2='''',:Param0=''Маска рахунку (%-всi)'',:BRANCH=''Вiддiлення'',:DEP=''Вкл. пiдлеглих (1-вкл.)'',:INFORM=''Вкл. iнф.повiдомл.(1-вкл.)'',:ISP=''Виконавець рах.(0-всi)'',:NODOCS=''Вкл. без оборотiв (1-вкл.)'',:SRT=''Сортувати по''';
    l_zpr.create_stmt  := '';
    ...
    l_zpr.default_vars := ':Param0=''%'',:BRANCH=''Поточне'',:DEP=''1'',:INFORM=''0'',:ISP=''0'',:NODOCS=''0'',:SRT=''датi''';
...
order by nls, kv, fdat, srt, dksrt, vobsrt, paydate, ref, bis,  fdat';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Виписки в розрізі дат ГРН. (позасистемні рахунки)';
