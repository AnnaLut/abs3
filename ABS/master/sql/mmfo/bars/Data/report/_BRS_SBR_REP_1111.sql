...
begin     
   ...
   exception when no_data_found then                       
    ...
    l_zpr.name         := '7.ВИК: Зведення документiв дня - РЕЄСТР проводок  (Папки,Бранчi+)';
    l_zpr.namef        := '';
    l_zpr.bindvars     := ':sFdat1='''',:TEMA=''Код папки (0-всі)'',:BRANCH=''Відділення (%-всі)'',:PRN=''Перегляд-0,Папки бух_облік-1,Папка(26,27)-2,Папка(38,39)-3,Папки бек-офіс-4'',:ISP=''Вик.''';
    l_zpr.create_stmt  := '';
