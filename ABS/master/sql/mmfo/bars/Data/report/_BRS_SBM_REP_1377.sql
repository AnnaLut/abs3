prompt ===================================== 
prompt == ЗДК: ТВБВ: Реєстр операцій (валюта) (3)
prompt ===================================== 
...
begin     
   l_zpr.name := 'ЗДК: ТВБВ: Реєстр операцій (валюта)';
   l_zpr.pkey := '\BRS\SBM\REP\1377';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.id           := 1;
    l_zpr.name         := 'ЗДК: ТВБВ: Реєстр операцій (валюта) (3)';
    l_zpr.namef        := '=''ZD3_5''||substr(:sFdat1,1,2)||substr(:sFdat1,4,2)||''.''||user_id';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='ЗДК: ТВБВ: Реєстр операцій (валюта) (3)';
   ...
   umu.add_report2arm(  p_report_id => 1377,
                        p_arm_code  => '$RM_WDOC',
                        p_approve   => 1);
