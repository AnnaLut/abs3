prompt ===================================== 
prompt == ГРЦ Количество счетов по классам (rahun.dbf) (new)
prompt ===================================== 
...
begin     
   l_zpr.name := 'ГРЦ Количество счетов по классам (rahun.dbf) (new)';
   l_zpr.pkey := '\BRS\SBER\***\45';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.create_stmt  := 'KU NUMBER(2), REGION CHAR(15),'||nlchr||
                           'Bud_NV NUMBER(8),'||nlchr||
                           'Bud_IN NUMBER(8),'||nlchr||
                           ...
                           'Fizstr_IN NUMBER(8),'||nlchr||
                           'Subpot_NV NUMBER(8),'||nlchr||
                           'Subpot_IN NUMBER(8),'||nlchr||
                           'Substr_NV NUMBER(8),'||nlchr||
                           'Substr_IN NUMBER(8)';
    l_zpr.rpt_template := '';
    l_zpr.form_proc    := '';
    l_zpr.default_vars := '';
