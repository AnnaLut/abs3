prompt ===================================== 
prompt == 423/Депозити ФО за % ст. на місяць, в тис (бранчi)
prompt ===================================== 
...
begin     
   l_zpr.name := '423/Депозити ФО за % ст. на місяць, в тис (бранчi)';
   l_zpr.pkey := '\BRS\***\ANI\59b';
...
WHERE a.kv=t.KV  and r.branch = :BRANCH 
ORDER BY  a.kv , a.IR  
  ';
    l_zpr.xsl_data     := '';
    l_zpr.xsd_data     := '';
