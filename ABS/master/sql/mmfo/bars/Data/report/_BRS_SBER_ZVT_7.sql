...
PROMPT ===================================================================================== 
prompt ===================================== 
prompt == 7.МФО: Зведення документiв дня - РЕЄСТР проводок  (Папки,Бранчi+)
prompt ===================================== 
...
begin     
   l_zpr.name := '7.МФО: Зведення документiв дня - РЕЄСТР проводок  (Папки,Бранчi+)';
   l_zpr.pkey := '\BRS\SBER\ZVT\7';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.name         := '7.МФО: Зведення документiв дня - РЕЄСТР проводок  (Папки,Бранчi+)';
    l_zpr.namef        := '';
    l_zpr.bindvars     := ':sFdat1=''За дату'',:TEMA=''Код папки (0-всі)'',:BRANCH=''Відділення (%-всі)'',:PRN=''Перегляд-0,Папки бух_облік-1,Папка(26,27)-2,Папка(38,39)-3,Папки бек-офіс-4'',:Param3=''Виконавець (0-всі)'' ';
    l_zpr.create_stmt  := '';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='7.МФО: Зведення документiв дня - РЕЄСТР проводок  (Папки,Бранчi+)';
