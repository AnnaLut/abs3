prompt ===================================== 
prompt == Друк заяв з продажу ІВ, що надійшли через Corp2
prompt ===================================== 
...
begin     
   l_zpr.name := 'Друк заяв з продажу ІВ, що надійшли через Corp2';
   l_zpr.pkey := '\BRS\SBR\BIR\4015';
   ...
   exception when no_data_found then                       
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Друк заяв з продажу ІВ, що надійшли через Corp2';
