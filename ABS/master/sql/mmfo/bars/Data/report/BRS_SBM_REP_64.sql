...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/_BRS_SBM_REP_64.sql =========*** Run **
PROMPT ===================================================================================== 
prompt ===================================== 
prompt == ЗДК: Касир: Касовий журнал
prompt ===================================== 
...
begin     
   l_zpr.name := 'ЗДК: Касир: Касовий журнал';
   l_zpr.pkey := '\BRS\SBM\REP\64';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.form_proc    := 'bars_cash.make_report_data( to_date(:sFdat1), :SHIFT, user_id,0, ''CJ'')';
...
order by substr(nls,1,1),  flg, dk,  isdptdoc,  kv, tt , nls';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='ЗДК: Касир: Касовий журнал';
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/_BRS_SBM_REP_64.sql =========*** End **
PROMPT ===================================================================================== 
