...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/_BRS_SBM_REP_76.sql =========*** Run **
PROMPT ===================================================================================== 
prompt ===================================== 
...
begin     
   ...
   exception when no_data_found then                       
    ...
    l_zpr.txt          := 'select  flg, :SHIFT shift,  to_number(substr(nls,1,1)) nlstype,'||nlchr||
                           ...
                           '            to_char(stime,''hh24:mi'') stime,  to_char(etime,''hh24:mi'') etime  '||nlchr||
                           ' from  ('||nlchr||
...
exec umu.add_report2arm(331,'$RM_BUHG');
exec umu.add_report2arm(331,'$RM_WDOC');
exec umu.add_report2arm(331,'$RM_DRU1');
exec umu.add_report2arm(331,'$RM_MAIN');
exec umu.add_report2arm(331,'$RM_BVBB');
commit;


PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/_BRS_SBM_REP_76.sql =========*** End **
PROMPT ===================================================================================== 
