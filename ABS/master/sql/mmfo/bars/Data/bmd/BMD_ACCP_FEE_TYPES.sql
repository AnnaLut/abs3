...
begin
  ...
  l_tabsemantic := 'Тип комісії';
  l_tabname     := 'ACCP_FEE_TYPES';
  ...
  bars_metabase.add_column(l_tabid, 1, 'FEE_TYPE_DESC', 'C', 'Опис', null, 500, null, 1, 0, 1, 0, '', '', 1, 0, '', 0, 0, 1, '');
  bars_metabase.add_column(l_tabid, 2, 'FEE_TYPE_ID', 'N', 'Тип', null, 22, 1, 1, 1, 0, 0, '', '', 1, 0, '', 0, 0, 1, '');
