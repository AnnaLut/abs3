...
begin
  ...
  l_tabsemantic := 'ѕор€док зн€тт€ ком≥с.винагороди  ';
  l_tabname := 'ACCP_ORDER_FEE';
  ...
  bars_metabase.add_column(l_tabid, 1, 'ID', 'N', ' од  ', null, 22, 1, 0, 1, 0, 0, '', '', 0, 0, '', 0, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'TEXT', 'C', 'ќпис пор€дку', null, 50, 2, 0, 0, 1, 0, '', '', 0, 0, '', 0, 0, 0, '');
