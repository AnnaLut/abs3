...
prompt Наименование операции: D: Стягнення недост.суми при дострок.розірванні вкладу
declare
  cnt_  number;
begin
  --------------------------------
