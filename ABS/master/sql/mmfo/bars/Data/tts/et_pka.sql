...
prompt Наименование операции: PKA-Витрати банку на відрядження (в Грн)
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('PKA', 'PKA-Витрати банку на відрядження (в Грн)', 1, null, 980, '#(bpk_get_transit(''10'',#(NLSA),#(NLSB),#(KVA)))', 980, null, null, null, null, 1, 0, 0, 0, null, null, null, null, null, null, '1000100000000000000000000000000000010000000000000000000000000000', 'Поповнення картрахунку');
  exception
    when dup_val_on_index then 
      update tts
         set tt='PKA', name='PKA-Витрати банку на відрядження (в Грн)', dk=1, nlsm=null, kv=980, nlsk='#(bpk_get_transit(''10'',#(NLSA),#(NLSB),#(KVA)))', kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=1, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1000100000000000000000000000000000010000000000000000000000000000', nazn='Поповнення картрахунку'
       where tt='PKA';
  end;
  --------------------------------
  ----------- Реквизиты ----------
