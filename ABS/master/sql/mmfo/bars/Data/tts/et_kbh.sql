...
prompt Наименование операции: KBH off DPT - Виплата відсотків в інш.банк
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('KBH', 'KBH off DPT - Виплата відсотків в інш.банк', 1, null, 980, '#(get_proc_nls(''T00'',#(KVA)))', 980, null, null, null, null, 0, 1, 0, 0, null, null, null, null, null, null, '0201100000000000000000000000000000010000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='KBH', name='KBH off DPT - Виплата відсотків в інш.банк', dk=1, nlsm=null, kv=980, nlsk='#(get_proc_nls(''T00'',#(KVA)))', kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=1, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0201100000000000000000000000000000010000000000000000000000000000', nazn=null
       where tt='KBH';
  end;
  --------------------------------
  ----------- Реквизиты ----------
