...
prompt Наименование операции: ЦП: Відправка МБ вал
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('FXC', 'ЦП: Відправка МБ вал', 1, null, null, '39293003', null, null, null, null, null, 0, 2, 0, 0, null, null, null, null, null, null, '0000000000000000000000000000000000010000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='FXC', name='ЦП: Відправка МБ вал', dk=1, nlsm=null, kv=null, nlsk='39293003', kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=2, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000000000000000000000000000000000010000000000000000000000000000', nazn=null
       where tt='FXC';
  end;
  --------------------------------
  ----------- Реквизиты ----------
