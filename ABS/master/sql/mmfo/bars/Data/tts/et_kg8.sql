...
prompt Наименование операции: KG8 (доч.CG8) Комісія за прийом переказу по системі "MoneyGram"
declare
  cnt_  number;
begin
  --------------------------------
