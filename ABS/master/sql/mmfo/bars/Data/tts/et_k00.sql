...
prompt Наименование операции: K00 К00 Комісія від часу виконання операції
declare
  cnt_  number;
begin
  --------------------------------
