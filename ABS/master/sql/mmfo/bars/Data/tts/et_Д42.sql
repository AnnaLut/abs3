...
prompt Наименование операции: Д42 ВИДАЧА ГОТІВКИ. Видача відсотків по вкладах
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('Д42', 'Д42 ВИДАЧА ГОТІВКИ. Видача відсотків по вкладах', 0, null, null, null, null, null, '#(BRANCH_USR.GET_BRANCH_PARAM2(''CASH'',0))', null, null, 0, 0, 0, 0, null, null, null, null, null, null, '1100100002000000000000000000000000000000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='Д42', name='Д42 ВИДАЧА ГОТІВКИ. Видача відсотків по вкладах', dk=0, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa='#(BRANCH_USR.GET_BRANCH_PARAM2(''CASH'',0))', nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1100100002000000000000000000000000000000000000000000000000000000', nazn=null
       where tt='Д42';
  end;
  --------------------------------
  ----------- Реквизиты ----------
