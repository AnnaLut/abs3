...
prompt Наименование операции: DMB Первинний внесок на вклад з поточного рах.клієнта (внутр.)
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('DMB', 'DMB Первинний внесок на вклад з поточного рах.клієнта (внутр.)', 0, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, 0, '0000100000000000000000000000000000010000000000000000000000000000', 'Внесення банківських металів згідно договору #{DPT_WEB.F_NAZN(''U'',#(ND))}');
  exception
    when dup_val_on_index then 
      update tts
         set tt='DMB', name='DMB Первинний внесок на вклад з поточного рах.клієнта (внутр.)', dk=0, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=0, flags='0000100000000000000000000000000000010000000000000000000000000000', nazn='Внесення банківських металів згідно договору #{DPT_WEB.F_NAZN(''U'',#(ND))}'
       where tt='DMB';
  end;
  --------------------------------
  ----------- Реквизиты ----------
