...
begin
  ...
  begin
    ...
    values ('IF3', 'IF3-Рекласифікація активів на 01.04.2018', 0, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '1101101000000000000000000001000000010000000000000000000000000000', 'Рекласифікація');
  exception
    when dup_val_on_index then 
      update tts
         set tt='IF3', name='IF3-Рекласифікація активів на 01.04.2018', dk=0, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1101101000000000000000000001000000010000000000000000000000000000', nazn='Рекласифікація'
       where tt='IF3';
  end;
  --------------------------------
  ------ Связанные операции ------
