...
prompt Наименование операции: CGM (доч.CG6) Комісія агента за прийом переказу по системі "MoneyGram"
declare
  cnt_  number;
begin
  --------------------------------
