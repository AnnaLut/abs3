...
prompt Наименование операции: EW2 d: Прийом готівки
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('EW2', 'EW2 d: Прийом готівки', 1, '#(BRANCH_USR.GET_BRANCH_PARAM2(''CASH'',0))', null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, 32, null, null, null, '0000100001000000000001000000000000000100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='EW2', name='EW2 d: Прийом готівки', dk=1, nlsm='#(BRANCH_USR.GET_BRANCH_PARAM2(''CASH'',0))', kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=32, proc=null, s3800=null, rang=null, flags='0000100001000000000001000000000000000100000000000000000000000000', nazn=null
       where tt='EW2';
  end;
  --------------------------------
  ----------- Реквизиты ----------
