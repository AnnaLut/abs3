...
prompt Наименование операции: off DPT - Первинний внесок з поточ. рах.
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('KBE', 'off DPT - Первинний внесок з поточ. рах.', 0, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0001100000000000000000000000000000010000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='KBE', name='off DPT - Первинний внесок з поточ. рах.', dk=0, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0001100000000000000000000000000000010000000000000000000000000000', nazn=null
       where tt='KBE';
  end;
  --------------------------------
  ----------- Реквизиты ----------
