...
begin
  ...
  begin
    ...
    values ('SM6', 'Сплата комісії за перерахування платежів з оплати ком.послуг', 1, '#(bpk_get_transit(''20'',#(NLSB),#(NLSA),#(KVA)))', null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0000100000000000000000000010000000000010000000000000000000000000', 'Сплата комісії за перерахування платежів з оплати ком.послуг');
  exception
    when dup_val_on_index then 
      update tts
         set tt='SM6', name='Сплата комісії за перерахування платежів з оплати ком.послуг', dk=1, nlsm='#(bpk_get_transit(''20'',#(NLSB),#(NLSA),#(KVA)))', kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000100000000000000000000010000000000010000000000000000000000000', nazn='Сплата комісії за перерахування платежів з оплати ком.послуг'
       where tt='SM6';
  end;
  --------------------------------
  ----------- Реквизиты ----------
