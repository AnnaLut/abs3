...
begin
  ...
  begin
    ...
    values ('052', '052 Комісія банку за операціями по системі "Vigo"', 1, '#(nbs_ob22 (''2909'',''31''))', null, '#(nbs_ob22 (''6510'',''76''))', 980, null, '#(nbs_ob22 (''2909'',''31''))', '#(nbs_ob22 (''6510'',''76''))', null, 0, 0, 1, 0, null, null, null, null, '#(nbs_ob22 (''3800'',''03''))', null, '0000100000000000000000000001000000000000000000000000000000000000', 'Комісія банку за операціями по системі "Vigo"');
  exception
    when dup_val_on_index then 
      update tts
         set tt='052', name='052 Комісія банку за операціями по системі "Vigo"', dk=1, nlsm='#(nbs_ob22 (''2909'',''31''))', kv=null, nlsk='#(nbs_ob22 (''6510'',''76''))', kvk=980, nlss=null, nlsa='#(nbs_ob22 (''2909'',''31''))', nlsb='#(nbs_ob22 (''6510'',''76''))', mfob=null, flc=0, fli=0, flv=1, flr=0, s=null, s2=null, sk=null, proc=null, s3800='#(nbs_ob22 (''3800'',''03''))', rang=null, flags='0000100000000000000000000001000000000000000000000000000000000000', nazn='Комісія банку за операціями по системі "Vigo"'
       where tt='052';
  end;
  --------------------------------
  ----------- Реквизиты ----------
