...
prompt Наименование операции: DPZ Стягнення недост.суми при частковій виплаті зі вкладу
declare
  cnt_  number;
begin
  --------------------------------
