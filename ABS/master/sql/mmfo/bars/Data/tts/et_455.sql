...
prompt Наименование операции: 455 Страх плат по договорах добровільного страх фін ризиків за опер з 
declare
  cnt_  number;
begin
  --------------------------------
