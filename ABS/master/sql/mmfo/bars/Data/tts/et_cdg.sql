...
prompt Наименование операции: CDG (доч.CDA) Комісія агента за прийом переказу WU/РФ/ком(Терміновий)
declare
  cnt_  number;
begin
  --------------------------------
