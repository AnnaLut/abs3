...
prompt Наименование операции: DU4 Погашення депозиту (міжбанк)
declare
  cnt_  number;
begin
  --------------------------------
