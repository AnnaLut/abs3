...
prompt Наименование операции: ЦП1 ДЦП - внутрішні
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('ЦП1', 'ЦП1 ДЦП - внутрішні', 1, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0000000000000000000000000000000000010000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='ЦП1', name='ЦП1 ДЦП - внутрішні', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000000000000000000000000000000000010000000000000000000000000000', nazn=null
       where tt='ЦП1';
  end;
  --------------------------------
  ----------- Реквизиты ----------
