...
prompt Наименование операции: Розподіл сум для компенсаційних вкладів
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('TK ', 'Розподіл сум для компенсаційних вкладів', 1, null, null, null, null, null, null, '2906401201', null, 0, 0, 0, 0, null, null, null, null, null, null, '0000000000000000000000000000000000000100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='TK ', name='Розподіл сум для компенсаційних вкладів', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb='2906401201', mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000000000000000000000000000000000000100000000000000000000000000', nazn=null
       where tt='TK ';
  end;
  --------------------------------
  ----------- Реквизиты ----------
