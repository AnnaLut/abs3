...
begin
  ...
  begin
    ...
    values ('RSM', 'RSM ѕерерахуванн¤ кошт?в на користь  л?Їнт?в (зовн?шн?й)', 1, null, null, '#(get_proc_nls(''T00'', NVL ( #(KVA), 980 ) ) )', null, null, null, null, null, 1, 1, 0, 0, null, null, null, null, null, null, '0201100000000000000000000000000000000100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='RSM', name='RSM ѕерерахуванн¤ кошт?в на користь  л?Їнт?в (зовн?шн?й)', dk=1, nlsm=null, kv=null, nlsk='#(get_proc_nls(''T00'', NVL ( #(KVA), 980 ) ) )', kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=1, fli=1, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0201100000000000000000000000000000000100000000000000000000000000', nazn=null
       where tt='RSM';
  end;
  --------------------------------
  ----------- –еквизиты ----------
