...
prompt Наименование операции: K16 d: розрахунки за прийняті перекази по системі "Швидка копійка"
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('K16', 'K16 d: розрахунки за прийняті перекази по системі "Швидка копійка"', 1, null, 980, '373910300465', 980, null, null, null, null, 0, 0, 0, 0, null, null, 5, null, null, null, '0000100000000000000000000000000000000100000000000000000000000000', 'розрахунки за прийняті перекази по системі "Швидка копійка"');
  exception
    when dup_val_on_index then 
      update tts
         set tt='K16', name='K16 d: розрахунки за прийняті перекази по системі "Швидка копійка"', dk=1, nlsm=null, kv=980, nlsk='373910300465', kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=5, proc=null, s3800=null, rang=null, flags='0000100000000000000000000000000000000100000000000000000000000000', nazn='розрахунки за прийняті перекази по системі "Швидка копійка"'
       where tt='K16';
  end;
  --------------------------------
  ----------- Реквизиты ----------
