...
prompt Наименование операции: 091 Пересилання між установами банку неплатіжних ювілейних монет та фу
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('091', '091 Пересилання між установами банку неплатіжних ювілейних монет та фу', 1, null, 980, null, 980, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '1000000000000000000000000000000000010000000000000000000000000000', 'Пересилання між установами банку неплатіжних ювілейних монет та футлярів');
  exception
    when dup_val_on_index then 
      update tts
         set tt='091', name='091 Пересилання між установами банку неплатіжних ювілейних монет та фу', dk=1, nlsm=null, kv=980, nlsk=null, kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1000000000000000000000000000000000010000000000000000000000000000', nazn='Пересилання між установами банку неплатіжних ювілейних монет та футлярів'
       where tt='091';
  end;
  --------------------------------
  ----------- Реквизиты ----------
