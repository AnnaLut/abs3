...
prompt Наименование операции: KM1 d: комісія за поповнення електронного гаманця готівкою по системі 
declare
  cnt_  number;
begin
  --------------------------------
