...
prompt Наименование операции: SCA Первинний внесок на вклад в нац.валюті готівкою
declare
  cnt_  number;
begin
  --------------------------------
