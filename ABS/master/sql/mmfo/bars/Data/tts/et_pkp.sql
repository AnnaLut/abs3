...
prompt Наименование операции: PKP д) Операції з БПК
declare
  cnt_  number;
begin
  --------------------------------
