...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_SEP_QDOCS_IMM.sql =========*** Run **
PROMPT ===================================================================================== 


PROMPT *** Create  view V_SEP_QDOCS_IMM ***

  CREATE OR REPLACE FORCE VIEW BARS.V_SEP_QDOCS_IMM ("DK", "REC", "REF", "DATD", "ND", "VOB", "MFOA", "NLSA", "KV", "S", "NLSB", "NAM_B", "NAZN", "D_REC", "FN_A", "DAT_A", "NAM_A", "ID_A", "ID_B", "DATP", "NMS", "OSTC", "LIM", "PAP", "OTM") AS 
  SELECT arc_rrp.dk,
          tzapros.rec,
          arc_rrp.REF,
          arc_rrp.datd,
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_SEP_QDOCS_IMM.sql =========*** End **
PROMPT ===================================================================================== 
