CREATE OR REPLACE FORCE VIEW BARS.NBU23_CCK_UL
(  RNK,
   ND,
   WDATE,
   CC_ID,
...
GRANT SELECT, UPDATE ON BARS.NBU23_CCK_UL TO BARS_ACCESS_DEFROLE;

GRANT SELECT, UPDATE ON BARS.NBU23_CCK_UL TO START1;