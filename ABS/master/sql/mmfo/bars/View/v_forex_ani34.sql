...
PROMPT *** Create  view V_FOREX_ANI34 ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_FOREX_ANI34 ("B", "E", "G01", "G02", "G03", "G04", "G05", "G06", "G07", "G08", "G08A", "G08B", "G09", "G10", "G11", "G12", "G13", "G14", "G15", "G16", "G17", "G18", "G19", "G20", "G21", "G22") AS 
  SELECT B,
          E,
          G01,
          G02,
