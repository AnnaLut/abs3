...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_DPU_PROC_DR.sql =========*** Run *** 
PROMPT ===================================================================================== 


PROMPT *** Create  view V_DPU_PROC_DR ***

  CREATE OR REPLACE FORCE VIEW BARS.V_DPU_PROC_DR ("NBS", "G67", "NBSN", "G67N", "REZID", "IO", "BRANCH") AS 
  select nbs,g67,nbsn,g67n,rezid,io,branch
   from proc_dr$base
  where (rezid,nbs) in (select vidd,bsd from dpu_vidd)
 ;
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_DPU_PROC_DR.sql =========*** End *** 
PROMPT ===================================================================================== 
