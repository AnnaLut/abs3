...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_NOTPORTFOLIO_INT_KD888.sql =========*
PROMPT ===================================================================================== 


PROMPT *** Create  view V_NOTPORTFOLIO_INT_KD888 ***

  CREATE OR REPLACE FORCE VIEW BARS.V_NOTPORTFOLIO_INT_KD888 ("ACCOUNT_ID", "INTEREST_KIND", "CURRENCY_ID", "MFO", "PARTNER_NAME", "ACCOUNT_NUMBER", "ACCOUNT_REST", "INTEREST_RATE", "INTEREST_AMOUNT", "DATE_FROM", "DATE_TO", "PURPOSE", "OPERATION_TYPE", "INTEREST_ACCOUNT_NUMBER", "INCOME_ACCOUNT", "MESSAGE", "STATE_ID", "ID", "RECKONING_ID", "OPER_REF") AS 
  SELECT t.account_id,
          t.interest_kind,
          a.kv currency_id,
          a.kf mfo,
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_NOTPORTFOLIO_INT_KD888.sql =========*
PROMPT ===================================================================================== 
