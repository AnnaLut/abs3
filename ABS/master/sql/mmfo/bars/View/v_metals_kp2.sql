...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_METALS_KP2.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create  view V_METALS_KP2 ***

  CREATE OR REPLACE FORCE VIEW BARS.V_METALS_KP2 ("BRANCH", "KOD", "KV", "VES", "VES_UN", "TYPE_", "PROBA", "NAME", "NAME_COMMENT", "CENA", "CENA_K", "CENA_NOMI", "NLS_3800", "KUPIVLYA", "PRODAZA", "PDV") AS 
  SELECT SYS_CONTEXT ('bars_context', 'user_branch') branch,
          ...
          CASE
             ...
             THEN
                make_docinput_url (
                   DECODE (NVL (m.cena_nomi, 0), 0, 'TM1', 'TI1'),
                   'Купити',
                   'DisR',
                   '1',
                   'reqv_BM__C',
          ...
          CASE
             ...
             THEN
                make_docinput_url (
                   DECODE (NVL (m.cena_nomi, 0), 0, 'TM2', 'TI2'),
                   'Продати',
                   'DisR',
                   '1',
                   'reqv_BM__C',
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_METALS_KP2.sql =========*** End *** =
PROMPT ===================================================================================== 
