...
PROMPT *** Create  view V_NBUR_#B5 ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_NBUR_#B5 ("REPORT_DATE", "KF", "VERSION_ID", "NBUC", "FIELD_CODE", "SEG_01", "SEG_02", "SEG_03", "SEG_04", "SEG_05", "FIELD_VALUE") AS 
...
grant SELECT                                                                 on V_NBUR_#B5      to BARSREADER_ROLE;
grant SELECT                                                                 on V_NBUR_#B5      to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on V_NBUR_#B5      to UPLD;
