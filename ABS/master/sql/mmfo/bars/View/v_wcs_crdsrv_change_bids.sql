...
PROMPT *** Create  grants  V_WCS_CRDSRV_CHANGE_BIDS ***
grant SELECT                                                                 on V_WCS_CRDSRV_CHANGE_BIDS to BARSREADER_ROLE;
grant SELECT                                                                 on V_WCS_CRDSRV_CHANGE_BIDS to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on V_WCS_CRDSRV_CHANGE_BIDS to UPLD;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_WCS_CRDSRV_CHANGE_BIDS.sql =========*
PROMPT ===================================================================================== 
