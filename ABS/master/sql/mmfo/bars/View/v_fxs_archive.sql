...
CREATE OR REPLACE FORCE VIEW BARS.V_FXS_ARCHIVE 
      (DEAL_TAG, NTIK, KVA, SUMA, KVB, SUMB, REF, SOSM, REFA, SOSA, REFB, SOSB, REFB2, REF1, REFA_SPTOD, REFB_SPTOD, REFB2_SPTOD, KODB, TA_DIG, TB_DIG, 
...
SELECT DEAL_TAG,
       ...
       (select substr(value, 1, 5)
          from operw w
         where w.tag = 'F092'
           and w.ref = x.REF) F092
  FROM (SELECT DEAL_TAG,
               NTIK,
               KVA,
