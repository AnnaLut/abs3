...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_STAFF_USER_ADM_META_ADD.sql =========
PROMPT ===================================================================================== 


PROMPT *** Create  view V_STAFF_USER_ADM_META_ADD ***

  CREATE OR REPLACE FORCE VIEW BARS.V_STAFF_USER_ADM_META_ADD ("ID", "LOGIN_NAME", "USER_NAME", "BRANCH", "CHANGE_BRANCH_FLAG", "EXTENDED_ACCESS_FLAG", "SECURITY_TOKEN_PASS", "ABS_AUTH_FLAG", "ABS_PASS_HASH", "ORACLE_AUTH_FLAG", "ORACLE_PASS", "ORACLE_ROLES", "AD_AUTH_FLAG", "AD_NAME", "USER_ROLES") AS 
  select t.id,
...
PROMPT *** Create  grants  V_STAFF_USER_ADM_META_ADD ***
grant SELECT                                                                 on V_STAFF_USER_ADM_META_ADD to BARSREADER_ROLE;
grant SELECT                                                                 on V_STAFF_USER_ADM_META_ADD to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on V_STAFF_USER_ADM_META_ADD to UPLD;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_STAFF_USER_ADM_META_ADD.sql =========
PROMPT ===================================================================================== 
