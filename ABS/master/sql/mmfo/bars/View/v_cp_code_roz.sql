...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_CP_CODE_ROZ.sql =========*** Run *** 
PROMPT ===================================================================================== 


PROMPT *** Create  view V_CP_CODE_ROZ ***

  CREATE OR REPLACE FORCE VIEW BARS.V_CP_CODE_ROZ ("ID", "ISIN", "CP_NAME", "BASEY", "BNAME", "KY", "DOK", "DNK", "TIP", "TIP_NAME", "DCP", "EMI", "EMINAME", "DAT_EM", "DOX", "DOCNAME", "CENA", "KV", "DATP", "IR", "RNK", "NMK", "COUNTRY", "AMORT", "VR_NAME", "PR_AKT", "IN_BR", "K23", "CENA_KUP", "KAT23", "PR1_KUP", "PERIOD_KUP", "PR_AMR", "QUOT_SIGN", "CENA_START", "METR", "PAWN", "PAWNNAME", "ZAL_CP", "HIERARCHY_ID", "HIERNAME", "EXPIRY", "VNCRP", "VNCRR", "IDT", "TYPENAME") AS 
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_CP_CODE_ROZ.sql =========*** End *** 
PROMPT ===================================================================================== 
