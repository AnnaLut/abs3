...
PROMPT *** Create  view V_NBUR_#26 ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_NBUR_#26 ("REPORT_DATE", "KF", "VERSION_ID", "NBUC", "FIELD_CODE", "SEG_01", "SEG_02", "SEG_03", "SEG_04", "SEG_05", "SEG_06", "FIELD_VALUE", "ERROR_MSG", "ADJ_IND") AS 
