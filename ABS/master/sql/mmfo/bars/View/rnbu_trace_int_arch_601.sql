...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/RNBU_TRACE_INT_ARCH_601.sql =========**
PROMPT ===================================================================================== 


PROMPT *** Create  view RNBU_TRACE_INT_ARCH_601 ***

  CREATE OR REPLACE FORCE VIEW BARS.RNBU_TRACE_INT_ARCH_601 ("COL_P1", "COL_P2", "COL_P8", "COL_P4", "COL_P3", "COL_P5", "COL_P6", "COL_P7", "COL_P9", "KODF", "DATF", "NLS", "KV", "ODATE", "KODP", "ZNAP", "NBUC", "ISP", "RNK", "ACC", "REF", "COMM", "ND", "MDATE", "TOBO") AS 
...
PROMPT *** Create  grants  RNBU_TRACE_INT_ARCH_601 ***
grant SELECT                                                                 on RNBU_TRACE_INT_ARCH_601 to BARSREADER_ROLE;
grant SELECT                                                                 on RNBU_TRACE_INT_ARCH_601 to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on RNBU_TRACE_INT_ARCH_601 to RPBN002;
grant SELECT                                                                 on RNBU_TRACE_INT_ARCH_601 to UPLD;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/RNBU_TRACE_INT_ARCH_601.sql =========**
PROMPT ===================================================================================== 
