...
PROMPT *** Create  view V_NBUR_#6B ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_NBUR_#6B ("REPORT_DATE", "KF", "VERSION_ID", "NBUC", "FIELD_CODE", "SEG_01", "SEG_02", "SEG_03", "SEG_04", "SEG_05", "SEG_06", "SEG_07", "SEG_08", "FIELD_VALUE", "ERROR_MSG", "ADJ_IND") AS 
