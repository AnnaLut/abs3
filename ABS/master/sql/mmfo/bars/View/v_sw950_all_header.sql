...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_SW950_ALL_HEADER.sql =========*** Run
PROMPT ===================================================================================== 


PROMPT *** Create  view V_SW950_ALL_HEADER ***

  CREATE OR REPLACE FORCE VIEW BARS.V_SW950_ALL_HEADER ("SENDER_BIC", "LORO_ACCNUM", "NOSTRO_ACCCODE", "NOSTRO_ACCNUM", "NOSTRO_ACCNAME", "NOSTRO_REST_IN", "NOSTRO_REST_OUT", "NOSTRO_TRN_COUNT", "STMT_REF", "STMT_MT", "STMT_TRN", "STMT_CURRCODE", "STMT_CURRENCY", "STMT_BEG_DATE", "STMT_END_DATE", "STMT_REST_IN", "STMT_REST_OUT", "STMT_DATE_IN", "STMT_DATE_OUT", "STMT_VALUE_DATE", "STMT_NUM", "STMT_PAGE", "STMT_PROCESSED", "STMT_DETAIL_COUNT", "STMT_NPROC_COUNT") AS 
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_SW950_ALL_HEADER.sql =========*** End
PROMPT ===================================================================================== 
