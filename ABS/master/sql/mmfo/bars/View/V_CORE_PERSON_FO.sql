...
select "REQUEST_ID","RNK","LASTNAME","FIRSTNAME","MIDDLENAME","ISREZ","INN","BIRTHDAY","COUNTRYCODNEREZ","K060","PERSON_CODE","DEFAULT_PERSON_KF","DEFAULT_PERSON_ID","PERSON_OBJECT_ID","STATUS","STATUS_MESSAGE","KF" from nbu_gateway.V_CORE_PERSON_FO;
