...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_CASHPAYED.sql =========*** Run *** ==
PROMPT ===================================================================================== 


PROMPT *** Create  view V_CASHPAYED ***

  CREATE OR REPLACE FORCE VIEW BARS.V_CASHPAYED ("REF", "ACC", "NLS", "KV", "KVNAME", "NMS", "OPTYPE", "S", "SQ", "ND", "DK", "SK", "TT", "TTNAME", "NAZN", "NLSK", "LASTVISADAT", "LASTVISA_USRID", "LASTVISA_USRNAM", "POSTDAT", "POST_USRID", "POST_USRNAM", "OPDATE", "SHIFT", "ENDOPDATE") AS 
  select
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_CASHPAYED.sql =========*** End *** ==
PROMPT ===================================================================================== 
