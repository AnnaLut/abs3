...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_DELTA15.sql =========*** Run *** ====
PROMPT ===================================================================================== 


PROMPT *** Create  view V_DELTA15 ***

  CREATE OR REPLACE FORCE VIEW BARS.V_DELTA15 ("ACC", "BRANCH", "KV", "NLS", "OSTC", "OSTB", "DAPP", "FDAT", "SUMN", "SUMU", "PLAN", "DELTA") AS 
  SELECT q."ACC",
       q."BRANCH",
       q."KV",
       q."NLS",
       ...
       q."SUMN",
       q."SUMU",
       ROUND (sumn * 0.15, 0) Plan,
       ROUND (sumn * 0.15, 0) - sumu Delta
  FROM (  SELECT a.acc,
                 a.branch,
                 a.kv,
                 a.nls,
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_DELTA15.sql =========*** End *** ====
PROMPT ===================================================================================== 
