...
PROMPT *** Create  view V_CIM_BOUND_PAYMENTS ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_CIM_BOUND_PAYMENTS ("BOUND_ID", "CONTR_ID", "PAY_FLAG", "PAY_FLAG_NAME", "REF", "DIRECT", "TYPE_ID", "TYPE", "VDAT", "ACCOUNT", "NAZN", "V_PL", "S_VPL", "SK_VPL", "RATE", "S_VK", "CREATE_DATE", "MODIFY_DATE", "BORG_REASON", "EA_URL", "BRANCH", "DEADLINE_DOC") AS 
  SELECT b.bound_id, b.contr_id, b.pay_flag, (select name from cim_payflag where id=b.pay_flag), b.REF, b.direct, 0,
          ...
          b.branch, b.deadline as deadline_doc
...
comment on table V_CIM_BOUND_PAYMENTS is 'Прив`язані платежі v 1.00.04';
