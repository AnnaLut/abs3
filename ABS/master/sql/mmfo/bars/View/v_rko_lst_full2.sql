...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/View/V_RKO_LST_FULL2.sql =========*** Run **
PROMPT ===================================================================================== 


PROMPT *** Create  view V_RKO_LST_FULL2 ***

  CREATE OR REPLACE FORCE VIEW BARS.V_RKO_LST_FULL2 ("ACC", "NLS", "KV", "NMS", "ISP", "DAT0A", "DAT0B", "RKO_S0", "KOLDOK", "DAT1B", "A1_OSTC", "DAT2B", "A2_OSTC", "NLS_SP", "KV_SP", "ACCD", "COMM", "ACC1", "R1", "ACC2", "R2", "RNK") AS 
  select a.acc,
            a.nls,
            a.kv,
            a.nms,
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/View/V_RKO_LST_FULL2.sql =========*** End **
PROMPT ===================================================================================== 
