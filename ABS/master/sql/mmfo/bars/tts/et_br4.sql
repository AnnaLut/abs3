...
prompt Наименование операции: BR4-Повернення надлишку коштів клієнту ЮО
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('BR4', 'BR4-Повернення надлишку коштів клієнту ЮО', 1, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0100100000000000000000000000000000010000000000000000000000000000', 'Повернення невикорист.коштів,які були зарезервов.для купівлі вал.клієнту ЮО');
  exception
    when dup_val_on_index then 
      update tts
         set tt='BR4', name='BR4-Повернення надлишку коштів клієнту ЮО', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0100100000000000000000000000000000010000000000000000000000000000', nazn='Повернення невикорист.коштів,які були зарезервов.для купівлі вал.клієнту ЮО'
       where tt='BR4';
  end;
  --------------------------------
  ----------- Реквизиты ----------
