...
begin
  ...
  begin
    ...
    values ('I06', 'I06 Імпорт інформаційний дебет (dk=2)', 2, null, 980, '#(get_proc_nls(''T00'',#(KVA)))', 980, null, null, null, null, 0, 1, 0, 0, null, null, null, null, null, null, '0201100000000000000000000000000000110000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='I06', name='I06 Імпорт інформаційний дебет (dk=2)', dk=2, nlsm=null, kv=980, nlsk='#(get_proc_nls(''T00'',#(KVA)))', kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=1, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0201100000000000000000000000000000110000000000000000000000000000', nazn=null
       where tt='I06';
  end;
  --------------------------------
  ----------- Реквизиты ----------
