...
prompt Наименование операции: --Передача цінності: сховище - > ОПЧ
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('VS7', '--Передача цінності: сховище - > ОПЧ', 1, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0000100000000000000000000000000000010000000000000000000000000001', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='VS7', name='--Передача цінності: сховище - > ОПЧ', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000100000000000000000000000000000010000000000000000000000000001', nazn=null
       where tt='VS7';
  end;
  --------------------------------
  ----------- Реквизиты ----------
