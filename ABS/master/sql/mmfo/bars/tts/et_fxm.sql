...
prompt Наименование операции: ЦП: Амортизація Дисконту та Премії
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('FXM', 'ЦП: Амортизація Дисконту та Премії', 1, null, null, null, 980, null, null, null, null, 0, 0, 1, 0, null, null, null, null, '#(nbs_ob22 (''3800'',''03''))', null, '0000000000000000000000000000000000010000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='FXM', name='ЦП: Амортизація Дисконту та Премії', dk=1, nlsm=null, kv=null, nlsk=null, kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=1, flr=0, s=null, s2=null, sk=null, proc=null, s3800='#(nbs_ob22 (''3800'',''03''))', rang=null, flags='0000000000000000000000000000000000010000000000000000000000000000', nazn=null
       where tt='FXM';
  end;
  --------------------------------
  ----------- Реквизиты ----------
