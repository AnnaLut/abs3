...
prompt Наименование операции: PKZ-Списання з картрахунку (мультивалютна) / 2О-Плата за дод.послуги
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('PKZ', 'PKZ-Списання з картрахунку (мультивалютна) / 2О-Плата за дод.послуги', 1, '#(bpk_get_transit(''2O'',#(NLSB),#(NLSA),#(KVA)))', null, null, 980, null, null, null, null, 0, 0, 1, 0, null, null, null, null, '#(nbs_ob22 (''3800'',''03''))', null, '1000100000000000000000000010000000010000000000000000000000000000', 'Списання з картрахунку / 2О-Плата за дод.послуги');
  exception
    when dup_val_on_index then 
      update tts
         set tt='PKZ', name='PKZ-Списання з картрахунку (мультивалютна) / 2О-Плата за дод.послуги', dk=1, nlsm='#(bpk_get_transit(''2O'',#(NLSB),#(NLSA),#(KVA)))', kv=null, nlsk=null, kvk=980, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=1, flr=0, s=null, s2=null, sk=null, proc=null, s3800='#(nbs_ob22 (''3800'',''03''))', rang=null, flags='1000100000000000000000000010000000010000000000000000000000000000', nazn='Списання з картрахунку / 2О-Плата за дод.послуги'
       where tt='PKZ';
  end;
  --------------------------------
  ----------- Реквизиты ----------
