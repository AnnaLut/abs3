...
prompt Ќаименование операции: STOP-контроль(сума виплати >150 000 з початку м≥с€ц€)
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('!15', 'STOP-контроль(сума виплати >150 000 з початку м≥с€ц€)', 1, null, null, null, null, null, null, null, null, 0, 0, 0, 0, 'F_CHECK_PAYMENT(#(REF))', null, null, null, null, null, '0000100000000000000000000001000000000000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='!15', name='STOP-контроль(сума виплати >150 000 з початку м≥с€ц€)', dk=1, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s='F_CHECK_PAYMENT(#(REF))', s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000100000000000000000000001000000000000000000000000000000000000', nazn=null
       where tt='!15';
  end;
  --------------------------------
  ----------- –еквизиты ----------
