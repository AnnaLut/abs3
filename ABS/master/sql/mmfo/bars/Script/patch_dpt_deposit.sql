...
prompt -- ======================================================
prompt -- recreate table DPT_DEPOSIT
prompt -- ======================================================
...
-- manual replacement of constraints such as "CHECK (VIDD IS NOT NULL)" to "MODIFY VIDD NOT NULL"
declare
  e_col_already_nn  exception;
  pragma exception_init( e_col_already_nn, -01442 );
begin
  begin
    execute immediate 'alter table DPT_DEPOSIT modify ACC constraint CC_DPTDEPOSIT_ACC_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
  ...
  begin
    execute immediate 'alter table DPT_DEPOSIT modify ARCHDOC_ID constraint CC_DPTDEPOSIT_ARCHDOCID_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
    then dbms_output.put_line( 'Column "ARCHDOC_ID" is already NOT NULL.' );
  end;
  begin
    execute immediate 'alter table DPT_DEPOSIT modify BRANCH constraint CC_DPTDEPOSIT_BRANCH_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
  ...
  begin
    execute immediate 'alter table DPT_DEPOSIT modify DAT_BEGIN constraint CC_DPTDEPOSIT_DATBEGIN_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
  ...
  begin
    execute immediate 'alter table DPT_DEPOSIT modify DATZ constraint CC_DPTDEPOSIT_DATZ_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
  ...
  begin
    execute immediate 'alter table DPT_DEPOSIT modify FREQ constraint CC_DPTDEPOSIT_FREQ_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
    then dbms_output.put_line( 'Column "FREQ" is already NOT NULL.' );
  end;
  begin
    execute immediate 'alter table DPT_DEPOSIT modify KF constraint CC_DPTDEPOSIT_KF_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
  ...
  begin
    execute immediate 'alter table DPT_DEPOSIT modify KV constraint CC_DPTDEPOSIT_KV_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
  ...
  begin
    execute immediate 'alter table DPT_DEPOSIT modify RNK constraint CC_DPTDEPOSIT_RNK_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
  ...
  begin
    execute immediate 'alter table DPT_DEPOSIT modify STOP_ID constraint CC_DPTDEPOSIT_STOPID_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
  ...
  begin
    execute immediate 'alter table DPT_DEPOSIT modify USERID constraint CC_DPTDEPOSIT_USERID_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
  ...
  begin
    execute immediate 'alter table DPT_DEPOSIT modify VIDD constraint CC_DPTDEPOSIT_VIDD_NN Not Null enable novalidate';
    dbms_output.put_line( 'Table altered.' );
  exception
    when e_col_already_nn
