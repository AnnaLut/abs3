...
declare
    l_app_code varchar2(10 char) := '$RM_NBUR';
    l_app_name varchar2(300 char) := 'АРМ Звітність (новий)';
    l_appid number(5);
    l_funcname1 varchar2(250 Byte) := '/barsroot/ndi/referencebook/GetRefBookData/?code=UPLOAD_EXCEL_NBUR_OVDP_6EX';
    l_name1 varchar2(250 Byte) := 'Справедлива вартість ЦБ для файлу 6ЕХ (LCR)';
