...
-- Date   : 09.08.2018
-- ================================== <Comments> ==================================
-- recreate table CUSTOMER_ADDRESS
-- ================================================================================
...
prompt -- ======================================================
prompt -- recreate table CUSTOMER_ADDRESS
prompt -- ======================================================
...
begin
  execute immediate q'[create unique index UK_CUSTOMER_ADDRESS on CUSTOMER_ADDRESS (KF, RNK, TYPE_ID)
  tablespace BRSBIGI
  pctfree 10
  initrans 2
  maxtrans 255
