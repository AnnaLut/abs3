...
declare
    l_app_code varchar2(10 char) := '$RM_W_W4';
    l_app_name varchar2(300 char) := 'АРМ "БПК – Way4"';
    l_appid number(5);
    l_funcname1 varchar2(250 Byte) := '/barsroot/ndi/referencebook/GetRefBookData/?accessCode=1'||chr(38)||'sPar=V_NBU_CREDIT_INSURANCE_FILES[NSIFUNCTION]';
    l_name1 varchar2(250 Byte) := 'Імпорт реєстру добровільного страхування кредитів БПК';
