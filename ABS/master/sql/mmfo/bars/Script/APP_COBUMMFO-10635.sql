...
declare
    l_app_code varchar2(10 char) := '$RM_STAT';
    l_app_name varchar2(300 char) := 'АРМ Візування файлів статистичної звітності НБУ';
    l_appid number(5);
    l_funcname1 varchar2(250 Byte) := '/barsroot/SignStatFiles/SignFiles/Index';
    l_name1 varchar2(250 Byte) := 'Візування  файлів звітності у форматі XML';
