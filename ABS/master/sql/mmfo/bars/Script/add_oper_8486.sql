...
declare
    l_app_code varchar2(10 char) := '$RM_KART';
    l_app_name varchar2(300 char) := 'АРМ Картотека переказів';
    l_appid number(5);
    l_funcname1 varchar2(250 Byte) := '/barsroot/gl/nl/index?tip=nll' || chr(38) ||'ttList=NLL';
    l_name1 varchar2(250 Byte) := 'NLL Картотека 3739 внутрішні(тип NLL) (тест)';
