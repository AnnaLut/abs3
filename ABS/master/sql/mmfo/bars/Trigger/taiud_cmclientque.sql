...
after insert or update or delete ON BARS.CM_CLIENT_QUE
for each row
declare
  l_idupd     number;
  l_chgaction number;
begin
  ...
  l_idupd := bars_sqnc.get_nextval('s_cmclient');
  ...
  then
    ...
    insert
      into cm_client_que_arc (idupd, doneby, chgaction,
        id,
        rnk,
        datein,
        datemod,
     ...
     values (l_idupd, user, l_chgaction,
        ...
        :new.eddr_id,
        :new.shortnameowner);
  elsif deleting and :old.oper_status <> 3 
  then
