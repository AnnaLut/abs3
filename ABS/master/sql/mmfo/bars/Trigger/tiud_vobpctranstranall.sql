...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Trigger/TIUD_VOBPCTRANSTRANALL.sql =========
PROMPT ===================================================================================== 


PROMPT *** Create  trigger TIUD_VOBPCTRANSTRANALL ***

  CREATE OR REPLACE TRIGGER BARS.TIUD_VOBPCTRANSTRANALL 
instead of update on v_obpc_trans_tran_all for each row
declare
  l_acc_tr  number;
  l_acc_fs  number;
  l_acc_fl  number;
...
begin
  ...
  if :new.t980 is null and
     ...
     if sql%rowcount = 0 then
        ...
        values(:new.tran_type, :new.tip, 980, l_acc_tr, l_acc_fs, l_acc_fl, l_acc_us, l_acc_ul, :old.branch);
     end if;
  end if;
  ...
  if :new.t840 is null and
     ...
     if sql%rowcount = 0 then
        insert into obpc_trans_tran(tran_type, tip, kv, transit_acc, acc_f_short, acc_f_long, acc_u_short, acc_u_long, branch)
        values(:new.tran_type, :new.tip, 840, l_acc_tr, l_acc_fs, l_acc_fl, l_acc_us, l_acc_ul, :old.branch);
     end if;
  end if;
...
/
ALTER TRIGGER BARS.TIUD_VOBPCTRANSTRANALL ENABLE;


PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Trigger/TIUD_VOBPCTRANSTRANALL.sql =========
PROMPT ===================================================================================== 
