 ...
 PROMPT ===================================================================================== 
 PROMPT *** Run *** ========== Scripts /Sql/BARS/package/brates_utl.sql =========*** Run *** 
 PROMPT ===================================================================================== 
 
  CREATE OR REPLACE PACKAGE BARS.BRATES_UTL 
is

 procedure add_rates(p_br_id number, p_bdate date, p_kv number, p_s number, p_rate number);

 procedure upd_rates(p_br_id number, p_bdate date, p_kv number, p_s number, p_rate number);

 procedure del_rates(p_br_id number, p_bdate date, p_kv number, p_s number, p_rate number);
...
PROMPT *** Create  grants  BRATES_UTL ***
grant EXECUTE                                                                on BRATES_UTL      to BARS_ACCESS_DEFROLE;

 
 
 PROMPT ===================================================================================== 
 PROMPT *** End *** ========== Scripts /Sql/BARS/package/brates_utl.sql =========*** End *** 
 PROMPT ===================================================================================== 
