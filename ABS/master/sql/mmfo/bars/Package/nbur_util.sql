...
is
  ...
  -- constants
  --
  g_body_version  constant varchar2(64)  := 'version 1.6  2018.03.03';
  ...
  , p_col_cmnt      in     varchar2 default null -- column comment
    ...
    e_inval_mod_col        exception;
    pragma exception_init( e_inval_mod_col, -22859 );
    -----------------
    -- local variable
    l_scss                 signtype := 1;
