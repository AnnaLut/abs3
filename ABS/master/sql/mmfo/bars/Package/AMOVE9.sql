CREATE OR REPLACE PROCEDURE BARS.AMOVE9 (p_ND number)  IS -- АВТО-ПЕРЕКЛАССИФИКАЦИЯ КД согласно доп.рекв. по вектору: от... до 01.01.2018 . далее - помесячно до 01.хх.2018

/*  
15.06.2018 ЬМЕНЯЕМ МЕСТАМИ ss - XS
...
---------If a1.tip     in ('SS ','SP ','SN ','SPN','SNO')  OR a1.ostc <> 0  then  --- -открыт новый счет и перебросить остаток
...
-- 8) Связываем счет сo старым  КД 
         ...
         INSERT INTO TEST_RECLASS ( ACC_OLD, ACC_NEW) VALUES (A1.ACC, A2.ACC );
