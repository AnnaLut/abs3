 ...
 PROMPT ===================================================================================== 
 PROMPT *** Run *** ========== Scripts /Sql/BARS/package/ovr.sql =========*** Run *** =======
 PROMPT ===================================================================================== 
       ...
       --   в том случае, когда "День погашення %%" не проставлен !!!
            ...
            LOOP
               ...
               Begin --- Проставляем OB22 уже открытым 2607,9129:
                 ...
                 EXCEPTION WHEN OTHERS then
                   UPDATE Specparam_Int  SET OB22='04' where ACC=k.acc_9129 ; -- and  OB22 is NULL ;
                 End;
...
PROMPT *** Create  grants  OVR ***
grant EXECUTE                                                                on OVR             to BARS009;
grant EXECUTE                                                                on OVR             to BARS010;
grant EXECUTE                                                                on OVR             to BARS_ACCESS_DEFROLE;
grant EXECUTE                                                                on OVR             to START1;
grant EXECUTE                                                                on OVR             to TECH005;
grant EXECUTE                                                                on OVR             to WR_ALL_RIGHTS;

 
 
 PROMPT ===================================================================================== 
 PROMPT *** End *** ========== Scripts /Sql/BARS/package/ovr.sql =========*** End *** =======
 PROMPT ===================================================================================== 
