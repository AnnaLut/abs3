  ...
  */
  ...
  BEGIN
    ...
    */
      ...
      dbms_application_info.set_client_info( 'Формування місячного знімку балансу для '||l_kf||' за ' || F_MONTH_LIT(dat1_,1,2) || 'міс.' );
...
--    execute immediate 'lock table SALDOZ subpartition for '||l_condition||' IN EXCLUSIVE MODE';
      ...
      dbms_application_info.set_client_info( 'Переоцінка валютних позицій місячного знімку балансу для '||l_kf||' за ' || F_MONTH_LIT(dat1_,1,2) );
