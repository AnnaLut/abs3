...
*/
    ...
    begin
        ...
        if (l_deals is not empty) then
            ...
            interest_utl.group_reckonings(deal_list_to_account_list(l_deals), p_grouping_mode_id => p_grouping_mode_id, p_line_type => interest_utl.RECKONING_TYPE_ORDINARY_INT);
        end if;
    end;
