...
/* Версия 15.2   19-11-2018  23-10-2018  10-09-2018  12-07-2018  20-04-2018  10-04-2018  26-03-2018  28-11-2017 
...
begin
   ...
   z23.to_log_rez (user_id , 351 , p_dat01 ,'Начало Кредити + БПК + ОВЕР + МБДК + Коррахунки');
   dbms_application_info.set_client_info('CR_351:'|| l_kf ||': Кредити + БПК + ОВЕР + МБДК + Коррахунки');
   ...
   LOOP
      ...
      if    d.custtype = 2 and d.tipa = 4 THEN l_tip_fin := 1;  -- Бюджетные
...
*/
               ...
               INSERT INTO REZ_CR (fdat   , RNK   , NMK    , ND    , KV      , NLS    , ACC       , EAD     , EADQ    , FIN     , PD       ,
                                   ...
                                   ob22   , grp   , cc_id  , pd_0  , istval  , wdate  , CCF       , okpo    , poci    , ddd_6B  , tip_fin  , 
                                   rpb    )
                           VALUES (p_dat01, s.RNK , d.NMK  , d.nd  , s.kv    , s.nls  , s.acc     , l_ead   , l_eadq  , l_fin   , l_pd     ,
                                   ...
                                   s.ob22 , l_grp , d.cc_id, l_pd_0, l_istval, d.wdate, l_ccf     , d.okpo  , l_poci  , l_ddd   , l_tip_fin, 
                                   nvl(z.rpb,0));
   ...
   End LOOP;
   z23.to_log_rez (user_id , 351 , p_dat01 ,'Кредити + БПК + ОВЕР + МБДК + Коррахунки');
