CREATE OR REPLACE PROCEDURE p_par_9200(p_dat01  date    , p_mode  integer , p_rnk  integer,
                                       p_nls    varchar2, p_kv    number  , p_fin  number , 
                                       p_VKR    VARCHAR2, p_comm  varchar2, p_PD   number ) IS 
...
begin
   ...
   if    p_mode = 1 THEN  update REZ_PAR_9200 set   rnk = l_9200.rnk, nd = l_9200.nd, fin = l_9200.fin, vkr = l_9200.vkr, comm = l_9200.comm, pd = l_9200.pd 
