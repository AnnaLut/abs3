...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/CP_OBU.sql =========*** Run *** ==
PROMPT ===================================================================================== 


PROMPT *** Create  procedure CP_OBU ***

  CREATE OR REPLACE PROCEDURE BARS.CP_OBU 
 ( p_ID  int , -- какую ЦБ   ( или все =0)
   p_dat2 date   -- дата перекласифікації (факт)
   )  is
...
---------
 ...
 exception when NO_DATA_FOUND then NULL;
  ...
  if l_fl = 1 and l_dat_pr is not null then
  begin
...
/****************
 ...
 select o.s/100
 into  s_63,
 from opldok o, OPER P, acconts a
 where o.acc = r_dl1.acc and o.dk=1  and o.ref=p.ref
       and o.ref=l_ref5 and a.acc=o.acc and a.nls like '6393%';
       and o.sos=5     ---o.sos>0  -- OBU/BARS
...
PROMPT *** Create  grants  CP_OBU ***
grant EXECUTE                                                                on CP_OBU          to BARS_ACCESS_DEFROLE;
grant EXECUTE                                                                on CP_OBU          to CP_ROLE;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/CP_OBU.sql =========*** End *** ==
PROMPT ===================================================================================== 
