...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/P_2400_NBS.sql =========*** Run **
PROMPT ===================================================================================== 


PROMPT *** Create  procedure P_2400_NBS ***

  CREATE OR REPLACE PROCEDURE BARS.P_2400_NBS (Dat01_ DATE, NAL_ varchar2 ) IS
...
PROMPT *** Create  grants  P_2400_NBS ***
grant EXECUTE                                                                on P_2400_NBS      to BARS_ACCESS_DEFROLE;
grant EXECUTE                                                                on P_2400_NBS      to RCC_DEAL;
grant EXECUTE                                                                on P_2400_NBS      to START1;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_2400_NBS.sql =========*** End **
PROMPT ===================================================================================== 
