...
(p_DAT    DATE,                   -- отчетная дата
 ...
 p_KODF   VARCHAR2 DEFAULT '02'  --код файла IS
  ...
  -- 02.06.2011 SERG     При синхронизации снимков баланса убрал флаг безусловного накопления
                         -- добавил наполнение recid, userid при вставке в rnbu_trace
  -- 13/05/2011 Virko	 Заменила частичное обновление на полное,
  -- т.к. в некоторых случаях не отрабатывало (было расхождение с балансом).

  -- 28-02-2010 Virko	 учет внесистемных вешалок

  -- Sta 	 Процедура формирования #02 на SNP-табл
  l_DAT01d_ date      ;
  l_DAT01t_ date      ;
