...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/GURN_ACCM.sql =========*** Run ***
PROMPT ===================================================================================== 


PROMPT *** Create  procedure GURN_ACCM ***

  CREATE OR REPLACE PROCEDURE BARS.GURN_ACCM      (usid_ int, FROM_ DATE, TO_ date, p_nls varchar2 default '%') IS
---           ***   Ver.  16/02-09   ***
--  KDI ÕÓ‚ËÈ Ô‡- P_nls Ú‡ V_GL Á‡Ï≥ÒÚ¸ Accounts

  CURSOR ALL_ACCOUNTS IS
    SELECT distinct u.ACC
    FROM ACCOUNTS_UPDATE u,   V_GL v
    WHERE CHGDATE >= FROM_ AND CHGDATE < TO_+1
          and v.acc=u.acc and v.nls like p_nls||'%';
...
---------
----   Select records from Accounts_update into Tmp_acc_regm
---------
...
BEGIN
     delete from tmp_acc_regm  where usid=usid_;
...
PROMPT *** Create  grants  GURN_ACCM ***
grant EXECUTE                                                                on GURN_ACCM       to BARS_ACCESS_DEFROLE;
grant EXECUTE                                                                on GURN_ACCM       to RPBN001;
grant EXECUTE                                                                on GURN_ACCM       to WR_ALL_RIGHTS;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/GURN_ACCM.sql =========*** End ***
PROMPT ===================================================================================== 
