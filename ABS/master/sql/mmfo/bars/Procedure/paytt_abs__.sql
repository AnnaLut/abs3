...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/PAYTT_ABS__.sql =========*** Run *
PROMPT ===================================================================================== 


PROMPT *** Create  procedure PAYTT_ABS__ ***

  CREATE OR REPLACE PROCEDURE BARS.PAYTT_ABS__ 
...
--20283928
--        USSR_PAYOFF@DEPDB.payoff_back(p_REF, p_DBCODE, p_NSC );
        logger.info('DEP : p_REF='   ||p_REF   ||
                       ' , p_DBCODE='||p_DBCODE||
                       ' , p_NSC='   ||p_NSC ) ;
     end;
  end if;
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/PAYTT_ABS__.sql =========*** End *
PROMPT ===================================================================================== 
