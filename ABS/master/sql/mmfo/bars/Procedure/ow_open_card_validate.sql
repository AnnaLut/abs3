...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/OW_OPEN_CARD_VALIDATE.sql ========
PROMPT ===================================================================================== 


PROMPT *** Create  procedure OW_OPEN_CARD_VALIDATE ***

  CREATE OR REPLACE PROCEDURE BARS.OW_OPEN_CARD_VALIDATE (rnk        in number,
                                                  nls        in varchar2,
...
PROMPT *** Create  grants  OW_OPEN_CARD_VALIDATE ***
grant EXECUTE                                                                on OW_OPEN_CARD_VALIDATE to BARS_ACCESS_DEFROLE;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/OW_OPEN_CARD_VALIDATE.sql ========
PROMPT ===================================================================================== 
