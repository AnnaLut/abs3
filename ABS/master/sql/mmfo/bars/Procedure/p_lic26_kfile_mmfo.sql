...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/P_LIC26_KFILE_MMFO.sql =========**
PROMPT ===================================================================================== 


PROMPT *** Create  procedure P_LIC26_KFILE_MMFO ***

  CREATE OR REPLACE PROCEDURE BARS.P_LIC26_KFILE_MMFO 
             (p_s      date,           -- дата по
              p_corpc  varchar2,
              p_sync out number )      -- код корпорации
is
--======================================================================================
-- Module      : REP
...
begin
   ...
   select gl.amfo, G_ROWTYPE_TOTAL, count(*), docdat, kod_corp
    ...
    l_sync := kfile_sync.get_sync_id(f_ourmfo, p_corpc, to_char(p_s,'DDMMYYYY'), 'DATA');
...
PROMPT *** Create  grants  P_LIC26_KFILE_MMFO ***
grant EXECUTE                                                                on P_LIC26_KFILE_MMFO to BARS_ACCESS_DEFROLE;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_LIC26_KFILE_MMFO.sql =========**
PROMPT ===================================================================================== 
