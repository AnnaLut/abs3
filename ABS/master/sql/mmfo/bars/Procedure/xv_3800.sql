...
begin
  ...
  for o in ( select ob22, substr(txt,1,38) NMS 
               from SB_OB22
              where r020='3800' and ob22 in ('03','10','16') and d_close is null )
  loop
...
--  ElsIf o.ob22 = '20' then txt_:= 'купiвля-продаж Б/Г';
    ...
    loop
      ...
      for k in ( select kv from tabval where kv in ( 36, 124, 392, 756 ) )
      loop
        ...
        nls6_ := nbs_ob22_null('6204',ob62_,b.branch);
        
        If nls6_ is null 
        then nls6_ := nbs_ob22_null('6204',ob62_,brG_);
        end if;
        
        If nls6_ is not null 
        then
          begin
