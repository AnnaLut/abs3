...
14.03.2013 - справочник kl_f3_29 не используется, данные формируются по
             всем валютам, кроме (980,958,961,962,964)
28.11.2012 - дополнительно обрабатываем доп.реквизит D#27 и если значение
             01 то формируем показатель 7BBBB00VVV
             (по просьбе Петрокоммерца)
26.11.2012 - п_дправила умову на призначення платежа
23.11.2012 - для Сбербанка в код 7BBBB00VVV включаем проводки
             Дт 2603  Кт 2900 с OB22='04'
22.11.2012 - добавлено формирование кода 7BBBB00VVV обов'язковий продаж
19.09.2012 - несущественные изменения
с 01.03.2006 разбивка по D020 не производится (D020='00')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
kodf_    varchar2(2):='27';
typ_ number;
