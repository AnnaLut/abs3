...
PROMPT *** Create  procedure SPD_15 ***
  ...
  CREATE OR REPLACE PROCEDURE BARS.SPD_15 ( p_mode int, p_isp int ) IS
   ...
   oo oper%rowtype;  dat01_ date := to_date('01-08-2014','dd-mm-yyyy');  dat31_ date := to_date('31-08-2014','dd-mm-yyyy');
begin
      ...
      begin
         ...
         if l_s15 > 0 then
            ...
            gl.in_doc3(oo.ref, '%15', 6, to_char(oo.ref),  SYSDATE,  gl.bdate, 1, k.kv, l_s15, 980,  l_s15q,
                      ...
                      'ПДФО з проц.доходiв за серпень 2014 р.', null, null, null, null, null, 0, null, p_isp);
