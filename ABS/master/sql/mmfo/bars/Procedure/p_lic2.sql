...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/P_LIC2.sql =========*** Run *** ==
PROMPT ===================================================================================== 


PROMPT *** Create  procedure P_LIC2 ***

  CREATE OR REPLACE PROCEDURE BARS.P_LIC2 (id_ SMALLINT, p_s DATE, p_po DATE, maska varchar2 )
IS
      ...
      LOOP
        ...
        LOOP
		  ...
		  IF ind_ = 1 THEN
            ...
            VALUES (id_,fdat_,acc_, 1, s_,nd_,mfob_,nazn_,vdat_,nlsk_,nms_d,
              userid_,ref_,tt_d,ostf_,sk_,dapp_,isp_,kv_,nls_,nms_);
		  ELSE
            INSERT INTO tmp_lic (id,fdat, acc, wd,s, nd, mfo,nazn,vdat,nlsk,namk,
              userid, ref, tt,ostf,sk,dapp,isp,kv,nls,nms)
            VALUES (id_,fdat_,acc_, 1, s1_k,nd_,mfob_,nazn_,vdat_,nls1_k,nms1_k,
              userid_,ref_,tt_d,ostf_,sk_,dapp_,isp_,kv_,nls_,nms_);
            INSERT INTO tmp_lic (id,fdat, acc, wd,s, nd, mfo,nazn,vdat,nlsk,namk,
              userid, ref, tt,ostf,sk,dapp,isp,kv,nls,nms)
            VALUES (id_,fdat_,acc_, 1, s2_k,nd_,mfob_,nazn_,vdat_,nls2_k,nms2_k,
              userid_,ref_,tt_d,ostf_,sk_,dapp_,isp_,kv_,nls_,nms_);
		  END IF;
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_LIC2.sql =========*** End *** ==
PROMPT ===================================================================================== 
