...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%22/04/2019 - для групи бал.рах '355' значення S031 буде формуватися 
...
%25/10/2018 - доработки для Инстолмента (б/c 2203, 2208, 3570
              тип 'ISS','IKN','IK0')
%09/11/2018 - изменено формирование показателя 164
%10/10/2018 - изменено формирование показателя 111 для первого транша
%08/10/2018 - для формирования части показателя "H" дополнительно
              определяем переменную PD_0_ из NBU23_REZ по ACC счета
%13/09/2018 - изменил формирование переменной ND_ACC_
              (было n.nd из ND_ACC сейчас NVL(cc.ndg, cc.nd) из CC_DEAL)
              изменено формирование показателя 126 для б/с по ЦБ
...
-- определение основных параметров КД
   BEGIN
      ...
      ELSE
         ...
         IF mfou_ NOT IN (300205, 353575, 300465, 380764)  -- убрал 05.12.2012
         THEN
            BEGIN                                            -- текущий лимит
               SELECT gl.p_icurval (a.kv, l.lim2, dat_), a.wdate
                 INTO sum_lim, p111p_
          ...
          then
             ...
             THEN
                ...
                then
                   ...
                   -- на 01.03.2014 новый код перечень кодов обеспечения S031
                   if substr(p070_,1,3) in ('140','141','142','150','181','280','300','301','304','310','311','320','321','351','354','355','357') then
             ...
             ELSE
                ...
                ELSE
                   if (ddd_ = '123' and p120_ != 0) or ddd_ not in ('119','123') then
                      ...
                      if ddd_ = '121' and ( p070_ in ('1510','1513','1520','1521','1522','1524','1532','1533','1542','1543',
                                                      '1600','2010','2020','2030','2040','2041','2042','2043','2044','2045','2060',
                                                      '2063','2071','2083','2103','2113','2123','2140','2141','2142','2143','2203',
                                                      '2211','2220','2233','2240','2241','2242','2243','2301','2303','2310','2311',
                                                      '2320','2321','2330','2331','2340','2341','2351','2353','2360','2361','2362',
                                                      '2363','2370','2371','2372','2373','2380','2381','2382','2383','2390','2391',
                                                      '2392','2393','2394','2395','2401','2403','2410','2411','2420','2421','2431',
                                                      '2433','2450','2451','2452','2453','2600','2620','2650','3510','3511','3519') or  
                                            (p070_ = '1502' and r011_ in ('2','3','6')) or
                                            (p070_ = '1811' and r011_ in ('2')) or
                                            (p070_ = '1819' and r011_ in ('4')) or
                                            (p070_ = '2800' and r011_ in ('1')) or
                                            (p070_ = '2801' and r011_ in ('3')) or
                                            (p070_ = '2805' and r011_ in ('4')) or
                                            (p070_ = '2806' and r011_ in ('5')) or
                                            (p070_ = '2809' and r011_ in ('6')) or
                                            (p070_ = '3003' and r011_ = '6' and r013_ ='9') or
                                            (p070_ = '3005' and r011_ = 'B' and r013_ ='9') or
                                            (p070_ = '3011' and r011_ = '5' and r013_ ='9') or
                                            (p070_ = '3012' and r011_ = '9' and r013_ ='9') or
                                            (p070_ = '3013' and r011_ in ('A','B','E','F','K') and r013_ = '9') or 
                                            (p070_ = '3014' and r011_ in ('N','O') and r013_ = '9') or
                                            (p070_ = '3040' and r011_ in ('4')) or
                                            (p070_ = '3041' and r011_ in ('2')) or
                                            (p070_ in ('3041','3042','3043','3044','3049') and r011_ =  '2') or 
                                            (p070_ = '3103' and r011_ in ('2','5') and r013_ = '9') or
                                            (p070_ = '3105' and r011_ in ('6','9') and r013_ = '9') or
                                            (p070_ = '3111' and r011_ in ('5') and r013_ = '9') or 
                                            (p070_ = '3112' and r011_ in ('7') and r013_ = '9') or
                                            (p070_ = '3113' and r011_ in ('A','B','D','E','F') and r013_ = '9') or
                                            (p070_ = '3114' and r011_ in ('K','L') and r013_ = '9') or
                                            (p070_ in ('3140','3141','3142','3143','3144','3211') and r011_ = '2') or
                                            (p070_ = '3212' and r011_ in ('3')) or
                                            (p070_ = '3213' and r011_ in ('5','6','8','9','A')) or
                                            (p070_ = '3214' and r011_ in ('B','C')) or
                                            (p070_ = '3540' and r011_ in ('2','3')) or
                                            (p070_ = '3541' and r011_ in ('2','4')) or
                                            (p070_ = '3542' and r011_ in ('1')) or
                                            (p070_ = '3548' and r011_ in ('2','4','6','8','A')) or
                                            (p070_ = '3578' and r011_ in ('1') and r013_ = '2' and tip_ not in ('SK9','OFR')) or
                                            (p070_ = '3560' and r011_ in ('1','3')) 
                                          )
                      then
                         w_ := '1';
                      else
...
------------------------------------------------------------------------------------------
-- блок для удаления показателей по договору для которого
-- сформирован показатель 125 и нет показателей 118,119,121,123
