...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/P_FD8_NN.sql =========*** Run *** 
PROMPT ===================================================================================== 
...
% VERSION     : 13/04/2017 (27/03/2017, 16/03/2017)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   INSERT --/*+APPEND PARALLEL (8) */ 
      ...
      SELECT rnk, nmk, prins, ost
        FROM (SELECT   /*+ordered */  
                 ...
                 WHERE s.rnk = c.rnk 
                   AND c.okpo like d.okpo || '%' 
                   AND d.link_group in (58, 655, 306)  
...
--                                       and substr(kodp,8,1) = 'Z'
                                  ( select ACC_NUM as NLS
                                     ...
                                     where REPORT_DATE = dat_
                                       and KF = GL.KF()
                                       and ACC_ID = acc_
                                       and p070_ = substr(FIELD_CODE,2,4)
                                       and substr(FIELD_CODE,8,1) = 'Z'
...
PROMPT *** Create  grants  P_FD8_NN ***
grant EXECUTE                                                                on P_FD8_NN        to BARS_ACCESS_DEFROLE;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/P_FD8_NN.sql =========*** End *** 
PROMPT ===================================================================================== 
