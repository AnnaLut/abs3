...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Table/NBUR_DM_BALANCES_YEARLY_ARCH.sql =====
PROMPT ===================================================================================== 


PROMPT *** ALTER_POLICY_INFO to NBUR_DM_BALANCES_YEARLY_ARCH ***


BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''NBUR_DM_BALANCES_YEARLY_ARCH'', ''CENTER'' , null, ''E'', ''E'', ''E'');
               bpa.alter_policy_info(''NBUR_DM_BALANCES_YEARLY_ARCH'', ''FILIAL'' , ''M'', ''M'', ''M'', ''M'');
               bpa.alter_policy_info(''NBUR_DM_BALANCES_YEARLY_ARCH'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
begin 
  execute immediate '
  CREATE TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH 
   (	REPORT_DATE DATE, 
	KF CHAR(6), 
...
PROMPT *** ALTER_POLICIES to NBUR_DM_BALANCES_YEARLY_ARCH ***
 exec bpa.alter_policies('NBUR_DM_BALANCES_YEARLY_ARCH');
...
COMMENT ON COLUMN BARS.NBUR_DM_BALANCES_YEARLY_ARCH.ACC_ID IS 'Iдентифiкатор рахунку';
COMMENT ON COLUMN BARS.NBUR_DM_BALANCES_YEARLY_ARCH.CUST_ID IS 'Iдентифiкатор контрагента';
...
PROMPT *** Create  constraint CC_DMBALSYEARLYARCH_RPTDT_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH MODIFY (REPORT_DATE CONSTRAINT CC_DMBALSYEARLYARCH_RPTDT_NN NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint CC_DMBALSYEARLYARCH_KF_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH MODIFY (KF CONSTRAINT CC_DMBALSYEARLYARCH_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMBALSYEARLYARCH_VERSION_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH MODIFY (VERSION_ID CONSTRAINT CC_DMBALSYEARLYARCH_VERSION_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMBALSYEARLYARCH_ACCID_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH MODIFY (ACC_ID CONSTRAINT CC_DMBALSYEARLYARCH_ACCID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMBALSYEARLYARCH_CUSTID ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH MODIFY (CUST_ID CONSTRAINT CC_DMBALSYEARLYARCH_CUSTID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMBALSYEARLYARCH_BAL ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH MODIFY (BAL CONSTRAINT CC_DMBALSYEARLYARCH_BAL NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMBALSYEARLYARCH_BALUAH ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH MODIFY (BAL_UAH CONSTRAINT CC_DMBALSYEARLYARCH_BALUAH NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMBALSYEARLYARCH_ADJBAL ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH MODIFY (ADJ_BAL CONSTRAINT CC_DMBALSYEARLYARCH_ADJBAL NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMBALSYEARLYARCH_ADJBALUAH ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_BALANCES_YEARLY_ARCH MODIFY (ADJ_BAL_UAH CONSTRAINT CC_DMBALSYEARLYARCH_ADJBALUAH NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  index UK_DMBALSYEARLYARCH ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UK_DMBALSYEARLYARCH ON BARS.NBUR_DM_BALANCES_YEARLY_ARCH (REPORT_DATE, KF, VERSION_ID, ACC_ID) 
...
PROMPT *** Create  grants  NBUR_DM_BALANCES_YEARLY_ARCH ***
grant SELECT                                                                 on NBUR_DM_BALANCES_YEARLY_ARCH to BARSREADER_ROLE;
grant SELECT                                                                 on NBUR_DM_BALANCES_YEARLY_ARCH to BARSUPL;
grant SELECT                                                                 on NBUR_DM_BALANCES_YEARLY_ARCH to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on NBUR_DM_BALANCES_YEARLY_ARCH to UPLD;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Table/NBUR_DM_BALANCES_YEARLY_ARCH.sql =====
PROMPT ===================================================================================== 
