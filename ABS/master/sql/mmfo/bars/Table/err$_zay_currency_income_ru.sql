...
PROMPT *** Create  grants  ERR$_ZAY_CURRENCY_INCOME_RU ***
grant SELECT                                                                 on ERR$_ZAY_CURRENCY_INCOME_RU to BARSREADER_ROLE;
grant SELECT                                                                 on ERR$_ZAY_CURRENCY_INCOME_RU to UPLD;
