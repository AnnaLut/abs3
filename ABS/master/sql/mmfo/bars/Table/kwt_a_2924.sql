...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''KWT_A_2924'', ''FILIAL'' , ''M'', ''M'', ''M'', ''M'');
               bpa.alter_policy_info(''KWT_A_2924'', ''WHOLE'' , null, ''E'', ''E'', ''E'');
               null;
           end; 
          '; 
END; 
...
COMMENT ON COLUMN BARS.KWT_A_2924.KF IS '';



PROMPT *** Create  grants  KWT_A_2924 ***
grant SELECT                                                                 on KWT_A_2924      to BARSREADER_ROLE;
grant SELECT                                                                 on KWT_A_2924      to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on KWT_A_2924      to UPLD;
