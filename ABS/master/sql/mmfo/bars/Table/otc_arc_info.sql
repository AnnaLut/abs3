...
COMMENT ON COLUMN BARS.OTC_ARC_INFO.CNT_LIM IS '';
COMMENT ON COLUMN BARS.OTC_ARC_INFO.CNT_TRANS IS '';
COMMENT ON COLUMN BARS.OTC_ARC_INFO.RUN_MODE IS '';
...
grant SELECT                                                                 on OTC_ARC_INFO    to BARSREADER_ROLE;
grant SELECT                                                                 on OTC_ARC_INFO    to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on OTC_ARC_INFO    to UPLD;
