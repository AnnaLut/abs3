...
begin 
  execute immediate 'create table EAD_SYNC_QUEUE
(
  id            NUMBER,
  crt_date      DATE,
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_EADSYNCQ1 ON BARS.EAD_SYNC_QUEUE (ID) 
...
PROMPT *** Create  constraint PK_EADSYNCQ1 ***
begin   
 execute immediate '
  ALTER TABLE BARS.EAD_SYNC_QUEUE ADD CONSTRAINT PK_EADSYNCQ1 PRIMARY KEY (ID)
...
PROMPT *** Create  constraint FK_EADSYNCQ_STSID_STATUSES1 ***
begin   
 execute immediate '
  ALTER TABLE BARS.EAD_SYNC_QUEUE ADD CONSTRAINT FK_EADSYNCQ_STSID_STATUSES1 FOREIGN KEY (STATUS_ID)
...
PROMPT *** Drop  constraint FK_EADSYNCQ_TID_TYPES1 ***
begin   
  execute immediate 'ALTER TABLE BARS.EAD_SYNC_QUEUE DROP CONSTRAINT FK_EADSYNCQ_TID_TYPES1';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-2443 then null; else raise; end if;
end;
/

PROMPT *** Create  constraint FK_EADSYNCQ_TID_TYPES1 ***
begin   
 execute immediate '
  ALTER TABLE BARS.EAD_SYNC_QUEUE ADD CONSTRAINT FK_EADSYNCQ_TID_TYPES1 FOREIGN KEY (TYPE_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.EAD_SYNC_QUEUE ADD CONSTRAINT FK_EADSYNCQUEUE_KF1 FOREIGN KEY (KF)
...
--ENABLE ROW MOVEMENT -- для возможности перемещения между партициями
PROMPT *** ALTER TABLE ENABLE_ROW MOVEMENT ***
ALTER TABLE EAD_SYNC_QUEUE ENABLE ROW MOVEMENT;
/
