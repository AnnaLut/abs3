...
COMMENT ON TABLE BARS.ACCM_SNAP_SCN IS 'SCN-ы последних генераций снимков баланса по партициям таблиц SALDOA, SALDOA_DEL_ROWS';
COMMENT ON COLUMN BARS.ACCM_SNAP_SCN.KF IS 'Код фiлiалу (МФО)';
