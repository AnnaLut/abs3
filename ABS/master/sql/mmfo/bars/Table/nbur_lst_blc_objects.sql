...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Table/NBUR_LST_BLC_OBJECTS.sql =========*** 
PROMPT ===================================================================================== 


PROMPT *** ALTER_POLICY_INFO to NBUR_LST_BLC_OBJECTS ***


BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''NBUR_LST_BLC_OBJECTS'', ''CENTER'' , null, ''E'', ''E'', ''E'');
               bpa.alter_policy_info(''NBUR_LST_BLC_OBJECTS'', ''FILIAL'' , ''M'', ''M'', ''E'', ''E'');
               bpa.alter_policy_info(''NBUR_LST_BLC_OBJECTS'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  table NBUR_LST_BLC_OBJECTS ***
begin 
  execute immediate '
  CREATE TABLE BARS.NBUR_LST_BLC_OBJECTS 
   (	REPORT_DATE DATE, 
	KF CHAR(6), 
...
PROMPT *** ALTER_POLICIES to NBUR_LST_BLC_OBJECTS ***
 exec bpa.alter_policies('NBUR_LST_BLC_OBJECTS');


COMMENT ON TABLE BARS.NBUR_LST_BLC_OBJECTS IS 'Список об`ектiв переформування яких заблоковано на звітну дату';
COMMENT ON COLUMN BARS.NBUR_LST_BLC_OBJECTS.REPORT_DATE IS 'Звiтна дата';
COMMENT ON COLUMN BARS.NBUR_LST_BLC_OBJECTS.KF IS 'Код фiлiалу (МФО)';
COMMENT ON COLUMN BARS.NBUR_LST_BLC_OBJECTS.VERSION_ID IS 'Ід. версії (для кожного фiлiалу своя)';
COMMENT ON COLUMN BARS.NBUR_LST_BLC_OBJECTS.OBJECT_ID IS 'Iдентифiкатор об`екту';
COMMENT ON COLUMN BARS.NBUR_LST_BLC_OBJECTS.BLOCKED_TIME IS 'Дата внесення відмітки про блокування';
COMMENT ON COLUMN BARS.NBUR_LST_BLC_OBJECTS.USER_NAME IS 'Логін користувача, що вніс відмітку';
...
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_LST_BLC_OBJECTS ADD CONSTRAINT UK_NBURLSTBLCOBJS UNIQUE (KF, REPORT_DATE, OBJECT_ID)
...
PROMPT *** Create  constraint CC_NBURLSTBLCOBJS_REPORTDT_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_LST_BLC_OBJECTS MODIFY (REPORT_DATE CONSTRAINT CC_NBURLSTBLCOBJS_REPORTDT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_NBURLSTBLCOBJS_VERSIONID_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_LST_BLC_OBJECTS MODIFY (VERSION_ID CONSTRAINT CC_NBURLSTBLCOBJS_VERSIONID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_NBURLSTBLCOBJS_OBJECTID_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_LST_BLC_OBJECTS MODIFY (OBJECT_ID CONSTRAINT CC_NBURLSTBLCOBJS_OBJECTID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_NBURLSTBLCOBJS_BLOCKEDTM_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_LST_BLC_OBJECTS MODIFY (BLOCKED_TIME CONSTRAINT CC_NBURLSTBLCOBJS_BLOCKEDTM_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_NBURLSTBLCOBJS_USERNM_NN ***
begin   
 execute immediate '
...
PROMPT *** Create  index UK_NBURLSTBLCOBJS ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UK_NBURLSTBLCOBJS ON BARS.NBUR_LST_BLC_OBJECTS (KF, REPORT_DATE, OBJECT_ID) 
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Table/NBUR_LST_BLC_OBJECTS.sql =========*** 
PROMPT ===================================================================================== 
