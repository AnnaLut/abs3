...
COMMENT ON TABLE BARS.P_MIGRAUNIC IS 'Справочник импорта Unicorn';
COMMENT ON COLUMN BARS.P_MIGRAUNIC.ACTION IS 'Действие';
COMMENT ON COLUMN BARS.P_MIGRAUNIC.PROCNAME IS 'Наименование процедуры импорта';
COMMENT ON COLUMN BARS.P_MIGRAUNIC.ERRMASK IS 'Маска ошибок';
COMMENT ON COLUMN BARS.P_MIGRAUNIC.ORDNUNG IS 'Порядок сортировки';
