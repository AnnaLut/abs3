...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''WCS_DOCEXPORT_TYPES'', ''CENTER'' , null, null, null, null);
...
COMMENT ON TABLE BARS.WCS_DOCEXPORT_TYPES IS 'Форматы экспорта печатных шаблонов';
COMMENT ON COLUMN BARS.WCS_DOCEXPORT_TYPES.ID IS 'Идентификатор';
COMMENT ON COLUMN BARS.WCS_DOCEXPORT_TYPES.NAME IS 'Наименование';
...
grant SELECT                                                                 on WCS_DOCEXPORT_TYPES to BARSREADER_ROLE;
grant SELECT                                                                 on WCS_DOCEXPORT_TYPES to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on WCS_DOCEXPORT_TYPES to BARS_DM;
grant SELECT                                                                 on WCS_DOCEXPORT_TYPES to UPLD;
