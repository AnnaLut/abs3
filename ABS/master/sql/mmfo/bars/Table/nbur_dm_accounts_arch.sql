...
COMMENT ON COLUMN BARS.NBUR_DM_ACCOUNTS_ARCH.ACC_ALT_DT IS 'Дата переходу на новий план рахунків згідно постанови НБУ №89 від 11.09.2017';
COMMENT ON COLUMN BARS.NBUR_DM_ACCOUNTS_ARCH.OB22_ALT IS '';
