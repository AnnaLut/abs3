...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CIG_D11'', ''CENTER'' , null, null, null, null);
...
COMMENT ON TABLE BARS.CIG_D11 IS 'D11 - Група економічної діяльності (Довідник НБУ kl_092)';
...
grant SELECT                                                                 on CIG_D11         to BARSREADER_ROLE;
grant DELETE,INSERT,SELECT,UPDATE                                            on CIG_D11         to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on CIG_D11         to BARS_DM;
grant SELECT                                                                 on CIG_D11         to CIG_ROLE;
grant SELECT                                                                 on CIG_D11         to UPLD;
