...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''BR_NORMAL_EDIT_UPDATE'', ''CENTER'' , null, null, null, null);
...
COMMENT ON COLUMN BARS.BR_NORMAL_EDIT_UPDATE.KF IS '';
COMMENT ON COLUMN BARS.BR_NORMAL_EDIT_UPDATE.IDUPD IS 'ѕервичный ключ дл€ таблицы обновлени€';
COMMENT ON COLUMN BARS.BR_NORMAL_EDIT_UPDATE.CHGACTION IS ' од обновлени€ (I/U/D)';
COMMENT ON COLUMN BARS.BR_NORMAL_EDIT_UPDATE.EFFECTDATE IS 'Ѕанковска€ дата начала действи€ параметров';
COMMENT ON COLUMN BARS.BR_NORMAL_EDIT_UPDATE.CHGDATE IS '—истемана€ дата обновлени€';
COMMENT ON COLUMN BARS.BR_NORMAL_EDIT_UPDATE.DONEBY IS ' од пользовател€. кто внес обновлени€(если в течении дн€ было несколько обновлений - остаетс€ только последнее)';
...
PROMPT *** Create  constraint CC_BRNORMALEDITUPDATE_KF_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.BR_NORMAL_EDIT_UPDATE MODIFY (KF CONSTRAINT CC_BRNORMALEDITUPDATE_KF_NN NOT NULL ENABLE NOVALIDATE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C005718 ***
begin   
 execute immediate '
  ALTER TABLE BARS.BR_NORMAL_EDIT_UPDATE MODIFY (BR_ID NOT NULL ENABLE NOVALIDATE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C005719 ***
begin   
 execute immediate '
  ALTER TABLE BARS.BR_NORMAL_EDIT_UPDATE MODIFY (BDATE NOT NULL ENABLE NOVALIDATE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C005720 ***
begin   
 execute immediate '
  ALTER TABLE BARS.BR_NORMAL_EDIT_UPDATE MODIFY (KV NOT NULL ENABLE NOVALIDATE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C005721 ***
begin   
 execute immediate '
  ALTER TABLE BARS.BR_NORMAL_EDIT_UPDATE MODIFY (BRANCH NOT NULL ENABLE NOVALIDATE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on BR_NORMAL_EDIT_UPDATE to BARSREADER_ROLE;
grant SELECT                                                                 on BR_NORMAL_EDIT_UPDATE to BARSUPL;
grant SELECT                                                                 on BR_NORMAL_EDIT_UPDATE to BARS_DM;
grant SELECT                                                                 on BR_NORMAL_EDIT_UPDATE to UPLD;
