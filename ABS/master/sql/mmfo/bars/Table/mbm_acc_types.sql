...
COMMENT ON TABLE BARS.MBM_ACC_TYPES IS 'Типи рахунків (спрощений розподіл)';
COMMENT ON COLUMN BARS.MBM_ACC_TYPES.TYPE_ID IS 'Тип рахунку';
COMMENT ON COLUMN BARS.MBM_ACC_TYPES.NAME IS 'Найменування типу';
