...
COMMENT ON COLUMN BARS.OB_CORP_SESS.D_TYPE IS 'Тип даних 1 - Дані';
...
PROMPT *** Create  constraint SYS_C0027397 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OB_CORP_SESS MODIFY (D_TYPE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
