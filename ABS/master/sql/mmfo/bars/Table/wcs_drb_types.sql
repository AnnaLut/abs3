...
COMMENT ON TABLE BARS.WCS_DRB_TYPES IS 'Типы ДРБ';
COMMENT ON COLUMN BARS.WCS_DRB_TYPES.ID IS 'Идентификатор';
COMMENT ON COLUMN BARS.WCS_DRB_TYPES.NAME IS 'Наименование';
