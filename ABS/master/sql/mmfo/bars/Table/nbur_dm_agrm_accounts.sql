...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Table/NBUR_DM_AGRM_ACCOUNTS.sql =========***
PROMPT ===================================================================================== 


PROMPT *** ALTER_POLICY_INFO to NBUR_DM_AGRM_ACCOUNTS ***


BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''NBUR_DM_AGRM_ACCOUNTS'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  table NBUR_DM_AGRM_ACCOUNTS ***
begin 
  execute immediate '
  CREATE TABLE BARS.NBUR_DM_AGRM_ACCOUNTS 
   (	REPORT_DATE DATE, 
	KF CHAR(6), 
	ACC_ID NUMBER(38,0), 
	AGRM_ID NUMBER(38,0), 
...
PROMPT *** ALTER_POLICIES to NBUR_DM_AGRM_ACCOUNTS ***
 exec bpa.alter_policies('NBUR_DM_AGRM_ACCOUNTS');


COMMENT ON TABLE BARS.NBUR_DM_AGRM_ACCOUNTS IS 'Зв`язок рахунків та договорів';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.PRTFL_TP IS 'Тип портфеля договорів';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.CCY_ID IS 'Валюта рахунку';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.BEG_DT IS 'Дата початку';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.END_DT IS 'Дата закінчення';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.AGRM_NUM IS 'Номер договору';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.AGRM_TP IS 'Вид договору (CC_VIDD.VIDD)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.AGRM_STE IS 'Стан договору (CC_SOS.SOS)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.AGRM_ID IS 'Ідентифікатор договору';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.KF IS 'Код філіалу (МФО)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.ACC_ID IS 'Iдентифiкатор рахунку (ACC)';
COMMENT ON COLUMN BARS.NBUR_DM_AGRM_ACCOUNTS.REPORT_DATE IS 'Звітна дата';




PROMPT *** Create  constraint CC_DMAGRMACCOUNTS_REPORTDT_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_AGRM_ACCOUNTS MODIFY (REPORT_DATE CONSTRAINT CC_DMAGRMACCOUNTS_REPORTDT_NN NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint CC_DMAGRMACCOUNTS_KF_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_AGRM_ACCOUNTS MODIFY (KF CONSTRAINT CC_DMAGRMACCOUNTS_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMAGRMACCOUNTS_ACNTID_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_AGRM_ACCOUNTS MODIFY (ACC_ID CONSTRAINT CC_DMAGRMACCOUNTS_ACNTID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMAGRMACCOUNTS_PRTFLTP_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_AGRM_ACCOUNTS MODIFY (PRTFL_TP CONSTRAINT CC_DMAGRMACCOUNTS_PRTFLTP_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint CC_DMAGRMACCOUNTS_CCYID_NN ***
begin   
 execute immediate '
  ALTER TABLE BARS.NBUR_DM_AGRM_ACCOUNTS MODIFY (CCY_ID CONSTRAINT CC_DMAGRMACCOUNTS_CCYID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  index UK_DMAGRMACCOUNTS ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UK_DMAGRMACCOUNTS ON BARS.NBUR_DM_AGRM_ACCOUNTS (KF, ACC_ID, AGRM_ID) 
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Table/NBUR_DM_AGRM_ACCOUNTS.sql =========***
PROMPT ===================================================================================== 
