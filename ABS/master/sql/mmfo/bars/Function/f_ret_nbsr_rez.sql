...
is
/*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    -- version  10.04.2017    (17.03.2017, 02.03.2016)

  10.04.2017  для 1502 счет резерва будет 1592 вместо 1590
...
begin
  ...
  then
      if substr(nlsa_,1,1) like '1%' then
         if substr(nlsa_,1,4) like '150%' then  --and substr(nlsa_,1,4) <> '1502' 
             nbsr_ := '1592';
