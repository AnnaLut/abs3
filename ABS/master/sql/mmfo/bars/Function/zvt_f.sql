...
IS
/*
24.04.2019 COBUMMFO-11466 всі операції проведені кодами D66 та D77 в папку 35 "Меморіальні (клієнтські) ручні"

20.07.2018 COBUMMFO-8319 Реалізація взаємодії між Банком, Біржою та Учасниками біржі при здійснені розрахунків відповідно до умов Договору Ескроу
Для формування документів дня в АБС, документи за бухгалтерськими проводками відносити в папки:
25 «Клієнт банк»-  Дт 2602 Кт 2600 та  Дт 2602 Кт  3570;
84 «Авт. Доходи»-  Дт 3570 Кт 6510.
...
BEGIN
   ...
   THEN
      t_ := 80;
   ELSIF     tt_ IN ('R01', 'I00', 'ZG9', '%%9', 'ARE') -- ARE - COBUMMFO-11355
         AND NBSd_ LIKE '7%'
   ...
   THEN
      ...
      ELSIF tt_ IN
               ('PKA',
                ...
                'PKY',
                'PKZ',
                'PXS')--COBUMMFO-11126 13.03.2019 Сербін
      THEN
         t_ := 86;                                                          --
      ELSE
  ...
  ELSIF     (   NBSD_ LIKE '260%'
   ...
   THEN
      t_ := 8;                                               -- Dt Forex paper
   ELSIF NBSd_ LIKE '7%' AND tt_ NOT IN ('PS0') AND tt_ NOT IN ('ARE') --ARE - COBUMMFO-11355
   THEN
      ...
      ELSE
        t_ := 39;
      END IF;
   ELSIF NBSk_ LIKE '7%' AND tt_ NOT IN ('PS0') AND tt_ NOT IN ('ARE') --ARE - COBUMMFO-11355
   THEN
      IF tt_ = 'MVN' THEN
     t_ := 27;
      ELSE
   ...
   THEN
      t_ := 84;
   --COBUMMFO-8319 Реалізація взаємодії між Банком, Біржою та Учасниками біржі при здійснені розрахунків відповідно до умов Договору Ескроу
   --Для формування документів дня в АБС, документи за бухгалтерськими проводками відносити в папки:
   --84 «Авт. Доходи»-  Дт 3570 Кт 6510.
   ELSIF NBSk_ = '6510' AND NBSd_ = '3570' AND tt_ = ('IBK')
   THEN
      t_ := 84;
  --COBUMMFO-8319 Реалізація взаємодії між Банком, Біржою та Учасниками біржі при здійснені розрахунків відповідно до умов Договору Ескроу
    --Для формування документів дня в АБС, документи за бухгалтерськими проводками відносити в папки:
    --25 «Клієнт банк» - Дт 2602 Кт  3570;
      ELSIF NBSk_ = '3570' AND NBSd_ = '2602' AND tt_ = ('IBC')
   THEN
      t_ := 25;
