           ...
           if -- з рахунку 2600, 2650 на 1919 (для ЦА та РУ)
             ...
             then l_res :=  0;
               ...
               select count(*) into l_n from oper o
                 where o.sos=5 and o.kv=980 and o.s=l_s
                   and substr(decode(o.dk, 1, o.nlsa, o.nlsb), 1, 4)='3739'
                   and decode(o.dk, 1, o.nlsb, o.nlsa)=p_nlsa
                   and o.vdat <= l_vdat and o.vdat >= l_vdat-4
