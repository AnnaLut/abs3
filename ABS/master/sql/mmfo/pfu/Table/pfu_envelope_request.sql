...
COMMENT ON TABLE PFU.PFU_ENVELOPE_REQUEST IS 'Запит на отримання конверту з даними для зарахувань пенсій';
COMMENT ON COLUMN PFU.PFU_ENVELOPE_REQUEST.ID IS '';
COMMENT ON COLUMN PFU.PFU_ENVELOPE_REQUEST.PFU_ENVELOPE_ID IS 'Ідентифікатор конверту, отриманого в результаті виконання запиту на отримання конвертів';
