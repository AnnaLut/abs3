...
COMMENT ON TABLE BARSUPL.UPL_MASTER IS 'Список мастер таблиц, которые будут содержать CKGK для подчиненных';
COMMENT ON COLUMN BARSUPL.UPL_MASTER.MASTER_ID IS 'Код';
COMMENT ON COLUMN BARSUPL.UPL_MASTER.DESCRIPT IS 'Описание';
