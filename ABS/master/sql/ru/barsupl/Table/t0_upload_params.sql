...
COMMENT ON TABLE BARSUPL.T0_UPLOAD_PARAMS IS 'Довідник параметрів вивантаження T0';
COMMENT ON COLUMN BARSUPL.T0_UPLOAD_PARAMS.PARAM_ID IS 'Ідентифікатор параметру';
COMMENT ON COLUMN BARSUPL.T0_UPLOAD_PARAMS.PARAM_NAME IS 'Назва параметру';
COMMENT ON COLUMN BARSUPL.T0_UPLOAD_PARAMS.PARAM_DESC IS 'Опис параметру';
COMMENT ON COLUMN BARSUPL.T0_UPLOAD_PARAMS.OBJECT_ID IS 'Ідентифікатор об`єкту в АБС';
