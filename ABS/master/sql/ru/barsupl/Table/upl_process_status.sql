...
COMMENT ON TABLE BARSUPL.UPL_PROCESS_STATUS IS 'Справочник статусов процесса выгрузки';
COMMENT ON COLUMN BARSUPL.UPL_PROCESS_STATUS.STATUS_ID IS 'Код статуса выгрузки';
COMMENT ON COLUMN BARSUPL.UPL_PROCESS_STATUS.STATUS_CODE IS 'Псевдо код статуса выгрузки';
COMMENT ON COLUMN BARSUPL.UPL_PROCESS_STATUS.DESCRIPT IS 'Описание статуса выгрузки';
