...
COMMENT ON TABLE BARSUPL.UPL_SQL IS 'SQL описание выгрузки';
COMMENT ON COLUMN BARSUPL.UPL_SQL.SQL_ID IS 'Ключ';
COMMENT ON COLUMN BARSUPL.UPL_SQL.SQL_TEXT IS 'Запрос';
COMMENT ON COLUMN BARSUPL.UPL_SQL.BEFORE_PROC IS 'pl/sql блок для выполнеия перед запросом';
COMMENT ON COLUMN BARSUPL.UPL_SQL.AFTER_PROC IS 'pl/sql блок для выполнеия после запроса';
COMMENT ON COLUMN BARSUPL.UPL_SQL.DESCRIPT IS 'Описание назначения выгрузки';
