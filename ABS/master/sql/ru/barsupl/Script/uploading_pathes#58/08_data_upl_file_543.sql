...
/
-- ***************************************************************************
-- ETL-21927   ANL - Не все файлы выгрузки дельты за 29.12.2017 по ГОУ и Киеву 
-- установить признак критичности на файлах
-- ***************************************************************************
...
Insert into BARSUPL.UPL_FILES
 ...
 Values (543, 543, 'PRVN_DEALS', 'prvn_deals', 0, '09', NULL, '10', 0, 'Таблиця КД-угод для сховища с доп. инфо на звитну дату', 543, 'null', 'WHOLE', 'ARR', 1, NULL, 1, 'AR', 1, 1);
