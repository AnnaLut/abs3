...
----  BARS.PRVN_FLOW.ADD2( 0, 0, l_report_date, 1 );
  BARS.PRVN_FLOW.SET_ADJ_SHD( l_report_date, 1 );
  commit;
end;');

Insert into BARSUPL.UPL_SQL (sql_id, sql_text, before_proc, after_proc, descript, vers)
 Values (7543, l_clob, l_clob1, NULL, 'Таблиця субугод КД для сховища на звітну дату (для FineVare)', '1.10');
...
Insert into BARSUPL.UPL_FILES
 ...
 Values (7543, 7543, 'PRVN_DEALS_T0', 'prvn_deals0', 0, '09', NULL, '10', 0, 'Таблиця КД-угод для сховища с доп. инфо на звитну дату', 7543, 'null', 'WHOLE', 'ARR', 1, NULL, 1, 'AR', 0, 1);
