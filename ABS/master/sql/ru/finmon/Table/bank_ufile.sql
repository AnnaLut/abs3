...
begin   
 execute immediate '
  ALTER TABLE FINMON.BANK_UFILE ADD CONSTRAINT FK_BANK_UFILE_FILE_ID FOREIGN KEY (FILE_ID)
...
PROMPT *** Create  constraint SYS_C002065657 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002065656 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002065655 ***
begin   
 execute immediate '
