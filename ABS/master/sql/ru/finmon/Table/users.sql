...
COMMENT ON TABLE FINMON.USERS IS 'Список пользователей программы';
COMMENT ON COLUMN FINMON.USERS.VDP_TYPE IS 'Тип пользователя (ADMN/OPER)';
...
COMMENT ON COLUMN FINMON.USERS.ID IS 'Идентификатор записи';
COMMENT ON COLUMN FINMON.USERS.VDP_POS IS 'Должность ';
COMMENT ON COLUMN FINMON.USERS.VDP_NM1 IS 'Фамилия';
COMMENT ON COLUMN FINMON.USERS.VDP_NM2 IS 'Имя';
COMMENT ON COLUMN FINMON.USERS.VDP_NM3 IS 'Отчество';
COMMENT ON COLUMN FINMON.USERS.VDP_TLF IS 'Телефон';
COMMENT ON COLUMN FINMON.USERS.VDP_EMAIL IS 'Электронный адрес';
COMMENT ON COLUMN FINMON.USERS.VDP_KEY IS 'Идентификатор ключа ЭЦП';
