...
PROMPT *** Create  sequence S_SPECPARAM_UPDATE ***
   ...
   CREATE SEQUENCE  BARS.S_SPECPARAM_UPDATE  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 13578395 CACHE 20 NOORDER  NOCYCLE ;
...
grant SELECT                                                                 on S_SPECPARAM_UPDATE to WR_ALL_RIGHTS;
