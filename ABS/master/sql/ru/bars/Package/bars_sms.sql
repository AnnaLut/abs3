...
g_header_version  constant varchar2(64)  := 'version 2.0 31/08/2010';
...
g_body_version  constant varchar2(64)  := 'version 2.1 01/08/2014';
...
begin
    ...
    --
    insert
      into msg_submit_data(msg_id, creation_time, expiration_time, phone, encode, msg_text)
    values (p_msgid, p_creation_time, p_expiration_time, p_phone, p_encode, p_msg_text);
    --
end create_msg;
