 ...
 PROMPT ===================================================================================== 
  ...
  CREATE OR REPLACE FUNCTION BARS.F_CHECK_INSIDER (p_nlsa accounts.nls%type, p_kva accounts.kv%type, p_nlsb accounts.nls%type, p_kvb accounts.kv%type, p_dk number) return varchar2
is
