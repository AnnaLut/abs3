 ...
 PROMPT ===================================================================================== 
 PROMPT *** Run *** ========== Scripts /Sql/BARS/function/f_pop_otcn_gi.sql =========*** Run 
 PROMPT ===================================================================================== 
 
  CREATE OR REPLACE FUNCTION BARS.F_POP_OTCN_GI (Dat_ DATE, type_ NUMBER,
                                       sql_acc_ VARCHAR2,
...
% VERSION     : 28.10.2009 (29.02.2008,18.01.2008,08.02.2007,16.02.2006)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
параметры:
  Dat_ - отчетная дата
...
29.02.2008 - для переменной Dat3_ берем последний рабочий месяца начала
             ...
             vob in (96, 196))
04.10.2009 для отчетной даты 30.09.2009 и МФО=333398(Луцк) обороты будем
           накапливать с 20.09.2009
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
...
if f_ourmfo=311647 and dat_=to_date('30102009','ddmmyyyy') then
   dat1_ := to_date('24102009','ddmmyyyy');
end if;
      ...
      IF type_ = 5 THEN -- для сальдовок за пер_од
         ...
         UPDATE OTCN_SALDO a
          SET  a.vost=NVL(Fost(a.acc, datv_), 0), -- вх_дний залишок
               a.vostq=DECODE(a.kv, 980, 0, NVL(Fostq(a.acc, datv_), 0)), -- екв. вх_дного залишку
...
/
 ...
 PROMPT ===================================================================================== 
 PROMPT *** End *** ========== Scripts /Sql/BARS/function/f_pop_otcn_gi.sql =========*** End 
 PROMPT ===================================================================================== 
