...
PROMPT *** Create  constraint FK_ASNPARAM_PARAMT ***
begin   
 execute immediate '
  ALTER TABLE BARS.ASYNC_PARAM ADD CONSTRAINT FK_ASNPARAM_PARAMT FOREIGN KEY (PARAM_TYPE)
	  REFERENCES BARS.ASYNC_PARAM_TYPE (PARAM_TYPE) ENABLE';
exception when others then
