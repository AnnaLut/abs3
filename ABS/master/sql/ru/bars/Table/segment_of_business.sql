...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''SEGMENT_OF_BUSINESS'', ''FILIAL'' , null, null, null, null);
...
COMMENT ON COLUMN BARS.SEGMENT_OF_BUSINESS.ID IS 'Ідентифікатор сегменту бізнесу';
COMMENT ON COLUMN BARS.SEGMENT_OF_BUSINESS.SEGMENT_CODE IS 'Код сегменту бізнесу';
COMMENT ON COLUMN BARS.SEGMENT_OF_BUSINESS.SEGMENT_NAME IS 'Назва сегменту бізнесу';
