...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_SYNC_PARAMS MODIFY (IS_SYNC CONSTRAINT CC_CIGDOGSYNCPAR_SYNC_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_SYNC_PARAMS MODIFY (DATA_TYPE CONSTRAINT CC_CIGDOGSYNCPAR_DATATYPE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_SYNC_PARAMS MODIFY (MFO CONSTRAINT CC_CIGDOGSYNCPAR_MFO_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
