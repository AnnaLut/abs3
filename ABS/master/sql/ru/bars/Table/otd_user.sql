...
begin   
 execute immediate '
  ALTER TABLE BARS.OTD_USER ADD CONSTRAINT FK_OTDUSER_OTDEL FOREIGN KEY (OTD)
	  REFERENCES BARS.OTDEL (ID) ENABLE';
exception when others then
...
PROMPT *** Create  constraint SYS_C0010771 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0010770 ***
begin   
 execute immediate '
...
grant DELETE,INSERT,SELECT,UPDATE                                            on OTD_USER        to BARS_ACCESS_DEFROLE;
