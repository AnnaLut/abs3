...
BEGIN 
        execute immediate  
          'begin  
               ...
               bpa.alter_policy_info(''STAFF_AD_USER'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  index I_STAFF_AD_USER_DOMAIN_NAME ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.I_STAFF_AD_USER_DOMAIN_NAME ON BARS.STAFF_AD_USER (ACTIVE_DIRECTORY_NAME) 
...
PROMPT *** Create  index I_STAFF_AD_USER_ID ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.I_STAFF_AD_USER_ID ON BARS.STAFF_AD_USER (USER_ID) 
...
grant FLASHBACK,SELECT                                                       on STAFF_AD_USER   to WR_REFREAD;
