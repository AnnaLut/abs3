...
PROMPT *** Create  constraint SYS_C001705741 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTC_F4A_HISTORY_ACC MODIFY (KV NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C001705740 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTC_F4A_HISTORY_ACC MODIFY (NLS NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C001705739 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTC_F4A_HISTORY_ACC MODIFY (ACC NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C001705738 ***
begin   
 execute immediate '
  ALTER TABLE BARS.OTC_F4A_HISTORY_ACC MODIFY (DATF NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
