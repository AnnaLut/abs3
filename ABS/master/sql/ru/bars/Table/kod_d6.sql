...
grant DELETE,INSERT,SELECT,UPDATE                                            on KOD_D6          to ABS_ADMIN;
grant DELETE,INSERT,SELECT,UPDATE                                            on KOD_D6          to BARS_ACCESS_DEFROLE;
grant DELETE,INSERT,SELECT,UPDATE                                            on KOD_D6          to KOD_D6;
grant SELECT                                                                 on KOD_D6          to RPBN002;
grant SELECT                                                                 on KOD_D6          to START1;
grant DELETE,FLASHBACK,INSERT,SELECT,UPDATE                                  on KOD_D6          to WR_ALL_RIGHTS;
