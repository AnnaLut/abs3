...
PROMPT *** Create  constraint FK_KLPQUEUEA_ACC ***
begin   
 execute immediate '
  ALTER TABLE BARS.KLP_QUEUEA ADD CONSTRAINT FK_KLPQUEUEA_ACC FOREIGN KEY (ACC)
...
PROMPT *** Create  constraint FK_KLPQUEUEA_SAB ***
begin   
 execute immediate '
  ALTER TABLE BARS.KLP_QUEUEA ADD CONSTRAINT FK_KLPQUEUEA_SAB FOREIGN KEY (SAB)
	  REFERENCES BARS.CUSTOMER (SAB) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C00735971 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C00735970 ***
begin   
 execute immediate '
