...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''ZAY_DATA_TRANSFER'', ''FILIAL'' , null, null, null, null);
...
begin   
 execute immediate '
  ALTER TABLE BARS.ZAY_DATA_TRANSFER MODIFY (TRANSFER_RESULT CONSTRAINT CC_ZAYDATTRANSRESULT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ZAY_DATA_TRANSFER MODIFY (TRANSFER_DATE CONSTRAINT CC_ZAYDATTRANSDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ZAY_DATA_TRANSFER MODIFY (TRANSFER_TYPE CONSTRAINT CC_ZAYDATTRANSTYPE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ZAY_DATA_TRANSFER MODIFY (MFO CONSTRAINT CC_ZAYDATTRANSMFO_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ZAY_DATA_TRANSFER MODIFY (URL CONSTRAINT CC_ZAYDATTRANSURL_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
