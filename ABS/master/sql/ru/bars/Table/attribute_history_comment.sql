...
PROMPT *** Create  constraint FK_ATTR_DEL_REF_ATTR_HIST ***
begin   
 execute immediate '
  ALTER TABLE BARS.ATTRIBUTE_HISTORY_COMMENT ADD CONSTRAINT FK_ATTR_DEL_REF_ATTR_HIST FOREIGN KEY (HISTORY_ID)
...
PROMPT *** Create  constraint SYS_C002861365 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861364 ***
begin   
 execute immediate '
