...
PROMPT *** Create  constraint XPK_SREZERVOB22 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SREZERV_OB22 ADD CONSTRAINT XPK_SREZERVOB22 PRIMARY KEY (NBS, OB22, S080, CUSTTYPE, KV, PR, NAL)
...
PROMPT *** Create  index XPK_SREZERVOB22 ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.XPK_SREZERVOB22 ON BARS.SREZERV_OB22 (NBS, OB22, S080, CUSTTYPE, KV, PR, NAL) 
...
grant SELECT                                                                 on SREZERV_OB22    to BARS_SUP;
