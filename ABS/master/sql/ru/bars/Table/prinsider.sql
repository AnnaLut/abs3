...
PROMPT *** Create  constraint SYS_C0010891 ***
begin   
 execute immediate '
...
grant ALTER,DEBUG,DELETE,FLASHBACK,INDEX,INSERT,ON COMMIT REFRESH,QUERY REWRITE,REFERENCES,SELECT,UPDATE on PRINSIDER       to BARS_DM;
grant SELECT                                                                 on PRINSIDER       to BARS_SUP;
...
PROMPT *** Create SYNONYM  to PRINSIDER ***
  ...
  CREATE OR REPLACE SYNONYM BARSDWH_ACCESS_USER.PRINSIDER FOR BARS.PRINSIDER;
