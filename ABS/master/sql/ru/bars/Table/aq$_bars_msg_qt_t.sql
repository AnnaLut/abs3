...
PROMPT *** Create  constraint SYS_IOT_TOP_2139472 ***
begin   
 execute immediate '
...
PROMPT *** Create  index SYS_IOT_TOP_2139472 ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.SYS_IOT_TOP_2139472 ON BARS.AQ$_BARS_MSG_QT_T (NEXT_DATE, TXN_ID, MSGID) 
