...
PROMPT *** Create  constraint FK_SMS_CLEARANCE_ACC_3570 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SMS_ACC_CLEARANCE ADD CONSTRAINT FK_SMS_CLEARANCE_ACC_3570 FOREIGN KEY (ACC_CLEARANCE)
...
PROMPT *** Create  constraint FK_SMS_CLEARANCE_ACC ***
begin   
 execute immediate '
  ALTER TABLE BARS.SMS_ACC_CLEARANCE ADD CONSTRAINT FK_SMS_CLEARANCE_ACC FOREIGN KEY (ACC)
	  REFERENCES BARS.ACCOUNTS (ACC) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
