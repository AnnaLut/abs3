...
PROMPT *** Create  constraint SYS_C003177357 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCT_SCORING MODIFY (SCORING_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177356 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCT_SCORING MODIFY (SUBPRODUCT_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
