...
PROMPT *** Create  constraint PK_W4PRODUCTMASK ***
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_MASK ADD CONSTRAINT PK_W4PRODUCTMASK PRIMARY KEY (CODE)
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_MASK MODIFY (TIP CONSTRAINT CC_W4PRODUCTMASK_TIP_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_MASK MODIFY (OB22 CONSTRAINT CC_W4PRODUCTMASK_OB22_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_MASK MODIFY (NBS CONSTRAINT CC_W4PRODUCTMASK_NBS_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_MASK MODIFY (KV CONSTRAINT CC_W4PRODUCTMASK_KV_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_MASK MODIFY (GRP_CODE CONSTRAINT CC_W4PRODUCTMASK_GRPCODE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_MASK MODIFY (NAME CONSTRAINT CC_W4PRODUCTMASK_NAME_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_PRODUCT_MASK MODIFY (CODE CONSTRAINT CC_W4PRODUCTMASK_CODE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  index PK_W4PRODUCTMASK ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_W4PRODUCTMASK ON BARS.W4_PRODUCT_MASK (CODE) 
