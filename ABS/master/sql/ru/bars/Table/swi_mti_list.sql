...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''SWI_MTI_LIST'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
grant DELETE,FLASHBACK,INSERT,SELECT,UPDATE                                  on SWI_MTI_LIST    to BARS_ACCESS_DEFROLE;
grant DELETE,INSERT,SELECT,UPDATE                                            on SWI_MTI_LIST    to START1;
grant FLASHBACK,SELECT                                                       on SWI_MTI_LIST    to WR_REFREAD;
