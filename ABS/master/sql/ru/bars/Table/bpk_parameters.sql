...
PROMPT *** Create  constraint FK_BPKPARAMETERS_BPKTAGS ***
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PARAMETERS ADD CONSTRAINT FK_BPKPARAMETERS_BPKTAGS FOREIGN KEY (TAG)
	  REFERENCES BARS.BPK_TAGS (TAG) ENABLE';
exception when others then
