...
PROMPT *** Create  constraint SYS_C002755403 ***
begin   
 execute immediate '
  ALTER TABLE BARS.STO_SEP_ORDER MODIFY (RECEIVER_EDRPOU NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002755402 ***
begin   
 execute immediate '
  ALTER TABLE BARS.STO_SEP_ORDER MODIFY (RECEIVER_NAME NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002755401 ***
begin   
 execute immediate '
  ALTER TABLE BARS.STO_SEP_ORDER MODIFY (RECEIVER_ACCOUNT NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002755400 ***
begin   
 execute immediate '
  ALTER TABLE BARS.STO_SEP_ORDER MODIFY (RECEIVER_MFO NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002755399 ***
begin   
 execute immediate '
  ALTER TABLE BARS.STO_SEP_ORDER MODIFY (ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on STO_SEP_ORDER   to BARS_DM;
