...
COMMENT ON TABLE BARS.STAFF_TABN IS 'Табельні номера користувачів для підтвердження';
COMMENT ON COLUMN BARS.STAFF_TABN.ID IS 'Ід. користувачв';
COMMENT ON COLUMN BARS.STAFF_TABN.TABN IS 'Табельний номер';
COMMENT ON COLUMN BARS.STAFF_TABN.GRANTOR IS 'Ід. користувача, що змінив атрибут';
