...
PROMPT *** Create  constraint FK_CIMAPELINK_APEID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_APE_LINK ADD CONSTRAINT FK_CIMAPELINK_APEID FOREIGN KEY (APE_ID)
	  REFERENCES BARS.CIM_CONTRACTS_APE (APE_ID) ENABLE';
exception when others then
...
PROMPT *** Create  constraint FK_CIMAPELINK_SC ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_APE_LINK ADD CONSTRAINT FK_CIMAPELINK_SC FOREIGN KEY (SERVICE_CODE)
	  REFERENCES BARS.CIM_APE_SERVICECODE (CODE_ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_CIMAPELINK_FANTOMID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_APE_LINK ADD CONSTRAINT FK_CIMAPELINK_FANTOMID FOREIGN KEY (FANTOM_ID)
...
PROMPT *** Create  constraint FK_CIMPAELINK_PAYMENTID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_APE_LINK ADD CONSTRAINT FK_CIMPAELINK_PAYMENTID FOREIGN KEY (PAYMENT_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_APE_LINK ADD CONSTRAINT CC_CIMAPELINK_PAYMENT_CHECK CHECK (PAYMENT_ID IS NULL OR FANTOM_ID IS NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_APE_LINK MODIFY (SERVICE_CODE CONSTRAINT CC_CIMAPELINK_SCODE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_APE_LINK    to BARS_ACCESS_DEFROLE;
