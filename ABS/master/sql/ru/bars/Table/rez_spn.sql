...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''REZ_SPN'', ''FILIAL'' , ''E'', ''E'', ''E'', ''E'');
               bpa.alter_policy_info(''REZ_SPN'', ''WHOLE'' , ''E'', ''E'', ''E'', ''E'');
               null;
           end; 
          '; 
END; 
...
grant DELETE,FLASHBACK,INSERT,SELECT,UPDATE                                  on REZ_SPN         to WR_REFREAD;
