...
COMMENT ON COLUMN BARS.WCS_PRODUCTS.START_DATE IS '';
COMMENT ON COLUMN BARS.WCS_PRODUCTS.END_DATE IS '';
...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_PRODUCTS ADD CONSTRAINT CC_WCSPRODUCTS_NAME_NN CHECK (NAME IS NOT NULL) ENABLE';
exception when others then
...
PROMPT *** Create  constraint SYS_C003176995 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_PRODUCTS MODIFY (START_DATE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003176994 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_PRODUCTS MODIFY (ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
