...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''PEREKR_S'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''PEREKR_S'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
begin   
 execute immediate '
  ALTER TABLE BARS.PEREKR_S ADD CONSTRAINT PK_PEREKRS PRIMARY KEY (IDS)
...
PROMPT *** Create  constraint SYS_C0010843 ***
begin   
 execute immediate '
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_PEREKRS ON BARS.PEREKR_S (IDS) 
