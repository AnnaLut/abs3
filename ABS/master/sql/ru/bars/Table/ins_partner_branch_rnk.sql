...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''INS_PARTNER_BRANCH_RNK'', ''FILIAL'' , null, null, null, null);
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PARTNER_BRANCH_RNK ADD CONSTRAINT FK_PTRBRANCHRNK_PID_PARTNERS FOREIGN KEY (PARTNER_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PARTNER_BRANCH_RNK ADD CONSTRAINT PK_PTRBRANCHRNK PRIMARY KEY (PARTNER_ID, BRANCH)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_PTRBRANCHRNK ON BARS.INS_PARTNER_BRANCH_RNK (PARTNER_ID, BRANCH) 
