...
PROMPT *** Create  constraint FK_OWREPTT_TTS ***
begin   
 execute immediate '
  ALTER TABLE BARS.OW_REP_TT ADD CONSTRAINT FK_OWREPTT_TTS FOREIGN KEY (TT)
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_REP_TT MODIFY (NAZN CONSTRAINT CC_OWREPTT_NAZN_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_REP_TT MODIFY (TT CONSTRAINT CC_OWREPTT_TT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
