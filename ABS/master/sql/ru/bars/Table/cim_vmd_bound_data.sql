...
PROMPT *** Create  constraint FK_CIMVMDBOUNDDATA_RNK ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND_DATA ADD CONSTRAINT FK_CIMVMDBOUNDDATA_RNK FOREIGN KEY (RNK)
...
PROMPT *** Create  constraint FK_CIMVMDBOUNDDATA_BENEFS ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND_DATA ADD CONSTRAINT FK_CIMVMDBOUNDDATA_BENEFS FOREIGN KEY (BENEF_ID)
...
PROMPT *** Create  constraint FK_CIMVMDBOUNDDATA_ID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND_DATA ADD CONSTRAINT FK_CIMVMDBOUNDDATA_ID FOREIGN KEY (BOUND_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND_DATA MODIFY (BOUND_ID CONSTRAINT CC_CIMVMDBOUNDDATA_ID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND_DATA MODIFY (BENEF_ID CONSTRAINT CC_CIMVMDBOUNDDATA_BENEFID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_VMD_BOUND_DATA MODIFY (RNK CONSTRAINT CC_CIMVMDBOUNDDATA_RNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_VMD_BOUND_DATA to BARS_ACCESS_DEFROLE;
