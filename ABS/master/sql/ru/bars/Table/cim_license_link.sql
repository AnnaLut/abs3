...
PROMPT *** Create  constraint FK_CIMLCLINK_LICENSEID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE_LINK ADD CONSTRAINT FK_CIMLCLINK_LICENSEID FOREIGN KEY (LICENSE_ID)
	  REFERENCES BARS.CIM_LICENSE (LICENSE_ID) ENABLE';
exception when others then
...
PROMPT *** Create  constraint FK_CIMLCLINK_FANTOMID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE_LINK ADD CONSTRAINT FK_CIMLCLINK_FANTOMID FOREIGN KEY (FANTOM_ID)
...
PROMPT *** Create  constraint FK_CIMLCLINK_PAYMENTID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE_LINK ADD CONSTRAINT FK_CIMLCLINK_PAYMENTID FOREIGN KEY (PAYMENT_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE_LINK ADD CONSTRAINT CC_CIMLCLINK_PAYMENT_CHECK CHECK (FANTOM_ID IS NULL OR PAYMENT_ID IS NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE_LINK MODIFY (CREATE_UID CONSTRAINT CC_CIMLCLINK_CREATEUID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE_LINK MODIFY (CREATE_DATE CONSTRAINT CC_CIMLCLINK_CREATEDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE_LINK MODIFY (S CONSTRAINT CC_CIMLCLINK_S_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE_LINK MODIFY (OKPO CONSTRAINT CC_CIMLCLINK_OKPO_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LICENSE_LINK MODIFY (LICENSE_ID CONSTRAINT CC_CIMLCLINK_LICENSEID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_LICENSE_LINK to BARS_ACCESS_DEFROLE;
