...
PROMPT *** Create  constraint FK_FM_REF_QUE_REF ***
begin   
 execute immediate '
  ALTER TABLE BARS.FM_REF_QUE ADD CONSTRAINT FK_FM_REF_QUE_REF FOREIGN KEY (REF)
...
grant SELECT,UPDATE                                                          on FM_REF_QUE      to FINMON01;
