...
PROMPT *** Create  constraint XFK_RNKPKODACC_ACC ***
begin   
 execute immediate '
  ALTER TABLE BARS.RNKP_KOD_ACC ADD CONSTRAINT XFK_RNKPKODACC_ACC FOREIGN KEY (ACC)
...
begin   
 execute immediate '
  ALTER TABLE BARS.RNKP_KOD_ACC ADD CONSTRAINT XFK_RNKPKODACC_KODK FOREIGN KEY (KODK)
	  REFERENCES BARS.KOD_CLI (KOD_CLI) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
