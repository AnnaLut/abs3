...
PROMPT *** Create  constraint FK_ZAGK_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.ZAG_K ADD CONSTRAINT FK_ZAGK_OPER FOREIGN KEY (KF, REF)
...
begin   
 execute immediate '
  ALTER TABLE BARS.ZAG_K MODIFY (KF CONSTRAINT CC_ZAGK_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
