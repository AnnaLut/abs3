...
PROMPT *** Create  constraint SYS_C002685878 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_PF1_PF2 MODIFY (PF2 NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002685877 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_PF1_PF2 MODIFY (PF1 NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
