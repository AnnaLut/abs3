...
PROMPT *** Create  constraint SYS_C002491074 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002491073 ***
begin   
 execute immediate '
...
PROMPT *** Create  index SYS_C002491074 ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.SYS_C002491074 ON BARS.DICT_PURPOSE_TRANS (ID) 
