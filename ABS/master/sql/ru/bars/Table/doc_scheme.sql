...
begin   
 execute immediate '
  ALTER TABLE BARS.DOC_SCHEME ADD CONSTRAINT CC_DOCSCHEME_POB CHECK (print_on_blank in (0,1)) ENABLE';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.DOC_SCHEME ADD CONSTRAINT CC_DOCSCHEME_POB_NN CHECK (PRINT_ON_BLANK IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DOC_SCHEME MODIFY (NAME CONSTRAINT CC_DOCSCHEME_NAME_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DOC_SCHEME MODIFY (ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DOC_SCHEME ADD CONSTRAINT CC_DOCSCHEME_FR CHECK (fr in (0,1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant DELETE,INSERT,SELECT,UPDATE                                            on DOC_SCHEME      to BARS_ACCESS_DEFROLE;
