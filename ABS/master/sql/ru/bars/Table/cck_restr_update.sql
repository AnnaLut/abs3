...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CCK_RESTR_UPDATE'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''CCK_RESTR_UPDATE'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
grant SELECT                                                                 on CCK_RESTR_UPDATE to BARS_SUP;
