...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_QUESTION_MATRIX_PARAMS ADD CONSTRAINT CC_QUESTMATRIXPARS_ORD_NN CHECK (ORD IS NOT NULL) ENABLE';
exception when others then
...
PROMPT *** Create  constraint SYS_C003177018 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_QUESTION_MATRIX_PARAMS MODIFY (AXIS_QID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177017 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_QUESTION_MATRIX_PARAMS MODIFY (QUESTION_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
