...
COMMENT ON TABLE BARS.OTCN_F42_ZALOG IS 'Временная таблица счетов и остатков залогов по кредитным договорам';
...
PROMPT *** Create  constraint SYS_C0010745 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0010744 ***
begin   
 execute immediate '
