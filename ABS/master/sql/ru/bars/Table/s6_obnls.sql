...
PROMPT *** Create  constraint SYS_C0097555 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097554 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097553 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097552 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097551 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097550 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097549 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0097548 ***
begin   
 execute immediate '
...
PROMPT *** Create  index UI_S6OBNLS ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UI_S6OBNLS ON BARS.S6_OBNLS (NLS, I_VA, DA) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE BRSDYND ';
exception when others then
  if  sqlcode=-955  then null; else raise; end if;
