...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''SW_BANKS'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
grant DELETE,INSERT,SELECT,UPDATE                                            on SW_BANKS        to ABS_ADMIN;
...
grant SELECT                                                                 on SW_BANKS        to BARS_ACCESS_DEFROLE;
