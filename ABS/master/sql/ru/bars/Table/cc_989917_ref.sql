...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CC_989917_REF'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''CC_989917_REF'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint FK_CC989917REF_OPER2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CC_989917_REF ADD CONSTRAINT FK_CC989917REF_OPER2 FOREIGN KEY (KF, REF2)
...
PROMPT *** Create  constraint FK_CC989917REF_OPER1 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CC_989917_REF ADD CONSTRAINT FK_CC989917REF_OPER1 FOREIGN KEY (KF, REF1)
	  REFERENCES BARS.OPER (KF, REF) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint SYS_C002108418 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002108417 ***
begin   
 execute immediate '
