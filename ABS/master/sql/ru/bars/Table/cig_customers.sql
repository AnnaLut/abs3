...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CIG_CUSTOMERS'', ''FILIAL'' , null, null, null, null);
...
PROMPT *** Create  constraint FK_CIGCUSTOMERS_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUSTOMERS ADD CONSTRAINT FK_CIGCUSTOMERS_BRANCH FOREIGN KEY (BRANCH)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUSTOMERS MODIFY (CUST_CODE CONSTRAINT CC_CIGCUSTOMERS_CUSTCODE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUSTOMERS MODIFY (CUST_NAME CONSTRAINT CC_CIGCUSTOMERS_NAME_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUSTOMERS MODIFY (BRANCH CONSTRAINT CC_CIGCUSTOMERS_BRANCH_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUSTOMERS MODIFY (RNK CONSTRAINT CC_CIGCUSTOMERS_RNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUSTOMERS MODIFY (CUST_TYPE CONSTRAINT CC_CIGCUSTOMERS_CUSTTYPE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUSTOMERS MODIFY (CUST_ID CONSTRAINT CC_CIGCUSTOMERS_CUSTID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
