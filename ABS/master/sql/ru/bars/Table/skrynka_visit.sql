...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''SKRYNKA_VISIT'', ''FILIAL'' , ''Q'', ''Q'', ''Q'', ''Q'');
...
begin   
 execute immediate '
  ALTER TABLE BARS.SKRYNKA_VISIT MODIFY (DATOUT CONSTRAINT NN_SKRYNKA_VISIT_DATOUT NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SKRYNKA_VISIT MODIFY (DATIN CONSTRAINT NN_SKRYNKA_VISIT_DATIN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SKRYNKA_VISIT MODIFY (ND CONSTRAINT NN_SKRYNKA_VISIT_ND NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SKRYNKA_VISIT MODIFY (KF CONSTRAINT CC_SKRYNKAVISIT_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SKRYNKA_VISIT MODIFY (BRANCH CONSTRAINT CC_SKRYNKAVISIT_BRANCH_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
