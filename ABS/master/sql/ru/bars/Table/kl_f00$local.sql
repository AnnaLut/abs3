...
PROMPT *** Create  constraint PK_KLFLOC ***
begin   
 execute immediate '
  ALTER TABLE BARS.KL_F00$LOCAL ADD CONSTRAINT PK_KLFLOC PRIMARY KEY (POLICY_GROUP, BRANCH, KODF, A017)
...
PROMPT *** Create  index PK_KLFLOC ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_KLFLOC ON BARS.KL_F00$LOCAL (POLICY_GROUP, BRANCH, KODF, A017) 
