...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''PROC_DR$BASE'', ''FILIAL'' , ''B'', ''B'', ''B'', ''B'');
               bpa.alter_policy_info(''PROC_DR$BASE'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint SYS_C0010898 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0010897 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0010896 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0010895 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0010894 ***
begin   
 execute immediate '
