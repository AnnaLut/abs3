...
COMMENT ON TABLE BARS.ADDRESS_LOCALITY_TYPE IS 'Типы населенных пунктов';
COMMENT ON COLUMN BARS.ADDRESS_LOCALITY_TYPE.ID IS 'Идентификатор';
COMMENT ON COLUMN BARS.ADDRESS_LOCALITY_TYPE.NAME IS 'Наименование';
COMMENT ON COLUMN BARS.ADDRESS_LOCALITY_TYPE.VALUE IS 'Значение';
...
grant SELECT                                                                 on ADDRESS_LOCALITY_TYPE to CUST001;
grant SELECT                                                                 on ADDRESS_LOCALITY_TYPE to START1;
grant DELETE,FLASHBACK,INSERT,SELECT,UPDATE                                  on ADDRESS_LOCALITY_TYPE to WR_ALL_RIGHTS;
grant SELECT                                                                 on ADDRESS_LOCALITY_TYPE to WR_CUSTREG;
