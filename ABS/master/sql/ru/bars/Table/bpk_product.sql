...
PROMPT *** Create  constraint FK_BPKPRODUCT_PS ***
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT ADD CONSTRAINT FK_BPKPRODUCT_PS FOREIGN KEY (NBS)
...
PROMPT *** Create  constraint FK_BPKPRODUCT_DEMANDCONDSET ***
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT ADD CONSTRAINT FK_BPKPRODUCT_DEMANDCONDSET FOREIGN KEY (CARD_TYPE, COND_SET)
	  REFERENCES BARS.DEMAND_COND_SET (CARD_TYPE, COND_SET) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_BPKPRODUCT_DEMANDACCTYPE ***
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT ADD CONSTRAINT FK_BPKPRODUCT_DEMANDACCTYPE FOREIGN KEY (TYPE)
	  REFERENCES BARS.DEMAND_ACC_TYPE (TYPE) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_BPKPRODUCT_DEMANDCARDTYPE ***
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT ADD CONSTRAINT FK_BPKPRODUCT_DEMANDCARDTYPE FOREIGN KEY (CARD_TYPE)
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT ADD CONSTRAINT CC_BPKPRODUCT_LIMIT CHECK (limit in (0,1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (LIMIT CONSTRAINT CC_BPKPRODUCT_LIMIT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (OB22 CONSTRAINT CC_BPKPRODUCT_OB22_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (NBS CONSTRAINT CC_BPKPRODUCT_NBS_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (COND_SET CONSTRAINT CC_BPKPRODUCT_CONDSET_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (KK CONSTRAINT CC_BPKPRODUCT_KK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (KV CONSTRAINT CC_BPKPRODUCT_KV_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (CARD_TYPE CONSTRAINT CC_BPKPRODUCT_CARDTYPE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (TYPE CONSTRAINT CC_BPKPRODUCT_TYPE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (NAME CONSTRAINT CC_BPKPRODUCT_NAME_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.BPK_PRODUCT MODIFY (ID CONSTRAINT CC_BPKPRODUCT_ID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on BPK_PRODUCT     to BARS_SUP;
