...
PROMPT *** Create  constraint FK_ATTR_HIST_DEL_REF_ATTR_HIST ***
begin   
 execute immediate '
  ALTER TABLE BARS.ATTRIBUTE_HISTORY_DELETION ADD CONSTRAINT FK_ATTR_HIST_DEL_REF_ATTR_HIST FOREIGN KEY (HISTORY_ID)
...
PROMPT *** Create  constraint SYS_C002861371 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861370 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861369 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C002861368 ***
begin   
 execute immediate '
