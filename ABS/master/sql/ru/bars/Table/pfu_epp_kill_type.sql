...
PROMPT *** Create  constraint SYS_C003234358 ***
begin   
 execute immediate '
  ALTER TABLE BARS.PFU_EPP_KILL_TYPE MODIFY (NAME NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003234357 ***
begin   
 execute immediate '
  ALTER TABLE BARS.PFU_EPP_KILL_TYPE MODIFY (ID_TYPE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
