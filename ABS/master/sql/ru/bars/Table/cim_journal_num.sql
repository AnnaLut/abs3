...
begin 
  ...
  CREATE TABLE BARS.CIM_JOURNAL_NUM 
   (	BRANCH VARCHAR2(30), 
	...
	N3 NUMBER DEFAULT 0, 
	N4 NUMBER DEFAULT 0, 
	NAME VARCHAR2(256) DEFAULT ''Заповніть назву установи в cim_journal_num'', 
	NAME_OV VARCHAR2(256) DEFAULT ''Заповніть адресу установи в cim_journal_num'', 
	ADR VARCHAR2(256) DEFAULT ''Заповніть назву установи в cim_journal_num'', 
...
PROMPT *** Create  constraint FK_CIMJOURNALNUM_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_JOURNAL_NUM ADD CONSTRAINT FK_CIMJOURNALNUM_BRANCH FOREIGN KEY (BRANCH)
...
PROMPT *** Create  constraint SYS_C002605559 ***
begin   
 execute immediate '
...
grant SELECT                                                                 on CIM_JOURNAL_NUM to BARS_ACCESS_DEFROLE;
