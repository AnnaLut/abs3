...
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS ADD CONSTRAINT CC_CORPS_EDOV CHECK (edov = trunc(edov)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS ADD CONSTRAINT CC_CORPS_BDOV CHECK (bdov = trunc(bdov)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CORPS MODIFY (RNK CONSTRAINT CC_CORPS_RNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create SYNONYM  to CORPS ***

  CREATE OR REPLACE SYNONYM BARSDWH_ACCESS_USER.CORPS FOR BARS.CORPS;
