...
PROMPT *** Create  constraint FK_CUSTREQS_TRUSTEERNK ***
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS ADD CONSTRAINT FK_CUSTREQS_TRUSTEERNK FOREIGN KEY (TRUSTEE_RNK)
...
PROMPT *** Create  constraint FK_CUSTREQS_TRUSTEETYPE ***
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS ADD CONSTRAINT FK_CUSTREQS_TRUSTEETYPE FOREIGN KEY (TRUSTEE_TYPE)
...
PROMPT *** Create  constraint FK_CUSTREQS_STAFF2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS ADD CONSTRAINT FK_CUSTREQS_STAFF2 FOREIGN KEY (REQ_PRCUSER)
...
PROMPT *** Create  constraint FK_CUSTREQS_STAFF ***
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS ADD CONSTRAINT FK_CUSTREQS_STAFF FOREIGN KEY (REQ_CRUSER)
	  REFERENCES BARS.STAFF$BASE (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_CUSTREQS_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS ADD CONSTRAINT FK_CUSTREQS_BRANCH FOREIGN KEY (BRANCH)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS ADD CONSTRAINT CC_CUSTREQS_TRUSTEETYPE CHECK (TRUSTEE_TYPE in (''V'',''H'',''T'')) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS ADD CONSTRAINT CC_CUSTREQS_REQSTATE CHECK ( REQ_STATE in ( -1, 0, 1, 2 ) ) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS MODIFY (REQ_CRUSER CONSTRAINT CC_CUSTREQS_REQCRUSER_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS MODIFY (REQ_CRDATE CONSTRAINT CC_CUSTREQS_REQCRDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS MODIFY (REQ_BDATE CONSTRAINT CC_CUSTREQS_REQBDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS MODIFY (BRANCH CONSTRAINT CC_CUSTREQS_BRANCH_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS MODIFY (TRUSTEE_RNK CONSTRAINT CC_CUSTREQS_TRUSTEERNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS MODIFY (TRUSTEE_TYPE CONSTRAINT CC_CUSTREQS_TRUSTEETYP_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS MODIFY (REQ_TYPE CONSTRAINT CC_CUSTREQS_REQTYPE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS MODIFY (REQ_ID CONSTRAINT CC_CUSTREQS_REQID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUST_REQUESTS ADD CONSTRAINT CC_CUSTREQS_REQTYPE CHECK ( REQ_TYPE in ( 0, 1, 2 ) ) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CUST_REQUESTS   to BARS_ACCESS_DEFROLE;
