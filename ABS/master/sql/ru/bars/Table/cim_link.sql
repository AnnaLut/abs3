...
PROMPT *** Create  constraint FK_CIMLINK_ACTID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LINK ADD CONSTRAINT FK_CIMLINK_ACTID FOREIGN KEY (ACT_ID)
...
PROMPT *** Create  constraint FK_CIMLINK_VMDID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LINK ADD CONSTRAINT FK_CIMLINK_VMDID FOREIGN KEY (VMD_ID)
...
PROMPT *** Create  constraint FK_CIMLINK_FANTOMID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LINK ADD CONSTRAINT FK_CIMLINK_FANTOMID FOREIGN KEY (FANTOM_ID)
...
PROMPT *** Create  constraint FK_CIMLINK_PAYMENTID ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LINK ADD CONSTRAINT FK_CIMLINK_PAYMENTID FOREIGN KEY (PAYMENT_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LINK MODIFY (CREATE_DATE CONSTRAINT CC_CIMLINK_CDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LINK ADD CONSTRAINT CC_CIMLINK_VMD_CHECK CHECK (vmd_id is null and act_id is not null or vmd_id is not null and act_id is null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LINK ADD CONSTRAINT CC_CIMLINK_PAYMENT_CHECK CHECK (payment_id is null and fantom_id is not null or payment_id is not null and fantom_id is null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_LINK MODIFY (S CONSTRAINT CC_CIMLINK_S_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_LINK        to BARS_ACCESS_DEFROLE;
