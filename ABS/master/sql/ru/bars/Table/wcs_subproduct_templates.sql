...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCT_TEMPLATES ADD CONSTRAINT CC_SBPTMPLS_SQID_NN CHECK (SCAN_QID IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177377 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCT_TEMPLATES MODIFY (TEMPLATE_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177376 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCT_TEMPLATES MODIFY (SUBPRODUCT_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
