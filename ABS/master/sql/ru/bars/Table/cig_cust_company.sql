...
PROMPT *** Create  constraint FK_CIGCUSTCUST_TERRIT ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUST_COMPANY ADD CONSTRAINT FK_CIGCUSTCUST_TERRIT FOREIGN KEY (REG_TERRITORY_ID)
...
PROMPT *** Create  constraint FK_CIGCUSTCOMP_TERRIT ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUST_COMPANY ADD CONSTRAINT FK_CIGCUSTCOMP_TERRIT FOREIGN KEY (FACT_TERRITORY_ID)
	  REFERENCES BARS.TERRITORY (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_CIGCUSTCOMP_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUST_COMPANY ADD CONSTRAINT FK_CIGCUSTCOMP_BRANCH FOREIGN KEY (BRANCH)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUST_COMPANY MODIFY (FACT_STREET_BUILDNUM CONSTRAINT CC_CIGCUSTCOMP_FACSTBUNUM_NN NOT NULL DISABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_CUST_COMPANY MODIFY (FACT_TERRITORY_ID CONSTRAINT CC_CIGCUSTCOMP_FACTTERRIT_NN NOT NULL DISABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
