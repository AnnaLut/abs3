...
PROMPT *** Create  constraint FK_CLVREQUESTARC_STAFF2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CLV_REQUEST_ARC ADD CONSTRAINT FK_CLVREQUESTARC_STAFF2 FOREIGN KEY (APR_USERID)
...
PROMPT *** Create  constraint FK_CLVREQUESTARC_STAFF ***
begin   
 execute immediate '
  ALTER TABLE BARS.CLV_REQUEST_ARC ADD CONSTRAINT FK_CLVREQUESTARC_STAFF FOREIGN KEY (REQ_USERID)
	  REFERENCES BARS.STAFF$BASE (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
