...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''E_TARIF'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
begin   
 execute immediate '
  ALTER TABLE BARS.E_TARIF ADD CONSTRAINT XPK_E_TARIF PRIMARY KEY (ID)
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.XPK_E_TARIF ON BARS.E_TARIF (ID) 
