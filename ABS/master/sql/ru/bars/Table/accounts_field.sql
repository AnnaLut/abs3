...
begin   
 execute immediate '
  ALTER TABLE BARS.ACCOUNTS_FIELD MODIFY (NAME CONSTRAINT CC_ACCOUNTSFIELD_NAME_NN NOT NULL ENABLE)';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.ACCOUNTS_FIELD MODIFY (TAG CONSTRAINT CC_ACCOUNTSFIELD_TAG_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ACCOUNTS_FIELD ADD CONSTRAINT CC_ACCFIELDS_INARCH_NN CHECK (use_in_arch is not null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on ACCOUNTS_FIELD  to BARS_SUP;
