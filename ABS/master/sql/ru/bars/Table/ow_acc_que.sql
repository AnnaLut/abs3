...
PROMPT *** Create  constraint FK_OWACCQUE_OWIICFILES ***
begin   
 execute immediate '
  ALTER TABLE BARS.OW_ACC_QUE ADD CONSTRAINT FK_OWACCQUE_OWIICFILES FOREIGN KEY (F_N)
...
PROMPT *** Create  constraint FK_OWACCQUE_ACCOUNTS ***
begin   
 execute immediate '
  ALTER TABLE BARS.OW_ACC_QUE ADD CONSTRAINT FK_OWACCQUE_ACCOUNTS FOREIGN KEY (ACC)
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_ACC_QUE ADD CONSTRAINT CC_OWACCQUE_SOS CHECK (sos in (0, 1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_ACC_QUE MODIFY (SOS CONSTRAINT CC_OWACCQUE_SOS_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_ACC_QUE MODIFY (DAT CONSTRAINT CC_OWACCQUE_DAT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_ACC_QUE MODIFY (S CONSTRAINT CC_OWACCQUE_S_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_ACC_QUE MODIFY (ACC CONSTRAINT CC_OWACCQUE_ACC_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
