...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''ALT_BPK'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''ALT_BPK'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint FK_ALTBPK_REF ***
begin   
 execute immediate '
  ALTER TABLE BARS.ALT_BPK ADD CONSTRAINT FK_ALTBPK_REF FOREIGN KEY (REF)
