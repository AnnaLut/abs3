...
PROMPT *** Create  constraint SYS_IOT_TOP_468267 ***
begin   
 execute immediate '
...
PROMPT *** Create  index SYS_IOT_TOP_468267 ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.SYS_IOT_TOP_468267 ON BARS.AQ$_BARS_MAIL_QT_G (MSGID, SUBSCRIBER#, NAME, ADDRESS#) 
