...
COMMENT ON TABLE BARS.KOD_70_2 IS 'Классификатор НБУ (KOD_70_2 - коды операций) ';
...
grant DELETE,INSERT,SELECT,UPDATE                                            on KOD_70_2        to ABS_ADMIN;
grant DELETE,INSERT,SELECT,UPDATE                                            on KOD_70_2        to BARS_ACCESS_DEFROLE;
grant DELETE,FLASHBACK,INSERT,SELECT,UPDATE                                  on KOD_70_2        to WR_ALL_RIGHTS;
