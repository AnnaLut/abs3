...
PROMPT *** Create  constraint SYS_C003234362 ***
begin   
 execute immediate '
  ALTER TABLE BARS.PFU_EPP_KILL_STATE MODIFY (NAME NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003234361 ***
begin   
 execute immediate '
  ALTER TABLE BARS.PFU_EPP_KILL_STATE MODIFY (ID_STATE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
