...
begin 
  execute immediate '
  CREATE GLOBAL TEMPORARY TABLE BARS.TMP_AN_KL 
   (	ID NUMBER(38,0), 
	RNK NUMBER(38,0), 
	NMK VARCHAR2(35), 
	NLS VARCHAR2(15), 
...
begin   
 execute immediate '
  ALTER TABLE BARS.TMP_AN_KL ADD CONSTRAINT XPK_TMP_AN_KL PRIMARY KEY (KF, RNK, NLS) ENABLE';
exception when others then
...
PROMPT *** Create  constraint SYS_C0011785 ***
begin   
 execute immediate '
...
PROMPT *** Create  constraint SYS_C0011784 ***
begin   
 execute immediate '
