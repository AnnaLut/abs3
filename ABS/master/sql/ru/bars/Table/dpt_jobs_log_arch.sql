...
PROMPT *** Create  constraint FK_DPTJOBSLOGARCH_TABVAL ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_LOG_ARCH ADD CONSTRAINT FK_DPTJOBSLOGARCH_TABVAL FOREIGN KEY (KV)
...
PROMPT *** Create  constraint FK_DPTJOBSLOGARCH_BANKS ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_LOG_ARCH ADD CONSTRAINT FK_DPTJOBSLOGARCH_BANKS FOREIGN KEY (KF)
...
PROMPT *** Create  constraint FK_DPTJOBSLOGARCH_DPTJOBSLIST ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_LOG_ARCH ADD CONSTRAINT FK_DPTJOBSLOGARCH_DPTJOBSLIST FOREIGN KEY (JOB_ID)
...
PROMPT *** Create  constraint FK_DPTJOBSLOGARCH_DPTJOBSJRNL ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_LOG_ARCH ADD CONSTRAINT FK_DPTJOBSLOGARCH_DPTJOBSJRNL FOREIGN KEY (RUN_ID)
...
PROMPT *** Create  constraint FK_DPTJOBSLOGARCH_DPTDPTALL2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_LOG_ARCH ADD CONSTRAINT FK_DPTJOBSLOGARCH_DPTDPTALL2 FOREIGN KEY (KF, DPT_ID)
...
PROMPT *** Create  constraint FK_DPTJOBSLOGARCH_CUSTOMER ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_LOG_ARCH ADD CONSTRAINT FK_DPTJOBSLOGARCH_CUSTOMER FOREIGN KEY (RNK)
...
PROMPT *** Create  constraint FK_DPTJOBSLOGARCH_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPT_JOBS_LOG_ARCH ADD CONSTRAINT FK_DPTJOBSLOGARCH_BRANCH FOREIGN KEY (BRANCH)
