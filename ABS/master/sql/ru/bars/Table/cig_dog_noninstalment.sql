...
PROMPT *** Create  constraint FK_CIGDOGNINST_TABVAL2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_NONINSTALMENT ADD CONSTRAINT FK_CIGDOGNINST_TABVAL2 FOREIGN KEY (USED_CURR_ID)
...
PROMPT *** Create  constraint FK_CIGDOGNINST_TABVAL1 ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_NONINSTALMENT ADD CONSTRAINT FK_CIGDOGNINST_TABVAL1 FOREIGN KEY (LIMIT_CURR_ID)
	  REFERENCES BARS.TABVAL$GLOBAL (KV) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
PROMPT *** Create  constraint FK_CIGDOGNINST_CIGDOGGENERAL ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_NONINSTALMENT ADD CONSTRAINT FK_CIGDOGNINST_CIGDOGGENERAL FOREIGN KEY (DOG_ID, BRANCH)
	  REFERENCES BARS.CIG_DOG_GENERAL (ID, BRANCH) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_CIGDOGNINST_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_NONINSTALMENT ADD CONSTRAINT FK_CIGDOGNINST_BRANCH FOREIGN KEY (BRANCH)
