...
PROMPT *** Create  constraint FK_SWIPASSPMAP_PASSP ***
begin   
 execute immediate '
  ALTER TABLE BARS.SWI_PASSP_MAP ADD CONSTRAINT FK_SWIPASSPMAP_PASSP FOREIGN KEY (MAP_PASSP_ID)
...
grant SELECT                                                                 on SWI_PASSP_MAP   to BARS_ACCESS_DEFROLE;
grant DELETE,INSERT,SELECT,UPDATE                                            on SWI_PASSP_MAP   to START1;
grant FLASHBACK,SELECT                                                       on SWI_PASSP_MAP   to WR_REFREAD;
