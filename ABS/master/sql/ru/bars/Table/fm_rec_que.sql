...
PROMPT *** Create  constraint FK_FMRECQUE_OPER2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.FM_REC_QUE ADD CONSTRAINT FK_FMRECQUE_OPER2 FOREIGN KEY (KF, REC)
...
PROMPT *** Create  constraint FK_FMRECQUE_ARCRRP ***
begin   
 execute immediate '
  ALTER TABLE BARS.FM_REC_QUE ADD CONSTRAINT FK_FMRECQUE_ARCRRP FOREIGN KEY (REC)
...
grant SELECT,UPDATE                                                          on FM_REC_QUE      to FINMON01;
