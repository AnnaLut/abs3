...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CIG_SYNC_DATA'', ''FILIAL'' , null, null, null, null);
...
PROMPT *** Create  constraint FK_CIGSYNCDATA_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_SYNC_DATA ADD CONSTRAINT FK_CIGSYNCDATA_BRANCH FOREIGN KEY (BRANCH)
