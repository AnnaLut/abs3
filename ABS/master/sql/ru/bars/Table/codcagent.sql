...
grant SELECT                                                                 on CODCAGENT       to BARS_SUP;
grant SELECT                                                                 on CODCAGENT       to CUST001;
grant SELECT                                                                 on CODCAGENT       to FINMON;
...
PROMPT *** Create SYNONYM  to CODCAGENT ***

  CREATE OR REPLACE SYNONYM BARSDWH_ACCESS_USER.CODCAGENT FOR BARS.CODCAGENT;
