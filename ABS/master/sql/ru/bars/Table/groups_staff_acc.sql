...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''GROUPS_STAFF_ACC'', ''FILIAL'' , null, null, null, null);
...
PROMPT *** Create  constraint FK_GROUPSSTAFFACC_GROUPSACC ***
begin   
 execute immediate '
  ALTER TABLE BARS.GROUPS_STAFF_ACC ADD CONSTRAINT FK_GROUPSSTAFFACC_GROUPSACC FOREIGN KEY (IDA)
...
grant DELETE,INSERT,SELECT,UPDATE                                            on GROUPS_STAFF_ACC to BARS_ACCESS_DEFROLE;
