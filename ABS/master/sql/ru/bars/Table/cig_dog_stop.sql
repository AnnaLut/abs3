...
PROMPT *** Create  constraint FK_CIGDOGSTOP_CIGDOGGEN ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_STOP ADD CONSTRAINT FK_CIGDOGSTOP_CIGDOGGEN FOREIGN KEY (DOG_ID)
	  REFERENCES BARS.CIG_DOG_GENERAL (ID) ENABLE';
exception when others then
...
PROMPT *** Create  constraint FK_CIGDOGSTOP_STAFF ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_STOP ADD CONSTRAINT FK_CIGDOGSTOP_STAFF FOREIGN KEY (STAFF_ID)
...
PROMPT *** Create  constraint FK_CIGDOGSTOP_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_STOP ADD CONSTRAINT FK_CIGDOGSTOP_BRANCH FOREIGN KEY (BRANCH)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_STOP MODIFY (BRANCH CONSTRAINT CC_CIGDOGSTOP_BRANCH_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_STOP MODIFY (STAFF_ID CONSTRAINT CC_CIGDOGSTOP_STAFFID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_DOG_STOP MODIFY (STOP_DATE CONSTRAINT CC_CIGDOGSTOP_SDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
