...
PROMPT *** Create  constraint FK_AREAS_REGIONS ***
begin   
 execute immediate '
  ALTER TABLE BARS.ADR_AREAS ADD CONSTRAINT FK_AREAS_REGIONS FOREIGN KEY (REGION_ID)
...
PROMPT *** Create  constraint PK_AREAS ***
begin   
 execute immediate '
  ALTER TABLE BARS.ADR_AREAS ADD CONSTRAINT PK_AREAS PRIMARY KEY (AREA_ID)
...
PROMPT *** Create  index PK_AREAS ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_AREAS ON BARS.ADR_AREAS (AREA_ID) 
