...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SCORING_QS_MATRIX ADD CONSTRAINT CC_SCORQSMTX_SID_NN CHECK (SCORING_ID IS NOT NULL) ENABLE';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SCORING_QS_MATRIX ADD CONSTRAINT CC_SCORQSMTX_SCORE_NN CHECK (SCORE IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SCORING_QS_MATRIX ADD CONSTRAINT CC_SCORQSMTX_QID_NN CHECK (QUESTION_ID IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SCORING_QS_MATRIX ADD CONSTRAINT CC_SCORQSMTX_AXIS1ORD_NN CHECK (AXIS1_ORD IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SCORING_QS_MATRIX ADD CONSTRAINT CC_SCORQSMTX_AXIS0ORD_NN CHECK (AXIS0_ORD IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
