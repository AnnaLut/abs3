...
PROMPT *** Create  constraint FK_SHTARIFSCALE_KF ***
begin   
 execute immediate '
  ALTER TABLE BARS.SH_TARIF_SCALE ADD CONSTRAINT FK_SHTARIFSCALE_KF FOREIGN KEY (KF)
...
PROMPT *** Create  constraint FK_SHTARIFSCALE_TARIFSCHEME ***
begin   
 execute immediate '
  ALTER TABLE BARS.SH_TARIF_SCALE ADD CONSTRAINT FK_SHTARIFSCALE_TARIFSCHEME FOREIGN KEY (IDS)
...
PROMPT *** Create  constraint FK_SHTARIFSCALE_TARIF ***
begin   
 execute immediate '
  ALTER TABLE BARS.SH_TARIF_SCALE ADD CONSTRAINT FK_SHTARIFSCALE_TARIF FOREIGN KEY (KF, KOD)
