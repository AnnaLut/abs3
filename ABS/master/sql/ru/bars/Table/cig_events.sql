...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''CIG_EVENTS'', ''FILIAL'' , null, null, null, null);
...
PROMPT *** Create  constraint FK_CIGEVENTS_CUSTOMER ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_EVENTS ADD CONSTRAINT FK_CIGEVENTS_CUSTOMER FOREIGN KEY (EVT_RNK)
...
PROMPT *** Create  constraint FK_CIGEVENTS_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_EVENTS ADD CONSTRAINT FK_CIGEVENTS_BRANCH FOREIGN KEY (BRANCH)
...
PROMPT *** Create  constraint FK_CIGEVENTS_STAFF ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_EVENTS ADD CONSTRAINT FK_CIGEVENTS_STAFF FOREIGN KEY (EVT_UNAME)
...
PROMPT *** Create  constraint FK_CIGEVENTS_SECRECTYPE ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_EVENTS ADD CONSTRAINT FK_CIGEVENTS_SECRECTYPE FOREIGN KEY (EVT_STATE_ID)
	  REFERENCES BARS.CIG_STATES (STATE_ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_EVENTS MODIFY (EVT_MESSAGE CONSTRAINT CC_CIGEVENTS_EVTMESSAGE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_EVENTS MODIFY (EVT_STATE_ID CONSTRAINT CC_CIGEVENTS_EVTSTATEID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_EVENTS MODIFY (EVT_UNAME CONSTRAINT CC_CIGEVENTS_EVTUNAME_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIG_EVENTS MODIFY (EVT_DATE CONSTRAINT CC_CIGEVENTS_EVTDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
