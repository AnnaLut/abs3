...
PROMPT *** Create  constraint FK_PKKHISTORYARC_ACCOUNTS ***
begin   
 execute immediate '
  ALTER TABLE BARS.PKK_HISTORY_ARC ADD CONSTRAINT FK_PKKHISTORYARC_ACCOUNTS FOREIGN KEY (ACC)
...
PROMPT *** Create  constraint FK_PKKHISTORYARC_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.PKK_HISTORY_ARC ADD CONSTRAINT FK_PKKHISTORYARC_OPER FOREIGN KEY (REF)
