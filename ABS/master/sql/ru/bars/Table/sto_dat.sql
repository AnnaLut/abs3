...
PROMPT *** Create  constraint FK_STODAT_OPER2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.STO_DAT ADD CONSTRAINT FK_STODAT_OPER2 FOREIGN KEY (KF, REF)
...
begin   
 execute immediate '
  ALTER TABLE BARS.STO_DAT ADD CONSTRAINT FK_STODAT_STODET2 FOREIGN KEY (KF, IDD)
	  REFERENCES BARS.STO_DET (KF, IDD) ON DELETE CASCADE ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
