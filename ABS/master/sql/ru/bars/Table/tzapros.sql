...
PROMPT *** Create  constraint FK_TZAPROS_ARCRRP2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.TZAPROS ADD CONSTRAINT FK_TZAPROS_ARCRRP2 FOREIGN KEY (KF, REC)
...
PROMPT *** Create  constraint FK_ARC_TZAPROS ***
begin   
 execute immediate '
  ALTER TABLE BARS.TZAPROS ADD CONSTRAINT FK_ARC_TZAPROS FOREIGN KEY (REC)
...
begin   
 execute immediate '
  ALTER TABLE BARS.TZAPROS ADD CONSTRAINT NN_TZAPROS_REC CHECK (REC IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.TZAPROS MODIFY (KF CONSTRAINT CC_TZAPROS_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
