...
COMMENT ON TABLE BARS.CIM_CREDIT_F503_PURPOSE IS 'Ціль використання кредиту';
...
COMMENT ON COLUMN BARS.CIM_CREDIT_F503_PURPOSE.DELETE_DATE IS 'Дата видаленя';
...
grant SELECT                                                                 on CIM_CREDIT_F503_PURPOSE to BARS_ACCESS_DEFROLE;
