...
PROMPT *** Create  constraint PK_CCKRATING ***
begin   
 execute immediate '
  ALTER TABLE BARS.CCK_RATING ADD CONSTRAINT PK_CCKRATING PRIMARY KEY (CODE)
...
PROMPT *** Create  index PK_CCKRATING ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_CCKRATING ON BARS.CCK_RATING (CODE) 
