...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTBANK ADD CONSTRAINT CC_CUSTBANK_BKI_NN CHECK (bki is not null) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTBANK MODIFY (RNK CONSTRAINT CC_CUSTBANK_RNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CUSTBANK ADD CONSTRAINT CC_CUSTBANK_BKI CHECK (bki in (0,1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant ALTER,DELETE,INSERT,SELECT,UPDATE                                      on CUSTBANK        to BARS_ACCESS_DEFROLE;
grant SELECT                                                                 on CUSTBANK        to BARS_DM;
grant SELECT                                                                 on CUSTBANK        to BARS_SUP;
