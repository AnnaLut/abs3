...
PROMPT *** Create  constraint FK_SWMVPSINFDOC_OPER2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SW_MVPS_INFDOCS ADD CONSTRAINT FK_SWMVPSINFDOC_OPER2 FOREIGN KEY (INFREF)
...
PROMPT *** Create  constraint FK_SWMVPSINFDOC_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.SW_MVPS_INFDOCS ADD CONSTRAINT FK_SWMVPSINFDOC_OPER FOREIGN KEY (REF)
	  REFERENCES BARS.OPER (REF) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_MVPS_INFDOCS MODIFY (FDAT CONSTRAINT CC_SWMVSPINFDOC_FDAT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_MVPS_INFDOCS MODIFY (INFREF CONSTRAINT CC_SWMVPSINFDOC_INFREF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.SW_MVPS_INFDOCS MODIFY (REF CONSTRAINT CC_SWMVPSINFDOC_REF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
