...
BEGIN 
        execute immediate  
          'begin  
               ...
               bpa.alter_policy_info(''CP_ACCC'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint FX_CP_ACCC ***
begin   
 execute immediate '
  ALTER TABLE BARS.CP_ACCC ADD CONSTRAINT FX_CP_ACCC FOREIGN KEY (VIDD, EMI, PF)
	  REFERENCES BARS.CP_VIDD (VIDD, EMI, PF) ENABLE';
exception when others then
