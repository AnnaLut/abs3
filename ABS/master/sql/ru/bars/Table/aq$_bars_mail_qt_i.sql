...
PROMPT *** Create  constraint SYS_IOT_TOP_468270 ***
begin   
 execute immediate '
...
PROMPT *** Create  index SYS_IOT_TOP_468270 ***
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.SYS_IOT_TOP_468270 ON BARS.AQ$_BARS_MAIL_QT_I (SUBSCRIBER#, NAME, QUEUE#, MSG_ENQ_TIME, MSG_STEP_NO, MSG_CHAIN_NO, MSG_LOCAL_ORDER_NO, MSGID) 
