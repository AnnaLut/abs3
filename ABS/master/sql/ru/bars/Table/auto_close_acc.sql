...
PROMPT *** Create  constraint FK_AUTOCLOSEACC_TIP_TIPS ***
begin   
 execute immediate '
  ALTER TABLE BARS.AUTO_CLOSE_ACC ADD CONSTRAINT FK_AUTOCLOSEACC_TIP_TIPS FOREIGN KEY (TIP)
...
PROMPT *** Create  constraint SYS_C002689044 ***
begin   
 execute immediate '
...
grant FLASHBACK,SELECT                                                       on AUTO_CLOSE_ACC  to WR_REFREAD;
