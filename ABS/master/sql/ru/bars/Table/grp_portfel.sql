...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''GRP_PORTFEL'', ''FILIAL'' , null, null, null, null);
...
grant DELETE,INSERT,SELECT,UPDATE                                            on GRP_PORTFEL     to RCC_DEAL;
grant SELECT                                                                 on GRP_PORTFEL     to START1;
grant FLASHBACK,SELECT                                                       on GRP_PORTFEL     to WR_REFREAD;
