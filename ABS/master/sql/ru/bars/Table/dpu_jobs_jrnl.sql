...
BEGIN 
        execute immediate  
          'begin  
               ...
               bpa.alter_policy_info(''DPU_JOBS_JRNL'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint FK_DPUJOBSJRNL_FDAT ***
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_JOBS_JRNL ADD CONSTRAINT FK_DPUJOBSJRNL_FDAT FOREIGN KEY (KF, BANK_DATE)
	  REFERENCES BARS.FDAT (KF, FDAT) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_JOBS_JRNL ADD CONSTRAINT CC_DPUJOBSJRNL_STATUS CHECK ( STATUS IN ( -1, 0, 1 ) ) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_JOBS_JRNL MODIFY (KF CONSTRAINT CC_DPUJOBSJRNL_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_JOBS_JRNL MODIFY (BRANCH CONSTRAINT CC_DPUJOBSJRNL_BRANCH_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_JOBS_JRNL MODIFY (USER_ID CONSTRAINT CC_DPUJOBSJRNL_USERID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_JOBS_JRNL MODIFY (BANK_DATE CONSTRAINT CC_DPUJOBSJRNL_BANKDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_JOBS_JRNL MODIFY (START_DATE CONSTRAINT CC_DPUJOBSJRNL_STARTDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.DPU_JOBS_JRNL MODIFY (JOB_ID CONSTRAINT CC_DPUJOBSJRNL_JOBID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
