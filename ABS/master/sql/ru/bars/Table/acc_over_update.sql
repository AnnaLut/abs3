...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''ACC_OVER_UPDATE'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''ACC_OVER_UPDATE'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
PROMPT *** Create  constraint SYS_C002993051 ***
begin   
 execute immediate '
...
grant SELECT                                                                 on ACC_OVER_UPDATE to BARS_SUP;
