...
PROMPT *** Create  constraint FK_FANTOM_PAYMENTS_TABVAL ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS ADD CONSTRAINT FK_FANTOM_PAYMENTS_TABVAL FOREIGN KEY (KV)
...
PROMPT *** Create  constraint FK_FANTOM_PAYMENTS_BRANCH ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS ADD CONSTRAINT FK_FANTOM_PAYMENTS_BRANCH FOREIGN KEY (BRANCH)
...
PROMPT *** Create  constraint FK_FANTOM_PAYMENTS_TRANS_TYPES ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS ADD CONSTRAINT FK_FANTOM_PAYMENTS_TRANS_TYPES FOREIGN KEY (OPER_TYPE)
	  REFERENCES BARS.CIM_OPERATION_TYPES (TYPE_ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_FANTOM_PAYMENTS_CUSTOMER ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS ADD CONSTRAINT FK_FANTOM_PAYMENTS_CUSTOMER FOREIGN KEY (RNK)
...
PROMPT *** Create  constraint FK_FANTOM_PAYMENTS_TYPES ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS ADD CONSTRAINT FK_FANTOM_PAYMENTS_TYPES FOREIGN KEY (DIRECT)
	  REFERENCES BARS.CIM_PAYMENT_TYPES (TYPE_ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint FK_FANTOM_PAYMENTS_DIRECT ***
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS ADD CONSTRAINT FK_FANTOM_PAYMENTS_DIRECT FOREIGN KEY (DIRECT)
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS ADD CONSTRAINT CC_FANTOMPAYMENTS_PAYTYPE_CC CHECK (payment_type>0) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS ADD CONSTRAINT CC_FANTOMPAYMENTS_DIRECT_CC CHECK (direct in (0,1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (DETAILS CONSTRAINT CC_FANTOMPAYMENTS_COMMENTS NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (BRANCH CONSTRAINT CC_CIMFANTOMPAYMENTS_BRANCH_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (S CONSTRAINT CC_FANTOMPAYMENTS_S NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (KV CONSTRAINT CC_FANTOMPAYMENTS_KV NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (VAL_DATE CONSTRAINT CC_FANTOMPAYMENTS_VDATE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (BANK_DATE CONSTRAINT CC_FANTOMPAYMENTS_BDATE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (RNK CONSTRAINT CC_FANTOMPAYMENTS_RNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (OPER_TYPE CONSTRAINT CC_FANTOMPAYMENTS_OPERTYPE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (PAYMENT_TYPE CONSTRAINT CC_FANTOMPAYMENTS_TYPEID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (DIRECT CONSTRAINT CC_FANTOMPAYMENTS_DIRECT_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.CIM_FANTOM_PAYMENTS MODIFY (FANTOM_ID CONSTRAINT CC_FANTOMPAYMENTS_IDFP_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on CIM_FANTOM_PAYMENTS to BARS_ACCESS_DEFROLE;
