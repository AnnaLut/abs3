...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''OW_PKK_QUE'', ''FILIAL'' , null, null, null, null);
...
PROMPT *** Create  constraint FK_OWPKKQUE_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_QUE ADD CONSTRAINT FK_OWPKKQUE_OPER FOREIGN KEY (REF)
...
PROMPT *** Create  constraint FK_OWPKKQUE_ACCOUNTS ***
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_QUE ADD CONSTRAINT FK_OWPKKQUE_ACCOUNTS FOREIGN KEY (ACC)
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_QUE ADD CONSTRAINT CC_OWPKKQUE_DK CHECK (dk in (0,1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_QUE ADD CONSTRAINT CC_OWPKKQUE_SOS CHECK (sos in (0,1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_QUE MODIFY (SOS CONSTRAINT CC_OWPKKQUE_SOS_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_QUE MODIFY (DK CONSTRAINT CC_OWPKKQUE_DK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_QUE MODIFY (ACC CONSTRAINT CC_OWPKKQUE_ACC_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.OW_PKK_QUE MODIFY (REF CONSTRAINT CC_OWPKKQUE_REF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
