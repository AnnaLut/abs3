...
PROMPT *** Create  constraint FK_SWOPER_OPER2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SW_OPER ADD CONSTRAINT FK_SWOPER_OPER2 FOREIGN KEY (KF, REF)
...
PROMPT *** Create  constraint FK_SWOPER_SWJOURNAL2 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SW_OPER ADD CONSTRAINT FK_SWOPER_SWJOURNAL2 FOREIGN KEY (KF, SWREF)
...
grant SELECT                                                                 on SW_OPER         to BARS_ACCESS_DEFROLE;
