...
PROMPT *** Create  constraint SYS_C002454333 ***
begin   
 execute immediate '
  ALTER TABLE BARS.W4_TARIF MODIFY (TARIF_CODE NOT NULL ENABLE)';
exception when others then
...
PROMPT *** Create  constraint SYS_C002454332 ***
begin   
 execute immediate '
  ALTER TABLE BARS.W4_TARIF MODIFY (PRODUCT_GROUPS NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
