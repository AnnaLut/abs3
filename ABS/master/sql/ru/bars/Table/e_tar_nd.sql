...
begin   
 execute immediate '
  ALTER TABLE BARS.E_TAR_ND ADD CONSTRAINT FK_ETARND_EDEAL$BASE FOREIGN KEY (KF, ND)
	  REFERENCES BARS.E_DEAL$BASE (KF, ND) ENABLE';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.E_TAR_ND ADD CONSTRAINT FK_E_TAR_ND_ID FOREIGN KEY (ID)
	  REFERENCES BARS.E_TARIF (ID) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.E_TAR_ND MODIFY (KF CONSTRAINT CC_ETARND_KF_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.E_TAR_ND MODIFY (ID CONSTRAINT NK_E_TAR_ND_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.E_TAR_ND MODIFY (ND CONSTRAINT NK_E_TAR_ND_ND NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
