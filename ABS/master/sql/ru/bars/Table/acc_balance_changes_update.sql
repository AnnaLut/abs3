...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''ACC_BALANCE_CHANGES_UPDATE'', ''FILIAL'' , null, ''E'', ''E'', ''E'');
...
COMMENT ON TABLE BARS.ACC_BALANCE_CHANGES_UPDATE IS '';
...
begin   
 execute immediate '
  ALTER TABLE BARS.ACC_BALANCE_CHANGES_UPDATE MODIFY (KOS_DELTA CONSTRAINT CC_ACCBALCHUPD_KOSD_NN NOT NULL ENABLE)';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.ACC_BALANCE_CHANGES_UPDATE MODIFY (DOS_DELTA CONSTRAINT CC_ACCBALCHUPD_DOSD_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ACC_BALANCE_CHANGES_UPDATE MODIFY (OSTC CONSTRAINT CC_ACCBALCHUPD_OSTC_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ACC_BALANCE_CHANGES_UPDATE MODIFY (ACC CONSTRAINT CC_ACCBALCHUPD_ACC_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ACC_BALANCE_CHANGES_UPDATE MODIFY (RNK CONSTRAINT CC_ACCBALCHUPD_RNK_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ACC_BALANCE_CHANGES_UPDATE MODIFY (CHANGE_TIME CONSTRAINT CC_ACCBALCHUPD_CHTIME_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.ACC_BALANCE_CHANGES_UPDATE MODIFY (ID CONSTRAINT CC_ACCBALCHUPD_ID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
