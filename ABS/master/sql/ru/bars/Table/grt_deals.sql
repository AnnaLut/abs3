...
PROMPT *** Create  constraint FK_GRTDEALS_ACCOUNTS ***
begin   
 execute immediate '
  ALTER TABLE BARS.GRT_DEALS ADD CONSTRAINT FK_GRTDEALS_ACCOUNTS FOREIGN KEY (ACC)
...
grant SELECT                                                                 on GRT_DEALS       to BARS_SUP;
