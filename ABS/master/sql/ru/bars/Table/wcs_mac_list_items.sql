...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_MAC_LIST_ITEMS ADD CONSTRAINT CC_MACLISTITEMS_TEXT_NN CHECK (TEXT IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177130 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_MAC_LIST_ITEMS MODIFY (ORD NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003177129 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_MAC_LIST_ITEMS MODIFY (MAC_ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
