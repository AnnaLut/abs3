...
COMMENT ON TABLE BARS.SEC_ATTRIBUTES IS 'Атрибути користувача для підтвердження службою безпеки';
COMMENT ON COLUMN BARS.SEC_ATTRIBUTES.ATTR_ID IS 'Ід. атрибуту';
...
COMMENT ON COLUMN BARS.SEC_ATTRIBUTES.ATTR_TABNAME IS 'Ім'я таблиці для підтвердження атрибуту';
COMMENT ON COLUMN BARS.SEC_ATTRIBUTES.ATTR_USERCOL IS 'Ім'я колонки з ід. користувача в таблиці атрибутів';
COMMENT ON COLUMN BARS.SEC_ATTRIBUTES.ATTR_STORAGE IS 'Ім'я таблиці зберігання атрибуту';
COMMENT ON COLUMN BARS.SEC_ATTRIBUTES.ATTR_TYPE IS 'Тип атрибуту';
COMMENT ON COLUMN BARS.SEC_ATTRIBUTES.INUSE IS 'У використанні';
