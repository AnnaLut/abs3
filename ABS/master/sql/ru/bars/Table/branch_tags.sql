...
COMMENT ON TABLE BARS.BRANCH_TAGS IS 'Тэги параметров безбалансовых отделений';
COMMENT ON COLUMN BARS.BRANCH_TAGS.TAG IS 'Тэг параметра';
COMMENT ON COLUMN BARS.BRANCH_TAGS.NAME IS 'Наименование параметра';
COMMENT ON COLUMN BARS.BRANCH_TAGS.NBS IS 'Умолч.БАЛ.сч';
COMMENT ON COLUMN BARS.BRANCH_TAGS.OB22 IS 'Умолч.ОБ22';
