...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''PEREKR_R'', ''FILIAL'' , null, null, null, null);
               bpa.alter_policy_info(''PEREKR_R'', ''WHOLE'' , null, null, null, null);
               null;
           end; 
          '; 
END; 
...
begin   
 execute immediate '
  ALTER TABLE BARS.PEREKR_R ADD CONSTRAINT PK_PEREKRR PRIMARY KEY (IDR)
...
PROMPT *** Create  constraint SYS_C0010840 ***
begin   
 execute immediate '
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_PEREKRR ON BARS.PEREKR_R (IDR) 
