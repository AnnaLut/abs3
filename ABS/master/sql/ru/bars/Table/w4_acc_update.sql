...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_ACC_UPDATE MODIFY (GLOBAL_BDATE CONSTRAINT CC_W4ACCUPD_GLOBALBD_NN NOT NULL ENABLE)';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.W4_ACC_UPDATE MODIFY (CARD_CODE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002125075 ***
begin   
 execute immediate '
  ALTER TABLE BARS.W4_ACC_UPDATE MODIFY (ACC_PK NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C002125074 ***
begin   
 execute immediate '
  ALTER TABLE BARS.W4_ACC_UPDATE MODIFY (ND NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on W4_ACC_UPDATE   to BARS_SUP;
