...
begin   
 execute immediate '
  ALTER TABLE BARS.SPOT ADD CONSTRAINT FK_SPOT_VP_LIST FOREIGN KEY (ACC)
	  REFERENCES BARS.VP_LIST (ACC3800) DISABLE';
exception when others then
...
begin   
 execute immediate '
  ALTER TABLE BARS.SPOT MODIFY (BRANCH CONSTRAINT CC_SPOT_BRANCH_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0011327 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SPOT MODIFY (VDATE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C0011326 ***
begin   
 execute immediate '
  ALTER TABLE BARS.SPOT MODIFY (KV NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant DELETE,INSERT,SELECT,UPDATE                                            on SPOT            to BARS_ACCESS_DEFROLE;
