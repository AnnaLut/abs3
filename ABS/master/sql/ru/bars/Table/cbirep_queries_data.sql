...
PROMPT *** Create  constraint FK_CBIREPDATA_CBIREPQUERIES ***
begin   
 execute immediate '
  ALTER TABLE BARS.CBIREP_QUERIES_DATA ADD CONSTRAINT FK_CBIREPDATA_CBIREPQUERIES FOREIGN KEY (QUERIES_ID)
	  REFERENCES BARS.CBIREP_QUERIES (ID) ENABLE';
exception when others then
