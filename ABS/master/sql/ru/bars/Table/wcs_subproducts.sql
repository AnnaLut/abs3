...
COMMENT ON COLUMN BARS.WCS_SUBPRODUCTS.START_DATE IS '';
COMMENT ON COLUMN BARS.WCS_SUBPRODUCTS.END_DATE IS '';
...
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCTS ADD CONSTRAINT CC_SUBPRODUCTS_NAME_NN CHECK (NAME IS NOT NULL) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003176999 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCTS MODIFY (START_DATE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
PROMPT *** Create  constraint SYS_C003176998 ***
begin   
 execute immediate '
  ALTER TABLE BARS.WCS_SUBPRODUCTS MODIFY (ID NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
grant SELECT                                                                 on WCS_SUBPRODUCTS to BARS_ACCESS_DEFROLE;
