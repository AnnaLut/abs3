...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''INS_PAYMENTS_SCHEDULE'', ''FILIAL'' , null, null, null, null);
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PAYMENTS_SCHEDULE ADD CONSTRAINT FK_INSPSCH_DEALID_DEALS FOREIGN KEY (DEAL_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PAYMENTS_SCHEDULE ADD CONSTRAINT CC_INSPSCH_PAYED CHECK (payed in (0, 1)) ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PAYMENTS_SCHEDULE ADD CONSTRAINT UK_INSPAYMENTSSCHEDULE UNIQUE (DEAL_ID, PLAN_DATE)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PAYMENTS_SCHEDULE ADD CONSTRAINT PK_INSPMTSSDL PRIMARY KEY (ID)
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE BRSBIGI  ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PAYMENTS_SCHEDULE MODIFY (PAYED CONSTRAINT CC_INSPMTSSDL_PAYED_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PAYMENTS_SCHEDULE MODIFY (PLAN_SUM CONSTRAINT CC_INSPMTSSDL_PSUM_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PAYMENTS_SCHEDULE MODIFY (PLAN_DATE CONSTRAINT CC_INSPMTSSDL_PDATE_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PAYMENTS_SCHEDULE MODIFY (DEAL_ID CONSTRAINT CC_INSPMTSSDL_DID_NN NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UK_INSPAYMENTSSCHEDULE ON BARS.INS_PAYMENTS_SCHEDULE (DEAL_ID, PLAN_DATE) 
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_INSPMTSSDL ON BARS.INS_PAYMENTS_SCHEDULE (ID) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE BRSBIGI ';
exception when others then
  if  sqlcode=-955  then null; else raise; end if;
