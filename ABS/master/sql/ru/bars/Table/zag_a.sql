...
PROMPT *** Create  constraint FK_ZAGA_OPER ***
begin   
 execute immediate '
  ALTER TABLE BARS.ZAG_A ADD CONSTRAINT FK_ZAGA_OPER FOREIGN KEY (KF, REF)
...
grant SELECT,UPDATE                                                          on ZAG_A           to BARS_ACCESS_DEFROLE;
