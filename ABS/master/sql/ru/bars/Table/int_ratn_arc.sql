...
PROMPT *** Create  constraint FK_INTRATNARC_BRATES ***
begin   
 execute immediate '
  ALTER TABLE BARS.INT_RATN_ARC ADD CONSTRAINT FK_INTRATNARC_BRATES FOREIGN KEY (BR)
...
PROMPT *** Create  constraint SYS_C003008347 ***
begin   
 execute immediate '
  ALTER TABLE BARS.INT_RATN_ARC MODIFY (GLOBAL_BDATE NOT NULL ENABLE)';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
 end;
/
