...
BEGIN 
        execute immediate  
          'begin  
               bpa.alter_policy_info(''INS_PARTNER_TYPE_BRANCHES'', ''FILIAL'' , null, null, null, null);
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PARTNER_TYPE_BRANCHES ADD CONSTRAINT FK_PTNTYPEBRHS__LID_LIMITS FOREIGN KEY (LIMIT_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PARTNER_TYPE_BRANCHES ADD CONSTRAINT FK_PTNTYPEBRHS_FID_FEES FOREIGN KEY (FEE_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PARTNER_TYPE_BRANCHES ADD CONSTRAINT FK_PTNTYPEBRHS_TID_TARIFFS FOREIGN KEY (TARIFF_ID)
...
PROMPT *** Create  constraint FK_PTNTYPEBRHS_PID_PARTNERS ***
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PARTNER_TYPE_BRANCHES ADD CONSTRAINT FK_PTNTYPEBRHS_PID_PARTNERS FOREIGN KEY (PARTNER_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PARTNER_TYPE_BRANCHES ADD CONSTRAINT UK_PTNTYPEBRANCHES UNIQUE (BRANCH, PARTNER_ID, TYPE_ID)
...
begin   
 execute immediate '
  ALTER TABLE BARS.INS_PARTNER_TYPE_BRANCHES ADD CONSTRAINT PK_PTNTYPEBRANCHES PRIMARY KEY (ID)
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE BRSMDLI  ENABLE';
exception when others then
  if  sqlcode=-2260 or sqlcode=-2261 or sqlcode=-2264 or sqlcode=-2275 or sqlcode=-1442 then null; else raise; end if;
...
PROMPT *** Create  constraint SYS_C003101251 ***
begin   
 execute immediate '
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.PK_PTNTYPEBRANCHES ON BARS.INS_PARTNER_TYPE_BRANCHES (ID) 
...
begin   
 execute immediate '
  CREATE UNIQUE INDEX BARS.UK_PTNTYPEBRANCHES ON BARS.INS_PARTNER_TYPE_BRANCHES (BRANCH, PARTNER_ID, TYPE_ID) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE BRSMDLI ';
exception when others then
  if  sqlcode=-955  then null; else raise; end if;
