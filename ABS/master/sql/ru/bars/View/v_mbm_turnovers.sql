  CREATE OR REPLACE FORCE VIEW "BARS"."V_MBM_TURNOVERS" 
  ("ID", "ACC_ID", "STATE", "TRANSACTION_TYPE", "DOCUMENT_ID", "DOCUMENT_NUMBER", "DEBIT", "KREDIT", 
  "PURPOSE", "TURNOVER_DATE", "CORESPONDETN_BANK_ID", "CORESPONDENT_ACC_NUMBER", "CORESPONDENT_CURRENCY_ID", 
  "CORESPONDENT_NAME", "CORESPONDENT_CODE", "CREATED_DATE", "PAYED_DATE") AS 
