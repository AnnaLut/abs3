...
PROMPT *** Create  view V_CUST_RISK ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.V_CUST_RISK ("RNK", "NMK", "CUSTTYPE", "RISK_ID", "RISK_NAME", "DAT_BEGIN", "DAT_END", "STAFF_ID", "STAFF_FIO") AS 
  select c.rnk RNK, c.nmk NMK, c.custtype CUSTTYPE, f.id RISK_ID, f.name RISK_NAME, r.dat_begin DAT_BEGIN, r.dat_end DAT_END, s.id STAFF_ID, s.fio STAFF_FIO
