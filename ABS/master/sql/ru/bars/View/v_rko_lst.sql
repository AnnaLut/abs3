...
PROMPT *** Create  view V_RKO_LST ***
  ...
  select v."ACC",v."ACCD",v."DAT0A",v."DAT0B",v."S0",v."KOLDOK",v."DAT1A",v."DAT1B",v."ACC1",v."DAT2A",v."DAT2B",v."ACC2",v."COMM",v."KF", a.branch from RKO_LST v, Accounts a where v.acc=a.acc;
