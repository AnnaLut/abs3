...
PROMPT *** Create  view V_9760 ***
  ...
  SELECT nls,           nms,
          make_docinput_url (
             ...
             'Nls_A',                                   nls,
             'DisB',                                     '1',
             'Nls_B',                                    '#(nbs_ob22(substr(#(P9760),1,4),substr(trim(substr(#(P9760),6,2))||''06'',1,2) ) )')
             ZAR,
          make_docinput_url (
             '976',                                     'Списати',
             'reqv_P9760',                          '',
             ...
             'Nls_A',                                   nls,
             'DisB',                                     '1',
             'Nls_B',                                   '#(nbs_ob22_null(substr(#(P9760),1,4), substr(trim(substr(#(P9760),6,2))||''02'',1,2),
                                                                        decode(substr(#(P9760),6,2), ''03'',  #(TOBO3),
