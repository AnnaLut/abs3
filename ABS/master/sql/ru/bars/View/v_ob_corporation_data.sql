CREATE OR REPLACE FORCE VIEW BARS.V_OB_CORPORATION_DATA
(
   ROWTYPE,
   OURMFO,
   NLS,
...
/     
GRANT SELECT ON BARS.V_OB_CORPORATION_DATA TO BARS_ACCESS_DEFROLE;
/
GRANT SELECT ON BARS.V_OB_CORPORATION_DATA TO CORP_CLIENT;
/
