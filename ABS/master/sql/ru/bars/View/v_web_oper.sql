...
PROMPT *** Create  view V_WEB_OPER ***
  ...
  SELECT "REF","DEAL_TAG","TT","VOB","ND","PDAT","VDAT","KV","DK","S","SQ","SK","DATD","DATP","NAM_A","NLSA","MFOA","NAM_B","NLSB","MFOB","NAZN","D_REC","USERID","ID_A","ID_B","ID_O","SIGN","SOS","VP","CHK","S2","KV2","KVQ","REFL","PRTY","SQ2","CURRVISAGRP","NEXTVISAGRP","REF_A","TOBO","SIGNED" FROM OPER --WHERE (NLSA, KV) in (SELECT NLS, KV FROM WEB_SAL) or (NLSB, KV2) in (SELECT NLS, KV FROM WEB_SAL); ;
