...
PROMPT *** Create  view CCK_RESTR_V ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.CCK_RESTR_V ("ND", "CC_ID", "RNK", "NMK", "BDATE", "WDATE", "VID_RESTR", "FDAT", "TXT", "SUMR", "FDAT_END", "PR_NO", "KND", "KDAT", "KVID") AS 
  SELECT cr.nd,
          cd.cc_id,
          c.rnk,
          c.nmk,
...
grant SELECT                                                                 on CCK_RESTR_V     to BARS_ACCESS_DEFROLE;
