...
PROMPT *** Create  view TABVAL ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.TABVAL ("COIN", "KV", "GRP", "NAME", "LCV", "NOMINAL", "SV", "DIG", "DENOM", "UNIT", "COUNTRY", "BASEY", "GENDER", "PRV", "D_CLOSE", "SKV", "S0000", "S3800", "S3801", "S3802", "S6201", "S7201", "S9282", "S9280", "S9281", "S0009", "G0000") AS 
  SELECT g.coin,g.kv,g.grp,g.NAME,g.lcv,g.nominal, g.sv, g.dig, g.denom, g.unit,g.country, g.basey, g.gender, g.prv, g.d_close,l.skv,l.s0000,l.s3800,l.s3801,l.s3802,l.s6201,l.s7201,l.s9282, l.s9280,l.s9281,l.s0009,l.g0000  FROM tabval$global g, tabval$local l  WHERE l.kv(+) = g.kv AND l.kf(+) = gl.kf ;
...
grant SELECT                                                                 on TABVAL          to BARS_SUP;
...
grant SELECT                                                                 on TABVAL          to RCC_DEAL;
