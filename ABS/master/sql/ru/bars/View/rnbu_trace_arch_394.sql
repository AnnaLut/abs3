...
PROMPT *** Create  view RNBU_TRACE_ARCH_394 ***
  ...
  CREATE OR REPLACE FORCE VIEW BARS.RNBU_TRACE_ARCH_394 ("COL_P1", "COL_P2", "COL_P3", "COL_P4", "COL_P5", "COL_P6", "COL_P7", "KODF", "DATF", "NLS", "KV", "ODATE", "KODP", "ZNAP", "NBUC", "ISP", "RNK", "ACC", "REF", "COMM", "ND", "MDATE", "TOBO") AS 
