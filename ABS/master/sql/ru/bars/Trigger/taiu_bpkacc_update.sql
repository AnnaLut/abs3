...
begin
  ...
  then
    ...
    then
      if ( (:old.ACC_PK != :new.ACC_PK)
           ...
           OR
           (:old.ACC_TOVR          != :new.ACC_TOVR) or
           (:old.ACC_TOVR is Null AND :new.ACC_TOVR is Not Null) or
           (:new.ACC_TOVR is Null AND :old.ACC_TOVR is Not Null)
           OR
           (:old.KF          != :new.KF) or
           (:old.KF is Null AND :new.KF is Not Null) or
           (:new.KF is Null AND :old.KF is Not Null)
           OR
           ...
           (:old.PRODUCT_ID is Null AND :new.PRODUCT_ID is Not Null) or
           ...
           OR
           (:old.ACC_W4          != :new.ACC_W4) or
           (:old.ACC_W4 is Null AND :new.ACC_W4 is Not Null) or
           (:new.ACC_W4 is Null AND :old.ACC_W4 is Not Null)
           OR
           (:old.FIN          != :new.FIN) or
  ...
  Then
    ...
    l_rec.IDUPD        := S_BPKACC_UPDATE.NextVal;
