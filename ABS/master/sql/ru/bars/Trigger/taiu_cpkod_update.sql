...
begin
   ...
   if  deleting   then
       ...
       insert into cp_kod_update(
              ...
              pr_akt, pr_amr, quot_sign, rnk, tip, vncrr, zal_cp, pawn,expiry, hierarchy_id)
      values (s_cpkod_update.nextval ,l_chgaction, l_bankdate, sysdate, user_id, :old.amort,  :old.basey,  :old.cena,
       ...
       if  updating then
        ...
        insert into cp_kod_update(
               ...
               idt, ir, k23, kat23, kv, ky, metr, name, period_kup, pr1_kup,
               pr_akt, pr_amr, quot_sign, rnk, tip, vncrr, zal_cp, pawn, expiry, hierarchy_id)
       values (s_cpkod_update.nextval ,l_chgaction, l_bankdate, sysdate, user_id, :new.amort, :new.basey, :new.cena,
