...
declare
    l_app_code varchar2(10 char) := 'ADR';
    l_app_name varchar2(300 char) := 'Очистка адрес';
    l_appid number(5);
    l_funcname1 varchar2(250 Byte) := '/barsroot/clients/GeneralClearAddress/index';
    l_name1 varchar2(250 Byte) := 'Загальна очистка адрес';
...
begin  
   bc.set_context;
    ...
    set name = l_app_name,
        frontend = 1
    where codeapp = RPAD(l_app_code , 4);
