...
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/BARS/Procedure/F_MESBAL_GL.sql =========*** Run *
PROMPT ===================================================================================== 


PROMPT *** Create  procedure F_MESBAL_GL ***

  CREATE OR REPLACE PROCEDURE BARS.F_MESBAL_GL (Dat_B DATE, Dat_N DATE,
...
ret_ := f_pop_otcn_GL(Dat_N, 5, sql_acc_, Dat_B);
...
PROMPT *** Create  grants  F_MESBAL_GL ***
grant EXECUTE                                                                on F_MESBAL_GL     to BARS_ACCESS_DEFROLE;
grant EXECUTE                                                                on F_MESBAL_GL     to RPBN001;
grant EXECUTE                                                                on F_MESBAL_GL     to WR_ALL_RIGHTS;



PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/BARS/Procedure/F_MESBAL_GL.sql =========*** End *
PROMPT ===================================================================================== 
