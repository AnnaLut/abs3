...
is
begin
 bars_audit.trace('finmon_check_public - started');
 begin
 ...
 exception when others then bars_audit.trace('INSERT FINMON_PUBLIC_CUSTOMERS - FAILED');
 end;
bars_audit.trace('finmon_check_public - finished');
