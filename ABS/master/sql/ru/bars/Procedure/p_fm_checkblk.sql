...
begin
               ...
               from (     -- opldok
                      select p.ref
                       ...
                       where p.pdat between trunc(sysdate) and to_date(to_char(sysdate, 'dd.mm.yyyy')||' 23:59:59', 'dd.mm.yyyy hh24:mi:ss')
                         ...
                         and a.blkd = getglobaloption('FM_BLK')
                      ...
                      select p.ref
                       ...
                       where p.pdat between trunc(sysdate) and to_date(to_char(sysdate, 'dd.mm.yyyy')||' 23:59:59', 'dd.mm.yyyy hh24:mi:ss')
                         ...
                         and decode(p.dk,1,p.mfoa,p.mfob) = getglobaloption('GLB-MFO')
                         and ( a.nbs in ('2560', '2570', '2600', '2601', '2602',
                                         '2604', '2605', '2606', '2610', '2611', '2615', '2620', '2622',
                                         '2625', '2630', '2635', '2640', '2641', '2642', '2643', '2650',
                                         '2651', '2652', '2655')
  ...
  loop
     ...
     values (z.ref, 'I', '000000000000000', '0000', null, '000', null, 0, user_id, null, null, 'блокування ФМ');
