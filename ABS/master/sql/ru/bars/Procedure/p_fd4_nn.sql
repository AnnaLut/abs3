...
% VERSION     : 23/03/2016 (09.09.2014, 01.09.2014)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
CURSOR OPL_DOK IS
   ...
   FROM accounts a, opldok c, kl_f3_29 n, operw k,
        cust_acc ca, custbank cb, customer b
...
LOOP
   ...
   IF flag_=0 and SN_ >0 THEN
      ...
      if nlsd_ like '3739%' and nlsk_ like nls_ || '%' then
         ddd_ := '13';
      end if;

      if nlsd_ like nls_ || '%' and nlsk_ like '3739%' and ddd_ is null then
         ddd_ := '31';
      end if;
...
grant EXECUTE                                                                on P_FD4_NN        to WR_ALL_RIGHTS;
