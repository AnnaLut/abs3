...
13.02.2012 изъять 20 аналитику для ОБ22 in ('03','10','16'     )
17.06.2011 Sta Исключила валюту 954

23-02-2011 Sta на всякий випадок вiдкривають новi 3800 та 3801 дату вiдк меншою
06-01-2011 Sta Обеспечить 100% наличие всех нужных сч 6204
               при помощи процедуры OP_BS_OB1 (b.branch,'6204ХХ' ) ;

 Открыть новые 3800 и 3801 для  каждого бранча-2 и
 для валюты kv not (959,961,962)
  и
 для ОБ22 in ('03','10','16','20')
...
loop
  ...
  ElsIf o.ob22 = '10' then txt_:= 'купiвля-продаж ';
...
--ElsIf o.ob22 = '20' then txt_:= 'купiвля-продаж Б/Г';
  ...
  loop
    ...
    loop
      ...
      nms3800_ :='ВП  '|| k.KV || txt_||'. Бранч '||BBBB_;
      ...
      nms3801_ :='ЕВП '|| k.KV || txt_||'. Бранч '||BBBB_;
      ...
      ----------НKР-1)  найти/открить нужный 6204/01 или 6204/17 від переоцінки рахунків резервів в іноземній валюті;
