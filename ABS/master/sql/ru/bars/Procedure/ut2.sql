...
/*
 ...
 Версия  1.0  11-04-2017  17-05-2016

 1) 11-04-2017 - rez23 - не менять!
*/
   ...
   loop
      ...
      loop
         ...
         update nbu23_rez set diskont  = k1.diskont + l_di
                --, rez23 = k1.rez23 - l_di, rezq23   = gl.p_icurval ( k.kv, (k1.rez23 - l_di)*100, dat31_ ) / 100 РЕЗЕРВ НЕ МЕНЯТЬ
         where rowid = k1.RI;
