...
begin
   ...
   l_dat31 := Dat_last  (dat01_-4,dat01_-1);
   l_maket := 1;

   begin
      select nlsa, s into l_nlsa,l_s
      from rez_doc_maket where dk<>-1 and rownum=1 and ref is not null order by nlsa ;
   EXCEPTION  WHEN NO_DATA_FOUND  THEN
      l_maket := 0;
   end;
   begin
      select sos into l_sos from oper
      where TT IN ('ARE','AR*') and nlsa=l_nlsa and s=l_s AND
            VDAT = l_dat31 and sos<>-1;
      l_maket := 0;
   EXCEPTION  WHEN NO_DATA_FOUND  THEN
      l_maket := 1;
   end;
...
-- все строки
   ...
   select *
   from ( select decode(o.dk,1,0,1) DK,o.kv kV,o.nlsa NLSA,o.nlsb NLSB,
                 sum(decode(o.dk,1,o.s2,-o.s2))/100 S,nvl(gn.grp,10) GRP
          from rez_doc_maket o,accounts a,grp_rez g,grp_rez_nbs gn
          where tt in ('ARE','AR*') and vdat=l_dat31 and o.nlsa=a.nls and
                o.kv=a.kv and a.nbs=gn.nbs (+) and a.ob22=gn.ob22 (+) and
                gn.grp=g.grp (+) and dk<>-1 and l_maket=1 and ref is null
          group by decode(o.dk,1,0,1),o.kv,o.nlsa,o.nlsb,gn.grp,g.name
          union all
          select o.dk DK,o.kv kV,o.nlsa NLSA,o.nlsb NLSB,
                 sum(decode(o.dk,1,-o.s2,o.s2))/100 S,nvl(gn.grp,10) GRP
          from oper o,accounts a,grp_rez g,grp_rez_nbs gn
          where tt in ('ARE','AR*') and vdat=l_dat31 and o.nlsa=a.nls and
                o.kv=a.kv and a.nbs=gn.nbs (+) and a.ob22=gn.ob22 (+) and
                gn.grp=g.grp (+) and sos <> -1
          group by o.dk,o.kv,o.nlsa,o.nlsb,gn.grp,g.name   )
   order by  grp,kv,nlsa;
/*
   select o.dk DK,o.kv kV,o.nlsa NLSA,o.nlsb NLSB,
          sum(decode(o.dk,1,-o.sq,o.sq))/100 S,nvl(gn.grp,10) GRP
   from rez_doc_maket o,accounts a,grp_rez g,grp_rez_nbs gn
   where tt in ('ARE','AR*') and vdat=l_dat31 and o.nlsa=a.nls and o.kv=a.kv
         and a.nbs=gn.nbs (+) and a.ob22=gn.ob22 (+) and gn.grp=g.grp (+)
         and sos in (1,5)
   group by o.dk,o.kv,o.nlsa,o.nlsb,gn.grp,g.name
   order by  gn.grp,o.kv;
 */
-- Итог по группе
   insert into order_rez (NAME,GRP,S)
   select g.name,nvl(x.grp,10),sum(x.S)
   from (select o.dk DK,o.kv kV,o.nlsa NLSA,o.nlsb NLSB,
                sum(decode(o.dk,1,-o.s2,o.s2))/100 S,gn.grp GRP,g.name NAME
         from  oper o,accounts a,grp_rez g,grp_rez_nbs gn
         where tt in ('ARE','AR*') and vdat=l_dat31 and o.nlsa=a.nls
               and o.kv=a.kv and a.nbs=gn.nbs (+) and a.ob22=gn.ob22 (+)
               and gn.grp=g.grp (+) and sos <>-1
         group by o.dk,o.kv,o.nlsa,o.nlsb,gn.grp,g.name
         union all
         select decode(o.dk,1,0,1) DK,o.kv kV,o.nlsa NLSA,o.nlsb NLSB,
                sum(decode(o.dk,1,o.s2,-o.s2))/100 S,gn.grp GRP,g.name NAME
         from  REZ_doc_maket o,accounts a,grp_rez g,grp_rez_nbs gn
         where tt in ('ARE','AR*') and vdat=l_dat31 and o.nlsa=a.nls
               and o.kv=a.kv and a.nbs=gn.nbs (+) and a.ob22=gn.ob22 (+)
               and gn.grp=g.grp (+) and dk<>-1 and  l_maket=1 and ref is null
         group by decode(o.dk,1,0,1),o.kv,o.nlsa,o.nlsb,gn.grp,g.name
         ) x, grp_rez g
   where x.grp=g.grp (+)
...
/*
   select g.name,nvl(x.grp,10),sum(x.S)
   from (select o.dk DK,o.kv kV,o.nlsa NLSA,o.nlsb NLSB,
                sum(decode(o.dk,1,-o.sq,o.sq))/100 S,gn.grp GRP,g.name NAME
         from  oper o,accounts a,grp_rez g,grp_rez_nbs gn
         where tt in ('ARE','AR*') and vdat=l_dat31 and o.nlsa=a.nls
               and o.kv=a.kv and a.nbs=gn.nbs (+) and a.ob22=gn.ob22 (+)
               and gn.grp=g.grp (+) and sos in (1,5)
