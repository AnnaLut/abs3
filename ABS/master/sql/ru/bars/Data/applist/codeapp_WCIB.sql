...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WCIB.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WCIB ***
  declare
    l_application_code varchar2(10 char) := 'WCIB';
    l_application_name varchar2(300 char) := 'АРМ Валютний контроль ТВБВ';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WCIB створюємо (або оновлюємо) АРМ АРМ Валютний контроль ТВБВ ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WCIB) - АРМ Валютний контроль ТВБВ  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWCIB.sql =========*** En
PROMPT ===================================================================================== 
