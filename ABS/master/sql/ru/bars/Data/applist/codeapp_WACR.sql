...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WACR.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WACR ***
  declare
    l_application_code varchar2(10 char) := 'WACR';
    l_application_name varchar2(300 char) := '--- АРМ Нарахування %% (WEB)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WACR створюємо (або оновлюємо) АРМ --- АРМ Нарахування %% (WEB) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WACR) - --- АРМ Нарахування %% (WEB)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWACR.sql =========*** En
PROMPT ===================================================================================== 
