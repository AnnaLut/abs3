...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_SEPN.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  SEPN ***
  declare
    l_application_code varchar2(10 char) := 'SEPN';
    l_application_name varchar2(300 char) := 'АРМ Заблоковані надходження з СЕП';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' SEPN створюємо (або оновлюємо) АРМ АРМ Заблоковані надходження з СЕП ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (SEPN) - АРМ Заблоковані надходження з СЕП  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappSEPN.sql =========*** En
PROMPT ===================================================================================== 
