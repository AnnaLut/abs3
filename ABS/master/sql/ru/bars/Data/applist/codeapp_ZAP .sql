...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_ZAP .sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  ZAP  ***
  declare
    l_application_code varchar2(10 char) := 'ZAP ';
    l_application_name varchar2(300 char) := 'СЕП. Інформаційні запити';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' ZAP  створюємо (або оновлюємо) АРМ СЕП. Інформаційні запити ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (ZAP ) - СЕП. Інформаційні запити  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappZAP .sql =========*** En
PROMPT ===================================================================================== 
