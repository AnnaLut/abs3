...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WIAF.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WIAF ***
  declare
    l_application_code varchar2(10 char) := 'WIAF';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WIAF створюємо (або оновлюємо) АРМ АРМ Страхування ФО (Адміністратор) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WIAF) - АРМ Страхування ФО (Адміністратор)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWIAF.sql =========*** En
PROMPT ===================================================================================== 
