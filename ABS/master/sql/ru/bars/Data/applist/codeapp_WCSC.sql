...
PROMPT *** Create/replace  ARM  WCSC ***
  declare
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WCSC створюємо (або оновлюємо) АРМ АРМ Конструктора кредитних продуктів (WEB) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WCSC) - АРМ Конструктора кредитних продуктів (WEB)  ');
