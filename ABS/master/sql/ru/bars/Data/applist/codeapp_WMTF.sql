...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WMTF.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WMTF ***
  declare
    l_application_code varchar2(10 char) := 'WMTF';
    l_application_name varchar2(300 char) := 'АРМ Реєстрації миттєвої картки на Ф.О.';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WMTF створюємо (або оновлюємо) АРМ АРМ Реєстрації миттєвої картки на Ф.О. ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WMTF) - АРМ Реєстрації миттєвої картки на Ф.О.  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWMTF.sql =========*** En
PROMPT ===================================================================================== 
