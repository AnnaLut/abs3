...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WDPT.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WDPT ***
  declare
    l_application_code varchar2(10 char) := 'WDPT';
    l_application_name varchar2(300 char) := 'АРМ Вкладних операцій (Web)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WDPT створюємо (або оновлюємо) АРМ АРМ Вкладних операцій (Web) ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Депозити ДУ Регулярні платежі ********** ');
          --  Створюємо функцію Депозити ДУ Регулярні платежі
      l := l +1;
      l_function_ids.extend(l);
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => 'Депозити ДУ Регулярні платежі',
                                                  p_funcname => '/barsroot/deposit/deloitte/depositaddregular.aspx',
                                                  p_rolename => '' ,
                                                  p_frontend => l_application_type_id
                                                  );
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WDPT) - АРМ Вкладних операцій (Web)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWDPT.sql =========*** En
PROMPT ===================================================================================== 
