...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_ACBO.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  ACBO ***
  declare
    l_application_code varchar2(10 char) := 'ACBO';
    l_application_name varchar2(300 char) := 'ACBO - Компенсація вкл.СРСР';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' ACBO створюємо (або оновлюємо) АРМ ACBO - Компенсація вкл.СРСР ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (ACBO) - ACBO - Компенсація вкл.СРСР  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappACBO.sql =========*** En
PROMPT ===================================================================================== 
