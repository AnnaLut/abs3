...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_PROB.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  PROB ***
  declare
    l_application_code varchar2(10 char) := 'PROB';
    l_application_name varchar2(300 char) := '*АРМ Проблемні активи (Web)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' PROB створюємо (або оновлюємо) АРМ *АРМ Проблемні активи (Web) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (PROB) - *АРМ Проблемні активи (Web)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappPROB.sql =========*** En
PROMPT ===================================================================================== 
