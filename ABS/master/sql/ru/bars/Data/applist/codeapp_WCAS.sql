...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WCAS.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WCAS ***
  declare
    l_application_code varchar2(10 char) := 'WCAS';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WCAS створюємо (або оновлюємо) АРМ АРМ Касира ТВБВ (Web) ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Пiдкрiплення касира iншим касиром ********** ');
      ...
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  ...
                                                  p_funcname => '/barsroot/barsweb/references/refbook.aspx?tabid=4014&mode=RO&force=1',
                                                  p_rolename => 'PYOD001' ,
                                                  p_frontend => l_application_type_id
                                                  );
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WCAS) - АРМ Касира ТВБВ (Web)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWCAS.sql =========*** En
PROMPT ===================================================================================== 
