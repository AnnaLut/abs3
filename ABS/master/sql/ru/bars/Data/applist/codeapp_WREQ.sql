...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_WREQ.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  WREQ ***
  declare
    l_application_code varchar2(10 char) := 'WREQ';
    l_application_name varchar2(300 char) := 'АРМ Обробка запитів БЕК-офісом (WEB)';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WREQ створюємо (або оновлюємо) АРМ АРМ Обробка запитів БЕК-офісом (WEB) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WREQ) - АРМ Обробка запитів БЕК-офісом (WEB)  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappWREQ.sql =========*** En
PROMPT ===================================================================================== 
