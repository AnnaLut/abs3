...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_ANKL.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  ANKL ***
  declare
    l_application_code varchar2(10 char) := 'ANKL';
    l_application_name varchar2(300 char) := 'АРМ Аналiз клiєнтiв';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' ANKL створюємо (або оновлюємо) АРМ АРМ Аналiз клiєнтiв ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (ANKL) - АРМ Аналiз клiєнтiв  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappANKL.sql =========*** En
PROMPT ===================================================================================== 
