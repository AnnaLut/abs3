...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_999 .sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  999  ***
  declare
    l_application_code varchar2(10 char) := '999 ';
    l_application_name varchar2(300 char) := 'АРМ "Перекриття коригуючих 6,7 класів за грудень на 5040(5041)"';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' 999  створюємо (або оновлюємо) АРМ АРМ "Перекриття коригуючих 6,7 класів за грудень на 5040(5041)" ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Згорнення 3800/3801(03) ********** ');
      ...
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  ...
                                                  p_funcname => 'F1_Select(13, "CLOS_380(3,'''','''','''','''');Виконати <Згорнення 3800/3801(03)>?;Виконано!")',
                                                  p_rolename => 'START1' ,
                                                  p_frontend => l_application_type_id
                                                  );
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (999 ) - АРМ "Перекриття коригуючих 6,7 класів за грудень на 5040(5041)"  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeapp999 .sql =========*** En
PROMPT ===================================================================================== 
