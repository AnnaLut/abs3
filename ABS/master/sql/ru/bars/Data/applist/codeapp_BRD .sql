...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_BRD .sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  BRD  ***
  declare
    l_application_code varchar2(10 char) := 'BRD ';
    l_application_name varchar2(300 char) := '*АРМ Баланс-Рахунок-Документ';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' BRD  створюємо (або оновлюємо) АРМ *АРМ Баланс-Рахунок-Документ ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (BRD ) - *АРМ Баланс-Рахунок-Документ  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappBRD .sql =========*** En
PROMPT ===================================================================================== 
