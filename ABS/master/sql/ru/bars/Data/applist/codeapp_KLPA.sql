...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_KLPA.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  KLPA ***
  declare
    l_application_code varchar2(10 char) := 'KLPA';
    l_application_name varchar2(300 char) := 'АРМ "Обробка платежів по Клієнт-Банку"';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' KLPA створюємо (або оновлюємо) АРМ АРМ "Обробка платежів по Клієнт-Банку" ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (KLPA) - АРМ "Обробка платежів по Клієнт-Банку"  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappKLPA.sql =========*** En
PROMPT ===================================================================================== 
