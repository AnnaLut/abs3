...
PROMPT *** Create/replace  ARM  WBIR ***
  declare
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' WBIR створюємо (або оновлюємо) АРМ АРМ Біржеві операції-ведення заявок (WEB) ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (WBIR) - АРМ Біржеві операції-ведення заявок (WEB)  ');
