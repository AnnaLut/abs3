...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_CDM .sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  CDM  ***
  declare
    l_application_code varchar2(10 char) := 'CDM ';
    l_application_name varchar2(300 char) := '(OLD) Робота з ЄБК ФО';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' CDM  створюємо (або оновлюємо) АРМ (OLD) Робота з ЄБК ФО ');
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (CDM ) - (OLD) Робота з ЄБК ФО  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappCDM .sql =========*** En
PROMPT ===================================================================================== 
