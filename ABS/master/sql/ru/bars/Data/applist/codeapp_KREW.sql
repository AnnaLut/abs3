...
SET DEFINE OFF 
PROMPT ===================================================================================== 
PROMPT *** Run *** ========== Scripts /Sql/Bars/Data/codeapp_KREW.sql =========*** Run *** =
PROMPT ===================================================================================== 


PROMPT *** Create/replace  ARM  KREW ***
  declare
    l_application_code varchar2(10 char) := 'KREW';
	...
	d integer := 0;
begin
     DBMS_OUTPUT.PUT_LINE(' KREW створюємо (або оновлюємо) АРМ АРМ кредитного iнспектора ');
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Облiк цiнностей по КД ********** ');
      ...
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  ...
                                                  p_funcname => '/barsroot/barsweb/references/refbook.aspx?tabid=4013&mode=RO&force=1',
                                                  p_rolename => 'PYOD001' ,
                                                  p_frontend => l_application_type_id
                                                  );
    ...
    DBMS_OUTPUT.PUT_LINE( chr(13)||chr(10)||' ********** Створюємо функцію Події по КП ********** ');
      ...
      l_function_ids(l)   :=   abs_utils.add_func(
                                                  p_name     => 'Події по КП',
                                                  p_funcname => '/barsroot/barsweb/references/refbook.aspx?tabid=5197&mode=RW&force=1',
                                                  p_rolename => 'RCC_DEAL' ,
                                                  p_frontend => l_application_type_id
                                                  );
   ...
   DBMS_OUTPUT.PUT_LINE(chr(13)||chr(10)||'  Прикріпляємо ресурси функцій до даного АРМу (KREW) - АРМ кредитного iнспектора  ');
...
PROMPT ===================================================================================== 
PROMPT *** End *** ========== Scripts /Sql/Bars/Data/Applist/codeappKREW.sql =========*** En
PROMPT ===================================================================================== 
