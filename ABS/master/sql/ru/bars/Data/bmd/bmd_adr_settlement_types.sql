...
begin
  ...
  l_tabsemantic := 'Довідник типів населених пунктів';
  l_tabname := 'ADR_SETTLEMENT_TYPES';
  ...
  bars_metabase.add_column(l_tabid, 1, 'SETTLEMENT_TP_ID', 'N', 'Ідентифікатор типу населеного пункту', null, 3, null, 0, 1, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'SETTLEMENT_TP_NM', 'C', 'Назва типу населеного пункту', null, 50, null, 0, 0, 1, 0, '', '', 1, 0, '', 1, 0, 1, '');
  bars_metabase.add_column(l_tabid, 3, 'SETTLEMENT_TP_NM_RU', 'C', 'Назва типу населеного пункту', null, 50, null, 0, 0, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
