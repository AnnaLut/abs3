...
begin
  ...
  l_tabsemantic := 'Довідник районів';
  l_tabname := 'ADR_AREAS';
  ...
  bars_metabase.add_column(l_tabid, 1, 'AREA_ID', 'N', 'Ідентифікатор району', null, 10, 1, 0, 1, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'AREA_NAME', 'C', 'Назва району', null, 50, 2, 0, 0, 1, 0, '', '', 0, 0, '', 1, 0, 1, '');
  bars_metabase.add_column(l_tabid, 3, 'AREA_NAME_RU', 'C', 'Назва району', null, 50, 3, 0, 0, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 4, 'REGION_ID', 'N', 'Ідентифікатор області', null, 10, 4, 0, 0, 0, 0, '', '', 0, 0, '', 1, 0, 1, '');
