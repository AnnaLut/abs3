...
begin
  ...
  l_tabsemantic := 'Довідник областей';
  l_tabname := 'ADR_REGIONS';
  ...
  bars_metabase.add_column(l_tabid, 1, 'REGION_ID', 'N', 'Ідентифікатор області', null, 10, 1, 0, 1, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'REGION_NAME', 'C', 'Назва області', null, 50, 2, 0, 0, 1, 0, '', '', 0, 0, '', 0, 0, 0, '');
  bars_metabase.add_column(l_tabid, 3, 'REGION_NAME_RU', 'C', 'Назва області', null, 50, 3, 0, 0, 0, 0, '', '', 0, 0, '', 0, 0, 0, '');
  bars_metabase.add_column(l_tabid, 4, 'COUNTRY_ID', 'N', 'Код країни', null, 3, 4, 0, 0, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
