...
begin
  ...
  l_tabsemantic := 'Довідник телефонних кодів';
  l_tabname := 'ADR_PHONE_CODES';
  ...
  bars_metabase.add_column(l_tabid, 1, 'PHONE_CODE_ID', 'N', 'Ід. телефонного коду', null, 10, 1, 0, 1, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
  bars_metabase.add_column(l_tabid, 2, 'PHONE_CODE', 'C', 'Телефонний код', null, 10, 2, 0, 0, 1, 0, '', '', 1, 0, '', 1, 0, 1, '');
  bars_metabase.add_column(l_tabid, 3, 'PHONE_ADD_NUM', 'C', 'Додатковий номер', null, 10, 3, 0, 0, 0, 0, '', '', 0, 0, '', 1, 0, 0, '');
