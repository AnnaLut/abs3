...
prompt Наименование операции: Нарах. доходи за договор з приватними нотаріусами (іпотека/застава ЮО)
declare
  cnt_  number;
begin
  --------------------------------
