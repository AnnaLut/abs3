...
prompt Наименование операции: Конвертація валюти за іншими безготівковими операціями
declare
  cnt_  number;
begin
  --------------------------------
