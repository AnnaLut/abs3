...
begin
  ...
  begin
    ...
    values ('V29', 'Виплати МО,МВС,СБУ,ДПА,ДДзВП + СК+Фонди', 1, null, 980, '#(tobopack.GetTOBOParam(''CASH''))', 980, null, null, '#(tobopack.GetTOBOParam(''CASH''))', null, 0, 0, 0, 0, null, null, 50, null, null, null, '0000100001000001000000000000000000010000000000000000000000000000', 'Виплата згiдно заяви');
  exception
    when dup_val_on_index then 
      update tts
         set tt='V29', name='Виплати МО,МВС,СБУ,ДПА,ДДзВП + СК+Фонди', dk=1, nlsm=null, kv=980, nlsk='#(tobopack.GetTOBOParam(''CASH''))', kvk=980, nlss=null, nlsa=null, nlsb='#(tobopack.GetTOBOParam(''CASH''))', mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=50, proc=null, s3800=null, rang=null, flags='0000100001000001000000000000000000010000000000000000000000000000', nazn='Виплата згiдно заяви'
       where tt='V29';
  end;
  --------------------------------
  ----------- Реквизиты ----------
