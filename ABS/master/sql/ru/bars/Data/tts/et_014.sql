...
begin
  ...
  begin
    ...
    values ('014', '014  Інформаційний ДЕБЕТ', 2, null, null, null, null, null, null, null, null, 1, 1, 0, 1, null, null, null, null, null, null, '1300100000000000000000000001000000000000000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='014', name='014  Інформаційний ДЕБЕТ', dk=2, nlsm=null, kv=null, nlsk=null, kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=1, fli=1, flv=0, flr=1, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='1300100000000000000000000001000000000000000000000000000000000000', nazn=null
       where tt='014';
  end;
  --------------------------------
  ----------- Реквизиты ----------
  ...
  exception
    ...
    when others then
      if ( sqlcode = -02291 ) then
        dbms_output.put_line('Не удалось добавить запись (tts_vob: 7, ''014'', null) - первичный ключ не найден!');
      else raise;
      end if;
  end;
  begin
