...
begin
  ...
  begin
    insert into tts(tt, name, dk, nlsm, kv, nlsk, kvk, nlss, nlsa, nlsb, mfob, flc, fli, flv, flr, s, s2, sk, proc, s3800, rang, flags, nazn)
    values ('DU7', 'Виплата відсотків в ін.валюті (міжбанк)', 1, null, null, '#(get_proc_nls(''T00'',#(KVA)))', null, null, null, '191992', '300465', 1, 1, 0, 0, null, null, null, null, null, 9, '0000100000000000000000000000000000010000000000000000000000000000', 'Відсотки по депозиту згідно #{DPU.F_NAZN(''U'',#(ND))}');
  exception
    when dup_val_on_index then 
      update tts
         set tt='DU7', name='Виплата відсотків в ін.валюті (міжбанк)', dk=1, nlsm=null, kv=null, nlsk='#(get_proc_nls(''T00'',#(KVA)))', kvk=null, nlss=null, nlsa=null, nlsb='191992', mfob='300465', flc=1, fli=1, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=9, flags='0000100000000000000000000000000000010000000000000000000000000000', nazn='Відсотки по депозиту згідно #{DPU.F_NAZN(''U'',#(ND))}'
       where tt='DU7';
  end;
  --------------------------------
  ----------- Реквизиты ----------
