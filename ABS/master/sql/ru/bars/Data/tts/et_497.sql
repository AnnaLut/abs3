...
prompt Наименование операции: 497 Коригуючі проводки по зменш.резерву за деб заборгованістю за ін.ак
declare
  cnt_  number;
begin
  --------------------------------
