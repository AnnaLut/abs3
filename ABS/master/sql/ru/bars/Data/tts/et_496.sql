...
prompt Наименование операции: 496 Коригуючі проводки по форм.резерву за деб заборгованістю за ін.акт
declare
  cnt_  number;
begin
  --------------------------------
