...
prompt Наименование операции: Списання з позаб. оприбутк.цінностей банкнот після досл. від НБУ
declare
  cnt_  number;
begin
  --------------------------------
  ...
  begin
    ...
    values ('SB9', 'Списання з позаб. оприбутк.цінностей банкнот після досл. від НБУ', 1, '#(nbs_ob22 (''9899'',''C4''))', null, '#(nbs_ob22 (''9910'',''01''))', null, null, null, null, null, 0, 0, 0, 0, null, null, null, null, null, null, '0000100000000000000000000000000000000100000000000000000000000000', null);
  exception
    when dup_val_on_index then 
      update tts
         set tt='SB9', name='Списання з позаб. оприбутк.цінностей банкнот після досл. від НБУ', dk=1, nlsm='#(nbs_ob22 (''9899'',''C4''))', kv=null, nlsk='#(nbs_ob22 (''9910'',''01''))', kvk=null, nlss=null, nlsa=null, nlsb=null, mfob=null, flc=0, fli=0, flv=0, flr=0, s=null, s2=null, sk=null, proc=null, s3800=null, rang=null, flags='0000100000000000000000000000000000000100000000000000000000000000', nazn=null
       where tt='SB9';
  end;
  --------------------------------
  ----------- Реквизиты ----------
