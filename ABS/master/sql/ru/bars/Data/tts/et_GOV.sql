...
prompt Наименование операции: --- Розрахунки за КУПІВЛЮ валюти через вал.позицію
declare
  cnt_  number;
begin
  --------------------------------
