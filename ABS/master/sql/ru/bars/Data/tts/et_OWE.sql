...
prompt Наименование операции: Дочірня до OWR  реверсал
declare
  cnt_  number;
begin
  --------------------------------
