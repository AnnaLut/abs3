prompt ===================================== 
prompt == Легалізація (значні суми)
prompt ===================================== 
...
begin     
   l_zpr.name := 'Легалізація (значні суми)';
   l_zpr.pkey := '\BRS\SBER\***\149';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.txt          := ' select ''Документи значні готівкові'' tip,
   ref,
   tt,
   nd,
   vdat,
 ...
 where o.vdat>=:Param0 and o.vdat<=:Param1 and
   ((substr(o.nlsa,1,4) in (''2600'',''2625'',''2620'',''2630'',''2603'',
       ''2605'',''2203'',''2206'',''2210'',''2211'',''2213'',''2214'',''1600'') 
   ...
   (select rate_o/bsum from  cur_rates
         where vdate=(select max(vdate) from cur_rates where vdate<=o.vdat) and kv=978))>=10000 and o.sos=5
union all
 select ''Документи значні безготівкові'' tip,
   ref,
   tt,
   nd,
   vdat,
 ...
 where o.vdat>=:Param0 and o.vdat<=:Param1 and
   (substr(o.nlsa,1,4) in (''2600'',''2625'',''2620'',''2630'',''2603'',
       ''2605'',''2203'',''2206'',''2210'',''2211'',''2213'',''2214'',''1600'') or
   substr(o.nlsb,1,4) in (''2600'',''2625'',''2620'',''2630'',''2603'',
       ''2605'',''2203'',''2206'',''2210'',''2211'',''2213'',''2214'',''1600'')) and
   (gl.p_icurval(o.kv,o.s/100,o.vdat)/
   (select rate_o/bsum from  cur_rates
