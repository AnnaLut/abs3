prompt =====================================
prompt == Контроль запитів перегляду мобільних номерів
prompt =====================================
...
begin
   l_zpr.name := 'Контроль запитів перегляду мобільних номерів';
   ...
   exception when no_data_found then
    ...
    l_zpr.bindvars     := ':sFdat1='''',:sFdat2='''',:rnk=''РНК (%-всі)'',:branch=''Відділення(%-всі)'',:Param0=''Телефон(%-всі)''';
    l_zpr.create_stmt  := '';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Контроль запитів перегляду мобільних номерів';
