prompt ===================================== 
prompt == Суми залишків на рахунках ЮО для #42 файлу
prompt ===================================== 
...
begin     
   l_zpr.name := 'Суми залишків на рахунках ЮО для #42 файлу';
   l_zpr.pkey := '\BRS\SBR\***\3038';
   ...
   exception when no_data_found then                       
    ...
    l_zpr.create_stmt  := '';
    l_zpr.rpt_template := 'rep3038.frx';
    l_zpr.form_proc    := '';
    l_zpr.default_vars := '';
    l_zpr.bind_sql     := '';
