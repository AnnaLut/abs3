prompt =====================================
prompt == Виписка за поточними рахунками клієнта
prompt =====================================
...
begin
   l_zpr.name := 'Виписка за поточними рахунками клієнта';
   ...
   exception when no_data_found then
    ...
    l_zpr.bindvars     := ':sFdat1='''',:sFdat2='''',:Param0=''Маска рахунку (%-всi)'',:KV=''Валюта (0-всi)'',:BRANCH=''Вiддiлення'',:DEP=''Вкл. пiдлеглих (1-вкл.)'',:ISP=''Виконавець рах.(0-всi)''';
    l_zpr.create_stmt  := '';
    ...
    l_zpr.default_vars := ':Param0=''%'',:KV=''0'',:BRANCH=''Поточне'',:DEP=''1'',:ISP=''0''';
    ...
    l_rep.name        :='Empty';
    l_rep.description :='Виписка за поточними рахунками клієнта';
