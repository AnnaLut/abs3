...
namespace cim
{
    public sealed class VCimConclusionRecord : BbRecord
    {
        ...
        public VCimConclusionRecord(BbDataSource Parent, OracleDecimal RowScn, Decimal? ID, Decimal? CONTR_ID, Decimal? ORG_ID, String ORG_NAME, String OUT_NUM, DateTime? OUT_DATE, Decimal? KV, Decimal? S, DateTime? BEGIN_DATE, DateTime? END_DATE, Decimal? S_DOC, DateTime? CREATE_DATE, Decimal? CREATE_UID, String EA_URL)
            : this(Parent)
        {
            this.ID = ID;
        ...
        {
            Fields.Add( new BbField("ID", OracleDbType.Decimal, false, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "ID висновку"));
            Fields.Add( new BbField("CONTR_ID", OracleDbType.Decimal, false, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "ID контракту"));
            Fields.Add( new BbField("ORG_ID", OracleDbType.Decimal, false, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "id органу, який видав висновок"));
            Fields.Add( new BbField("ORG_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Назва органу, який видав висновок"));
            Fields.Add( new BbField("OUT_NUM", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Вихідний номер висновку"));
            Fields.Add( new BbField("OUT_DATE", OracleDbType.Date, true, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Вихідна дата висновку"));
            Fields.Add( new BbField("KV", OracleDbType.Decimal, false, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Код валюти"));
            Fields.Add( new BbField("S", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Сума висновку"));
            Fields.Add( new BbField("BEGIN_DATE", OracleDbType.Date, false, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Дата початку строку"));
            Fields.Add( new BbField("END_DATE", OracleDbType.Date, false, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Дата закінчення строку"));
            Fields.Add( new BbField("S_DOC", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Сума пов`язаних документів"));
            Fields.Add( new BbField("CREATE_DATE", OracleDbType.Date, false, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Дата введення висновку"));
            Fields.Add( new BbField("CREATE_UID", OracleDbType.Decimal, false, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Користувач, який ввів висновок"));
            Fields.Add( new BbField("EA_URL", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_CONCLUSION", ObjectTypes.View, "Висновки v 1.00.01", "Адреса сервера електронного архіву ВК"));        
        }
