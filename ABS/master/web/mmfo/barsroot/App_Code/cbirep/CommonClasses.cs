...
namespace Bars.ObjLayer.CbiRep
{
    ...
    public class ParsedReport
    {
        ...
        private string param(string inputString)
        {
        ...
        private void Parse()
        {
            ...
            if (!String.IsNullOrEmpty(this._CbirepRepParams.BINDVARS))
                foreach (String param in this._CbirepRepParams.BINDVARS.Split(delimeter, StringSplitOptions.None))
                {
                    ...
                    string[] sep = new string[] { "\'", ":", "=" };
                    string[] words = param.Split(sep, StringSplitOptions.RemoveEmptyEntries);
                    String ID="",Name="";
                    if (words.Length < 2)
                    {
                        ID = words[0];
                    ...
                    //String  Name = space.Split().Trim('\'')[1].Trim('\'')[0];
    ...
    public class ReportSystemParams
    {
        ...
        public String GenerateReportFile()
        {
            ...
            DBLogger.Debug("BarsWeb.CbiRep : arguments line = " + ApplFilePath + " " + ExeFileArgs, "BarsWeb.CbiRep");
