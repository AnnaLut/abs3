...
{
    public class V_PFU_REGISTERS_ARC
    {
        public DateTime? arcdate { get; set; } //Дата попадання в архів
        public string arcdateuser { get; set; } //ПІБ користувача, який додав реєстр до архіву
