...
/// <summary>
/// Summary description for McpAreaRegistration
/// </summary>
public class McpAreaRegistration : AreaRegistration
{
    public override string AreaName { get { return "Mcp"; } }
    ...
    private void BindAreaDI()
    {
        ...
        ninjectKernel.Bind<IMcpRepository>().To<McpRepository>();
    }
}