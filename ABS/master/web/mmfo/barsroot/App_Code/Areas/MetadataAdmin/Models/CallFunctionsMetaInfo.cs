...
namespace BarsWeb.Areas.MetaDataAdmin.Models
{
    ...
    public class CallFunctionMetaInfo
    {
        ...
        public List<ComplexParams> ComplexParams { get; set; }
        ...
        public List<GenerateParamInfo> GenerateParamsInfo { get;set;}
        ...
        public List<GetParamsInfo> GetParamsInfo { get; set; }
