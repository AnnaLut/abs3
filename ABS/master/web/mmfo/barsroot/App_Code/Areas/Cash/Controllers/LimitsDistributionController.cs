...
namespace BarsWeb.Areas.Cash.Controllers
{
    ...
    public class LimitsDistributionController : ApplicationController
    {
        ...
        public ActionResult ShowMfoProtocol(decimal? id = null)
        {
            ViewBag.id = id;
            return View();
        }

        public ActionResult ShowAtmProtocol(decimal? id = null)
        {
            ViewBag.id = id;
            return View();
        }
        ...
        public ActionResult GetAtmProtocolData(
            [DataSourceRequest] DataSourceRequest request,
            decimal id)
        {
            var data = _atmLimDistRepository.GetAtmProtocolData(id);
            var list = data.ToDataSourceResult(request);
            return Json(list, JsonRequestBehavior.AllowGet);
        }

        public ActionResult GetMfoProtocolData(
        [DataSourceRequest] DataSourceRequest request,
        decimal id)
        {
            var data = _mfoLimDistRepository.GetMfoProtocolData(id);
            var list = data.ToDataSourceResult(request);
            return Json(list, JsonRequestBehavior.AllowGet);
        }
