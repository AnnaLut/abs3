...
namespace BarsWeb.Areas.Cash.Infrastructure.Sync
{
    ...
    {
        public BranchSynchronizer(ICenterAccountRepository centerAccountRepository, ISyncRepository syncRepository)
        ...
        {
            connectionOption.Url = CombineUrl(connectionOption.Url, GetBranchesActionMethod + "?mfoCode=" + connectionOption.Mfo);
            ...
            */
            ...
            try
            {
                ...
                foreach (var branch in brachesResponse.Branches)
                {
                    ...
                    CenterAccountRepository.AddBranchData(branch);
