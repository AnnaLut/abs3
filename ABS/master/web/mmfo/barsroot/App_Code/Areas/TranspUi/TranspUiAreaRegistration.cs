...
/// <summary>
/// Summary description for TranspUiAreaRegistration
/// </summary>
public class TranspUiAreaRegistration : AreaRegistration
{
    public override string AreaName { get { return "TranspUi"; } }
    ...
    private void BindAreaDI()
    {
        ...
        ninjectKernel.Bind<ITranspUiRepository>().To<TranspUiRepository>();
    }
}