...
/// <summary>
/// Summary description for GDAAreaRegistration
/// </summary>
public class GDAAreaRegistration : AreaRegistration
{
    public override string AreaName { get { return "GDA"; } }
    ...
    private void BindAreaDI()
    {
        ...
        ninjectKernel.Bind<IGDARepository>().To<GDARepository>();
    }
}