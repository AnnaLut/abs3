    ...
    public class SqlCreatorBPK
    {
        ...
        public static BarsSql Active(decimal[] data, int confirm)
        {
            return new BarsSql()
            {
                ...
                SqlParams = new object[] 
                {
                    new OracleParameter("p_acc", OracleDbType.Array, data.Length, (Bars.Oracle.NumberList)data, ParameterDirection.Input) { UdtTypeName = "BARS.NUMBER_LIST", Value = data},
        ...
        public static BarsSql Active(decimal acc, int confirm)
        {
            return new BarsSql()
            {
                SqlText = @"begin
                                confirm_acc(:p_acc, :p_confirm);
                            end;",
                SqlParams = new object[]
                {
