...
namespace credit
{
    public sealed class VWcsCrdsrvBidTemplatesRecord : BbRecord
    {
        ...
        public VWcsCrdsrvBidTemplatesRecord(BbDataSource Parent, OracleDecimal RowScn, Decimal? BID_ID, String TEMPLATE_ID, String TEMPLATE_NAME, String PRINT_STATE_ID, String PRINT_STATE_NAME, String SCAN_QID, String WS_ID, Decimal? WS_NUM, String DOCEXP_TYPE_ID, Byte[] IMG, Decimal? IS_SCAN_REQUIRED, Decimal? ENABLED, Decimal? VISIBLE, String IQUERY_ID)
            : this(Parent)
        {
            this.BID_ID = BID_ID;
        ...
        private void fillFields()
        {
            ...
            Fields.Add(new BbField("IQUERY_ID", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_CRDSRV_BID_TEMPLATES", ObjectTypes.View, "Шаблоны заявки кредитной службы (Представление)", "Информационый запрос"));        
        }
