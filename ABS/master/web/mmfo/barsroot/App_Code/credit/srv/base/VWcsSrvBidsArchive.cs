...
namespace credit
{
    public sealed class VWcsSrvBidsArchiveRecord : BbRecord
    {
        ...
        private void fillFields()
        {
            ...
            //Fields.Add(new BbField("STATUS_REVIEW", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_SRV_BIDS_ARCHIVE", ObjectTypes.View, "Архив заявок службы (CБ, ЮС, СПА, ДР, ФЕП) (Представление)", "Статус рішення"));        
        }
