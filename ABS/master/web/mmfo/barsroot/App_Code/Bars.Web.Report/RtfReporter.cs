    ...
    public class RtfReporter
    {
        ...
        public void Generate()
        {
            ...
            try
            {
                ...
                // вычитываем шаблон
                _cmd.CommandText = "SELECT id, template , FILE_NAME FROM doc_scheme WHERE upper(ID)=upper('" + _strTemplateID + "')";
                ...
                if (fileNameObj != null && !string.IsNullOrEmpty(Convert.ToString(fileNameObj)))  //Exist frx file, print from it
                {
                    ...
                    pars.Add(new FrxParameter("adds", TypeCode.String, Convert.ToString(this.ADDS)));
