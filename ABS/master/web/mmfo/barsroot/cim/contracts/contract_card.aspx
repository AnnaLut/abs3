...
<asp:Content ID="contents_body" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <bars:BarsSqlDataSourceEx runat="server" ID="dsBranches" ProviderName="barsroot.core"
        SelectCommand="select branch, branch || ' - ' || name name from branch order by 1">
    </bars:BarsSqlDataSourceEx>
    ...
    <bars:BarsSqlDataSourceEx runat="server" ID="dsBasePersentRate" ProviderName="barsroot.core"
        SelectCommand="select null id, null name from dual union all select base, base from v_cim_f503_p_base">
    </bars:BarsSqlDataSourceEx>
    <bars:BarsSqlDataSourceEx runat="server" ID="dsBasePersentRateTerm" ProviderName="barsroot.core"
        SelectCommand="select null id, null name from dual union all select term, term from v_cim_f503_p_base_t">
    </bars:BarsSqlDataSourceEx>
    <bars:BarsSqlDataSourceEx runat="server" ID="dsPurpose" ProviderName="barsroot.core"
        SelectCommand="select null id, null name from dual union all select id,name from cim_credit_f503_purpose">
    </bars:BarsSqlDataSourceEx>
    <bars:BarsSqlDataSourceEx runat="server" ID="dsInfoAboutChanges" ProviderName="barsroot.core"
        SelectCommand="select null id, null info from dual union all select id,info from v_cim_f503_change_info">
    </bars:BarsSqlDataSourceEx>
            ...
            <asp:Panel runat="server" ID="pnMainReq" GroupingText="Базові реквізити">
                <table>
                    <tr>
                        ...
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddContrType" DataSourceID="dsContrType" DataTextField="CONTR_TYPE_NAME"
                                DataValueField="CONTR_TYPE_ID" ToolTip="Вкажіть тип контракту" class="required k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                        <td>Статус контракту
                        </td>
                        ...
                        <td style="text-align: left">Електронний архів:
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <input type="text" id="tbConractNum" maxlength="60" class="required k-textbox" title="Вкажіть номер контракту" />
                            Дод. номер
                            <input type="text" id="tbConractSubNum" maxlength="20" title="Вкажіть додатковий номер контракту" class="k-textbox"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <input type="text" id="tbDateOpen" name="tbDateOpen" class="required" maxlength="10"
                                title="Вкажіть дату відкриття контракту" style="text-align: center" />
                        </td>
                        <td>Дата закінчення
                        </td>
                        <td class="field">
                            <input type="text" id="tbDateClose" class="k-datepicker" title="Вкажіть дату закінчення контракту" style="text-align: center;" />
                        </td>
                    </tr>
                    <tr>
                        <td>Коментар
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddKv" DataSourceID="dsKv" DataTextField="NAME"
                                DataValueField="KV" ToolTip="Вкажіть валюту контракту" class="required k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                        <td>Сума контракту
                        </td>
                        <td class="field">
                            <bars:NumericEdit runat="server" ID="tbSum" ToolTip="Вкажіть суму контракту" class="k-textbox" Height="25px"></bars:NumericEdit>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
            <asp:Panel runat="server" ID="pnClient" GroupingText="Контрагент">
                <table>
                    <tr>
                        ...
                        <td class="field">
                            <input type="text" id="tbClientOkpo" name="tbClientOkpo" maxlength="10" class="required k-textbox"
                        ...
                        <td class="field">
                            <input type="text" id="tbClientRnk" name="tbClientRnk" class="required numeric k-textbox" title="Вкажіть внутрішній код контрагента" />
            ...
            <asp:Panel runat="server" ID="pnBenef" GroupingText="Бенефіціар (клієнт-нерезидент)">
                <table>
                    <tr>
                        ...
                        <td class="field">
                            <input type="text" id="tbBenefId" name="tbBenefId" class="required numeric k-textbox" title="Вкажіть код бенефіціара" />
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <input type="text" id="tbBenefBicCode" name="tbBenefBicCode" class="k-textbox" title="Вкажіть код бенефіціара" />
            ...
            <table>
                <tr>
                    ...
                    <td style="vertical-align: top">
                        <asp:Panel runat="server" ID="pnBranch" GroupingText="Відділення">
                            <table>
                                <tr>
                                    <td>Відділення, за яким закріплено контракт
                                    </td>
                                </tr>
                                <tr>

                                    <td>
                                        <asp:DropDownList runat="server" DataSourceID="dsBranches" ID="ddBranch" DataTextField="NAME" DataValueField="BRANCH" CssClass="k-dropdown" Height="25px"/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>Відділення, відповідальне за прийом первинних документів
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:DropDownList runat="server" DataSourceID="dsBranches" ID="ddServiceBranch" DataTextField="NAME" DataValueField="BRANCH" CssClass="k-dropdown" Height="25px"/>
                                    </td>
                                    <td></td>
                                </tr>
                            </table>
            ...
            <asp:Panel runat="server" ID="pnInpExp" GroupingText="Реквізити торгового контракту">
                <table>
                    <tr>
                        ...
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddTrDeadline" DataSourceID="dsTrDeadline"
                                DataTextField="DEADLINE" DataValueField="DEADLINE" ToolTip="Вкажіть контрольний строк" CssClass="k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddTrSpecs" DataSourceID="dsTrSpecs"
                                DataTextField="SPEC_NAME" DataValueField="SPEC_ID" ToolTip="Вкажіть спеціалізацію" CssClass="k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddTrSubjects" DataSourceID="dsTrSubjects"
                                DataTextField="SUBJECT_NAME" DataValueField="SUBJECT_ID" ToolTip="Вкажіть предмет контракту" CssClass="k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <textarea cols="84" rows="3" id="tbTrComments" class="k-input"></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddCreditPercent" DataSourceID="dsCreditPercent"
                                DataTextField="NAME" DataValueField="ID" ToolTip="Вкажіть тип максимальної процентної ставки НБУ" CssClass="k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddCreditorType" DataSourceID="dsCreditorType"
                                DataTextField="NAME" DataValueField="ID" ToolTip="Вкажіть тип кредитора" CssClass="k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                        <td>Тип кредиту
                        </td>
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddCreditType" DataSourceID="dsCreditType" DataTextField="NAME"
                                DataValueField="ID" ToolTip="Вкажіть тип кредиту" Width="300px" CssClass="k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddCreditTerm" DataSourceID="dsCreditTerm" DataTextField="NAME"
                                DataValueField="ID" ToolTip="Вкажіть cтроковість кредиту" CssClass="k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                        <td>Вид позичальника
                        </td>
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddCreditBorrower" DataSourceID="dsCreditBorrower"
                                DataTextField="NAME" DataValueField="ID" ToolTip="Вкажіть вид позичальника" CssClass="k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="field" colspan="3">
                            <asp:DropDownList runat="server" ID="ddCreditPrepay" DataSourceID="dsCreditPrepay"
                                DataTextField="NAME" DataValueField="ID" ToolTip="Вкажіть можливість дострокового погашення" CssClass="k-dropdown" Height="25px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
            ...
            <asp:Panel runat="server" ID="pnF503" GroupingText="Реквізити звіту Ф503">
                <table>
                    <tr>
                        ...
                        <td>
                            <select id="ddF503Reason" class="k-dropdown" style="width: 40px; height: 25px;">
                                <option value=""></option>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="ddF503State" class="k-dropdown" style="width: 40px; height: 25px;">
                                <option value=""></option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                    ...
                    <tr>
                        <td>Примітка</td>
                        <td>
                            <input id="tbF503Note" style="width: 600px" maxlength="108" class="k-textbox"/>
                        </td>
                    </tr>
                    <tr>
                        <td>Тип процентної ставки</td>
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddPercentType" Name="ddPercentType" DataSourceID="dsCreditPercent"
                                DataTextField="NAME" DataValueField="ID" ToolTip="Вкажіть тип процентної ставки" CssClass="k-dropdown" style="width: 80px; height: 25px;">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td>База плаваючої процентної ставки</td>
                       <td class="field">
                             <asp:DropDownList runat="server" ID="ddBasePersentRate" Name="ddBasePersentRate" DataSourceID="dsBasePersentRate"
                                DataTextField="NAME" DataValueField="ID" ToolTip="Вкажіть базу плаваючої процентної ставки" CssClass="k-dropdown" style="width: 80px; height: 25px;">
                            </asp:DropDownList>
                        </td>
                        <td>термін</td>
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddBasePersentRateTerm" Name="ddBasePersentRateTerm" DataSourceID="dsBasePersentRateTerm"
                                DataTextField="NAME" DataValueField="ID" ToolTip="Вкажіть термін" CssClass="k-dropdown" style="width: 40px; height: 25px;">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td>Розмір маржі процентної ставки</td>
                        <td class="field">
                            <input type="text" id="tbSizeMargin" class="required numeric k-textbox" title="Вкажіть розмір процентної ставки" />
                        </td>
                    </tr>
                    <tr>
                        <td>Величина процентної ставки</td>
                        <td class="field">
                            <input type="text" id="tbSizePersentRate" class="required numeric k-textbox" title="Вкажіть велисину процентної ставки" />
                        </td>
                    </tr>
                    <tr>
                        <td>Ціль використання кредиту</td>
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddPurpose" Name="ddPurpose" DataSourceID="dsPurpose"
                                DataTextField="NAME" DataValueField="ID" ToolTip="Вкажіть ціль використання кредиту" CssClass="k-dropdown" style="width: 300px; height: 25px;">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td>Інформація щодо внесення змін до договору</td>
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddInfoAboutChanges" Name="ddInfoAboutChanges" DataSourceID="dsInfoAboutChanges"
                                DataTextField="INFO" DataValueField="ID" ToolTip="Вкажіть інформіцію щодо внесення змін до договору" CssClass="k-dropdown" style="width: 300px; height: 25px;">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
            ...
            <asp:Panel runat="server" ID="pnF504" GroupingText="Реквізити звіту Ф504">
                <table>
                    <tr>
                        <td>Код підстави подання звіту</td>
                        <td>
                            <select id="ddF504Reason" class="k-dropdown" style="width: 40px; height: 25px;">
                                <option value=""></option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                            </select>
                    ...
                    <tr>
                        <td>Примітка</td>
                        <td>
                            <input id="tbF504Note" style="width: 600px" maxlength="108" class="k-textbox"/>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
                ...
                <table>
                    <tr>
                        ...
                        <td colspan="3" class="field">
                            <input type="text" id="tbCrdName" maxlength="64" style="width: 400px" title="Вкажіть назву договору" class="k-textbox" />
                        </td>
                    </tr>
                    <tr>
            ...
            <fieldset id="pnLongTermAgree">
                ...
                <table>
                    <tr>
                        ...
                        <td colspan="3" class="field">
                            <textarea rows="2" cols="84" id="tbCrdAddAgree" title="Вкажіть додаткові угоди" class="k-input"></textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="field" colspan="3">
                            <input type="text" id="tbPencentNbuInfo" maxlength="128" style="width: 436px" class="k-textbox" title="Вкажіть додаткову інформацію про максимальну процентну ставку НБУ" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="field">
                            <input type="text" id="tbCrdIndEndDate" name="tbCrdIndEndDate" maxlength="10" title="Вкажіть кінцеву дату індивідуального строку дії реєстрації контракту"
                                style="text-align: center; width: 80px" class="k-textbox"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3" class="field">
                            <textarea rows="2" cols="84" id="tbCrdPrevReestrAttr" title="Зареєстровані зміни до контракту" class="k-input"></textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="field">
                            <textarea rows="2" cols="84" id="tbCrdParentChData" class="k-input" title="Вкажіть інформація про короткостроковий контракт (заповнюється при перереєстрації з короткострокового у довгостроковий)"></textarea>
                        </td>
                    </tr>
                    <tr>
