...
<body>
    ...
    <div>
        <br />    
		 <asp:ObjectDataSource  id="ds_n" runat="server" SelectMethod="SelectQDocs"
			 TypeName="qdocs.VSepQdocs" SortParameterName="SortExpression" EnablePaging="True">
		 </asp:ObjectDataSource>
	<%--<Bars:BarsSqlDataSourceEx ID="ds" runat="server" ProviderName="barsroot.core" AllowPaging="true" SelectCommand="select  dk, rec, ref, datd, nd, vob, mfoa, nlsa, kv, s, nlsb, nam_b, nazn, d_rec, to_char(dat_a, 'dd.mm.yyyy hh24:mi:ss') as dat_a, fn_a,  nam_a, id_a, id_b, datp, nms, ostc, lim, pap, otm from v_sep_qdocsorder by rec"/>--%>
       <!-- <bars:ImageTextButton ID="btnRefresh" runat="server" ImageUrl="/common/images/default/16/refresh.png" meta:resourcekey="btnRefresh" CommandName="RefreshDoc" OnCommand="toolBar_Command" ButtonStyle="Image" UseSubmitBehavior="False" />
        ...
        <Bars:BarsGridViewEx ID="gv"
								...
								OnRowDataBound="gv_V_RowDataBound"
								OnPreRender="gv_V_PreRender"
								OnPageIndexChanging="gv_V_PageIndexChanging"
...
<asp:CheckBox runat="server" EnableViewState="False" ID="chkSelect" meta:resourcekey="chkSelectResource1"></asp:CheckBox>
                ...
                <asp:BoundField DataField="REC" HeaderText="Референс сообщения" meta:resourcekey="Rec" SortExpression="REC" />
                <asp:BoundField DataField="DATD" HeaderText="Дата поступления" meta:resourcekey="PostDate" SortExpression="DATD"/>
                <asp:BoundField DataField="DK" HeaderText="Д/К" meta:resourcekey="DK" SortExpression="DK"/>
                <asp:BoundField DataField="MFOA" HeaderText="МФО А" meta:resourcekey="MFOA" SortExpression="MFOA">
                    <itemstyle horizontalalign="Right" />
                </asp:BoundField>                  
                <asp:BoundField DataField="NLSA" HeaderText="Счет А" meta:resourcekey="NLSA" SortExpression="NLSA">
                    <itemstyle horizontalalign="Right" />
                </asp:BoundField>                    
                <asp:BoundField DataField="KV" HeaderText="ВАЛ" meta:resourcekey="VAL" SortExpression="KV"/>
                <asp:BoundField DataField="ID_A" HeaderText="ОКПО А" meta:resourcekey="OKPOA" SortExpression="ID_A">
                    <itemstyle horizontalalign="Right" />
                </asp:BoundField>    
                <asp:BoundField DataField="NAM_A" HeaderText="Название" meta:resourcekey="NAMA" SortExpression="NAM_A"/>
                <asp:BoundField DataField="S" HeaderText="Сумма" meta:resourcekey="S" SortExpression="S"/>
                <asp:BoundField DataField="NLSB" HeaderText="Наш счет" meta:resourcekey="NLSB" SortExpression="NLSB">
                    <itemstyle horizontalalign="Right" />
                </asp:BoundField>                  
                <asp:BoundField DataField="ID_B" HeaderText="ОКПО В" meta:resourcekey="OKPOB" SortExpression="ID_B">
                    <itemstyle horizontalalign="Right" />
                </asp:BoundField>                 
                <asp:BoundField DataField="NAM_B" HeaderText="Название счета из сообщения" meta:resourcekey="NAMB" SortExpression="NAM_B"/>
                <asp:BoundField DataField="OSTC" HeaderText="Остаток" meta:resourcekey="OSTC" SortExpression="OSTC"/>
                <asp:BoundField DataField="FN_A" HeaderText="Файл А$" meta:resourcekey="FN_A" SortExpression="FN_A"/>
                <asp:BoundField DataField="DAT_A" HeaderText="Дата создания файла $A" meta:resourcekey="DAT_A" SortExpression="DAT_A"/>
            </Columns>
            <AlternatingRowStyle CssClass="gv_AlternatingRowStyle" />
        </Bars:BarsGridViewEx>
