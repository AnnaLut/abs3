...
<body>
    ...
    <asp:Panel ID="Pn1" runat="server" Width="910Px">
        ...
        <table width="910Px" bgcolor="#CCD7ED">
            ...
            <tr>
                <td class="style1">
                    <asp:Label ID="lb_IKY" runat="server" Style="text-align: right" Text="Підняти категорію якості "
                        Visible="false"></asp:Label>
                </td>
                <td style="text-align: left">
                    <bec:DDLList ID="tb_IKY" runat="server" IsRequired="true" Visible="false">
                    </bec:DDLList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style1">
                    <asp:Label ID="Lb0_obs" runat="server" Style="text-align: right" Text="Стан обслуговування богу " Visible="false"></asp:Label>
                </td>
                <td style="text-align: left">
                    <bec:DDLList ID="DDL_obs" runat="server" IsRequired="false" Enabled="false" Width="170" Visible="false">
                    </bec:DDLList>
                </td>
            </tr>
            <tr>
    ...
    <asp:Panel runat="server" ID="pnGrid" Style="margin-left: 0px; margin-right: 10px;
        ...
        <Bars:BarsGridViewEx ID="gvMain" runat="server" Width="910Px" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="NAME" HeaderText="Дата" Visible="false" />
                ...
                <asp:TemplateField HeaderText="Відповідь" FooterStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                        <asp:DropDownList ID="DropDownList1" AppendDataBoundItems="true" DataSource='<%# SQL_SELECT_dataset("select val, name as name from FIN_QUESTION_REPLY where kod=" + ((char)39).ToString() + Eval("KOD") +((char)39).ToString() + "and idf = " +Eval("IDF") + "union all select -99 as val, null as name from dual")%>'
                            DataTextField="NAME" DataValueField="VAL" Text='<%#Eval("S")%>' Visible='<%# (Convert.ToString(Eval("POB")) == "2")?(false):(true) %>'
    ...
    <asp:Panel runat="server" ID="pnRez" Visible="false" Style="margin-left: 0px; margin-right: 10px;
        ...
        <table width="910Px" bgcolor="#CCD7ED">
            ...
            <tr>
                <td class="style4">
                    <asp:Label ID="lb_ip" runat="server" Style="text-align: right; font-style: italic;
                        ...
                        Visible="false" Width="400"></asp:Label>
                </td>
                <td style="text-align: left">
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <bec:TextBoxNumb ID="tb_klas" runat="server" Enabled="false" IsRequired="false" Visible="false" />
                </td>
            </tr>
            <tr>
                <td class="style4">
                ...
                <td style="text-align: left">
                    <bec:TextBoxNumb ID="tb_obs" runat="server" Enabled="false" IsRequired="false" Visible="false" />
                </td>
            </tr>
            <tr>
                <td class="style4">
                ...
                <td style="text-align: left">
                    <bec:TextBoxNumb ID="tb_kat" runat="server" Enabled="false" IsRequired="false" Visible="false" />
                </td>
            </tr>
            <tr>
                <td class="style4">
        ...
        <table width="910Px" bgcolor="#CCD7ED">
            ...
            <tr>
                <td style="text-align: right">
                    <br />
                    <br />
                    <asp:ImageButton ID="IB_NEXT" runat="server" AlternateText="Повернутись на попередню сторінку"
                        ImageUrl="/Common/Images/default/16/arrow_left.png" OnClick="Bt_next_Click" Style="text-align: right"
                        ToolTip="Повернутись на попередню сторінку" />
