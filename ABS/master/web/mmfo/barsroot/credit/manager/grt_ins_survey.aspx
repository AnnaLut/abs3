<%@ Page Language="C#" MasterPageFile="~/credit/manager/master.master" AutoEventWireup="true"
    CodeFile="grt_ins_survey.aspx.cs" Inherits="credit_manager_grt_ins_survey" Theme="default"
    Title="Анкета страховки {0} - {1} залога {2} - {3} заявки №{4}" meta:resourcekey="PageResource1" %>
