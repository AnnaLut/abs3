    ...
    <div style="background-color: lightgrey">
        ...
        <form id="formCustAcc" runat="server" defaultbutton="btFind">
            <table border="0" cellpadding="2" cellspacing="2" class="SimpleText">
                <tr>
                    <td>
                        <span>Реєстр №Контрагента:</span>
                    </td>
                    <td>
                        <input id="tbFindRNK" style="width: 150px" type="text" title="Маска для пошуку по РНК Клієнта" runat="server" />
                    </td>
                    <td>
                        <span>Код ЗКПО:</span>
                    </td>
                    <td>
                        <input id="tbFindOKPO" style="width: 105px" maxlength="10" type="text" title="Полу пошуку по ЗКПО" />
                    </td>
                    <td rowspan="2">&nbsp;&nbsp;
                            <asp:Button ID="btFind" runat="server" Style="width: 60px; height: 60px" OnClientClick="refreshGridwithSimpleFilter();return false;" Text="Ок" ToolTip="Застосувати вказані умови фільтру" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <span>Найменування Контрагента:</span>
                    </td>
                    <td>
                        <input id="tbFindNMK" style="width: 150px" type="text" title="Пошук по найменуваню клієнта" />
                    </td>
                    <td>К050:
                    </td>
                    <td>
                        <input id="tbFindK050" style="width: 95px" type="text" />
                    </td>
                </tr>
            </table>
        </form>
        ...
        <table id="T" cellspacing="0" cellpadding="0" border="2">
            <tr>
                ...
                <td>&nbsp;<img runat="server" class="outset" meta:resourcekey="btShow" id="btShow" title="Показывать закрытых контрагентов"
                    style="border-top-style: outset" onclick="fnShow()">&nbsp;
                </td>
                <td>&nbsp;<img runat="server" class="outset" meta:resourcekey="btReg" id="btReg" title="Зарегистрировать нового контрагента"
                ...
                <td>&nbsp;<img runat="server" class="outset" meta:resourcekey="btRefresh" id="btRefresh"
                ...
                <td>&nbsp;<img runat="server" class="outset" meta:resourcekey="btKontr" id="btKontr"
                ...
                <td>&nbsp;<img runat="server" class="outset" style="visibility: hidden" meta:resourcekey="btCredits"
                    id="btCredits" title="Потребительские кредиты контрагента" onclick="fnCredits()">&nbsp;
                </td>
                <td>&nbsp;<img runat="server" class="outset" meta:resourcekey="Choose" id="Choose" title="Выход"
                    onclick="goBack()">&nbsp;
                </td>
                <td>
