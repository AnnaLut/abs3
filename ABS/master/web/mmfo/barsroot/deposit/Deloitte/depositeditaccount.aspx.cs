...
public partial class DepositEditAccount : Bars.BarsPage
{
    ...
    public void rbPercentWay_CheckedChanged(object sender, EventArgs e)
    {
        if (rbPercentWay_BPK.Checked)
        {
            ...
            btnPercent.Attributes["onclick"] = "SearchAccounts('CARDS', 'textBankAccount', 'textBankMFO', 'textIntRcpOKPO', 'textIntRcpName');";
            btnPercent.Visible = true;
        }
        else if (rbPercentWay_BankACC.Checked)
        {
            ...
            btnPercent.Attributes["onclick"] = "SearchAccounts('BPK', 'textBankAccount', 'textBankMFO', 'textIntRcpOKPO', 'textIntRcpName');";
            btnPercent.Visible = true;
        }
    ...
    public void rbDepoWay_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (RBDepoPayWay_BPK.Checked)
        {
            ...
            btnDeposit.Attributes["onclick"] = "SearchAccounts('CARDS', 'textAccountNumber', 'textRestRcpMFO', 'textRestRcpOKPO', 'textRestRcpName');";
        ...
        else if (RBDepoPayWay_BankACC.Checked)
        {
            ...
            btnDeposit.Attributes["onclick"] = "SearchAccounts('BPK', 'textAccountNumber', 'textRestRcpMFO', 'textRestRcpOKPO', 'textRestRcpName');";
            btnDeposit.Visible = true;
        }
