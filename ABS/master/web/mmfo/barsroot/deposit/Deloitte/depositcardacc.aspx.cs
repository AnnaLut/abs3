            ...
            switch (Request["mode"])
            {
                ...
                case "CARDS":
                    ...
                    cmdGetCardAcc.CommandText =
                        "select '<A href=# onclick=\"returnAcc('''||bankcode||''','''||balacc||''','''||replace(custname,'''','`')||''','''||custcode||''')\">Вибрати</a>', " +
                        "       cardnum, balacc, currency, custname, bankcode, custcode " +
                        " from V_CARDACCOUNTS  where custid = :RNK and currency = :cur_id";
                ...
                case "NOTCARDS":
                    ...
                    cmdGetCardAcc.CommandText =
                        ...
                        " where a.nbs in ('2620','2630','2635') and a.dazs Is Null and a.RNK = b.RNK and s.acc = a.acc and a.kv = :cur_id" +
                        " and a.rnk = :rnk )";
