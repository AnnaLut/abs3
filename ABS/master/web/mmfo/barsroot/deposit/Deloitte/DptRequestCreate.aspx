                    ...
                    <asp:Panel ID="pnRequstType" runat="server" GroupingText="Тип запиту">
                        <table class="InnerTable" width="100%">
                            <tr>
                                ...
                                <td style="width: 33%">
                                    <asp:RadioButton ID="rbContractClose" Text="&nbsp; Запит на розірвання Депозитів" OnCheckedChanged="rbContractsClose_CheckedChanged"
                                        AutoPostBack="true" runat="server" GroupName="RequestType" />
                                </td>
                            </tr>
                        </table>
                ...
                <td>
                    <table class="InnerTable">
                        ...
                        <bars:BarsGridViewEx ID="gvContracts" DataSourceID="dsContracts" runat="server" CssClass="barsGridView"
                            ...
                            PageSize="15" JavascriptSelectionType="MultiSelect" DataKeyNames="DPT_ID,DPT_NUM,NMK,OKPO,BIRTHDATE,DOC_SER,DOC_NUM,LCV">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Частка спадку<BR>Сума доручення" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <bwc:NumericEdit ID="nmAmount" runat="server" Width="90px" MaxLength="10" Visible='<%# (TrusteeType == "V" ? false : true) %>'
                                            Presiction='<%# (TrusteeType == "H" ? 4 : 2) %>' EditMask = "f" >
                                        </bwc:NumericEdit>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Виплата<BR>в валюті ВКЛАДУ" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="cbSelectKV" runat="server" Visible='<%# (req_type == 2 ? true:false) %>'/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </bars:BarsGridViewEx>
