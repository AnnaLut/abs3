                ...
                <table ID="tbRequestParams" runat="server" class="InnerTable" width="100%">
                    <tr>
                        ...
                        <td colspan="2" align="center" >
                         ...
                         <td align="center">
                            <asp:RadioButton ID="rbContractsClose" Text="&nbsp; Запит на дострокове розірвання Депозитів" 
                                runat="server" GroupName="RequestType" />
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <table class="tbl_style1" width="99%" border="1">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th runat="server" id="ColKv" colspan="8">
                                                    <asp:Label ID="lbKV" runat="server" Text="Виплата в<BR>валюті вкладу" CssClass="InfoText" />
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <bars:EADocsView runat="server" ID="EADocsView" EAStructID="22" 
                                                AgrID='<%# Convert.ToInt64((Eval("CONTRACT_ID")).ToString().Substring(0,Eval("CONTRACT_ID").ToString().Length-2))%>' 
                                                RNK='<%#Convert.ToInt64((Eval("CONTRACT_RNK")).ToString().Substring(0,Eval("CONTRACT_RNK").ToString().Length-2)) %>'/>
                                        </td>
                                        ...
                                        <td align="center" runat="server" id="TabColAgreements" >
                                         ...
                                         <td align="center" runat="server" id="ColKv" >
                                            <asp:CheckBox ID="cbKV" runat="server" Enabled='<%# IsEdit %>'
                                                Checked='<%# Convert.ToBoolean(Eval("FL_KV")) %>' 
                                                Visible='<%# (rbContractsClose.Checked ? true : false) %>' />
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:ListView>
        ...
        <tr>
            ...
            <td align="left" style="width:25%" >
                <asp:RequiredFieldValidator ID="RequestCommentValidator" ControlToValidate="tbRequestComment" 
                    Text="" runat="server" EnableClientScript="true" SetFocusOnError="true" />
            </td>
        </tr>
        <tr>
            <td align="right">
