...
public partial class DepositDelete : Bars.BarsPage
{
	...
	private void btCancel_Click(object sender, System.EventArgs e)
	{
		...
		_dbLogger.Info("Пользователь нажал кнопку \"Отмена\" на странице удаления депозитного договора.  Номер договора " + dpt_id.ToString(),
			"deposit");
	...
	private void btNext_Click(object sender, System.EventArgs e)
	{
		...
		_dbLogger.Info("Пользователь нажал кнопку \"Следующий\" на странице удаления депозитного договора.  Номер договора " + dpt_id.ToString(),
			"deposit");
	...
	private void btConfirmDelete_Click(object sender, System.EventArgs e)
	{
		...
		_dbLogger.Info("Пользователь нажал кнопку \"Подтверждаю удаление\" на странице удаления депозитного договора.  Номер договора " + dpt_id.ToString(),
			"deposit");
		...
		try
		{
			...
			_dbLogger.Debug("Процедура удаления договора завершилась успешно на странице удаления депозитного договора.  Номер договора " + dpt_id.ToString(),
				"deposit");
		}
		finally	
		{
	...
	private void DptDeleteEnabled()
	{
		...
		try
		{
			_dbLogger.Debug("Проверка можно ли удалять договор на странице удаления депозитного договора.  Номер договора " + dpt_id.ToString(),
				"deposit");
