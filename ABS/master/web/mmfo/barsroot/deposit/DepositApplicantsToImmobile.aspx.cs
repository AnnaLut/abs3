...
public partial class deposit_DepositApplicantsToImmobile : System.Web.UI.Page
{
    ...
    public deposit_DepositApplicantsToImmobile()
    {
    ...
    protected void btnCheckAll_Click(object sender, EventArgs e)
    {
        ...
        _dbLogger.Info("Користувач відмітив усі депозити для перенесення в нерухомі.", "deposit");
    }
    ...
    protected void btnImmobile_Click(object sender, EventArgs e)
    {
        ...
        */
        ...
        List<Int64> DepositList = new List<Int64>();
        ...
        foreach (GridViewRow row in gvApplicants.Rows)
        {
            ...
            {                    
                ...
                Int64 TMP = Convert.ToInt64(gvApplicants.DataKeys[idx]["DPT_ID"]);
				 _dbLogger.Info("TMP= " + TMP);
                DepositList.Add(TMP);
        ...
        {
            _dbLogger.Info("Користувач ініціював перенесення " + DepositList.Count.ToString() + " депозитних договорів у картотеку нерухомих.", "deposit");
            ...
            try
            {
                ...
                OracleParameter list = new OracleParameter("p_dptid", OracleDbType.Int64, ParameterDirection.Input);
