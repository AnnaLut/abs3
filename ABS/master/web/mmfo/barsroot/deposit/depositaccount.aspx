		...
		<script language="javascript" type="text/javascript" >
            ...
            function search_accounts()
            {
                var result = window.showModalDialog('dialog.aspx?type=metatab&role=ABS_ADMIN&tabname=ACCOUNTS' +
                    '&tail="NBS in (\'2620\',\'2625\') AND DAZS Is Null AND RNK=' + document.getElementById('RNK').value +
                    ' AND KV = ' + document.getElementById('KV').value + ' "&pk=NLS&sk=NMS',
	...
	<body onload="AfterPageLoad();">
		<form id="Form2asas" method="post" runat="server">
			<table class="MainTable" id="ContractTable">
				...
				<tr>
					<td>
                        <asp:textbox id="textContractType" tabIndex="1001" runat="server" CssClass="InfoText" 
                            ToolTip="Вид договора" BorderStyle="Inset" ReadOnly="true" />
                    </td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<table class="InnerTable">
                            <tr>
                                ...
                                <td style="width:10%">
                                    <input id="btnAccounts" onclick="search_accounts()" type="button" 
				...
				<tr>
					<td>
						<table class="InnerTable" id="tbDptField" runat="server">
							<tr>
								<td colspan="3">
                                    <asp:label id="lbDopRec" Text="Дополнительные реквизиты вклада" runat="server" CssClass="InfoLabel" />
                                </td>
							</tr>
						</table>
					</td>
							...
							<tr>
								...
								<td style="width:25%">
									<input id="btNext" tabindex="100" type="button" runat="server"
                                        ...
                                        causesvalidation="false" validationgroup="CheckFields" />
								</td>
							</tr>
						</table>
					</td>
