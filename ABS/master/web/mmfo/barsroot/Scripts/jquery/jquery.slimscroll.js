...
(function($) {
  ...
  jQuery.fn.extend({
    slimScroll: function(options) {
      ...
      var isOverPanel, isOverBar, isDragg, isHover, queueHide, hoverResize , touchDif,
        ...
        if (o.hoverSize) {
          rail.hover(function () {
            rail.css({ width: o.hoverSize });
            bar.css({ width: o.hoverSize });
          }, function () {
        ...
        {
          if (o.hoverSize) {
            hoverResize = setTimeout(function(){
              if (!(o.disableFadeOut && isOverPanel) && !isOverBar && !isDragg)
              {
                rail.animate({ width: o.size },300);
                bar.animate({ width: o.size },300);
              }
            }, 1000);
          }
