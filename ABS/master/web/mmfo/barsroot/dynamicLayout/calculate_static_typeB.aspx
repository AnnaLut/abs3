<%@ Page Language="C#" AutoEventWireup="true" CodeFile="calculate_static_typeB.aspx.cs" Inherits="calculate_static_typeA" Title="Функція Сховище. Оприбуткування памятних монет" %>
...
<script language="javascript" type="text/javascript">
    ...
    function OpenDocument(ref) {
        // var url = '/barsroot/docview/item/?id=' + ref + '&partial=true'; //'/barsroot/documentview/default.aspx?ref=' + ref
    ...
    <form id="frmCoinInvoice" runat="server" style="vertical-align: central">
        ...
        <asp:Panel ID="pnDynamicLayout" runat="server" GroupingText="" Style="margin-left: 10px; margin-right: 10px">
            ...
            <table id="tblDetailTypeA" runat="server" visible="false">
                <tr>
                    <td>
                        <asp:Label ID="lbKvATypeA" runat="server" Text="Валюта А" ToolTip="Валюта А"></asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="lbNlsTypeA" runat="server" Text="№ рахунку А" ToolTip="№ рахунку А"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <BarsRef:TextBoxRefer ID="tbKvATypeA" runat="server" Width="70px" Enabled="true"
                            TAB_NAME="TABVAL" KEY_FIELD="KV" SEMANTIC_FIELD="NAME" ORDERBY_CLAUSE="order by kv desc" WHERE_CLAUSE=" where d_close is null" />
                    </td>
                    <td>
                        <asp:TextBox ID="tbNlsTypeA" runat="server" Enabled="true" MaxLength="14" ToolTip="Рах.А у нас" Width="100"></asp:TextBox>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <input type="hidden" id="lbId" value="0" runat="server" />
                        <input type="hidden" id="hNlsA" value="" runat="server" />
                        <input type="hidden" id="hKvA" value="" runat="server" />
                ...
                <tr>
                    <td>
                        ...
                        <BarsEX:BarsGridViewEx ID="gvStatic" runat="server" PagerSettings-PageButtonCount="10" DataSourceID="odsStatic"
                            ...
                            CssClass="barsGridView" DateMask="dd/MM/yyyy" DataKeyNames="ID, KV, NLS_A, MFOB, MFOB_NAME, NLS_B, NAMB, OKPOB, PERCENT, DELTA, SUMM_A, NAZN, TT, NLS_COUNT, ORD, VOB"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="NLS_A" HeaderText="Рах А у нас" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="BRANCH_NAME" HeaderText="Рах А залишок" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:### ### ### ### ### ### ### ###0.00}" />
                                <asp:BoundField DataField="NAMA" HeaderText="Назва відправника" ItemStyle-HorizontalAlign="Left" />
