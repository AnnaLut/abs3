                                ...
                                <tr id="tr" runat="server" class="edit">
                                    ...
                                    <td>
                                        <bars:TextBoxString ID="NAME" runat="server" Value='<%# Bind("NAME") %>' IsRequired="true"
                                            TabIndex="101" ValidationGroup="Fees" MaxLength="40" />
                                    </td>
                                    <td align="right">
                                    ...
                                    <td align="right">
                                        <bars:TextBoxDecimal ID="PERC_VALUE" runat="server" Value='<%# Bind("PERC_VALUE") %>'
                                            TabIndex="103" ValidationGroup="Fees" Width="75px" MaxValue="100" />
                                    </td>
                                </tr>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <tr id="tr" runat="server" class="new">
                                    ...
                                    <td>
                                        <bars:TextBoxString ID="LIMIT_ID" runat="server" Value='<%# Bind("LIMIT_ID") %>' IsRequired="true"
                                            TabIndex="201" ValidationGroup="Fees" MaxLength="20" />
                                    </td>
                                    <td>
                                        <bars:TextBoxString ID="NAME" runat="server" Value='<%# Bind("NAME") %>' IsRequired="true"
                                            TabIndex="202" ValidationGroup="Fees" MaxLength="40" />
                                    </td>
                                    <td align="right">
                                        <bars:TextBoxDecimal ID="SUM_VALUE" runat="server" Value='<%# Bind("SUM_VALUE") %>'
                                    ...
                                    <td align="right">
                                        <bars:TextBoxDecimal ID="PERC_VALUE" runat="server" Value='<%# Bind("PERC_VALUE") %>'
                                            TabIndex="204" ValidationGroup="Fees" Width="75px" MaxValue="100" />
                                    </td>
                                </tr>
                            </InsertItemTemplate>
                        </asp:ListView>
