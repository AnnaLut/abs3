                                ...
                                <tr id="tr" runat="server" class="edit">
                                    ...
                                    <td>
                                        <bars:TextBoxString ID="NAME" runat="server" Value='<%# Bind("NAME") %>' IsRequired="true"
                                            TabIndex="101" ValidationGroup="Tariffs" MaxLength="40" />
                                    </td>
                                    <td align="right">
                                    ...
                                    <td align="right">
                                        <bars:TextBoxDecimal ID="MIN_PERC" runat="server" Value='<%# Bind("MIN_PERC") %>'
                                            TabIndex="103" ValidationGroup="Tariffs" Width="75px" MaxValue="100" />
                                    </td>
                                    <td align="right">
                                    ...
                                    <td align="right">
                                        <bars:TextBoxDecimal ID="MAX_PERC" runat="server" Value='<%# Bind("MAX_PERC") %>'
                                            TabIndex="105" ValidationGroup="Tariffs" Width="75px" MaxValue="100" />
                                    </td>
                                </tr>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <tr id="tr" runat="server" class="new">
                                    ...
                                    <td>
                                        <bars:TextBoxString ID="TARIFF_ID" runat="server" Value='<%# Bind("TARIFF_ID") %>' IsRequired="true"
                                            TabIndex="201" ValidationGroup="Tariffs" MaxLength="20" />
                                    </td>
                                    <td>
                                        <bars:TextBoxString ID="NAME" runat="server" Value='<%# Bind("NAME") %>' IsRequired="true"
                                            TabIndex="202" ValidationGroup="Tariffs" MaxLength="40" />
                                    </td>
                                    <td align="right">
                                        <bars:TextBoxDecimal ID="MIN_VALUE" runat="server" Value='<%# Bind("MIN_VALUE") %>'
                                    ...
                                    <td align="right">
                                        <bars:TextBoxDecimal ID="MIN_PERC" runat="server" Value='<%# Bind("MIN_PERC") %>'
                                            TabIndex="204" ValidationGroup="Tariffs" Width="75px" MaxValue="100" />
                                    </td>
                                    <td align="right">
                                        <bars:TextBoxDecimal ID="MAX_VALUE" runat="server" Value='<%# Bind("MAX_VALUE") %>'
                                    ...
                                    <td align="right">
                                        <bars:TextBoxDecimal ID="MAX_PERC" runat="server" Value='<%# Bind("MAX_PERC") %>'
                                            TabIndex="206" ValidationGroup="Tariffs" Width="75px" MaxValue="100" />
                                    </td>
                                </tr>
                            </InsertItemTemplate>
                        </asp:ListView>
