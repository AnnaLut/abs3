<%@ Page Language="C#" AutoEventWireup="true" CodeFile="import_vip.aspx.cs" Inherits="sberutls_import_vip" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title title="Завантаження файлів VIP клієнтів"> </title>
     <style type="text/css">
        .title {
        ...
        <div>
            <table>
                <tr>
                    <td>
                        <br>
                             ЗАВАНТАЖЕННЯ ФАЙЛІВ VIP КЛІЄНТІВ
                        </br>
                    </td>
                </tr>
            </table>
