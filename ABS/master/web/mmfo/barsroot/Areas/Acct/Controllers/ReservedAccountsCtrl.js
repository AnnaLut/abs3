			...
			bars.ui.confirm(
				{
					...
					'Рахунок може видалятися у разі його <b>помилкового резервування працівником фронт офісу</b>, або у разі <b>відмови клієнта від обслуговлювання</b>'
				},
				function () {
					bars.ui.loader($('#resAcctGrid'), true);
					var grid = vm.resAcctGrid;
			...
			$.ajax({
				...
				success: function (result) {
					if (result) {
						...
						bars.ui.alert({ text: "У обраного мультивалютного рахунку відсутній відкритий рахунок<br>Для використання необхідно відкрити хоч один." });
					}
				}
			});
		}
