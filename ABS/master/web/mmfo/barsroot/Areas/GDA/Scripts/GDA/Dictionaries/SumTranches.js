        ...
        schema: {
            model: {
                ...
                fields: {
                    ...
                    MinSumTranche: { type: 'number', validation: { min: 0 } },
                    MaxSumTranche: { type: 'number', validation: { min: 0 } },
                    MinReplenishmentAmount: { type: 'number', validation: { min: 0 } },
                    MaxReplenishmentAmount: { type: 'number', validation: { min: 0 } }
                }
            }
        },
        serverFiltering: false,
