...
var HISTORY_GRID_COLUMNS = [
 {
    ...
    },
    {
        ...
        width: "10%",
        template: "<div style='text-align:center;'>#=(PAY_DATE == null) ? ' ' : kendo.toString(PAY_DATE,'dd.MM.yyyy')#</div>"
    },
    {
        field: "MATCH_DATE",
        title: "Дата/час<br/>відправки<br/>реєстру в ПФУ",
        width: "10%",
        template: "<div style='text-align:center;'>#=(MATCH_DATE == null) ? ' ' : kendo.toString(MATCH_DATE,'dd.MM.yyyy mm:ss')#</div>"
    },
    {
        field: "USERID",
...
function initGridHistoryChecked(FileId) {
    ...
    fillKendoGrid("#gridLinesChecked", {
        ...
        columns: [
            ...
            {
                field: "id",
                title: "ID інформаційного</br> рядка",//"ID",
                width: "5%",
                filterable: {
                    ui: function (element) {
