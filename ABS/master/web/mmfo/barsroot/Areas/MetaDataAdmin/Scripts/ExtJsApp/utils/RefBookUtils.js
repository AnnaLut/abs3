Ext.define('ExtApp.utils.RefBookUtils', {
    ...
    if (colMetaInfo.COLTYPE == 'CLOB' && colMetaInfo.Kind == "UploadParam") {
        ...
        getRefUrl: function (thisCombo) {
            ...
            if (false) {
                ...
                url = '/barsroot/metaDataAdmin/ReferenceBookAdmin/GetRelatedReferenceData?nativeTableId=' + nativeTableId + 'tableName=' + tabeName +
                               '&fieldForId=' + thisCombo.SrcColName + '&fieldForName=' + thisCombo.SrcTextColName;
            }
            else
                url = '/barsroot/metaDataAdmin/ReferenceBookAdmin/GetRelatedReferenceData?nativeTableId=' + nativeTableId + '&tableName=' + thisCombo.SrcTableName +
                               '&fieldForId=' + thisCombo.SrcColName + '&fieldForName=' + thisCombo.SrcTextColName;
            return url;
        },
        ...
        getUrlByDinamicTabName: function (combo, selectedRow) {
            ...
            var dynamicUrl = '/barsroot/metaDataAdmin/ReferenceBookAdmin/GetRelatedReferenceData?tableName=' + tableName;
            return dynamicUrl;
        },
        ...
        getUrlBySrcCond: function (combo, selectedRow) {
            ...
            var dynamicUrl = '/barsroot/metaDataAdmin/ReferenceBookAdmin/GerSrcQueryData?srcQueryModel=' + queryModelString;
            return dynamicUrl;
