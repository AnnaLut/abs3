Ext.application({
    ...
    name: 'ExtApp',
    appFolder: '/barsroot/Areas/MetaDataAdmin/Scripts/ExtJsApp',
    ...
    launch: function () {
      ...
      debugger
        ...
        if (tableId) {
            ...
            Ext.Ajax.request({
                url: '/barsroot/metaDataAdmin/ReferenceBookAdmin/GetMetadata',
                method: 'POST',
            ...
            Ext.Ajax.request({
                url: '/barsroot/metaDataAdmin/ReferenceBookAdmin/GetFuncOnlyMetaData',
                params: {
                    CodeOper: codeOper
                },
                success: function (conn, response) {
