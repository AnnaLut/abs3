...
function GetPhoto(rnk, successCallback) {
    Waiting(true);
    AJAX({ srcSettings: {
        url: bars.config.urlContent("/api/paymentverification/paymentverification/getphoto"),
...
function GetPhone(rnk, successCallback) {
    ...
    AJAX({ srcSettings: {
        url: bars.config.urlContent("/api/paymentverification/paymentverification/getphone"),
        success: successCallback,
        error: function(jqXHR, textStatus, errorThrown){            //bars.ui.alert({ text: "ERROR" });
            Waiting(false);
        },
...
function Send(rnk, phone, code, skipcode, successCallback) {
    Waiting(true);
    AJAX({ srcSettings: {
        url: bars.config.urlContent("/api/paymentverification/paymentverification/cellphone"),
        success: successCallback,
        error: function(jqXHR, textStatus, errorThrown){            //bars.ui.alert({ text: "ERROR" });
            Waiting(false);
        },
