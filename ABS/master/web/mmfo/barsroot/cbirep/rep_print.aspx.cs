            ...
            switch (report.CbirepRepParams.FORM)
            {
                case "frm_UniReport":
                    ...
                    else
                    {
                        ...
                        Response.Write("<PRE>");
                        var data = report.ReportData.ToArray();
                        if (data.Length > 2*1024*1024)
                            Response.Write("<p>Розмір файлу більше 2Мб, пепередній перегляд недоступний, скористайтесь кнопкою \"Зберегти\".</p>");
                        else
                ...
                case "frm_FastReport":
                    ...
                    switch (ddlFileTypes.SelectedValue)
                    {
                        ...
                        case "TEXT":
                            ...
                            break;
                        case "WORD":
                            doc.Print(FrxExportTypes.Word2007);
                            break;
                        case "CSV":
                            doc.Print(FrxExportTypes.Csv);
                            break;
