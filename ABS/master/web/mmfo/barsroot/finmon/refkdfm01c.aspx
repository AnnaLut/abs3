<%@ Page Language="C#" AutoEventWireup="true" Title="Довідник Kdfm01c"
    CodeFile="refkdfm01c.aspx.cs" Inherits="finmon_refkdfm01c" Trace="false" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="formKdfm01c" runat="server">
        ...
        <div class="pageTitle">
            <asp:Label ID="lbTitle" runat="server" Text="Місцезнаходження об`єкта"></asp:Label>
        </div>
        <p></p>
        <BarsEX:BarsSqlDataSourceEx ID="odsKdfm01c" runat="server" AllowPaging="False" ProviderName="barsroot.core"></BarsEX:BarsSqlDataSourceEx>

        <BarsEX:BarsGridViewEx ID="gvKdfm01c" runat="server" PagerSettings-PageButtonCount="10" PageIndex="0"
            PageSize="15" AllowPaging="True" AllowSorting="True"
            DataSourceID="odsKdfm01c" CssClass="barsGridView" DataKeyNames="CODE,NAME" DateMask="dd/MM/yyyy"
