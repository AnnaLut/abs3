                       ...
                       cmd.CommandText = "SET ROLE bars_access_defrole";
                        ...
                        for (int i = 0; i < grd_Data.Rows.Count; i++)
                        {
                            ...
                            */
                            ...
                            string NamA = Convert.ToString(row.Cells[9].Text);
                            ...
                            string NamB = Convert.ToString(row.Cells[10].Text);
                            ...
                            try
                            {
                                if (!ourDoc.oDocument())
                                {
                                    ...
                                    _dbLogger.Financial("Импорт Moper: док Ref" + Ref + ": " + NlsA + "(" + KvA + ") " + SA.ToString("F0") + " -> " + BankB + " " + NlsB + "(" + KvB + ") " + SB.ToString("F0") + "[" + NamB + "],[" + Nazn + "] " + OperId);
                            }
                            catch (Exception exc)
                            {
