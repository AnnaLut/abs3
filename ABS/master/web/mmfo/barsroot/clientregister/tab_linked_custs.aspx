...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" src="../Scripts/kendo/cultures/kendo.culture.uk.min.js"></script>
    <script type="text/javascript" src="../Scripts/kendo/cultures/kendo.culture.uk-UA.min.js"></script>
    <script type="text/javascript" src="../Scripts/kendo/messages/kendo.messages.uk-UA.min.js"></script>

    <script type="text/javascript" src="../Scripts/Bars/bars.ui.js"></script>
    <script type="text/javascript" src="../Scripts/Bars/bars.utils.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <table border="0" cellpadding="3" cellspacing="0">
                        ...
                        <table border="0" cellpadding="3" cellspacing="0">
                                ...
                                <td style="width: 50px">
                                    ...
                                    <bars:BarsGridViewEx ID="gvCustRelations" runat="server" CaptionText="" ClearFilterImageUrl="mvwres://Bars.DataComponentsEx, Version=1.0.0.0, Culture=neutral, PublicKeyToken=464dd68da967e56c/Bars.DataComponents.Resources.filter_delete.png"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CUSTTYPE" HeaderText="Ознака (1-ЮО,2-ФО, 3-Банк)" SortExpression="CUSTTYPE">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                            ...
                            <tr>
                                <td style="padding-left: 10px">
                                    ...
                                    <bars:BarsSqlDataSourceEx ID="sdsCUSTTYPE" runat="server" SelectCommand="select 1 as ID, 'ЮО' as NAME from dual union select 2 as ID, 'ФО' as NAME from dual union select 3 as ID, 'Банк' as NAME from dual"
                                        ProviderName="barsroot.core">
                                    </bars:BarsSqlDataSourceEx>
                                                            ...
                                                            <asp:MultiView ID="mv" runat="server">
                                                                <asp:View ID="v0" runat="server">
                                                                    <table border="0" cellpadding="3" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Label ID="CUSTTYPETitle" runat="server" Text="Ознака (1-ЮО, 2-ФО, 3-Банк): "></asp:Label>
                                                                            </td>
                                                                            <td>
                                                                ...
                                                                <asp:View ID="v0" runat="server">
                                                                    <table border="0" cellpadding="3" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <bars:TextBoxString ID="NAME" runat="server" Width="300px" IsRequired="true" ValidationGroup="Params"
                                                                                    Value='<%# Bind("NAME") %>' />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <bars:TextBoxRefer ID="COUNTRY" runat="server" TAB_ID="128" KEY_FIELD="COUNTRY" SEMANTIC_FIELD="NAME"
                                                                                    OnValueChanged="COUNTRY_ValueChanged" IsRequired="true" ValidationGroup="Params" Value='<%# Bind("COUNTRY") %>' />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <bars:TextBoxRefer ID="REGION" runat="server" TAB_ID="194" KEY_FIELD="C_REG" SEMANTIC_FIELD="NAME_REG"
                                                                                    OnValueChanged="REGION_ValueChanged" IsRequired="true" ValidationGroup="Params" Value='<%# Bind("REGION") %>' />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <bars:TextBoxRefer ID="VED" runat="server" TAB_ID="208" KEY_FIELD="VED" SEMANTIC_FIELD="NAME"
                                                                                    WHERE_CLAUSE="where D_CLOSE is null" IsRequired="true" ValidationGroup="Params"
                                                                                    OnValueChanged="VED_ValueChanged" Value='<%# Bind("VED") %>' />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <bars:TextBoxRefer ID="SED" runat="server" TAB_ID="191" KEY_FIELD="SED" SEMANTIC_FIELD="NAME"
                                                                                    WHERE_CLAUSE="where D_CLOSE is null" IsRequired="true" ValidationGroup="Params"
                                                                                    OnValueChanged="SED_ValueChanged" Value='<%# Bind("SED") %>' />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <bars:TextBoxRefer ID="ISE" runat="server" TAB_ID="153" KEY_FIELD="ISE" SEMANTIC_FIELD="NAME"
                                                                                    WHERE_CLAUSE="where D_CLOSE is null" IsRequired="true" ValidationGroup="Params"
                                                                                    OnValueChanged="ISE_ValueChanged" Value='<%# Bind("ISE") %>' />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
            ...
            <tr style="vertical-align: top; width: 50px;">
                <td style="vertical-align: top">
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid black">
                                    ...
                                    <asp:FormView ID="fvCustRelationData" runat="server" DataSourceID="odsCustRelationDataFV"
                                        ...
                                        OnItemDeleted="fvCustRelationData_ItemDeleted" OnItemInserted="fvCustRelationData_ItemInserted" OnItemUpdating="fvCustRelationData_ItemUpdating"
                                            ...
                                            <asp:Panel ID="pnlRelData" runat="server" GroupingText="Параметри">
                                                <table border="0" cellpadding="3" cellspacing="0">
                                                            ...
                                                            <asp:MultiView ID="mvCustRelationData" runat="server">
                                                                ...
                                                                <asp:View ID="vVAGA" runat="server">
                                                                    <table border="0" cellpadding="3" cellspacing="0">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="VAGA1" runat="server" IsRequired="false" Style="text-align: right;
                                                                                                                                                 font-family:'Lucida Grande', Geneva, Arial, Tahoma, Verdana, Helvetica, sans-serif;
                                                                                                                                                 font-size:9pt;
                                                                                                                                                 width:150px; "
                                                                                    Text='<%# Bind("VAGA1") %>' MaxValue="100"  /> 
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="VAGA2" runat="server" IsRequired="false" Style="text-align: right;
                                                                                                                                                 font-family:'Lucida Grande', Geneva, Arial, Tahoma, Verdana, Helvetica, sans-serif;
                                                                                                                                                 font-size:9pt;
                                                                                                                                                 width:150px; "
                                                                                    Text='<%# Bind("VAGA2") %>' MaxValue="100"  /> 
                                                                            </td>
																			<td>
                                                                ...
                                                                <asp:View ID="vTRUSTEE" runat="server">
                                                                    <table border="0" cellpadding="3" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                         <asp:Label ID="PositionGenitiveTitle" runat="server" Text="Посадаа у родовому відмінку"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <bars:TextBoxString ID="POSITION_R" runat="server" IsRequired="false" ValidationGroup="DataParams"
                                                                                Value='<%# Bind("POSITION_R") %>' />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                    ...
                                                    -->
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Label ID="LAST_NAMETitle" runat="server" Text="Прізвище"></asp:Label>
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Label ID="FIRST_NAMETitle" runat="server" Text="Ім`я"></asp:Label>
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Label ID="MIDDLE_NAMETitle" runat="server" Text="По-батькові"></asp:Label>
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <asp:MultiView ID="mvCustRelationData" runat="server">
                                                                            ...
                                                                            <asp:View ID="vTRUSTEE" runat="server">
                                                                                <table border="0" cellpadding="3" cellspacing="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                        <asp:Label ID="PositionGenitiveTitle" runat="server" Text="Посада у родовому відмінку"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <bars:TextBoxString ID="POSITION_R" runat="server" IsRequired="false" ValidationGroup="DataParams"
                                                                                            Value='<%# Bind("POSITION_R") %>' />
                                                                ...
                                                                <asp:View ID="vVAGA" runat="server">
                                                                    <table border="0" cellpadding="3" cellspacing="0">
                                                                        <tr>
                                                                            ...
                                                                            <%--<td>
                                                                                <bars:TextBoxDecimal ID="VAGA1" runat="server" IsRequired="false" 
                                                                                    Value='<%# Bind("VAGA1") %>' ReadOnly="true" MaxValue="100" />
                                                                            </td>--%>
                                                                            <td>
                                                                                <asp:TextBox ID="VAGA1" runat="server" ReadOnly="true" IsRequired="false" Style="text-align: right;
                                                                                                                                                 font-family:'Lucida Grande', Geneva, Arial, Tahoma, Verdana, Helvetica, sans-serif;
                                                                                                                                                 font-size:9pt;
                                                                                                                                                 width:150px; "
                                                                                    Text='<%# Bind("VAGA1") %>' MaxValue="100" /> 
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="VAGA2" runat="server" ReadOnly="true" IsRequired="false" Style="text-align: right;
                                                                                                                                                 font-family:'Lucida Grande', Geneva, Arial, Tahoma, Verdana, Helvetica, sans-serif;
                                                                                                                                                 font-size:9pt;
                                                                                                                                                 width:150px; "
                                                                                    Text='<%# Bind("VAGA2") %>' MaxValue="100"  /> 
    ...
    <script type="text/javascript">
        ...
        function sendDataToWebservice(service, info) {
            $.ajax({
                type: "POST",
                data: JSON.stringify(info),
                url: '/barsroot/clientregister/defaultWebService.asmx/' + service,
                dateType: "json",
        ...
        function InitData(txt) {
            $.ajax({
                ...
                url: '/barsroot/clientregister/defaultWebService.asmx/TranslateKMU',
                dateType: "json",
                contentType: "application/json; charset=UTF-8",
                success: function (data) {
                    var client = {};
                    client.NMK = txt;
                    client.NMKK = txt.substr(0, 38);
                    client.NMKV = data.d.substr(0, 70);
                    $.ajax({
                        type: "POST",
                        data: JSON.stringify({ "cl": client }),
                        url: '/barsroot/clientregister/defaultWebService.asmx/ValidateClient',
                        dateType: "json",
                        contentType: "application/json; charset=UTF-8",
                        success: function (data) {
                            switch (data.d.Code) {
                                ...
                                case 'ALERT':
                                    if (!var_agreement){
                                        //bars.ui.confirm({ text: 'УВАГА: ВВЕДЕНЕ НАЙМЕНУВАННЯ СХОЖЕ НА НАЙМЕНУВАННЯ ЗІ СПИСКУ ТЕРРОРИСТІВ.' },
                                        //    function () {
                                        //        var_agreement = true;
                                        //    });
                                        var_agreement = confirm("УВАГА: ВВЕДЕНЕ НАЙМЕНУВАННЯ СХОЖЕ НА НАЙМЕНУВАННЯ ЗІ СПИСКУ ТЕРРОРИСТІВ.");
                                    }
        ...
        function remItemsFromDropdown(arrItems) {
            for (var i in arrItems) {
                $("option[value='" + arrItems[i] + "']").remove();
            }
        }
        function valfioifTeror(client) {
            var item = sendDataToWebservice('ValidateClient', { cl: client });
            return item;
        }
        
        var checkElement = $("span").filter(function () {
            return ($(this).text().indexOf('Найменування') > -1)
        });
        if (checkElement.length!=0) {
            checkElement.parent().parent().children()[1].children[0];
        }

        checkElement.onfocusout = function () {
            
            var m_nmk = checkElement.value;
            InitData(m_nmk);
        };
