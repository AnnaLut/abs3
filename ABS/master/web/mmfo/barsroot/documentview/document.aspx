...
<head runat="server">
    ...
    <script language="javascript" type="text/jscript">
        ...
        function getOpenAccCard(param) {
            var accountA = document.getElementById('edAccA').value;
            var accountB = document.getElementById('edAccB').value;
         //var childWindow = window.showModalDialog('/barsroot/customerlist/custacc.aspx?type=2&acc=' + account, "", "dialogWidth:800px;center:yes;");
            if (param.id == "edAccA") {
                window.open('/barsroot/customerlist/custacc.aspx?type=2&acc=' + accountA, '_blank');
            }
            else if (param.id == "edAccB") {
                window.open('/barsroot/customerlist/custacc.aspx?type=2&acc=' + accountB, '_blank');
            }
        //var childWindow = window.open('/barsroot/customerlist/custacc.aspx?type=2&acc=' + account, '_blank');
        }
    </script>
</head>
    ...
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                ...
                <td colspan="3">
                    <input id="edValueDate" type="text" style="text-align: center" runat="server" readonly="readonly" /></td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <input id="edSendreOKPO" type="text" style="text-align: right" value="нет данных" runat="server" readonly="readonly" /></td>
            ...
            <tr>
                ...
                <td>
                    <input id="edAccA" type="text" style="text-align: left" value="нет данных" runat="server" readonly="readonly" ondblclick="getOpenAccCard(edAccA)"/></td>
                <td>
                    <input id="edCcyA" type="text" style="text-align: center" value="нет данных" runat="server" readonly="readonly" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input id="edMfoA" type="text" style="text-align: left" value="нет данных" runat="server" readonly="readonly" /></td>
                <td>
                    <input id="edSumA" type="text" style="text-align: right" value="нет данных" runat="server" readonly="readonly" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <input id="edReceiverOKPO" type="text" style="text-align: right" value="нет данных" runat="server" readonly="readonly" /></td>
            ...
            <tr>
                ...
                <td>
                    <input id="edAccB" type="text" style="text-align: left" value="нет данных" runat="server" readonly="readonly" ondblclick="getOpenAccCard(edAccB)" /></td>
                <td>
                    <input id="edCcyB" type="text" style="text-align: center" value="нет данных" runat="server" readonly="readonly" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input id="edMfoB" type="text" style="text-align: left" value="нет данных" runat="server" readonly="readonly" /></td>
                <td>
                    <input id="edSumB" type="text" style="text-align: right" value="нет данных" runat="server" readonly="readonly" /></td>
            </tr>
            <tr>
                <td style="height: 20px" colspan="5"></td>
            </tr>
            ...
            <tr>
                <td  class="nazn" colspan="5"><textarea id="lbDetails" cols="1" rows="3" readonly="readonly" style="width:820px" runat="server"></textarea></td>
            </tr>
        </table>
    </form>
</body>
