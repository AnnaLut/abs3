...
<body bottommargin="0" rightmargin="0">
    <form id="form1" runat="server">
        <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="False" EnableViewState="False">
            <Columns>
                <asp:BoundField DataField="Z" HeaderText="Z" meta:resourcekey="BoundFieldResource10">
                ...
                <asp:BoundField DataField="DOS" HeaderText="Дебет" DataFormatString="{0:N}" HtmlEncode="False" meta:resourcekey="BoundFieldResource5">
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
                <asp:BoundField DataField="KOS" HeaderText="Кредит" DataFormatString="{0:N}" HtmlEncode="False" meta:resourcekey="BoundFieldResource6">
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
