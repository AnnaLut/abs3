...
<script type="text/javascript">
    function EADocsView_ShowDialog(eas_id, rnk, agr_id, req_id, modal) {
        if (eas_id == '' || rnk == '') return false;

        var Url = '/barsroot/UserControls/dialogs/EADocsView.aspx?eas_id=' + eas_id + '&rnk=' + rnk + '&agr_id=' + agr_id + '&req_id=' + req_id + '&rnd=' + Math.random();
