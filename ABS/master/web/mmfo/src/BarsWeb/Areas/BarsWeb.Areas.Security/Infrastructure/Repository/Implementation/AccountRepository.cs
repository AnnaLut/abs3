...
namespace BarsWeb.Areas.Security.Infrastructure.Repository.Implementation
{
    public class AccountRepository : IAccountRepository
    {
        ...
        public AuthorizedStatus AuthorizeByHash(string userName, string hashPass)
        {
            ...
            try
            {
                CustomAuthenticateUser(userName, hashPass, false);
            }
        ...
        /// <returns>В случае ошибки генерируется Exception</returns>
        public void CustomAuthenticateUser(string userName, string password, bool clearPassword)
        {
