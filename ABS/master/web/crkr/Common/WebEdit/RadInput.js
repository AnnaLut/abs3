...
RadMaskedTextBox.prototype.R= function (Q,P)
{
    ...
    this.l=document.getElementById(Q);
    this.field=document.getElementById(Q+"_TextBox");
...
field.addEventListener("\x6beydown",og, false);
field.addEventListener("\x6b\x65ypress",Og, false);
field.addEventListener("\x62lur",onBlur, false);
field.addEventListener("\x69\x6eput",lg, false);
}
if (window.opera)
{
var ig= function ()
