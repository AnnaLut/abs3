...
public partial class DepositAddRegular : Bars.BarsPage
{
    ...
    protected void InitControls()
    {
        ...
        StartDate.Text = Convert.ToString(NextBankdate.ToString("d"));
    ...
    protected void btnReg_ServerClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            _dbLogger.Info("Идентификатор ноого регулярного платежа" + Convert.ToString(IDD.Value));            
    ...
    protected void ComboFill()
    {
        ...
        cmd.CommandText = "select * from BARS.V_FREQ_STO order by FREQ";
