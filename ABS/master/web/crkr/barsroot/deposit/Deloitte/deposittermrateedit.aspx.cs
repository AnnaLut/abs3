...
public partial class DepositTermRateEdit : Bars.BarsPage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            _dbLogger.Info("Пользователь начал формирование доп. соглашения тип=" + agr_id +
                " по договору №" + dpt_id + " с шаблоном " + template,
                "deposit");
        }
    ...
    {
        _dbLogger.Info("Користувач натиснув кнопку \"Змінити\" (Термін вкладу) на сторінці зміни терміну депозитного договору №" + textDptNum.Text, "deposit");
    ...
    {
        _dbLogger.Info("Пользователь нажал кнопку \"Изменить\" (Процентную ставку) на странице изменения процентной ставки по депозитного договору №" + textDptNum.Text,
            "deposit");
