...
public partial class barsroot_deposit_DepositChangeFrequency : System.Web.UI.Page
{
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "error_mesage", "alert('Не вибрано нову періодичність виплати відсотків!');", true);
        }
        else
        {
            _dbLogger.Info( "Користувач натиснув кнопку \"Продовжити\" на сорінці зміни періодичності виплати відсотків по депозиту №" + tbDepositID.Text,
                           "deposit" );
