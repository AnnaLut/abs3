...
public partial class credit_srv_bid_cardMaster : System.Web.UI.MasterPage
{
    ...
    protected void lbSCORING_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(String.Format("/barsroot/credit/manager/prescoringresults.aspx?bid_id={0}", BID_ID));
    }
    ...
    public void FillData()
    {
        ...
        SUBPRODUCT.Text = BidRecord.SUBPRODUCT_NAME;
        SUBPRODUCT.ToolTip = BidRecord.SUBPRODUCT_ID;
        ...
        WORKER_BANK.Text = BidRecord.WORKER_BANK;
    }
    # endregion
}
