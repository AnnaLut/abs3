...
public partial class credit_srv_printdocs : Bars.BarsPage
{
    ...
    {
        ods.SelectParameters.Add("WS_ID", WS_ID);
        // заголовок
    ...
    protected void sc_DocumentScaned(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Label lbIQUERY_ID = (Label)sc.Parent.FindControl("lbIQUERY_ID");
            ...
            /*String IQUERY_ID = lbIQUERY_ID.Text;//(String)lv.SelectedDataKey["IQUERY_ID"];
            if (!String.IsNullOrWhiteSpace(IQUERY_ID))
            {
    ...
    protected void lv_ItemDataBound(object sender, ListViewItemEventArgs e)
    {
        ...
        {
            VWcsSrvBidTemplatesRecord rec = ((e.Item as ListViewDataItem).DataItem as VWcsSrvBidTemplatesRecord);
