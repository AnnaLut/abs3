...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        ...
        <asp:ObjectDataSource ID="odsBidSrvTemplates" runat="server" SelectMethod="SelectBidSrvTemplates"
            TypeName="credit.VWcsBidTemplates">
            <SelectParameters>
                <asp:QueryStringParameter Name="BID_ID" QueryStringField="bid_id" Type="Decimal" />
            </SelectParameters>
        ...
        <table border="0" cellpadding="3" cellspacing="0">
            ...
            <tr id="trSrvResult" runat="server">
                <td class="buttonContainer">
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="/Common/Images/default/16/win_max.gif"
                        OnClientClick="ShowHide(this); return false;" grpid="GRP_SRV_RESULT" grpvisible="0" />
                </td>
                <td colspan="2" class="groupTitle">
                    <asp:Label ID="Label1" runat="server" Text="Сканкопії висновків служб"></asp:Label>
                </td>
            </tr>
            <asp:ListView ID="lvBidSrvTemplates" runat="server" DataSourceID="odsBidSrvTemplates" EnableModelValidation="True">
                <LayoutTemplate>
                    <tr id="itemPlaceholder" runat="server" />
                </LayoutTemplate>
                <ItemTemplate>
                    <tr id="row" runat="server" grpid="GRP_SRV_RESULT" grpvisible="0" class="rowHidden">
                        <td class="buttonContainer" runat="server">
                        </td>
                        <td runat="server">
                            <bec:ByteImage ID="bi" runat="server" Value='<%# Eval("IMG") %>' Width="300px" />
