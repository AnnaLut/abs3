...
namespace BarsWeb.Areas.Sep.Infrastructure.Repository.DI.Abstract
{
    ...
    {
        IQueryable<SepTZ> GetSepTZList(DataSourceRequest request, AccessType accessType);
        decimal GetSepTZCount(AccessType accessType, DataSourceRequest request);
        void DeleteSepTZRow(int rowREC);
