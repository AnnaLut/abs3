...
namespace BarsWeb.Areas.Crkr
{
    ...
    public class CrkrAreaRegistration : AreaRegistration
    {
        ...
        private void BindAreaDi()
        {
            ...
            ninjectKernel.Bind<ICrkrProfileRepository>().To<CrkrProfileRepository>();
            ninjectKernel.Bind<IDoposProfileRepository>().To<DoposProfileRepository>();
            ninjectKernel.Bind<ICrkrRepository>().To<CrkrRepository>();
            ninjectKernel.Bind<ICaGrcRepository>().To<CaGrcRepository>();
            ninjectKernel.Bind<ISaveClientRepository>().To<SaveClientRepository>();
            ninjectKernel.Bind<IUserRepository>().To<UserRepository>();
            ninjectKernel.Bind<ISightRepository>().To<SightRepository>();
            ninjectKernel.Bind<IRegisterRepository>().To<RegisterRepository>();
        }
    }
