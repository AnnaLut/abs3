...
{
    /// <summary>
    /// ListSetController. Редагування списку функцій Відкриття/Закриття дня.
    /// </summary>
    public class ListSetController : ApplicationController
    {
        ...
        public ActionResult GetListSetData(DataSourceRequest request)
        {
        ...
        public ActionResult GetListfuncsetData(DataSourceRequest request, decimal setId)
        {
        ...
        public ActionResult GetOperlistHandbookData(DataSourceRequest request, decimal setId)
        {
