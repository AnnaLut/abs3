...
namespace BarsWeb.Areas.Arcs.Infrastructure.Repository.DI.Implementation
{
    public class ArchivesRepository : IArchivesRepository
    {
        ...
        public int PutTbsOnline(string table)
        {
            object[] parameters =         
            { 
                new OracleParameter("p_tbs",OracleDbType.Varchar2).Value=table
            };
            return _entities.ExecuteStoreCommand("begin bars_arcs.put_tbs_online(:p_tbs); end;", parameters);
        }
