...
namespace BarsWeb.Areas.Ndi.Infrastructure
{
    ...
    public static class SqlStatementParamsParser
    {
        ...
        public static IEnumerable<CallFunctionsMetaInfo> BuildFunctions(IEnumerable<CallFunctionsMetaInfo> functions)
        {
        ...
        public static void BuildFunction(CallFunctionsMetaInfo function)
        {
