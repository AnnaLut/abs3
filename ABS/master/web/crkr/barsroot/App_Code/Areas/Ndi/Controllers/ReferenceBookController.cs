...
namespace BarsWeb.Areas.Ndi.Controllers
{
    ...
    public class ReferenceBookController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public JsonResult CallRefFunction(int? tableId, int? funcId, string jsonFuncParams, int? codeOper, string procName = "", string msg = "",
            string web_form_name = "", string sPar = "", string jsonSqlProcParams = "")
        {
            ...
            try
            {
                ...
                string resultMessage = _repository.CallRefFunction(tableId, funcId, codeOper, funcParams, procName, msg, web_form_name);
        ...
        public JsonResult GetFuncOnlyMetaData(int? codeOper)
        {
            try
            {
                CallFunctionsMetaInfo funcInfo = _repository.GetFunctionsMetaInfo(codeOper);
