...
namespace BarsWeb.Areas.Cash.Infrastructure.Sync
{
    ...
    public abstract class SynchronizerBase
    {
        ...
        protected SynchronizerBase(ICenterAccountRepository centerAccountRepository, ISyncRepository syncRepository)
        {
            CenterAccountRepository = centerAccountRepository;
            SyncRepository = syncRepository;
        }

        protected readonly ICenterAccountRepository CenterAccountRepository;
        ...
        public SyncResult Sync(ConnectionOption connectionOption, LogBinder logBinder)
        {
            if (Connection != null)
            {
                ...
                CenterAccountRepository.Connection = Connection;
            }
