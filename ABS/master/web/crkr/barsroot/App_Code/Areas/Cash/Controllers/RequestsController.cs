...
namespace BarsWeb.Areas.Cash.Controllers
{
    ...
    public class RequestsController : ApplicationController
    {
        ...
        public RequestsController(IRequestRepository requestRepository, IMfoRepository mfoRepository, ICenterAccountRepository centerAccountRepository)
        {
        ...
        {
            V_CLIM_ACC acc = _centerAccountRepository.GetAccounts().First(x =>
