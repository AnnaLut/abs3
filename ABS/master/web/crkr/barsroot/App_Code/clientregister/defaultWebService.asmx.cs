...
namespace clientregister
{
    ...
    public class defaultWebService : Bars.BarsWebService
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    else if (myClient.CUSTTYPE == "corp")
                    {
                        ...
                        WriteCategoryToDb(Int32.Parse(myClient.ID), custCatsList);
                    }
        ...
        public void WriteCategoryToDb(int rnk, List<CustCategoryRecord> custCatList)
        {
        ...
        public void WritePersonToDatabase(Client myClient)
        {
            ...
            if (myClient.EditType == "ReReg")
            {
                ...
                SetParameters("pTelM", DB_TYPE.Varchar2, GetParamObj("Str", myClient.DopRekv_MPNO), DIRECTION.Input);
