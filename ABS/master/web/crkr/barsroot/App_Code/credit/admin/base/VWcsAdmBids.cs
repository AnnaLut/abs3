...
namespace credit
{
    public sealed class VWcsAdmBidsRecord : BbRecord
    {
        public VWcsAdmBidsRecord(): base()
        {
            fillFields();
        }
        public VWcsAdmBidsRecord(BbDataSource Parent) : base (Parent)
        {
            fillFields();
        }
        public VWcsAdmBidsRecord(BbDataSource Parent, OracleDecimal RowScn, Decimal? BID_ID, String SUBPRODUCT_ID, String SUBPRODUCT_NAME, DateTime? CRT_DATE, String STATUS, String F, String I, String O, String FIO, DateTime? BDATE, String INN, String WORK_MAIN_NAME, String WORK_MAIN_INN, String WORK_ADD_NAME, String WORK_ADD_INN, Decimal? PROPERTY_COST, Decimal? SUMM, Decimal? OWN_FUNDS, String TERM, String CREDIT_CURRENCY, Decimal? SINGLE_FEE, Decimal? MONTHLY_FEE, Decimal? INTEREST_RATE, String REPAYMENT_METHOD, Decimal? REPAYMENT_DAY, String GARANTEES, String GARANTEES_IDS, Decimal? MGR_ID, String MGR_FIO, String BRANCH, String BRANCH_NAME, String STATES, DateTime? CHECKOUT_DAT, Decimal? CHECKOUT_USER_ID, String CHECKOUT_USER_FIO, String CHECKOUT_USER_BRANCH/*, String SRV_HIERARCHY*/)
            : this(Parent)
        {
            this.BID_ID = BID_ID;
        ...
        {
            Fields.Add( new BbField("BID_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Идентификатор заявки"));
            Fields.Add(new BbField("SUBPRODUCT_ID", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Идентификатор субпродукта"));
            Fields.Add(new BbField("SUBPRODUCT_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Наименование субпродукта"));
            Fields.Add(new BbField("CRT_DATE", OracleDbType.Date, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Дата создания заявки"));
            Fields.Add(new BbField("STATUS", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Статус заявки"));
            Fields.Add(new BbField("F", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Ф клиента"));
            Fields.Add(new BbField("I", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "И клиента"));
            Fields.Add(new BbField("O", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "О клиента"));
            Fields.Add(new BbField("FIO", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "ФИО клиента"));
            Fields.Add(new BbField("BDATE", OracleDbType.Date, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Дата рождения клиента"));
            Fields.Add(new BbField("INN", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "ИНН клиента"));
            Fields.Add(new BbField("WORK_MAIN_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Наименование основного места работы"));
            Fields.Add(new BbField("WORK_MAIN_INN", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "ЄДРПОУ основного места работы"));
            Fields.Add(new BbField("WORK_ADD_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Наименование дополнительного места работы"));
            Fields.Add(new BbField("WORK_ADD_INN", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "ЄДРПОУ дополнительного места работы"));
            Fields.Add(new BbField("PROPERTY_COST", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Стоимость имущества"));
            Fields.Add(new BbField("SUMM", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Сумма кредита"));
            Fields.Add(new BbField("OWN_FUNDS", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Сума власних коштів"));
            Fields.Add(new BbField("TERM", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Срок кредита"));
            Fields.Add(new BbField("CREDIT_CURRENCY", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Валюта кредиту"));
            Fields.Add(new BbField("SINGLE_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Комісія банку разова"));
            Fields.Add(new BbField("MONTHLY_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Комісія банку щомісячна"));
            Fields.Add(new BbField("INTEREST_RATE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Відсоткова ставка"));
            Fields.Add(new BbField("REPAYMENT_METHOD", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Метод погашення"));
            Fields.Add(new BbField("REPAYMENT_DAY", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "День погашення"));
            Fields.Add(new BbField("GARANTEES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Обеспечения"));
            Fields.Add(new BbField("GARANTEES_IDS", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Обеспечения (коды)"));
            Fields.Add(new BbField("MGR_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Ид менеджера"));
            Fields.Add(new BbField("MGR_FIO", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "ФИО менеджера"));
            Fields.Add(new BbField("BRANCH", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Идентификатор отделения"));
            Fields.Add(new BbField("BRANCH_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Наименование отделения"));
            Fields.Add(new BbField("STATES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Состояния"));
            Fields.Add(new BbField("CHECKOUT_DAT", OracleDbType.Date, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Дата начала обработки"));
            Fields.Add(new BbField("CHECKOUT_USER_ID", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Ид. пользователя обработки"));
            Fields.Add(new BbField("CHECKOUT_USER_FIO", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "ФИО пользователя обработки"));
            Fields.Add(new BbField("CHECKOUT_USER_BRANCH", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Код отделения пользователя обработки"));
            //Fields.Add(new BbField("SRV_HIERARCHY", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_ADM_BIDS", ObjectTypes.View, "Архив заявок кредитной службы (Представление)", "Идентификатор уровеня иерархии"));        
        }
    ...
    public sealed class VWcsAdmBidsFilters : BbFilters
    {
        public VWcsAdmBidsFilters(BbDataSource Parent)
            : base(Parent)
        {
    ...
    public partial class VWcsAdmBids : BbTable<VWcsAdmBidsRecord, VWcsAdmBidsFilters>
    {
        public VWcsAdmBids() : base(new BbConnection())
        {
            // base.Connection.RoleName = "WR_WCS";
        }
        public VWcsAdmBids(BbConnection Connection)
            : base(Connection)
        {
        }
        public override List<VWcsAdmBidsRecord> Select(VWcsAdmBidsRecord Item)
        {
            List<VWcsAdmBidsRecord> res = new List<VWcsAdmBidsRecord>();
