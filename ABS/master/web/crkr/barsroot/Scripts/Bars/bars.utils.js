...
bars.utils.checkEdrpouCtrlDigit = function (edrpou) {
    ...
    // Если в результате деления на 11 получилось число больше 10, 
    // не обходи выполнить повторный расчет сумму.
	
    
    //функция расчета контрольного разряда
    ...
    var weightCoeficient1 = [1, 2, 3, 4, 5, 6, 7];
    var weightCoeficient2 = [7, 1, 2, 3, 4, 5, 6];
