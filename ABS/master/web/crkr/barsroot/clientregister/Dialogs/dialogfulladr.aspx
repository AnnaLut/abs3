...
<head runat="server">
    ...
    <script src="../../Scripts/Bars/bars.extension.js"></script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function addValueToObj(id, adres) {
            if ($('#FGTWN' + id).val()/* && $('#FGADR'+id).val()*/) {
                ...
                adres.territory_id = $('#TerCod' + id).val();
        ...
        function ReturnVal() {
            ...
            if (window.closedFunction) {
                window.closedFunction(new Array(CustomerAddress, strReturn));
            }
            window.close();
        }
        ...
        function ShowAdrManual(typeId) {
            if (window.showModalDialog) {
                ...
                bars.ui.handBook('TERRITORY', function(data) {
                    if (data) {
                        $('#TerCod' + typeId).val(data[0].ID);
                        $('#FGTWN' + typeId).val(data[0].CITY);
                        $('#FGOBL' + typeId).val(data[0].REGION);
                        $('#FGDST' + typeId).val(data[0].DISTRICT);
                    }
                });
            }
        }
                    ...
                    <div class="accordion-content">
                        <table class="address" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="LocalityType1" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                <td>вул, просп., б-р:</td>
                                <td>
                                    <select id="StreetType1" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                <td>№ буд., д/в:</td>
                                <td>
                                    <select id="HomeType1" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                <td>№ корп., секц.:</td>
                                <td>
                                    <select id="HomePartType1" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                <td>№ кв., кімн., оф.:</td>
                                <td>
                                    <select id="RoomType1" class="small-dd" runat="server"></select>
                    ...
                    <div class="accordion-content">
                        <table class="address" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="LocalityType2" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="StreetType2" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="HomeType2" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="HomePartType2" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="RoomType2" class="small-dd" runat="server"></select>
                    ...
                    <div class="accordion-content">
                        <table class="address" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="LocalityType3" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="StreetType3" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="HomeType3" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="HomePartType3" class="small-dd" runat="server"></select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="RoomType3" class="small-dd" runat="server"></select>
