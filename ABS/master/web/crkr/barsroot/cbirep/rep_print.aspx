            ...
            <table border="0" cellpadding="3" cellspacing="0" style="width: 99%">
                ...
                <tr>
                    <td>
                        ...
                        <FR:WebReport ID="wr" runat="server" Width="100%" ShowPrint="false" ShowExports="false" Height="100%" ShowRefreshButton="False" ShowZoomButton="true" ToolbarIconsStyle="Blue" />
                    </td> 
                </tr>
            </table>
        </div>
