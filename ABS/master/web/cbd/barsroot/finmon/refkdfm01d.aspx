<%@ Page Language="C#" AutoEventWireup="true" Title="Довідник KDFM01d"
    CodeFile="refkdfm01d.aspx.cs" Inherits="finmon_refkdfm01d" Trace="false" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="formKDFM01d" runat="server">
        <asp:Panel ID="panelFiltert" runat="server" GroupingText="Фільтр:" Style="margin-left: 10px;" Visible="true">
            <table width="75%">
                <tr align="right">
                    <td>
        ...
        <div class="pageTitle">
            <asp:Label ID="lbTitle" runat="server" Text="Об`єкт операції"></asp:Label>
        </div>
        <BarsEX:BarsSqlDataSourceEx ID="odsKdfm01d" runat="server" AllowPaging="False" ProviderName="barsroot.core"></BarsEX:BarsSqlDataSourceEx>

        <BarsEX:BarsGridViewEx ID="gvKdfm01d" runat="server" PagerSettings-PageButtonCount="10" PageIndex="0"
            PageSize="15" AllowPaging="True" AllowSorting="True"
            DataSourceID="odsKdfm01d" CssClass="barsGridView" DataKeyNames="CODE,NAME" DateMask="dd/MM/yyyy"
