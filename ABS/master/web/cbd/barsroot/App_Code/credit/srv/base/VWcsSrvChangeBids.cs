...
namespace credit
{
    public sealed class VWcsSrvChangeBidsRecord : BbRecord
    {
        public VWcsSrvChangeBidsRecord(): base()
        {
            fillFields();
        }
        public VWcsSrvChangeBidsRecord(BbDataSource Parent) : base (Parent)
        {
            fillFields();
        }
        public VWcsSrvChangeBidsRecord(BbDataSource Parent, OracleDecimal RowScn, Decimal? BID_ID, String SUBPRODUCT_ID, String SUBPRODUCT_NAME, DateTime? CRT_DATE, String F, String I, String O, DateTime? BDATE, String INN, Decimal? SUMM, Decimal? OWN_FUNDS, String TERM, String CREDIT_CURRENCY, Decimal? SINGLE_FEE, Decimal? MONTHLY_FEE, Decimal? INTEREST_RATE, String REPAYMENT_METHOD, String REPAYMENT_METHOD_TEXT, Decimal? REPAYMENT_DAY, String GARANTEES, Decimal? MGR_ID, String MGR_FIO, String BRANCH, String BRANCH_NAME, String STATES, String FIO, String SRV, Decimal? CHECKOUTED, DateTime? CHECKOUT_DAT, Decimal? CHECKOUT_USER_ID, String CHECKOUT_USER_FIO, String CHECKOUT_USER_BRANCH, String SRV_HIERARCHY)
            : this(Parent)
        {
            this.BID_ID = BID_ID;
        ...
        {
            Fields.Add( new BbField("BID_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Идентификатор заявки"));
            Fields.Add( new BbField("SUBPRODUCT_ID", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Идентификатор субпродукта"));
            Fields.Add( new BbField("SUBPRODUCT_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Наименование субпродукта"));
            Fields.Add( new BbField("CRT_DATE", OracleDbType.Date, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Дата создания заявки"));
            Fields.Add( new BbField("F", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Ф клиента"));
            Fields.Add( new BbField("I", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "И клиента"));
            Fields.Add( new BbField("O", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "О клиента"));
            Fields.Add( new BbField("BDATE", OracleDbType.Date, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Дата рождения клиента"));
            Fields.Add( new BbField("INN", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "ИНН клиента"));
            Fields.Add( new BbField("SUMM", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Сумма кредита"));
            Fields.Add( new BbField("OWN_FUNDS", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Сума власних коштів"));
            Fields.Add( new BbField("TERM", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Срок кредита"));
            Fields.Add( new BbField("CREDIT_CURRENCY", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Валюта кредиту"));
            Fields.Add( new BbField("SINGLE_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Комісія банку разова"));
            Fields.Add( new BbField("MONTHLY_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Комісія банку щомісячна"));
            Fields.Add( new BbField("INTEREST_RATE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Відсоткова ставка"));
            Fields.Add( new BbField("REPAYMENT_METHOD", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Метод погашення"));
            Fields.Add( new BbField("REPAYMENT_METHOD_TEXT", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", ""));
            Fields.Add( new BbField("REPAYMENT_DAY", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "День погашення"));
            Fields.Add( new BbField("GARANTEES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Обеспечения"));
            Fields.Add( new BbField("MGR_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Ид менеджера"));
            Fields.Add( new BbField("MGR_FIO", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "ФИО менеджера"));
            Fields.Add( new BbField("BRANCH", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Идентификатор отделения"));
            Fields.Add( new BbField("BRANCH_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Наименование отделения"));
            Fields.Add( new BbField("STATES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Состояния"));
            Fields.Add( new BbField("FIO", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "ФИО клиента"));
            Fields.Add( new BbField("SRV", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Краткий код службы"));
            Fields.Add( new BbField("CHECKOUTED", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "В обработке 0/1"));
            Fields.Add( new BbField("CHECKOUT_DAT", OracleDbType.Date, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Дата начала обработки"));
            Fields.Add( new BbField("CHECKOUT_USER_ID", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Ид. пользователя обработки"));
            Fields.Add( new BbField("CHECKOUT_USER_FIO", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "ФИО пользователя обработки"));
            Fields.Add( new BbField("CHECKOUT_USER_BRANCH", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Код отделения пользователя обработки"));
            Fields.Add( new BbField("SRV_HIERARCHY", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_SRV_CHANGE_BIDS", ObjectTypes.View, "Заявки службы (CБ, ЮС, СПА, ДР, ФЕП)", "Идентификатор уровеня иерархии"));        
        }
    ...
    public sealed class VWcsSrvChangeBidsFilters : BbFilters
    {
        public VWcsSrvChangeBidsFilters(BbDataSource Parent) : base (Parent)
        {
    ...
    public partial class VWcsSrvChangeBids : BbTable<VWcsSrvChangeBidsRecord, VWcsSrvChangeBidsFilters>
    {
        public VWcsSrvChangeBids() : base(new BbConnection())
        {
            // base.Connection.RoleName = "WR_WCS";
        }
        public VWcsSrvChangeBids(BbConnection Connection)
            : base(Connection)
        {
        }
        public override List<VWcsSrvChangeBidsRecord> Select(VWcsSrvChangeBidsRecord Item)
        {
            List<VWcsSrvChangeBidsRecord> res = new List<VWcsSrvChangeBidsRecord>();
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    res.Add(new VWcsSrvChangeBidsRecord(
                        this,
