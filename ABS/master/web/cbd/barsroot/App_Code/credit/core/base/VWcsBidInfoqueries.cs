...
namespace credit
{
    public sealed class VWcsBidInfoqueriesRecord : BbRecord
    {
        public VWcsBidInfoqueriesRecord(): base()
        {
            fillFields();
        }
        public VWcsBidInfoqueriesRecord(BbDataSource Parent) : base (Parent)
        {
            fillFields();
        }
        public VWcsBidInfoqueriesRecord(BbDataSource Parent, OracleDecimal RowScn, Decimal? BID_ID, String TYPE_ID, String TYPE_NAME, String SERVICE_ID, String SERVICE_NAME, String SRV_HIERARCHY, String SRV_HIERARCHY_NAME, String WS_ID, Decimal? ACT_LEVEL, String IQUERY_ID, String IQUERY_NAME, String IQUERY_TEXT, Decimal? IS_REQUIRED, Decimal? STATUS, String STATUS_MSG, Decimal? PROCESSED, Decimal? ORD)
            : this(Parent)
        {
            this.BID_ID = BID_ID;
        ...
        {
            Fields.Add( new BbField("BID_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Идентификатор заявки"));
            Fields.Add( new BbField("TYPE_ID", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Идентификатор типа инфо-запроса"));
            Fields.Add( new BbField("TYPE_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Наименование типа инфо-запроса"));
            Fields.Add( new BbField("SERVICE_ID", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Идентификатор службы"));
            Fields.Add( new BbField("SERVICE_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Наименование службы"));
            Fields.Add( new BbField("SRV_HIERARCHY", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Уровень службы"));
            Fields.Add( new BbField("SRV_HIERARCHY_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Наименование уровеня службы"));
            Fields.Add( new BbField("WS_ID", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Рабочее пространство ответов"));
            Fields.Add( new BbField("ACT_LEVEL", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Уровень активации"));
            Fields.Add( new BbField("IQUERY_ID", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Идентификатор информационного запроса"));
            Fields.Add( new BbField("IQUERY_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Наименование информационного запроса"));
            Fields.Add( new BbField("IQUERY_TEXT", OracleDbType.Clob, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Текст ручного запроса"));
            Fields.Add( new BbField("IS_REQUIRED", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Обязательность"));
            Fields.Add( new BbField("STATUS", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Статус"));
            Fields.Add( new BbField("STATUS_MSG", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Текст статуса"));
            Fields.Add( new BbField("PROCESSED", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Выполнялся"));
            Fields.Add( new BbField("ORD", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_BID_INFOQUERIES", ObjectTypes.View, "Информационные запросы заявки (Представление)", "Порядок"));        
        }
    ...
    public sealed class VWcsBidInfoqueriesFilters : BbFilters
    {
        public VWcsBidInfoqueriesFilters(BbDataSource Parent) : base (Parent)
        {
    ...
    public partial class VWcsBidInfoqueries : BbTable<VWcsBidInfoqueriesRecord, VWcsBidInfoqueriesFilters>
    {
        public VWcsBidInfoqueries() : base(new BbConnection())
        {
            // base.Connection.RoleName = "WR_WCS";
        }
        public VWcsBidInfoqueries(BbConnection Connection)
            : base(Connection)
        {
        }
        public override List<VWcsBidInfoqueriesRecord> Select(VWcsBidInfoqueriesRecord Item)
        {
            List<VWcsBidInfoqueriesRecord> res = new List<VWcsBidInfoqueriesRecord>();
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    res.Add(new VWcsBidInfoqueriesRecord(
                        this,
