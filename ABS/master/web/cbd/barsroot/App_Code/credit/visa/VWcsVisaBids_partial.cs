...
namespace credit
{
    public partial class VWcsVisaBids
    {
        public List<VWcsVisaBidsRecord> SelectVisaBids(String SRV_HIERARCHY, Decimal? BidId, String Inn, String Fio, String SortExpression, int maximumRows, int startRowIndex)
        {
