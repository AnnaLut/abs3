...
namespace cim
{
    public sealed class VCimInUnboundPaymentsRecord : BbRecord
    {
        ...
        private void fillFields()
        {
            ...
            Fields.Add( new BbField("ACC", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_IN_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані вхідні (экспортні) платежі", "ACC рахунку"));
            ...
            Fields.Add( new BbField("PDAT", OracleDbType.Date, true, false, false, false, false, "V_CIM_IN_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані вхідні (экспортні) платежі", "Дата створення локумента"));
            ...
            Fields.Add( new BbField("OP_TYPE_ID", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_IN_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані вхідні (экспортні) платежі", ""));
            ...
            Fields.Add( new BbField("PAY_TYPE", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_IN_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані вхідні (экспортні) платежі", "Тип платежу ()"));
            Fields.Add( new BbField("PAY_TYPE_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_IN_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані вхідні (экспортні) платежі", "Назва типу"));
            ...
            Fields.Add( new BbField("DIRECT", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_IN_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані вхідні (экспортні) платежі", "Напрям платежу 0 - вхідні, 1 - вихідні"));
            Fields.Add( new BbField("DIRECT_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_IN_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані вхідні (экспортні) платежі", ""));
            Fields.Add( new BbField("TT", OracleDbType.Char, true, false, false, false, false, "V_CIM_IN_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані вхідні (экспортні) платежі", "Код операції"));
            Fields.Add( new BbField("BACKGROUND_COLOR", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_IN_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані вхідні (экспортні) платежі", ""));        
        }
