                    ...
                    try
                    {
                        ...
                        if (ourDoc.oDocument())
                        {
                            ...
                            for (int i = 0; i < l_doc_list.Count; i++)
                            {
                                ...
                                Bars.Logger.DBLogger.Financial("Ввод чека ref=" + oper.Ref + ": " + oper.NlsA + "(" + oper.KvA + ") " + oper.SA.ToString("F0") + " -> " + oper.BankB + " " + oper.NlsB + "(" + oper.KvB + ") " + oper.SB.ToString("F0") + "[" + oper.NamB + "],[" + oper.Nazn + "] " + oper.OperId);
