...
namespace BarsWeb.Controllers
{
    public class AccountController : ApplicationController
    {
        ...
        /// <summary>
        /// сторінка перегляду журналу подій
        /// </summary>
        /// <returns></returns>
        [AuthorizeUser]
        public ActionResult Audit(decimal pageNum = 1, decimal pageSize = 20)
        {
            ViewBag.count = _repository.GetCountUserSecAudit();
            ViewBag.pageNum = pageNum;
            ViewBag.pageSize = pageSize;
            var audit = _repository.GetUserSecAudit(pageNum, pageSize);
            return View(audit);
        }
        ...
        {
            _repository.SetUserError(string.Format("ClientJsError: {0}", stack));
        }
