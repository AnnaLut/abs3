...
public partial class credit_crdsrv_bid_srvsreinput : Bars.BarsPage
{
    ...
    protected void btDataReInput_Click(object sender, EventArgs e)
    {
        ...
        if (1 == cmn.wu.HAS_BID_STATE(BID_ID, "NEW_SRVSREINPUT_FINISHED"))
        {
            cmn.wp.BID_STATE_CHECK_IN(BID_ID, "NEW_SRVSREINPUT_FINISHED", (String)null);
            cmn.wp.BID_STATE_DEL(BID_ID, "NEW_SRVSREINPUT_FINISHED");
        }

        cmn.wp.BID_STATE_SET(BID_ID, "NEW_SRVSREINPUT", Comment.Value);
