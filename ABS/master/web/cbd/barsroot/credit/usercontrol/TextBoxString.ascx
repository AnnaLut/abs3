...
<asp:RequiredFieldValidator ID="rfv" runat="server" ControlToValidate="tb" 
    Display="None" Enabled="False" ErrorMessage='<%# RequiredErrorText %>'></asp:RequiredFieldValidator>
<asp:RegularExpressionValidator ID="rev" runat="server" ControlToValidate="tb" Display="None" ErrorMessage='<%# MinMaxLengthErrorText %>'></asp:RegularExpressionValidator>
