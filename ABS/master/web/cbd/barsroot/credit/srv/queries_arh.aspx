<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="queries_arh.aspx.cs" Inherits="credit_srv_queries_arh" Title="Архив заявок ({0})"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        ...
        <table border="0" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectSrvBidsArchive"
                        TypeName="credit.VWcsSrvBidsArchive" SortParameterName="SortExpression" EnablePaging="True">
                        <SelectParameters>
                    ...
                    <Bars:BarsGridViewEx ID="gv" runat="server" AutoGenerateColumns="False" CaptionText=""
                        ...
                        <Columns>
                            <asp:HyperLinkField DataNavigateUrlFields="BID_ID" DataNavigateUrlFormatString="/barsroot/credit/srv/bid_card_arh.aspx?bid_id={0}"
