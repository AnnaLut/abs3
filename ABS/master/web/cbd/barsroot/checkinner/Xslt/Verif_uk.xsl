...
<TD title="Виконавець"><xsl:attribute name="onclick"><xsl:text>Sort('a.USERID')</xsl:text></xsl:attribute>
<xsl:text>Исп.</xsl:text></TD>

<TD noWrap="true" width="100" title="Рахунок-А верифікації">
<xsl:text>Рахунок-А вериф</xsl:text></TD>

<TD noWrap="true" width="100" title="МФО-Б верифікації">
<xsl:text>МФО-Б вериф</xsl:text></TD>

<TD noWrap="true" width="100" title="Рахунок-Б верифікації">
<xsl:text>Рахунок-Б вериф</xsl:text></TD>

<TD noWrap="true" width="100" title="ОКПО-Б верифікації">
<xsl:text>ОКПО-Б вериф</xsl:text></TD>

<TD noWrap="true" width="120" title="Сума верифікації">
<xsl:text>Сума вериф</xsl:text></TD>

<TD><xsl:attribute name="onclick"><xsl:text>Sort('a.NAZN')</xsl:text></xsl:attribute>
<xsl:text>Призначення платежу</xsl:text></TD>
</TR>  
