...
<TD title="Дата руху"><xsl:attribute name="onclick"><xsl:text>Sort('FDAT')</xsl:text></xsl:attribute>
<xsl:text>Дата руху</xsl:text></TD>

<TD title="Вхідний залишок"><xsl:attribute name="onclick"><xsl:text>Sort('ch_OSTF')</xsl:text></xsl:attribute>
...
<TD title="Вихідний залишок"><xsl:attribute name="onclick"><xsl:text>Sort('ch_OST')</xsl:text></xsl:attribute>
...
<TR>
	...
	<TD align="center" title="Виписка по рахунку" style="CURSOR: hand; COLOR: blue; TEXT-DECORATION: underline"><xsl:attribute name="onclick"><xsl:text>OpenAccExtract('</xsl:text><xsl:value-of select="ACC" /><xsl:text>','</xsl:text><xsl:value-of select="CH_FDAT" /><xsl:text>')</xsl:text></xsl:attribute><xsl:value-of select="CH_FDAT" /></TD>
