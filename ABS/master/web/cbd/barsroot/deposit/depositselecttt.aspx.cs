    ...
    private void Page_Load(object sender, System.EventArgs e)
	{
		...
		try
		{
			...
			if (action == "percent")
			{
                ...
                DBLogger.Info("Выбор операции для выплаты процентов по депозитному договору №" + dpt_id.Value,
					"deposit");
			}		
			else if (action == "close")
			{
                ...
                DBLogger.Info("Вибір операції для виплати депозиту при достроковому розірванні договору №" + dpt_id.Value,
					"deposit");
			}
            else if (action == "closep")
            {
                ...
                DBLogger.Info("Вибір операції для виплати відсотків при достроковому розірванні договору №" + dpt_id.Value,
                    "deposit");
            }
            else if (action == "return")
			{
                ...
                DBLogger.Info("Выбор операции для выплаты по завершению депозитного договора №" + dpt_id.Value,
					"deposit");
			}
