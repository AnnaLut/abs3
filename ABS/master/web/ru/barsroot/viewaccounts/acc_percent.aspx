...
<head>
    ...
    <script language="jscript" src="../Scripts/jquery/jquery.min.js"></script>
</head>
<body>
            ...
            <td align="left" height="1">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="90">
                            <input name="tbMFO" type="text" id="tbMFO" onchange="SaveP(this)" onfocusout="checkAcc(this)" style="width: 90px">
                        </td>
                        <td width="40">
                        ...
                        <td width="150">
                            <input name="tbNlsC" type="text" id="tbNlsC" onchange="ValidNlsC()" onfocusout="checkAcc(this)" style="width: 150px">
                        </td>
                        <td width="50">
                            <span class ="BarsLabel">ОКПО</span>
                        </td>
                        <td width="150">
                            <input name="tbOKPO" type="text" id="tbOKPO" onchange="SaveP(this)" onkeyup="numbValidate(this)" style="width: 150px">
                        </td>
                        <td>
                        </td>
                    </tr>
                ...
                <table width="100%">
                    <tr>
                        <td width="100"><span class="BarsLabel"  >Призначення платежу</span>
                        </td>
                        <td width="536">
