	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table class="MainTable">
				<tr>
					<td><asp:label id="lbTitle" meta:resourcekey="lbTitle8" runat="server" CssClass="InfoHeader">Принятые файлы зачислений</asp:label></td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
					    <table class="InnerTable">
					        <tr>
					            <td>
					                <input id="btImport" runat="server" meta:resourcekey="btNewFile" class="AcceptButton" type="button" src="img/download.png" value="Принять новый файл" onclick="location.replace('DepositFile.aspx');"/></td>
					            <td>
					                <input id="btCreate" runat="server" meta:resourcekey="btCreate" class="AcceptButton" type="button" src="img/add.png" value="Создать новый файл" onclick="location.replace('DepositFile.aspx?mode=create');" visible="true"/></td>
					            <td>
                                    <input id="btCopy" runat="server" meta:resourcekey="btCopy" disabled="disabled" class="AcceptButton" type="button" src="img/copy.png" value="Копировать файл" onserverclick="btCopy_ServerClick" /></td>
					            <td>
