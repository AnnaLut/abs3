                    ...
                    <asp:Panel ID="pnlFilter" runat="server" GroupingText="Фільтр">
                        <table border="0" class="tbl">
                            <tr>
                                ...
                                <td class="header" >
                                    <asp:Label ID="lRnk" runat="server" Text="РНК клієнта"></asp:Label>
                                </td>
                                <td class="header">
                                    <asp:Label ID="ErrCntTitle" runat="server" Text="Кількість помилок"></asp:Label>
                                </td>
                                <td class="header">
                                    <asp:Label ID="ErrTxtTitle" runat="server" Text="Текст помилки"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="param_cntr">
                                ...
                                <td class="param_cntr" >
                                 ...
                                 <td class="param_cntr" >
                                    <asp:TextBox ID="tbRNK" runat="server" TextMode="MultiLine" Rows="4" ToolTip="Вказуються коди через ; без пробілів"></asp:TextBox>
                                </td>
                                <td class="param_cntr" >
                                    <asp:TextBox ID="tbErrCnt" runat="server" TextMode="MultiLine" Rows="4" ToolTip="Вказується к-ть помилок через ; без пробілів"></asp:TextBox>
                                </td>
                                <td class="param_cntr" >
                                    <asp:TextBox ID="tbErrTxt" runat="server" TextMode="MultiLine" Rows="4" ToolTip="Текст помилки (працює як LIKE )"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="button_cntr" colspan="6">
