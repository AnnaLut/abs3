    ...
    <form id="form1" runat="server">
        <table class="MainTable">
            ...
            <tr>
                ...
                <td>
                    <cc1:DateEdit ID="DATE_FROM" runat="server" CssClass="InfoText95" Width="120px" meta:resourcekey="DATE_FROM"></cc1:DateEdit></td>
            </tr>
             <tr>
                <td class="auto-style4">
                </td>
                ...
                <td>
                    <cc1:DateEdit ID="DATE_TO"  runat="server" CssClass="InfoText95"  Width="120px"  meta:resourcekey="DATE_TO"></cc1:DateEdit>
                </td>
            </tr> 
            <tr>
                <td class="auto-style4">
                ...
                <td>
                    <cc1:DateEdit ID="CANCEL_DATE"  runat="server" CssClass="InfoText95" Width="119px" meta:resourcekey="CANCEL_DATE"></cc1:DateEdit>
                </td>
            </tr>
             <tr>
            ...
            <tr>
                ...
                <td class="auto-style7">
                    ...
                    <input type="hidden" runat="server" id="DATE_FROM_" />
                    <input type="hidden" runat="server" id="DATE_TO_" />
                    <input type="hidden" runat="server" id="DATE_CLOSE_" />
                </td>
