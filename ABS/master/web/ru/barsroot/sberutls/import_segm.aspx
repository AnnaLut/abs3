<%@ Page Language="C#" AutoEventWireup="true" CodeFile="import_segm.aspx.cs" Inherits="sberutls_import_segm" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title title="Завантаження файлів сегменту суб'єкта господарювання"> </title>
     <style type="text/css">
        .title {
        ...
        <div>
            <table>
                <tr>
                    <td>
                        <br>
                             Завантаження файлів сегменту суб'єкта господарювання
                        </br>
                    </td>
                </tr>
            </table>
