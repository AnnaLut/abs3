<%@ Page Language="C#" AutoEventWireup="true" CodeFile="confirm_immobile_edit.aspx.cs" Inherits="confirm_edit" %>
...
<body>
    ...
    <asp:Panel  ID="pnPay" GroupingText="Виконання дій:" runat="server" Style="margin-left: 10px;
        ...
        <tr>
            ...
            <td>
                <asp:Button runat="server" ID="bt_visa" Text="Підтвердити редагування" OnClick="bt_visa_Click" OnClientClick='return confirm("Підтвердити дані?")'/>
            </td>
            <td>
                <asp:Button runat="server" ID="bt_not_visa" Text="Повернути на повторне редагування" OnClick="bt_not_visa_Click" OnClientClick='return confirm("Повернути на повторне редагування?")'/>
            </td>
