...
<HTML>
	<HEAD>
		...
		<script language="JavaScript" src="Scripts/CloseNBSAccInfo.js?v.1.0"></script>
		<script language="JavaScript" src="Scripts\CustAcc.js?v1.11"></script>
		...
		<div style="BACKGROUND-COLOR: lightgrey">
            ...
            <asp:Panel CssClass="SimpleText" ID="pnSearsh" GroupingText="Пошук" style="white-space:nowrap;padding:10px;" runat="server">
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" id="cbShowDK" onclick="switchView(this)"> <label for="cbShowDK" style="white-space:nowrap">Залишки двома колонками (Д/К)</label>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input id="tbFindOKPO" style="width:75px" type="text" />
                    </td>
			...
			<TABLE cellSpacing="0" cellPadding="0" border="1">
				<TR>
					...
					<TD>&nbsp;<IMG class="outset" id="btRefresh" title="Перечитать данные" onclick="ReInitGrid()"><IMG class="outset" id="btFilter" title="Установить фильтр" onclick="ShowModalFilter()">
						<IMG class="outset" id="btHistAcc" title="История счета" onclick="fnShowHistAcc()">
                        <IMG class="outset" id="btHist" title="История изменения параметров счета" onclick="fnShowHist()">
                        <IMG class="outset" id="btIntState" title="Моделювання нарахованих відсотків" onclick="fnIntState()" src="/Common/Images/A_PROC.gif">
               <%--     <IMG class="outset" id="btLinkAcc" title="Пов'язані рахунки" onclick="fnClickLinkAcc()" src="/Common/Images/DETAILS.gif">
                        <IMG class="outset" id="btSumVal" title="Підсумки по валютам" onclick="fnClickVal()" src="/Common/Images/summ.gif">&nbsp;
                       <IMG class="outset" id="btTurn" title="Обороти по рахунку за період" onclick="fnClickTurn()" src="/Common/Images/tudasuda.gif">
                        <IMG class="outset" id="btTurn" title="Обороти за період" onclick="fnClickTurnPeriod()" src="/Common/Images/book.gif">&nbsp;--%>
                        <IMG class="outset" id="btClientCard" title="Картка клієнта" onclick="fnClickClientCard()" src="/Common/Images/custpers.gif">&nbsp;</TD>
