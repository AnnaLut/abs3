...
public partial class DepositAgreementTemplate : Bars.BarsPage
{
	...
	private void Page_Load(object sender, System.EventArgs e)
	{
		...
		try
		{
			...
			_dbLogger.Info("Выбор шаблона для доп. соглашения тип=" + agr_id.ToString() + " по договору №" + dpt_id.ToString(),
				"SocialDeposit");
	...
	private void btForm_ServerClick(object sender, System.EventArgs e)
	{
		...
		_dbLogger.Info("Пользователь выбрал шаблон " + template_id +" для доп. соглашения тип=" + agr_id.ToString() + " по договору №" + dpt_id.ToString(),
			"SocialDeposit");
