    ...
    public partial class DocInputPage : BarsPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                __IS_NEED_CHECK_TT.Value = ConfigurationSettings.AppSettings["Module.Documents.PAYVERIF"];
        ...
        private void GetGlobalData()
        {
            ...
            try
            {
                ...
                + ((parSignMixedMode == "1") ? ("docsign.get_user_key_hash") : ("null")) + " USER_KEYHASH, "
                + "(select val from params where par='OKPO') BANK_OKPO "
                ...
                __USER_KEYHASH.Value = Convert.ToString(rdr["USER_KEYHASH"]);
