...
public partial class DepositClient : Bars.BarsPage
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request["info"] == null)
            {
                ...
                if (Request["scheme"] == "DELOITTE")
                {
                    ...
                    if (Request["rnk"] != null)
                    {
                        ...
                        EADocsView.RNK = Convert.ToInt64(Request["rnk"]); // отсечь хвост ММФО
            ...
            else // info
            {
                ...
                if (Request["scheme"] == "DELOITTE")
                {
                    ...
                    EADocsView.RNK = Convert.ToDecimal(Request["rnk"]); // отсечь хвост ММФО
                    EADocsView.Visible = true;
    ...
    private void InitEADControls(Decimal cust_id)
    {
        ...
        EADocsView.RNK = Convert.ToDecimal(rnkstr); // отсечь хвост ММФО
        EADocsView.Visible = true;
