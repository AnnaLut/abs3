...
function f_EnableEditCliet() {
    ...
    var rnd = Math.random();
    //var client_edit_window =   window.open('/barsroot/clientregister/registration.aspx?readonly=0&rnk=' + document.getElementById('textClientRnk').value, "Dialog", 'height: 600px, width: 650px');
    //client_edit_window.onunload = function () { location.reload(); };
    core$IframeBox({ url: "/barsroot/clientregister/registration.aspx?module=DPT&readonly=0&rnk=" + document.getElementById('textClientRnk').value, width: 850, height: 650, title: "Картка клієнта rnk=" + document.getElementById('textClientRnk').value, callback: "ReloadPage();" });
