    ...
    <div style="width: 100%">
        <table class="MainTable" width="100%">
                        ...
                        <table class="InnerTable" width="100%">
                            <tr>
                                <td align="center" style="width: 17%" rowspan="2">
                                    <asp:Button ID="btnClientCard" runat="server" Text="Картка Клієнта" class="AcceptButton"
            ...
            <tr>
                ...
                <td>
                    <Bars:BarsSqlDataSourceEx ID="dsDepositClosed" AllowPaging="true" PageSize="15"
                        ProviderName="barsroot.core" runat="server">
                    </Bars:BarsSqlDataSourceEx>
                </td>
            </tr>
        ...
        <ajax:TabContainer ID="TabMainContainer" runat="server" TabStripPlacement="Top" OnActiveTabChanged="MainTabChanged_Click" AutoPostBack ="true"
            ...
            <ajax:TabPanel ID="TabDeposit" HeaderText="Депозити" runat="server">
                <ContentTemplate>
                    <ajax:TabContainer ID="TabDepositContainer" runat="server" ActiveTabIndex="0" 
                        Width="99.5%" OnActiveTabChanged="DepositTabChanged_Click" AutoPostBack ="True"
                        Height="450px">
                                    ...
                                    <tr>
                                        <td colspan="2" valign="top">
                                            <Bars:BarsGridViewEx ID="gvDepositMain" DataSourceID="dsDepositMain" runat="server"
                                                ...
                                                JavascriptSelectionType="SingleRow" DataKeyNames="DPT_ID,DPT_LOCK,ARCHDOC_ID,WB"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="WB" Visible="false" />
                                                </Columns>
                                            </Bars:BarsGridViewEx>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2" valign="top">
                                            <Bars:BarsGridViewEx ID="gvDepositTrustee" CssClass="barsGridView" runat="server"
                                                ...
                                                ShowExportExcelButton="false" JavascriptSelectionType="SingleRow" DataKeyNames="DPT_ID,DPT_LOCK,ARCHDOC_ID,WB"
                                                OnRowDataBound="gv_RowDataBound">
                                                <Columns>
                                                    <asp:BoundField DataField="DPT_ID" Visible="false"></asp:BoundField>
                                                    <asp:BoundField HtmlEncode="False" DataField="DPT_NUM" SortExpression="DPT_NUM" HeaderText="№<BR>договору">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" style="width: 50%">
                                            <asp:Button ID="btnPayoutHeritage" runat="server" class="AcceptButton" Text="Виплата спадщини"
                                                OnClick="btnPayoutHeritage_Click" OnRowDataBound="gv_RowDataBound"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" valign="top">
                                            <Bars:BarsGridViewEx ID="gvHeritage" DataSourceID="dsDepositHeritor" runat="server"
                                                ...
                                                ShowCaption="False" JavascriptSelectionType="SingleRow" DataKeyNames="DPT_ID,DPT_LOCK,ARCHDOC_ID,DAT_END,INHERIT_SHARE,LCV,WB"
                                                OnRowDataBound="gv_RowDataBound">
                                                <Columns>
                                                    <asp:BoundField DataField="DPT_ID" Visible="false"></asp:BoundField>
                                    ...
                                    <tr>
                                        <td colspan="2" valign="top">
                                            <Bars:BarsGridViewEx ID="gvDepositBeneficiary" DataSourceID="dsDepositBeneficiary"
                                                ...
                                                DataKeyNames="DPT_ID,DPT_LOCK,ARCHDOC_ID,TRUSTEE_ID,KV,WB"
                                                OnRowDataBound="gv_RowDataBound">
                                                <Columns>
                                                    <asp:BoundField DataField="DPT_ID" Visible="false"></asp:BoundField>
                                                    <asp:BoundField HtmlEncode="False" DataField="DPT_NUM" SortExpression="DPT_NUM" HeaderText="№<BR>договору">
                                                    ...
                                                    <asp:BoundField DataField="TRUSTEE_ID" Visible="false" />
                                                     <asp:BoundField DataField="KV" Visible="true" />
                                                    <asp:BoundField DataField="WB" Visible="false" />
                                                </Columns>
                                            </Bars:BarsGridViewEx>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2" valign="top">
                                            <Bars:BarsGridViewEx ID="gvDepositChildren" CssClass="barsGridView" runat="server"
                                                DataSourceID="dsDepositChildren" Style="width: 100%" PageSize="15" AllowPaging="True" AutoGenerateColumns="False" ShowPageSizeBox="False" ShowCaption="False" JavascriptSelectionType="SingleRow" DataKeyNames="DPT_ID,DPT_LOCK,ARCHDOC_ID,RNK_M,RNK_C,WB"
                        ...
                        <ajax:TabPanel runat="server" ID="TabContractClosed" HeaderText="ЗАКРИТІ">
                            <ContentTemplate>
                                <table class="InnerTable" width="100%" cellpadding="3">
                                    <tr>
                                        <td align="left" style="width: 50%">
                                            <asp:Button ID="btSelectClosedContract" runat="server" class="AcceptButton" Text="Вибрати договір"
                                                OnClick="SelectContract_Click" />
                                        </td>
                                        <td align="right" style="width: 50%">
                                         </td>
                                    ...
                                    <tr>
                                        <td colspan="2" valign="top">
                                            <Bars:BarsGridViewEx ID="gvDepositClosed" DataSourceID="dsDepositClosed" runat="server"
                                                CssClass="barsGridView" Style="width: 100%" AllowPaging="True" PageSize="15"
                                                ShowPageSizeBox="false" AutoGenerateColumns="False" AllowSorting="true" ShowCaption="false"
                                                JavascriptSelectionType="SingleRow" DataKeyNames="DPT_ID,DPT_LOCK,ARCHDOC_ID,WB"
                                                OnRowDataBound="gv_RowDataBound">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td style="width:20%" align="center">
                                <asp:Label ID="Label1" runat="server" Text="Невідкличний депозит" BackColor="Brown" ForeColor="Bisque" Font-Bold="True" />
                            </td>
                            <td style="width:20%" align="center">
                             ...
                             <td style="width:20%" align="center">
                                <asp:Label ID="Label2" runat="server" Text="Договір відкритий в web-banking"
                                    BackColor="Green" Forecolor="Yellow" Font-Bold="True" />
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
