...
namespace Bars.Doc
{
    ...
    public class cDoc
    {
        ...
        public string KeyHash;      // хеш ключа на токене (для нового режима)
        ...
        public bool oDocument()
        {
            ...
            */
            ...
            // для корегуючих, якщо дата вадютування відключена на формі - дату валютування вираховуємо самі
            if (this.Vob == 96 && this.TTFlags.Substring(3, 1) == "0")
            {
                ...
                if (rdr.Read())
                {
                    ...
                    this.DatV1 = startDate;
                    this.DatV2 = startDate;
                }
            }
        ...
        public bool iDoc()
        {
            ...
            if (isSignMixedMode)
            {
                ...
                cmd.Parameters.Add("p_key_hash", OracleDbType.Varchar2, this.KeyHash, ParameterDirection.Input);
        ...
        public void PutVisa()
        {
            ...
            try
            {
                ...
                if (isSignMixedMode) // генерация подписи
                {
