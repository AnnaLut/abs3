    ...
    {      
        ...
        public static SetClient CreateCustomer(SetClient ClientReq, OracleConnection connect)
        {
            ...
            {               
                ...
                cmdSearchCustomer.Parameters.Add("p_trustregdat", OracleDbType.Date, XRMIntegrationUtl.GmtToLocal(checkClient.TrustRegDat), ParameterDirection.InputOutput);
                cmdSearchCustomer.Parameters.Add("p_bdate", OracleDbType.Date, XRMIntegrationUtl.GmtToLocal(checkClient.BDate), ParameterDirection.InputOutput);
                cmdSearchCustomer.Parameters.Add("p_edate", OracleDbType.Date, XRMIntegrationUtl.GmtToLocal(checkClient.EDate), ParameterDirection.InputOutput);
