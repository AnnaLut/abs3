...
namespace credit
{
    ...
    public class Common
    {
        ...
        private List<VWcsBidCreditdataGroupsRecord> _BidCreditdataGroups;
        ...
        public List<VWcsBidSurveyGroupsRecord> BidSurveyGroupsSurId
        {
            get
            {
                if (_BidSurveyGroups == null)
                {
                    _BidSurveyGroups = (new VWcsBidSurveyGroups(_con)).SelectBidSurveyGroupsSurId(_BID_ID, _SUR_ID);
                }

                return _BidSurveyGroups;
            }
        }
        public List<VWcsBidCreditdataGroupsRecord> BidCreditdataGroups
        {
            get
            {
                if (_BidCreditdataGroups == null)
                {
                    _BidCreditdataGroups = (new VWcsBidCreditdataGroups(_con)).SelectBidCreditdataGroups(_BID_ID);
                }

                return _BidCreditdataGroups;
            }
        }
        public List<VWcsBidCreditdataGroupsRecord> BidCreditdataGroupId
        {
            get
            {
                if (_BidCreditdataGroups == null)
                {
                    _BidCreditdataGroups = (new VWcsBidCreditdataGroups(_con)).SelectBidCreditdataGroupId(_BID_ID, _GRP_ID);
                }
        ...
        public Common(BbConnection con, Decimal? BID_ID, String SUR_ID)
        {
            _con = con;
            _BID_ID = BID_ID;
            _SUR_ID = SUR_ID;
