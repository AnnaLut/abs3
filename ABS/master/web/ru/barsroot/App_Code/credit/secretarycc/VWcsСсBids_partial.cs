...
namespace credit
{
    public partial class VWcsCcBids
    {
        public List<VWcsCcBidsRecord> SelectCcBids(String SRV_HIERARCHY, Decimal? BidId, String Inn, String Fio, String SortExpression, int maximumRows, int startRowIndex)
        {
