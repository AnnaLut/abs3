            ...
            try
            {
                ...
                using (OracleDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        credit.nKom = String.IsNullOrEmpty(reader.GetValue(23).ToString()) ? (decimal?)null : Convert.ToDecimal(reader.GetString(23).Replace(".", ","), ci);
                        ...
                        credit.S_SDI = String.IsNullOrEmpty(reader.GetValue(32).ToString()) ? (decimal?)null : Convert.ToDecimal(reader.GetString(32).Replace(".", ","), ci);
                        ...
                        credit.RANG = String.IsNullOrEmpty(reader.GetValue(41).ToString()) ? (decimal?)null : Convert.ToDecimal(reader.GetString(41).Replace(".", ","), ci);
                        ...
                        credit.SN8 = String.IsNullOrEmpty(reader.GetValue(46).ToString()) ? (decimal?)null : Convert.ToDecimal(reader.GetString(46).Replace(".", ","), ci);
                        credit.SK4 = String.IsNullOrEmpty(reader.GetValue(47).ToString()) ? (decimal?)null : reader.GetDecimal(47);
                        credit.I_CR9 = String.IsNullOrEmpty(reader.GetValue(48).ToString()) ? (decimal?)null : Convert.ToDecimal(reader.GetString(48).Replace(".", ","), ci);
            ...
            try
            {
                ...
                using (OracleDataReader readerTag = cmd.ExecuteReader())
                {
                    ...
                    while (readerTag.Read())
                    {
                        ...
                        val = String.IsNullOrEmpty(readerTag.GetValue(1).ToString()) ? (decimal?)null : Convert.ToDecimal(readerTag.GetString(1).Replace(".", ","), ci);
                        cmd.Parameters.Clear();
