...
{
    /// <summary>
    /// CurrencyBuyModel - Візування введених угод (покупка)
    /// </summary>
    public class CurrencyBuyModel
    {
        ...
        public string NLS_ACC0 { get; set; }
        public decimal? OSTC0 { get; set; }
        public string OKPO0 { get; set; }
        public string OKPOP { get; set; }
        public decimal? ACC1 { get; set; }
        public string NLS { get; set; }
        public decimal? KOM { get; set; }
        public decimal? SKOM { get; set; }
        public string MFOP { get; set; }
        public string NLSP { get; set; }
        public decimal? DIG { get; set; }
        public string META_AIM_NAME { get; set; }
        public string CONTRACT { get; set; }
        public DateTime? DAT2_VMD { get; set; }
        public DateTime? DAT_VMD { get; set; }
        public string DAT5_VMD { get; set; }
        public string COUNTRY_NAME { get; set; }
        public string BASIS_TXT { get; set; }
        public string NAME { get; set; }
        public string BANK_CODE { get; set; }
        public string BANK_NAME { get; set; }
        public string PRODUCT_GROUP_NAME { get; set; }
        public string NUM_VMD { get; set; }
        public decimal? VIZA { get; set; }
        public decimal? PRIORITY { get; set; }
        public string PRIORNAME { get; set; }
        public string COMM { get; set; }
        public decimal? COVER_ID { get; set; }
        public decimal? VERIFY_OPT { get; set; }
        public string IDENTKB { get; set; }
