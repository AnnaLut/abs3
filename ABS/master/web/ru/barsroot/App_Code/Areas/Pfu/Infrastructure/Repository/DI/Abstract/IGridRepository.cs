...
namespace BarsWeb.Areas.Pfu.Infrastructure.Repository.DI.Abstract
{
    ...
    public interface IGridRepository
    {
        ...
        List<PfuEppLine> GetEppLine(DataSourceRequest request, decimal kff, string bdate, string status);
        ...
        decimal GetStatusRows(decimal status, decimal kff, string bdate);
        ...
        void UnblockPensioner(IList<BlockPensioner> pensioners);
    }
