...
public class safe_deposit
{
    ...
    public void WriteToDataBase()
    {
        ...
        try
        {
            ...
            cmdCreateDeal.CommandText = "begin safe_deposit.DEAL (" +
                ...
                ":p_trustee_deal_num,:p_trustee_deal_start,:p_trustee_deal_end,:p_is_import,:p_rnk);end;";
            //cmdCreateDeal.BindByName = true;
            ...
            cmdCreateDeal.Parameters.Add("p_is_import", OracleDbType.Decimal, 0, ParameterDirection.Input);
            cmdCreateDeal.Parameters.Add("p_rnk", OracleDbType.Decimal, RNK, ParameterDirection.Input);
    ...
    public void Pay(Decimal n_sk, Decimal item, DateTime dat1, DateTime dat2, String numpar, Decimal? sum, String extnd)
    {
        OracleConnection connect = new OracleConnection();
        ...
        {              
            ...
            OracleCommand cmdSelectSafeType = connect.CreateCommand();
            cmdSelectSafeType.CommandType = CommandType.StoredProcedure;
            cmdSelectSafeType.BindByName = true;
           // cmdSelectSafeType.CommandText = "begin SKRN.P_DEP_SKRN( :DAT1,:DAT2, :N_SK , :item, :nExecNpar ); end;";
            cmdSelectSafeType.CommandText = "SKRN.P_DEP_SKRN";
           
            if (dat1 == DateTime.MinValue)
                cmdSelectSafeType.Parameters.Add("dat_", OracleDbType.Date, null, ParameterDirection.Input);
            else
                cmdSelectSafeType.Parameters.Add("dat_", OracleDbType.Date, dat1, ParameterDirection.Input);

            if (dat2 == DateTime.MinValue)
                cmdSelectSafeType.Parameters.Add("dat2_", OracleDbType.Date, null, ParameterDirection.Input);
            else
                cmdSelectSafeType.Parameters.Add("dat2_", OracleDbType.Date, dat2, ParameterDirection.Input);

            cmdSelectSafeType.Parameters.Add("n_sk_", OracleDbType.Decimal, n_sk, ParameterDirection.Input);
            cmdSelectSafeType.Parameters.Add("mode_", OracleDbType.Decimal, item, ParameterDirection.Input);
            
            if (String.IsNullOrEmpty(numpar))
                cmdSelectSafeType.Parameters.Add("par_", OracleDbType.Decimal, null, ParameterDirection.Input);
            else
                cmdSelectSafeType.Parameters.Add("par_", OracleDbType.Decimal, numpar, ParameterDirection.Input);

            cmdSelectSafeType.Parameters.Add("p_userid", OracleDbType.Decimal, null, ParameterDirection.Input);

            cmdSelectSafeType.Parameters.Add("p_sum", OracleDbType.Decimal, sum.HasValue ? sum : 0   , ParameterDirection.Input);

            cmdSelectSafeType.Parameters.Add("p_extnd", OracleDbType.Varchar2, 30, extnd, ParameterDirection.Input);
