...
<head>
    ...
    <script type="text/javascript" src="JScriptForregistration.js?v=<%= barsroot.ServicesClass.GetVersionWeb() %>.t023"></script>
    <script type="text/javascript" src="InitService.js"></script>
    <script type="text/javascript" src="KendoCommon.js"></script>
...
<body onload="FullInit(); InitObjects(); InitTabs();">    
    <div id="realPhotoWin" style="display:none">
        <table>
            <tr>
                <td style="border: 5px solid"><img id="kkPhoto_WEB" runat="server" src="/Common/Images/empty_image.png" alt="" /></td>
                <td style="border: 5px solid"><img id="kkPhoto_JPG" runat="server" src="/Common/Images/empty_image.png" alt="" /></td>
                <td style="border: 5px solid"><img id="kkPhoto_PHOTO" runat="server" src="/Common/Images/empty_image.png" alt="" /></td>
            </tr>
            <tr>
