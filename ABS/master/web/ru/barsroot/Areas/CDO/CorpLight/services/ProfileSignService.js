...
angular.module(globalSettings.modulesAreas)
    .factory('CDO.CorpLight.ProfileSignService',
        ['$http', '$q',
        function ($http, $q) {
            ...
            var _getProfileSignBuffer = function (relCustId) {
                ...
                $http.get(bars.config.urlContent('/api/cdo/CorpLight/ProfileSign/signBuffer/') + relCustId)
            ...
            var _setProfileSign = function (relCustId, visaId, signedData) {
                ...
                var deferred = $q.defer();
                $http.post(bars.config.urlContent('/api/cdo/CorpLight/ProfileSign/'), signObject)
                    .success(function (response) {
                        state.isLoading = false;
                        deferred.resolve(response);
                    }).error(function (response) {
