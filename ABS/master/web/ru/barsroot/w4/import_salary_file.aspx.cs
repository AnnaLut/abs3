...
public partial class w4_import_salary_file : Bars.BarsPage
{
    ...
    protected void odsInstantData_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
    {
        ...
        e.InputParameters["COUNT"] = lbInstantCount.Text;
    }
    ...
    protected void BRANCH_ValueChanged(object sender, EventArgs e)
    {
        if (!String.IsNullOrEmpty(BRANCH.Value))
        {
            ...
            STAFF.WHERE_CLAUSE = String.Format("WHERE BRANCH = '{0}' AND ACTIVE = 1", BRANCH.Value);
        }
        else
        {
 ...
 protected void btnAddCardNumFilter_Click(object sender, EventArgs e)
    { 
        lstbxCardNumsList.Items.Add(new ListItem(txbxCardNumber.Text)); 
    }
    ...
    protected void btnDelCardNumsListItem_Click(object sender, EventArgs e)
    {
        List<ListItem> itemsToRemove = new List<ListItem>();
        foreach (ListItem listItem in lstbxCardNumsList.Items)
        {
        ...
        {
            lstbxCardNumsList.Items.Remove(listItem);
        }
    }
}