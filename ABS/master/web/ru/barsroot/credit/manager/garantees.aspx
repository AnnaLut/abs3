        ...
        <tr>
            <td id="tdContainer" runat="server">
                ...
                <div class="formViewContainer">
                    ...
                    <Bars:BarsSqlDataSourceEx ID="sds" runat="server" ProviderName="barsroot.core" SelectCommand="select g.* from wcs_garantees g, wcs_subproduct_garantees sg, wcs_bids b where g.id = sg.garantee_id and sg.subproduct_id = b.subproduct_id and g.id = (case when wcs_utl.has_bid_state(b.id,'NEW_FT_DATAINPUT') = 1 then 'GUARANTOR' else g.id end) and b.id = :BID_ID"
