...
public partial class cim_reports_default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dsReports.SelectCommand = "select report_id, name, proc, template, file_type, file_name from cim_reports_list " + ((Session[Constants.StateKeys.AccessFlag] == "1")? (" where use_in_tvbv=1"):("")) + " order by 1";
