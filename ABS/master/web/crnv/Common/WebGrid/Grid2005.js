...
{
   var add = "&"+Math.random(); 
   var result = window.showModalDialog("/barsroot/webservices/filter.aspx?table="+v_FilterTable+add,window,"dialogWidth:615px;dialogHeight:480px;center:yes;edge:sunken;help:no;status:no;scroll:no");
   var str = "";
   if(result != null){
