...
function barsUiAlert(text, winName, winType) {
    ...
    alert.dialog({bgiframe:true, dialogClass: '', buttons: [{ text: 'ok!', click: function () { $('#barsUiAlertDialog').dialog('close'); } }], autoOpen: true, position: 'center', title: winName, modal: true, resizable: false, minWidth: '400', minHeight: '150', close: function () { $('#barsUiAlertDialog').remove(); } });
    var img='';
    switch (winType) {
        case 'error':
