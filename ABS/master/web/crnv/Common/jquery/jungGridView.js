(function ($) {
    ...
    function addPreload(elem) {
        ...
        elem.append('<div class="divPreloader" style="top:' + ((h / 2) - 20) + 'px;"><div class="overlay" style="top:-' + ((h / 2) - 20) + 'px;height:' + (h) + 'px;width:' + w + 'px"></div><div class="loading"><div id="lbStatus">Завантаження...</div><div id="lbImgLoading"></div></div></div>');
    }
    function removePreload(elem) { elem.find('.divPreloader').remove(); }
    ...
    var methods = {
        init: function (options) {
            ...
            var make = function () {
                ...
                elem.find('thead tr th div').click(function () {
                    var $this = $(this);
