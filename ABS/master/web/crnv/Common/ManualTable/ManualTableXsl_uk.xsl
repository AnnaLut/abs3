...
<TD width="297px" title="Опис"><xsl:attribute name="onclick"><xsl:text>Sort('NAME')</xsl:text></xsl:attribute>
<xsl:text>Опис</xsl:text></TD>
</TR>
...
<TD align="left" title="Выбрати" style="CURSOR: hand; COLOR: blue; TEXT-DECORATION: underline"><xsl:value-of select="ID" /></TD>
