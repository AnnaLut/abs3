...
<asp:Content ID="contents_body" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <bars:BarsSqlDataSourceEx runat="server" ID="dsCountries" ProviderName="barsroot.core"
        SelectCommand="select country, name from country union all select null, null from dual order by name">
    ...
    <div style="overflow: auto; padding: 10px 0 10px 0">
        ...
        <div style="padding-left: 10px;">
            <asp:Button runat="server" ID="btAddNew" Text="Добавити" OnClick="btAddNew_Click" />
        </div>
        <bars:BarsGridViewEx ID="gvVCimBeneficiaries" runat="server" AutoGenerateColumns="false"
