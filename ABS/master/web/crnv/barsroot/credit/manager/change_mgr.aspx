<%@ Page Language="C#" MasterPageFile="~/credit/manager/master.master" AutoEventWireup="true"
    CodeFile="change_mgr.aspx.cs" Inherits="credit_manager_change_mgr" Title="Переназначение менеджера заявки"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <table border="0" cellpadding="3" cellspacing="0">
                ...
                <td style="padding: 10px">
                    <table border="0" cellpadding="3" cellspacing="0">
                        <tr valign="top">
                            <td>
                                <asp:Panel ID="pnlBid" runat="server" GroupingText="Дані про заявку" 
                                    ...
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="InnTitle" runat="server" Text="Идентификационный код клиента :" 
                                                    meta:resourcekey="InnTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="FioTitle" runat="server" Text="ФИО клиента (маска %) :" 
                                                    meta:resourcekey="FioTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                            ...
                            <td>
                                <asp:Panel ID="pnlMgr" runat="server" GroupingText="Дані менеджера" 
                                    meta:resourcekey="pnlMgrResource1">
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:Label ID="BranchTitle" runat="server" Text="Код отделения :" 
                                                    meta:resourcekey="BranchTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:ObjectDataSource ID="odsOurBranch" runat="server" SelectMethod="Select" TypeName="credit.OurBranch">
                                                </asp:ObjectDataSource>
                                                <bec:DDLList ID="Branch" runat="server" DataSourceID="odsOurBranch" DataTextField="BRANCH"
                                                    DataValueField="BRANCH" IsRequired="false" Width="200" ValidationGroup="Search" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="MgrIDTitle" runat="server" Text="Ид. менеджера :" 
                                                    meta:resourcekey="MgrIDTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                                <bec:TextBoxNumb ID="MgrID" runat="server" IsRequired="False" ValidationGroup="Search" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="MgrFioTitle" runat="server" Text="ФИО менеджера (маска %) :" 
                                                    meta:resourcekey="MgrFioTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                                <bec:TextBoxString ID="MgrFio" runat="server" IsRequired="False" ValidationGroup="Search"
                                                    Width="200" />
                                            </td>
                                        </tr>
                                    </table>
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectMgrChangeBids"
                        TypeName="credit.VWcsMgrChangeBids" SortParameterName="SortExpression" 
                        ...
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="Branch" Name="Branch" PropertyName="SelectedValue"
                                Type="String" />
                            <asp:ControlParameter ControlID="MgrID" Name="MgrID" PropertyName="Value" Type="Decimal" />
                            <asp:ControlParameter ControlID="MgrFio" Name="MgrFio" PropertyName="Value" Type="String" />
                        </SelectParameters>
                    </asp:ObjectDataSource>
                    <Bars:BarsGridViewEx ID="gv" runat="server" AutoGenerateColumns="False" CaptionText=""
                        ...
                        <Columns>
                            <asp:TemplateField meta:resourcekey="TemplateFieldResource1">
                                ...
                                <HeaderTemplate>
                                    <asp:CheckBox ID="cbAll" runat="server" AutoPostBack="True" 
                                        OnCheckedChanged="cbAll_CheckedChanged" meta:resourcekey="cbAllResource1" />
                                </HeaderTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="BID_ID" HeaderText="№ заявки" 
                                SortExpression="BID_ID" meta:resourcekey="BoundFieldResource1">
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="INN" HeaderText="Ідент. код клієнта" 
                                SortExpression="INN" meta:resourcekey="BoundFieldResource4" />
                            ...
                            <asp:BoundField DataField="GARANTEES" HeaderText="Забезпечення" 
                                SortExpression="GARANTEES" meta:resourcekey="BoundFieldResource7">
                            </asp:BoundField>
                            <asp:BoundField DataField="MGR_FIO" HeaderText="ПІБ менеджера" 
                                SortExpression="MGR_FIO" meta:resourcekey="BoundFieldResource8" />
            ...
            <tr>
                <td class="sectionTitle">
                    <asp:Label ID="ChangeTitle" runat="server" Text="Переназначение" 
                        meta:resourcekey="ChangeTitleResource1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="padding: 10px">
                        ...
                        <tr valign="top">
                            <td>
                                ...
                                <Bars:BarsGridViewEx ID="gvStaff" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    ShowExportExcelButton="True" ShowFilter="True" ShowCaption="False" 
                                    ShowPageSizeBox="False" meta:resourcekey="gvStaffResource1">
                                    <NewRowStyle CssClass=""></NewRowStyle>
                                    <AlternatingRowStyle CssClass="alternateRow"></AlternatingRowStyle>
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="LOGNAME" HeaderText="Логин" SortExpression="LOGNAME" 
                                            meta:resourcekey="BoundFieldResource12">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="BRANCH" HeaderText="Отделение" 
                                            SortExpression="BRANCH" meta:resourcekey="BoundFieldResource13">
                                        </asp:BoundField>
                                    </Columns>
                                    <EditRowStyle CssClass="editRow"></EditRowStyle>
                                    <FooterStyle CssClass="footerRow"></FooterStyle>
                        ...
                        <tr>
                            <td align="right" colspan="3">
                                <asp:Button ID="btChange" runat="server" Text="Переназначить" ToolTip="Переназначить на выбраного пользователя"
                                    SkinID="sButton" OnClick="btChange_Click" ValidationGroup="Change" 
                                    meta:resourcekey="btChangeResource1" />
                            </td>
                        </tr>
                    </table>
                </td>
