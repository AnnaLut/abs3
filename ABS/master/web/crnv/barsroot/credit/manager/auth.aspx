        ...
        <table class="dataTable">
            <tr>
                <td style="padding-right: 30px">
                    <bec:ByteImage ID="imgSc" runat="server" Width="500px" Height="300px" ToolTip="Связная сканкопия"
                        ImageUrl="/Common/Images/empty_image.png" ShowView="true" ShowLabel="true" />
                </td>
