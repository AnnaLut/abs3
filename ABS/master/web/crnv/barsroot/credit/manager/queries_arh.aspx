<%@ Page Language="C#" MasterPageFile="~/credit/manager/master.master" AutoEventWireup="true"
    CodeFile="queries_arh.aspx.cs" Inherits="credit_manager_queries_arh" Title="Архив заявок ({0})"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <table border="0" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td style="padding: 10px">
                    <table border="0" cellpadding="3" cellspacing="0">
                        <tr valign="top">
                            <td>
                                <asp:Panel ID="pnlPersonal" runat="server" GroupingText="Персональні дані" 
                                    meta:resourcekey="pnlPersonalResource1">
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalInnTitle" runat="server" 
                                                    Text="Идентификационный код клиента :" 
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalFioTitle" runat="server" Text="ФИО клиента (маска %) :" 
                                                    meta:resourcekey="PersonalFioTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalBDayTitle" runat="server" Text="Дата рождения клиента :" 
                                                    meta:resourcekey="PersonalBDayTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalWorkInnTitle" runat="server" 
                                                    Text="ЄДРПОУ работодателя :" meta:resourcekey="PersonalWorkInnTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalWorkNameTitle" runat="server" 
                                                    Text="Наименование работодателя :" 
                            ...
                            <td>
                                <asp:Panel ID="pnlCredit" runat="server" GroupingText="Дані кредиту" 
                                    meta:resourcekey="pnlCreditResource1">
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditSubproductTitle" runat="server" Text="Субпродукт :" 
                                                    meta:resourcekey="CreditSubproductTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditPropertyCostTitle" runat="server" 
                                                    Text="Сотимость товара :" meta:resourcekey="CreditPropertyCostTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditOwmFoundsTitle" runat="server" 
                                                    Text="Сумма собственных средств :" 
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditSumTitle" runat="server" Text="Сумма кредита :" 
                                                    meta:resourcekey="CreditSumTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditTermTitle" runat="server" Text="Срок кредита :" 
                                                    meta:resourcekey="CreditTermTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditGuaranteeTitle" runat="server" Text="Обеспечение :" 
                                                    meta:resourcekey="CreditGuaranteeTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                                ...
                                                <asp:ListBox ID="CreditGuarantee" runat="server" Rows="3" SelectionMode="Multiple"
                                                    ...
                                                    DataValueField="GARANTEE_ID" Width="200px" AppendDataBoundItems="True" 
                                                    meta:resourcekey="CreditGuaranteeResource1">
                            ...
                            <td>
                                <asp:Panel ID="pnlBid" runat="server" GroupingText="Дані про заявку" 
                                    meta:resourcekey="pnlBidResource1">
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:Label ID="BidIdTitle" runat="server" Text="№ заявки :" 
                                                    meta:resourcekey="BidIdTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="BidDateTitle" runat="server" Text="Дата создания заявки :" 
                                                    meta:resourcekey="BidDateTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                                <table border="0" cellpadding="1" cellspacing="0">
                                                    <tr>
                                                        <td style="white-space: nowrap">
                                                            <asp:Label ID="BidDateTitleFrom" runat="server" Width="30px" Text="c : " 
                                                                meta:resourcekey="BidDateTitleFromResource1"></asp:Label>
                                                            <bec:TextBoxDate ID="BidDateFrom" runat="server" IsRequired="False" ValidationGroup="Search" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="white-space: nowrap">
                                                            <asp:Label ID="BidDateTitleTo" runat="server" Width="30px" Text="до : " 
                                                                meta:resourcekey="BidDateTitleToResource1"></asp:Label>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="BidStateTitle" runat="server" Text="Статус заявки :" 
                                                    meta:resourcekey="BidStateTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalBranchTitle" runat="server" Text="Код отделения :" 
                                                    meta:resourcekey="PersonalBranchTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalMgrFioTitle" runat="server" 
                                                    Text="ФИО менеджера (маска %) :" 
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectMgrBidsArchive"
                        TypeName="credit.VWcsMgrBidsArchive" SortParameterName="SortExpression" 
                        EnablePaging="True">
                        <SelectParameters>
                    ...
                    <Bars:BarsGridViewEx ID="gv" runat="server" AutoGenerateColumns="False" CaptionText=""
                        ...
                        <Columns>
                            <asp:HyperLinkField DataNavigateUrlFields="BID_ID" DataNavigateUrlFormatString="/barsroot/credit/manager/bid_card_arh.aspx?bid_id={0}"
