<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="queries_arh.aspx.cs" Inherits="credit_adm_queries_arh" Title="Повернення заявки ({0})"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        ...
        <table border="0" cellpadding="3" cellspacing="0">
                    ...
                    <table border="0" cellpadding="3" cellspacing="0">
                            ...
                            <td>
                                <asp:Panel ID="pnlBid" runat="server" GroupingText="Дані про заявку" meta:resourcekey="pnlBidResource1">
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="BidDateTitle" runat="server" Text="Дата створення заявки :" meta:resourcekey="BidDateTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                                <table border="0" cellpadding="1" cellspacing="0">
                                                    <tr>
                                                        <td style="white-space: nowrap">
                                                            <asp:Label ID="BidDateTitleFrom" runat="server" Width="30px" Text="з : " meta:resourcekey="BidDateTitleFromResource1"></asp:Label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:ListBox ID="BidState" runat="server" Rows="3" SelectionMode="Multiple" ValidationGroup="Search"
                                                    ...
                                                    <asp:ListItem Value="ERR" meta:resourcekey="ListItemResource6" Selected="true">Системна помилка</asp:ListItem>
                                                    <asp:ListItem Value="ALL" meta:resourcekey="ListItemResource2">Всі</asp:ListItem>
                                                    <asp:ListItem Value="PROC" meta:resourcekey="ListItemResource3">Обробка</asp:ListItem>
                                                    <asp:ListItem Value="DONE" meta:resourcekey="ListItemResource4">Видано</asp:ListItem>
                                                    <asp:ListItem Value="DENY" meta:resourcekey="ListItemResource5">Відказано</asp:ListItem>
                                                </asp:ListBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalBranchTitle" runat="server" Text="Код підрозділу :" meta:resourcekey="PersonalBranchTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalMgrFioTitle" runat="server" Text="ПІБ менеджера (маска %) :"
                            ...
                            <td>
                                <asp:Panel ID="pnlPersonal" runat="server" GroupingText="Персональні дані" meta:resourcekey="pnlPersonalResource1">
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalInnTitle" runat="server" Text="Ідентифікаційний код клієнта :"
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalFioTitle" runat="server" Text="ПІБ клієнта (маска %) :" meta:resourcekey="PersonalFioTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalBDayTitle" runat="server" Text="Дата народження клієнта :" meta:resourcekey="PersonalBDayTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalWorkInnTitle" runat="server" Text="ЄДРПОУ роботодавця :"
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="PersonalWorkNameTitle" runat="server" Text="Найменування роботодавця :"
                            ...
                            <td>
                                <asp:Panel ID="pnlCredit" runat="server" GroupingText="Дані кредиту" meta:resourcekey="pnlCreditResource1">
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditPropertyCostTitle" runat="server" Text="Вартість товара :"
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditOwmFoundsTitle" runat="server" Text="Сума власних коштів :"
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditSumTitle" runat="server" Text="Сума кредита :" meta:resourcekey="CreditSumTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CreditGuaranteeTitle" runat="server" Text="Забезпечення :" meta:resourcekey="CreditGuaranteeTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                            ...
                            <td>
                                <asp:Panel ID="pnlProc" runat="server" GroupingText="Дані про обробку" meta:resourcekey="pnlProcResource1">
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CHECK_BRANCHTitle" runat="server" Text="Код підрозділу :" meta:resourcekey="CHECK_BRANCHTitleResource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CHECK_USER_FIOTitle" runat="server" Text="ПІБ співробітника (маска %) :"
                        ...
                        <tr>
                            <td align="right" colspan="4">
                                <asp:Button ID="btSearch" runat="server" Text="Застосувати" SkinID="bSearch" OnClick="btSearch_Click"
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectAdmBids"
                        TypeName="credit.VWcsAdmBids" SortParameterName="SortExpression" EnablePaging="True"
                    ...
                    <Bars:BarsGridViewEx ID="gv" runat="server" AutoGenerateColumns="False" CaptionText=""
                        ...
                        <Columns>
                            <asp:HyperLinkField DataNavigateUrlFields="BID_ID" DataNavigateUrlFormatString="/barsroot/credit/admin/bid_card.aspx?bid_id={0}"
