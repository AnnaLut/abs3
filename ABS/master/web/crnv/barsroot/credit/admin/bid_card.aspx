                            ...
                            <tr>
                                <td>
                                    <asp:RadioButtonList ID="RadioButton" runat="server">
                                        ...
                                        <asp:ListItem Text="Кредитна служба ТВБВ"></asp:ListItem>
                                        <asp:ListItem Text="Аналіз розгляду службами ТВБВ"></asp:ListItem>
                                        <asp:ListItem Text="Аналіз рішення кредитного комітету ТВБВ"></asp:ListItem>
