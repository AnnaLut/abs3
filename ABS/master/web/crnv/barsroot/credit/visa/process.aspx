<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="process.aspx.cs" Inherits="credit_visa_process" Title="Обработка заявки №{0}"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <Bars:BarsObjectDataSource ID="ods" runat="server" SelectMethod="SelectVisaBidInfoqueries"
            TypeName="credit.VWcsVisaBidInfoqueries">
            <SelectParameters>
    ...
    <div class="formViewContainer">
        <asp:ObjectDataSource ID="odsFV" runat="server" SelectMethod="SelectVisaBidInfoquery"
            TypeName="credit.VWcsVisaBidInfoqueries">
            <SelectParameters>
                <asp:QueryStringParameter Name="BID_ID" QueryStringField="bid_id" Type="Decimal" />
                <asp:QueryStringParameter QueryStringField="srvhr" Name="SRV_HIERARCHY" Type="String" />
                ...
                <table border="0" cellpadding="3" cellspacing="0" class="contentTable">
                    ...
                    <tr>
                        <td style="padding-top: 20px" class="actionButtonsContainer">
                            <asp:Button ID="bFinish" OnClientClick="if (!confirm('Ви впевнені в правильності Вашого вибору?')) return false;"
                                SkinID="bNext" runat="server" Text="Далее" CommandName="Finish" meta:resourcekey="bFinishResource1" />
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
