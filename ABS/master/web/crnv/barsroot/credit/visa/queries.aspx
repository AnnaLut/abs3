<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="queries.aspx.cs" Inherits="credit_visa_queries" Title="Обробка заявок"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <table border="0" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectVisaBids" TypeName="credit.VWcsVisaBids"
                    ...
                    <Bars:BarsGridViewEx ID="gv" runat="server" AutoGenerateColumns="False" CaptionText=""
                        ...
                        <Columns>
                            <asp:HyperLinkField DataNavigateUrlFields="SRV_HIERARCHY,BID_ID" DataNavigateUrlFormatString="/barsroot/credit/visa/bid_card.aspx?srvhr={0}&bid_id={1}"
