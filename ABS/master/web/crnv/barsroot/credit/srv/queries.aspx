<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="queries.aspx.cs" Inherits="credit_srv_queries" Title="Обробка заявок"
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <table border="0" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SelectSrvBids" TypeName="credit.VWcsSrvBids"
                        SortParameterName="SortExpression" EnablePaging="True">
                        <SelectParameters>
                            <asp:QueryStringParameter QueryStringField="srv" Name="SRV" Type="String" />
                    ...
                    <Bars:BarsGridViewEx ID="gv" runat="server" AutoGenerateColumns="False" CaptionText=""
                        ...
                        <Columns>
                            <asp:HyperLinkField DataNavigateUrlFields="SRV,SRV_HIERARCHY,BID_ID" DataNavigateUrlFormatString="/barsroot/credit/srv/bid_card.aspx?srv={0}&srvhr={1}&bid_id={2}"
