<%@ Page Language="C#" MasterPageFile="~/credit/master.master" AutoEventWireup="true"
    CodeFile="process.aspx.cs" Inherits="credit_srv_process" Title="Обработка заявки №{0}"
    Theme="default" Trace="false" MaintainScrollPositionOnPostback="false" meta:resourcekey="PageResource1" %>
...
<%@ Register Src="../usercontrols/TextBoxXML.ascx" TagName="TextBoxXML" TagPrefix="bec" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="dataContainer">
        <Bars:BarsObjectDataSource ID="ods" runat="server" SelectMethod="SelectSrvBidInfoqueries"
            TypeName="credit.VWcsSrvBidInfoqueries">
            <SelectParameters>
    ...
    <div class="formViewContainer">
        <asp:ObjectDataSource ID="odsFV" runat="server" SelectMethod="SelectSrvBidInfoquery"
            TypeName="credit.VWcsSrvBidInfoqueries">
            <SelectParameters>
                <asp:QueryStringParameter QueryStringField="srv" Name="SRV" Type="String" />
                <asp:QueryStringParameter QueryStringField="srvhr" Name="SRV_HIERARCHY" Type="String" />
