	...
	<body onload="FOCUS();">
		<form id="Form1" method="post" runat="server">
			<table class="MainTable">
				<tr>
					<td align="center" colspan="2"><asp:label id="lbTitle" meta:resourcekey="lbTitle6" runat="server" CssClass="InfoLabel">Печать доп.соглашения</asp:label></td>
				</tr>
				<tr>
					<td colspan="2"></td>
				</tr>
				...
				<tr>
					<td><asp:label id="Label1" meta:resourcekey="Label1_4" runat="server" CssClass="InfoText">Дата заключения</asp:label></td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" CssClass="InfoText" Text="Термін дії довіреності (лише для додаткових угод про довіреність)"></asp:Label></td>
                    <td>
                        <table class="InnerTable">
                            <tr>
                                <td style="width:10%"><asp:Label ID="Label3" runat="server" CssClass="InfoText" Text="з"></asp:Label></td>
                                <td style="width:20%">
                                    <cc1:DateEdit ID="dtBegin" runat="server"></cc1:DateEdit>
                                </td>
                                <td style="width:10%"></td>
                                <td style="width:10%"><asp:Label ID="Label4" runat="server" CssClass="InfoText" Text="по"></asp:Label></td>
                                <td style="width:50%">
				...
				<tr>
					...
					<td><input id="textAgrId" type="hidden" runat="server"/> <input id="textAgrNum" type="hidden" runat="server"/>
						<input id="template" type="hidden" runat="server"/><input id="dpt_id" type="hidden" runat="server"/>
				...
				<tr>
					<td><asp:button id="btForm" meta:resourcekey="btForm2" tabIndex="1" runat="server" Text="Формировать текст" CssClass="AcceptButton"></asp:button></td>
					<td><input class="AcceptButton" id="btPrint" meta:resourcekey="btPrint" disabled tabIndex="2" type="button" value="Печать"
							runat="server"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td></td>
					<td><asp:button id="btNextAgr" meta:resourcekey="btNextAgr" tabIndex="3" runat="server" Text="Следующее" Visible="False" ToolTip="Следующее доп. соглашение на текущий договор"
							CssClass="AcceptButton"></asp:button></td>
				</tr>
			</table>
