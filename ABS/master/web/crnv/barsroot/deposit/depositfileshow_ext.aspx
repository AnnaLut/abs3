<%@ Page language="c#" CodeFile="depositfileshow_ext.aspx.cs" AutoEventWireup="true" Inherits="DepositFileShow" %>
				...
				<tr>
					<td>
                                ...
                                <asp:TemplateField HeaderText="*">
                                    <itemtemplate>
                                        <asp:ImageButton id="imgOpen" runat="server" ImageUrl="\Common\Images\default\16\open.png"
                                            onclientclick=<%# "GetFileExt('" + Eval("FILENAME") + "','" + Eval("FDAT") + "','" + Eval("HEADER_ID") + "');return false;"%> ></asp:ImageButton> 
                                    </itemtemplate>
                                </asp:TemplateField>
                        ...
                        <Bars:BarsSqlDataSourceEx ProviderName="barsroot.core" id="dsFiles" runat="server" 
                            SelectCommand="SELECT FILENAME,DAT,INFO_LENGTH,to_char(SUM/100,'9999999999999999990.99') SUM, NAZN, HEADER_ID, to_char(DAT,'dd/mm/yyyy') FDAT, 1,BRANCH FROM DPT_FILE_HEADER WHERE BRANCH like sys_context('bars_context','user_branch_mask') and file_version = '2' ORDER BY header_id desc, DAT DESC, FILENAME DESC"
                        >                            
				...
				<tr>
					<td>
					    <table class="InnerTable">
					        <tr>
					            <td style="width:25%">
					                <input id="btImport" runat="server" meta:resourcekey="btNewFile" class="AcceptButton" type="button" value="Принять новый файл" onclick="location.replace(document.getElementById('redir_uri').value);"/></td>
					            <td style="width:25%">
					                <input id="btCreate" runat="server" meta:resourcekey="btCreate" class="AcceptButton" type="button" value="Создать новый файл" onclick="location.replace(document.getElementById('redir_uri_create').value);" visible="true"/></td>
					            <td style="width:25%">
					        ...
					        <tr>
					            <td>
					                ...
					                <input type="hidden" runat="server" id="redir_uri" />
					                <input type="hidden" runat="server" id="redir_uri_create" />
					                <input type="hidden" runat="server" id="redir_uri_add" />
					            </td>
					            <td></td>
					            <td></td>
					        </tr>					        
