...
<body>
    ...
    <table class="MainTable">
        <tr>
            <td align="center">
                &nbsp;<asp:Label ID="lbTitle" runat="server" CssClass="InfoLabel" meta:resourcekey="lbTitle"
                    Text="Права на спадок  по депозиту № %s"></asp:Label></td>            
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td><input id="btFinish" runat="server" class="AcceptButton" size="" type="button"
            ...
            <td>
                <table class="InnerTable">
                    <tr>
                        ...
                        <td style="width:40%"><input id="btClose" runat="server" class="AcceptButton" size="" type="button"
                                value="Дострокове розторгнення" onclick="InheritClose()" disabled="disabled" tabindex="5" /></td>
                    </tr>
                </table>
            </td>
        </tr>
