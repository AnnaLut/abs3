												    ...
												    <table class="InnerTable">
												        <tr>
												            <td align="right" style="width:1%">
                                                                <img id="btSaveComment" style="cursor:hand" src="\Common\Images\SAVE.gif" onclick="SaveComment()" /></td>
												            <td style="width:100%">
											...
											<tr>
												<td>
													<table class="InnerTable" id="ButtonTable">
														...
														<tr>
															<td>
															    <asp:Button ID="btShowClient" runat="server" CssClass="AcceptButton" 
                                                                    onclientclick="showClientExt();" Text="Картка клієнта" />
                                                            </td>
															<td></td>
															<td></td>
															<td>
