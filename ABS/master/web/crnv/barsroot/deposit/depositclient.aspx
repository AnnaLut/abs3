...
<%@ Page language="c#" CodeFile="DepositClient.aspx.cs" AutoEventWireup="true" Inherits="DepositClient" enableViewState="True" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		...
		function AfterPageLoad() {
		    if (document.getElementById('textClientTerritory') != null) {
					...
					<td>
						<table class="InnerTable">
                            <tr>
                                <td colspan="5">
									<input id="btSearch" meta:resourcekey="btSearch3" onclick="openDialog(this.form)" type="button" value="Поиск" runat="server"
										tabindex="102" class="DirectionButton"/>
                                </td>
                            </tr>
                            <tr>
                                <td width="5%">
							...
							<tr>
								...
								<td width="35%">
									<input id="textClientName" readonly="readonly" type="text" maxlength="70" 
                                    runat="server" title="ФИО" class="InfoText"/>
								</td>
								<td width="10%"></td>
								<td width="20%">
									...
									<div class="mn" id="full_name">
										<table class="InnerTable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input id="textFIOGenitive" tabindex="4" type="text" maxlength="70" runat="server" class="InfoText"/>
                                                </td>
                                                <td>
                                                </td>
                                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:label id="lbVTerritory" runat="server" CssClass="InfoText" ForeColor="Red" Visible="False">*</asp:label>
                                </td>
                                <td>
                                    <asp:label id="lbClientTerritory" meta:resourcekey="lbClientTerritory" 
                                        runat="server" CssClass="InfoText" Visible="False">Код території (для УПБ)</asp:label>
                                </td>
                                <td>
                                    <asp:textbox id="textClientTerritory" meta:resourcekey="textClientTerritory" 
                                        ToolTip="Код території" runat="server"  CssClass="InfoText" Visible="False"></asp:textbox>
                                </td>
                                <td>
                                	<input id="btTerritory" onclick="showTerritory()" tabindex="7" type="button" value="?"
										runat="server" class="ImgButton" title="Вибрати код території" visible="False"/>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="validatorTextClientTerritory" runat="server" ControlToValidate="textClientTerritory"
                                        CssClass="InfoText" ErrorMessage="необходимо заполнить" 
                                        meta:resourcekey="NeedToFill" Enabled="False"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
							<tr>
								<td></td>
								...
								<td>
									<asp:textbox id="textClientIndex" meta:resourcekey="textClientIndex" onkeydown="doNum();"  MaxLength="5" runat="server" ToolTip="Индекс"
										tabIndex="8" onblur="doValueCheck('textClientIndex');CopyAddress('textClientIndex','textFactIndex');" CssClass="InfoText"></asp:textbox>
								</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								...
								<td style="white-space:nowrap">
                                    ...
                                    <asp:textbox ID="textClientRegion" meta:resourcekey="textClientRegion" runat="server" MaxLength="35" ToolTip="Область"
									tabIndex="9" CssClass="InfoText80" onblur="CopyAddress('textClientRegion','textFactRegion','preClientRegion');"></asp:textbox>
								</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								...
								<td style="white-space:nowrap">
                                    ...
                                    <asp:textbox ID="textClientDistrict" meta:resourcekey="textClientDistrict" runat="server" MaxLength="35" ToolTip="Район" 
                                    tabIndex="10" CssClass="InfoText80" onblur="CopyAddress('textClientDistrict','textFactDistrict','preClientDistrict');"></asp:textbox>
                                </td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								...
								<td style="white-space:nowrap">
                                    <asp:TextBox ID="preClientSettlement" runat="server" CssClass="InfoText10" Enabled="False"></asp:TextBox>
                                    <asp:textbox ID="textClientSettlement" meta:resourcekey="textClientSettlement" runat="server" MaxLength="70" ToolTip="Населённый пункт"
										tabIndex="11" CssClass="InfoText80" onblur="CopyAddress('textClientSettlement','textFactSettlement','preClientSettlement');"></asp:textbox>
                                </td>
								<td></td>
								<td>
                                    <asp:CustomValidator ID="validatorClientSettlement" runat="server" CssClass="Validator" meta:resourcekey="NeedToFill"
                                        ErrorMessage="необходимо заполнить" ClientValidationFunction="validateClientSettlement" ControlToValidate="textClientSettlement" ValidateEmptyText="True"></asp:CustomValidator></td>
							</tr>
							<tr>
								<td>
                                    </td>
								...
								<td style="white-space:nowrap">
                                    <asp:TextBox ID="preClientAddress" runat="server" CssClass="InfoText10" Enabled="False"></asp:TextBox>
                                    <asp:textbox ID="textClientAddress" runat="server" meta:resourcekey="textClientAddress" MaxLength="70" ToolTip="Адрес"
										tabIndex="12" CssClass="InfoText80" onblur="CopyAddress('textClientAddress','textFactAddress','preClientAddress');"></asp:textbox>
								</td>
								<td>
                                    <input id="btStreetType" runat="server" onclick="GetStreetType()" type="button" value="?" title="Тип улицы"
									tabindex="13" class="ImgButton" meta:resourcekey="forbtStreetType" />
                                </td>
								<td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="textFactAddressFull" runat="server" CssClass="InfoText" meta:resourcekey="textFactAddressFull" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td></td>
                                <td>
									...
									<div class="mn" id="fact_address">
										<table class="InnerTable">
											<tr>
												...
												<td width="35%">
													<asp:textbox id="textFactIndex" onblur="doValueCheck('textFactIndex');CopyAddress();" tabIndex="14" maxLength="5" runat="server"
											...
											<tr>
												...
												<td>
													<asp:textbox id="textFactRegion" tabIndex="15" maxLength="35" runat="server"
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>
                                                    <asp:Label ID="lbFactAddress" runat="server" CssClass="InfoText" meta:resourcekey="lbAddress" Text="Адрес"></asp:Label>
                                                </td>
                                                <td>
							...
							<tr>
								...
								<td>
									<asp:dropdownlist id=listClientCodeType runat="server" 
										...
										DataSource="<%# dsClientCodeType %>" tabIndex=19
							...
							<tr>
								...
								<td>
									<asp:textbox id="textClientCode" meta:resourcekey="textClientCode" runat="server" MaxLength="10" ToolTip="Идентификационный код"
										tabIndex="19" CssClass="InfoText" onblur="doValueCheck('textClientCode');ckOKPO();"></asp:textbox>
								</td>
								<td></td>
								<td>
							...
							<tr>
								...
								<td>
									<asp:dropdownlist id=listDocType runat="server" 
										...
										DataSource="<%# dsDocType %>" tabIndex=20
										CssClass="BaseDropDownList">
									</asp:dropdownlist>
								</td>
								<td></td>
							...
							<tr>
								...
								<td>
									<asp:textbox id="textDocSerial" meta:resourcekey="textDocSerial" runat="server" MaxLength="10" ToolTip="Серия документа" 
                                    tabIndex="21" CssClass="InfoText" onblur="ckSerial();"></asp:textbox>
								</td>
								<td></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								...
								<td>
									<asp:textbox id="textDocNumber" meta:resourcekey="textDocNumber" runat="server" MaxLength="20" ToolTip="Номер документа" 
                                    tabIndex="22" CssClass="InfoText" onblur="doValueCheck('textDocNumber');ckNumber();"></asp:textbox>
								</td>
								<td></td>
								<td>
									<asp:requiredfieldvalidator id="validatorDocNumber" meta:resourcekey="NeedToFill" runat="server" ErrorMessage="необходимо заполнить" 
                                    ControlToValidate="textDocNumber" CssClass="Validator"></asp:requiredfieldvalidator>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<asp:textbox id="textDocOrg" meta:resourcekey="textDocOrg" runat="server" MaxLength="70" ToolTip="Кем выдан" 
                                    tabIndex="23" CssClass="InfoText"></asp:textbox>
								</td>
								<td></td>
								<td>
							...
							<tr>
								...
								<td>
									<igtxt:webdatetimeedit id="dtDocDate" runat="server" ToolTip="Дата выдачи документа" EditModeFormat="dd/MM/yyyy"
										DisplayModeFormat="dd/MM/yyyy" HorizontalAlign="Center" MinValue="1800-01-01" tabIndex="24" CssClass="InfoDateSum"
							...
							<tr>
								...
								<td>
									<igtxt:webdatetimeedit id="dtBirthDate" runat="server" ToolTip="Дата рождения клиента" EditModeFormat="dd/MM/yyyy"
										DisplayModeFormat="dd/MM/yyyy" HorizontalAlign="Center" MinValue="1800-01-01" tabIndex="25" CssClass="InfoDateSum">
							...
							<tr>
								...
								<td>
									<asp:textbox id="textBirthPlace" meta:resourcekey="textBirthPlace" runat="server" MaxLength="70" ToolTip="Место рождения" 
                                    tabIndex="26" CssClass="InfoText"></asp:textbox>
								</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								...
								<td>
									<asp:textbox id="textHomePhone" meta:resourcekey="textHomePhone" runat="server" MaxLength="15" ToolTip="Домашний телефон"
                                     tabIndex="27" CssClass="InfoText"></asp:textbox>
								</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
                                ...
                                <td>
									<asp:textbox id="textWorkPhone" meta:resourcekey="textWorkPhone" runat="server" MaxLength="15" ToolTip="Рабочий телефон"
									tabIndex="28" CssClass="InfoText"></asp:textbox>
								</td>
								<td></td>
								<td></td>
							</tr>
						...
						<table class="InnerTable">
							...
							<tr>
								...
								<td>
									<asp:button id="btUpdate" meta:resourcekey="btUpdate" runat="server" Text="Регистрировать" Visible="False"
                                    tabIndex="100" CssClass="DirectionButton"></asp:button>
								</td>
								<td>
									&nbsp;</td>
								<td>
									<asp:button id="btnClear" meta:resourcekey="btnClear" runat="server" Text="Очистить" CausesValidation="False"
                                     tabIndex="103" CssClass="DirectionButton"></asp:button>
								</td>
							</tr>
						</table>
					</td>
