...
function fnCheckRates()
{
 ...
 document.all.SMIN.value = document.all.SMIN.value.replace(re,'.');
 document.all.SMAX.value = document.all.SMAX.value.replace(re,'.');
 SaveR(selectedRowId,document.all.TAR.value,document.all.PR.value,document.all.SMIN.value,document.all.SMAX.value,document.all.BDAT.value,document.all.EDAT.value);
}
function onDef()
{
