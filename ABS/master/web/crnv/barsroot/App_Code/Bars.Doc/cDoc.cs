...
namespace Bars.Doc
{
    ...
    public class cDoc
    {
        ...
        public bool oDocument()
        {
            ...
            cmd.CommandText = "SELECT dk,nlsm,nlsk,fli,SUBSTR(flags,38,1),name, flags FROM tts WHERE tt=:TT";
        ...
        public bool pLnk()
        {
            ...
            cmd.CommandText = "SELECT t.tt,t.dk,a.dk,t.s,t.s2 FROM tts t, ttsap a WHERE a.ttap=t.tt AND a.tt=:TT";
            cmd.Parameters.Add("TT", OracleDbType.Varchar2, this.TT, ParameterDirection.Input);
