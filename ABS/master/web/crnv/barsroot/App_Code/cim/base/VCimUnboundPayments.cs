...
namespace cim
{
    public sealed class VCimUnboundPaymentsRecord : BbRecord
    {
        ...
        private void fillFields()
        {
            ...
            Fields.Add( new BbField("PAY_TYPE", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_UNBOUND_PAYMENTS", ObjectTypes.View, "Нерозібрані платежі", "Тип, 0-раніше не прив'язані, 1-відв'язані реальні, 2-відв'язані фантоми"));
