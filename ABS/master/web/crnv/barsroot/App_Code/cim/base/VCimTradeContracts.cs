...
namespace cim
{
    public sealed class VCimTradeContractsRecord : BbRecord
    {
        ...
        public VCimTradeContractsRecord(BbDataSource Parent, OracleDecimal RowScn, Decimal? CONTR_ID, Decimal? CONTR_TYPE, String CONTR_TYPE_NAME, String NUM, Decimal? RNK, String OKPO, String NMK, String ND, String VED, String VED_NAME, DateTime? OPEN_DATE, DateTime? CLOSE_DATE, Decimal? KV, Decimal? S, Decimal? BENEF_ID, String BENEF_NAME, Decimal? COUNTRY_ID, String COUNTRY_NAME, Decimal? STATUS_ID, String STATUS_NAME, String COMMENTS, String BRANCH, String BRANCH_NAME, Decimal? SPEC_ID, String SPEC_NAME, Decimal? SUBJECT_ID, String SUBJECT_NAME, Decimal? DEADLINE, String TRADE_DESC)
            : this(Parent)
        {
        ...
        private void fillFields()
        {
            ...
            Fields.Add( new BbField("COUNTRY_ID", OracleDbType.Decimal, true, false, false, false, false, "V_CIM_TRADE_CONTRACTS", ObjectTypes.View, "Довідник торгових контрактів v1.0", ""));
            Fields.Add( new BbField("COUNTRY_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_TRADE_CONTRACTS", ObjectTypes.View, "Довідник торгових контрактів v1.0", ""));
            ...
            Fields.Add( new BbField("COMMENTS", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_TRADE_CONTRACTS", ObjectTypes.View, "Довідник торгових контрактів v1.0", "Уточнення предмету контракту"));
            Fields.Add( new BbField("BRANCH", OracleDbType.Varchar2, false, false, false, false, false, "V_CIM_TRADE_CONTRACTS", ObjectTypes.View, "Довідник торгових контрактів v1.0", ""));
            Fields.Add( new BbField("BRANCH_NAME", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_TRADE_CONTRACTS", ObjectTypes.View, "Довідник торгових контрактів v1.0", ""));
            ...
            Fields.Add( new BbField("TRADE_DESC", OracleDbType.Varchar2, true, false, false, false, false, "V_CIM_TRADE_CONTRACTS", ObjectTypes.View, "Довідник торгових контрактів v1.0", ""));        
        }
