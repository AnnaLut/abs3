                ...
                case "err":
                    {
                        ...
                        {
                            resp_str = ergen.GetHtmlErrorPage((System.Exception)HttpContext.Current.Session["AppError"], fullInfo);
                        ...
                        else
                        {
                            ...
                            {
                                resp_str = ergen.GetHtmlErrorPage((System.Exception)AppDomain.CurrentDomain.GetData(key), fullInfo);
