...
namespace Bars.WebServices
{
    public class WebServices : Bars.BarsWebService
    {
        ...
        //Закрыть счет
        [WebMethod(EnableSession = true)]
        public string CloseAccount(decimal acc, int prompts)
        {
            ...
            try
            {
                ...
                result += reader.GetValue(7).ToString() + "(" + reader.GetValue(6).ToString() + ") ";
        ...
        public object[] GetMetaTable(string[] data)
        {
            ...
            try
            {
                ...
                while (SQL_Reader_Read())
                {
                    ...
                    if (SQL_Reader_GetValues()[9].ToString() == "1" && SK_Field == "")
                    {
                        pos = 2;
                    ...
                    else if (SQL_Reader_GetValues()[8].ToString() == "1" && PK_Field == "")
                    {
                        pos = 1;
                        colname = "COL1";
                    }
                ...
                Logger.DBLogger.Info("GetMetaTable:::" + Pop);
