...
namespace Bars.DocPrint
{
    public class cDocPrint
    {
        ...
        public static string GetRandomFileName()
        {
            ...
            string strTempDir = System.Environment.GetEnvironmentVariable("TEMP");
            string strTicketFile = strTempDir + "/" + "ticket_" +
                System.DateTime.Now.ToString("dd_MM_yyyy_HH_mm_ss_fffffff") +
                "_" + rnd.Next().ToString() + ".txt";
        ...
        public static string GetRandomFileName(string Ref)
        {
            Random rnd = new Random();
            string strTempDir = System.Environment.GetEnvironmentVariable("TEMP");
            string strTicketFile = strTempDir + "/" + "ticket_" + Ref +
                System.DateTime.Now.ToString("dd_MM_yyyy_HH_mm_ss_fffffff") +
                "_" + rnd.Next().ToString() + ".txt";
            return strTicketFile;
        }
