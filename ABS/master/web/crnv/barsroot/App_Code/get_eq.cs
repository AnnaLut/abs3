...
public class get_eq : BarsWebService
{
    ...
    public  String  Get_eq(Decimal vidd, String ser, String num, String datb, Decimal kv, String kurs, Decimal s)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "select to_char(limeq.geteq(:fl,:ser, :num, :datb, :kv, :kurs, :s)) as Result from dual";
     ...
     [WebMethod(EnableSession = true)]
    public String Set_eq(String vdat_, String datb_, Decimal vidd_, String serd_, String pasp_, String fio_, Decimal sq_, Decimal kv_, Decimal s_, String ref_, String branch_, String kurs_, String kuro_)
    {
        String UserName = Bars.Configuration.ConfigurationSettings.AppSettings["VAL.Username"];
        String Password = Bars.Configuration.ConfigurationSettings.AppSettings["VAL.Pass"];
