...
namespace credit
{
    public sealed class VWcsVisaBidsRecord : BbRecord
    {
        public VWcsVisaBidsRecord(): base()
        {
            fillFields();
        }
        public VWcsVisaBidsRecord(BbDataSource Parent) : base (Parent)
        {
            fillFields();
        }
        ...
        {
            Fields.Add( new BbField("BID_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Идентификатор заявки"));
            Fields.Add( new BbField("SUBPRODUCT_ID", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Идентификатор субпродукта"));
            Fields.Add( new BbField("SUBPRODUCT_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Наименование субпродукта"));
            Fields.Add( new BbField("CRT_DATE", OracleDbType.Date, false, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Дата создания заявки"));
            Fields.Add( new BbField("F", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Ф клиента"));
            Fields.Add( new BbField("I", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "И клиента"));
            Fields.Add( new BbField("O", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "О клиента"));
            Fields.Add( new BbField("BDATE", OracleDbType.Date, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Дата рождения клиента"));
            Fields.Add( new BbField("INN", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "ИНН клиента"));
            Fields.Add( new BbField("SUMM", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Сумма кредита"));
            Fields.Add( new BbField("OWN_FUNDS", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Сума власних коштів"));
            Fields.Add( new BbField("TERM", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Срок кредита"));
            Fields.Add( new BbField("CREDIT_CURRENCY", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Валюта кредиту"));
            Fields.Add( new BbField("SINGLE_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Комісія банку разова"));
            Fields.Add( new BbField("MONTHLY_FEE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Комісія банку щомісячна"));
            Fields.Add( new BbField("INTEREST_RATE", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Відсоткова ставка"));
            Fields.Add( new BbField("REPAYMENT_METHOD", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Метод погашення"));
            Fields.Add( new BbField("REPAYMENT_DAY", OracleDbType.Decimal, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "День погашення"));
            Fields.Add( new BbField("GARANTEES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Обеспечения"));
            Fields.Add( new BbField("MGR_ID", OracleDbType.Decimal, false, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Ид менеджера"));
            Fields.Add( new BbField("MGR_FIO", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "ФИО менеджера"));
            Fields.Add( new BbField("BRANCH", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Идентификатор отделения"));
            Fields.Add( new BbField("BRANCH_NAME", OracleDbType.Varchar2, false, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Наименование отделения"));
            Fields.Add( new BbField("STATES", OracleDbType.Varchar2, true, false, false, false, false, "V_WCS_VISA_BIDS", ObjectTypes.View, "Заявки для визирования (Представление)", "Состояния"));
    ...
    {
        public VWcsVisaBidsFilters(BbDataSource Parent) : base (Parent)
        {
    ...
    {
        public VWcsVisaBids() : base(new BbConnection())
        {
            // base.Connection.RoleName = "WR_WCS";
        }
        public VWcsVisaBids(BbConnection Connection)
            : base(Connection)
        {
        }
        public override List<VWcsVisaBidsRecord> Select(VWcsVisaBidsRecord Item)
        {
            List<VWcsVisaBidsRecord> res = new List<VWcsVisaBidsRecord>();
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    res.Add(new VWcsVisaBidsRecord(
                        this,
