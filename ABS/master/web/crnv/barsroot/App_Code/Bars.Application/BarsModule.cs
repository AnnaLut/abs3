    ...
    public sealed class BarsModule : IHttpModule, IRequiresSessionState
    {
        ...
        void OnError(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session != null)
            {
                ...
                if (!currUrl.Contains("dialog.aspx?type=err"))
                {
        ...
        void OnAuthenticate(object sender, EventArgs e)
        {
            ...
            bool isUserLoggedIn = (app.Context.Session["userIdentity"] == null) ? (false) : (true);
            ...
            if (isUserLoggedIn)
            {
                ...
                {
                    // Время жизни сесии
                    string timeExpr = Bars.Configuration.ConfigurationSettings.AppSettings[AUTHENTICATION_SESSION_EXPIRATION_KEY];
                    ...
                    if (DateTime.Now > dMax)
                    {
                        ...
                        if (pageFileExt != ".asmx")
                        {
                            ...
                            //res.Redirect("/barsroot/account/login/", true);
                            return;
                        }
                    }
                    else if (pageFileName != "synchead.asmx")
