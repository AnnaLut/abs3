...
<head>
    ...
    <script language="JavaScript" src="Scripts/DptDealState.js?v1.8"></script>
                        ...
                        <tr>
                            <td>
                                <img class="outset" id="btDetail" title="Параметри договору" onclick="fnDetail()"
                                    src="/Common/Images/OPEN_.gif">&nbsp;<img class="outset" id="btRefresh" title="Перечитати"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="BarsTextBoxRO" id="tbKv" title="Валюта договору" style="width: 270px"
                                    tabindex="0" readonly type="text">
                            </td>
                        </tr>
                        <tr>
                            <td nowrap style="width: 109px; height: 10px" align="right">
        ...
        <tr>
            <td nowrap align="left">
                ...
                <input class="BarsTextBoxRO" id="tbOst_Pl" title="Залишок на депозитному рахунку"
                    style="width: 100px; text-align: right" tabindex="0" readonly type="text">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="BarsLabel" id="lbNlsP" style="color: green">
                    Рахунок нарах. %%:</span>
            ...
            <td>
                <asp:Panel ID="pnActions" runat="server" Height="40px" Style="padding-top: 5px" BorderStyle="Groove"
                    ...
                    <table>
                        <tr>
                            <td>
                                <input disabled class="BarsButton" id="pb0" style="width: 125px; color: blue" onclick="fnRazm()"
                                    type="button" value="Розміщення">
                            </td>
                            <td>
                                <input disabled class="BarsButton" id="pb1" style="width: 125px; color: purple" onclick="fnPopol()"
                                    type="button" value="Поповнення">
                            </td>
                            <td>
                                <input disabled class="BarsButton" id="pb3" style="width: 125px; color: green" onclick="fnNachis()"
                                    type="button" value="Нарахування %%">
                            </td>
                            <td>
                                <input disabled class="BarsButton" id="pb4" style="width: 125px; color: teal" onclick="fnViplat()"
                                    type="button" value="Виплата. нарах. %%">
                            </td>
                            <td>
                                <input disabled class="BarsButton" id="pb2" style="width: 125px; color: maroon" onclick="fnPogash()"
                                    type="button" value="Погашення">
                            </td>
                            <td>
                                <input disabled class="BarsButton" id="pb5" style="width: 125px; color: red" onclick="fnStop()"
                                    type="button" value="Штрафування" title="Дострокове розторгнення договору">
                            </td>
                        </tr>
                        <tr>
                            <td>
