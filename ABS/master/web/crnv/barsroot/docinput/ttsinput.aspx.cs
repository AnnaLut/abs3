				...
				try
				{
					...
					while (rdr.Read())
					{
						...
						if (sFold != sGroup)
						{
							...
							listTts.Controls.Add(new LiteralControl("<DIV onclick=\"sM('"+i+"')\" >"));
							listTts.Controls.Add(new LiteralControl("<img id='i_"+i+"' align=\"absmiddle\" src=\"/Common/Images/Folder.gif\" />"));
						...
						if("RO"==rdr.GetOracleString(3).Value )
							listTts.Controls.Add(new LiteralControl(" style='color:green'"));
						listTts.Controls.Add(new LiteralControl(">"));
						listTts.Controls.Add(new LiteralControl("&nbsp<span onselectstart='return false;' onmouseleave=\"this.style.textDecoration='none'\" onmousemove=\"this.style.textDecoration='underline'\" onclick=\"go('"+sTT+"'," + i + ")\" class=ms>"+sName+"</span>"));
						listTts.Controls.Add(new LiteralControl("</DIV>"));	
					}
                    rdr.Close();
                    rdr.Dispose();
