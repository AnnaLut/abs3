...
<head>
    ...
    <script language="javascript" type="text/javascript" src="additionalFuncs.js?v.1.0"></script>
    <script language="javascript" type="text/javascript" src="/Common/jquery/jquery.js"></script>
    <script language="javascript" type="text/javascript" src="/Common/jquery/jquery.numbermask.js"></script>
    <script language="javascript" type="text/javascript" src="JScriptFortab_main_rekv.js?v1.4.10"></script>
    <script language="javascript" type="text/javascript" src="JScriptFortab_main_rekv_person.js?v1.1.2"></script>
...
<body>
    ...
    <table id="tblEdits" border="0" cellpadding="1" cellspacing="0" style="">
        ...
        <tr>
            ...
            <td>
                ...
                <input id="bt_FullDopRekv" style="display:none;" title="Режим ввода доп. реквизитов" class="ref" 
        ...
        <tr class="trPersonFIO" id="trPersonFIO" style="display: none">
            <td colspan="2">
                <div style="float:right;margin:0 173px 0 0;border:1px solid #9b9b9b;width:300px">
        ...
        <tr>
            ...
            <td>
                ...
                <input id="bt_fullADR" title="Режим ввода полного адреса" class="ref" onclick="ShowfullADR();ToDoOnChange();"
                    type="button" value="..." tabindex="8" />
                <div class="required">
                    *</div>
            </td>
    ...
    <input type="hidden" runat="server" id="forbt_fullADR" meta:resourcekey="forbt_fullADR"
        value="Режим ввода полного адреса" />
