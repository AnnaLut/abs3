...
<table style="FONT-SIZE: 10pt; FONT-FAMILY: Arial" cellSpacing="0" borderColorDark="#ffffff" cellPadding="2" borderColorLight="black" border="1" width="100%">
	<tr>
		...
		<td class="cellStyle" width="200px"><xsl:text>Group</xsl:text></td>
		<td class="cellStyle" width="180px"><xsl:text>Mark</xsl:text></td>
		<td class="cellStyle"><xsl:text>Performer</xsl:text></td>
	</tr>
