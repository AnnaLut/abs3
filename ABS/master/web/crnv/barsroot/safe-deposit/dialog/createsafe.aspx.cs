...
public partial class safe_deposit_dialog_createsafe : System.Web.UI.Page
{
    ...
    public static String GetNls(String safe_id)
    {
        ...
        try
        {
            ...
            cmd.CommandText = @"SELECT substr(f_newnls(:safe_id,'SCRN','2909'),1,14) FROM dual";
            cmd.Parameters.Add("safe_id", OracleDbType.Decimal, safe_id, ParameterDirection.Input);
    ...
    public static String SafeIdExists(String safe_id)
    {
        ...
        try
        {
            ...
            OracleCommand cmd = connect.CreateCommand();
            cmd.CommandText = "select n_sk from skrynka where n_sk = :n_sk";
            cmd.Parameters.Add("safe_id", OracleDbType.Decimal, safe_id, ParameterDirection.Input);
    ...
    protected void btCreateSafe_Click(object sender, EventArgs e)
    {
        ...
        sdpt.CreateSafe(Convert.ToDecimal(SAFE_ID.Text), 
