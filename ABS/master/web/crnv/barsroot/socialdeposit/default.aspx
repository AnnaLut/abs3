					...
					<td>
						<table class="InnerTable">
							...
							<tr>
								...
								<td>
									<asp:textbox id="textClientIndex" meta:resourcekey="textClientIndex" onkeydown="doNum();" runat="server" MaxLength="5" ToolTip="Индекс"
										tabIndex="7" onblur="doValueCheck('textClientIndex');CopyAddress('textClientIndex','textFactIndex');" CssClass="InfoText"></asp:textbox>
								</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								...
								<td>
								    <asp:TextBox ID="preClientRegion" runat="server" CssClass="InfoText10" Enabled="False"></asp:TextBox><asp:textbox id="textClientRegion" meta:resourcekey="textClientRegion" runat="server" MaxLength="35" ToolTip="Область" tabIndex="8"
										CssClass="InfoText80" onblur="CopyAddress('textClientRegion','textFactRegion','preClientRegion');"></asp:textbox>
								</td>
								<td>
                                    </td>
								<td></td>
							...
							<tr>
								...
								<td>
                                    <asp:TextBox ID="preClientDistrict" runat="server" CssClass="InfoText10" Enabled="False"></asp:TextBox><asp:textbox id="textClientDistrict" meta:resourcekey="textClientDistrict" runat="server" MaxLength="35" ToolTip="Район" tabIndex="9"
										CssClass="InfoText80" onblur="CopyAddress('textClientDistrict','textFactDistrict','preClientDistrict');"></asp:textbox></td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								...
								<td>
                                    <asp:TextBox ID="preClientSettlement" runat="server" CssClass="InfoText10" Enabled="False"></asp:TextBox><asp:textbox id="textClientSettlement" meta:resourcekey="textClientSettlement" runat="server" MaxLength="70" ToolTip="Населённый пункт"
										tabIndex="10" CssClass="InfoText80" onblur="CopyAddress('textClientSettlement','textFactSettlement','preClientSettlement');"></asp:textbox></td>
								<td></td>
								<td>
							...
							<tr>
								...
								<td>
                                    <asp:TextBox ID="preClientAddress" runat="server" CssClass="InfoText10" Enabled="False"></asp:TextBox><asp:textbox id="textClientAddress" meta:resourcekey="textClientAddress" runat="server" MaxLength="70" ToolTip="Адрес" tabIndex="11"
										CssClass="InfoText80" onblur="CopyAddress('textClientAddress','textFactAddress','preClientAddress');"></asp:textbox>
								</td>
								<td><input id="btStreetType" onclick="GetStreetType()" tabIndex="11" type="button" value="?"
										class="ImgButton" Title="Тип улицы" runat="server" meta:resourcekey="forbtStreetType" ></td>
								<td><input type="hidden" runat="server" id="hidStreetType" /></td>
							</tr>
                            <tr>
