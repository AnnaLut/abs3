...
namespace barsroot.cim
{
    ...
    public class CimManager
    {
        ...
        public static string Version = "1.0.0.55";
        ...
        private void readContract()
        {
            ...
            if (this.ContrId.HasValue)
            {
                try
                {
                    ...
                    oraCmd.CommandText = "select contr_id,contr_type, contr_type_name, num, subnum, rnk,open_date,close_date,kv,s,benef_id,status_id,status_name,comments, branch, branch_name, owner_uid, owner_name, bic, b010, service_branch from v_cim_all_contracts where contr_id=:contrId";
