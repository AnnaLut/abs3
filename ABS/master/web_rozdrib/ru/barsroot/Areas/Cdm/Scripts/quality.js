...
bars.quality = bars.quality || {
    ...
    loadGroups: function (callback, params) {
        ...
        $.get(bars.config.urlContent('/Cdm/Quality/GetGroups?isAdminMode=' + bars.quality.isAdminMode)).done(function (data) {
            bars.ui.loader('body', false);
    ...
    loadSubGroups: function (selector) {
        bars.ui.loader('body', true);
        $.get(bars.config.urlContent('/Cdm/Quality/GetSubGroups')).done(function (data) {
            bars.ui.loader('body', false);
    ...
    openAdvisoryList: function () {
        ...
        if (rowParams.sub) {
            ...
            advisoryListUrl = advisoryListUrl + '&subGroupId=' + rowParams.sub + '&SubGroupOrd=' + rowParams.subord;
        }
        ...
        $.ajax(
            {
                ...
                success: function (data) {
                    ...
                    if (data.status == 'ok') {
                        ...
                        bars.ui.error({ text: data.message + queuedMsg });
                    }
    ...
    loadDropDownData: function () {
        if (bars.quality.dropDownData == null) {
            $.get(bars.config.urlContent('/Cdm/Quality/GetDropDownData')).done(function (data) {
    ...
    resyncCurrentAdvisories: function () {
        ...
        $.get(bars.config.urlContent('/Cdm/Quality/GetAdvisoryListByRnk?rnk=' + self.currentRnk + "&groupId=" + self.currentGroup)).done(function (data) {
