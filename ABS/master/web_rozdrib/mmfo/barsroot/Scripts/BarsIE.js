...
function barsie$init() {
    ...
    return document.getElementById('BarsPrint');
}
...
function barsie$print(filename) {
    if (filename.substring(0, 1) == "/") {
        ...
        try {
            ...
            if (typeof ax.CallDPrint != "undefined") {
                ax.CallDPrint(filename, "");
            } else {
                document.location.href = '/barsroot/dialog.aspx?type=print_file&filename=' + filename;
            }
        } catch (e) {
