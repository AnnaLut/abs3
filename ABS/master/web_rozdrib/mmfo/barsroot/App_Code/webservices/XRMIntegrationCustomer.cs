        ...
        public static SetClient CreateCustomer(SetClient ClientReq, OracleConnection connect)
        {
            ...
            {               
                ...
                _ClientPerson.SEX = ((OracleDecimal)cmdSearchCustomer.Parameters["Sex_"].Value).Value;
                    ...
                    ClientReq.ClientRequisites.CheckClient.RelId = ((OracleDecimal)cmdSearchCustomer.Parameters["p_relid"].Value).IsNull ? (Decimal?)null : ((OracleDecimal)cmdSearchCustomer.Parameters["p_relid"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.RelRnk = ((OracleDecimal)cmdSearchCustomer.Parameters["p_relrnk"].Value).IsNull ? (Decimal?)null : ((OracleDecimal)cmdSearchCustomer.Parameters["p_relrnk"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.Relintext = ((OracleDecimal)cmdSearchCustomer.Parameters["p_relintext"].Value).IsNull? (Decimal?)null : ((OracleDecimal)cmdSearchCustomer.Parameters["p_relintext"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.Vaga1 = ((OracleDecimal)cmdSearchCustomer.Parameters["p_vaga1"].Value).IsNull ? (Decimal?)null : ((OracleDecimal)cmdSearchCustomer.Parameters["p_vaga1"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.Vaga2 = ((OracleDecimal)cmdSearchCustomer.Parameters["p_vaga2"].Value).IsNull ? (Decimal?)null : ((OracleDecimal)cmdSearchCustomer.Parameters["p_vaga2"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.TypeId = ((OracleDecimal)cmdSearchCustomer.Parameters["p_typeid"].Value).IsNull ? (Decimal?)null : ((OracleDecimal)cmdSearchCustomer.Parameters["p_typeid"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.Position = ((OracleString)cmdSearchCustomer.Parameters["p_position"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_position"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.Position_r = ((OracleString)cmdSearchCustomer.Parameters["p_position_r"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_position_r"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.FirstName = ((OracleString)cmdSearchCustomer.Parameters["p_firstname"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_firstname"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.MiddleName = ((OracleString)cmdSearchCustomer.Parameters["p_middlename"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_middlename"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.LastName = ((OracleString)cmdSearchCustomer.Parameters["p_lastname"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_lastname"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.DocumentTypeId = ((OracleDecimal)cmdSearchCustomer.Parameters["p_documenttypeid"].Value).IsNull ? (Decimal?)null : ((OracleDecimal)cmdSearchCustomer.Parameters["p_documenttypeid"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.Document = ((OracleString)cmdSearchCustomer.Parameters["p_document"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_document"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.TrustRegNum = ((OracleString)cmdSearchCustomer.Parameters["p_trustregnum"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_trustregnum"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.TrustRegDat = ((OracleDate)cmdSearchCustomer.Parameters["p_trustregdat"].Value).IsNull ? (DateTime?)null : ((OracleDate)cmdSearchCustomer.Parameters["p_trustregdat"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.BDate = ((OracleDate)cmdSearchCustomer.Parameters["p_bdate"].Value).IsNull ? (DateTime?)null : ((OracleDate)cmdSearchCustomer.Parameters["p_bdate"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.EDate = ((OracleDate)cmdSearchCustomer.Parameters["p_edate"].Value).IsNull ? (DateTime?)null : ((OracleDate)cmdSearchCustomer.Parameters["p_edate"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.NotaryName = ((OracleString)cmdSearchCustomer.Parameters["p_notaryname"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_notaryname"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.NotaryRegion = ((OracleString)cmdSearchCustomer.Parameters["p_notaryregion"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_notaryregion"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.SignPrivs = ((OracleDecimal)cmdSearchCustomer.Parameters["p_signprivs"].Value).IsNull ? (Decimal?)null : ((OracleDecimal)cmdSearchCustomer.Parameters["p_signprivs"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.SignId = ((OracleDecimal)cmdSearchCustomer.Parameters["p_signid"].Value).IsNull ? (Decimal?)null : ((OracleDecimal)cmdSearchCustomer.Parameters["p_signid"].Value).Value;
                    ClientReq.ClientRequisites.CheckClient.Namer = ((OracleString)cmdSearchCustomer.Parameters["p_namer"].Value).IsNull ? null : ((OracleString)cmdSearchCustomer.Parameters["p_namer"].Value).Value;
